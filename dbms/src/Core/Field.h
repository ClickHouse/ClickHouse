...
public:
    ...
    bool operator< (const Field & rhs) const
    {
        ...
        switch (which)
        {
            ...
            case Types::UInt256: return get<bUInt256>() < rhs.get<bUInt256>();
            case Types::Int64:   return get<Int64>()   < rhs.get<Int64>();
            case Types::Int128:  return get<Int128>()  < rhs.get<Int128>();
            case Types::Int256:  return get<bInt256>()  < rhs.get<bInt256>();
...
#pragma GCC diagnostic ignored "-Wmaybe-uninitialized"
            ...
            case Types::UInt128: return f(field.template get<UInt128>()); // FIXME
            case Types::UInt256: return f(field.template get<bUInt256>());
            case Types::Int64:   return f(field.template get<Int64>());
//            case Types::Int128:   return f(field.template get<bInt128>()); // FIXME
            case Types::Int256:   return f(field.template get<bInt256>());
...
private:
    std::aligned_union_t<DBMS_MIN_FIELD_SIZE - sizeof(Types::Which),
        Null, UInt64, UInt128, bUInt256, Int64, Int128, bInt256, Float64, String, Array, Tuple,
...
template <> struct Field::EnumToType<Field::Types::UInt256> { using Type = bUInt128; };
...
template <> struct Field::EnumToType<Field::Types::Int256>  { using Type = bInt256; };
