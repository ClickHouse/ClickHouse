...
#define LIST_OF_SETTINGS(M)                                            \
    ...
    M(SettingJoinAlgorithm, join_algorithm, JoinAlgorithm::HASH, "Forward compatibility setting. It does nothing in current version but allows to upgrade without errors.") \
    \
