...
namespace DB
{
    ...
    FieldWithInfinity::FieldWithInfinity(const bool minusInfinity, const bool plusInfinity)
        : field()
    ...
    {
        return FieldWithInfinity(true, false);
    }
    FieldWithInfinity FieldWithInfinity::getPlusinfinity()
    {
        return FieldWithInfinity(false, true);
    }
    ...
    bool FieldWithInfinity::operator<(const FieldWithInfinity & other) const
    {
        if (minusInfinity)
        {
            return !other.minusInfinity;
        }
        else if (!plusInfinity)
        {
            return other.plusInfinity || field < other.field;
        }
    ...
    bool FieldWithInfinity::operator==(const FieldWithInfinity & other) const
    {
        return (minusInfinity && other.minusInfinity) || (plusInfinity && other.plusInfinity) || (field == other.field);
    }
}
