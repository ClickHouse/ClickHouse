...
FORCE_INLINE void trackMemory(std::size_t size)
{
#if USE_JEMALLOC
...
FORCE_INLINE bool trackMemoryNoExcept(std::size_t size) noexcept
{
    try
    {
        trackMemory(size);
...
FORCE_INLINE void untrackMemory(void * ptr [[maybe_unused]], std::size_t size [[maybe_unused]] = 0) noexcept
{
    try
    {
#if USE_JEMALLOC
