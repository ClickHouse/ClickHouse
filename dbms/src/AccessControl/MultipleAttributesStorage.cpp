...
UUID MultipleAttributesStorage::insertImpl(const IAttributes & attrs, bool replace_if_exists)
{
    auto id = nested_storage_for_insertion->insert(attrs, replace_if_exists);
