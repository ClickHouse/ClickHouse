...
#define M(a, b) numeric_attribute_map[a] = b;
	...
	M("VisitStartDateTimeRoundedToMinute", 	"toUInt32(toStartOfMinute(StartTime))")
	M("VisitStartDateTimeRoundedToHour",   	"toUInt32(toStartOfHour(StartTime))")
	M("VisitStartDate",       				"toUInt32(toDateTime(StartDate))")
	M("VisitStartDateRoundedToMonth",      	"toUInt32(toDateTime(toStartOfMonth(StartDate)))")
	M("VisitStartWeek",       				"toUInt32(toDateTime(toMonday(StartDate)))")
	M("VisitStartTime",       				"toUInt32(toTime(StartTime))")
	M("VisitStartTimeRoundedToMinute",		"toUInt32(toStartOfMinute(toTime(StartTime)))")
...
#define M(a, b) formatted_attribute_map[a] = b;
	...
	M("VisitStartTimeRoundedToMinute",		"toStartOfMinute(toTime(StartTime))")
