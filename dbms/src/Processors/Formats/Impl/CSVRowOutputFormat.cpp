...
CSVRowOutputFormat::CSVRowOutputFormat(WriteBuffer & out_, const Block & header, bool with_names_, FormatFactory::WriteCallback callback, const FormatSettings & format_settings)
    : IRowOutputFormat(header, out_, callback), with_names(with_names_), format_settings(format_settings)
{
