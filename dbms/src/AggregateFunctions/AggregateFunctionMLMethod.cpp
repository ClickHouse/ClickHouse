...
LinearModelData::LinearModelData(Float64 learning_rate, Float64 l2_reg_coef, UInt32 param_num, UInt32 batch_capacity, std::shared_ptr< DB::IGradientComputer > gradient_computer, std::shared_ptr< DB::IWeightsUpdater > weights_updater)
...
void LinearModelData::predict(ColumnVector<Float64>::Container &container, Block &block, const ColumnNumbers &arguments, const Context & context) const
    {
...
void Nesterov::merge(const IWeightsUpdater& rhs, Float64 frac, Float64 rhs_frac)
    ...
    void Nesterov::update(UInt32 batch_size,
    ...
    void Nesterov::add_to_batch(std::vector<Float64> & batch_gradient, IGradientComputer & gradient_computer,
...
void Momentum::update(UInt32 batch_size,
                std::vector<Float64> & weights, Float64 & bias,
                const std::vector<Float64> & batch_gradient)
    {
...
void StochasticGradientDescent::update(UInt32 batch_size,
                std::vector<Float64> & weights, Float64 & bias,
                const std::vector<Float64> & batch_gradient)
    {
        /// batch_size is already checked to be greater than  0
...
void IWeightsUpdater::add_to_batch(std::vector<Float64> & batch_gradient, IGradientComputer & gradient_computer,
                              const std::vector<Float64> & weights, Float64 bias,
                              Float64 learning_rate, Float64 l2_reg_coef, Float64 target, const IColumn **columns, size_t row_num)
    {
...
void LogisticRegression::predict(ColumnVector<Float64>::Container & container,
                         Block & block,
                         const ColumnNumbers & arguments,
                         const std::vector<Float64> & weights, Float64 bias, const Context & context) const
    {
...
void LogisticRegression::compute(std::vector<Float64> & batch_gradient, const std::vector<Float64> & weights, Float64 bias,
                 Float64 learning_rate, Float64 l2_reg_coef, Float64 target, const IColumn **columns, size_t row_num)
    {
...
void LinearRegression::predict(ColumnVector<Float64>::Container &container,
                 Block &block,
                 const ColumnNumbers &arguments,
                 const std::vector<Float64> &weights, Float64 bias, const Context & context) const
    {
...
void LinearRegression::compute(std::vector<Float64> & batch_gradient, const std::vector<Float64> &weights, Float64 bias,
                 Float64 learning_rate, Float64 l2_reg_coef, Float64 target, const IColumn **columns, size_t row_num)
    {
