...
StoragePtr TableFunctionInput::executeImpl(const ASTPtr & ast_function, const Context & context) const
{
    ...
    StoragePtr storage = StorageInput::create(getName(), ColumnsDescription{sample_block.getNamesAndTypesList()});
