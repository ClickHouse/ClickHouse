...
public:
    /** Data is parsed using fast, streaming parser.
      ...
      */
    ValuesBlockInputStream(ReadBuffer & istr_, const Block & header_, const Context & context_, const FormatSettings & format_settings,
                           UInt64 max_block_size_, UInt64 rows_portion_size_);
