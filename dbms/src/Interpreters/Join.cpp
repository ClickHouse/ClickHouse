    ...
    #define M(TYPE) \
        case Join::Type::TYPE: \
            std::tie(filter, offsets_to_replicate) = \
                ...
                *maps.TYPE, block.rows(), key_columns, key_sizes, added_columns, null_map, right_indexes); \
            break;
        APPLY_FOR_JOIN_VARIANTS(M)
    #undef M
...
//    std::cerr << "joinBlock: " << block.dumpStructure() << "\n";
    ...
    if (kind == ASTTableJoin::Kind::Left && strictness == ASTTableJoin::Strictness::Any)
        joinBlockImpl<ASTTableJoin::Kind::Left, ASTTableJoin::Strictness::Any>(
            block, key_names_left, columns_added_by_join, sample_block_with_columns_to_add, maps_any);
        ...
        joinBlockImpl<ASTTableJoin::Kind::Left, ASTTableJoin::Strictness::All>(
            block, key_names_left, columns_added_by_join, sample_block_with_columns_to_add, maps_all);
        ...
        joinBlockImpl<ASTTableJoin::Kind::Left, ASTTableJoin::Strictness::Any>(
            block, key_names_left, columns_added_by_join, sample_block_with_columns_to_add, maps_any_full);
        ...
        joinBlockImpl<ASTTableJoin::Kind::Left, ASTTableJoin::Strictness::All>(
            block, key_names_left, columns_added_by_join, sample_block_with_columns_to_add, maps_all_full);
