...
{
public:
    StorageS3BlockInputStream(StorageS3 & storage_, const Context & context, UInt64 max_block_size)
        : storage(storage_)
    {
...
{
    BlockInputStreamPtr block_input = std::make_shared<StorageS3BlockInputStream>(*this, context, max_block_size);
...
{
public:
    explicit StorageS3BlockOutputStream(StorageS3 & storage_)
