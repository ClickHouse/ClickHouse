...
bool StorageReplicatedMergeTree::executeMetadataAlter(const StorageReplicatedMergeTree::LogEntry & entry)
{
...

    {
        ...
        auto table_lock = lockExclusively();
                                                      ...
                                                      const Context & context)
{
    ...
    auto lock1 = lockStructureForShare();
    auto lock2 = source_table->lockStructureForShare();
...
{
    auto lock1 = lockStructureForShare();
    auto lock2 = dest_table->lockStructureForShare();
