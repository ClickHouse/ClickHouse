...
MergeTreeSelectProcessor::MergeTreeSelectProcessor(
    ...
    MergeTreeData::DataPartPtr owned_data_part_,
    ...
    MergeTreeBaseSelectProcessor{
        ...
        storage_, std::move(prewhere_info_), max_block_size_rows_,
        preferred_block_size_bytes_, preferred_max_column_in_block_size_bytes_,
        std::move(reader_settings_), use_uncompressed_cache_, std::move(virt_column_names_)},
    required_columns{std::move(required_columns_)},
    data_part{std::move(owned_data_part_)},
