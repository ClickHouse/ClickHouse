...
private:
    void traverseAST(ASTPtr & node, bool replace_all = false) const;
    bool atomFromAST(const ASTPtr & node, bool replace_all = false) const;
    bool termFromAST(const ASTPtr & node, bool replace_all = false) const;
