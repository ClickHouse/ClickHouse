    ...
    Int64 max_block_number_to_read) const
{
    ...
    NamesAndTypesList available_real_columns = data.getColumns().getPhysical();
    ...
    ExpressionActionsPtr & out_expression, String & out_column, const Context & context) const
{
    ...
    out_expression = ExpressionAnalyzer(function, context, {}, data.getColumns().getPhysical()).getActions(false);
