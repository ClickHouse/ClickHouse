...
/** Implements the `quotas` system tables, which allows you to get information about quotas.
  */
class StorageSystemQuotas final : public StorageHelper<StorageSystemQuotas>, public IStorageSystemOneBlock<StorageSystemQuotas>
{
public:
...
protected:
    friend struct StorageHelper<StorageSystemQuotas>;
