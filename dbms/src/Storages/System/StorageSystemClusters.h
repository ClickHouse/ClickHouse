...
/** Implements system table 'clusters'
  ...
  */
class StorageSystemClusters final : public StorageHelper<StorageSystemClusters>, public IStorageSystemOneBlock<StorageSystemClusters>
{
    friend struct StorageHelper<StorageSystemClusters>;
public:
