...
struct UnaryOperationImpl
{
    ...
    static void NO_INLINE __attribute__((no_sanitize("undefined"))) vector(const ArrayA & a, ArrayC & c)
    {
        size_t size = a.size();
    ...
    static void __attribute__((no_sanitize("undefined"))) constant(A a, ResultType & c)
    {
        c = Op::apply(a);
    }
};
