...
public:
    ...
    String getSignature() const override { return "f(String, String) -> " + String(TypeName<typename Impl::ResultType>::get()); }
...
public:
    ...
    String getSignature() const override { return "f(String, String) -> String"; }
