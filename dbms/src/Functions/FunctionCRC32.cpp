...
struct CRC32Impl
{
    ...
    static void vector_fixed_to_constant(const ColumnString::Chars & data, size_t n, UInt32 & res) { res = crc32(data, 0, n); }
...
private:
    static uint32_t crc32(const ColumnString::Chars & buf, size_t offset, size_t size)
    {
