...
inline UInt64 uniqVariadicHashInexact(size_t num_args, const IColumn ** columns, size_t row_num)
{
	UInt64 hash;
...
inline UInt64 uniqVariadicHashInexactTuple(size_t num_args, const IColumn ** columns, size_t row_num)
{
	UInt64 hash;
...
inline UInt128 uniqVariadicHashExact(size_t num_args, const IColumn ** columns, size_t row_num)
{
	SipHash hash;
...
inline UInt128 uniqVariadicHashExactTuple(size_t num_args, const IColumn ** columns, size_t row_num)
{
	SipHash hash;
