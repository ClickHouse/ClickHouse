...
template <typename Impl, typename Name>
class FunctionStringStringStringToString : public IFunction
{
public:
	/// Получить имя функции.
	String getName() const
...
struct NameReplace			{ static const char * get() { return "replace"; } };
...
typedef FunctionStringStringStringToString<ReplaceImpl,	NameReplace>			FunctionReplace;
