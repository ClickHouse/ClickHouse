...
/** Протокол взаимодействия с сервером.
  ...
  *
  * 3. Клиент может отправить пакет GetSampleBlock чтобы получить структуру таблицы.
  * В ответ, сервер отправляет один пакет типа Data или Exception.
  */
...
namespace Protocol
{
	...
	namespace Client
	{
		enum Enum
		{
			...
			GetSampleBlock = 5,	/// Получить структуру таблицы.
		};
	}
