...
/** Выполняет над блоком вычисление некоторого выражения.
  ...
  */
class OldExpressionBlockInputStream : public IProfilingBlockInputStream
{
public:
	OldExpressionBlockInputStream(BlockInputStreamPtr input_, ExpressionPtr expression_, unsigned part_id_ = 0, bool clear_temporaries_ = false)
