...
public:
	...
	/** Зарезервировать место хотя бы под указанное количество строк и/или байт, если это возможно.
	  * Ничего не делать, если невозможно. Функция может игнорировать какой-либо из аргументов.
	  * Функция влияет только на производительность.
	  */
	virtual void reserve(size_t rows, size_t bytes) {}
