...
if [-z "$CLICKHOUSE_URL_PARAMS"]
then
  export CLICKHOUSE_URL_PARAMS=${CLICKHOUSE_URL_PARAMS:="${CLICKHOUSE_URL_PARAMS}&database=${CLICKHOUSE_DATABASE}"}
else
...
if [-z "$CLICKHOUSE_URL_PARAMS"]
then
  export CLICKHOUSE_URL=${CLICKHOUSE_URL:="${CLICKHOUSE_URL}?${$CLICKHOUSE_URL_PARAMS}"}
  export CLICKHOUSE_URL_HTTPS=${CLICKHOUSE_URL_HTTPS:="${CLICKHOUSE_URL_HTTPS}?${$CLICKHOUSE_URL_PARAMS}"}
fi
