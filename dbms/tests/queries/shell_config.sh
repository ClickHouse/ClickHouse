...
[ -x "${CLICKHOUSE_BINARY}-client" ] && export CLICKHOUSE_CLIENT=${CLICKHOUSE_CLIENT:="${CLICKHOUSE_BINARY}-client"}
[ -x "${CLICKHOUSE_BINARY}" ] && export CLICKHOUSE_CLIENT=${CLICKHOUSE_CLIENT:="${CLICKHOUSE_BINARY} client"}
