...
select '---------GO1';
SELECT '1,a1,1', arrayEnumerateUniqRanked(1,a1,1) FROM test.arrays_test;
SELECT '1,a2,1', arrayEnumerateUniqRanked(1,a2,1) FROM test.arrays_test;
SELECT '1,a3,1', arrayEnumerateUniqRanked(1,a3,1) FROM test.arrays_test;
SELECT '1,a4,1', arrayEnumerateUniqRanked(1,a4,1) FROM test.arrays_test;
...
SELECT '1,a3,2,a4,1', arrayEnumerateUniqRanked(1,a3,1,a4,2) FROM test.arrays_test;
SELECT '1,a3,2,a4,1', arrayEnumerateUniqRanked(1,a3,2,a4,2) FROM test.arrays_test;
SELECT '1,a3,2,a4,1', arrayEnumerateUniqRanked(2,a3,2,a4,2) FROM test.arrays_test;
SELECT '1,a3,2,a4,1', arrayEnumerateUniqRanked(2,a3,2,a4,1) FROM test.arrays_test;
SELECT '1,a3,2,a4,1', arrayEnumerateUniqRanked(2,a3,1,a4,2) FROM test.arrays_test;
select '---------END';
