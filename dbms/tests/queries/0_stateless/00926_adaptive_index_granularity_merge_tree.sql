...
SELECT distinct(marks) from system.parts WHERE table = 'zero_rows_per_granule' and database='default' and active=1;
...
SELECT distinct(marks) from system.parts WHERE table = 'two_rows_per_granule' and database='default' and active=1;
...
SELECT distinct(marks) from system.parts WHERE table = 'four_rows_per_granule' and database='default' and active=1;
...
SELECT distinct(marks) from system.parts WHERE table = 'huge_granularity_small_blocks' and database='default' and active=1;
...
SELECT distinct(marks) from system.parts WHERE table = 'adaptive_granularity_alter' and database='default' and active=1;
...
SELECT sum(marks) from system.parts WHERE table = 'adaptive_granularity_alter' and database='default' and active=1;
