...
SELECT i + i, i - i, i * i, i / i FROM test.decimal WHERE i > 0; -- { serverError 405 }
...
SELECT f + 21, f - 21, f - 84, f * 21, f * -21, f / 21, f / 84 FROM test.decimal WHERE f > 0; -- { serverError 405 }
...
SELECT 21 + f, 21 - f, 84 - f, 21 * f, -21 * f, 21 / f, 84 / f FROM test.decimal WHERE f > 0; -- { serverError 405 }
