...
SELECT compression_codec FROM system.columns WHERE database = 'default' AND table = 'alter_compression_codec' AND name = 'alter_column';
...
SELECT compression_codec FROM system.columns WHERE database = 'default' AND table = 'large_alter_table_00804' AND name = 'data';
