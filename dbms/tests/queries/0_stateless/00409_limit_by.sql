...
SELECT dummy FROM remote('localhost,127.0.0.{1,2}', system.one) LIMIT 1 BY dummy;
SELECT dummy FROM remote('localhost,127.0.0.{1,2}', system.one) LIMIT 2 BY dummy;

SELECT 1 as one FROM remote('localhost,127.0.0.{1,2}', system.one) LIMIT 1 BY one;
