DROP USER IF EXISTS u1, u2@hostB, u2@'192.168.0.0/16', u2@'192.168.0.0/255.255.0.0', u2@'192.168.%.%', u3, u4;
...
SHOW CREATE USER u1;
ALTER USER u1 ACCOUNT UNLOCK SETTINGS DEFAULT HOST ANY;
SHOW CREATE USER u1;
CREATE ROLE r1, r2;
GRANT r1,r2 TO u1;
...
DROP USER u1, u2@hostB, u2@'192.168.0.0/16', u2@'192.168.0.0/255.255.0.0', u2@'192.168.%.%', u3, u4;
DROP ROLE r1, r2;
