...
insert into test.test_ins_arr select today(), [number, 42] from system.numbers limit 10000;
...
insert into test.test_ins_null select today(), if(number % 2, number, Null) from system.numbers limit 10000;
...
insert into test.test_ins_arr_null select today(), [if(number % 2, number, Null), number, Null] from system.numbers limit 10000;
...
insert into test.test_ins_arr_arr select today(), [[number],[number + 1, number + 2]] from system.numbers limit 10000;
...
insert into test.test_ins_arr_arr_null select today(), [[1, Null, number], [3, Null, number]] from system.numbers limit 10000;
...
insert into test.test_ins_arr_arr_arr select today(), [[[number]],[[number + 1], [number + 2, number + 3]]] from system.numbers limit 10000;
