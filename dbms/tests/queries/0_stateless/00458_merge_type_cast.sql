...
CREATE TABLE merge_32_64 (x UInt64) ENGINE = Merge(test, '^u32|u64$');
...
CREATE TABLE merge_s64_u64 (x UInt64) ENGINE = Merge(test, '^s64|u64$');
...
CREATE TABLE merge_one_two (x UInt64) ENGINE = Merge(test, '^one$|^two$');
...
CREATE TABLE merge_one_two (x String) ENGINE = Merge(test, '^one$|^two$');
...
CREATE TABLE merge_one_two (x Array(UInt64), z String, y Array(UInt64)) ENGINE = Merge(test, '^one$|^two$');
