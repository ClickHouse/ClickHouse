...
SELECT partition, name FROM system.parts WHERE database = 'default' AND table = 'not_partitioned' AND active ORDER BY name;
...
SELECT 'Parts before OPTIMIZE:';
SELECT partition, name FROM system.parts WHERE database = 'default' AND table = 'partitioned_by_week' AND active ORDER BY name;
...
SELECT 'Parts before OPTIMIZE:';
SELECT partition, name FROM system.parts WHERE database = 'default' AND table = 'partitioned_by_tuple' AND active ORDER BY name;
...
SELECT 'Parts before OPTIMIZE:';
SELECT partition, name FROM system.parts WHERE database = 'default' AND table = 'partitioned_by_string' AND active ORDER BY name;
...
SELECT 'Parts:';
SELECT partition, name, rows FROM system.parts WHERE database = 'default' AND table = 'without_fixed_size_columns' AND active ORDER BY name;
