...
create table distr1 as shard1 engine Distributed (test_cluster_two_shards_localhost, default, shard1, cityHash64(id));
create table distr2 as shard2 engine Distributed (test_cluster_two_shards_localhost, default, shard2, cityHash64(id));
