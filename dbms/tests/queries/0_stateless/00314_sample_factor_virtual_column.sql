...
CREATE TABLE sample_merge_00314 AS sample_00314_1 ENGINE = Merge(default, '^sample_00314_\\d$');

SELECT abs(sum(_sample_factor) - 3000000) / 3000000 < 0.001 FROM sample_merge_00314 SAMPLE 100000;
SELECT abs(sum(_sample_factor) - 3000000) / 3000000 < 0.001 FROM merge(default, '^sample_00314_\\d$') SAMPLE 100000;
