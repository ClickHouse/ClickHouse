...
SELECT distinct(marks) from system.parts WHERE table = 'zero_rows_per_granule1' and database='default' and active=1;

SELECT COUNT(*) FROM zero_rows_per_granule2;

SELECT distinct(marks) from system.parts WHERE table = 'zero_rows_per_granule2' and database='default' and active=1;
...
SELECT distinct(marks) from system.parts WHERE table = 'four_rows_per_granule1' and database='default' and active=1;
...
SELECT distinct(marks) from system.parts WHERE table = 'four_rows_per_granule2' and database='default' and active=1;
...
SELECT distinct(marks) from system.parts WHERE table = 'adaptive_granularity_alter1' and database='default' and active=1;
...
SELECT distinct(marks) from system.parts WHERE table = 'adaptive_granularity_alter2' and database='default' and active=1;
...
SELECT sum(marks) from system.parts WHERE table = 'adaptive_granularity_alter1' and database='default' and active=1;
...
SELECT sum(marks) from system.parts WHERE table = 'adaptive_granularity_alter2' and database='default' and active=1;
