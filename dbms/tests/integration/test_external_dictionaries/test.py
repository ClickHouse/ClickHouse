...
from external_sources import SourceHTTP, SourceHTTPS, SourceCassandra
...
def setup_module(module):
    ...
    node = cluster.add_instance('node', main_configs=main_configs, with_mysql=True, with_mongo=True, with_cassandra=True)
