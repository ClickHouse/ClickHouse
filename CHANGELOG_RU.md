...
* Добавлена системная таблица system.merge_tree_settings Kirill Shvakov
...
* Агрегатная функция `quantileExact` возвращает `nan` в случае агрегации по пустому множеству Float типов.

### Исправление ошибок:
* Убрано излишнее экранирование параметров connection string для ODBC, котрое приводило к невозможности соединения. Ошибка возникла в версии .
...
* Исправлен некорректный код возврата clickhouse-client в случае ошибочного запроса. Ошибка возникла в версии
* #2786
* #2777
* #2795
