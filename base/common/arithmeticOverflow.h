...
namespace common
{
    ...
    template <>
    inline bool addOverflow(int256_t x, int256_t y, int256_t & res)
    {
        // FIXME: mock
        res = x + y;
        return false;
    ...
    template <>
    inline bool subOverflow(int256_t x, int256_t y, int256_t & res)
    {
        // FIXME: mock
        res = x - y;
        return false;
    ...
    template <>
    inline bool mulOverflow(int256_t x, int256_t y, int256_t & res)
    {
        // FIXME: mock
        res = x * y;
        return false;
