...
using TypeListWideInt = TypeList<UInt128, Int128, UInt256, Int256, UInt512, Int512>;
...
using TypeListDecimal = TypeList<Decimal32, Decimal64, Decimal128, Decimal256, Decimal512>;
