...
public:
    ...
    FunctionDelegate(NotifyFunction function) : _function(function) { }

    FunctionDelegate(const FunctionDelegate & delegate) : AbstractDelegate<TArgs>(delegate), _function(delegate._function) { }
    ...
    AbstractDelegate<TArgs> * clone() const { return new FunctionDelegate(*this); }
...
public:
    ...
    FunctionDelegate(const FunctionDelegate & delegate) : AbstractDelegate<void>(delegate), _function(delegate._function) { }
    ...
    AbstractDelegate<void> * clone() const { return new FunctionDelegate(*this); }
