...
#    if defined(POCO_OS_FAMILY_WINDOWS)
// mingw-w64 spells the 16-bit view of `in6_addr` `u.Word` and only defines `s6_addr16`
// itself when building for Cygwin, so define it here; the BSD spelling below does not exist.
