...
This is the replacement for "__cxa_thread_atexit" function provided by your compiler.
It is needed to avoid linking with "__cxa_thread_atexit_impl" function, that require too new (2.18) glibc library.
