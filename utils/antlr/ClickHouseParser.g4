...
columnExpr
    ...
    | columnExpr NOT? BETWEEN (ASYMMETRIC | SYMMETRIC)? columnExpr AND columnExpr        # ColumnExprBetween
...
keyword
    ...
    : ACCESS | ADD | AFTER | ALIAS | ALL | ALTER | AND | ANTI | ANY | ARRAY | AS | ASCENDING | ASOF | AST | ASYNC | ASYMMETRIC | ATTACH | BETWEEN | BOTH | BY | CACHES | CASE
    ...
    | ROWS | SAMPLE | SECOND | SELECT | SEMI | SENDS | SET | SETTING | SETTINGS | SHOW | SOURCE | START | STOP | SUBSTRING | SYMMETRIC | SYNC | SYNTAX | SYSTEM | STEP | TABLE
    ...
    ;
keywordForAlias
    : AFTER | ALIAS | ALTER | AST | ASYNC | ASYMMETRIC | ATTACH | BOTH | CASE | CAST | CHECK | CLEAR | CLUSTER | CODEC
    ...
    | SELECT | SENDS | SET | SHOW | SOURCE | START | STOP | SUBSTRING | SYMMETRIC | SYNC | SYNTAX | SYSTEM | TABLE | TABLES | TEMPORARY
