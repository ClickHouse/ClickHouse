...
(
  ...
  # Remove configs that conflict with or are superseded by our shared catalog setup
  rm -f \
  ...
  # Add our shared catalog setup configs
  cp $SCRIPT_DIR/env/config/database_replicated.xml "$CH_CONFIG_DIR/config.d/"
  cp $SCRIPT_DIR/env/config/shared_catalog_config.xml "$CH_CONFIG_DIR/config.d/"
  cp $SCRIPT_DIR/env/config/clusters.xml "$CH_CONFIG_DIR/config.d/"
  cp $SCRIPT_DIR/env/config/shared_catalog_user.xml "$CH_CONFIG_DIR/users.d/"
