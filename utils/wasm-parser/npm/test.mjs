...
const wasmDir = argValue('--wasm-dir');
...
check('full build has formatting', (Parser.features & 1) !== 0);
check('full build has AST JSON', (Parser.features & 4) !== 0);
...
check('slim build has no formatting', (SlimParser.features & 1) === 0);
