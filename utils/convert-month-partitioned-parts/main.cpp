...
void run(String part_path, String date_column, String dest_path)
{
    ...
    (void)minmax_idx.store(minmax_idx_columns, minmax_idx_column_types, disk, new_tmp_part_path_str, checksums);
    ...
    (void)partition.store(partition_key_sample, disk, new_tmp_part_path_str, checksums);
