...
* Removed the mutation number from a part name in case there were no mutations. This remove fixes compatibility with old versions. [#8250](https://github.com/ClickHouse/ClickHouse/pull/8250) ([alesapin](https://github.com/alesapin))
