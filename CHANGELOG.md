...
* Added system tables: `formats`, `data_type_families`, `aggregate_function_combined`, `table_functions`, `table_engines`, `collections` [#2721](https://github.com/yandex/ClickHouse/pull/2721).
