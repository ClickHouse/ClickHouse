...
DISPATCH_1(double, exp, double)
DISPATCH_1(double, exp2, double)
DISPATCH_1(double, expm1, double)
DISPATCH_1(double, fabs, double)
DISPATCH_1(double, floor, double)
DISPATCH_1(double, log, double)
DISPATCH_1(double, log10, double)
DISPATCH_1(double, log1p, double)
DISPATCH_1(double, log2, double)
DISPATCH_1(double, sin, double)
DISPATCH_1(double, sqrt, double)
DISPATCH_1(double, tan, double)

DISPATCH_1(float, asinf, float)
DISPATCH_1(float, logf, float)
DISPATCH_1(float, sqrtf, float)

DISPATCH_1(long double, ceill, long double)
DISPATCH_1(long double, fabsl, long double)
...
DISPATCH_2(double, pow, double, double)

DISPATCH_2(double, ldexp, double, int)
DISPATCH_2(double, scalbn, double, int)
DISPATCH_2(float, ldexpf, float, int)
DISPATCH_2(long double, ldexpl, long double, int)
DISPATCH_2(long double, scalbnl, long double, int)

DISPATCH_2(long double, copysignl, long double, long double)
DISPATCH_2(long double, fmodl, long double, long double)
