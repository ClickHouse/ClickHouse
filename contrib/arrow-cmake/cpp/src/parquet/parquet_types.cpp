...
EncryptionWithFooterKey::EncryptionWithFooterKey(const EncryptionWithFooterKey& other94) {
  (void) other94;
}
EncryptionWithFooterKey& EncryptionWithFooterKey::operator=(const EncryptionWithFooterKey& other95) {
  (void) other95;
  return *this;
}
...
void EncryptionWithColumnKey::__set_column_key_metadata(const std::string& val) {
  this->column_key_metadata = val;
__isset.column_key_metadata = true;
}
...
uint32_t EncryptionWithColumnKey::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->path_in_schema.resize(_size96);
            uint32_t _i100;
            for (_i100 = 0; _i100 < _size96; ++_i100)
            {
              xfer += iprot->readString(this->path_in_schema[_i100]);
            }
            xfer += iprot->readListEnd();
          }
          isset_path_in_schema = true;
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->column_key_metadata);
          this->__isset.column_key_metadata = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t EncryptionWithColumnKey::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("path_in_schema", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    for (_iter101 = this->path_in_schema.begin(); _iter101 != this->path_in_schema.end(); ++_iter101)
    {
  ...
  if (this->__isset.column_key_metadata) {
    xfer += oprot->writeFieldBegin("column_key_metadata", ::apache::thrift::protocol::T_STRING, 2);
    xfer += oprot->writeBinary(this->column_key_metadata);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(EncryptionWithColumnKey &a, EncryptionWithColumnKey &b) {
  using ::std::swap;
  swap(a.path_in_schema, b.path_in_schema);
  swap(a.column_key_metadata, b.column_key_metadata);
  swap(a.__isset, b.__isset);
}

EncryptionWithColumnKey::EncryptionWithColumnKey(const EncryptionWithColumnKey& other102) {
  path_in_schema = other102.path_in_schema;
  column_key_metadata = other102.column_key_metadata;
  __isset = other102.__isset;
}
EncryptionWithColumnKey& EncryptionWithColumnKey::operator=(const EncryptionWithColumnKey& other103) {
  path_in_schema = other103.path_in_schema;
  column_key_metadata = other103.column_key_metadata;
...
void EncryptionWithColumnKey::printTo(std::ostream& out) const {
  ...
  out << "path_in_schema=" << to_string(path_in_schema);
  out << ", " << "column_key_metadata="; (__isset.column_key_metadata ? (out << to_string(column_key_metadata)) : (out << "<null>"));
  out << ")";
}
...
ColumnCryptoMetaData::ColumnCryptoMetaData(const ColumnCryptoMetaData& other104) {
  ENCRYPTION_WITH_FOOTER_KEY = other104.ENCRYPTION_WITH_FOOTER_KEY;
  ENCRYPTION_WITH_COLUMN_KEY = other104.ENCRYPTION_WITH_COLUMN_KEY;
  __isset = other104.__isset;
}
ColumnCryptoMetaData& ColumnCryptoMetaData::operator=(const ColumnCryptoMetaData& other105) {
  ENCRYPTION_WITH_FOOTER_KEY = other105.ENCRYPTION_WITH_FOOTER_KEY;
  ENCRYPTION_WITH_COLUMN_KEY = other105.ENCRYPTION_WITH_COLUMN_KEY;
...
void ColumnChunk::__set_crypto_meta_data(const ColumnCryptoMetaData& val) {
  this->crypto_meta_data = val;
__isset.crypto_meta_data = true;
}
...
uint32_t ColumnChunk::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 8:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          xfer += this->crypto_meta_data.read(iprot);
          this->__isset.crypto_meta_data = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t ColumnChunk::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.crypto_meta_data) {
    xfer += oprot->writeFieldBegin("crypto_meta_data", ::apache::thrift::protocol::T_STRUCT, 8);
    xfer += this->crypto_meta_data.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(ColumnChunk &a, ColumnChunk &b) {
  ...
  swap(a.crypto_meta_data, b.crypto_meta_data);
  swap(a.__isset, b.__isset);
}

ColumnChunk::ColumnChunk(const ColumnChunk& other106) {
  file_path = other106.file_path;
  file_offset = other106.file_offset;
  meta_data = other106.meta_data;
  offset_index_offset = other106.offset_index_offset;
  offset_index_length = other106.offset_index_length;
  column_index_offset = other106.column_index_offset;
  column_index_length = other106.column_index_length;
  crypto_meta_data = other106.crypto_meta_data;
  __isset = other106.__isset;
}
ColumnChunk& ColumnChunk::operator=(const ColumnChunk& other107) {
  file_path = other107.file_path;
  file_offset = other107.file_offset;
  meta_data = other107.meta_data;
  offset_index_offset = other107.offset_index_offset;
  offset_index_length = other107.offset_index_length;
  column_index_offset = other107.column_index_offset;
  column_index_length = other107.column_index_length;
  crypto_meta_data = other107.crypto_meta_data;
...
void ColumnChunk::printTo(std::ostream& out) const {
  ...
  out << ", " << "crypto_meta_data="; (__isset.crypto_meta_data ? (out << to_string(crypto_meta_data)) : (out << "<null>"));
  out << ")";
}
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->sorting_columns.resize(_size113);
            uint32_t _i117;
            for (_i117 = 0; _i117 < _size113; ++_i117)
            {
              xfer += this->sorting_columns[_i117].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t RowGroup::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("columns", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<ColumnChunk> ::const_iterator _iter118;
  ...
  if (this->__isset.sorting_columns) {
    xfer += oprot->writeFieldBegin("sorting_columns", ::apache::thrift::protocol::T_LIST, 4);
    {
      ...
      std::vector<SortingColumn> ::const_iterator _iter119;
      for (_iter119 = this->sorting_columns.begin(); _iter119 != this->sorting_columns.end(); ++_iter119)
      {
...
RowGroup::RowGroup(const RowGroup& other120) {
  columns = other120.columns;
  total_byte_size = other120.total_byte_size;
  num_rows = other120.num_rows;
  sorting_columns = other120.sorting_columns;
  file_offset = other120.file_offset;
  total_compressed_size = other120.total_compressed_size;
  __isset = other120.__isset;
}
RowGroup& RowGroup::operator=(const RowGroup& other121) {
  columns = other121.columns;
  total_byte_size = other121.total_byte_size;
  num_rows = other121.num_rows;
  sorting_columns = other121.sorting_columns;
  file_offset = other121.file_offset;
  total_compressed_size = other121.total_compressed_size;
...
TypeDefinedOrder::TypeDefinedOrder(const TypeDefinedOrder& other122) {
  (void) other122;
}
TypeDefinedOrder& TypeDefinedOrder::operator=(const TypeDefinedOrder& other123) {
  (void) other123;
  return *this;
}
...
ColumnOrder::ColumnOrder(const ColumnOrder& other124) {
  TYPE_ORDER = other124.TYPE_ORDER;
  __isset = other124.__isset;
}
ColumnOrder& ColumnOrder::operator=(const ColumnOrder& other125) {
  TYPE_ORDER = other125.TYPE_ORDER;
...
PageLocation::PageLocation(const PageLocation& other126) {
  offset = other126.offset;
  compressed_page_size = other126.compressed_page_size;
  first_row_index = other126.first_row_index;
}
PageLocation& PageLocation::operator=(const PageLocation& other127) {
  offset = other127.offset;
  compressed_page_size = other127.compressed_page_size;
  first_row_index = other127.first_row_index;
  return *this;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->page_locations.resize(_size128);
            uint32_t _i132;
            for (_i132 = 0; _i132 < _size128; ++_i132)
            {
              xfer += this->page_locations[_i132].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t OffsetIndex::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("page_locations", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<PageLocation> ::const_iterator _iter133;
    for (_iter133 = this->page_locations.begin(); _iter133 != this->page_locations.end(); ++_iter133)
    {
...
OffsetIndex::OffsetIndex(const OffsetIndex& other134) {
  page_locations = other134.page_locations;
}
OffsetIndex& OffsetIndex::operator=(const OffsetIndex& other135) {
  page_locations = other135.page_locations;
  return *this;
}
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->null_pages.resize(_size136);
            uint32_t _i140;
            for (_i140 = 0; _i140 < _size136; ++_i140)
            {
              xfer += iprot->readBool(this->null_pages[_i140]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->min_values.resize(_size141);
            uint32_t _i145;
            for (_i145 = 0; _i145 < _size141; ++_i145)
            {
              xfer += iprot->readBinary(this->min_values[_i145]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->max_values.resize(_size146);
            uint32_t _i150;
            for (_i150 = 0; _i150 < _size146; ++_i150)
            {
              xfer += iprot->readBinary(this->max_values[_i150]);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->boundary_order = (BoundaryOrder::type)ecast151;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->null_counts.resize(_size152);
            uint32_t _i156;
            for (_i156 = 0; _i156 < _size152; ++_i156)
            {
              xfer += iprot->readI64(this->null_counts[_i156]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ColumnIndex::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("null_pages", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<bool> ::const_iterator _iter157;
    for (_iter157 = this->null_pages.begin(); _iter157 != this->null_pages.end(); ++_iter157)
    {
      xfer += oprot->writeBool((*_iter157));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("min_values", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter158 = this->min_values.begin(); _iter158 != this->min_values.end(); ++_iter158)
    {
  ...
  xfer += oprot->writeFieldBegin("max_values", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter159 = this->max_values.begin(); _iter159 != this->max_values.end(); ++_iter159)
    {
      xfer += oprot->writeBinary((*_iter159));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  if (this->__isset.null_counts) {
    xfer += oprot->writeFieldBegin("null_counts", ::apache::thrift::protocol::T_LIST, 5);
    {
      ...
      for (_iter160 = this->null_counts.begin(); _iter160 != this->null_counts.end(); ++_iter160)
      {
...
ColumnIndex::ColumnIndex(const ColumnIndex& other161) {
  null_pages = other161.null_pages;
  min_values = other161.min_values;
  max_values = other161.max_values;
  boundary_order = other161.boundary_order;
  null_counts = other161.null_counts;
  __isset = other161.__isset;
}
ColumnIndex& ColumnIndex::operator=(const ColumnIndex& other162) {
  null_pages = other162.null_pages;
  min_values = other162.min_values;
  max_values = other162.max_values;
  boundary_order = other162.boundary_order;
  null_counts = other162.null_counts;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->schema.resize(_size163);
            uint32_t _i167;
            for (_i167 = 0; _i167 < _size163; ++_i167)
            {
              xfer += this->schema[_i167].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          isset_schema = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->row_groups.resize(_size168);
            uint32_t _i172;
            for (_i172 = 0; _i172 < _size168; ++_i172)
            {
              xfer += this->row_groups[_i172].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->key_value_metadata.resize(_size173);
            uint32_t _i177;
            for (_i177 = 0; _i177 < _size173; ++_i177)
            {
              xfer += this->key_value_metadata[_i177].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.key_value_metadata = true;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->column_orders.resize(_size178);
            uint32_t _i182;
            for (_i182 = 0; _i182 < _size178; ++_i182)
            {
              xfer += this->column_orders[_i182].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t FileMetaData::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("schema", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<SchemaElement> ::const_iterator _iter183;
    for (_iter183 = this->schema.begin(); _iter183 != this->schema.end(); ++_iter183)
    {
  ...
  xfer += oprot->writeFieldBegin("row_groups", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    std::vector<RowGroup> ::const_iterator _iter184;
    for (_iter184 = this->row_groups.begin(); _iter184 != this->row_groups.end(); ++_iter184)
    {
  ...
  if (this->__isset.key_value_metadata) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->key_value_metadata.size()));
      std::vector<KeyValue> ::const_iterator _iter185;
      for (_iter185 = this->key_value_metadata.begin(); _iter185 != this->key_value_metadata.end(); ++_iter185)
      {
  ...
  if (this->__isset.column_orders) {
    xfer += oprot->writeFieldBegin("column_orders", ::apache::thrift::protocol::T_LIST, 7);
    {
      ...
      std::vector<ColumnOrder> ::const_iterator _iter186;
      for (_iter186 = this->column_orders.begin(); _iter186 != this->column_orders.end(); ++_iter186)
      {
...
FileMetaData::FileMetaData(const FileMetaData& other187) {
  version = other187.version;
  schema = other187.schema;
  num_rows = other187.num_rows;
  row_groups = other187.row_groups;
  key_value_metadata = other187.key_value_metadata;
  created_by = other187.created_by;
  column_orders = other187.column_orders;
  __isset = other187.__isset;
}
FileMetaData& FileMetaData::operator=(const FileMetaData& other188) {
  version = other188.version;
  schema = other188.schema;
  num_rows = other188.num_rows;
  row_groups = other188.row_groups;
  key_value_metadata = other188.key_value_metadata;
  created_by = other188.created_by;
  column_orders = other188.column_orders;
...
void AesGcmV1::__set_aad_metadata(const std::string& val) {
  this->aad_metadata = val;
__isset.aad_metadata = true;
}

void AesGcmV1::__set_iv_prefix(const std::string& val) {
  this->iv_prefix = val;
__isset.iv_prefix = true;
}
...
uint32_t AesGcmV1::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->aad_metadata);
          this->__isset.aad_metadata = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 2:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->iv_prefix);
          this->__isset.iv_prefix = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t AesGcmV1::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.aad_metadata) {
    xfer += oprot->writeFieldBegin("aad_metadata", ::apache::thrift::protocol::T_STRING, 1);
    xfer += oprot->writeBinary(this->aad_metadata);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.iv_prefix) {
    xfer += oprot->writeFieldBegin("iv_prefix", ::apache::thrift::protocol::T_STRING, 2);
    xfer += oprot->writeBinary(this->iv_prefix);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(AesGcmV1 &a, AesGcmV1 &b) {
  using ::std::swap;
  swap(a.aad_metadata, b.aad_metadata);
  swap(a.iv_prefix, b.iv_prefix);
  swap(a.__isset, b.__isset);
}

AesGcmV1::AesGcmV1(const AesGcmV1& other189) {
  aad_metadata = other189.aad_metadata;
  iv_prefix = other189.iv_prefix;
  __isset = other189.__isset;
}
AesGcmV1& AesGcmV1::operator=(const AesGcmV1& other190) {
  aad_metadata = other190.aad_metadata;
  iv_prefix = other190.iv_prefix;
...
void AesGcmV1::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "AesGcmV1(";
  out << "aad_metadata="; (__isset.aad_metadata ? (out << to_string(aad_metadata)) : (out << "<null>"));
  out << ", " << "iv_prefix="; (__isset.iv_prefix ? (out << to_string(iv_prefix)) : (out << "<null>"));
  out << ")";
}
...
void AesGcmCtrV1::__set_aad_metadata(const std::string& val) {
  this->aad_metadata = val;
__isset.aad_metadata = true;
}

void AesGcmCtrV1::__set_gcm_iv_prefix(const std::string& val) {
  this->gcm_iv_prefix = val;
__isset.gcm_iv_prefix = true;
}

void AesGcmCtrV1::__set_ctr_iv_prefix(const std::string& val) {
  this->ctr_iv_prefix = val;
__isset.ctr_iv_prefix = true;
}
...
uint32_t AesGcmCtrV1::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->gcm_iv_prefix);
          this->__isset.gcm_iv_prefix = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 3:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->ctr_iv_prefix);
          this->__isset.ctr_iv_prefix = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t AesGcmCtrV1::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.gcm_iv_prefix) {
    xfer += oprot->writeFieldBegin("gcm_iv_prefix", ::apache::thrift::protocol::T_STRING, 2);
    xfer += oprot->writeBinary(this->gcm_iv_prefix);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.ctr_iv_prefix) {
    xfer += oprot->writeFieldBegin("ctr_iv_prefix", ::apache::thrift::protocol::T_STRING, 3);
    xfer += oprot->writeBinary(this->ctr_iv_prefix);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void swap(AesGcmCtrV1 &a, AesGcmCtrV1 &b) {
  using ::std::swap;
  swap(a.aad_metadata, b.aad_metadata);
  swap(a.gcm_iv_prefix, b.gcm_iv_prefix);
  swap(a.ctr_iv_prefix, b.ctr_iv_prefix);
  swap(a.__isset, b.__isset);
}

AesGcmCtrV1::AesGcmCtrV1(const AesGcmCtrV1& other191) {
  aad_metadata = other191.aad_metadata;
  gcm_iv_prefix = other191.gcm_iv_prefix;
  ctr_iv_prefix = other191.ctr_iv_prefix;
  __isset = other191.__isset;
}
AesGcmCtrV1& AesGcmCtrV1::operator=(const AesGcmCtrV1& other192) {
  aad_metadata = other192.aad_metadata;
  gcm_iv_prefix = other192.gcm_iv_prefix;
  ctr_iv_prefix = other192.ctr_iv_prefix;
...
void AesGcmCtrV1::printTo(std::ostream& out) const {
  ...
  out << "AesGcmCtrV1(";
  out << "aad_metadata="; (__isset.aad_metadata ? (out << to_string(aad_metadata)) : (out << "<null>"));
  out << ", " << "gcm_iv_prefix="; (__isset.gcm_iv_prefix ? (out << to_string(gcm_iv_prefix)) : (out << "<null>"));
  out << ", " << "ctr_iv_prefix="; (__isset.ctr_iv_prefix ? (out << to_string(ctr_iv_prefix)) : (out << "<null>"));
  out << ")";
}
...
EncryptionAlgorithm::EncryptionAlgorithm(const EncryptionAlgorithm& other193) {
  AES_GCM_V1 = other193.AES_GCM_V1;
  AES_GCM_CTR_V1 = other193.AES_GCM_CTR_V1;
  __isset = other193.__isset;
}
EncryptionAlgorithm& EncryptionAlgorithm::operator=(const EncryptionAlgorithm& other194) {
  AES_GCM_V1 = other194.AES_GCM_V1;
  AES_GCM_CTR_V1 = other194.AES_GCM_CTR_V1;
...
void FileCryptoMetaData::__set_encrypted_footer(const bool val) {
  this->encrypted_footer = val;
}

void FileCryptoMetaData::__set_footer_key_metadata(const std::string& val) {
  this->footer_key_metadata = val;
__isset.footer_key_metadata = true;
}

void FileCryptoMetaData::__set_footer_offset(const int64_t val) {
  this->footer_offset = val;
}
...
uint32_t FileCryptoMetaData::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  bool isset_encrypted_footer = false;
  bool isset_footer_offset = false;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->encrypted_footer);
          isset_encrypted_footer = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 3:
        if (ftype == ::apache::thrift::protocol::T_STRING) {
          xfer += iprot->readBinary(this->footer_key_metadata);
          this->__isset.footer_key_metadata = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->footer_offset);
          isset_footer_offset = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
  ...
  if (!isset_encryption_algorithm)
    throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_encrypted_footer)
    throw TProtocolException(TProtocolException::INVALID_DATA);
  if (!isset_footer_offset)
    throw TProtocolException(TProtocolException::INVALID_DATA);
  return xfer;
}
...
uint32_t FileCryptoMetaData::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("encrypted_footer", ::apache::thrift::protocol::T_BOOL, 2);
  xfer += oprot->writeBool(this->encrypted_footer);
  xfer += oprot->writeFieldEnd();

  if (this->__isset.footer_key_metadata) {
    xfer += oprot->writeFieldBegin("footer_key_metadata", ::apache::thrift::protocol::T_STRING, 3);
    xfer += oprot->writeBinary(this->footer_key_metadata);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldBegin("footer_offset", ::apache::thrift::protocol::T_I64, 4);
  xfer += oprot->writeI64(this->footer_offset);
  xfer += oprot->writeFieldEnd();
...
void swap(FileCryptoMetaData &a, FileCryptoMetaData &b) {
  ...
  swap(a.encrypted_footer, b.encrypted_footer);
  swap(a.footer_key_metadata, b.footer_key_metadata);
  swap(a.footer_offset, b.footer_offset);
  swap(a.__isset, b.__isset);
}

FileCryptoMetaData::FileCryptoMetaData(const FileCryptoMetaData& other195) {
  encryption_algorithm = other195.encryption_algorithm;
  encrypted_footer = other195.encrypted_footer;
  footer_key_metadata = other195.footer_key_metadata;
  footer_offset = other195.footer_offset;
  __isset = other195.__isset;
}
FileCryptoMetaData& FileCryptoMetaData::operator=(const FileCryptoMetaData& other196) {
  encryption_algorithm = other196.encryption_algorithm;
  encrypted_footer = other196.encrypted_footer;
  footer_key_metadata = other196.footer_key_metadata;
  footer_offset = other196.footer_offset;
...
void FileCryptoMetaData::printTo(std::ostream& out) const {
  ...
  out << ", " << "encrypted_footer=" << to_string(encrypted_footer);
  out << ", " << "footer_key_metadata="; (__isset.footer_key_metadata ? (out << to_string(footer_key_metadata)) : (out << "<null>"));
  out << ", " << "footer_offset=" << to_string(footer_offset);
  out << ")";
}
