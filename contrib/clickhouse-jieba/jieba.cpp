...
struct HMMModel
{
    static std::vector<State> viterbi(const std::vector<RuneInfo> & runes)
    {
    ...
    static double getEmitProb(size_t state, Rune rune)
    {
    ...
    constexpr std::array<double, STATE_COUNT> start_prob;
    constexpr std::array<std::array<double, STATE_COUNT>, STATE_COUNT> trans_prob;

    constexpr int UNICODE_COUNT = 65536;
    constexpr std::array<std::array<double, UNICODE_COUNT>, STATE_COUNT> emit_probs;
};
