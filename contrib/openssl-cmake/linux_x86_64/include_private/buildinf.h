...
#define DATE "built on: Tue Nov 29 12:56:31 2022 UTC"
...
static const char compiler_flags[] = {
    ...
    '-','W','a',',','-','-','g','e','n','e','r','a','t','e','-','m',
    'i','s','s','i','n','g','-','b','u','i','l','d','-','n','o','t',
    'e','s','=','y','e','s',' ','-','D','P','U','R','I','F','Y',' ',
    ' ','-','D','O','P','E','N','S','S','L','_','U','S','E','_','N',
    'O','D','E','L','E','T','E',' ','-','D','L','_','E','N','D','I',
    'A','N',' ','-','D','O','P','E','N','S','S','L','_','P','I','C',
    ' ','-','D','O','P','E','N','S','S','L','_','B','U','I','L','D',
    'I','N','G','_','O','P','E','N','S','S','L',' ','-','D','Z','L',
    'I','B',' ','-','D','N','D','E','B','U','G',' ','-','D','D','E',
    'V','R','A','N','D','O','M','=','"','\\','"','/','d','e','v','/',
    'u','r','a','n','d','o','m','\\','"','"','\0'
};
