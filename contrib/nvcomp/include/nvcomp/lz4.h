 ...
 */
static const nvcompBatchedLZ4CompressOpts_t nvcompBatchedLZ4CompressDefaultOpts =
  {NVCOMP_TYPE_CHAR, NVCOMP_BITSHUFFLE_NONE, {0}};
...
static const nvcompBatchedLZ4DecompressOpts_t nvcompBatchedLZ4DecompressDefaultOpts =
  {NVCOMP_DECOMPRESS_BACKEND_DEFAULT, 0 /* sort_before_hw_decompress */, NVCOMP_TYPE_CHAR, NVCOMP_BITSHUFFLE_NONE, {0}};
...
/**
 * @brief The maximum supported compressed and decompressed chunk size in bytes for the LZ4 decompressor.
 ...
 * `nvcompSuccess`. If decompression using the CUDA backend is not successful,
 * for example due to the corrupted input or out-of-bound errors, the `device_statuses`
