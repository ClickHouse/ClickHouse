...
public:
  ...
  virtual void enterVectorMatchOp(PromQLParser::VectorMatchOpContext * /*ctx*/) override { }
  virtual void exitVectorMatchOp(PromQLParser::VectorMatchOpContext * /*ctx*/) override { }
