...
To reproduce the query-log results in this guide, run one or more of the [example workload queries](/guides/clickhouse/performance-and-monitoring/query-optimization-example#establish-the-baseline) at least twice after loading the dataset. Then flush the query log so that the completed runs are available to the examples below:
