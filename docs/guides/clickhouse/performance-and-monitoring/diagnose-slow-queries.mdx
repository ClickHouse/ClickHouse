...
After selecting a pattern, inspect its individual executions. For example, the following query lists the five longest-running queries on the NYC Taxi dataset:
