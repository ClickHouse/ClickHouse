...
Begin with a recurring slow-query pattern and a representative historical execution identified using [Diagnose slow queries](/guides/clickhouse/performance-and-monitoring/diagnose-slow-queries). You should have the complete query, a bounded dataset and time range, and its initial duration and resource measurements. This guide turns that historical diagnosis into controlled comparison runs.
