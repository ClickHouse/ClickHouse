...
For that we first need to copy the primary index file into the [user_files_path](/reference/settings/server-settings/settings#user_files_path) of a node from the running cluster:
