...
| Format versions | ⚠️ Partial | ⚠️ Partial | v1 and v2 are supported. v3 support is partial; experimental deletion vector reads require `allow_iceberg_deletion_vectors = 1`; manifest compaction isn't supported. |
| Column statistics | ✅ | ✅ | |
