...
| Expire snapshots | <Tooltip tip="Contact Support for availability">⚠️</Tooltip> | ⚠️ | Experimental. Requires Iceberg v2, `allow_insert_into_iceberg = 1`, and `allow_expire_snapshots = 1`. See [Expire snapshots](/reference/functions/table-functions/iceberg#iceberg-expire-snapshots). |
