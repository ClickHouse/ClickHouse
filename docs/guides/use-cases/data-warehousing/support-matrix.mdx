...
| Named collections | ❌ | ✅ | [Named collections aren't supported in ClickHouse Cloud](/whats-new/cloud-compatibility#named-collections). |
|  |  |  |  |
| **Read features** | | | |
...
| **Write features** | | | |
| `INSERT` | ✅ Beta | ✅ Beta | Requires `allow_delta_lake_writes = 1` from v26.7; on earlier versions, use `allow_experimental_delta_lake_writes = 1`. See [Delta Lake writes](/reference/functions/table-functions/deltalake#inserting-data). |
...
| Named collections | ❌ | ⚠️ | Experimental. [Named collections aren't supported in ClickHouse Cloud](/whats-new/cloud-compatibility#named-collections). |
| **Read features** | | | |
...
| Snapshot and incremental reads | <Tooltip tip="Contact Support for availability">⚠️</Tooltip> | ⚠️ | Experimental. Table engine only. See [Paimon engine capabilities](/reference/engines/table-engines/integrations/paimon#capabilities). |
| Partition pruning | <Tooltip tip="Contact Support for availability">⚠️</Tooltip> | ⚠️ | Experimental. Enabled with `use_paimon_partition_pruning`. |
| Schema evolution | ❌ | ❌ | Not supported |
| Time travel | ❌ | ❌ | Not supported |
...
| **Caching** | | | |
| Data caching | ❌ | ❌ | Not supported |
| Metadata caching | <Tooltip tip="Contact Support for availability">⚠️</Tooltip> | ⚠️ | Experimental. Controlled by `use_paimon_metadata_files_cache`. See [Paimon settings](/reference/engines/table-engines/integrations/paimon#settings). |
