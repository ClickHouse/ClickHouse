...
To upgrade ClickHouse to a specific release, replace `xx.yy.a.b` in the following example with a version listed on the [ClickHouse releases page](https://github.com/ClickHouse/ClickHouse/releases):
