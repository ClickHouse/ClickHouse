...
| `commit_logs_cache_size_threshold` | Deprecated, has no effect. Use `log_readahead_commit_window_bytes` instead.                                                                                                                              | -                                                                                                            |
...
| `log_readahead_eviction_timeout_ms`| Idle timeout after which an inactive per-peer read-ahead reader is evicted.                                                                                                                              | `30000`                                                                                                      |
...
which are kept only for config compatibility and now have no effect. The same read-ahead mechanism
also serves follower replication catch-up reads when `log_readahead_enabled` is `true`; see
