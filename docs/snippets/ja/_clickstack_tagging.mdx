...
<div className="ch-image-md">
  <Frame>
    <img src="/images/use-cases/observability/clickstack-tags-search.webp" alt="保存済み検索内のタグ" />
  </Frame>
</div>
...
<div className="ch-image-md">
  <Frame>
    <img src="/images/use-cases/observability/clickstack-tags-dashboard.webp" alt="ダッシュボードで複数のタグを選択" />
  </Frame>
</div>