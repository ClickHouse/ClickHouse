    ...
    <div className="ch-agent-prompt-wrapper" data-mdast="ignore">
      <div className="ch-agent-prompt-main-row">
        ...
        <button
          ...
          onClick={handleCopy}
          aria-label={copied ? "コピーしました" : "プロンプトをコピー"}
        >
          {copied ? (
          ...
          <span style={{ display: "grid", justifyItems: "center" }}>
            <span style={{ gridArea: "1 / 1", visibility: copied ? "hidden" : "visible" }}>プロンプトをコピー</span>
            <span style={{ gridArea: "1 / 1", visibility: copied ? "visible" : "hidden" }}>コピーしました</span>
          </span>
        </button>
      </div>
