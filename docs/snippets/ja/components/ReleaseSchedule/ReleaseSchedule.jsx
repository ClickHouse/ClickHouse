      ...
      <thead>
        <tr>
          ...
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href="/manage/updates#fast-release-channel-early-upgrades">高速チャネル</a>
          </th>
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href="/manage/updates#regular-release-channel">標準チャネル</a>
          </th>
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href="/manage/updates#slow-release-channel-deferred-upgrades">低速チャネル</a>
          </th>
        </tr>
        <tr>
