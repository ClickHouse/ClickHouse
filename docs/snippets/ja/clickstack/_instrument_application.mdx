...
## アプリケーションをインストルメントする {#instrument-the-application}
...
### Node SDK をインストールする {#install-node-sdk}

        ```bash
        npm install @hyperdx/node-opentelemetry
        ```

### run.sh でラッパーを有効にする {#enable-run-sh-wrapper}
...
### ブラウザ SDK を有効にする {#enable-browser-sdk}
