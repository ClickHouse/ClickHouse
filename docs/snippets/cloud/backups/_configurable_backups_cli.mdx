...
Frequency determines the worst-case age of the newest restore point (your RPO). Retention controls how long backup data is kept; it does not make the newest restore point more recent. For example, with a retention of 24 hours and a frequency of 48 hours, the newest restore point can be almost 48 hours old.
