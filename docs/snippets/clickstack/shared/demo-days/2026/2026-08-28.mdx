...
Dashboard variables went out to production this week. The feature toggle is gone, and the [public docs](/clickstack/managed/features/dashboards/overview#dashboard-variables) cover the reference forms and macros.
