...
If you would like to test the Kafka logs integration before configuring your own existing setup, you can test with our preconfigured setup and sample data in the ["Demo dataset"](./kafka-logs#demo-dataset) section.
...
<Frame>
  <img src="/images/clickstack/kafka/logs/search-view.webp" alt="Search view" />
</Frame>
</div>

<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/kafka/logs/log-view.webp" alt="Log view" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/import-dashboard.webp" alt="Import Dashboard" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/kafka/logs/finish-import.webp" alt="Finish importing Kafka logs dashboard" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/kafka/logs/example-dashboard.webp" alt="Kafka Logs example dashboard" />
</Frame>
</div>
</Step>
</Steps>
...
- Set up [alerts](../features/alerts) for critical events (broker failures, replication errors, consumer group issues)
- Combine with [Kafka Metrics](./kafka-metrics) for comprehensive Kafka monitoring
- Create additional [dashboards](../features/dashboards/overview) for specific use cases (controller events, partition reassignment)

## Going to production {#going-to-production}

This guide extends ClickStack's built-in OpenTelemetry Collector for quick setup. For production deployments, we recommend running your own OTel Collector and sending data to ClickStack's OTLP endpoint. See [Sending OpenTelemetry data](../ingesting-data/opentelemetry) for production configuration.
