...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/systemd/systemd-search-view.webp" alt="Log search view" />
</Frame>
</div>

<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/systemd/systemd-log-view.webp" alt="Log view" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/systemd/finish-import-systemd.webp" alt="Finish import" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/systemd/systemd-logs-dashboard.webp" alt="Example dashboard" />
</Frame>
</div>
...
- Set up [alerts](../features/alerts) for critical system events (service failures, authentication failures, OOM kills)
- Create additional [dashboards](../features/dashboards/overview) for specific use cases (SSH security monitoring, service health)
...
See [Ingesting with OpenTelemetry](../ingesting-data/opentelemetry) for production deployment patterns.
