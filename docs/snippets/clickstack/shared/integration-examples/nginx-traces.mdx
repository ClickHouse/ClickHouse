...
If you would like to test the integration before configuring your own existing setup, you can test with our preconfigured setup and sample data in the [following section](./nginx-traces#demo-dataset).
...
<Frame>
  <img src="/images/clickstack/nginx-traces-search-view.webp" alt="View Traces" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/finish-nginx-traces-dashboard.webp" alt="Finish Import" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/nginx-traces-dashboard.webp" alt="Example Dashboard" />
</Frame>
</div>
</Step>
</Steps>
...
This guide sends traces directly from the Nginx OpenTelemetry module to ClickStack's OTLP endpoint. For production deployments, we recommend running your own OTel Collector as a gateway to provide batching and resilience. See [Sending OpenTelemetry data](../ingesting-data/opentelemetry) for production configuration.
