...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/kafka/import-kafka-dashboard.webp" alt="Finish import dialog" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/kafka/kafka-metrics-dashboard.webp" alt="Kafka Metrics dashboard" />
</Frame>
</div>
...
- Set up [alerts](../features/alerts) for critical metrics (under-replicated partitions, consumer lag growth, request latency spikes)
