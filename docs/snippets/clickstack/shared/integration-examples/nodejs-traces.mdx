...
Install the `@hyperdx/node-opentelemetry` package and initialize it at the start of your application. See the [Node.js SDK guide](../ingesting-data/sdks/nodejs#getting-started) for detailed installation steps.
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/nodejs/traces-search-view.webp" alt="Traces search view" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/nodejs/trace-view.webp" alt="Individual trace view" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/nodejs/finish-import.webp" alt="Finish import" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/nodejs/example-traces-dashboard.webp" alt="Example dashboard" />
</Frame>
</div>
...
- Set up [alerts](../features/alerts) for critical metrics (error rates, latency thresholds)
...
See [Ingesting with OpenTelemetry](../ingesting-data/opentelemetry) for production deployment patterns and collector configuration examples.
