...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/postgres/import-dashboard.webp" alt="Finish import dialog" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/postgres/postgres-metrics-dashboard.webp" alt="PostgreSQL metrics dashboard" />
</Frame>
</div>
...
- Set up [alerts](../features/alerts) for critical thresholds (connection limits, high rollback rates, low cache hit ratios)
