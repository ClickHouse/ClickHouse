...
If you would like to test the MySQL logs integration before configuring your own existing setup, you can test with our preconfigured setup and sample data in the ["Demo dataset"](./mysql#demo-dataset) section.
...
<Frame>
  <img src="/images/clickstack/mysql/search-view.webp" alt="Search view" />
</Frame>
</div>

<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/mysql/log-view.webp" alt="Log view" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/mysql/finish-import.webp" alt="Finish import" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/mysql/example-dashboard.webp" alt="Example dashboard" />
</Frame>
</div>
...
- Set up [alerts](../features/alerts) for critical events (connection failures, slow queries exceeding thresholds, error spikes)
