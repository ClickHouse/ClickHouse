...
If you would like to test the Redis integration before configuring your own existing setup, you can test with our preconfigured setup and sample data in the ["Demo dataset"](./redis-logs#demo-dataset) section.
...
<Frame>
  <img src="/images/clickstack/redis/redis-log-view.webp" alt="Log view" />
</Frame>
</div>

<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/redis/redis-log.webp" alt="Log" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/redis/redis-import-dashboard.webp" alt="Finish Import" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/redis/redis-logs-dashboard.webp" alt="Example Dashboard" />
</Frame>
</div>
</Step>
</Steps>
...
- Create additional [dashboards](../features/dashboards/overview) for specific use cases (API monitoring, security events)
