...
If you would like to test the MongoDB integration before configuring your own existing setup, you can test with our preconfigured setup and sample data in the ["Demo dataset"](./mongodb-logs#demo-dataset) section.
...
<Frame>
  <img src="/images/clickstack/mongodb/search-view.webp" alt="MongoDB logs search view" />
</Frame>
</div>

<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/mongodb/log-view.webp" alt="MongoDB log detail view" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/mongodb/finish-import.webp" alt="Finish importing MongoDB logs dashboard" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/mongodb/example-dashboard.webp" alt="MongoDB logs dashboard" />
</Frame>
</div>
</Step>
</Steps>
...
- Set up [alerts](../features/alerts) for critical events (error spikes, slow query thresholds)
- Create additional [dashboards](../features/dashboards/overview) for specific use cases (replica set monitoring, connection tracking)
