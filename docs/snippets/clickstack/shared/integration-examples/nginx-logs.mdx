...
If you would like to test the integration before configuring your own existing setup, you can test with our preconfigured setup and sample data in the [following section](./nginx-logs#demo-dataset).
...
<Frame>
  <img src="/images/clickstack/nginx-logs-search-view.webp" alt="Log view" />
</Frame>
</div>

<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/log-view.webp" alt="Log view" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/finish-nginx-logs-import.webp" alt="Finish Import" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/nginx-logs-dashboard.webp" alt="Example Dashboard" />
</Frame>
</div>
</Step>
</Steps>
