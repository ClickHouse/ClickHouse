...
If you would like to test the EC2 host logs integration before configuring your production instance, you can test with our preconfigured setup and sample data in the ["Demo dataset"](./ec2#demo-dataset) section.
...
<Frame>
  <img src="/images/clickstack/host-logs/ec2/search-view.webp" alt="EC2 logs search view" />
</Frame>
</div>
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/host-logs/ec2/log-view.webp" alt="EC2 log detail showing metadata" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/host-logs/ec2/search-view-demo.webp" alt="EC2 logs search view" />
</Frame>
</div>
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/host-logs/ec2/log-view-demo.webp" alt="EC2 log detail with metadata" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/host-logs/import-dashboard.webp" alt="Finish import" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/host-logs/host-logs-dashboard.webp" alt="EC2 logs dashboard" />
</Frame>
</div>
...
- Set up [alerts](../../features/alerts) for critical system events (service failures, authentication failures, disk warnings)
