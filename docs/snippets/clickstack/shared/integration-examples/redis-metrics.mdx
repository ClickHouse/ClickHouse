...
<Frame>
  <img src={metrics_view} alt="Redis Metrics view" />
</Frame>
</div> */}
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/import-redis-metrics-dashboard.webp" alt="Finish import dialog" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/redis-metrics-dashboard.webp" alt="Redis Metrics dashboard" />
</Frame>
</div>
...
- Set up [alerts](../features/alerts) for critical metrics (memory usage thresholds, connection limits, cache hit rate drops)
