...
<Frame>
  <img src="/images/clickstack/temporal/temporal-metrics.webp" alt="Temporal Metrics" />
</Frame>
</div>
</Step>
</Steps>
...
<Frame>
  <img src="/images/clickstack/import-dashboard.webp" alt="Import dashboard button" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/temporal/import-temporal-metrics-dashboard.webp" alt="Finish import dialog" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/temporal/temporal-metrics-dashboard.webp" alt="Temporal Metrics dashboard" />
</Frame>
</div>
</Step>
</Steps>
...
- Set up [alerts](../features/alerts) for critical metrics (workflow failure rates, task backlog growth, schedule-to-start latency)
