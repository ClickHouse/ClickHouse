...
<Frame>
  <img src="/images/clickstack/cloudflare/clickpipe-s3.webp" alt="Clickpipe s3" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/continuous-ingestion.webp" alt="Continuous ingestion" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/parse-information.webp" alt="Parse information" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/add-source.webp" alt="Add source" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/configure-optional-fields.webp" alt="Configure optional" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/save-source.webp" alt="Save source" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/search-view.webp" alt="Search view" />
</Frame>
</div>

<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/log-view.webp" alt="Log view" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/import-dashboard.webp" alt="Import dashboard" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/finish-import.webp" alt="Import dashboard" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudflare/example-dashboard.webp" alt="Example dashboard" />
</Frame>
</div>
...
- Set up [alerts](../features/alerts) for security events (WAF blocks, bot traffic spikes, error rate thresholds)
- Optimize [retention policies](../managing/ttl) based on your data volume
