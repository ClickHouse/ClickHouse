...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudwatch/log-search-view.webp" alt="Log Search View" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudwatch/error-log-column-values.webp" alt="Error Log Column Values" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudwatch/demo-search-view.webp" alt="Demo search view" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudwatch/finish-import.webp" alt="Finish import dialog" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/cloudwatch/logs-dashboard.webp" alt="CloudWatch Logs dashboard" />
</Frame>
</div>
...
- Set up [alerts](../features/alerts) for critical events (connection failures, error spikes)
