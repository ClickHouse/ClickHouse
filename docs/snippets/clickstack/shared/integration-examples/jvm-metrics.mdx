...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/jvm/jvm-metrics-import.webp" alt="Finish import" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/jvm/jvm-metrics-dashboard.webp" alt="Kafka Metrics dashboard" />
</Frame>
</div>
...
- Set up [alerts](../features/alerts) for critical metrics like high heap usage, frequent GC pauses, or thread exhaustion
