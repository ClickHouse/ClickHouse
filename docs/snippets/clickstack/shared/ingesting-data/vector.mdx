...
This guide focuses on onboarding data into ClickStack using Vector for both ClickStack and ClickHouse Observability. For simplicity, it doesn't cover Vector sources or pipeline configuration in depth. Instead, it focuses on configuring the **sink** that writes data into ClickHouse and ensuring the resulting schema is compatible with ClickStack.
...
The following guide assumes you have already created a ClickHouse Observability service and recorded your service credentials. If you haven't, follow the [Getting Started](/clickstack/getting-started/managed) guide for ClickHouse Observability until promoted to configure Vector.
...
<Note>
The example above uses the default user for ClickHouse Observability. For production deployments, we recommend [creating a dedicated ingestion user](./collector#creating-an-ingestion-user) with appropriate permissions and limits.
</Note>
</Step>
<Step title="Navigate to the ClickStack UI" id="navigate-to-clickstack-ui">

Navigate to your ClickHouse Observability service and select "ClickStack" from the left-hand menu. If you’ve already completed the onboarding, this will launch the ClickStack UI in a new tab, and you will be automatically authenticated. If not, you can proceed through the onboarding and select “Launch ClickStack” once you’ve selected Vector as your input source.

<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/launch-clickstack-vector.webp" alt="Launch ClickStack for vector" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/create-vector-datasource.webp" alt="Create datasource - vector" />
</Frame>
</div>
...
For other possible options, see the [configuration reference](../managing/config).
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/nginx-logs-vector-search.webp" alt="Nginx logs in CLickStack" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/play-ui-clickstack.webp" alt="Play UI ClickStack" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-login.webp" alt="ClickStack login" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/create-vector-datasource-oss.webp" alt="Create datasource - vector" />
</Frame>
</div>
...
<VectorSampleData nginxLogsUrl="../integration-examples/nginx-logs#configure-nginx" />
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/nginx-logs-vector-search.webp" alt="HyperDX UI" />
</Frame>
</div>
</Step>
</Steps>
...
The following guide assumes you have set up ClickStack with the [Getting Started guide](/clickstack/getting-started/oss).
