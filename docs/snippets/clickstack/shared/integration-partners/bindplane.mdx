...
- ClickStack API Ingestion Key (found in ClickStack Team Settings > API Keys, [view docs here for reference](../ingesting-data/opentelemetry#sending-otel-data))
...
<Frame>
  <img src="/images/clickstack/bindplane/bindplane-configuration.webp" alt="Telemetry Signals in ClickStack via Bindplane" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/bindplane/bindplane-hyperdx.webp" alt="Telemetry Signals in ClickStack via Bindplane" />
</Frame>
</div>
</Step>
</Steps>
