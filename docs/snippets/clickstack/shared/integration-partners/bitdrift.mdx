...
<Frame>
  <img src="/images/clickstack/bitdrift/bitdrift-user-journey-dashboard.png" alt="A bitdrift User Journey dashboard showing paths to an ANR" />
</Frame>
</div>
...
- **ClickStack** installed and reachable from your backend services, either self-managed or on ClickHouse Cloud. See [Getting started with open source ClickStack](/clickstack/getting-started/oss) or [Getting started with ClickHouse Observability](/clickstack/getting-started/managed).
- Your backend services instrumented with **OpenTelemetry** and sending traces to ClickStack. See [Ingesting with OpenTelemetry](../ingesting-data/opentelemetry).
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/bitdrift/bitdrift-view-trace.jpg" alt="A bitdrift trace linking to a distributed trace in the ClickStack UI" />
</Frame>
</div>
