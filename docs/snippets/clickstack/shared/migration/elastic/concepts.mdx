...
In ClickStack, [the UI provides a Lucene-compatible search interface](../../features/search) for ease of transition, alongside full SQL support via the ClickHouse backend. This syntax is comparable to the [Elastic query string](https://www.elastic.co/docs/reference/query-languages/query-dsl/query-dsl-query-string-query#query-string-syntax) syntax. For an exact comparison of this syntax, see ["Searching in ClickStack and Elastic"](./search).
...
<Frame>
  <img src="/images/use-cases/observability/elasticsearch.webp" alt="Elasticsearch" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/clickhouse.webp" alt="ClickHouse" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/clickhouse-execution.webp" alt="ClickHouse execution" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/elasticsearch-execution.webp" alt="Elasticsearch execution" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/es-transforms.webp" alt="Elasticsearch transforms" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/ch-mvs.webp" alt="ClickHouse Materialized Views" />
</Frame>
</div>
