...
- A running ClickStack instance (see [Deployment](./deployment/overview) for setup options)
- A **Personal API Access Key** — find yours in HyperDX under **Team Settings → API Keys → Personal API Access Key**

<div className="ch-image-md">
<Frame>
  <img src="/images/clickstack/api-key-personal.webp" alt="Personal API Access Key in Team Settings"  border />
</Frame>
</div>
