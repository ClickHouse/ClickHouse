...
ClickStack also supports creating charts from natural language prompts using the [text-to-chart](../../text-to-chart) feature. Describe what you want to see, and ClickStack generates the visualization automatically.
</Tip>
...
<Frame>
  <img src="/images/use-cases/observability/clickstack-visualization-1.webp" alt="Chart Explorer" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/clickstack-visualization-2.webp" alt="Simple visualization" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/clickstack-visualization-3.webp" alt="Simple visualization 2" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/clickstack-duplicate-series.webp" alt="The Duplicate series copy icon and its tooltip on a chart series row" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-1.webp" alt="Create Dashboard" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-2.webp" alt="Create Dashboard Visualization" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-3.webp" alt="Dashboard with visuals" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-4.webp" alt="Dashboard Visualization 2" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-5.webp" alt="Dashboard with visuals 2" />
</Frame>
</div>
</Step>
...
2. Choose the `Heatmap` visualization type from the top menu. The data source dropdown only shows sources whose [source type is `Traces`](../../managing/config#traces). Logs, metrics, and session sources are filtered out, since heatmaps need a span duration column that only traces sources provide.
...
To customize the heatmap further, click **Display Settings** to open a drawer for the **Scale** (Log or Linear), **Value**, and **Count** expression. The full list of options are documented in [Customize the heatmap](../event-deltas#customize) on the Event Deltas page. The same drawer is reused.

Click `Run` to preview the chart, then `Save`.

<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/heatmap-tile-editor.webp" alt="Heatmap tile editor with span duration defaults pre-filled, ServiceName payment filter, and Display Settings button" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/heatmap-tile-rendered.webp" alt="Heatmap dashboard tile showing payment service span duration distribution over 24 hours" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/heatmap-tile-drilldown.webp" alt="Heatmap cell click revealing the View in Event Deltas action" />
</Frame>
</div>

Selecting it opens the [Event Deltas](../event-deltas) view with the tile's data source, `Where` clause, and time range carried over. From there you can examine the same distribution interactively, slice by attribute to see what makes the slow spans different from the fast ones, and inspect the individual spans behind any cell, without rebuilding the query by hand.
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-filter.webp" alt="Dashboard with filtering" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-save.webp" alt="Dashboard save" />
</Frame>
</div>
</Step>
</Steps>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-edit.webp" alt="Dashboard edit" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/number-tile-background-chart.webp" alt="Display Settings drawer for a number tile, with Background chart set to Area" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/table-tile-display-settings.webp" alt="Display Settings drawer for a table tile, with Alternate Row Background turned on" />
</Frame>
</div>
...
`color` accepts any token from the categorical and semantic lists above (for example `chart-blue` or `chart-success`). Optional `backgroundChart.color` overrides the sparkline color with the same token enum. See the [ClickStack API reference](../../api-reference) for authentication and base URLs.
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-search.webp" alt="Dashboard search" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/filter-dropdown.webp" alt="Services dropdown filter showing available service names" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/edit-filters.webp" alt="Edit Filters button in the dashboard toolbar" />
</Frame>
</div>
</Step>
...
<Frame>
  <img src="/images/clickstack/dashboards/add-filter.webp" alt="Add filter dialog with Display Name, Data source, and Filter expression fields" />
</Frame>
</div>
...
<div className="ch-image-md">
<Frame>
  <img src="/images/clickstack/dashboards/saved-filters.webp" alt="Filters modal showing a configured Services filter" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/filtered-dashboard.webp" alt="Dashboard filtered to the frontend service" />
</Frame>
</div>
</Step>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/save-filter-values.webp" alt="Dashboard menu showing Save Query and Filters as Default option" />
</Frame>
</div>
</Step>
</Steps>
...
Chart builder tiles pick up broadcast filters automatically. Raw SQL tiles must include the [`$__filters` macro](./sql-visualizations#dashboard-filter-macro) and have a source selected, since ClickStack cannot infer where the condition belongs in a hand-written query.
...
See [SQL-based visualizations](./sql-visualizations#dashboard-variables) for the full list of macros available to SQL tiles.
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/dashboards/drilldown.webp" alt="Drilldown context menu showing View All Events and Filter by group options" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-clickhouse.webp" alt="ClickHouse dashboard" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/use-cases/observability/hyperdx-dashboard-services.webp" alt="ClickHouse services" />
</Frame>
</div>
