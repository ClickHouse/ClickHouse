...
<Frame>
  <img src="/images/clickstack/event-deltas/overview.webp" alt="Event deltas overview on the payment service with the bright band climbing mid-window and no recovery in frame" />
</Frame>
</div>
...
Event deltas require a **Trace** data source with a duration expression. Any OpenTelemetry-instrumented service producing span data works.
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/event-deltas/before-after.webp" alt="Comparison mode on the payment service with the rectangle drawn from the climb inflection to the right edge, bottom resting on the 1 ms baseline" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/event-deltas/slow-vs-fast.webp" alt="Slow vs fast comparison on frontend-proxy with the rectangle covering only the cleanly-separated upper band, well clear of the dense bulk" />
</Frame>
</div>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/event-deltas/drill-down.webp" alt="Click popover on a ScopeVersion bar showing Selection vs Background percentages and filter, exclude, copy actions" />
</Frame>
</div>
...
<Note>
Aggregated **Other (N)** buckets that collapse low-frequency values aren't clickable. To filter for a specific value within that bucket, use the [search bar](./search) directly.
</Note>
...
<div className="ch-image-lg">
<Frame>
  <img src="/images/clickstack/event-deltas/settings-drawer.webp" alt="Display Settings drawer with Scale, Value, and Count fields" />
</Frame>
</div>
...
The same heatmap is also available as a [dashboard tile](./dashboards/overview#create-a-tile-heatmap), which is useful when you want to monitor the distribution shape over time outside the Event Deltas drill-down flow.
</Tip>
