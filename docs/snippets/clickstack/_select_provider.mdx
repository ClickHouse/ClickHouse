...
Once you have specified the requirements, your ClickHouse Observability service will take several minutes to provision. Feel free to explore the rest of the [ClickHouse Cloud console](/products/cloud/getting-started/intro) whilst waiting for provisioning.
