...
<div className="ch-image-md">
  <Frame>
    <img src="/images/bestpractices/simple_merges.webp" alt="Fusiones simples" />
  </Frame>
</div>
...
Normalmente, ClickHouse evita fusionar partes de más de ~150 GB (configurable mediante [max&#95;bytes&#95;to&#95;merge&#95;at&#95;max&#95;space&#95;in&#95;pool](/es/reference/settings/merge-tree-settings/max-bytes#max_bytes_to_merge_at_max_space_in_pool)). Pero `OPTIMIZE FINAL` **ignora esta salvaguarda**, lo que significa que:
