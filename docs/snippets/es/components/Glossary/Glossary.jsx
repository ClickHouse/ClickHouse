    ...
    <div className="not-prose glossary-browser">
      <div className="glossary-search-row">
        ...
        <div className="glossary-search-wrap">
          ...
          <input id="glossary-search" type="search" value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Buscar términos y definiciones..." autoComplete="off" />
        </div>
        <span className="glossary-count" aria-live="polite">
          {visibleEntries.length} {visibleEntries.length === 1 ? "término" : "términos"}
        </span>
      </div>
      ...
      {visibleEntries.length > 0 ? (
        ...
        <div className="glossary-empty">
          <p>Ningún término del glosario coincide con «{query}».</p>
