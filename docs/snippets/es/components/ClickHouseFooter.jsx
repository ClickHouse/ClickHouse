    ...
    <div className="flex flex-col bg-neutral-900 pb-8 pt-16 -mx-[100vw] px-[100vw] mt-20">
      <div className="mx-auto w-full max-w-7xl justify-between gap-8 pb-11 md:flex lg:gap-10">
        <div className="flex w-full flex-col">
          <div className="sitemap flex flex-col gap-y-8 lg:flex-row lg:gap-x-3">
            ...
            <div className="flex flex-col lg:w-4/12">
              <h3 className="mb-3 font-inter text-sm font-semibold text-neutral-100">Productos</h3>
            ...
            {/* Community Column */}
            <div className="flex flex-col lg:w-4/12">
              <h3 className="mb-3 font-inter text-sm font-semibold text-neutral-100">Únete a nuestra comunidad</h3>
              <ul className="flex flex-col gap-y-2">
                <li>
            ...
            <div className="flex flex-col lg:w-4/12">
              <h3 className="mb-3 font-inter text-sm font-semibold text-neutral-100">Comparaciones</h3>
              <ul className="flex flex-col gap-y-2">
                <li>
              ...
              <h3 className="mb-3 mt-8 font-inter text-sm font-semibold text-neutral-100">Socios</h3>
              <ul className="flex flex-col gap-y-2">
                <li>
        ...
        <div className="flex flex-col pt-12 md:w-fit md:pt-0 md:min-w-[300px]">
          ...
          <div className="mb-4 text-sm text-neutral-400">¡Mantente al día sobre nuevas funcionalidades, hoja de ruta del producto, soporte y ofertas en la nube!</div>
      ...
      <div className="flex flex-col items-start pt-8">
        <div className="mx-auto w-full max-w-7xl flex flex-col items-center gap-3 pt-4 text-center text-sm text-neutral-400 sm:gap-1 md:flex-row md:justify-between md:pt-0 md:text-left">
          <div>© {new Date().getFullYear()} ClickHouse, Inc. Sede central en Bay Area, CA y Ámsterdam, NL.</div>
