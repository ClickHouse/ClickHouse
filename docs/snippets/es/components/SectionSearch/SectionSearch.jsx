export const SectionSearch = ({ section = "/reference/statements", label = "Sentencias", placeholder = "Buscar en esta sección..." }) => {
  ...
  useEffect(() => {
    ...
    // La fuente *.mintlify.app heredada exponía las páginas en la raíz del host, mientras que
    // la fuente *.mintlify.site incluye un prefijo /docs.
