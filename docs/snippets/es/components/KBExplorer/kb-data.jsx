export const kbIndex = {
  ...
  articles: [
    ...
    },
    {
      ...
      description: "Una base de datos columnar almacena los datos de cada columna de forma independiente. Esto permite leer datos del disco únicamente para las columnas que se utilizan en cada consulta.",
