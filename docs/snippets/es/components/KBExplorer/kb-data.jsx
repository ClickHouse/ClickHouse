export const kbIndex = {
  ...
  "articles": [
    ...
    },
    {
      ...
      "description": "Este artículo explica cómo resolver el error DB::Exception relacionado con partes que se intersectan en ClickHouse, generalmente causado por una condición de carrera o intervención manual en los datos de ZooKeeper.",
    ...
    },
    {
      ...
      "description": "Esta guía muestra cómo recopilar y visualizar trazas de consultas en ClickHouse autogestionado mediante métodos integrados o usando Grafana. Resulta especialmente útil cuando se trabaja con consultas complejas y se necesita comprender la mecánica de ejecución interna más allá de lo que ofrece EXPLAIN.",
    ...
    },
    {
      ...
      "title": "Qué ocurre con las vistas materializadas actualizables al reiniciar el servidor",
      "description": "Por qué todas las vistas materializadas actualizables pueden actualizarse a la vez al reiniciar un servidor y cómo reanudar sus actualizaciones una por una.",
