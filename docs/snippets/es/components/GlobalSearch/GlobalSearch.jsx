export const GlobalSearch = ({ placeholder = "Buscar en los docs de ClickHouse..." }) => {
  ...
  useEffect(() => {
    ...
    const mount = () => {
      ...
      try {
        ...
        console.log("Error en la búsqueda global de Inkeep:", error)
      }
    }
    ...
    return () => {
      ...
      try {
        ...
        // Ignorar errores de limpieza de un widget ya desconectado.
      }
