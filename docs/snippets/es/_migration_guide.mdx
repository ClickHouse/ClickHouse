...
3. **[PIVOT](#pivot-data-from-redshift-to-clickhouse-using-s3)** usar S3 object storage con una lógica de «descargar y luego cargar»
...
<Steps>
  ...
  <Step title="Configurar su origen de datos de Redshift" id="configure-your-redshift-datasource">
  ...
  <Step title="Consultar su instancia de Redshift desde ClickHouse" id="query-your-redshift-instance-from-clickhouse">
  ...
  <Step title="Importar datos de Redshift a ClickHouse" id="import-data-from-redshift-to-clickhouse">
...
<div className="ch-image-md">
  <Frame>
    <img src="/images/integrations/data-ingestion/redshift/pivot.webp" alt="PIVOT de Redshift mediante S3" />
  </Frame>
</div>
...
<Steps>
  <Step title="Exporta los datos a un bucket de S3 con UNLOAD" id="export-data-into-an-s3-bucket-using-unload">
    ...
    <div className="ch-image-md">
      <Frame>
        <img src="/images/integrations/data-ingestion/redshift/s3-1.webp" alt="UNLOAD de Redshift a S3" style={{ backgroundColor: "white" }} />
      </Frame>
    </div>
    ...
    <div className="ch-image-md">
      <Frame>
        <img src="/images/integrations/data-ingestion/redshift/s3-2.webp" alt="Datos en S3" style={{ backgroundColor: "white" }} />
      </Frame>
    </div>
  </Step>
