...
## Instrumentar la aplicación {#instrument-the-application}
...
### Instala el SDK de Node {#install-node-sdk}

        ```bash
        npm install @hyperdx/node-opentelemetry
        ```

### Habilita el envoltorio en run.sh {#enable-run-sh-wrapper}
...
### Habilita el SDK para navegador {#enable-browser-sdk}
