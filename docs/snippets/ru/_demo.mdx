...
<Image img="/images/use-cases/observability/hyperdx-demo/architecture.webp" alt="Архитектура" size="lg" caption="Источник: https://opentelemetry.io/docs/demo/architecture/" />
