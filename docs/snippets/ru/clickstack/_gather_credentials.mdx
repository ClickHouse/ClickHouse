...
<Image img="/images/use-cases/observability/clickstack-cloud-connect.webp" size="lg" alt="Панель подключения сервиса с HTTPS-конечной точкой и паролем" border />