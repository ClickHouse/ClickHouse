...
<Steps>
  <Step title="Клонируйте и запустите приложение" id="clone-and-run-the-application">
  ...
  <Step title="Получите сведения о подключении" id="get-connection-details">
  ...
  <Step title="Инструментируйте приложение" id="instrument-the-application">
  ...
  <Step title="Сгенерируйте трафик и просмотрите телеметрию" id="generate-traffic-and-view-telemetry">
    ...
    <Frame>
      <img src="/images/clickstack/getting-started/instrument_app_clickstack_logs.webp" alt="Журналы ClickStack" />
    </Frame>
    ...
    <Frame>
      <img src="/images/clickstack/getting-started/instrument_app_clickstack_traces.webp" alt="Трейсы ClickStack" />
    </Frame>
    ...
    <Frame>
      <img src="/images/clickstack/getting-started/instrument_app_clickstack_sessions.webp" alt="Сеансы ClickStack" />
    </Frame>
