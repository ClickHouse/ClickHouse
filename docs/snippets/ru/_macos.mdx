...
<Steps>
  ...
  <Step title="Устранение ошибки developer verification error в macOS" id="fix-developer-verification-error-macos">
    ...
    <div className="ch-image-sm">
      <Frame>
        <img src="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.webp" alt="Диалог ошибки проверки разработчика в macOS" />
      </Frame>
    </div>
    ...
    2. Перейдите в раздел **Privacy &amp; Security**:
       ...
       <div className="ch-image-md">
         <Frame>
           <img src="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.webp" alt="Стандартный вид настроек Privacy & Security в macOS" />
         </Frame>
       </div>
    ...
    4. Нажмите **Allow Anyway**.
       ...
       <div className="ch-image-md">
         <Frame>
           <img src="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.webp" alt="Настройки Privacy & Security в macOS с кнопкой Allow Anyway" />
         </Frame>
       </div>
