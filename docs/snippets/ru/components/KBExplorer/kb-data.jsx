export const kbIndex = {
  ...
  "articles": [
    ...
    },
    {
      ...
      "description": "В этой статье объясняется, как устранить ошибку DB::Exception, связанную с пересекающимися частями в ClickHouse, которая часто вызвана состоянием гонки или ручным вмешательством в данные ZooKeeper.",
    ...
    },
    {
      ...
      "description": "В этом руководстве показано, как собирать и визуализировать трассировки запросов в самостоятельно управляемом ClickHouse с помощью встроенных инструментов или Grafana. Это особенно полезно при работе со сложными запросами, когда необходимо понять внутреннюю механику выполнения за пределами того, что предоставляет EXPLAIN.",
    ...
    },
    {
      ...
      "description": "Почему при перезапуске сервера все refreshable materialized view могут начать обновляться одновременно и как затем запускать их по одному.",
