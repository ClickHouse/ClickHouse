export const QuickStartsGrid = ({ quickStartsData = [], featured = [] }) => {
  ...
  const useCaseOptions = [
    { value: "real-time-analytics", label: "Аналитика в реальном времени" },
  ...
  return (
    <>
      <div style={{ maxWidth: "1312px", marginLeft: "max(0px, calc((100vw - 1312px) / 2 - 19rem))", marginRight: "auto", paddingLeft: "1.75rem", paddingRight: "1.75rem" }}>
        <div className="my-8">
          {/* Избранные быстрые старты section - full width banner image cards */}
          {featuredQuickStarts.length > 0 && (
            <div className="mb-12">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-6">Избранные быстрые старты</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="space-y-5">
                        <FilterGroup label="Сценарии использования" options={visibleUseCaseOptions} selectedOptions={selectedUseCases} onToggle={toggleUseCase} />
                        <FilterGroup label="Область продукта" options={visibleProductOptions} selectedOptions={selectedProducts} onToggle={toggleProduct} />
                      </div>
                    </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              {filteredQuickStarts.length > 0 ? (
                ...
                <div className="text-center py-12 flex flex-col items-center">
                  <p className="text-gray-600 dark:text-gray-400 text-lg block">Не найдено ни одного руководства быстрого старта, соответствующего вашим критериям.</p>
