      ...
      <div className="ch-agent-prompt-main-row">
        ...
        >
          ...
          <span style={{ display: "grid", justifyItems: "center" }}>
            <span style={{ gridArea: "1 / 1", visibility: copied ? "hidden" : "visible" }}>Скопировать промпт</span>
            <span style={{ gridArea: "1 / 1", visibility: copied ? "visible" : "hidden" }}>Скопировано</span>
          </span>
        </button>
      </div>
