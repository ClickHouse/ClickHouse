export const GlobalSearch = ({ placeholder = "Поиск в документации ClickHouse..." }) => {
  ...
  useEffect(() => {
    ...
    const mount = () => {
      ...
      try {
        ...
        console.log("Глобальный поиск Inkeep завершился с ошибкой:", error)
      }
    }
    ...
    return () => {
      ...
      try {
        ...
        // Игнорировать ошибки очистки от уже отсоединённого виджета.
      }
