...
<div className="ch-image-md">
  <Frame>
    <img src="/images/integrations/data-ingestion/redshift/push.webp" alt="PUSH Redshift в ClickHouse" />
  </Frame>
</div>
...
<div className="ch-image-md">
  <Frame>
    <img src="/images/integrations/data-ingestion/redshift/pull.webp" alt="PULL из Redshift в ClickHouse" />
  </Frame>
</div>
...
<div className="ch-image-md">
  <Frame>
    <img src="/images/integrations/data-ingestion/redshift/pivot.webp" alt="PIVOT из Redshift с использованием S3" />
  </Frame>
</div>
...
<Steps>
  <Step title="Экспортируйте данные в S3 бакет с помощью UNLOAD" id="export-data-into-an-s3-bucket-using-unload">
    ...
    <div className="ch-image-md">
      <Frame>
        <img src="/images/integrations/data-ingestion/redshift/s3-1.webp" alt="UNLOAD из Redshift в S3" style={{ backgroundColor: "white" }} />
      </Frame>
    </div>
    ...
    <div className="ch-image-md">
      <Frame>
        <img src="/images/integrations/data-ingestion/redshift/s3-2.webp" alt="Данные в S3" style={{ backgroundColor: "white" }} />
      </Frame>
    </div>
  </Step>
