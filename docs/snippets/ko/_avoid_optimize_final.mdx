...
<div className="ch-image-md">
  <Frame>
    <img src="/images/bestpractices/simple_merges.webp" alt="단순 머지" />
  </Frame>
</div>
...
일반적으로 ClickHouse는 ~150 GB보다 큰 파트를 머지하지 않도록 합니다([max&#95;bytes&#95;to&#95;merge&#95;at&#95;max&#95;space&#95;in&#95;pool](/ko/reference/settings/merge-tree-settings/max-bytes#max_bytes_to_merge_at_max_space_in_pool)로 설정 가능). 하지만 `OPTIMIZE FINAL`은 **이 안전장치를 무시**하므로 다음과 같은 문제가 발생할 수 있습니다.
