...
* `bytes`가 기본값이며, 설정 [`output_format_avro_string_column_pattern`](/ko/reference/settings/formats/output-format#output_format_avro_string_column_pattern)으로 제어됩니다.
