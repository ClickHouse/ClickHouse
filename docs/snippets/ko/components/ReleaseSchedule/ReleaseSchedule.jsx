      ...
      <thead>
        <tr>
          ...
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href="/manage/updates#fast-release-channel-early-upgrades">빠른 채널</a>
          </th>
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href="/manage/updates#regular-release-channel">정규 채널</a>
          </th>
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href="/manage/updates#slow-release-channel-deferred-upgrades">느린 채널</a>
          </th>
        </tr>
        <tr>
          <th scope="col" style={groupStartStyle}>시작</th>
          <th scope="col">종료</th>
          <th scope="col" style={groupStartStyle}>시작</th>
          <th scope="col">종료</th>
          <th scope="col" style={groupStartStyle}>시작</th>
