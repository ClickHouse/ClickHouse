...
<Image img="/images/integrations/data-ingestion/redshift/push.webp" size="md" alt="Push 방식으로 Redshift에서 ClickHouse로 데이터 전송" />
...
<Image img="/images/integrations/data-ingestion/redshift/pull.webp" size="md" alt="Redshift에서 ClickHouse로 PULL" />
...
<Image img="/images/integrations/data-ingestion/redshift/pivot.webp" size="md" alt="S3를 사용한 Redshift PIVOT" />
