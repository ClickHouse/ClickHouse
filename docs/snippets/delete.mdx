...
See [Choose the delete mode in the `DELETE` reference](/reference/statements/delete#lightweight-delete-mode) for the available modes, prerequisites, a configuration example, and differences in visibility across replicas.
