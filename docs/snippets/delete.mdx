...
See [the `DELETE` reference](/reference/statements/delete) for the available modes, prerequisites, a configuration example, and differences in visibility across replicas.
