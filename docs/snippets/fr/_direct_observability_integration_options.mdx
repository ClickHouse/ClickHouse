...
Datadog propose pour son agent un plugin de supervision ClickHouse qui interroge directement les tables système. Cette intégration offre une supervision complète de la base de données avec prise en charge du cluster grâce à la fonctionnalité clusterAllReplicas.
