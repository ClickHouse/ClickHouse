...
<Accordion title="Gérer votre IP Access List">
  ...
  <div className="ch-image-md">
    <Frame>
      <img src="/images/_snippets/ip-allow-list-check-list.webp" alt="Vérifiez si le service autorise le trafic provenant de votre adresse IP dans l’IP Access List" />
    </Frame>
  </div>
  ...
  <div className="ch-image-md">
    <Frame>
      <img src="/images/_snippets/ip-allow-list-add-current-ip.webp" alt="Ajoutez votre adresse IP actuelle à l’IP Access List dans ClickHouse Cloud" />
    </Frame>
  </div>
</Accordion>