...
<div className="ch-image-md">
  <Frame>
    <img src="/images/use-cases/observability/clickstack-tags-search.webp" alt="Tags dans une recherche enregistrée" />
  </Frame>
</div>
...
<div className="ch-image-md">
  <Frame>
    <img src="/images/use-cases/observability/clickstack-tags-dashboard.webp" alt="Plusieurs tags sélectionnés dans le tableau de bord" />
  </Frame>
</div>