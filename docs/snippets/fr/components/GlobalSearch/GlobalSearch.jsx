export const GlobalSearch = ({ placeholder = "Rechercher dans la documentation ClickHouse..." }) => {
  ...
  useEffect(() => {
    ...
    const mount = () => {
      ...
      try {
        ...
        console.log("Échec de la recherche globale Inkeep :", error)
      }
    }
    ...
    return () => {
      ...
      try {
        ...
        // Ignorer les erreurs de nettoyage d'un widget déjà détaché.
      }
