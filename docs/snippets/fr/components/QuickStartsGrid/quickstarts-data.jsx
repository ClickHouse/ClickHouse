export const quickStartsData = [
  ...
  },
  {
    ...
    title: "Créer votre première table MergeTree",
    description:
      "Découvrez le fonctionnement du principal table engine de ClickHouse en créant une table MergeTree, en chargeant des données de prix immobiliers au Royaume-Uni, et en observant l'impact des parts et des merges sur le stockage et les performances des requêtes.",
