export const QuickStartsGrid = ({ quickStartsData = [], featured = [] }) => {
  ...
  const useCaseOptions = [
    { value: "real-time-analytics", label: "Analytique en temps réel" },
    { value: "data-warehousing", label: "Entrepôt de données" },
    { value: "observability", label: "Observabilité" },
  ...
  return (
    <>
      <div style={{ maxWidth: "1312px", marginLeft: "max(0px, calc((100vw - 1312px) / 2 - 19rem))", marginRight: "auto", paddingLeft: "1.75rem", paddingRight: "1.75rem" }}>
        <div className="my-8">
          {/* Quickstarts en vedette section - full width banner image cards */}
          {featuredQuickStarts.length > 0 && (
            <div className="mb-12">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-6">Quickstarts en vedette</h2>
                ...
                {featuredQuickStarts.map((quickStart) => (
                  ...
                  >
                    ...
                    <div className="relative w-full aspect-[16/9] overflow-hidden bg-[#FAFF69] flex flex-col justify-center px-6 transition-transform duration-200 group-hover:scale-[1.02]">
                      ...
                      <span className="relative z-10 pr-24 text-base md:text-lg font-bold leading-snug text-black line-clamp-4">{quickStart.title}</span>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="space-y-5">
                        <FilterGroup label="Cas d'usage" options={visibleUseCaseOptions} selectedOptions={selectedUseCases} onToggle={toggleUseCase} />
                        <FilterGroup label="Domaine produit" options={visibleProductOptions} selectedOptions={selectedProducts} onToggle={toggleProduct} />
                      </div>
                    </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              {filteredQuickStarts.length > 0 ? (
                ...
                <div className="text-center py-12 flex flex-col items-center">
                  <p className="text-gray-600 dark:text-gray-400 text-lg block">Aucun guide de démarrage rapide ne correspond à vos critères.</p>
                  <p className="text-gray-500 dark:text-gray-500 text-sm mt-2 block">Essayez d'affiner vos filtres ou votre terme de recherche.</p>
                </div>
              )}
            </div>
          </div>
