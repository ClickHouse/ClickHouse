export const QuickStartsGrid = ({ quickStartsData = [], featured = [] }) => {
  ...
  const useCaseOptions = [
    { value: 'real-time-analytics', label: "Analyses en temps réel" },
  ...
  const productOptions = [
    ...
    { value: 'language-clients', label: "Clients par langage" },
              ...
              {filteredQuickStarts.length > 0 ? (
                ...
                <div className="text-center py-12 flex flex-col items-center">
                  <p className="text-gray-600 dark:text-gray-400 text-lg block">
                    Aucun guide de démarrage rapide ne correspond à vos critères.
                  </p>
                  <p className="text-gray-500 dark:text-gray-500 text-sm mt-2 block">
                    Essayez d'affiner vos filtres ou votre terme de recherche.
                  </p>
                </div>
              )}
            </div>
