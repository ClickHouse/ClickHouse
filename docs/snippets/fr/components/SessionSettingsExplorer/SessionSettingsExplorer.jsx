const SessionSettingsExplorer = ({ href: baseRoute }) => {
  ...
  // conserver les liaisons de portée du module. L'état différé (lazy) maintient les données
  // générées dans cette portée d'évaluation en ne les construisant qu'une fois par montage.
