...
يكتمل إدراج مليون صف خلال نحو 7 ثوانٍ على `m6gd.large` (أصغر فئة) بفضل تخزين NVMe. تحقّق من ذلك بإجراء استعلام؛ إذ تختلف أعداد الصفوف بين مرات التشغيل لأن البيانات تُولَّد باستخدام `random()`:
