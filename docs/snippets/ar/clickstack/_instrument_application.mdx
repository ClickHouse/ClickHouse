...
## أضِف أدوات القياس عن بُعد إلى التطبيق {#instrument-the-application}
...
### تثبيت Node SDK {#install-node-sdk}

        ```bash
        npm install @hyperdx/node-opentelemetry
        ```

### تفعيل wrapper في run.sh {#enable-run-sh-wrapper}
...
### تفعيل Browser SDK {#enable-browser-sdk}
