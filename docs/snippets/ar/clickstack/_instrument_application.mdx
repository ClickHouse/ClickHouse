...
<Steps>
  <Step title="استنساخ التطبيق وتشغيله" id="clone-and-run-the-application">
    ...
    <Frame>
      <img src="/images/clickstack/getting-started/hackernews_main.webp" alt="تطبيق HackerNews Analyzer قيد التشغيل محليًا" />
    </Frame>
  ...
  <Step title="احصل على تفاصيل الاتصال" id="get-connection-details">
  ...
  <Step title="أضِف أدوات القياس عن بُعد إلى التطبيق" id="instrument-the-application">
  ...
  <Step title="أنشئ حركة مرور واعرض بيانات القياس عن بُعد" id="generate-traffic-and-view-telemetry">
    ...
    أعِد تحميل علامة تبويب المتصفح لكي يقدّم Vite الحزمة المحدَّثة، ثم حدِّث التطبيق بضع مرات، وبدّل بين السنوات، وانقر للدخول إلى القصص لتوليد بعض الزيارات.
    ...
    <Frame>
      <img src="/images/clickstack/getting-started/instrument_app_clickstack_logs.webp" alt="سجلات ClickStack" />
    </Frame>
    ...
    <Frame>
      <img src="/images/clickstack/getting-started/instrument_app_clickstack_traces.webp" alt="تتبعات ClickStack" />
    </Frame>

    3. افتح **Session Replay** لتشغيل فيديو يمكنك التنقّل خلاله لجلسة في المتصفح، متزامنًا مع المخطط الزمني للتتبّع.

    <Frame>
      <img src="/images/clickstack/getting-started/instrument_app_clickstack_sessions.webp" alt="جلسات ClickStack" />
    </Frame>
