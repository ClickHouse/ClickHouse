...
<Steps>
  <Step>
    ...
    **1.** في ClickHouse Cloud، اختر **مصادر البيانات** من قائمة التنقل الرئيسية، ثم انقر على **إنشاء ClickPipe**.
  ...
  <Step>
    ...
    **تهانينا!** لقد أعددت أول ClickPipe بنجاح.
    إذا كان ClickPipe هذا مُعدًّا للاستيعاب المستمر، فسيظل قيد التشغيل باستمرار، ويستوعب البيانات آنيًا من مصدر البيانات البعيد.
