...
<Image img="/images/use-cases/observability/hyperdx-demo/architecture.webp" alt="البنية" size="lg" caption="المصدر: https://opentelemetry.io/docs/demo/architecture/" />
