...
<Accordion title="إدارة قائمة الوصول إلى IP">
  ...
  <div className="ch-image-md">
    <Frame>
      <img src="/images/_snippets/ip-allow-list-check-list.webp" alt="تحقق مما إذا كانت الخدمة تسمح بمرور الزيارات من عنوان IP الخاص بك ضمن قائمة الوصول إلى IP" />
    </Frame>
  </div>
  ...
  <div className="ch-image-md">
    <Frame>
      <img src="/images/_snippets/ip-allow-list-add-current-ip.webp" alt="أضف عنوان IP الحالي إلى قائمة الوصول إلى IP في ClickHouse Cloud" />
    </Frame>
  </div>
</Accordion>