    ...
    <div className="ch-agent-prompt-wrapper" data-mdast="ignore">
      <div className="ch-agent-prompt-main-row">
        ...
        <button
          ...
          onClick={handleCopy}
          aria-label={copied ? "تم النسخ" : "نسخ الموجّه"}
        >
          {copied ? (
          ...
          <span style={{ display: "grid", justifyItems: "center" }}>
            <span style={{ gridArea: "1 / 1", visibility: copied ? "hidden" : "visible" }}>نسخ الموجّه</span>
            <span style={{ gridArea: "1 / 1", visibility: copied ? "visible" : "hidden" }}>تم النسخ</span>
          </span>
        </button>
      </div>
