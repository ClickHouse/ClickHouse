  ...
  return (
    <div className="ch-agent-prompt-wrapper" data-mdast="ignore">
      <div className="ch-agent-prompt-main-row">
        ...
        <button type="button" className="ch-agent-prompt-copy-button" onClick={handleCopy} aria-label={copied ? "تم النسخ" : "نسخ الموجّه"}>
          {copied ? (
          ...
          <span>{copied ? "تم النسخ" : "نسخ الموجّه"}</span>
        </button>
      </div>
