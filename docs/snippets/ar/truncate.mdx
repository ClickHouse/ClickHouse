...
يمكنك استخدام الإعداد [alter&#95;sync](/ar/reference/settings/session-settings/alter#alter_sync) لضبط انتظار تنفيذ الإجراءات على النسخ المتماثلة.

يمكنك تحديد مدة الانتظار (بالثواني) لكي تنفذ النسخ المتماثلة غير النشطة استعلامات `TRUNCATE` باستخدام الإعداد [replication&#95;wait&#95;for&#95;inactive&#95;replica&#95;timeout](/ar/reference/settings/session-settings/other#replication_wait_for_inactive_replica_timeout).
