      ...
      <thead>
        <tr>
          ...
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href="/manage/updates#fast-release-channel-early-upgrades">Fast Channel</a>
          </th>
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href="/manage/updates#regular-release-channel">Regular Channel</a>
          </th>
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href="/manage/updates#slow-release-channel-deferred-upgrades">Slow Channel</a>
          </th>
        </tr>
        <tr>
