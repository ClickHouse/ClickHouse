      ...
      <thead>
        <tr>
          ...
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href={withBase("/products/cloud/features/admin-features/upgrades#fast-release-channel-early-upgrades")}>Fast Channel</a>
          </th>
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href={withBase("/products/cloud/features/admin-features/upgrades#regular-release-channel")}>Regular Channel</a>
          </th>
          <th colSpan={2} scope="colgroup" style={groupStartStyle}>
            <a href={withBase("/products/cloud/features/admin-features/upgrades#slow-release-channel-deferred-upgrades")}>Slow Channel</a>
          </th>
        </tr>
        <tr>
