/**
 * VersionBadge — small inline badge marking the minimum ClickHouse version a
 * feature is available in. Mintlify shim of clickhouse-docs's
 * `src/theme/badges/VersionBadge`.
 *
 * Usage:
