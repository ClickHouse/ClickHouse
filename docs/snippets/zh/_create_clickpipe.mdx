...
<Steps>
  <Step>
    ...
    **1.** 在 ClickHouse Cloud 中，先在主导航菜单中选择 **数据源**，然后点击 **创建 ClickPipe**。
  ...
  <Step>
    ...
    <Info>
      您还可以将[virtual columns](/zh/reference/functions/table-functions/s3#virtual-columns) (例如 `_path` 或 `_size`) 映射到字段。
    </Info>
  </Step>
