...
<div className="ch-image-md">
  <Frame>
    <img src="/images/use-cases/observability/clickstack-tags-search.webp" alt="已保存的搜索中的标签" />
  </Frame>
</div>
...
<div className="ch-image-md">
  <Frame>
    <img src="/images/use-cases/observability/clickstack-tags-dashboard.webp" alt="仪表盘中选中的多个标签" />
  </Frame>
</div>