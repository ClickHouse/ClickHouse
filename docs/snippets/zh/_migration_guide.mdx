...
<Image img="/images/integrations/data-ingestion/redshift/pull.webp" size="md" alt="从 Redshift 到 ClickHouse 的 PULL" />
...
<Image img="/images/integrations/data-ingestion/redshift/pivot.webp" size="md" alt="使用 S3 从 Redshift 中转" />
...
<Steps>
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/redshift/s3-1.webp" size="md" alt="从 Redshift 通过 UNLOAD 导出到 S3" background="white" />
