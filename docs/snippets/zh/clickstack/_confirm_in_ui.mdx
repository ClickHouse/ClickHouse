...
<Frame>
  <img src="/images/use-cases/observability/clickstack-cloud-first-time.webp" alt="启动 ClickStack" />
</Frame>
...
<Frame>
  <img src="/images/use-cases/observability/clickstack-start-ingestion.webp" alt="ClickStack 开始摄取" />
</Frame>
...
<Frame>
  <img src="/images/use-cases/observability/clickstack-start-exploring.webp" alt="ClickStack 开始探索" />
</Frame>

将 source 切换为 `Logs`，并将时间范围设置为 **Last 15 minutes**。来自 `telemetrygen` 的合成日志应该会在几秒内出现。

<Frame>
  <img src="/images/use-cases/observability/clickstack-search.webp" alt="显示日志的 ClickStack 搜索视图" />
</Frame>
