        ...
        <div className="my-8">
                  ...
                  >
                    ...
                    <div className="relative w-full aspect-[2/1] overflow-hidden bg-[#FAFF69] flex flex-col justify-center px-6 pb-12">
                      ...
                      <div className="absolute inset-x-0 bottom-0 h-12 bg-[#E7EA5B] flex items-center justify-between px-5">
                        ...
                        <span className="text-sm font-medium text-black">快速入门</span>
                      </div>
                    </div>
                  </a>
                ))}
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="space-y-5">
                        <FilterGroup label="用例" options={visibleUseCaseOptions} selectedOptions={selectedUseCases} onToggle={toggleUseCase} />
                        <FilterGroup label="产品领域" options={visibleProductOptions} selectedOptions={selectedProducts} onToggle={toggleProduct} />
                      </div>
                    </div>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-6">探索快速入门</h2>
              ...
              {filteredQuickStarts.length > 0 ? (
                ...
                <div className="text-center py-12 flex flex-col items-center">
                  ...
                  <p className="text-gray-500 dark:text-gray-500 text-sm mt-2 block">请尝试调整筛选条件或搜索关键词。</p>
                </div>
              )}
            </div>
          </div>
