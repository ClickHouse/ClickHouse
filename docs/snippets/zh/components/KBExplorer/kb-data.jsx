export const kbIndex = {
  ...
  "articles": [
    ...
    },
    {
      ...
      "description": "本文介绍如何解决 ClickHouse 中与交叉部分相关的 DB::Exception 错误，该错误通常由竞争条件或对 ZooKeeper 数据的手动干预引起。",
    ...
    },
    {
      ...
      "title": "如何收集并绘制查询追踪",
      "description": "本指南介绍如何使用内置方法或 Grafana 收集并绘制自托管 ClickHouse 的查询追踪信息。当您处理复杂查询并需要深入了解 EXPLAIN 所提供信息之外的内部执行机制时，本指南尤为实用。",
    ...
    },
    {
      ...
      "title": "服务器重启后，可刷新materialized view会怎样",
      "description": "了解服务器重启后，为什么所有可刷新materialized view可能同时刷新，以及如何让它们逐个恢复刷新。",
