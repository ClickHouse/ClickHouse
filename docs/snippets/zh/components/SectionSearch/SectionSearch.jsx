export const SectionSearch = ({ section = "/reference/statements", label = "Statements", placeholder = "搜索本节内容..." }) => {
  ...
  useEffect(() => {
    ...
    // 旧版 *.mintlify.app 来源将页面暴露在主机根路径下，而
    // *.mintlify.site 来源则包含 /docs 前缀。
