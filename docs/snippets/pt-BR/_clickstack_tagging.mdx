...
<div className="ch-image-md">
  <Frame>
    <img src="/images/use-cases/observability/clickstack-tags-search.webp" alt="Tags na pesquisa salva" />
  </Frame>
</div>
...
<div className="ch-image-md">
  <Frame>
    <img src="/images/use-cases/observability/clickstack-tags-dashboard.webp" alt="Várias tags selecionadas no dashboard" />
  </Frame>
</div>