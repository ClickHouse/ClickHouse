export const SectionSearch = ({ section = "/reference/statements", label = "Statements", placeholder = "Pesquisar nesta seção..." }) => {
  ...
  useEffect(() => {
    ...
    // A fonte legada *.mintlify.app expunha páginas na raiz do host, enquanto
    // a fonte *.mintlify.site inclui um prefixo /docs.
