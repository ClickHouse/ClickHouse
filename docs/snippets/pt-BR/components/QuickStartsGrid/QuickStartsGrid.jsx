  ...
  return (
    <>
      <div style={{ maxWidth: "1312px", marginLeft: "max(0px, calc((100vw - 1312px) / 2 - 19rem))", marginRight: "auto", paddingLeft: "1.75rem", paddingRight: "1.75rem" }}>
        <div className="my-8">
          {/* Guias de início rápido em destaque section - full width banner image cards */}
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="space-y-5">
                        ...
                        <FilterGroup label="Área do produto" options={visibleProductOptions} selectedOptions={selectedProducts} onToggle={toggleProduct} />
                      </div>
                    </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              {filteredQuickStarts.length > 0 ? (
                ...
                <div className="text-center py-12 flex flex-col items-center">
                  <p className="text-gray-600 dark:text-gray-400 text-lg block">Nenhum guia de início rápido encontrado para os critérios selecionados.</p>
