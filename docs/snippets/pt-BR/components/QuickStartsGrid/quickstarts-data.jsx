export const quickStartsData = [
  ...
  },
  {
    ...
    description:
      "Aprenda como funciona o principal motor de tabela do ClickHouse criando uma tabela MergeTree, carregando dados de preços de imóveis do Reino Unido e observando como as partes e os merges afetam o armazenamento e o desempenho das consultas.",
