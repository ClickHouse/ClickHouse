export const GlobalSearch = ({ placeholder = "Pesquisar na documentação do ClickHouse..." }) => {
  ...
  useEffect(() => {
    ...
    const mount = () => {
      ...
      try {
        ...
        console.log("Falha na busca global do Inkeep:", error)
      }
    }
    ...
    return () => {
      ...
      try {
        ...
        // Ignorar erros de limpeza de um widget já desanexado.
      }
