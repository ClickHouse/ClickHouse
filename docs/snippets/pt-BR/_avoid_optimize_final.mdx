...
<div className="ch-image-md">
  <Frame>
    <img src="/images/bestpractices/simple_merges.webp" alt="Mesclagens simples" />
  </Frame>
</div>
...
Normalmente, o ClickHouse evita mesclar partes maiores que ~150 GB (configurável por meio de [max&#95;bytes&#95;to&#95;merge&#95;at&#95;max&#95;space&#95;in&#95;pool](/pt-BR/reference/settings/merge-tree-settings/max-bytes#max_bytes_to_merge_at_max_space_in_pool)). Mas `OPTIMIZE FINAL` **ignora essa proteção**, o que significa que:
