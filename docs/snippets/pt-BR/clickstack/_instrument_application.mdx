...
<Steps>
  <Step title="Faça o clone e execute a aplicação" id="clone-and-run-the-application">
  ...
  <Step title="Obtenha os detalhes da conexão" id="get-connection-details">
  ...
  <Step title="Gere tráfego e visualize a telemetria" id="generate-traffic-and-view-telemetry">
    ...
    <Frame>
      <img src="/images/clickstack/getting-started/instrument_app_clickstack_logs.webp" alt="Logs do ClickStack" />
    </Frame>
    ...
    <Frame>
      <img src="/images/clickstack/getting-started/instrument_app_clickstack_traces.webp" alt="Traces do ClickStack" />
    </Frame>
    ...
    <Frame>
      <img src="/images/clickstack/getting-started/instrument_app_clickstack_sessions.webp" alt="Sessões do ClickStack" />
    </Frame>
