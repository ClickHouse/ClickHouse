...
Você pode usar a configuração [alter&#95;sync](/pt-BR/reference/settings/session-settings/alter#alter_sync) para configurar a espera pela execução de ações nas réplicas.

Você pode especificar por quanto tempo (em segundos) esperar que réplicas inativas executem consultas `TRUNCATE` com a configuração [replication&#95;wait&#95;for&#95;inactive&#95;replica&#95;timeout](/pt-BR/reference/settings/session-settings/other#replication_wait_for_inactive_replica_timeout).
