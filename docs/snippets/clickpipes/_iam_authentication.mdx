...
GRANT rds_iam TO clickpipes_iam_user;`
  ...
  return (
    <>
      ...
      <pre><code className="language-sql">{createUserSql}</code></pre>
      ...
      <Image img="/images/cloud/security/secures3_arn.webp" alt="Service role ID (IAM) value in the Network security information section" size="lg" border/>
