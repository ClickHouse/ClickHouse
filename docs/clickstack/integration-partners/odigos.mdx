...
1. Open the ClickStack UI (HyperDX):
   ...
   - **Managed ClickStack**: open your service in the [ClickHouse Cloud console](https://console.clickhouse.cloud), then click **Launch ClickStack**. See [Open ClickStack and confirm ingestion](/clickstack/getting-started/managed#open-clickstack-and-confirm-ingestion) for details.
