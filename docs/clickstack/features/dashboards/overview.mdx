...
<Image img="/images/clickstack/dashboards/table-tile-display-settings.png" alt="Display Settings drawer for a table tile, with Alternate Row Background turned on" size="lg"/>
