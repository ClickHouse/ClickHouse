...
<Image img="/images/use-cases/observability/hyperdx-demo/architecture.webp" alt="Architecture" size="lg" caption="Credit: https://opentelemetry.io/docs/demo/architecture/"/>
