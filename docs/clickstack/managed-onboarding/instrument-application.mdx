...
title: 'Instrument an application in 5 mins with ClickHouse Observability'
description: 'Instrument a Node.js application with OpenTelemetry and send its logs, metrics, and traces into ClickHouse Observability'
doc_type: 'guide'
...
This guide walks you through instrumenting a small Node.js application with OpenTelemetry and sending its logs, metrics, traces, and session replays into ClickHouse Observability. The backend is instrumented with no changes to the application source code.
