...
description: 'Forward AWS CloudWatch logs into ClickHouse Observability via the OpenTelemetry CloudWatch receiver'
doc_type: 'guide'
...
This guide walks you through forwarding AWS CloudWatch logs into ClickHouse Observability using the OpenTelemetry [`awscloudwatch` receiver](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/awscloudwatchreceiver), then viewing them in the ClickStack UI.
