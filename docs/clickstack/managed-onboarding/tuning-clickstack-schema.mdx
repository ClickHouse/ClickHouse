...
title: 'Tuning ClickHouse Observability - refining your schema'
description: 'Refine your ClickStack schema for improved query performance and storage efficiency in ClickHouse Observability'
doc_type: 'guide'
