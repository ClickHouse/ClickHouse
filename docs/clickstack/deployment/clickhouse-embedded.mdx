...
description: 'Using ClickStack embedded in ClickHouse Server'
doc_type: 'guide'
keywords: ['ClickStack embedded', 'ClickHouse embedded', 'ClickStack ClickHouse server', 'built-in observability']
sidebarTitle: 'Embedded in ClickHouse'
slug: /clickstack/deployment/clickhouse-embedded
---
...
- [ClickHouse Observability](/clickstack/getting-started/managed) — fully managed on ClickHouse Cloud
