...
Open **Team Settings**, navigate to **API Keys**, and copy the **Ingestion API Key**. Telemetry sent to the bundled OpenTelemetry Collector must include this key in the `authorization` header.
</Step>
