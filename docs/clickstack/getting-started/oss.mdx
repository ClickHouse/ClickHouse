...
<Steps>
<Step title="Deploy the stack with docker" id="deploy-stack-with-docker">
...
<Step title="Navigate to the ClickStack UI" id="navigate-to-hyperdx-ui">
...
<Step title="Explore the product" id="explore-the-product">
...
<Steps>
<Step title="Run with docker" id="run-local-with-docker">
...
<Step title="Complete connection credentials" id="complete-connection-credentials">
