...
<Tip>
Use the guide selector to choose the **OpenTelemetry** (recommended) or **Vector** path.
</Tip>
...
ClickStack creates the OpenTelemetry data sources automatically. Open the logs view in ClickStack and search for `ClickStack ingestion test`.
...
<Step title="Open ClickStack and confirm ingestion" id="open-clickstack-and-confirm-ingestion-vector">
