...
- [max_block_size](/reference/settings/session-settings/max#max_block_size) -- Maximum block size in rows.
- [preferred_block_size_bytes](/reference/settings/session-settings/preferred#preferred_block_size_bytes) -- Preferred block size in bytes.
