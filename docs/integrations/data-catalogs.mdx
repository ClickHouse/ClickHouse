...
Query Unity Catalog managed [Iceberg](/reference/engines/table-engines/integrations/iceberg) tables using OAuth client credentials from a Databricks service principal. See the [Unity Catalog guide](/guides/use-cases/data-warehousing/unity-catalog#read-iceberg) for full setup.
...
Query Unity Catalog [Delta Lake](/reference/engines/table-engines/integrations/deltalake) tables using a Databricks Personal Access Token (PAT). See the [Unity Catalog guide](/guides/use-cases/data-warehousing/unity-catalog#read-delta) for full setup.
