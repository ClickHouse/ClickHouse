...
- Heat map of host states across all connected ADQM clusters.
...
- Per-column compressed and uncompressed size, compression ratio, and codec, with graphs.
...
- One-click navigation from a host or table into ADQM Notebook.
