...
From CH version 26.1 onwards, this schema is supported when `allow_experimental_nullable_tuple_type=1` (see [this documentation page](/reference/settings/session-settings/allow-experimental#allow_experimental_nullable_tuple_type)).
