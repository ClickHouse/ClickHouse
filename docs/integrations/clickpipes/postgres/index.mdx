...
8. Additionally, you can provide a custom `PARTITION BY <expr>` expression to control destination [ClickHouse table partitioning](/concepts/core-concepts/partitions).
