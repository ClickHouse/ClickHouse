...
- [AWS Aurora for PostgreSQL source setup guide](/integrations/clickpipes/postgres/source/aurora#configure-database-user)
- [AWS RDS for PostgreSQL source setup guide](/integrations/clickpipes/postgres/source/rds#configure-database-user)
- [AWS Aurora for MySQL source setup guide](/integrations/clickpipes/mysql/source/aurora#configure-database-user)
- [AWS RDS for MySQL source setup guide](/integrations/clickpipes/mysql/source/rds#configure-database-user)
