...
| [GCP Private Service Connect](/integrations/clickpipes/networking/gcp-psc) | Yes       | For data sources hosted on GCP. Cross-region connectivity via Global Access is not supported yet; use [SSH tunneling](#ssh-tunneling) to reach a private data source in unsupported GCP regions. |
