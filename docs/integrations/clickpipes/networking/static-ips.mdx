...
- **ap-southeast-5**: For services in AWS `ap-southeast-5` created on or after TBD — SET BEFORE MERGE (services created before this date use `us-east-2` IPs).
...
| **ap-southeast-5** - Kuala Lumpur (from TBD — SET BEFORE MERGE)     | `43.216.242.22`, `43.217.15.131`, `56.68.22.103`, `56.69.23.169`, `56.69.84.101`, `56.69.183.161`                                                    |
