...
slug: /pt-BR/concepts/features/configuration/server-config/configuration-files
...
<div id="from_env_zk">
  ### Substituição por variáveis de ambiente e nós do ZooKeeper {#from_env_zk}
</div>
...
<div id="substitution-with-file-content">
  ## Substituição com conteúdo de arquivo {#substitution-with-file-content}
</div>
...
<div id="encryption">
  ## Criptografando e ocultando a configuração {#encryption}
</div>
