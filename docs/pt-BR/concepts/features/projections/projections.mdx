---
slug: /pt-BR/concepts/features/projections/projections
title: 'Projeções'
...
<div id="how-do-projections-work">
  ## Como funcionam as projeções? {#how-do-projections-work}
</div>
...
<div id="smarter_storage_with_part_offset">
  ### Armazenamento mais inteligente com `_part_offset` {#smarter_storage_with_part_offset}
</div>
...
<div id="when-to-use-projections">
  ## Quando usar projeções? {#when-to-use-projections}
</div>
...
<div id="filtering-without-using-primary-keys">
  ### Filtragem por colunas que não estão na chave primária {#filtering-without-using-primary-keys}
</div>
...
<div id="further-examples">
  ### Mais exemplos {#further-examples}
</div>
...
<div id="average-price-projections">
  #### Consulta 1. Preço médio por ano {#average-price-projections}
</div>
...
<div id="average-price-london-projections">
  #### Consulta 2. Preço médio por ano em Londres {#average-price-london-projections}
</div>
...
<div id="most-expensive-neighborhoods-projections">
  #### Consulta 3. Os bairros mais caros {#most-expensive-neighborhoods-projections}
</div>
...
<div id="combining-projections">
  ### Combinando projeções em uma consulta {#combining-projections}
</div>
