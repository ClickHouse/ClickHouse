---
slug: /pt-BR/concepts/features/materialized-views/refreshable-materialized-view
...
<div id="when-should-refreshable-materialized-views-be-used">
  ## Quando as views materializadas atualizáveis devem ser usadas? {#when-should-refreshable-materialized-views-be-used}
</div>
...
<div id="when-was-a-refreshable-materialized-view-last-refreshed">
  ## Quando uma view materializada atualizável foi atualizada pela última vez? {#when-was-a-refreshable-materialized-view-last-refreshed}
</div>
...
<div id="how-can-i-change-the-refresh-rate">
  ## Como posso alterar a frequência de atualização? {#how-can-i-change-the-refresh-rate}
</div>
...
<div id="using-append-to-add-new-rows">
  ## Usando `APPEND` para adicionar novas linhas {#using-append-to-add-new-rows}
</div>
