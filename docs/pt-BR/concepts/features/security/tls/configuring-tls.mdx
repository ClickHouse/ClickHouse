---
slug: /pt-BR/concepts/features/security/tls/configuring-tls
...
<div id="configure-openssl-for-standalone-clickhouse-keeper">
  ## Configure o OpenSSL para o ClickHouse Keeper autônomo {#configure-openssl-for-standalone-clickhouse-keeper}
</div>
...
<div id="openssl-verification-modes">
  ## Modos de verificação do OpenSSL e manipuladores de certificado {#openssl-verification-modes}
</div>
...
<div id="verification-modes">
  ### Modos de verificação {#verification-modes}
</div>
...
<div id="invalid-certificate-handlers">
  ### Manipuladores de certificados inválidos {#invalid-certificate-handlers}
</div>
...
<div id="disabling-certificate-verification">
  ### Exemplo: desativando a verificação de certificados {#disabling-certificate-verification}
</div>
