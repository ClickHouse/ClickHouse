...
sidebarTitle: 'JWT'
slug: /pt-BR/concepts/features/security/external-authenticators/jwt
...
<div id="required-claims">
  ### Claims obrigatórias {#required-claims}
</div>
...
<div id="other-recognized-claims">
  ### Outras claims reconhecidas {#other-recognized-claims}
</div>
...
<div id="optional-claims">
  ### Claims opcionais {#optional-claims}
</div>
...
<div id="example-token-header-and-payload">
  ### Exemplo de cabeçalho e payload do token {#example-token-header-and-payload}
</div>
...
<div id="token-freshness">
  ### Recência do token {#token-freshness}
</div>
...
<div id="lifetime-and-garbage-collection">
  ### Tempo de vida e coleta de lixo {#lifetime-and-garbage-collection}
</div>
...
<div id="persistent-access-assignments">
  ### Atribuições persistentes de acesso {#persistent-access-assignments}
</div>
...
<div id="differences-from-regular-users">
  ## Diferenças em relação aos usuários regulares {#differences-from-regular-users}
</div>
...
<div id="sql-security-definer-views">
  ## Views com SQL SECURITY DEFINER {#sql-security-definer-views}
</div>
...
<div id="client-usage">
  ## Uso do cliente {#client-usage}
</div>

<div id="passing-token-directly">
  ### Informando um token diretamente {#passing-token-directly}
</div>
...
<div id="oauth2-device-code-login">
  ### Login OAuth2 com código do dispositivo {#oauth2-device-code-login}
</div>
...
<div id="clickhouse-cloud-built-in">
  ## Autenticador JWT integrado do ClickHouse Cloud {#clickhouse-cloud-built-in}
</div>
...
<div id="enabling-jwt-authentication-for-your-service">
  ## Habilitar a autenticação JWT para seu serviço {#enabling-jwt-authentication-for-your-service}
</div>
...
<div id="interserver-communication">
  ## Comunicação entre servidores {#interserver-communication}
</div>
