...
slug: /pt-BR/concepts/features/performance/caches/query-cache
...
<div id="background-design-and-limitations">
  ## Contexto, design e limitações {#background-design-and-limitations}
</div>
...
<div id="subquery-caching">
  ## Armazenamento em cache de subconsultas {#subquery-caching}
</div>
