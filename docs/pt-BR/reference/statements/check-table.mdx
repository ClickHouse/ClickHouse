...
* `SETTINGS`: (Opcional) Permite definir configurações adicionais.
  * (Opcional): [check&#95;query&#95;single&#95;value&#95;result](/pt-BR/reference/settings/session-settings/check#check_query_single_value_result): Essa configuração controla se a saída será detalhada (`0`) ou resumida (`1`).
