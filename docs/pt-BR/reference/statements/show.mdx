...
<Note>
  ...
  * [`display_secrets_in_show_and_select`](/pt-BR/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select) (configuração do servidor)
  * [`format_display_secrets_in_show_and_select` ](/pt-BR/reference/settings/formats/format#format_display_secrets_in_show_and_select) (configuração de formato)
