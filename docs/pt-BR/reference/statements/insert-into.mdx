...
Para inserir um valor padrão em vez de `NULL` em uma coluna com um tipo de dado não anulável, habilite a configuração [insert&#95;null&#95;as&#95;default](/pt-BR/reference/settings/session-settings/insert#insert_null_as_default).
...
Ao inserir grandes volumes de dados, o ClickHouse otimiza o desempenho de gravação por meio de um processo chamado &quot;squashing&quot;. Pequenos blocos de dados inseridos na memória são mesclados e compactados em blocos maiores antes de serem gravados em disco. O squashing reduz a sobrecarga associada a cada operação de gravação. Nesse processo, os dados inseridos ficam disponíveis para consulta depois que o ClickHouse conclui a gravação de cada [`max_insert_block_size`](/pt-BR/reference/settings/session-settings/max-insert#max_insert_block_size) linhas.

**Veja também**

* [async&#95;insert](/pt-BR/reference/settings/session-settings/async-insert#async_insert)
* [wait&#95;for&#95;async&#95;insert](/pt-BR/reference/settings/session-settings/wait-for#wait_for_async_insert)
* [wait&#95;for&#95;async&#95;insert&#95;timeout](/pt-BR/reference/settings/session-settings/wait-for#wait_for_async_insert_timeout)
* [async&#95;insert&#95;max&#95;data&#95;size](/pt-BR/reference/settings/session-settings/async-insert#async_insert_max_data_size)
