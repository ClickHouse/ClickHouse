...
**Exemplo 6:** Reutilizando uma expressão escalar comum definida por lambda em uma subconsulta

Defina a expressão escalar comum como uma lambda para que seu argumento seja explicitamente associado:
