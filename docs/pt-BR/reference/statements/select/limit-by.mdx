...
Se você quiser usar números de colunas em vez de nomes de colunas na cláusula `LIMIT BY`, ative a configuração [enable&#95;positional&#95;arguments](/pt-BR/reference/settings/session-settings/enable-positional-arguments#enable_positional_arguments).
