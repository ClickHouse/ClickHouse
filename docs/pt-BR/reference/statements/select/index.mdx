...
A lista de expressões imediatamente após `SELECT` é obrigatória; todas as outras cláusulas são opcionais.

`SELECT` e suas cláusulas opcionais são abordados em seções separadas:
