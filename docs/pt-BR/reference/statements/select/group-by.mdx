...
Quando quiser agrupar dados na tabela por números de colunas em vez de nomes de colunas, habilite a configuração [enable&#95;positional&#95;arguments](/pt-BR/reference/settings/session-settings/enable-positional-arguments#enable_positional_arguments).
...
Como a cláusula `GROUP BY` tem três expressões-chave, o resultado contém quatro tabelas com subtotais &quot;acumulados&quot; da direita para a esquerda:
...
* Configuração [group&#95;by&#95;use&#95;nulls](/pt-BR/reference/settings/session-settings/group-by#group_by_use_nulls) para compatibilidade com o padrão SQL.
...
* A configuração [group&#95;by&#95;use&#95;nulls](/pt-BR/reference/settings/session-settings/group-by#group_by_use_nulls) para compatibilidade com o padrão SQL.
...
A configuração [max&#95;bytes&#95;before&#95;external&#95;group&#95;by](/pt-BR/reference/settings/session-settings/max-bytes#max_bytes_before_external_group_by) determina o limite de consumo de RAM para despejar dados temporários do `GROUP BY` no sistema de arquivos. Se for definida como 0 (o padrão), ela fica desabilitada.
Como alternativa, você pode definir [max&#95;bytes&#95;ratio&#95;before&#95;external&#95;group&#95;by](/pt-BR/reference/settings/session-settings/max-bytes#max_bytes_ratio_before_external_group_by), que permite usar `GROUP BY` em memória externa somente quando a consulta atingir um determinado limite de uso de memória.
