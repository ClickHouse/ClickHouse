...
<Warning>
  **Obsoleto**
  ...
  As window views estão obsoletas e poderão ser removidas em uma versão futura. Elas permanecem condicionadas à configuração [allow&#95;experimental&#95;window&#95;view](/pt-BR/reference/settings/session-settings/allow-experimental#allow_experimental_window_view) (`SET allow_experimental_window_view = 1`) e não são recomendadas para novos usos.
</Warning>
