...
Para que o ClickHouse possa acessar um recurso HTTPS, você deve [configurar o openSSL](/pt-BR/reference/settings/server-settings/settings/other#openssl) na configuração do servidor.
