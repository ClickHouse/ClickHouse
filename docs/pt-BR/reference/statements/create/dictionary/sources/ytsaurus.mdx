...
<Info>
  ...
  usando a configuração [`allow_experimental_ytsaurus_dictionary_source`](/pt-BR/reference/settings/session-settings/allow-experimental#allow_experimental_ytsaurus_dictionary_source).
</Info>
