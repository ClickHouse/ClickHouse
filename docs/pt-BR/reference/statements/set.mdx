...
Para mais informações sobre a configuração `session_timezone`, consulte [session&#95;timezone](/pt-BR/reference/settings/session-settings/other#session_timezone).
