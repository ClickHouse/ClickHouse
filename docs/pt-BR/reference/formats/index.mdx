...
| [PNG](/pt-BR/reference/formats/PNG)                                                                                                   | ✗       | ✔     |
| [Puffin](/pt-BR/reference/formats/Puffin/Puffin)                                                                                      | ✔       | ✗     |
| [PuffinMetadata](/pt-BR/reference/formats/Puffin/PuffinMetadata)                                                                      | ✔       | ✗     |
...
deve estar localizado no diretório especificado em [format&#95;schema&#95;path](/pt-BR/reference/settings/server-settings/settings/format#format_schema_path)
na configuração do servidor.

## Ignorar erros {#skippingerrors}

Alguns formatos, como `CSV`, `TabSeparated`, `TSKV`, `JSONEachRow`, `Template`, `CustomSeparated` e `Protobuf`, podem ignorar uma linha inválida se ocorrer um erro de análise e continuar a análise a partir do início da próxima linha. Veja as configurações [input&#95;format&#95;allow&#95;errors&#95;num](/pt-BR/reference/settings/formats/input-format#input_format_allow_errors_num) e
[input&#95;format&#95;allow&#95;errors&#95;ratio](/pt-BR/reference/settings/formats/input-format#input_format_allow_errors_ratio).
Limitações:

* Em caso de erro de análise, `JSONEachRow` ignora todos os dados até a quebra de linha (ou EOF), portanto as linhas devem ser delimitadas por `\n` para que os erros sejam contados corretamente.
