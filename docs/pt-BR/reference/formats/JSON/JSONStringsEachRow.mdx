---
alias: []
description: 'Documentação do formato JSONStringsEachRow'
input_format: true
...
Diferencia-se de [`JSONEachRow`](/pt-BR/reference/formats/JSON/JSONEachRow) apenas pelo fato de que os campos de dados são gerados como strings, e não como valores JSON tipados.
...
Leia os dados no formato `JSONStringsEachRow`:
