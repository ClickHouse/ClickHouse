...
A tabela abaixo mostra todos os tipos de dados compatíveis com o formato Apache Avro e seus correspondentes tipos de dados do ClickHouse [tipos de dados](/pt-BR/reference/data-types/index) em consultas `INSERT` e `SELECT`.
...
* `bytes` é o padrão, controlado pela configuração [`output_format_avro_string_column_pattern`](/pt-BR/reference/settings/formats/output-format#output_format_avro_string_column_pattern)
