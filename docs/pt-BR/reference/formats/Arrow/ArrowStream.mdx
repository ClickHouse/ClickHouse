...
| `output_format_arrow_unsupported_types_as_binary`                            | Gera tipos sem conversão como dados binários brutos. Se for false, esses tipos gerarão a exceção UNKNOWN&#95;TYPE.                                                        | `1`         |
