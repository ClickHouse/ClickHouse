...
A expressão de pós-processamento transforma tokens do tipo [String](/pt-BR/reference/data-types/string) em tokens do mesmo tipo.
Além disso, a expressão de pós-processamento deve referenciar apenas a coluna ou expressão sobre a qual o text index está definido.
Quando a coluna é do tipo `Array(String)`, o pós-processador ainda opera sobre tokens individuais como valores simples do tipo `String`.
