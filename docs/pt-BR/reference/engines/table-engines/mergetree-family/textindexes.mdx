...
| [hasPhrase](/pt-BR/reference/functions/regular-functions/string-search-functions#hasPhrase)                   | sim                                                   | `splitByNonAlpha`, `splitByString`, `ngrams`, `asciiCJK`, `icu` | sim                     |
...
Observe que a função requer um dos tokenizadores `splitByNonAlpha`, `splitByString`, `ngrams`, `asciiCJK` ou `icu`.
...
`hasPhrase` pode ser usado em conjunto com os tokenizers `splitByNonAlpha`, `splitByString`, `ngrams`, `asciiCJK` e `icu`.
