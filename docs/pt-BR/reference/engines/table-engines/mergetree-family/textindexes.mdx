...
Criar um índice com `support_phrase_search = 1` exige, portanto, que a configuração do MergeTree [`allow_experimental_text_index_phrase_search`](/pt-BR/reference/settings/merge-tree-settings#allow_experimental_text_index_phrase_search) esteja habilitada.
...
<Warning>
  ...
  Defina a configuração do MergeTree [`allow_experimental_text_index_phrase_search`](/pt-BR/reference/settings/merge-tree-settings#allow_experimental_text_index_phrase_search) para habilitar o armazenamento de posições.
</Warning>
