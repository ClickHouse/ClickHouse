...
Para usar a replicação, defina parâmetros na seção [zookeeper](/pt-BR/reference/settings/server-settings/settings/zookeeper#zookeeper) da configuração do servidor.
...
Você pode especificar qualquer cluster ZooKeeper existente, e o sistema usará um diretório nele para seus próprios dados (o diretório é especificado ao criar uma tabela replicável).
...
Como o exemplo mostra, esses parâmetros podem conter substituições em `{}`. Os valores substituídos são obtidos na seção [macros](/pt-BR/reference/settings/server-settings/settings/other#macros) do arquivo de configuração.
...
* [background&#95;schedule&#95;pool&#95;size](/pt-BR/reference/settings/server-settings/settings/background-schedule#background_schedule_pool_size)
* [background&#95;fetches&#95;pool&#95;size](/pt-BR/reference/settings/server-settings/settings/background#background_fetches_pool_size)
* [execute&#95;merges&#95;on&#95;single&#95;replica&#95;time&#95;threshold](/pt-BR/reference/settings/merge-tree-settings/other#execute_merges_on_single_replica_time_threshold)
* [max&#95;replicated&#95;fetches&#95;network&#95;bandwidth](/pt-BR/reference/settings/merge-tree-settings/max-replicated#max_replicated_fetches_network_bandwidth)
* [max&#95;replicated&#95;sends&#95;network&#95;bandwidth](/pt-BR/reference/settings/merge-tree-settings/max-replicated#max_replicated_sends_network_bandwidth)