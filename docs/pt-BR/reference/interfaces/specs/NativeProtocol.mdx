...
| 14 | cluster&#95;function&#95;protocol&#95;version  | VarUInt   | universal      | VERSIONED&#95;CLUSTER&#95;FUNCTION&#95;PROTOCOL (v54479)  | Versão do protocolo da table function `*Cluster` do servidor. Atual: `7`. O valor controla campos aditivos no payload inter-server da tarefa de leitura do cluster (o corpo `ReadTaskResponse`, que de outra forma não é especificado); `7` adiciona um `read_source_index` opcional. Clientes externos não participam de leituras de cluster — eles decodificam e ignoram este campo. |
