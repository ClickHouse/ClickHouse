...
### Usando resultados condicionais diretamente {#using-conditional-results-directly}
...
### Valores `NULL` em condicionais {#null-values-in-conditionals}
...
<Note title="Use a configuração `least_greatest_legacy_null_behavior` para alterar o comportamento de `NULL`">
...
A configuração [`short_circuit_function_evaluation`](/pt-BR/reference/settings/session-settings/short-circuit-function-evaluation#short_circuit_function_evaluation) controla se a avaliação de curto-circuito é usada.
...
A configuração [`short_circuit_function_evaluation`](/pt-BR/reference/settings/session-settings/short-circuit-function-evaluation#short_circuit_function_evaluation) controla
