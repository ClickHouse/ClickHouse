...
<Accordion title="Ativando o parser completo">
  ...
  usando a configuração [`input_format_values_interpret_expressions`](/pt-BR/reference/settings/formats/input-format#input_format_values_interpret_expressions).
...
Quando uma consulta é recebida, o servidor mantém no máximo [max&#95;query&#95;size](/pt-BR/reference/settings/session-settings/max#max_query_size) bytes da solicitação em RAM
...
<Note>
  Você pode alterar esse comportamento padrão definindo [prefer&#95;column&#95;name&#95;to&#95;alias](/pt-BR/reference/settings/session-settings/prefer#prefer_column_name_to_alias) como `1`.
</Note>
