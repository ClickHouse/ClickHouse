...
<Steps>
  ...
  <Step title="Carregue os dados" id="load-table">
  ...
  <Step title="Executar uma busca de similaridade vetorial por força bruta" id="run-a-brute-force-vector-similarity-search">
  ...
  <Step title="Execute a busca ANN" id="perform-ann-search">
