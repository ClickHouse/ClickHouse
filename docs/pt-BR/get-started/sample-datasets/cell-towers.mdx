...
<Image img="/images/getting-started/example-datasets/superset-cell-tower-dashboard.webp" size="md" alt="Dashboard de torres de telefonia celular por tipo de rádio no mcc 204" />
...
<Tabs>
  <Tab title="ClickHouse Cloud">
    ...
    <Image img="/images/_snippets/cloud-load-data-sample.webp" size="md" alt="Carregar conjunto de dados de torres de celular" />
...
<Image img="/images/getting-started/example-datasets/superset-add.webp" size="md" alt="Adicionar um banco de dados" />

Escolha **ClickHouse Connect** na lista:

<Image img="/images/getting-started/example-datasets/superset-choose-a-database.webp" size="md" alt="Escolher ClickHouse Connect como tipo de banco de dados" />
...
<Image img="/images/getting-started/example-datasets/superset-connect-a-database.webp" size="md" alt="Adicionar o ClickHouse como fonte de dados no Superset" />
...
<Image img="/images/getting-started/example-datasets/superset-add-dataset.webp" size="md" alt="Adicionar a tabela cell_towers como um conjunto de dados no Superset" />
...
<Image img="/images/getting-started/example-datasets/superset-create-map.webp" size="md" alt="Crie um mapa no Superset" />
...
<Image img="/images/getting-started/example-datasets/superset-lon-lat.webp" size="md" alt="Especifique os campos de longitude e latitude" />
...
<Image img="/images/getting-started/example-datasets/superset-umts-netherlands.webp" size="md" alt="Gráfico para rádios UMTS no MCC 204" />
...
<Image img="/images/getting-started/example-datasets/superset-cell-tower-dashboard.webp" size="md" alt="Dashboard de torres de celular por tipo de rádio no mcc 204" />
