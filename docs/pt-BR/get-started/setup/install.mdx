...
<div className="ch-install-cloud-card">
  ...
  <div className="ch-install-cloud-actions">
    ...
    <a
      ...
      href="https://clickhouse.com/docs/pt-BR/get-started/setup/cloud"
      onClick={(event) => { event.preventDefault(); window.location.href = withDocsBase('/pt-BR/get-started/setup/cloud'); }}
    >
