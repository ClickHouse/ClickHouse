...
<Steps>
  <Step title="Instale o ClickHouse usando curl" id="install-clickhouse-using-curl">
    ...
    No Linux e no macOS, isso também instala o [`clickhousectl`](/pt-BR/install/clickhousectl),
    ...
    segundo plano e gerenciar o ClickHouse Cloud. Consulte a [página de instalação do clickhousectl](/pt-BR/install/clickhousectl)
