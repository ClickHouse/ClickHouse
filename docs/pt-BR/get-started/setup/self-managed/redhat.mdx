...
> Recomenda-se usar pacotes `rpm` oficiais pré-compilados para **CentOS**, **RedHat** e todas as outras
...
<Steps>
  ...
  <Step>
    ...
    * Você pode substituir `stable` por `lts` para usar diferentes [tipos de lançamento](/pt-BR/resources/support-center/knowledge-base/setup-installation/production), conforme suas necessidades.
