...
<Steps>
  ...
  <Step>
    ...
    * Carregar dados de uma URL de arquivo
    ...
    <Image img="/images/_snippets/select_data_source.webp" size="md" alt="Selecione a fonte de dados" border />
    ...
    * as chaves primárias no ClickHouse ***não são únicas*** para cada linha de uma tabela
    ...
    <Image img="/images/_snippets/client_details.webp" size="md" alt="detalhes da conexão do ClickHouse client" border />
