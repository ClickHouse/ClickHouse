...
<Visibility for="humans">
  <View title="UI do Cloud">
    ...
    * O [tutorial](/pt-BR/get-started/sample-datasets/nyc-taxi) orienta você a inserir 2 milhões de linhas em uma tabela e executar algumas consultas analíticas
