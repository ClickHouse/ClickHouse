    ...
    <Steps>
      ...
      <Step title="Conectar ao ClickHouse" id="2-connect-to-clickhouse">
        ...
        * Conecte-se pelo seu app
        ...
        ### Conectar usando o console SQL {#connect-using-sql-console}
        ...
        ### Conecte-se ao seu aplicativo {#connect-with-your-app}
      ...
      <Step title="Adicionar dados" id="3-add-data">
        ...
        * Faça upload de dados a partir do URL do arquivo
        ...
        ### Adicionar dados pelo SQL Console {#add-data-using-the-sql-console}
        ...
        * `metric`: um número de ponto flutuante de 32 bits ([Float32](/pt-BR/reference/data-types/float))
        ...
        #### Uma breve introdução às chaves primárias {#a-brief-intro-to-primary-keys}
        ...
        * as chaves primárias no ClickHouse ***não são exclusivas*** para cada linha de uma tabela
        ...
        #### Insira dados na sua tabela {#insert-data-into-your-table}
        ...
        ### Adicionar dados usando o ClickHouse Client {#add-data-using-the-clickhouse-client}
