...
| Estado transacional da aplicação somado a consultas analíticas que exigem um sistema de atendimento independente                       | [Services Postgres e ClickHouse no ClickHouse Cloud](/pt-BR/products/managed-postgres/clickhouse-integration) | Quais tabelas precisam de replicação, defasagem de replicação aceitável, mudanças de schema e o custo e a operação de dois services         |
