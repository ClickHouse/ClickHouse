...
slug: /pt-BR/get-started/migrate/bigquery/overview
...
<div id="bigquery-projects-vs-clickhouse-cloud-services">
  ### Projetos do BigQuery vs Serviços do ClickHouse Cloud {#bigquery-projects-vs-clickhouse-cloud-services}
</div>
...
<div id="bigquery-datasets-vs-clickhouse-cloud-databases">
  ### Conjuntos de dados do BigQuery vs bancos de dados do ClickHouse Cloud {#bigquery-datasets-vs-clickhouse-cloud-databases}
</div>
...
<div id="bigquery-folders">
  ### Pastas do BigQuery {#bigquery-folders}
</div>
...
<div id="bigquery-slot-reservations-and-quotas">
  ### Reservas de slot e cotas do BigQuery {#bigquery-slot-reservations-and-quotas}
</div>
...
<div id="query-acceleration-techniques">
  ## Técnicas de aceleração de consultas {#query-acceleration-techniques}
</div>

<div id="primary-and-foreign-keys-and-primary-index">
  ### Chaves primárias e estrangeiras e índice primário {#primary-and-foreign-keys-and-primary-index}
</div>
...
<div id="secondary-indexes-only-available-in-clickhouse">
  ## Índices secundários (Disponíveis apenas no ClickHouse) {#secondary-indexes-only-available-in-clickhouse}
</div>
...
<div id="vector-indexes">
  ## Índices vetoriais {#vector-indexes}
</div>
...
<div id="querying-materialized-views">
  ## Consultando visões materializadas {#querying-materialized-views}
</div>
...
<div id="data-sources-and-file-formats">
  ## Fontes de dados e formatos de arquivo {#data-sources-and-file-formats}
</div>
...
<div id="sql-language-features">
  ## Recursos da linguagem SQL {#sql-language-features}
</div>
