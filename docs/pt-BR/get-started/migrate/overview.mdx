...
| OSS para Cloud                                                            | Transfira dados de uma implantação autogerenciada do ClickHouse usando [`remoteSecure`](/pt-BR/get-started/migrate/oss-to-cloud/clickhouse-to-cloud) ou [`BACKUP` e `RESTORE`](/pt-BR/get-started/migrate/oss-to-cloud/oss-to-cloud-backup-restore). |
