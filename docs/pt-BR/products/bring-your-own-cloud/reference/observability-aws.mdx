...
<div id="prometheus-monitoring">
  ## Abordagens de monitoramento com Prometheus {#prometheus-monitoring}
</div>
...
<div id="monitoring-approaches-comparison">
  ### Comparando métodos de monitoramento {#monitoring-approaches-comparison}
</div>
...
<div id="builtin-prometheus-stack">
  ## A stack do Prometheus integrada do BYOC {#builtin-prometheus-stack}
</div>
...
<div id="prometheus-stack-integration">
  ### Integre com suas ferramentas de monitoramento {#prometheus-stack-integration}
</div>
...
<div id="direct-prometheus-integration">
  ## Integração do serviço ClickHouse com o Prometheus {#direct-prometheus-integration}
</div>
