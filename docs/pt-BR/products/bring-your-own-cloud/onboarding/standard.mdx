...
<Steps>
  ...
  <Step title="Configure a infraestrutura do BYOC" id="setup-byoc-infrastructure">
    ...
    * **Região**: Todas as **regiões públicas** listadas na nossa documentação de [regiões compatíveis](/pt-BR/products/cloud/reference/supported-regions) estão disponíveis para implantações de BYOC. No momento, regiões privadas não são compatíveis.
