...
<Steps>
  ...
  <Step title="Configure a infraestrutura do BYOC" id="set-up-byoc-infrastructure">
    ...
    5. Se sua VPC estiver em um projeto host de Shared VPC, insira o **Shared VPC host project ID**. Deixe em branco quando a VPC estiver no mesmo projeto da infraestrutura. Consulte [Shared VPC a partir de um projeto host](#shared-vpc-host-project) abaixo.
