...
description: 'Exatamente o que o ClickHouse Connector pode e não pode fazer: conexões de saída, Permissões do ClickHouse, RBAC do Kubernetes, atribuição e minimização de dados'
...
## O que o conector não pode fazer {#what-the-connector-cannot-do}
