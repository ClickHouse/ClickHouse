...
### Posso executar isso em um ambiente isolado da internet ou usando meus próprios espelhos? {#air-gapped-and-mirrors}
...
### O que acontece se o conector ficar indisponível? {#connector-down}
