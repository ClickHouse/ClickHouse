...
### Quem pode alterar meus serviços, e quando?
...
### Como impedir que o ClickHouse altere meus clusters?
...
### O que acontece se o connector ficar offline?
...
### O que é excluído quando um serviço é excluído?
...
### Onde está a senha do meu usuário default?
...
### Posso executar isso isolado da internet ou por meio dos meus próprios espelhos?
