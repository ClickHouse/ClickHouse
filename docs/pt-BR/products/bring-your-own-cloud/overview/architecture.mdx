...
<div id="control-plane-communication">
  ### Comunicação com o plano de controle {#control-plane-communication}
</div>
...
<div id="key-requirements">
  ## Principais requisitos para BYOC {#key-requirements}
</div>
...
<div id="tailscale-private-network">
  ### Conexão de rede privada Tailscale {#tailscale-private-network}
</div>
