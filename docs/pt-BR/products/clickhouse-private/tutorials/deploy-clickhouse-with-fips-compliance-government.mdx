...
<Steps>
  <Step>
    ## Fase 1: Criar certificados compatíveis com FIPS
  ...
  <Step>
    ## Fase 2: Instalar os pré-requisitos do Kubernetes
  ...
  <Step>
    ## Fase 4: Criar Secrets de certificados
  ...
  <Step>
    ## Fase 5: Implantar o Cluster ClickHouse
