...
<Steps>
  <Step stepNumber={0}>
    ## Passo 0: Configuração da conta de serviço
  ...
  <Step stepNumber={1}>
    ## Passo 1: Definir Variáveis de Ambiente (`00-env.sh`)
  ...
  <Step stepNumber={2}>
    ## Etapa 2: Criar o Artifact Registry (`01-artifact-registry.sh`)
  ...
  <Step stepNumber={3}>
    ## Etapa 3: Copiar imagens de contêiner (`02-copy-images.sh`)
  ...
  <Step stepNumber={4}>
    ## Etapa 4: Configurar VPC e Subnet (`03-vpc-subnet.sh`)
  ...
  <Step stepNumber={5}>
    ## Etapa 5: Criar o Cloud NAT (`04-cloud-nat.sh`)
  ...
  <Step stepNumber={6}>
    ## Etapa 6: Criar conta de serviço do GCP (`05-service-account.sh`)
  ...
  <Step stepNumber={7}>
    ## Etapa 7: Criar um bucket no GCS (`06-gcs-bucket.sh`)
  ...
  <Step stepNumber={8}>
    ## Etapa 8: Criar cluster do GKE (`07-gke-cluster.sh`)
  ...
  <Step stepNumber={9}>
    ## Etapa 9: Criar Node Pools (`08-node-pools.sh`)
  ...
  <Step stepNumber={10}>
    ## Passo 10: Implantar o Conjunto de Daemon do Local SSD (`09-local-ssd-daemonset.sh`)
  ...
  <Step stepNumber={11}>
    ## Etapa 11: Adicionar rótulos de topologia (`10-topology-labels.sh`)
  ...
  <Step stepNumber={12}>
    ## Passo 12: Instalar os Pré-requisitos do Kubernetes
  ...
  <Step stepNumber={13}>
    ## Etapa 13: Etapas do FIPS (Condicional)
  ...
  <Step stepNumber={14}>
    ## Passo 14: Instalar o Operator (`16-install-operator.sh`)
  ...
  <Step stepNumber={15}>
    ## Passo 15: Implantar o ClickHouse Cluster (`17-install-cluster.sh`)
  ...
  <Step stepNumber={16}>
    ## Etapa 16: Vincular o Workload Identity (`18-bind-helm-workload-identity.sh`)
  ...
  <Step stepNumber={17}>
    ## Passo 17: Verifique a instalação
