...
Antes de solicitar o encerramento da conta, siga as etapas abaixo para prepará-la.

<Steps>
  <Step>
    ### 1. Exporte todos os dados que você precisa manter.
  ...
  <Step>
    ### 2. Pare e exclua seus serviços.

    > Isso interromperá o acúmulo de cobranças adicionais na sua conta
  </Step>

  <Step>
    ### 3. Remova todos os usuários, exceto o admin que solicitará o encerramento.

    > Isso evita atividades inesperadas na conta que possam impedir o encerramento
  </Step>

  <Step>
    ### 4. Revise as abas &#39;Usage&#39; e &#39;Billing&#39; para verificar se todas as cobranças foram pagas.
