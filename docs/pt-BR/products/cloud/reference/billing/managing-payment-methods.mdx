...
3. Na caixa de diálogo **Edit forma de pagamento**, você verá seu cartão de crédito atual listado como a forma de pagamento principal.
...
6. Clique em **Update forma de pagamento** para confirmar.
