...
<Steps>
  <Step title="Abra a caixa de diálogo de alertas de gastos" id="open-spend-alerts-dialog">
  ...
  <Step title="Configure e salve o alerta" id="configure-and-save">
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-config.webp" alt="Caixa de diálogo de alertas de gastos da organização com limite de gastos, alertas automáticos por limite e canais de notificação" size="md" />
  </Step>
</Steps>
