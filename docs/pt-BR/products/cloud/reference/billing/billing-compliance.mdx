...
<div id="billing-compliance">
  ## Conformidade de faturamento {#billing-compliance}
</div>
...
<div id="direct-payg">
  ### Cobrança Pay-As-You-Go com cartão de crédito {#direct-payg}
</div>
...
<div id="cloud-marketplace-payg">
  ### Faturamento Pay-As-You-Go do marketplace de nuvem {#cloud-marketplace-payg}
</div>
...
<div id="committed-spend-contract">
  ### Faturamento por contrato com compromisso de consumo {#committed-spend-contract}
</div>
...
<div id="marketplace-payg">
  ## Como pagar via marketplaces {#marketplace-payg}
</div>
