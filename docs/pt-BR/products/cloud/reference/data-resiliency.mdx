...
<div id="database-backups">
  ## Backups de banco de dados {#database-backups}
</div>
...
<div id="restoring-from-a-backup">
  ## Restauração a partir de um backup {#restoring-from-a-backup}
</div>
...
<div id="primary-service-data-corruption">
  ### Corrupção de dados do serviço primário {#primary-service-data-corruption}
</div>
...
<div id="primary-region-downtime">
  ### Indisponibilidade da região primária {#primary-region-downtime}
</div>
