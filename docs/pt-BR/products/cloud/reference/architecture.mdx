...
<div id="storage-backed-by-object-store">
  ## Armazenamento baseado em armazenamento de objetos {#storage-backed-by-object-store}
</div>
...
<div id="service-isolation">
  ## Isolamento de serviço {#service-isolation}
</div>
...
<div id="storage-isolation">
  ### Isolamento do armazenamento {#storage-isolation}
</div>
...
<div id="compute-compute-separation">
  ## computação-computação separation {#compute-compute-separation}
</div>
