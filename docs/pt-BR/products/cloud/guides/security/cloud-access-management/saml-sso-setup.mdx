...
Oferecemos suporte a SSO iniciado pelo provedor de serviço, várias organizações usando conexões separadas e provisionamento just-in-time. Também oferecemos suporte ao provisionamento SCIM em prévia privada com [Okta](/pt-BR/products/cloud/guides/security/cloud-access-management/scim-setup) e [Microsoft Entra ID](/pt-BR/products/cloud/guides/security/cloud-access-management/scim-setup-entra). Ainda não oferecemos suporte a mapeamento de atributos.
...
* Provisionamento SCIM — automatize o provisionamento de usuários e grupos com [Okta](/pt-BR/products/cloud/guides/security/cloud-access-management/scim-setup) ou [Microsoft Entra ID](/pt-BR/products/cloud/guides/security/cloud-access-management/scim-setup-entra) (prévia privada).
