...
## Gerenciar funções de banco de dados (beta) {#manage-database-roles}
...
<Tip>
  As funções de banco de dados gerenciadas pelo Cloud substituem as funções [`sql-console-role:<email>`](/pt-BR/products/cloud/guides/security/cloud-access-management/manage-database-users#sql-console-users-and-roles) atribuídas manualmente, que não são compatíveis com a [autenticação JWT](/pt-BR/products/cloud/guides/security/cloud-access-management/jwt-authentication-setup).
</Tip>
...
<div id="update-custom-role">
  ## Atualizar funções personalizadas {#update-custom-role}
</div>
...
<div id="delete-custom-role">
  ## Excluir funções personalizadas {#delete-custom-role}
</div>
