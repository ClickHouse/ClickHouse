---
sidebarTitle: 'Provisioning SCIM com Okta'
slug: /cloud/security/scim-setup
title: 'Provisioning SCIM com Okta'
description: 'Como configurar o Provisioning SCIM entre Okta e ClickHouse Cloud'
doc_type: 'guide'
...
Este guia mostra como configurar o Provisioning SCIM de ponta a ponta com o **Okta**. O endpoint SCIM do ClickHouse Cloud segue o SCIM 2.0 (RFC 7644). O Okta se autentica usando Basic Auth, que é o método usado neste guia. Se o seu provedor de identidade for o Microsoft Entra ID, siga o guia [Provisioning SCIM com Entra ID](/pt-BR/products/cloud/guides/security/cloud-access-management/scim-setup-entra).
...
<Steps>
  <Step title="Ative o SCIM" id="enable-scim-provisioning">
    ...
    ![Acesse a guia de configuração do SCIM em Configurações da organização](/images/cloud/security/scim-okta/scim-okta-01.webp)
