...
Para isso, configure seus Security Groups da AWS para permitir conexões do ClickHouse Cloud ao seu serviço de banco de dados interno/privado. Consulte os [endereços IP de egress padrão das regiões do ClickHouse Cloud](/pt-BR/products/cloud/guides/data-sources/cloud-endpoints-api), juntamente com os [endereços IP estáticos disponíveis](https://api.clickhouse.cloud/static-ips.json).