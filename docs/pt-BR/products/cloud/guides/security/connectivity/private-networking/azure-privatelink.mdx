...
<div id="option-1-using-azure-portal-to-create-a-private-endpoint-in-azure">
  ### Opção 1: Usar o Azure Portal para criar um Private Endpoint no Azure
</div>
...
* **Region**: Escolha a região em que a VNet implantada, que será conectada ao ClickHouse Cloud via Private Link, está localizada.

Depois de concluir as etapas acima, clique no botão **Next: Resource**.

<Image img="/images/cloud/security/azure-pe-create-basic.webp" size="md" alt="Criar Private Endpoint Basic" border />
...
* **Virtual network**: Escolha a VNet que você deseja conectar ao ClickHouse Cloud usando Private Link
...
<Image img="/images/cloud/security/azure-pe-create-vnet.webp" size="md" alt="Seleção da Virtual Network do Private Endpoint" border />
...
Opcionalmente, você pode adicionar tags ao seu Private Endpoint.
...
O **Connection status** do Private Endpoint criado ficará com o estado **Pending**. Ele mudará para o estado **Approved** assim que você adicionar esse Private Endpoint à lista de permissões do serviço.
