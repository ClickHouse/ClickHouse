...
<div id="working-with-your-restored-service">
  ## Trabalhando com seu serviço restaurado {#working-with-your-restored-service}
</div>
...
<div id="use-the-new-restored-service">
  ### Use o **novo serviço restaurado** {#use-the-new-restored-service}
</div>
...
<div id="migrate-data-from-the-newly-restored-service-back-to-the-original-service">
  ### Migre os dados do **serviço restaurado recentemente** de volta para o **serviço original** {#migrate-data-from-the-newly-restored-service-back-to-the-original-service}
</div>
...
<div id="undeleting-or-undropping-tables">
  ## Recuperando tabelas excluídas ou removidas {#undeleting-or-undropping-tables}
</div>
