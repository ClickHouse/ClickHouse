...
<Image img="/images/cloud/manage/scaling-patch-request.webp" size="lg" alt="Solicitação PATCH de escalonamento" border caption="Solicitação `PATCH` para atualizar `numReplicas`" />

<Image img="/images/cloud/manage/scaling-patch-response.webp" size="md" alt="Resposta PATCH de escalonamento" border caption="Resposta à solicitação `PATCH`" />
...
<Image img="/images/cloud/manage/scaling-configure.webp" size="md" alt="Configurações de escalonamento" border caption="Configurações de escalonamento do serviço no console do ClickHouse Cloud" />
