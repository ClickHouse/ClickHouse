...
| [Integração do Prometheus para ClickHouse Cloud](#clickhouse-cloud-prometheus-integration)                      | [clickhouse.com/docs](/pt-BR/products/cloud/features/monitoring/prometheus)                                                | Cloud       | Métricas                       |
