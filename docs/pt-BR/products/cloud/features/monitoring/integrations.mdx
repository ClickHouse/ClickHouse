...
| [Integração do Prometheus para ClickHouse Cloud](#clickhouse-cloud-prometheus-integration)                      | [clickhouse.com/docs](/pt-BR/integrations/prometheus)                                                | Cloud       | Métricas                       |
