...
Os limites do tier Basic de `100` bancos de dados e `500` tabelas aplicam-se apenas a serviços de réplica única nesse tier. Os serviços de réplica única nos tiers Scale e Enterprise usam as proteções padrão do serviço. Para mais detalhes, consulte [Limites de uso](/pt-BR/products/cloud/guides/best-practices/usagelimits).