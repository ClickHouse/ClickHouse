...
<Image img="/images/cloud/agent-builder/memory/memories.webp" alt="Painel Memories mostrando o ícone de cérebro destacado na navegação à esquerda, um campo de filtro, um botão Add, uma caixa de seleção Use memory, uma entrada de memória com controles de edição e exclusão e um botão Admin Settings" size="sm" />
