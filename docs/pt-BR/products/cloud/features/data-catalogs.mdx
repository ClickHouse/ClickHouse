...
| Unity Catalog        | Iceberg e Delta (somente locais de armazenamento externo) | Credenciais de cliente OAuth               | Cloud (somente Iceberg) &amp; [Core](/pt-BR/guides/use-cases/data-warehousing/unity-catalog) | 25.10+ |
