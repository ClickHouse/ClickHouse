...
<Image img="/images/cloud/reference/compute-compute-1.webp" size="md" alt="Serviço único no ClickHouse Cloud" caption="Fig. 1 - Serviço único no ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-2.webp" size="md" alt="Separação de compute no ClickHouse Cloud" caption="Fig. 2 - Separação de compute no ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-8.webp" size="lg" alt="Exemplo de warehouse com serviços primário e secundário" background="white" caption="Fig. 3 - Exemplo de warehouse" />
...
<Image img="/images/cloud/reference/compute-compute-3.webp" size="md" alt="Acesso de usuários entre serviços que compartilham os mesmos dados" caption="Fig. 4 - A usuária Alice foi criada no Serviço 1, mas pode usar as mesmas credenciais para acessar todos os serviços que compartilham os mesmos dados" />
...
<Image img="/images/cloud/reference/compute-compute-4.webp" size="md" alt="Configurações de controle de acesso à rede" caption="Fig. 5 - Alice está impedida de acessar o serviço 2 por causa das configurações de controle de acesso à rede" />
...
<Image img="/images/cloud/reference/compute-compute-5.webp" size="lg" alt="Serviços read-write e read-only em um warehouse" caption="Fig. 6 - Serviços read-write e read-only em um warehouse" />
...
<Image img="/images/cloud/reference/compute-compute-7.webp" size="md" alt="Criando um novo serviço em um warehouse" caption="Fig. 7 - Clique no sinal de mais para criar um novo serviço em um warehouse" />
