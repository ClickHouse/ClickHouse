...
<div id="access-controls">
  ## Controles de acesso {#access-controls}
</div>
...
<div id="setup-warehouses">
  ## Como configurar um warehouse {#setup-warehouses}
</div>
...
<div id="renaming-a-warehouse">
  ### Renomeando um warehouse {#renaming-a-warehouse}
</div>
...
<div id="deleting-a-warehouse">
  ### Excluindo um warehouse {#deleting-a-warehouse}
</div>
