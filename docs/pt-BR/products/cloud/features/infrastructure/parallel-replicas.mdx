...
<div id="managing-cache-locality">
  ### Gerenciando a localidade do cache {#managing-cache-locality}
</div>
...
<div id="task-stealing">
  ### Roubo de tarefas {#task-stealing}
</div>
...
<div id="settings-related-to-parallel-replicas">
  ## Configurações relacionadas a réplicas paralelas {#settings-related-to-parallel-replicas}
</div>
...
## Investigando problemas com réplicas paralelas {#investigating-issues-with-parallel-replicas}
