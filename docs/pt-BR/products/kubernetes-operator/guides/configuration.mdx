---
position: 2
slug: /pt-BR/products/kubernetes-operator/guides/configuration
...
<div id="clickhousecluster-configuration">
  ## Configuração do ClickHouseCluster {#clickhousecluster-configuration}
</div>
...
<div id="replicas-and-shards">
  ### Réplicas e shards {#replicas-and-shards}
</div>
...
<div id="keeper-integration">
  ### Integração com o Keeper {#keeper-integration}
</div>
...
<div id="keepercluster-configuration">
  ## Configuração do KeeperCluster {#keepercluster-configuration}
</div>
...
<div id="cluster-domain">
  ## Domínio do cluster {#cluster-domain}
</div>
...
<div id="pod-configuration">
  ## Configuração do pod do Kubernetes {#pod-configuration}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencepodtemplatespec-for-all-supported-pod-template-options">
  ### Consulte a [Referência da API](/pt-BR/products/kubernetes-operator/reference/api-reference#podtemplatespec) para ver todas as opções de template de pod do Kubernetes compatíveis. {#see-api-reference-for-all-supported-pod-template-options}
</div>

<div id="pod-disruption-budgets">
  ## Orçamentos de interrupção de pods {#pod-disruption-budgets}
</div>
...
<div id="pdb-overrides">
  ### Substituindo os padrões {#pdb-overrides}
</div>
...
<div id="pdb-cluster-wide-disable">
  ### Desativação em nível de cluster {#pdb-cluster-wide-disable}
</div>
...
<div id="container-configuration">
  ## Configuração do contêiner {#container-configuration}
</div>

<div id="custom-image">
  ### Imagem personalizada {#custom-image}
</div>
...
<div id="container-resources">
  ### Recursos de contêiner {#container-resources}
</div>
...
<div id="volume-mounts">
  ### Montagem de volumes {#volume-mounts}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencecontainertemplatespec-for-all-supported-container-template-options">
  ### Consulte a [Referência da API](/pt-BR/products/kubernetes-operator/reference/api-reference#containertemplatespec) para ver todas as opções de template de contêiner suportadas. {#see-api-reference-for-all-supported-container-template-options}
</div>

<div id="tls-ssl-configuration">
  ## Configuração de TLS/SSL {#tls-ssl-configuration}
</div>

<div id="configure-secure-endpoints">
  ### Configure endpoints seguros {#configure-secure-endpoints}
</div>
...
<div id="ssl-certificate-secret-format">
  ### Formato do Secret de certificado SSL {#ssl-certificate-secret-format}
</div>
...
<div id="clickhouse-keeper-communication-over-tls">
  ### Comunicação entre ClickHouse e Keeper via TLS {#clickhouse-keeper-communication-over-tls}
</div>
...
<div id="external-secret-required-keys">
  ### Chaves obrigatórias {#external-secret-required-keys}
</div>
...
<div id="external-secret-status">
  ### Condição de status e solução de problemas {#external-secret-status}
</div>
...
<div id="additional-ports">
  ## Portas adicionais {#additional-ports}
</div>
...
<div id="additional-ports-mysql-example">
  ### Exemplo completo: MySQL wire protocol {#additional-ports-mysql-example}
</div>
...
<div id="additional-ports-constraints">
  ### Restrições de campo {#additional-ports-constraints}
</div>
...
<div id="additional-ports-reserved">
  ### Portas e nomes reservados {#additional-ports-reserved}
</div>
...
<div id="version-probe-and-upgrade-channel">
  ## Sonda de versão e canal de upgrade {#version-probe-and-upgrade-channel}
</div>
...
<div id="upgrade-channel-choosing">
  ### Escolhendo um canal de lançamento {#upgrade-channel-choosing}
</div>
...
<div id="version-status-conditions">
  ### Condições de status {#version-status-conditions}
</div>
...
<div id="version-probe-template">
  ### Sobrescrevendo o Job da sonda de versão {#version-probe-template}
</div>
...
<div id="version-operator-flags">
  ### Controles gerais do operador {#version-operator-flags}
</div>
...
<div id="default-user-password">
  ### Senha do usuário `default` {#default-user-password}
</div>
...
<div id="default-password-secret-example">
  #### Exemplo completo com um Secret {#default-password-secret-example}
</div>
...
<div id="using-configmap-for-user-passwords">
  #### Usando um ConfigMap {#using-configmap-for-user-passwords}
</div>
...
<div id="database-sync">
  ### Sincronização do banco de dados {#database-sync}
</div>
...
<div id="server-logging">
  ### Logging do servidor {#server-logging}
</div>
...
<div id="embedded-extra-configuration">
  ### Configuração adicional embutida {#embedded-extra-configuration}
</div>
...
<div id="embedded-extra-users-configuration">
  ### Configuração embutida de usuários adicionais {#embedded-extra-users-configuration}
</div>
...
<div id="see-documentationconceptsfeaturesconfigurationsettingssettings-users-for-all-supported-clickhouse-users-configuration-options">
  #### Consulte a [documentação](/pt-BR/concepts/features/configuration/settings/settings-users) para ver todas as opções de configuração de usuários do ClickHouse suportadas. {#see-documentation-for-all-supported-clickhouse-users-configuration-options}
</div>

<div id="configuration-example">
  ### Exemplo de configuração {#configuration-example}
</div>
