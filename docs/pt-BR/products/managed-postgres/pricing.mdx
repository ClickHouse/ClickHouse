...
<div id="price-performance">
  ## Relação preço-desempenho {#price-performance}
</div>
...
<div id="tier-based-pricing">
  ### Preços por tier {#tier-based-pricing}
</div>
...
<div id="pricing-calculator">
  ## Calculadora de preços {#pricing-calculator}
</div>
...
## Destaques do preço Beta {#beta-pricing-highlights}

### Preços do Public Beta na AWS {#aws-public-beta-pricing}
...
### Preços do Private Preview no GCP {#gcp-private-preview-pricing}
