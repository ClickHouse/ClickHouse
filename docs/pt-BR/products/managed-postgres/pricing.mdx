...
As configurações de instância são agrupadas em três categorias para simplificar a seleção da infraestrutura com base nas características da carga de trabalho. Nem todos os tipos de instância estão disponíveis em todas as regiões da AWS.
