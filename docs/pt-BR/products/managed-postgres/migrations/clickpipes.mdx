...
<Note>
  Se você encontrar problemas durante a migração, consulte o [FAQ de Migrações do Managed Postgres](/pt-BR/cloud/managed-postgres/migrations/faq) para ver os erros e as soluções mais comuns.
</Note>
