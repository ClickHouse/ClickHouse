...
## Migração automatizada de esquema
...
### Importe o esquema para seu serviço Managed Postgres
...
### Etapa 1: Colocar o banco de dados Postgres de origem em modo somente leitura
...
### Passo 2: Validar contagens de linhas
...
### Etapa 5: Faça a transição do tráfego
