...
[tutorial do ClickHouse]: /pt-BR/get-started/sample-datasets/nyc-taxi "Tutorial avançado do ClickHouse"
...
[Atualização de dados de dicionário usando LIFETIME]: /reference/statements/create/dictionary/lifetime "Documentação do ClickHouse: Atualização de dados de dicionário usando LIFETIME"
