...
<Steps>
  ...
  <Step>
    ...
    * **Remove deleted rows during merges**: Para [ReplacingMergeTree](/pt-BR/reference/engines/table-engines/mergetree-family/replacingmergetree) tables, remove fisicamente as linhas excluídas durante os merges em segundo plano
