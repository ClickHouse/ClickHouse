...
O Private Link permite conectividade privada entre sua instância do ClickHouse Managed Postgres e sua Virtual Private Cloud (VPC), sem expor o tráfego à internet pública. Isso oferece uma camada adicional de isolamento e segurança de rede.
...
Para habilitar o Private Link para sua instância de ClickHouse Managed Postgres:
