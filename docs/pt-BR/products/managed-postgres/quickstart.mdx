...
<Visibility for="humans">
  <View title="UI do Cloud">
    ...
    * Consulte o ClickHouse diretamente do Postgres usando `pg_clickhouse`
    ...
    ## Parte 1: Primeiros passos com NVMe Postgres {#part-1}

    ### Criar um banco de dados {#create-postgres-database}
    ...
    ### Conecte-se ao seu banco de dados {#connect}
    ...
    ### Experimente o desempenho com NVMe {#nvme-performance}
    ...
    ### Execute consultas nos seus dados {#run-queries}
    ...
    ***
    ...
    ## Parte 2: Adicione análises em tempo real com ClickHouse {#part-2}
    ...
    * **ClickHouse** para analytics em menos de um segundo em bilhões de linhas
    ...
    ### Configurar a integração com o ClickHouse {#setup-integrate-clickhouse}
    ...
    * Clique em **Replicar dados no ClickHouse**.
    ...
    ### Consulte o ClickHouse a partir do Postgres {#pg-clickhouse-extension}
    ...
    ### Veja suas análises em ação {#analytics-after-integration}
    ...
    ### Compare o desempenho do Postgres vs ClickHouse {#performance-comparison}
