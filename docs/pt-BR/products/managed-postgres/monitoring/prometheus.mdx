...
[cloud-api]: /pt-BR/products/cloud/features/admin-features/api/api-overview "Cloud API"

[API keys]: /pt-BR/products/cloud/features/admin-features/api/openapi "Gerenciar chaves de API"