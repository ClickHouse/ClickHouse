---
slug: /pt-BR/products/managed-postgres/scaling
...
<div id="choosing-instance">
  ### Como escolher o tipo de instância certo {#choosing-instance}
</div>
...
<div id="scaling-process">
  ### Processo de escalonamento {#scaling-process}
</div>
...
<div id="scaling-duration">
  ### Duração do escalonamento {#scaling-duration}
</div>
...
<div id="scaling-strategies">
  ## Estratégias de escalonamento {#scaling-strategies}
</div>
...
<div id="read-replicas">
  ### Réplicas de leitura para escalabilidade horizontal {#read-replicas}
</div>
...
<div id="cdc-scaling">
  ### Escalonamento de CDC para a integração com o ClickHouse {#cdc-scaling}
</div>

Se você estiver replicando dados para o ClickHouse usando [ClickPipes](/pt-BR/products/managed-postgres/clickpipes), poderá escalar de forma independente o pipeline de CDC (captura de alterações de dados):
