---
slug: /pt-BR/products/managed-postgres/read-replicas
...
<div id="why-use-read-replicas">
  ## Por que usar réplicas de leitura {#why-use-read-replicas}
</div>
...
<div id="wal-shipping-from-object-storage">
  ### WAL shipping a partir do armazenamento de objetos {#wal-shipping-from-object-storage}
</div>
...
<div id="why-we-chose-this-approach">
  ### Por que escolhemos esta abordagem {#why-we-chose-this-approach}
</div>
...
<div id="replication-lag-characteristics">
  ### Características da defasagem de replicação {#replication-lag-characteristics}
</div>
