...
Se deixarmos em branco, o banco de dados ficará em memória e será perdido assim que encerrarmos o processo do Python.
...
Usaremos a configuração [`schema_inference_make_columns_nullable`](/pt-BR/reference/settings/formats#schema_inference_make_columns_nullable) para que os tipos de coluna não sejam todos convertidos em `Nullable`.
