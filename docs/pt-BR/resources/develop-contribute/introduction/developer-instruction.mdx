...
- `arg1` — Description of the argument. [DataType](/pt-BR/reference/data-types/float)
- `arg2` — Description of the argument. [DataType](/pt-BR/reference/data-types/float)
- `arg3` — Description of optional argument (optional). [DataType](/pt-BR/reference/data-types/float)
...
- Returns {insert what the function returns here}. [DataType](/pt-BR/reference/data-types/float)
