...
Se você quiser visualizar as alterações na documentação, as instruções de como fazer a compilação da página de documentação localmente estão disponíveis no arquivo README.md [aqui](https://github.com/ClickHouse/clickhouse-docs).
