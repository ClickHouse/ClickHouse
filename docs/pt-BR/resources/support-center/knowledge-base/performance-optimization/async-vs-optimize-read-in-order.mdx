...
<Image img="/images/knowledgebase/sync_read.webp" size="md" alt="Diagrama de leitura síncrona de dados" />
...
<Image img="/images/knowledgebase/async_read.webp" size="md" alt="Diagrama de leitura assíncrona de dados" />
