...
<Steps>
  <Step title="Criar embeddings">
    ...
    Você pode pensar em um embedding como um grande vetor de números de ponto flutuante que representa seus dados. [Confira este guia da OpenAI para saber mais sobre embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings).
  </Step>
