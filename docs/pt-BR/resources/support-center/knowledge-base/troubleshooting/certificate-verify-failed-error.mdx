...
Como alternativa, aponte seu cliente diretamente para o pacote do certifi. [ClickHouse Connect](/pt-BR/integrations/language-clients/python) não usa o certifi automaticamente como alternativa, portanto passe o pacote pelo parâmetro `ca_cert`:
