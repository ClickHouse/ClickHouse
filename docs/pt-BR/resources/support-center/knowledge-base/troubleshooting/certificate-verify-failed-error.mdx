...
Como alternativa, aponte seu cliente diretamente para o pacote do certifi. [ClickHouse Connect](/pt-BR/integrations/python) não usa o certifi automaticamente como alternativa, portanto passe o pacote pelo parâmetro `ca_cert`:
...
Consulte a [documentação de configuração do `clickhouse-client`](/pt-BR/interfaces/client#configuration_files).