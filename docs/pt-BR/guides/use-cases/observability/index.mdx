...
O ClickHouse pode armazenar métricas do Prometheus em uma tabela [`TimeSeries`](/pt-BR/reference/engines/table-engines/integrations/time-series) e executar consultas PromQL. Consulte [Protocolos do Prometheus e PromQL](/pt-BR/interfaces/prometheus) para configurar a ingestão, as consultas e as visualizações.