...
Para gravação, o Iceberg exige [allow&#95;insert&#95;into&#95;iceberg](/pt-BR/reference/settings/session-settings/allow#allow_insert_into_iceberg) (25.7+, Beta a partir da 26.2). Consulte [Gravando em lagos de dados](/pt-BR/guides/use-cases/data-warehousing/getting-started/writing-data). O Delta Lake exige [allow&#95;delta&#95;lake&#95;writes](/pt-BR/reference/settings/session-settings/allow-experimental#allow_experimental_delta_lake_writes) (25.9+). A [matriz de suporte](/pt-BR/guides/use-cases/data-warehousing/support-matrix) lista quais flags se aplicam a cada formato e operação.
