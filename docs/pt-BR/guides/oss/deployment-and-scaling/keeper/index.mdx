...
<div id="keeper-configuration-settings">
  #### Configurações do Keeper {#keeper-configuration-settings}
</div>
...
<div id="internal-coordination-settings">
  #### Configurações internas de coordenação {#internal-coordination-settings}
</div>
...
<div id="migration-from-zookeeper">
  ### Migração do ZooKeeper {#migration-from-zookeeper}
</div>
...
<div id="pre-migration-preparation">
  #### Preparação para a migração {#pre-migration-preparation}
</div>
...
<div id="consolidating-multiple-zookeeper-clusters">
  #### Consolidando vários clusters do ZooKeeper {#consolidating-multiple-zookeeper-clusters}
</div>
...
<div id="handling-encryption-and-acls">
  #### Como lidar com criptografia e ACLs {#handling-encryption-and-acls}
</div>
...
<div id="verifying-the-migration">
  #### Verificando a migração {#verifying-the-migration}
</div>
...
<div id="post-migration-tuning">
  #### Ajustes pós-migração {#post-migration-tuning}
</div>
...
<div id="recovering-after-losing-quorum">
  ### Recuperação após perder quórum {#recovering-after-losing-quorum}
</div>
...
<div id="using-disks-with-keeper">
  ## Usando discos com Keeper {#using-disks-with-keeper}
</div>
...
<div id="changing-disk-setup">
  ### Alterando a configuração de disco {#changing-disk-setup}
</div>
...
<div id="clickhouse-keeper-user-guide">
  ## Guia do usuário do ClickHouse Keeper {#clickhouse-keeper-user-guide}
</div>
...
<div id="configuring-clickhouse-keeper-with-unique-paths">
  ## Configurando o ClickHouse Keeper com caminhos exclusivos {#configuring-clickhouse-keeper-with-unique-paths}
</div>
...
<div id="example-environment">
  ### Ambiente de Example {#example-environment}
</div>
...
<div id="procedures-to-set-up-tables-to-use-uuid">
  ### Procedimentos para configurar tabelas para usarem `{uuid}` {#procedures-to-set-up-tables-to-use-uuid}
</div>
...
<div id="reconfiguration">
  ## Reconfiguração dinâmica do ClickHouse Keeper {#reconfiguration}
</div>
...
<div id="converting-a-single-node-keeper-into-a-cluster">
  ## Convertendo um keeper de nó único em um cluster {#converting-a-single-node-keeper-into-a-cluster}
</div>
...
<div id="unsupported-features">
  ## Recursos não suportados {#unsupported-features}
</div>
