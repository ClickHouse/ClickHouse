---
slug: /pt-BR/guides/oss/deployment-and-scaling/examples/2-shards-2-replicas
...
#### Configuração do cluster {#cluster-config}
...
### Configuração de usuário {#cluster-configuration}
...
### Configuração do Keeper {#configuration-explanation}
