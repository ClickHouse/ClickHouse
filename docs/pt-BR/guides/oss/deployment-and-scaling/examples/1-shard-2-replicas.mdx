---
slug: /pt-BR/guides/oss/deployment-and-scaling/examples/1-shard-2-replicas
...
#### Configuração do Keeper {#keeper-config-explanation}
...
#### Configuração de macros {#macros-config-explanation}
...
### Configuração de usuário {#user-config}
...
### Configuração do ClickHouse Keeper {#configuration-explanation}
