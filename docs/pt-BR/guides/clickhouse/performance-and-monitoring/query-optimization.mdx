...
Esperamos que este guia tenha ajudado você a entender melhor como investigar consultas lentas no ClickHouse e como torná-las mais rápidas. Para se aprofundar no tema, leia mais sobre o [analisador de consultas](/pt-BR/guides/clickhouse/performance-and-monitoring/analyzer) e [profiling](/pt-BR/concepts/features/performance/troubleshoot/sampling-query-profiler) para entender com mais clareza como o ClickHouse executa sua consulta.

À medida que você se familiariza com as particularidades do ClickHouse, recomendamos a leitura sobre [chaves de particionamento](/pt-BR/concepts/best-practices/partitioning-keys) e [data skipping indexes](/pt-BR/concepts/features/performance/skip-indexes/skipping-indexes) para conhecer técnicas mais avançadas que podem acelerar suas consultas.