...
Representa o conteúdo de uma projeção em tabelas MergeTree. Pode ser usada para introspecção.
...
| Argumento    | Descrição                                        |
| ------------ | ------------------------------------------------ |
| `database`   | O nome do banco de dados de onde ler a projeção. |
| `table`      | O nome da tabela de onde ler a projeção.         |
| `projection` | A projeção a ser lida.                           |

<div id="returned_value">
  ## Valor retornado
</div>

Um objeto de tabela com as colunas fornecidas pela projeção especificada.
