---
description: 'Representa o conteúdo dos arquivos de índice e de marcas de tabelas MergeTree.
...
Representa o conteúdo dos arquivos de índice e de marcas de tabelas MergeTree. Pode ser usado para introspecção.
...
| Argumento     | Descrição                                                          |
| ------------- | ------------------------------------------------------------------ |
| `database`    | O nome do banco de dados do qual o índice e as marcas serão lidos. |
| `table`       | O nome da tabela da qual o índice e as marcas serão lidos.         |
...
Um objeto do tipo tabela com colunas contendo valores do índice primário e do índice min-max (se habilitado) da tabela de origem, colunas contendo valores de marcas (se habilitado) para todos os arquivos possíveis nas partes de dados da tabela de origem e colunas virtuais:
...
A coluna de marcas pode conter o valor `(NULL, NULL)` caso a coluna esteja ausente da parte de dados ou as marcas de um de seus subfluxos não tenham sido gravadas (por exemplo, em partes compactas).
