...
O ClickHouse oferece vários tipos inteiros de comprimento fixo,
com sinal (`Int`) ou sem sinal (`UInt`), que variam de um byte a 32 bytes.

Ao criar tabelas, é possível definir parâmetros numéricos para inteiros (por exemplo, `TINYINT(8)`, `SMALLINT(16)`, `INT(32)`, `BIGINT(64)`), mas o ClickHouse os ignora.
