...
description: 'Guia para configurar e usar scripts SQL de inicialização no ClickHouse para
  criação automática de esquema e migrações'
sidebar_label: 'Scripts de inicialização'
slug: /operations/startup-scripts
title: 'Scripts de inicialização'
doc_type: 'guide'
---

O ClickHouse pode executar consultas SQL arbitrárias definidas na configuração do servidor durante a inicialização. Isso pode ser útil para migrações ou para a criação automática de esquema.
