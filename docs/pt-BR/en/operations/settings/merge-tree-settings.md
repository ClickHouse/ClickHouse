---
description: 'Configurações do MergeTree presentes em `system.merge_tree_settings`'
...
Configure o valor padrão para todas as tabelas `MergeTree` no arquivo de configuração do servidor:
...
Defina para uma tabela específica:
...
{/* As configurações abaixo são geradas automaticamente pelo script localizado em 
