---
description: 'Tabela de sistema com informações sobre as configurações globais do servidor,
...
No momento, a tabela mostra apenas as configurações da primeira camada de `config.xml` e não oferece suporte a configurações aninhadas (por exemplo, [logger](../../operations/server-configuration-parameters/settings.md#logger)).
...
* `name` ([String](/pt-BR/sql-reference/data-types/string)) — Nome da configuração do servidor.
* `value` ([String](/pt-BR/sql-reference/data-types/string)) — Valor da configuração do servidor.
* `default` ([String](/pt-BR/sql-reference/data-types/string)) — Valor padrão da configuração do servidor.
* `changed` ([UInt8](/pt-BR/sql-reference/data-types/int-uint)) — Indica se uma configuração foi especificada em config.xml
* `description` ([String](/pt-BR/sql-reference/data-types/string)) — Breve descrição da configuração do servidor.
* `type` ([String](/pt-BR/sql-reference/data-types/string)) — Tipo de valor da configuração do servidor.
* `changeable_without_restart` ([Enum8(&#39;No&#39; = 0, &#39;IncreaseOnly&#39; = 1, &#39;DecreaseOnly&#39; = 2, &#39;Yes&#39; = 3)](/pt-BR/sql-reference/data-types/enum)) — Indica se uma configuração pode ser alterada em tempo de execução.
* `is_obsolete` ([UInt8](/pt-BR/sql-reference/data-types/int-uint)) — Indica se uma configuração está obsoleta.
...
* [Configurações](../../operations/system-tables/settings.md)
* [Arquivos de configuração](../../operations/configuration-files.md)
* [Configurações do servidor](../../operations/server-configuration-parameters/settings.md)