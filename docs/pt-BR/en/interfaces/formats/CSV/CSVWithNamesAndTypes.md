...
Também imprime duas linhas de cabeçalho com os nomes e tipos das colunas, assim como [TabSeparatedWithNamesAndTypes](../formats/TabSeparatedWithNamesAndTypes).
...
Usando o seguinte arquivo CSV, chamado `football_types.csv`:
...
Insira dados usando o formato `CSVWithNamesAndTypes`:
...
A saída será um CSV com duas linhas de cabeçalho: uma para os nomes das colunas e outra para os tipos:
