...
Neste formato, o ClickHouse gera cada linha como um objeto JSON separado, um por linha.
...
Leia os dados no formato `JSONEachRow`:
...
As colunas de dados com nomes desconhecidos serão ignoradas durante a importação se a configuração [input&#95;format&#95;skip&#95;unknown&#95;fields](/pt-BR/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) estiver definida como 1.
