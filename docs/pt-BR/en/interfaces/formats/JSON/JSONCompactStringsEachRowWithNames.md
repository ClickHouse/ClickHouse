...
Difere do formato [`JSONCompactEachRow`](./JSONCompactEachRow.md) por também exibir a linha de cabeçalho com os nomes das colunas, de forma semelhante ao formato [TabSeparatedWithNames](../TabSeparated/TabSeparatedWithNames.md).
...
Leia os dados no formato `JSONCompactStringsEachRowWithNames`:
