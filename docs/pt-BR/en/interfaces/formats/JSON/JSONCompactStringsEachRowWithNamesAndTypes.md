---
description: 'Documentação do formato JSONCompactStringsEachRowWithNamesAndTypes'
...
Diferencia-se do formato `JSONCompactEachRow` por também exibir duas linhas de cabeçalho com nomes e tipos de colunas, de forma semelhante a [TabSeparatedWithNamesAndTypes](/pt-BR/interfaces/formats/TabSeparatedRawWithNamesAndTypes).
...
Use um arquivo JSON chamado `football.json`, com os dados a seguir:
...
Use o formato `JSONCompactStringsEachRowWithNamesAndTypes` para ler os dados:
...
as colunas dos dados de entrada serão mapeadas para as colunas da tabela com base em seus nomes; colunas com nomes desconhecidos serão ignoradas se a configuração [input&#95;format&#95;skip&#95;unknown&#95;fields](/pt-BR/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) estiver definida como 1.
