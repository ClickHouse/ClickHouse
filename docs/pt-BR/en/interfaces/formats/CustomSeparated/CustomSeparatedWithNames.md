...
Também imprime a linha de cabeçalho com os nomes das colunas, assim como em [TabSeparatedWithNames](../TabSeparated/TabSeparatedWithNames.md).
...
Leia os dados usando o formato `CustomSeparatedWithNames`:
...
e colunas com nomes desconhecidos serão ignoradas se a configuração [`input_format_skip_unknown_fields`](../../../operations/settings/settings-formats.md/#input_format_skip_unknown_fields) estiver definida como `1`.
