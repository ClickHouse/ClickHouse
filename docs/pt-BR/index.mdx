  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="Analytics em tempo real" description="Ofereça insights instantâneos e dashboards em escala. Analise bilhões de linhas em tempo real com resultados em milissegundos." href="/pt-BR/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="Observabilidade" description="Armazene e consulte logs, métricas e traces em escala usando o ClickStack, a stack de observabilidade open source com tecnologia ClickHouse." href="/pt-BR/clickstack/overview" showArrow />

        <HeroCard title="Armazenamento de dados" description="Analise e explore dados instantaneamente para obter insights e criar aplicativos. Escale mais rápido descarregando workloads intensivas." href="/pt-BR/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="Analytics agêntica" description="Permita que agentes de IA consultem diretamente seus dados em tempo real para gerar insights conversacionais e visualizações instantâneas" href="/pt-BR/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="Plataforma de engenharia de LLM de código aberto para observabilidade, métricas, avaliações e gerenciamento de prompts." href="https://langfuse.com/docs" showArrow external />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Operator do Kubernetes" description="Automatiza a implantação, configuração e gerenciamento de clusters ClickHouse e ClickHouse Keeper no Kubernetes." href="/pt-BR/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="Um banco de dados rápido, confiável e escalável que roda no próprio processo. Experimente o poder do ClickHouse no próprio processo." href="/pt-BR/products/chdb/index" showArrow />
        </div>
      </div>
