...
export const IntegrationsBanner = () => {
    const assetBase = typeof window !== 'undefined' && window.location.pathname.startsWith('/docs') ? '/docs' : '';
    const href = '/pt-BR/integrations/home';
    return (
        <a
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "guia de início rápido", href: "/pt-BR/get-started/quickstarts/home" },
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Referência SQL", href: "/pt-BR/reference/statements" },
        { label: "Configurações", href: "/pt-BR/reference/settings/index" },
        { label: "Funções", href: "/pt-BR/reference/functions/regular-functions/overview" },
        { label: "Motores", href: "/pt-BR/reference/engines/engines" },
        { label: "Tabelas do sistema", href: "/pt-BR/reference/system-tables" },
        { label: "Formatos", href: "/pt-BR/reference/formats/index" },
        { label: "Tipos de dados", href: "/pt-BR/reference/data-types/index" }
    ]}
        />
        ...
        { label: "Operator do Kubernetes", href: "/pt-BR/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              { label: "2. Boas práticas para organizar dados para analytics e crescimento", href: "/pt-BR/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. Formas de consultar grandes conjuntos de dados em tempo real", href: "/pt-BR/get-started/use-cases/real-time-analytics" },
              { label: "4. Como criar dashboards, alertas e funcionalidades orientadas a eventos sobre a mesma plataforma", href: "/pt-BR/get-started/use-cases/data-warehousing" },
              { label: "5. Dicas para manter os custos baixos sem perder desempenho", href: "/pt-BR/concepts/best-practices/index" },
          ]}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" galaxyEvent="docs.home.chdb" description="Um banco de dados rápido, confiável e escalável que roda no próprio processo. Experimente o poder do ClickHouse no próprio processo." href="/chdb/index" showArrow />
        </div>
      </div>
