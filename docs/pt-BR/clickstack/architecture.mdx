---
slug: /pt-BR/clickstack/architecture
...
### ClickHouse Cloud: o mecanismo {#clickhouse-cloud}
...
### OpenTelemetry collector: ingestão de dados {#open-telemetry-collector-managed}
...
### ClickStack UI (HyperDX): a interface {#hyperdx}
...
### ClickHouse: o mecanismo de banco de dados {#clickhouse}
...
### Coletor OpenTelemetry: ingestão de dados {#open-telemetry-collector}
...
### UI do ClickStack (HyperDX): a interface {#hyperdx-ui}
...
### MongoDB: estado da aplicação {#mongo}
