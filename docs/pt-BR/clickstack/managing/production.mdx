...
### Proteja a ingestão {#secure-ingestion-managed}
...
#### Crie um usuário de ingestão {#create-a-database-ingestion-user-managed}
...
### Configure o Time To Live (TTL) {#configure-ttl-managed}
...
### Estimativa de recursos {#estimating-resources}
...
#### Isolando cargas de trabalho de leitura e gravação {#isolating-read-write}
...
### Segurança de rede e portas {#network-security}
...
### Configuração de Secret de sessão {#session-secret}
...
### Ingestão segura {#secure-ingestion}
...
#### Criar um usuário de ingestão {#create-a-database-ingestion-user-oss}
...
#### Melhores práticas de segurança {#self-managed-security}
...
#### Permissões de usuário para a ClickStack UI {#user-permissions}
...
### Diretrizes do MongoDB {#mongodb-guidelines}
