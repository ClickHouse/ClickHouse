...
<Tabs>
  ...
  <Tab title="Configurações da equipe do ClickStack">
    <Image img="/images/clickstack/rbac/team-page-clickstack.webp" alt="Página Configurações da equipe do ClickStack mostrando os membros da equipe e suas funções" size="lg" />
  </Tab>
</Tabs>
