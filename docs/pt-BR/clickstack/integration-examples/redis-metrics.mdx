...
<Steps>
  <Step>
    #### <TrackedLink href={'https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/redis-metrics-dashboard.json'} download="redis-metrics-dashboard.json" eventName="docs.redis_metrics_monitoring.dashboard_download">Baixe</TrackedLink> a configuração do painel
  </Step>
  ...
  <Step>
    ...
    <Note>
      Para o dataset de demonstração, defina o intervalo de tempo como **2025-10-20 05:00:00 - 2025-10-21 05:00:00 (UTC)** (ajuste com base no seu fuso horário local). O painel importado não terá um intervalo de tempo especificado por padrão.
    </Note>
  </Step>
</Steps>
