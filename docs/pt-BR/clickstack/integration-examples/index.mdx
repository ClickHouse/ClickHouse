...
| Seção                                                                          | Descrição                                      |
| ------------------------------------------------------------------------------ | ---------------------------------------------- |
| [Logs genéricos de host](/pt-BR/clickstack/integration-examples/host-logs)           | Colete logs do sistema do host                 |
| [Logs de host do EC2](/pt-BR/clickstack/integration-examples/host-logs/ec2)          | Monitore os logs da instância EC2              |
