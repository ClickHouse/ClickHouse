---
slug: /pt-BR/clickstack/deployment/managed
title: 'Gerenciado'
...
### Iniciar um collector {#start-a-collector-existing}
...
### Configurar collectors existentes {#configure-existing-collectors-existing}
...
### Iniciar a ingestão (opcional) {#start-ingestion-existing}
...
### Crie um banco de dados e uma tabela {#create-database-and-tables}
...
<div id="clickstack-read-only-compute">
  ### Usando o ClickStack com capacidade computacional somente leitura {#clickstack-read-only-compute}
</div>
...
<div id="how-clickstack-selects-compute">
  #### Como o ClickStack seleciona a capacidade computacional {#how-clickstack-selects-compute}
</div>
...
<div id="recommended-setup">
  #### Configuração recomendada {#recommended-setup}
</div>
...
<div id="adding-data-sources">
  ### Adicionando mais fontes de dados {#adding-data-sources}
</div>
...
<div id="using-custom-schemas">
  #### Usando esquemas personalizados {#using-custom-schemas}
</div>
