...
Consulte a documentação de [AWS PrivateLink para ClickPipes](/pt-BR/integrations/clickpipes/networking/aws-privatelink) para mais detalhes. Entre em contato com o suporte do ClickHouse para obter ajuda.