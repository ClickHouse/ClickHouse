...
<Info>
  Antes de começar a adicionar os detalhes da conexão, certifique-se de ter adicionado os endereços IP do ClickPipes à lista de permissões das regras do seu firewall. Na página a seguir, você pode encontrar uma [lista de endereços IP do ClickPipes](/pt-BR/integrations/clickpipes/home#list-of-static-ips).
