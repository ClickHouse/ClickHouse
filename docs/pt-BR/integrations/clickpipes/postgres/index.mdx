...
<Info>
  Antes de começar a adicionar os detalhes da conexão, certifique-se de adicionar os endereços IP do ClickPipes à lista de permissões das regras do seu firewall. Você pode encontrar a lista de endereços IP do ClickPipes [aqui](/pt-BR/integrations/clickpipes/networking/static-ips).
...
<Note>
  Certifique-se de adicionar os [endereços IP do ClickPipes](/pt-BR/integrations/clickpipes/networking/static-ips) à lista de permissões do firewall do host bastion SSH para que o ClickPipes possa estabelecer o túnel SSH.
</Note>
...
8. Além disso, você pode fornecer uma expressão personalizada `PARTITION BY <expr>` para controlar o [particionamento da tabela ClickHouse](/pt-BR/concepts/core-concepts/partitions) de destino.

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/partition-by.png" alt="Particionar por" size="lg" border />
