...
8. Além disso, você pode fornecer uma expressão personalizada `PARTITION BY <expr>` para controlar o [particionamento da tabela ClickHouse](/pt-BR/partitions) de destino.
