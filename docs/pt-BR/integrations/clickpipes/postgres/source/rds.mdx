...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/modify_parameter_group.webp" alt="Modificando o Postgres no RDS com o novo grupo de parâmetros" size="lg" border />

3. Reinicie a sua instância do RDS para aplicar as alterações

<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/rds/reboot_rds.webp" alt="Reiniciando o Postgres no RDS" size="lg" border />
