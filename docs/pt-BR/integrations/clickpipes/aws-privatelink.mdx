...
Se o seu serviço não puder usar o DNS privado gerenciado pelo PrivateLink (por exemplo, se o provedor exigir
que os consumidores gerenciem a resolução de DNS, como no caso do Confluent Cloud), consulte [DNS privado personalizado](#custom-private-dns).
