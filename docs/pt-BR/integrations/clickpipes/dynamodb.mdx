...
Primeiro, habilite um stream do Kinesis na sua tabela do DynamoDB para capturar alterações em tempo real. Queremos fazer isso antes de criar o snapshot para evitar a perda de dados.
...
Em seguida, vamos criar um snapshot da tabela do DynamoDB. Isso pode ser feito por meio de uma exportação da AWS para o S3. Consulte o guia da AWS [aqui](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/S3DataExport.HowItWorks.html).
