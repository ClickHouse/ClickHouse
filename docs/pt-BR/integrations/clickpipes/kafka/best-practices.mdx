...
A principal contrapartida é o tamanho das partes. Blocos de inserção maiores produzem menos [partes](/pt-BR/parts), porém maiores, no ClickHouse, o que mantém baixa a sobrecarga de merge. O ClickPipes mantém as linhas de uma partição na memória enquanto cria um bloco; portanto, o tamanho de parte que pode alcançar depende da memória disponível para o pipe — quando a memória é limitada, ele cria blocos menores e a tabela acumula mais partes. Fornecer mais memória ao pipe permite criar blocos maiores, produzindo menos partes.
