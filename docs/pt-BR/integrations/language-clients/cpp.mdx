...
A forma mais simples de incorporar a biblioteca ao seu projeto é usando o módulo
...
A opção `WITH_OPENSSL` habilita o suporte a TLS na biblioteca e é necessária ao se conectar ao
