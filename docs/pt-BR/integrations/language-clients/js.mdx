...
| **http&#95;agent**?: http.Agent | https.Agent <br /><Badge color="green" icon="flask">Experimental</Badge>   | Agente HTTP personalizado para o cliente.                                     | -            | [documentação do agente HTTP](/pt-BR/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only)                           |
| **set&#95;basic&#95;auth&#95;header**?: boolean <br /><Badge color="green" icon="flask">Experimental</Badge> | Define o cabeçalho `Authorization` com as credenciais de autenticação básica. | `true`       | [uso desta configuração na documentação do agente HTTP](/pt-BR/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only) |
