...
### Carregue os dados de táxi de NYC
...
<Frame>
  ![A tabela yellow\_tripdata e suas colunas em um Lakehouse do Fabric](/images/integrations/tools/data-integration/microsoft-fabric/fabric-08-tutorial-lakehouse-table.webp)
</Frame>
...
<Frame>
  ![As três consultas do tutorial no SQL Console embutido do ClickHouse](/images/integrations/tools/data-integration/microsoft-fabric/fabric-09-tutorial-sample-queries.webp)
</Frame>
...
### A verificação de e-mail falha ao abrir um item do ClickHouse
...
### Não é possível entrar no console do ClickHouse Cloud
...
### Acesso negado ao abrir um item
