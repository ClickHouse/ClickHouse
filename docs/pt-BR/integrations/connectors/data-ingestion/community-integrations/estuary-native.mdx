...
A Estuary oferece um conector de materialização direto para o ClickHouse que usa o [protocolo nativo](/pt-BR/interfaces/tcp) e o [formato nativo](/pt-BR/interfaces/formats/Native) do ClickHouse.
