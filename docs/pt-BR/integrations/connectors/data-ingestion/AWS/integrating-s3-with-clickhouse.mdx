---
slug: /pt-BR/integrations/connectors/data-ingestion/AWS/integrating-s3-with-clickhouse
...
<div id="splitting-large-files">
  ### Dividindo arquivos grandes {#splitting-large-files}
</div>
...
<div id="managing-credentials">
  ## Gerenciando credenciais {#managing-credentials}
</div>
...
<div id="s3-optimizing-performance">
  ## Otimização de desempenho {#s3-optimizing-performance}
</div>
...
<div id="s3-storage-tuning">
  ### Ajuste do armazenamento S3 {#s3-storage-tuning}
</div>
...
<div id="s3-backed-mergetree">
  ## MergeTree com backend em S3 {#s3-backed-mergetree}
</div>
...
<div id="storage-tiers">
  ### Camadas de armazenamento {#storage-tiers}
</div>
...
<div id="creating-a-disk">
  ### Criando um disco {#creating-a-disk}
</div>
...
<div id="creating-a-storage-policy">
  ### Criando uma política de armazenamento {#creating-a-storage-policy}
</div>
...
<div id="modifying-a-table">
  ### Modificando uma tabela {#modifying-a-table}
</div>
...
<div id="handling-replication">
  ### Como lidar com a replicação {#handling-replication}
</div>
...
<div id="configuring-s3-for-clickhouse-use">
  ## Use o armazenamento de objetos do S3 como disco do ClickHouse {#configuring-s3-for-clickhouse-use}
</div>
...
<div id="configure-clickhouse-to-use-the-s3-bucket-as-a-disk">
  ### Configure o ClickHouse para usar o bucket do S3 como disco {#configure-clickhouse-to-use-the-s3-bucket-as-a-disk}
</div>
...
<div id="s3-multi-region">
  ## Replicando um único shard entre duas regiões da AWS usando armazenamento de objetos S3 {#s3-multi-region}
</div>
...
<div id="plan-the-deployment">
  ### Planeje a implantação {#plan-the-deployment}
</div>
...
<div id="install-software">
  ### Instale o software {#install-software}
</div>

<div id="clickhouse-server-nodes">
  #### Nós do servidor ClickHouse {#clickhouse-server-nodes}
</div>
...
<div id="deploy-clickhouse">
  #### Implantar o ClickHouse {#deploy-clickhouse}
</div>
...
<div id="deploy-clickhouse-keeper">
  #### Implante o ClickHouse Keeper {#deploy-clickhouse-keeper}
</div>
...
<div id="create-s3-buckets">
  ### Crie buckets do S3 {#create-s3-buckets}
</div>
...
<div id="configure-clickhouse-keeper">
  ### Configurar o ClickHouse Keeper {#configure-clickhouse-keeper}
</div>
...
<div id="configure-clickhouse-server">
  ### Configurar o servidor ClickHouse {#configure-clickhouse-server}
</div>

<div id="define-a-cluster">
  #### Defina um cluster {#define-a-cluster}
</div>
...
<div id="disable-zero-copy-replication">
  #### Desativar a replicação zero-copy {#disable-zero-copy-replication}
</div>
...
<div id="configure-networking">
  ### Configurar a rede {#configure-networking}
</div>
...
<div id="start-the-servers">
  ### Inicie os servidores {#start-the-servers}
</div>

<div id="run-clickhouse-keeper">
  #### Inicie o ClickHouse Keeper {#run-clickhouse-keeper}
</div>
...
<div id="check-clickhouse-keeper-status">
  #### Verifique o status do ClickHouse Keeper {#check-clickhouse-keeper-status}
</div>
...
<div id="run-clickhouse-server">
  #### Inicie o servidor ClickHouse {#run-clickhouse-server}
</div>
