...
<Tabs>
  <Tab title="AWS Marketplace">
    1. <h3 id="subscribe-to-the-connector">Assinar o conector</h3>
    ...
    3. <h3 id="activate-the-connector">Ativar o conector e criar uma conexão</h3>
  ...
  <Tab title="Instalação manual">
    ...
    1. Faça upload do JAR mais recente do Spark conector (`clickhouse-spark-runtime-3.X_2.X-0.10.X.jar`) para um bucket do S3.
