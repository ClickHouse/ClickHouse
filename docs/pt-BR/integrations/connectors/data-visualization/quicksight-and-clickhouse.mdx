...
<Image size="md" img="/images/integrations/data-visualization/quicksight_02.webp" alt="Tela de seleção de fonte de dados do QuickSight com MySQL destacado nos resultados da pesquisa" border />
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_03.webp" alt="Formulário de configuração de conexão MySQL no QuickSight com campos de hostname, porta, banco de dados e credenciais" border />
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_06.webp" alt="Pré-visualização de dados no QuickSight mostrando a estrutura da tabela com colunas e dados de amostra" border />
