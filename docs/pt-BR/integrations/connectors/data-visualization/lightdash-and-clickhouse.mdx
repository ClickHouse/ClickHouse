...
<Steps>
  ...
  <Step>
    ### Configure seu perfil do dbt para o ClickHouse
  ...
  <Step>
    ### Crie um projeto no Lightdash conectado ao ClickHouse
  ...
  <Step>
    ### Explore os dados do ClickHouse no Lightdash
  ...
  <Step>
    ### Defina métricas e dimensões no Lightdash
  ...
  <Step>
    ### Consulte seus dados a partir das tabelas
  ...
  <Step>
    ### Pergunte à IA: análises self-service com tecnologia do dbt
