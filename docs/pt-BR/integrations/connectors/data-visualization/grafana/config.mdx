...
slug: /pt-BR/integrations/connectors/data-visualization/grafana/config
...
<div id="column-aliases">
  ### Aliases de coluna {#column-aliases}
</div>
...
<div id="table-defined-alias-columns">
  #### Colunas ALIAS definidas na tabela {#table-defined-alias-columns}
</div>
