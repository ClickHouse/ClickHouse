  ...
  <Step title="Instale o driver" id="2-install-the-driver">
    ...
    <Info>
      **Setup do Docker Compose**
      ...
      Para instalações baseadas em Docker, consulte o [guia de configuração de banco de dados do Superset](https://superset.apache.org/docs/configuration/databases/#clickhouse) para obter instruções sobre como adicionar o `clickhouse-connect` ao seu contêiner.
    </Info>
