...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_03.webp" alt="Página de configuração da conexão do Mitzu com o ClickHouse, com formulário de configuração" border />
...
Selecione até 2 etapas para calcular a taxa de retenção. Escolha a janela de retenção e a janela recorrente para
