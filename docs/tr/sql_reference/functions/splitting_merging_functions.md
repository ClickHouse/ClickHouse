...
-   `separator` — The separator which should contain exactly one character. [Dize](../../sql_reference/data_types/string.md).
-   `s` — The string to split. [Dize](../../sql_reference/data_types/string.md).
...
Tür: [Dizi](../../sql_reference/data_types/array.md) -den [Dize](../../sql_reference/data_types/string.md).
...
-   `separator` — The separator. [Dize](../../sql_reference/data_types/string.md).
-   `s` — The string to split. [Dize](../../sql_reference/data_types/string.md).
