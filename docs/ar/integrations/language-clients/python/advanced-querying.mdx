...
إذا فشل الاتصال أثناء قراءة نتيجة، فسيُطلق `StreamFailureError` بدلًا من إعادة نتيجة مقتطعة بصمت. ويحمل الاستثناء رسالة الخطأ من جانب الخادم عندما يكون ClickHouse قد أبلغ عنها.
