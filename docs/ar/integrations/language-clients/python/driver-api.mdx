...
تسترجع `Client.query` مجموعة بيانات جدولية بتنسيق ClickHouse Native وتُرجع `QueryResult`. تُجسَّد النتيجة الكاملة عند الوصول إلى إحدى خصائص النتيجة. استخدم طريقة بث للنتائج التي لا ينبغي الاحتفاظ بها في الذاكرة.
