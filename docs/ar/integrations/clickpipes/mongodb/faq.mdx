...
راجع وثائق [AWS PrivateLink for ClickPipes](/ar/integrations/clickpipes/networking/aws-privatelink) لمزيد من التفاصيل. يُرجى التواصل مع دعم ClickHouse للحصول على المساعدة.