...
* إذا كان هناك معرّف المخطط مضمن في الرسالة، فسيستخدمه لاسترجاع المخطط.
* إذا لم يكن هناك معرّف المخطط مضمن في الرسالة، فسيستخدم معرّف المخطط أو اسم الموضوع المحدد في تهيئة ClickPipe لاسترجاع المخطط.
* إذا كُتبت الرسالة بدون معرّف المخطط مضمن، ولم يتم تحديد معرّف المخطط أو اسم الموضوع في تهيئة ClickPipe، فلن يتم استرجاع المخطط وسيتم تخطي الرسالة مع تسجيل `SOURCE_SCHEMA_ERROR` في جدول الأخطاء الخاص بـ ClickPipes.
...
تنطبق القواعد التالية على كلٍّ من السجلات المتوافقة مع Confluent وAWS Glue Schema Registry. وهي تحكم المواءمة بين المخطط المسترجَع وجدول الوجهة في ClickHouse:
