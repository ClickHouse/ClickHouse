...
| ---------------- | ---------------------------------------------------------------------------------------------------- | ----- | ------ | ------------------------------------------------------------------------------------ |
| Apache Kafka     | <img src="/images/integrations/logos/kafka.svg" alt="شعار Apache Kafka" width="32" />                | البث  | مستقر  | هيّئ ClickPipes وابدأ باستيعاب بيانات البث من Apache Kafka إلى ClickHouse Cloud.     |
| Confluent Cloud  | <img src="/images/integrations/logos/confluent.svg" alt="شعار Confluent Cloud" width="32" />         | البث  | مستقر  | استفد من الإمكانات المشتركة لـ Confluent وClickHouse Cloud من خلال تكاملنا المباشر.  |
| Redpanda         | <img src="/images/integrations/logos/logo_redpanda.webp" alt="شعار Redpanda" width="32" />           | البث  | مستقر  | هيّئ ClickPipes وابدأ باستيعاب بيانات البث من Redpanda إلى ClickHouse Cloud.         |
| AWS MSK          | <img src="/images/integrations/logos/msk.svg" alt="شعار AWS MSK" width="32" />                       | البث  | مستقر  | هيّئ ClickPipes وابدأ باستيعاب بيانات البث من AWS MSK إلى ClickHouse Cloud.          |
| Azure Event Hubs | <img src="/images/integrations/logos/azure_event_hubs.svg" alt="شعار Azure Event Hubs" width="32" /> | البث  | مستقر  | هيّئ ClickPipes وابدأ باستيعاب بيانات البث من Azure Event Hubs إلى ClickHouse Cloud. |
| WarpStream       | <img src="/images/integrations/logos/warpstream.svg" alt="شعار WarpStream" width="32" />             | البث  | مستقر  | هيّئ ClickPipes وابدأ باستيعاب بيانات البث من WarpStream إلى ClickHouse Cloud.       |
...
تُعرَّف أنواع Nullable في Avro باستخدام مخطط اتحاد بالشكل `(T, null)` أو `(null, T)`، حيث إن T هو نوع Avro الأساسي. أثناء استنتاج المخطط، تُربَط أنواع اتحاد هذه بعمود &quot;Nullable&quot; في ClickHouse. لاحظ أن ClickHouse لا يدعم الأنواع `Nullable(Array)` و`Nullable(Map)` و`Nullable(Tuple)`. ستُحوَّل اتحادات null في Avro لهذه الأنواع إلى إصدارات غير Nullable (وتُحوَّل أنواع Avro Record إلى Tuple مُسمّى في ClickHouse). وستُدرَج قيم Avro &quot;nulls&quot; لهذه الأنواع على النحو التالي:
