...
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | -------------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Apache Kafka](/ar/integrations/clickpipes/kafka/index)        | <img src="/images/integrations/logos/kafka.svg" alt="شعار Apache Kafka" width="32" />                  | بث مباشر       | مستقر       | قم بتهيئة ClickPipes وابدأ في إدخال البيانات المتدفقة من Apache Kafka إلى ClickHouse Cloud.                                                                                                                           |
...
| Redpanda                                                    | <img src="/images/integrations/logos/logo_redpanda.webp" alt="شعار Redpanda" width="32" />             | بث مباشر       | مستقر       | قم بتهيئة ClickPipes وابدأ في إدخال البيانات المتدفقة من Redpanda إلى ClickHouse Cloud.                                                                                                                               |
| AWS MSK                                                     | <img src="/images/integrations/logos/msk.svg" alt="شعار AWS MSK" width="32" />                         | بث مباشر       | مستقر       | قم بتهيئة ClickPipes وابدأ في إدخال البيانات المتدفقة من AWS MSK إلى ClickHouse Cloud.                                                                                                                                |
...
| WarpStream                                                  | <img src="/images/integrations/logos/warpstream.svg" alt="شعار WarpStream" width="32" />               | بث مباشر       | مستقر       | قم بتهيئة ClickPipes وابدأ في إدخال البيانات المتدفقة من WarpStream إلى ClickHouse Cloud.                                                                                                                             |
| Amazon S3                                                   | <img src="/images/integrations/logos/amazon_s3_logo.svg" alt="شعار Amazon S3" width="32" />            | تخزين الكائنات | مستقر       | قم بتهيئة ClickPipes لإدخال كميات كبيرة من البيانات من تخزين الكائنات.                                                                                                                                                |
| Google Cloud Storage                                        | <img src="/images/integrations/logos/gcs.svg" alt="شعار Google Cloud Storage" width="32" />            | تخزين الكائنات | مستقر       | قم بتهيئة ClickPipes لإدخال كميات كبيرة من البيانات من تخزين الكائنات.                                                                                                                                                |
| DigitalOcean Spaces                                         | <img src="/images/integrations/logos/digitalocean.svg" alt="شعار Digital Ocean" width="32" />          | تخزين الكائنات | مستقر       | قم بتهيئة ClickPipes لإدخال كميات كبيرة من البيانات من تخزين الكائنات.                                                                                                                                                |
| Azure Blob Storage                                          | <img src="/images/integrations/logos/azureblobstorage.svg" alt="شعار Azure Blob Storage" width="32" /> | تخزين الكائنات | مستقر       | قم بتهيئة ClickPipes لإدخال كميات كبيرة من البيانات من تخزين الكائنات.                                                                                                                                                |
| [Amazon Kinesis](/ar/integrations/clickpipes/kinesis/overview) | <img src="/images/integrations/logos/amazon_kinesis_logo.svg" alt="شعار Amazon Kenesis" width="32" />  | بث مباشر       | مستقر       | قم بتهيئة ClickPipes وابدأ في إدخال البيانات المتدفقة من Amazon Kinesis إلى ClickHouse Cloud.                                                                                                                         |
| [GCP Pub/Sub](/ar/integrations/clickpipes/pubsub/overview)     | <img src="/images/integrations/logos/google_pubsub.svg" alt="شعار Google Cloud Pub/Sub" width="32" />  | بث مباشر       | بيتا عامة   | قم بتهيئة ClickPipes وابدأ في إدخال البيانات المتدفقة من Google Cloud Pub/Sub إلى ClickHouse Cloud.                                                                                                                   |
| [Postgres](/ar/integrations/clickpipes/postgres/index)         | <img src="/images/integrations/logos/postgresql.svg" alt="شعار Postgres" width="32" />                 | DBMS           | مستقر       | قم بتهيئة ClickPipes وابدأ في إدخال البيانات من Postgres إلى ClickHouse Cloud.                                                                                                                                        |
| [MySQL](/ar/integrations/clickpipes/mysql/index)               | <img src="/images/integrations/logos/mysql.svg" alt="شعار MySQL" width="32" />                         | DBMS           | بيتا عامة   | قم بتهيئة ClickPipes وابدأ في إدخال البيانات من MySQL إلى ClickHouse Cloud.                                                                                                                                           |
| [MongoDB](/ar/integrations/clickpipes/mongodb/index)           | <img src="/images/integrations/logos/mongodb.svg" alt="شعار MongoDB" width="32" />                     | DBMS           | معاينة خاصة | قم بتهيئة ClickPipes وابدأ في إدخال البيانات من MongoDB إلى ClickHouse Cloud.                                                                                                                                         |
