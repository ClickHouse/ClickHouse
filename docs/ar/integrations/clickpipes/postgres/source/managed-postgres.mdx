...
افتح خدمة ClickHouse Managed Postgres الخاصة بك في ClickHouse Cloud console وانقر على **Sync to ClickHouse** في الشريط الجانبي. يملأ المعالج بيانات source connection تلقائيًا، ويتيح لك اختيار destination خدمة ClickHouse وطريقة replication والجداول المراد نسخها. ولا يتطلب ذلك إعداد أي USER أو publication أو شبكة.

اتبع دليل [Sync to ClickHouse](/ar/products/managed-postgres/clickhouse-integration) للحصول على شرح تفصيلي خطوة بخطوة.
