...
## الخيار 1: المزامنة إلى ClickHouse من خدمة Postgres
...
## الخيار 2: اختيار ClickHouse Managed Postgres كمصدر في ClickPipes
...
### النسخ المتماثل المنطقي (النسخ المتماثل المنطقي)
