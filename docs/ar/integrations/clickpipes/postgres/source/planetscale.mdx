...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_wal_level_logical.webp" alt="ضبط wal_level في وحدة تحكم PlanetScale" size="md" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/planetscale/planetscale_max_slot_wal_keep_size.webp" alt="ضبط max_slot_wal_keep_size في وحدة تحكم PlanetScale" size="md" border />
