...
بدلاً من إضافة المُعدِّل FINAL إلى اسم كل جدول في الاستعلام، يمكنك استخدام [إعداد FINAL](/ar/reference/settings/session-settings/other#final) لتطبيقه تلقائيًا على جميع الجداول في الاستعلام.
