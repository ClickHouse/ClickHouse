...
<Info>
  قبل البدء بإضافة تفاصيل الاتصال، تأكد من إدراج ClickPipes IP addresses في قائمة السماح بقواعد جدار الحماية لديك. في الصفحة التالية، يمكنك العثور على [قائمة بعناوين ClickPipes IP addresses](/ar/integrations/clickpipes/home#list-of-static-ips).
