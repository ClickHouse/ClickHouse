...
<Tabs>
  ...
  <Tab title="استخدام نفق SSH">
    ...
    2. حدِّث قواعد Network Security Group ‏(NSG) الخاصة بمضيف bastion عبر SSH للسماح بحركة المرور الواردة من [قائمة عناوين IP الثابتة الخاصة بـ ClickPipes](/ar/integrations/clickpipes/networking/static-ips) للمنطقة التي نُشرت فيها خدمتك.
