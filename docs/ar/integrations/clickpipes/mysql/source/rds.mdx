...
تحدّد ميزة النسخ الاحتياطي التلقائي ما إذا كان التسجيل الثنائي مفعّلًا أم معطّلًا في MySQL. ويمكن تهيئة النسخ الاحتياطية التلقائية لمثيلك من خلال RDS Console بالانتقال إلى **Modify** &gt; **Additional configuration** &gt; **Backup** وتحديد مربع الاختيار **Enable automated backups** (إذا لم يكن محددًا بالفعل).
...
نوصي بضبط **فترة الاحتفاظ بالنسخ الاحتياطية** على مدة طويلة نسبيًا، بحسب حالة استخدام النسخ المتماثل لديك.
