...
يمكننا الآن إعداد Kinesis ClickPipe لالتقاط التغييرات في الوقت الفعلي من دفق Kinesis. اتبع دليل Kinesis ClickPipe [هنا](/ar/integrations/clickpipes/kinesis/overview)، ولكن استخدم الإعدادات التالية:
