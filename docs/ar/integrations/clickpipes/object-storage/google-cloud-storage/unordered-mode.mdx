...
في هذا الوضع، يُجري ClickPipe الخاص بـ GCS تحميلًا أوليًا لكل **الملفات** الموجودة في المسار المحدد، ثم يستمع إلى إشعارات الكائنات عبر اشتراك Pub/Sub التي تطابق هذا المسار. سيتم **تجاهل** أي رسالة تخص ملفًا سبق اكتشافه، أو ملفًا لا يطابق المسار، أو حدثًا من نوع مختلف. **لا يمكن** بدء الإدخال من ملف معيّن أو من نقطة زمنية محددة — إذ يحمّل ClickPipes دائمًا جميع الملفات في المسار المحدد.
...
<Steps>
  ...
  <Step>
    ...
    **2.** فعّل **Continuous ingestion**، ثم اختر **Any order** بوصفه وضع الإدخال، وقدّم اسم **اشتراك Pub/Sub** للاشتراك المتصل بحاويتك. يجب أن يتبع اسم الاشتراك التنسيق التالي:
