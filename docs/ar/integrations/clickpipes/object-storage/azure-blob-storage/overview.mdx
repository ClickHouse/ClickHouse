...
<Warning>
  إن **التحكم بالوصول المستند إلى عناوين IP لا يعمل** إذا كانت حاوية Azure Blob Storage الخاصة بك في منطقة Azure نفسها التي توجد فيها خدمة ClickHouse Cloud. وعندما تكون الخدمتان في المنطقة نفسها، تُوجَّه حركة المرور عبر شبكة Azure الداخلية بدلًا من الإنترنت العام.
</Warning>
