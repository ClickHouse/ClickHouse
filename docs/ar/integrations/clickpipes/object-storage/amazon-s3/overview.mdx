...
| `Start after`                        | None              | للإدخال المستمر المرتب، يتخطى الملفات التي يقل اسمها أو مسارها عن اسم الملف أو المسار المُكوَّن أو يساويه وفق الترتيب المعجمي.                    |
| `Skip initial load`                  | false             | للإدخال المستمر غير المرتب، يتخطى الفحص الأولي للملفات الموجودة ويعالج إشعارات الكائنات فقط من قائمة انتظار SQS المُكوَّنة.                       |
