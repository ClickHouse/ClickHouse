...
لإدخال الملفات التي تُسلَّم عبر قائمة الانتظار فقط، فعِّل **تخطي التحميل الأولي**. عند تفعيله، تتخطى ClickPipes الفحص الأولي للملفات الموجودة في المسار المحدد وتعالج الملفات التي تُسلَّم عبر قائمة انتظار SQS فقط.
