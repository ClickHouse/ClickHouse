...
slug: /ar/integrations/connectors/data-visualization/grafana/config
...
<div id="custom-http-headers">
  #### رؤوس HTTP مخصّصة {#custom-http-headers}
</div>
...
<div id="column-aliases">
  ### الأسماء المستعارة للأعمدة {#column-aliases}
</div>
...
<div id="table-defined-alias-columns">
  #### أعمدة ALIAS المعرّفة على الجدول {#table-defined-alias-columns}
</div>
