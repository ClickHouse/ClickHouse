...
| عوامل تصفية | قائمة بعوامل تصفية ستُطبَّق في عبارة `WHERE`.                                                                                                                           |
...
يمكن تهيئة القيم الافتراضية في [إعدادات السجلات](/ar/integrations/connectors/data-visualization/grafana/config#logs) الخاصة بمصدر البيانات، بحيث يُحمَّل منشئ الاستعلامات مسبقًا بقاعدة بيانات/جدول وأعمدة افتراضية.
...
تم تمكين هذه الميزة ضمن إضافة ClickHouse لربط trace بالسجلات والعكس صحيح. وهي تعمل بأفضل شكل عند تهيئة OpenTelemetry لكلٍّ من السجلات وtraces في [إعدادات مصدر البيانات](/ar/integrations/connectors/data-visualization/grafana/config#opentelemetry)
