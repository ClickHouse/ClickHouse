  ...
  <Step title="تثبيت برنامج التشغيل" id="2-install-the-driver">
    ...
    <Info>
      **إعداد Docker Compose**
      ...
      بالنسبة إلى عمليات التثبيت المستندة إلى Docker، راجع [دليل تهيئة قاعدة البيانات في Superset](https://superset.apache.org/docs/configuration/databases/#clickhouse) للحصول على إرشادات حول إضافة `clickhouse-connect` إلى الحاوية الخاصة بك.
    </Info>
