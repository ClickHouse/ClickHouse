...
أولاً، انتقل إلى [https://quicksight.aws.amazon.com](https://quicksight.aws.amazon.com)، ثم افتح قسم Datasets وانقر على &quot;New dataset&quot;:
...
ابحث عن موصل MySQL الرسمي المضمّن مع QuickSight (ويظهر باسم **MySQL** فقط):
...
حدّد تفاصيل الاتصال. يُرجى ملاحظة أن منفذ واجهة MySQL هو 9004 افتراضيًا،
وقد يختلف بحسب إعدادات الخادم لديك.

<Image size="md" img="/images/integrations/data-visualization/quicksight_03.webp" alt="نموذج إعداد اتصال MySQL في QuickSight مع حقول اسم المضيف والمنفذ وقاعدة البيانات وبيانات الاعتماد" border />

<br />

أمامك الآن خياران لجلب البيانات من ClickHouse. أولاً، يمكنك اختيار جدول من القائمة:
...
بدلاً من ذلك، يمكنك تحديد custom SQL لجلب بياناتك:

<Image size="md" img="/images/integrations/data-visualization/quicksight_05.webp" alt="محرر استعلامات custom SQL في QuickSight لجلب البيانات من ClickHouse" border />

<br />

عند النقر على &quot;Edit/Preview data&quot;، ينبغي أن تتمكن من رؤية بنية الجدول المكتشفة أو تعديل custom SQL، إذا اخترت هذه الطريقة للوصول إلى البيانات:
...
يمكنك الآن المتابعة إلى نشر مجموعة البيانات وإنشاء تصور جديد!
