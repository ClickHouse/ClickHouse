...
لمعرفة كيفية إضافة مجموعات البيانات باستخدام واجهة برمجة تطبيقات الخاصة بنا، يُرجى الرجوع إلى [هذا المثال في وثائق المطورين](https://developer.luzmo.com/api/createDataprovider?exampleSection=DataproviderCreateClickhouseRequestBody).
