...
<Steps>
  ...
  <Step title="نزِّل Apache NiFi وشغِّله" id="2-download-and-run-apache-nifi">
    لإعداد جديد، نزِّل الملف التنفيذي من [https://nifi.apache.org/download.html](https://nifi.apache.org/download.html) ثم ابدأ بتشغيل `./bin/nifi.sh start`
  </Step>
