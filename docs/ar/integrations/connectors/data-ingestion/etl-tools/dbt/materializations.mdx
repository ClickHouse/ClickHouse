...
* في بعض الحالات النادرة جدًا، قد يؤدي استخدام `incremental_predicates` غير الحتمية إلى حدوث حالة سباق للعناصر
  المحدَّثة أو المحذوفة. ولضمان نتائج متسقة، ينبغي أن تقتصر المسندات التزايدية على الاستعلامات الفرعية التي تتعامل مع
  بيانات لن تُعدَّل أثناء التجسيد التزايدي.
...
<div id="dictionary-configurations">
  ### التهيئات
</div>
