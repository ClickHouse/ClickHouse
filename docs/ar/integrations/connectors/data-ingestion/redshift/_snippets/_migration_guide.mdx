...
<Steps>
  ...
  <Step>
    ...
    <Note>
      يستخدم هذا المثال CSV كتنسيق وسيط. ومع ذلك، بالنسبة إلى أحمال العمل في بيئات الإنتاج، نوصي باستخدام Apache Parquet باعتباره الخيار الأفضل لعمليات الترحيل الكبيرة، لأنه يدعم الضغط ويمكن أن يوفّر بعض تكاليف التخزين مع تقليل أوقات النقل. (افتراضيًا، تُضغط كل مجموعة صفوف باستخدام SNAPPY). كما يستفيد ClickHouse من الطبيعة العمودية لـ Parquet لتسريع استيعاب البيانات.
    </Note>
  </Step>
</Steps>