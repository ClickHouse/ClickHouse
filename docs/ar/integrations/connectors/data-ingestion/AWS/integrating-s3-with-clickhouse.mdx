---
slug: /ar/integrations/connectors/data-ingestion/AWS/integrating-s3-with-clickhouse
...
<div id="splitting-large-files">
  ### تقسيم الملفات الكبيرة {#splitting-large-files}
</div>
...
<div id="managing-credentials">
  ## إدارة بيانات الاعتماد {#managing-credentials}
</div>
...
<div id="s3-optimizing-performance">
  ## تحسين الأداء {#s3-optimizing-performance}
</div>
...
<div id="s3-storage-tuning">
  ### ضبط تخزين S3 {#s3-storage-tuning}
</div>
...
<div id="s3-backed-mergetree">
  ## MergeTree المعتمد على S3 {#s3-backed-mergetree}
</div>
...
<div id="creating-a-storage-policy">
  ### إنشاء سياسة تخزين {#creating-a-storage-policy}
</div>
...
<div id="handling-replication">
  ### التعامل مع النسخ المتماثل {#handling-replication}
</div>
...
<div id="configuring-s3-for-clickhouse-use">
  ## استخدم تخزين الكائنات في S3 كقرص لـ ClickHouse {#configuring-s3-for-clickhouse-use}
</div>
...
<div id="configure-clickhouse-to-use-the-s3-bucket-as-a-disk">
  ### اضبط ClickHouse لاستخدام حاوية S3 كقرص {#configure-clickhouse-to-use-the-s3-bucket-as-a-disk}
</div>
...
<div id="s3-multi-region">
  ## تكرار شظية واحدة عبر منطقتين في AWS باستخدام تخزين الكائنات في S3 {#s3-multi-region}
</div>
...
<div id="plan-the-deployment">
  ### خطّط لعملية النشر {#plan-the-deployment}
</div>
...
<div id="deploy-clickhouse-keeper">
  #### نشر ClickHouse Keeper {#deploy-clickhouse-keeper}
</div>
...
<div id="create-s3-buckets">
  ### إنشاء حاويات S3 {#create-s3-buckets}
</div>
...
<div id="configure-clickhouse-keeper">
  ### تهيئة ClickHouse Keeper {#configure-clickhouse-keeper}
</div>
...
<div id="configure-clickhouse-server">
  ### إعداد خادم ClickHouse {#configure-clickhouse-server}
</div>

<div id="define-a-cluster">
  #### تحديد عنقود {#define-a-cluster}
</div>
...
<div id="disable-zero-copy-replication">
  #### تعطيل zero-copy replication {#disable-zero-copy-replication}
</div>
...
<div id="configure-networking">
  ### تهيئة الشبكة {#configure-networking}
</div>
...
<div id="start-the-servers">
  ### شغِّل الخوادم {#start-the-servers}
</div>

<div id="run-clickhouse-keeper">
  #### تشغيل ClickHouse Keeper {#run-clickhouse-keeper}
</div>
...
<div id="check-clickhouse-keeper-status">
  #### تحقّق من حالة ClickHouse Keeper {#check-clickhouse-keeper-status}
</div>
...
<div id="run-clickhouse-server">
  #### شغّل خادم ClickHouse {#run-clickhouse-server}
</div>
