...
<Tabs>
  <Tab title="AWS Marketplace">
    1. <h3 id="subscribe-to-the-connector">الاشتراك في الـ موصل</h3>
    ...
    3. <h3 id="activate-the-connector">تفعيل الـ موصل وإنشاء اتصال</h3>
  ...
  <Tab title="التثبيت اليدوي">
    ...
    1. ارفع أحدث ملف JAR لـ موصل Spark (`clickhouse-spark-runtime-3.X_2.X-0.10.X.jar`) إلى S3 bucket.
