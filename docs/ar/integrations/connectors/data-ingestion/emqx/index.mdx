...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_1.webp" size="md" border alt="الخطوة 1 من إنشاء قاعدة تكامل البيانات في EMQX Cloud مع عرض استعلام SQL" />

يمكنك استخدام اختبار SQL لاختبار الاستعلام والاطلاع على النتائج.

<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_2.webp" size="md" border alt="الخطوة 2 من إنشاء قاعدة تكامل البيانات في EMQX Cloud مع عرض نتائج الاختبار" />
