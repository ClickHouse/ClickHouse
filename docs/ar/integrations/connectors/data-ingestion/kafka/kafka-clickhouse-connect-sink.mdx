...
اعتبارًا من الإصدار 26.9 من ClickHouse وما بعده، أصبح هذا المخطط مدعومًا بشكل افتراضي. أما في الإصدارات من 26.1 إلى 26.8 فيتطلب الإعداد `allow_experimental_nullable_tuple_type = 1` (راجع [صفحة التوثيق هذه](/ar/reference/settings/session-settings/allow-experimental#allow_experimental_nullable_tuple_type)).
