...
يستخدم Vector [المصادر](https://vector.dev/docs/about/concepts/#sources) لجلب البيانات وفق نموذج push أو pull. وفي المقابل، توفّر [المصبات](https://vector.dev/docs/about/concepts/#sinks) وجهةً للأحداث. لذلك نستخدم مصدر Kafka ومصب ClickHouse. لاحظ أنه رغم دعم Kafka باعتباره Sink، فلا يتوفر مصدر لـ ClickHouse. لذلك لا يُعد Vector مناسبًا إذا كنت تريد نقل البيانات من ClickHouse إلى Kafka.
