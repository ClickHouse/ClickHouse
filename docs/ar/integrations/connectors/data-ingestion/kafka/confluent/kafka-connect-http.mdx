...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.webp" size="md" alt="واجهة Confluent Cloud تعرض كيفية إنشاء رسالة اختبار في topic Kafka" border />
