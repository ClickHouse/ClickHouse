...
### تحميل بيانات سيارات الأجرة في مدينة نيويورك
...
<Frame>
  ![الجدول yellow\_tripdata وأعمدته في Fabric Lakehouse](/images/integrations/tools/data-integration/microsoft-fabric/fabric-08-tutorial-lakehouse-table.webp)
</Frame>
...
<Frame>
  ![استعلامات الدليل العملي الثلاثة في وحدة تحكم ClickHouse SQL المدمجة](/images/integrations/tools/data-integration/microsoft-fabric/fabric-09-tutorial-sample-queries.webp)
</Frame>
...
### فشل التحقق من البريد الإلكتروني عند فتح عنصر ClickHouse
...
### تعذّر تسجيل الدخول إلى وحدة تحكم ClickHouse Cloud
