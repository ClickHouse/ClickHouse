...
يتضمن DbVisualizer أحدث برامج تشغيل JDBC الخاصة بـ ClickHouse. كما يوفّر إدارة مدمجة وكاملة لبرامج تشغيل JDBC، مع الإشارة إلى أحدث الإصدارات وكذلك الإصدارات السابقة من برامج التشغيل.

<Image img="/images/integrations/sql-clients/dbvisualizer-driver-manager.webp" size="lg" border alt="واجهة مدير برامج التشغيل في DbVisualizer تعرض إعداد برنامج تشغيل ClickHouse JDBC" />
