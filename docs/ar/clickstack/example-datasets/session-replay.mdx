...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/demo-app.webp" alt="التطبيق التجريبي لإعادة تشغيل الجلسة" />
  ...
  <Step>
    ...
    <Image img="/images/clickstack/session-replay/replay-search-view.webp" alt="البحث في إعادة تشغيل الجلسة" />

    يُفترض أن تظهر جلستك في القائمة مع مدتها وعدد الأحداث فيها. انقر على الزر ▶️ لإعادة تشغيلها.

    <Image img="/images/clickstack/session-replay/session-replay.webp" alt="إعادة تشغيل الجلسة" />
