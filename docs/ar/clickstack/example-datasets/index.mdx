...
| [بيانات اصطناعية باستخدام telemetrygen](/ar/clickstack/example-datasets/telemetrygen) | استخدم `telemetrygen` لإرسال سجلات وتتبعات ومقاييس اصطناعية ومتنوعة، تُشكَّل باستخدام flags عبر الخدمات ومستويات الخطورة وحالات span وأنواع المقاييس، إلى ClickStack OpenTelemetry collector قيد التشغيل |
