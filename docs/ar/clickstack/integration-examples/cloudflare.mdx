  ...
  <Step>
    ...
    <Info>
      **عرض timezone**
      ...
      يعرض HyperDX طوابع زمنية وفق timezone المحلية في متصفحك. تمتد البيانات التجريبية عبر **2026-02-24 00:00:00 - 2026-02-25 00:00:00 (UTC)**. يضمن النطاق الزمني الواسع ظهور السجلات التجريبية مهما كان موقعك. وبعد ظهور السجلات، يمكنك تضييق النطاق إلى فترة 24 ساعة للحصول على visualizations أوضح.
    </Info>
  </Step>
</Steps>
...
<Steps>
  <Step>
    #### <TrackedLink href={'https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/cloudflare-logs-dashboard.json'} download="cloudflare-logs-dashboard.json" eventName="docs.cloudflare_logs_monitoring.dashboard_download">تنزيل</TrackedLink> إعدادات لوحة المعلومات
  </Step>
