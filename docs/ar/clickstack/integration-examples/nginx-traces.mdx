...
<Steps>
  <Step>
    #### <TrackedLink href={'https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/nginx-traces-dashboard.json'} download="nginx-traces-dashboard.json" eventName="docs.nginx_traces_monitoring.dashboard_download">تنزيل</TrackedLink> إعداد لوحة معلومات
  </Step>

  <Step>
    #### استيراد لوحة معلومات الجاهزة مسبقًا
  ...
  <Step>
    #### سيتم إنشاء لوحة معلومات مع تهيئة جميع المرئيات مسبقًا.

    <Note>
      بالنسبة إلى مجموعة البيانات التجريبية، اضبط النطاق الزمني على **2025-10-26 13:00:00 - 2025-10-27 13:00:00 (UTC)** (عدّله وفقًا لمنطقتك الزمنية المحلية). لن تتضمن لوحة معلومات المستوردة نطاقًا زمنيًا محددًا افتراضيًا.
    </Note>
