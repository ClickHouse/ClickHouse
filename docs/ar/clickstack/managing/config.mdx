...
| `مفعّل`                           | يظل المصدر المعطّل محفوظًا، لكنه يُخفى من محددات المصادر ولا يُختار تلقائيًا أبدًا.                                                                                                                                                                                                                                                                                                                                                                              | لا    | لا                           | مفعّل                                              |
...
| `عمود الطابع الزمني المعروض`      | عمود طابع زمني اختياري بدقة أعلى يُستخدم للعرض في واجهة المستخدم. ويُستخدم عمود الطابع الزمني تلقائيًا عند عدم تحديده.                                                                                                                                                                                                                                                                                                                                           | لا    | نعم                          | `Timestamp`                                        |
| `مصدر المقاييس المترابط`          | مصدر مقاييس مرتبط (مثل مقاييس HyperDX).                                                                                                                                                                                                                                                                                                                                                                                                                          | لا    | No                           | –                                                  |
...
| `استخدام فهرس نصي`                | ما إذا كانت عمليات البحث المستندة إلى Lucene تستخدم `hasAllTokens` عند البحث في العمود الضمني.                                                                                                                                                                                                                                                                                                                                                                   | لا    | لا                           | `تلقائي (يُكتشف من المخطط)`                        |
...
| `العروض المُجسَّدة`               | [العروض المادية](/ar/clickstack/managing/materialized-views) المجمّعة مسبقًا والمرتبطة بهذا المصدر، وتُستخدم تلقائيًا لتسريع الاستعلامات المؤهلة. راجع [العروض المادية](#materialized-views-settings).                                                                                                                                                                                                                                                              | لا    | No                           | –                                                  |
