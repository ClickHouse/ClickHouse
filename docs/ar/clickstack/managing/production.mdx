...
### تأمين الإدخال {#secure-ingestion-managed}
...
#### إنشاء مستخدم للإدخال {#create-a-database-ingestion-user-managed}
...
### تهيئة Time To Live (TTL) {#configure-ttl-managed}
...
### تقدير الموارد {#estimating-resources}
...
#### عزل أعباء عمل الرصد {#isolating-workloads}
...
#### عزل أعباء عمل القراءة والكتابة {#isolating-read-write}
...
### أمان الشبكة والمنافذ {#network-security}
...
### تهيئة سر الجلسة {#session-secret}
...
### تأمين الإدخال {#secure-ingestion}
...
#### إنشاء مستخدم للإدخال {#create-a-database-ingestion-user-oss}
...
#### أفضل ممارسات الأمان {#self-managed-security}
...
#### أذونات المستخدم لواجهة ClickStack UI {#user-permissions}
...
### ضبط مدة البقاء (TTL) {#configure-ttl}
...
### إرشادات MongoDB {#mongodb-guidelines}
