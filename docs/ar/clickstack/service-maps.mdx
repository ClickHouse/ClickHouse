...
<Image img="/images/clickstack/service-maps/source-selector.webp" alt="تمييز محدد المصدر في شريط أدوات خريطة الخدمات" size="lg" />
...
<Image img="/images/clickstack/service-maps/sampling.webp" alt="تمييز مُنزلق أخذ العينات في شريط أدوات خريطة الخدمات" size="lg" />

**منتقي نطاق التاريخ** — حدِّد النافذة الزمنية لبيانات التتبعات المستخدمة لإنشاء الخريطة.

<Image img="/images/clickstack/service-maps/date-selector.webp" alt="تمييز منتقي نطاق التاريخ في شريط أدوات خريطة الخدمات" size="lg" />
