...
انقر على **خرائط الخدمات** في لوحة التنقل اليسرى لفتح الرسم البياني الكامل. تظهر الخدمات بمجرد البدء في [إدخال بيانات التتبّع](/ar/clickstack/ingesting-data) باستخدام OpenTelemetry.
