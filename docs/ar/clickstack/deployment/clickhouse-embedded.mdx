...
إذا كنت مستعدًا للانتقال إلى ما بعد مرحلة التقييم، ففكّر في نشرٍ جاهزٍ للإنتاج:

* [All-in-One](/ar/clickstack/deployment/all-in-one) — حاوية واحدة تضم جميع المكونات، بما في ذلك التخزين الدائم والمصادقة
* [Docker Compose](/ar/clickstack/deployment/docker-compose) — مكونات منفصلة لمزيد من التحكم
* [Helm](/ar/clickstack/deployment/helm) — موصى به لعمليات النشر على Kubernetes في بيئات الإنتاج
