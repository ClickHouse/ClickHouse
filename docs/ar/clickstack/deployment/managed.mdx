---
slug: /ar/clickstack/deployment/managed
title: 'مُدار'
...
### بدء تشغيل collector {#start-a-collector-existing}
...
### تهيئة collectors الموجودة {#configure-existing-collectors-existing}
...
### بدء إدخال البيانات (اختياري) {#start-ingestion-existing}
...
### أنشئ قاعدة بيانات وجدولًا {#create-database-and-tables}
...
<div id="clickstack-read-only-compute">
  ### استخدام ClickStack مع حوسبة للقراءة فقط {#clickstack-read-only-compute}
</div>
...
<div id="how-clickstack-selects-compute">
  #### كيف يختار ClickStack موارد الحوسبة {#how-clickstack-selects-compute}
</div>
...
<div id="adding-data-sources">
  ### إضافة المزيد من مصادر البيانات {#adding-data-sources}
</div>
...
<div id="using-custom-schemas">
  #### استخدام المخططات المخصصة {#using-custom-schemas}
</div>
