---
slug: /ar/clickstack/architecture
...
### ClickHouse Cloud: المحرّك {#clickhouse-cloud}
...
### ClickStack UI (HyperDX): الواجهة {#hyperdx}
...
### ClickHouse: محرك قاعدة البيانات {#clickhouse}
...
### OpenTelemetry collector: استيعاب البيانات {#open-telemetry-collector}
...
### ClickStack UI (HyperDX): الواجهة {#hyperdx-ui}
