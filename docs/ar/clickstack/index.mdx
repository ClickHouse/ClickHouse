...
export const INFRA = [
  ...
  { title: 'تتبّعات Node.js',img: '/images/logo-nodejs.svg',               href: '/clickstack/integration-examples/nodejs-traces' },
];
...
export const DATABASES = [
  ...
  { title: 'تتبّعات Nginx',       img: '/images/logo-nginx.svg',     href: '/clickstack/integration-examples/nginx-traces' },
