...
<Steps>
  ...
  <Step>
    ## الحساب المسبق للتجميعات المتكررة
  ...
  <Step>
    ## اختر المفتاح الأساسي وفق نمط الوصول لديك
    ...
    لا يتيح ClickHouse تعديل المفتاح الأساسي في مكانه، لذا فهذه table migration وليست مجرد `ALTER` بسيط. ويشرح دليل ضبط الأداء كيفية إنشاء الجدول الجديد، وإعادة توجيه إدخال البيانات، واستخدام جدول `Merge` بحيث تظل لوحات المعلومات الحالية تعمل عبر البيانات القديمة والجديدة.
