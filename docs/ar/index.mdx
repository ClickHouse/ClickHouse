    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" galaxyEvent="docs.home.chdb" description="قاعدة بيانات سريعة وموثوقة وقابلة للتوسع تعمل داخل العملية. اختبر قوة ClickHouse داخل العملية." href="/chdb/index" showArrow />
        </div>
      </div>
