  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "الدلائل السريعة", href: "/get-started/quickstarts/home" },
        { label: "مفاهيم ClickHouse", href: "/concepts/core-concepts/index" },
        { label: "مجموعات بيانات نموذجية", href: "/get-started/sample-datasets/index" },
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="التحليلات اللحظية" description="قدّم رؤى فورية ولوحات معلومات على نطاق واسع. حلّل مليارات الصفوف لحظيًا بزمن استجابة بالمللي ثانية." href="/ar/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="الرصد" description="خزّن السجلات والمقاييس والتتبعات واستعلم عنها على نطاق واسع باستخدام ClickStack، حزمة الرصد مفتوحة المصدر والمدعومة من ClickHouse." href="/ar/clickstack/overview" showArrow />

        <HeroCard title="مستودعات البيانات" description="حلّل البيانات واستكشفها فورًا لاستخراج الرؤى وتشغيل التطبيقات. توسّع أسرع عبر نقل أعباء العمل الثقيلة." href="/ar/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="التحليلات المعتمدة على الوكلاء" description="اسمح لوكلاء الذكاء الاصطناعي بالاستعلام مباشرة عن بياناتك اللحظية لتقديم رؤى فورية وحوارية وتصوّرات مرئية" href="/ar/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              { label: "2. أفضل الممارسات لتنظيم البيانات لأغراض analytics والنمو", href: "/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. طرق query على datasets كبيرة في الوقت الفعلي", href: "/get-started/use-cases/real-time-analytics" },
              { label: "4. كيفية بناء dashboards وتنبيهات وfeatures قائمة على الأحداث فوقها", href: "/get-started/use-cases/data-warehousing" },
              { label: "5. نصائح للحفاظ على انخفاض التكاليف مع بقاء الأداء مرتفعًا", href: "/concepts/best-practices/index" },
          ]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" description="حزمة observability متكاملة all in one ومدعومة من ClickHouse، تمنحك استعلامات فائقة السرعة وaggregations قوية على logs وmetrics وtraces وsession replay والأخطاء." href="/ar/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard filename="thumbnail-postgres-light.webp" title="Managed Postgres" description="خدمة Postgres سريعة وقابلة للتوسّع وبمستوى المؤسسات، ومتكاملة أصلاً مع ClickHouse. اجمع بسهولة بين Postgres للمعاملات وClickHouse من أجل analytics." href="/ar/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="منصة هندسة LLM مفتوحة المصدر لـ observability والمقاييس والتقييمات وإدارة المطالبات." href="https://langfuse.com/docs" showArrow external />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Kubernetes Operator" description="يؤتمت نشر مجموعات ClickHouse وClickHouse Keeper على Kubernetes وتهيئتها وإدارتها." href="/ar/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="قاعدة بيانات سريعة وموثوقة وقابلة للتوسع تعمل داخل العملية. اختبر قوة ClickHouse داخل العملية." href="/ar/products/chdb/index" showArrow />
        </div>
      </div>
