...
يمكنك استخدام [واجهات برمجة التطبيقات العامة](/ar/products/cloud/api-reference/service/instance-scaling-update) في ClickHouse Cloud لتوسيع خدمتك من خلال تحديث إعدادات التوسيع الخاصة بالخدمة، أو تعديل عدد النسخ المتماثلة من Cloud Console.
