...
<Image img="/images/cloud/manage/scaling-patch-request.webp" size="lg" alt="طلب PATCH للتوسع" border caption="طلب `PATCH` لتحديث `numReplicas`" />

<Image img="/images/cloud/manage/scaling-patch-response.webp" size="md" alt="استجابة PATCH للتوسع" border caption="الاستجابة لطلب `PATCH`" />
...
<Image img="/images/cloud/manage/scaling-configure.webp" size="md" alt="إعدادات تهيئة التوسيع" border caption="إعدادات توسيع الخدمة من وحدة تحكم ClickHouse Cloud" />
