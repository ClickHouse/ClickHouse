...
التوسّع هو القدرة على تعديل الموارد المتاحة بما يلبي متطلبات العملاء. يمكن توسيع خدمات فئتَي Scale وEnterprise tier أفقيًا عبر استدعاء واجهة برمجة تطبيقات برمجيًا أو تغيير الإعدادات في UI. ويمكن أيضًا توسيع خدمات فئة Scale وخدمات فئة Enterprise tier ذات ملفات التعريف القياسية `1:4` رأسيًا **تلقائيًا** لتلبية متطلبات التطبيق.

<ScalePlanFeatureBadge feature="التوسّع الرأسي التلقائي" />

<Note>
  تدعم فئتَا Scale وEnterprise tier الخدمات أحادية النسخة المتماثلة ومتعددة النسخ المتماثلة. تدعم خدمات Scale أحادية النسخة المتماثلة وخدمات Enterprise ذات ملفات التعريف القياسية `1:4` التوسّع الرأسي التلقائي بالخدمة الذاتية. تتطلب خدمات Enterprise ذات ملفات التعريف المخصصة تغيير الحجم الرأسي بمساعدة فريق الدعم. يمكن لخدمات Scale وEnterprise التوسّع أفقيًا إلى نسخ متماثلة متعددة. تحتوي خدمات فئة Basic على نسخة متماثلة واحدة، وهي ثابتة الحجم، ولا تتيح التوسّع الرأسي أو الأفقي. لمزيد من المعلومات، راجع [خدمات أحادية النسخة المتماثلة الكبيرة](/ar/products/cloud/features/large-single-replica-services).
</Note>
