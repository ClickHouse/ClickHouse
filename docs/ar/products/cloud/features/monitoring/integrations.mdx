...
| [تكامل ClickHouse Cloud Prometheus](#clickhouse-cloud-prometheus-integration)                                 | [clickhouse.com/docs](/ar/integrations/prometheus)                                                | Cloud       | المقاييس                          |
...
يمكنك تهيئة Datadog Agent باستخدام [تكامل OpenMetrics](https://docs.datadoghq.com/integrations/openmetrics/) لاستطلاع واجهة برمجة تطبيقات ClickHouse Cloud دوريًا وجمع المقاييس. راجع [صفحة تكامل Prometheus](/ar/integrations/prometheus#integrating-with-datadog) للاطلاع على تفاصيل التهيئة.
