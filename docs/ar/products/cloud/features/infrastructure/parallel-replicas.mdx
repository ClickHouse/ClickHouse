...
<div id="managing-cache-locality">
  ### إدارة محلية ذاكرة التخزين المؤقت {#managing-cache-locality}
</div>
...
<div id="settings-related-to-parallel-replicas">
  ## الإعدادات المتعلقة بالنسخ المتماثلة المتوازية {#settings-related-to-parallel-replicas}
</div>
...
## استقصاء المشكلات المتعلقة بالنسخ المتماثلة المتوازية {#investigating-issues-with-parallel-replicas}
