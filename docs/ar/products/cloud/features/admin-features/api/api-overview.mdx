...
بصيغة JSON عبر https://api.clickhouse.cloud/v1. ويمكنك أيضًا العثور على وثائق API عبر
[واجهة مستخدم Swagger](/ar/api-reference/organization/get-list-of-available-organizations).
