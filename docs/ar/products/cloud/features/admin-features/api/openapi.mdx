...
<Note>
  يغطي هذا المستند واجهة برمجة تطبيقات ClickHouse Cloud. للاطلاع على نقاط النهاية لواجهة برمجة تطبيقات قاعدة البيانات، يُرجى مراجعة [Cloud Endpoints API](/ar/products/cloud/guides/sql-console/query-endpoints)
</Note>
