...
4. باستخدام [Terraform](#manage-udfs-with-terraform) (alpha)
...
يتوفر كل ما هو متاح في واجهة المستخدم برمجيًا أيضًا عبر [ClickHouse Cloud واجهة برمجة تطبيقات](/ar/cloud/manage/api/api-overview).
...
<Note>
  تتوفر هذه الموارد في إصدار الموفّر 3.24.0 والإصدارات الأحدث. وهي في حالة alpha، وقد يتغير سلوكها في إصدارات الموفّر المستقبلية.
</Note>
