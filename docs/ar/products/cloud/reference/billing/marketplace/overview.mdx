...
<div id="how-can-i-verify-that-my-organization-is-connected-to-marketplace-billing">
  ### كيف يمكنني التحقق من أن مؤسستي مرتبطة بفوترة Marketplace؟​ {#how-can-i-verify-that-my-organization-is-connected-to-marketplace-billing}
</div>
...
<div id="i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-how-can-i-unsubscribe">
  ### اشتركتُ في ClickHouse Cloud كمستخدم عبر marketplace. كيف يمكنني إلغاء الاشتراك؟​ {#i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-how-can-i-unsubscribe}
</div>
...
<div id="i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-and-then-unsubscribed-now-i-want-to-subscribe-back-what-is-the-process">
  ### اشتركتُ في ClickHouse Cloud كمستخدم عبر Marketplace، ثم ألغيتُ الاشتراك. والآن أريد الاشتراك مجددًا، فما الإجراء؟​ {#i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-and-then-unsubscribed-now-i-want-to-subscribe-back-what-is-the-process}
</div>
...
<div id="how-do-i-access-my-invoice-for-my-marketplace-subscription-to-the-clickhouse-cloud-service">
  ### كيف يمكنني الوصول إلى فاتورتي لاشتراك Marketplace في خدمة ClickHouse Cloud؟​ {#how-do-i-access-my-invoice-for-my-marketplace-subscription-to-the-clickhouse-cloud-service}
</div>
...
<div id="why-do-the-dates-on-the-usage-statements-not-match-my-marketplace-invoice">
  ### لماذا لا تتطابق التواريخ في كشوف Usage مع فاتورة Marketplace الخاصة بي؟​ {#why-do-the-dates-on-the-usage-statements-not-match-my-marketplace-invoice}
</div>
...
<div id="where-can-i-find-general-billing-information">
  ### أين يمكنني العثور على معلومات عامة عن الفوترة؟ {#where-can-i-find-general-billing-information}
</div>
...
<div id="is-there-a-difference-in-clickhouse-cloud-pricing-whether-paying-through-the-cloud-provider-marketplace-or-directly-to-clickhouse">
  ### هل يوجد فرق في تسعير ClickHouse Cloud بين الدفع عبر marketplace الخاص بمزوّد الخدمة السحابية والدفع مباشرةً إلى ClickHouse؟ {#is-there-a-difference-in-clickhouse-cloud-pricing-whether-paying-through-the-cloud-provider-marketplace-or-directly-to-clickhouse}
</div>
...
<div id="multiple-organizations-to-bill-to-single-cloud-marketplace-account">
  ### هل يمكنني إعداد عدة مؤسسات في ClickHouse بحيث تُفوَّتر على حساب واحد لفوترة cloud marketplace ‏(AWS أو GCP أو Azure)؟ {#multiple-organizations-to-bill-to-single-cloud-marketplace-account}
</div>
...
### إذا كانت مؤسسة في ClickHouse الخاصة بي تُفوَّتر عبر اتفاقية التزام بالإنفاق من خلال cloud Marketplace، فهل سيتم نقلها تلقائيًا إلى فوترة PAYG عند نفاد الرصيد؟ {#automatically-move-to-PAYG-when-running-out-of-credit}
