...
<Steps>
  ...
  <Step title="إضافة marketplace اشتراك إلى مؤسسة" id="add-marketplace-subscription">
    بعد تسجيل الدخول بنجاح، يمكنك إما إنشاء مؤسسة جديدة لتتم فوترة هذه marketplace اشتراك عليها، أو اختيار مؤسسة حالية لتتم الفوترة عليها عبر هذا الاشتراك.

    <Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-8.webp" size="md" alt="إضافة marketplace اشتراك" border />
