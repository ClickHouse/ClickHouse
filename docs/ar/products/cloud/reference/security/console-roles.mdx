...
| عضو              | يتيح تسجيل الدخول فقط مع إمكانية إدارة إعدادات الملف الشخصي. ويُعيَّن افتراضيًا لمستخدمي SAML SSO، ما لم تكن المؤسسة قد هيأت دورًا افتراضيًا مختلفًا.                       |
