...
| **وحدة تحكم SQL دور mapping** ([مزيد من المعلومات](/ar/products/cloud/guides/security/cloud-access-management/manage-sql-console-role-assignments)) | إدارة تعيينات الأدوار في وحدة تحكم SQL                                                                                                                                        |
