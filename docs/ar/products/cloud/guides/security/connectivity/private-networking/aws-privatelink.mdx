...
لنفترض أنك تحاول استخدام [MySQL](/ar/reference/functions/table-functions/mysql) أو دوال الجداول [PostgreSQL](/ar/reference/functions/table-functions/postgresql) في ClickHouse Cloud للاتصال بقاعدة البيانات المستضافة لديك داخل Amazon Web Services (AWS) VPC. لا يمكن استخدام AWS PrivateLink لتأمين هذا الاتصال. فـ PrivateLink اتصال أحادي الاتجاه؛ إذ يتيح لشبكتك الداخلية أو لـ Amazon VPC الاتصال بـ ClickHouse Cloud بأمان، لكنه لا يتيح لـ ClickHouse Cloud الاتصال بشبكتك الداخلية.
