...
<Tip>
  يُفضَّل استخدام [أدوار قاعدة البيانات المُدارة عبر Cloud](/ar/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles) (بيتا) لإدارة الوصول إلى قاعدة البيانات من وحدة التحكم. لا تتوافق أدوار `sql-console-role:<email>` مع [مصادقة JWT](/ar/products/cloud/guides/security/cloud-access-management/jwt-authentication-setup).
</Tip>
