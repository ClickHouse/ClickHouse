...
| [ترحيل RBAC باستخدام الأدوار المخصصة](/ar/products/cloud/guides/security/cloud-access-management/migrating-rbac-custom-roles)      | دليل للمسؤول للترحيل إلى نظام التحكم في الوصول الجديد المستند إلى الدور                                      |
