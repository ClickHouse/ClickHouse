...
<Note>
  **إدارة أدوار قاعدة البيانات من Console (Beta)**

  يمكنك أيضًا إدارة أدوار قاعدة البيانات مباشرةً من ClickHouse Cloud console بإضافة أذونات البيانات إلى الأدوار المخصّصة. هذه الميزة في مرحلة Beta ومتاحة للخدمات التي تشغّل ClickHouse بالإصدار 26.4 وما بعده. تتقدّم الأدوار المُسنَدة يدويًا باستخدام اصطلاح التسمية `sql-console-role:<email>` على الأدوار المُسنَدة عبر Console. لمزيد من المعلومات، راجع [إدارة أدوار قاعدة البيانات](/ar/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles).
</Note>
