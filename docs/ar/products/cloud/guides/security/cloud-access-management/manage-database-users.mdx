...
<div id="sql-console-passwordless-authentication">
  ### المصادقة بدون كلمة مرور في SQL Console {#sql-console-passwordless-authentication}
</div>
...
<Tip>
  يُفضَّل استخدام [أدوار قاعدة البيانات المُدارة عبر Cloud](/ar/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles) (Beta) لإدارة الوصول إلى قاعدة البيانات من Console. الأدوار `sql-console-role:<email>` غير متوافقة مع [مصادقة JWT](/ar/products/cloud/guides/security/cloud-access-management/jwt-authentication-setup).
</Tip>
...
<div id="database-authentication">
  ## مصادقة قاعدة البيانات {#database-authentication}
</div>

<div id="database-user-id--password">
  ### معرّف مستخدم قاعدة البيانات وكلمة المرور {#database-user-id--password}
</div>
...
<div id="database-ssh">
  ### مستخدم قاعدة بيانات مع مصادقة SSH {#database-ssh}
</div>
