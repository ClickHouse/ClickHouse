...
<Tip>
  يُفضَّل استخدام [أدوار قاعدة البيانات المُدارة عبر Cloud](/ar/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles) (Beta) لإدارة الوصول إلى قاعدة البيانات من Console. الأدوار `sql-console-role:<email>` غير متوافقة مع [مصادقة JWT](/ar/products/cloud/guides/security/cloud-access-management/jwt-authentication-setup).
</Tip>
