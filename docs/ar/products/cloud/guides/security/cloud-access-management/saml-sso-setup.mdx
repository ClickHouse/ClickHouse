...
نحن ندعم SSO الذي يبدأه موفّر الخدمة، واستخدام مؤسسات متعددة لاتصالات منفصلة، والتوفير الفوري عند الحاجة. كما ندعم توفير SCIM في معاينة خاصة مع [Okta](/ar/products/cloud/guides/security/cloud-access-management/scim-setup) و[Microsoft Entra ID](/ar/products/cloud/guides/security/cloud-access-management/scim-setup-entra). ولا ندعم حتى الآن تعيين السمات.
...
* توفير SCIM — أتمتة تهيئة المستخدمين والمجموعات باستخدام [Okta](/ar/products/cloud/guides/security/cloud-access-management/scim-setup) أو [Microsoft Entra ID](/ar/products/cloud/guides/security/cloud-access-management/scim-setup-entra) (معاينة خاصة).
