...
نحن ندعم SSO الذي يبدأه موفّر الخدمة، واستخدام مؤسسات متعددة لاتصالات منفصلة، والتوفير الفوري عند الحاجة. كما ندعم [توفير SCIM](/ar/products/cloud/guides/security/cloud-access-management/scim-setup) في معاينة خاصة، مع دعم Okta. ولا ندعم حتى الآن تعيين السمات.
