...
يمكن تمكين [المجموعات المسماة](/ar/concepts/features/configuration/server-config/named-collections) التي أُنشئت باستخدام DDL في بعض خدمات ClickHouse Cloud. تواصل مع فريق الدعم لتأكيد التوافر. لا تتوفر المجموعات المسماة المُعرَّفة في ملفات التكوين لأن المستخدمين لا يمكنهم تعديل ملفات تكوين الخادم في ClickHouse Cloud.
