...
محركات الجداول التالية مدعومة أيضًا وتُستخدم كما هي مكتوبة. ويختلف محرك الجدول `MySQL` المدعوم عن محرك قاعدة البيانات `MySQL` غير المدعوم:
...
## قائمة الميزات غير المدعومة {#list-of-unsupported-features}
