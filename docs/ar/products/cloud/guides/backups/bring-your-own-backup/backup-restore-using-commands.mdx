...
<Tabs>
  ...
  <Tab title="الاستعادة">
    ...
    عند تمكين `restore_access_entities_with_current_grants`، تُقيَّد منح المستخدمين والأدوار المستعادة بما يُسمح للمستخدم الذي يجري الاستعادة بمنحه
    (بنفس دلالات [`GRANT CURRENT GRANTS`](/ar/sql-reference/statements/grant))، بدلًا من فشل `RESTORE`
