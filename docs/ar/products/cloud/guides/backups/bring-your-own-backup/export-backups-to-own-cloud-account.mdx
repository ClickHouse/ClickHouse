...
النسخ الاحتياطية المُصدَّرة إلى حسابك السحابي الخاص تختلف عن نسخ Cloud الاحتياطية في مكانها من ناحية مهمة واحدة: إذ لا يمكنها استخدام النسخ الأصلي (راجع الملاحظة أدناه).
...
<Warning>
  **تأثير الأداء مقارنةً بالنسخ الاحتياطية في مكانها**
  لا يمكن للنسخ الاحتياطية المُصدَّرة إلى الحاوية الخاصة بك استخدام النسخ الأصلي (على جانب الخادم). يتطلب النسخ الأصلي أن يشترك المصدر والوجهة في بيانات الاعتماد نفسها، وهو ما لا
  ينطبق هنا: فالمصدر هو حاوية مُدارة من ClickHouse والوجهة هي الحاوية الخاصة بك، مع مصادقة باستخدام بيانات اعتماد منفصلة.

  ولأن النسخ الأصلي غير متاح، تُنزَّل البيانات من المصدر ثم يُعاد رفعها إلى الحاوية الخاصة بك (&quot;النسخ عبر المخازن المؤقتة&quot;). ونتيجةً لذلك، يكون تصدير
