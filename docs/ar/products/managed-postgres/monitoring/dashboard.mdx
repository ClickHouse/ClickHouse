...
<Image img="/images/managed-postgres/monitoring/dashboard.webp" alt="لوحة معلومات المراقبة تعرض IOPS، وCPU usage، والذاكرة، والقرص، والبايتات المستلَمة والمرسَلة، وعدد البايتات لكل قاعدة بيانات، والاتصالات، ومعدل النقل، وعملية commit وrollback، والنسبة المئوية لعمليات قراءة block التي تُخدَّم من buffer cache بدلًا من القرص، وdeadlock" size="lg" border />
