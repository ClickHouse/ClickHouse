...
| [Query Insights](/ar/products/managed-postgres/monitoring/query-insights)    | بيانات قياس عن بُعد لكل عبارة: كل نمط query مُرتَّب حسب التأثير، مع عدادات تشخيصية                         | لا شيء                   |
