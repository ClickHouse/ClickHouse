...
<div id="price-performance">
  ## الأداء مقابل السعر {#price-performance}
</div>
...
<div id="tier-based-pricing">
  ### التسعير حسب الفئة {#tier-based-pricing}
</div>
...
<div id="pricing-calculator">
  ## حاسبة التسعير {#pricing-calculator}
</div>
...
<div id="beta-pricing-highlights">
  ## أبرز ملامح تسعير Beta {#beta-pricing-highlights}
</div>

<div id="aws-public-beta-pricing">
  ### تسعير Public Beta على AWS {#aws-public-beta-pricing}
</div>
...
### تسعير المعاينة الخاصة على GCP {#gcp-private-preview-pricing}
