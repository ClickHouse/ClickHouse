...
<Visibility for="humans">
  <View title="واجهة مستخدم Cloud">
    ...
    * استعلم من ClickHouse مباشرةً من داخل Postgres باستخدام `pg_clickhouse`
    ...
    ## الجزء 1: البدء مع NVMe Postgres {#part-1}

    ### إنشاء قاعدة بيانات {#create-postgres-database}
    ...
    ### اختبر أداء NVMe {#nvme-performance}
    ...
    ### تشغيل الاستعلامات على بياناتك {#run-queries}
    ...
    ***
    ...
    ## الجزء الثاني: إضافة تحليلات فورية مع ClickHouse {#part-2}
    ...
    * **ClickHouse** لإجراء تحليلات على مليارات الصفوف في أقل من ثانية
    ...
    ### إعداد تكامل ClickHouse {#setup-integrate-clickhouse}
    ...
    * انقر على **Replicate data to ClickHouse**.
    ...
    ### الاستعلام عن ClickHouse من Postgres {#pg-clickhouse-extension}
    ...
    ### شاهد تحليلاتك عمليًا {#analytics-after-integration}
    ...
    ### مقارنة أداء Postgres مقابل ClickHouse {#performance-comparison}
