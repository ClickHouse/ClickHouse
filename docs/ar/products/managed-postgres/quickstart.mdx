...
<Image img="/images/managed-postgres/create-service.webp" alt="إنشاء خدمة Managed Postgres" size="md" border />

أدخل اسمًا لمثيل قاعدة البيانات، ثم انقر على **Create service**. سيتم توجيهك إلى صفحة Overview.

<Image img="/images/managed-postgres/overview.webp" alt="صفحة Overview لـ Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/connect-modal.webp" alt="النافذة المنبثقة Connect في Managed Postgres" size="md" border />
...
الآن بعد أن أصبحت لدينا جداول وبيانات في Postgres، لننسخ الجداول إلى ClickHouse لأغراض التحليلات. نبدأ بالنقر على **تكامل ClickHouse** في الشريط الجانبي. ثم يمكنك النقر على **Replicate data in ClickHouse**.
...
انقر على **Next** للانتقال إلى منتقي الجداول. وكل ما عليك فعله هنا هو:

* تحديد قاعدة بيانات ClickHouse لنسخ البيانات إليها.
* توسيع مخطط **public** وتحديد جدولَي users وevents اللذين أنشأناهما سابقًا.
* النقر على **Replicate data to ClickHouse**.

<Image img="/images/managed-postgres/table-picker.webp" alt="منتقي جداول Managed Postgres" size="md" border />
...
<Image img="/images/managed-postgres/replicated-tables.webp" alt="جداول Managed Postgres المنسوخة بالنسخ المتماثل في ClickHouse" size="md" border />
