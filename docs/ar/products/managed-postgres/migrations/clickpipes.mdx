...
### الخطوة 1: ضبط قاعدة بيانات Postgres المصدر على وضع القراءة فقط
...
### الخطوة 2: التحقق من أعداد الصفوف
...
### الخطوة 3: إيقاف الـ pipe مؤقتًا
...
### الخطوة 4: إعادة تعيين التسلسلات
