...
<Note>
  إذا واجهت مشكلات أثناء الترحيل، فراجع [الأسئلة الشائعة حول عمليات ترحيل Managed Postgres](/ar/cloud/managed-postgres/migrations/faq) للاطلاع على الأخطاء الشائعة وحلولها.
</Note>
