...
<Steps>
  <Step title="استنسخ المستودع" id="clone-the-repository">
    ```bash
  ...
  <Step title="تهيئة خيارات التثبيت" id="configure-installation-options">
  ...
  <Step title="ابنِ وانشر" id="build-and-deploy">
