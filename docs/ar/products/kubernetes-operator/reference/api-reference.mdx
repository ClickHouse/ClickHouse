...
| الحقل    | النوع                                       | الوصف                                                                                                                                                       | مطلوب | الافتراضي |
| -------- | ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------- |
| `policy` | [NetworkPolicyPolicy](#networkpolicypolicy) | تحدد السياسة ما إذا كان المشغّل يدير مورد NetworkPolicy يقيّد حركة الدخول إلى كبسولات Keeper.<br />تكون القيمة الافتراضية &quot;Disabled&quot; إذا لم تُعيَّن. | false | Disabled  |
