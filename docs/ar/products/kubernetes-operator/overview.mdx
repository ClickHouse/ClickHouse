...
* **[المقدمة](/ar/products/kubernetes-operator/guides/introduction)** - نظرة عامة عامة على مفاهيم مُشغِّل ClickHouse
* **[دليل التهيئة](/ar/products/kubernetes-operator/guides/configuration)** - تهيئة عناقيد ClickHouse وKeeper
* **[المراقبة](/ar/products/kubernetes-operator/guides/monitoring)** - مقاييس Prometheus ومسبارات التحقق من السلامة لـ مُشغِّل ClickHouse
...
* **[سياسات الشبكة](/ar/products/kubernetes-operator/guides/network-policies)** - تقييد حركة المرور الواردة إلى نقاط نهاية المقاييس وwebhook الخاصة بـ مُشغِّل ClickHouse
