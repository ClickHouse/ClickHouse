...
شغّل Agentic Data Stack بالكامل محليًا باستخدام Docker Compose لطرح أسئلة على بياناتك منذ أول تسجيل دخول. يتيح لك أمر واحد فقط، وهو `docker compose up`، تشغيل [LibreChat](/ar/products/agentic-data-stack/components/librechat) و[خادم MCP من ClickHouse](/ar/products/agentic-data-stack/components/mcp-server) و[ClickHouse](/ar/get-started/setup/install) و[Langfuse](/ar/products/agentic-data-stack/components/langfuse) لأغراض المراقبة.
