...
<div id="accessing-prometheus-stack">
  ### الوصول إلى Prometheus Stack
</div>

للاتصال بحزمة Prometheus المضمّنة:

1. **فعِّل موازن التحميل الخاص** لبنية BYOC التحتية لديك في ClickHouse Cloud console (راجع [موازنات التحميل](/ar/products/bring-your-own-cloud/configuration/configurations#load-balancers)).
