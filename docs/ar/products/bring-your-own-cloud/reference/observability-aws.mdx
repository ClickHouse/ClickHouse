...
<div id="prometheus-monitoring">
  ## أساليب المراقبة باستخدام Prometheus {#prometheus-monitoring}
</div>
...
<div id="monitoring-approaches-comparison">
  ### مقارنة أساليب المراقبة {#monitoring-approaches-comparison}
</div>
...
<div id="builtin-prometheus-stack">
  ## حزمة Prometheus المدمجة في BYOC {#builtin-prometheus-stack}
</div>
...
<div id="prometheus-stack-integration">
  ### التكامل مع أدوات المراقبة لديك {#prometheus-stack-integration}
</div>
...
<div id="direct-prometheus-integration">
  ## تكامل Prometheus مع خدمة ClickHouse {#direct-prometheus-integration}
</div>
