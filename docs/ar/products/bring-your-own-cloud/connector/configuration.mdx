...
description: 'هيّئ ClickHouse Connector: مثيلات ClickHouse، وقوائم السماح الخاصة بالمشغّل، وسياسات الشبكة، وإخفاء المعلومات الحساسة، والمرايا الخاصة، والتخزين'
...
## إضافة مثيلات ClickHouse أو تعديلها {#clickhouse-instances}
...
## سياسة الشبكة وحركة المرور الصادرة {#network-policy}
