...
تُعد هذه الصفحة مرجع الأمان لـ ClickHouse Connector: مجموعة الاتصالات الكاملة التي ينشئها، والامتيازات الدقيقة التي يمتلكها، وما يستحيل عليه فعله من الناحية البنيوية، وكيف يُنسَب كل إجراء. لمعرفة كيفية ترابط المكونات، راجع [المعمارية](/ar/products/bring-your-own-cloud/connector/architecture).
...
## ما لا يمكن للموصل فعله {#what-the-connector-cannot-do}
...
## كيفية إسناد عمليات الوصول {#how-access-is-attributed}
