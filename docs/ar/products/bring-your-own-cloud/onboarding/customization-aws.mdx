...
<Info>
  أدوار IAM التي يديرها العميل متاحة حاليًا في معاينة خاصة. تواصل مع ClickHouse Support لتمكين هذه الإمكانية لمؤسستك قبل اتباع الخطوات أدناه.
</Info>

باستخدام أدوار IAM التي يديرها العميل، يمكنك:
