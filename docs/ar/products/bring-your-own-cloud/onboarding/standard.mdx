...
<Steps>
  <Step title="اختر موفر خدمة سحابية" id="choose-cloud-provider">
  ...
  <Step title="إعداد البنية التحتية لـ BYOC" id="setup-byoc-infrastructure">
