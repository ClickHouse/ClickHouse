...
<Steps>
  ...
  <Step stepNumber={1}>
    ## الخطوة 1: ضبط متغيرات البيئة (`00-env.sh`)
  ...
  <Step stepNumber={2}>
    ## الخطوة 2: إنشاء Artifact Registry (`01-artifact-registry.sh`)
  ...
  <Step stepNumber={3}>
    ## الخطوة 3: نسخ صور الحاويات (`02-copy-images.sh`)
  ...
  <Step stepNumber={4}>
    ## الخطوة 4: تهيئة VPC والشبكة الفرعية (`03-vpc-subnet.sh`)
  ...
  <Step stepNumber={5}>
    ## الخطوة 5: إنشاء Cloud NAT (`04-cloud-nat.sh`)
  ...
  <Step stepNumber={6}>
    ## الخطوة 6: إنشاء حساب خدمة في GCP (`05-service-account.sh`)
  ...
  <Step stepNumber={7}>
    ## الخطوة 7: إنشاء حاوية GCS (`06-gcs-bucket.sh`)
  ...
  <Step stepNumber={8}>
    ## الخطوة 8: إنشاء عنقود GKE (`07-gke-cluster.sh`)
  ...
  <Step stepNumber={9}>
    ## الخطوة 9: إنشاء مجموعات العقد (`08-node-pools.sh`)
  ...
  <Step stepNumber={10}>
    ## الخطوة 10: نشر DaemonSet للقرص Local SSD (`09-local-ssd-daemonset.sh`)
  ...
  <Step stepNumber={11}>
    ## الخطوة 11: إضافة تسميات الطوبولوجيا (`10-topology-labels.sh`)
  ...
  <Step stepNumber={12}>
    ## الخطوة 12: تثبيت المتطلبات الأساسية لـ Kubernetes
  ...
  <Step stepNumber={14}>
    ## الخطوة 14: تثبيت الـ Operator (`16-install-operator.sh`)
  ...
  <Step stepNumber={15}>
    ## الخطوة 15: نشر مجموعة ClickHouse (`17-install-cluster.sh`)
  ...
  <Step stepNumber={16}>
    ## الخطوة 16: ربط Workload Identity (`18-bind-helm-workload-identity.sh`)
