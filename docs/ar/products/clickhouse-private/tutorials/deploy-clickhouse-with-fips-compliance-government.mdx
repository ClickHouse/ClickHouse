...
<Steps>
  <Step title="المرحلة 1: إنشاء شهادات FIPS" id="phase-1-create-fips-certificates">
  ...
  <Step title="المرحلة 2: تثبيت المتطلبات الأساسية لـ Kubernetes" id="phase-2-install-kubernetes-prerequisites">
  ...
  <Step title="المرحلة 3: تثبيت المشغِّل" id="phase-3-install-operator">
  ...
  <Step title="المرحلة 4: إنشاء أسرار الشهادات" id="phase-4-create-certificate-secrets">
  ...
  <Step title="المرحلة 5: نشر مجموعة ClickHouse" id="phase-5-deploy-clickhouse-cluster">
  ...
  <Step title="المرحلة 6: التحقق من التثبيت" id="phase-6-verify-installation">
