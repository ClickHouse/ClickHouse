...
slug: /chdb/debugging
description: 'استكشف أخطاء عمليات DataStore وأصلحها باستخدام explain() وتحليل الأداء والتسجيل'
keywords: ['chdb', 'datastore', 'استكشاف الأخطاء وإصلاحها', 'explain', 'تحليل الأداء', 'التسجيل']
doc_type: 'guide'
---
