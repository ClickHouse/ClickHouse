...
اختبار أداء شائع يُحاكي مستودع البيانات الداخلي لمورّد جملة. تُخزَّن البيانات وفق تمثيل الصيغة العادية الثالثة، مما يتطلب عددًا كبيرًا من عمليات `JOIN` عند تنفيذ الاستعلامات. ورغم قِدمه وافتراضه غير الواقعي بأن البيانات موزعة توزيعًا منتظمًا ومستقلًا، لا يزال TPC-H حتى اليوم أكثر اختبارات الأداء OLAP شيوعًا.
