...
في كثير من حالات استخدام ClickHouse، تُدمَج عدة جداول في جدول مسطّح واحد غير مُطبَّع.
هذه الخطوة اختيارية — وفيما يلي تُعرض الاستعلامات بصيغتها الأصلية وبصيغة أُعيدت كتابتها للجدول غير المُطبَّع.
