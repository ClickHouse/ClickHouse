...
<sub><span>*</span> يدعم ClickHouse أيضًا الأعداد الصحيحة غير الموقَّعة ذات النطاقات الممتدة، أي <a href="/ar/sql-reference/data-types/int-uint">`UInt8`، `UInt32`، `UInt32`، و`UInt64`</a>.</sub><br />
<sub><span>**</span>يكون نوع String في ClickHouse غير محدود افتراضيًا، ولكن يمكن تقييده بأطوال محددة باستخدام <a href="/ar/sql-reference/statements/create/table#constraints">القيود</a>.</sub>
