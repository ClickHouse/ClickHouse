...
<sub><span>*</span> يدعم ClickHouse أيضًا الأعداد الصحيحة غير الموقَّعة ذات النطاقات الممتدة، أي <a href="/ar/reference/data-types/int-uint">`UInt8`، `UInt32`، `UInt32`، و`UInt64`</a>.</sub><br />
