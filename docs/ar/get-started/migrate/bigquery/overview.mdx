...
slug: /ar/get-started/migrate/bigquery/overview
...
<div id="bigquery-projects-vs-clickhouse-cloud-services">
  ### مشاريع BigQuery مقابل خدمات ClickHouse Cloud {#bigquery-projects-vs-clickhouse-cloud-services}
</div>
...
<div id="bigquery-datasets-vs-clickhouse-cloud-databases">
  ### مجموعات بيانات BigQuery مقابل قواعد بيانات ClickHouse Cloud {#bigquery-datasets-vs-clickhouse-cloud-databases}
</div>
...
<div id="query-acceleration-techniques">
  ## تقنيات تسريع الاستعلامات {#query-acceleration-techniques}
</div>

<div id="primary-and-foreign-keys-and-primary-index">
  ### المفاتيح الأساسية والخارجية والفهرس الأساسي {#primary-and-foreign-keys-and-primary-index}
</div>
...
<div id="secondary-indexes-only-available-in-clickhouse">
  ## الفهارس الثانوية (متاحة فقط في ClickHouse) {#secondary-indexes-only-available-in-clickhouse}
</div>
...
<div id="vector-indexes">
  ## الفهارس المتجهية {#vector-indexes}
</div>
...
<div id="querying-materialized-views">
  ## الاستعلام عن العروض المادية {#querying-materialized-views}
</div>
...
<div id="data-sources-and-file-formats">
  ## مصادر البيانات وتنسيقات الملفات {#data-sources-and-file-formats}
</div>
...
<div id="sql-language-features">
  ## ميزات لغة SQL {#sql-language-features}
</div>
