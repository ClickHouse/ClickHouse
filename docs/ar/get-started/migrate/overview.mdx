...
| من OSS إلى Cloud                                                         | انقل البيانات من عملية نشر ClickHouse مُدارة ذاتيًا باستخدام [`remoteSecure`](/ar/get-started/migrate/oss-to-cloud/clickhouse-to-cloud) أو [`BACKUP` و`RESTORE`](/ar/get-started/migrate/oss-to-cloud/oss-to-cloud-backup-restore). |
