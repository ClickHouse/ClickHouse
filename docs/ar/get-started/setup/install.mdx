...
<div className="ch-install-cloud-card">
  ...
  <div className="ch-install-cloud-actions">
    ...
    <a
      ...
      href="https://clickhouse.com/docs/ar/get-started/setup/cloud"
      onClick={(event) => { event.preventDefault(); window.location.href = withDocsBase('/ar/get-started/setup/cloud'); }}
    >
