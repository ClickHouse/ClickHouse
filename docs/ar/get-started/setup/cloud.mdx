    ...
    <Steps>
      ...
      <Step title="الاتصال بـ ClickHouse" id="2-connect-to-clickhouse">
        ...
        * الاتصال من تطبيقك
        ...
        ### الاتصال باستخدام SQL Console {#connect-using-sql-console}
        ...
        ### الاتصال بتطبيقك {#connect-with-your-app}
      ...
      <Step title="إضافة بيانات" id="3-add-data">
        ...
        * حمّل البيانات من URL للملف
        ...
        ### إضافة البيانات باستخدام SQL Console {#add-data-using-the-sql-console}
        ...
        * `metric`: عدد ذو فاصلة عائمة بطول 32 بت ([Float32](/ar/reference/data-types/float))
        ...
        #### مقدمة موجزة عن المفاتيح الأساسية {#a-brief-intro-to-primary-keys}
        ...
        * المفاتيح الأساسية في ClickHouse ***ليست فريدة*** لكل صف في جدول
        ...
        #### إدراج البيانات في جدولك {#insert-data-into-your-table}
        ...
        ### إضافة البيانات باستخدام ClickHouse Client {#add-data-using-the-clickhouse-client}
