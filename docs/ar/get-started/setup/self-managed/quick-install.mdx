...
<Steps>
  <Step title="ثبّت ClickHouse باستخدام curl" id="install-clickhouse-using-curl">
    ...
    على Linux وmacOS، يثبّت هذا أيضًا [`clickhousectl`](/ar/install/clickhousectl)،
    ...
    الخلفية، وإدارة ClickHouse Cloud. راجع [صفحة تثبيت clickhousectl](/ar/install/clickhousectl)
