---
slug: /ar/concepts/features/projections/projections
title: 'الإسقاطات'
...
<div id="smarter_storage_with_part_offset">
  ### تخزين أكثر ذكاءً باستخدام `_part_offset` {#smarter_storage_with_part_offset}
</div>
...
<div id="when-to-use-projections">
  ## متى تستخدم الإسقاطات؟ {#when-to-use-projections}
</div>
...
<div id="filtering-without-using-primary-keys">
  ### التصفية على أعمدة ليست ضمن المفتاح الأساسي {#filtering-without-using-primary-keys}
</div>
...
<div id="average-price-projections">
  #### الاستعلام 1. متوسط السعر لكل سنة {#average-price-projections}
</div>
...
<div id="average-price-london-projections">
  #### الاستعلام 2. متوسط السعر سنويًا في لندن {#average-price-london-projections}
</div>
...
<div id="most-expensive-neighborhoods-projections">
  #### الاستعلام 3. الأحياء الأكثر تكلفة {#most-expensive-neighborhoods-projections}
</div>
...
<div id="combining-projections">
  ### دمج الإسقاطات في استعلام واحد {#combining-projections}
</div>
