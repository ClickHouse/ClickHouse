...
ويمكن تحديد قائمة البادئات باستخدام إعداد الخادم [`custom_settings_prefixes`](/ar/reference/settings/server-settings/settings/custom#custom_settings_prefixes)، والمُعرَّف في ملف تكوين الخادم لديك.
