...
منفذ الاستبطان هو نقطة نهاية لـ [بروتوكول قابل للتركيب](/ar/operations/settings/composable-protocols) موسومة بـ `<introspection>true</introspection>`. لا يُهيَّأ أي منفذ للاستبطان افتراضيًا:
