...
وهو إعداد الخادم `default_session_user` [إعداد الخادم](/ar/operations/server-configuration-parameters/settings)
...
مستخدم الجلسة default المُهيأ عموميًا، بينما تُصادَق الطلبات على المنفذ 8124
...
secret الخاص بـ cluster والمستخدم الأولي، ولا تستخدم أبدًا مستخدم الجلسة default.
