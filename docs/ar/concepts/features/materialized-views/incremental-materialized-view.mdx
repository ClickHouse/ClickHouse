...
في المقابل، لننظر في ما يحدث إذا أدرجنا صفًا مع تفعيل `parallel_view_processing=1`. عند تفعيل هذا الإعداد، تُنفَّذ العروض بالتوازي، من دون أي ضمانات بشأن الترتيب الذي تصل به الصفوف إلى الجدول الهدف:
