---
slug: /ar/concepts/features/materialized-views/refreshable-materialized-view
...
<div id="when-should-refreshable-materialized-views-be-used">
  ## متى ينبغي استخدام العروض المادية القابلة للتحديث؟ {#when-should-refreshable-materialized-views-be-used}
</div>
...
<div id="when-was-a-refreshable-materialized-view-last-refreshed">
  ## متى تم آخر تحديث للعرض المادي القابل للتحديث؟ {#when-was-a-refreshable-materialized-view-last-refreshed}
</div>
...
<div id="how-can-i-change-the-refresh-rate">
  ## كيف يمكنني تغيير معدل التحديث؟ {#how-can-i-change-the-refresh-rate}
</div>
...
<div id="using-append-to-add-new-rows">
  ## استخدام `APPEND` لإضافة صفوف جديدة {#using-append-to-add-new-rows}
</div>
