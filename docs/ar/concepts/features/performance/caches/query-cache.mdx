...
تخصيصها في ذاكرة التخزين المؤقت للاستعلام، والحد الأقصى لعدد نتائج الاستعلام المخزّنة. ولتنفيذ ذلك، حدِّد أولًا الإعدادين
...
من ذاكرة التخزين المؤقت للاستعلام. لتعطيل الضغط، استخدم الإعداد [query&#95;cache&#95;compress&#95;entries](/ar/reference/settings/session-settings/query-cache#query_cache_compress_entries).

أحيانًا يكون من المفيد الاحتفاظ بعدة نتائج مخزَّنة مؤقتًا للاستعلام نفسه. ويمكن تحقيق ذلك باستخدام الإعداد
[query&#95;cache&#95;tag](/ar/reference/settings/session-settings/query-cache#query_cache_tag) الذي يعمل كتسمية (أو مساحة اسم) لعناصر ذاكرة التخزين المؤقت للاستعلام. وتتعامل ذاكرة التخزين المؤقت للاستعلام
...
كذلك، لا تُخزَّن نتائج الاستعلامات التي تحتوي على دوال non-deterministic مؤقتًا افتراضيًا. وتشمل هذه الدوال:
...
لا تُخزَّن نتائج الاستعلامات التي تتضمن system tables (مثل [system.processes](/ar/reference/system-tables/processes)&#96; أو
