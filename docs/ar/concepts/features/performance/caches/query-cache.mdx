...
slug: /ar/concepts/features/performance/caches/query-cache
...
<div id="background-design-and-limitations">
  ## الخلفية والتصميم والقيود {#background-design-and-limitations}
</div>
...
<div id="configuration-settings-and-usage">
  ## إعدادات التكوين والاستخدام {#configuration-settings-and-usage}
</div>
...
<div id="subquery-caching">
  ## التخزين المؤقت للاستعلامات الفرعية {#subquery-caching}
</div>
