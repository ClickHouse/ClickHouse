...
* أنشئ دليلاً لتخزين ملفات التهيئة.
  ...
  يخزّن ClickHouse تهيئات كيانات التحكم في الوصول في المجلد المحدد في مَعلَمة إعداد الخادم [access&#95;control&#95;path](/ar/reference/settings/server-settings/settings/access-control#access_control_path).
