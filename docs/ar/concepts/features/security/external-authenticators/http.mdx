...
slug: /ar/concepts/features/security/external-authenticators/http
title: 'HTTP'
doc_type: 'reference'
---
...
<div id="http-auth-server-definition">
  ## تعريف خادم مصادقة HTTP {#http-auth-server-definition}
</div>
...
<div id="enabling-http-auth-using-sql">
  ### تمكين مصادقة HTTP باستخدام SQL {#enabling-http-auth-using-sql}
</div>
...
<div id="passing-session-settings">
  ### تمرير إعدادات الجلسة {#passing-session-settings}
</div>
