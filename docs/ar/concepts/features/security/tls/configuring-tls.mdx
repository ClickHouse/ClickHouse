---
slug: /ar/concepts/features/security/tls/configuring-tls
...
<div id="configure-openssl-for-standalone-clickhouse-keeper">
  ## تهيئة OpenSSL لـ ClickHouse Keeper المستقل {#configure-openssl-for-standalone-clickhouse-keeper}
</div>
...
<div id="openssl-verification-modes">
  ## أوضاع التحقق في OpenSSL ومعالِجات الشهادات {#openssl-verification-modes}
</div>
...
<div id="verification-modes">
  ### أوضاع التحقق {#verification-modes}
</div>
...
<div id="invalid-certificate-handlers">
  ### معالجات الشهادات غير الصالحة {#invalid-certificate-handlers}
</div>
...
<div id="disabling-certificate-verification">
  ### مثال: تعطيل التحقق من الشهادة {#disabling-certificate-verification}
</div>
