...
**④ الضغط والتخزين**: [تُضغط](/ar/reference/statements/create/table/codec) ملفات الأعمدة والفهرس الجديدان ويُحفَظان في [دليل](/ar/concepts/core-concepts/parts#what-are-table-parts-in-clickhouse) جديد يمثل جزء البيانات المدمج.
