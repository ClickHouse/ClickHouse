...
في ClickHouse 24.10، أُضيفت [لوحة معلومات لدمج الأجزاء](https://presentations.clickhouse.com/2024-release-24.10/index.html#17) جديدة إلى [لوحات معلومات المراقبة](https://clickhouse.com/blog/common-issues-you-can-solve-using-advanced-monitoring-dashboards) المضمنة. وهي متاحة في كلٍّ من OSS وCloud عبر معالج HTTP ‏`/merges`، ويمكن استخدامها لتصوير جميع دمج الأجزاء لجدولنا التجريبي:
...
يستخدم خادم ClickHouse عدة [خيوط دمج](/ar/reference/settings/server-settings/settings#background_pool_size) في الخلفية لتنفيذ دمج الأجزاء بشكل متزامن:
