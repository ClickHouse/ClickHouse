...
<Steps>
  <Step title="فك الضغط والتحميل">
    تُفك ضغط [ملفات الأعمدة الثنائية المضغوطة](/ar/concepts/core-concepts/parts#what-are-table-parts-in-clickhouse) الخاصة بالأجزاء المراد دمجها وتُحمَّل إلى الذاكرة.
  </Step>
