...
<Steps>
  ...
  <Step title="التقسيم">
    تُقسَّم البيانات المُفرَزة إلى أعمدة.
  </Step>
  ...
  <Step title="الكتابة إلى القرص">
    تُحفَظ الأعمدة المضغوطة كملفات أعمدة ثنائية داخل دليل جديد يمثّل جزء البيانات الخاص بعملية الإدراج. ويُضغط الفهرس الأساسي المتناثر أيضًا ويُخزَّن في الدليل نفسه.
  </Step>
</Steps>
