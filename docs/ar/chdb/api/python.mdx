...
أزِل دالة UDF مسجَّلة سابقًا بلغة بايثون. لا يحدث شيء إذا لم تكن الدالة مسجَّلة، لذا يمكن استدعاؤها بأمان دون شرط.
...
كما في [`create_function`](#create-function)، باستثناء `name` و`func`، إذ يُستمدّان من الدالة المُزيَّنة.
...
* تُحوَّل قيم `DateTime`/`DateTime64` المُدخلة إلى ClickHouse إلى كائنات `datetime` في بايثون مزودة بمعلومات timezone
...
6. مُفسِّر بايثون المستخدم هو نفسه المستخدم لتشغيل البرنامج النصي.
