...
بدلاً من ذلك، وجّه العميل إلى حزمة certifi مباشرةً. لا يلجأ [ClickHouse Connect](/ar/integrations/python) إلى certifi تلقائيًا، لذا مرّر الحزمة عبر المعامل `ca_cert`:
...
راجع [وثائق إعداد `clickhouse-client`](/ar/interfaces/client#configuration_files).