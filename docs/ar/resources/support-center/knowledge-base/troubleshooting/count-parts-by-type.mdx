---
title: العثور على أعداد وأحجام الأجزاء العريضة أو المدمجة
description: 'توضح لك هذه المقالة في قاعدة المعارف كيفية العثور على عدد الأجزاء حسب نوعها — عريضة أو مدمجة.'
date: 2026-01-12
tags: ['استكشاف الأخطاء وإصلاحها']
keywords: ['الأجزاء المدمجة', 'الأجزاء العريضة']
---

<br />

يمكن استخدام الاستعلام التالي لحساب عدد الأجزاء حسب النوع:
...
شغّل الاستعلام أدناه للاستعلام عن حجم الأجزاء من نوع عريض ومدمج:
...
<Info>
  **يظهر حجم الجزء المدمج على أنه صفر**

  لاحظ أن أحجام الأعمدة لا تُحتسب في الأجزاء المدمجة، لذا تظهر هنا بالقيمة `0`.
</Info>