...
description: 'توضح لك مقالة قاعدة المعارف هذه كيفية العثور على عدد الأجزاء بحسب نوعها، سواء كانت عريضة أم مدمجة.'
date: 2026-01-12
...
يمكن استخدام الاستعلام التالي لعدّ عدد الأجزاء حسب النوع:
...
<Info>
  **يظهر حجم الجزء المدمج بقيمة صفر**

  لاحظ أن أحجام الأعمدة لا تُحتسب في الأجزاء المدمجة، لذا تظهر أعلاه بالقيمة `0`.
</Info>