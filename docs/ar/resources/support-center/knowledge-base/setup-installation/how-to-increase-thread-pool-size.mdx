...
اطّلع على [الوثائق](/ar/reference/settings/server-settings/settings/max-thread#max_thread_pool_size) لمزيد من التفاصيل حول الإعدادات المذكورة أعلاه والإعدادات الأخرى التي تؤثر في المجمّع العام للخيوط.