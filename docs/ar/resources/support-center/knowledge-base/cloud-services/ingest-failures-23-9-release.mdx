...
description: "تعرّف على كيفية حل فشل الإدخال الناتجة عن التحقق الأكثر صرامة من الامتيازات، والذي استُحدث في ClickHouse 23.9 للجداول التي تستخدم `async_inserts`. حدِّث الامتيازات لإصلاح الأخطاء."
date: 2022-11-17
