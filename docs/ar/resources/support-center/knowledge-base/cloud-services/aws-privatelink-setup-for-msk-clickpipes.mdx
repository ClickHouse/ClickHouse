...
سيرشدك هذا الدليل إلى كيفية البدء بإعداد **MSK multi-VPC** لاستخدامه مع [ClickPipes Reverse Private Endpoint](/ar/integrations/clickpipes/networking/aws-privatelink#msk-multi-vpc).
...
اتبع خطوات إنشاء Reverse Private Endpoint في [وثائق ClickPipes](/ar/integrations/clickpipes/networking/aws-privatelink#creating-clickpipe).