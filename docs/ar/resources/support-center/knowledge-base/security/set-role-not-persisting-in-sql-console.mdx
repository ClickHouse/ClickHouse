...
عند تشغيل `SET ROLE` في ClickHouse Cloud SQL Console، قد يبدو أن الدور يتغير لاستعلام واحد ثم يعود إلى حالته السابقة في الاستعلام التالي. استخدم دور SQL Console لكل مستخدم عندما تحتاج الأذونات إلى الاستمرار عبر الاستعلامات والجلسات.

<Tip>
  يُفضّل استخدام [أدوار قاعدة البيانات المُدارة عبر Cloud](/ar/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles) لإدارة الوصول إلى قاعدة البيانات من وحدة التحكم. لا تتوافق أدوار `sql-console-role:<email>` مع جلسات JWT داخل SQL console.
</Tip>
...
## آلية عمل أدوار مستخدمي SQL Console {#how-sql-console-user-roles-work}
...
## تهيئة الأذونات الدائمة {#configure-persistent-permissions}
...
## تجنب تعديل الأدوار المُدارة {#avoid-modifying-managed-roles}
