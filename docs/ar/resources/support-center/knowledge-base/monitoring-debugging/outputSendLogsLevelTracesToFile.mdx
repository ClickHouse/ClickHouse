---
title: كيفية إخراج تتبعات مستوى سجلات الإرسال إلى ملف باستخدام clickhouse-client
description: "كيفية إخراج تتبعات مستوى سجلات الإرسال إلى ملف باستخدام clickhouse-client"
date: 2024-11-21
tags: ['تصدير البيانات']
keywords: ['تتبعات مستوى السجلات', 'clickhouse-client']
---
...
[رابط المرجع](/ar/reference/settings/session-settings/send-logs#send_logs_level)