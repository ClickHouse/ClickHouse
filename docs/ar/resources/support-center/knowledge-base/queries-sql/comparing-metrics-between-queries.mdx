---
date: 2023-01-14
title: مقارنة المقاييس بين استعلامين بالديسيبل
description: استعلام لمقارنة المقاييس بين استعلامين في ClickHouse.
tags: ['الأداء والتحسين']
keywords: [مقارنة الاستعلامات, مقارنة المقاييس, أداء الاستعلام]
---
...
لمقارنة المقاييس بين استعلامين، يجب أولاً الحصول على `query_id` لكلا الاستعلامين.
...
ستحصل على جدول يضم مقاييس تقارن بين الاستعلامين:
