---
title: مثال سريع في بايثون باستخدام وحدة requests لطلبات HTTP
description: "مثال يستخدم بايثون ووحدة requests للكتابة إلى ClickHouse والقراءة منه"
date: 2022-07-10
...
راجع [قاعدة المعرفة](/ar/resources/support-center/knowledge-base/integrations/python-clickhouse-connect-example#steps) هذه للاطلاع على خطوات إعداد بيئة بايثون الافتراضية.