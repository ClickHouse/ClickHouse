...
2. إعدادات نقطة النهاية.
   * تحقّق من الإعدادين [listen&#95;host](/ar/reference/settings/server-settings/settings/listen#listen_host) و[tcp&#95;port](/ar/reference/settings/server-settings/settings/tcp-port#tcp_port).
...
4. إعدادات الاتصال الآمن.
   ...
   * تحقّق من:
     * الإعداد [tcp&#95;port&#95;secure](/ar/reference/settings/server-settings/settings/tcp-port#tcp_port_secure).
     * إعدادات [شهادات SSL](/ar/reference/settings/server-settings/settings/other#openssl).
