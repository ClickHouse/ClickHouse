...
- `arg1` — Description of the argument. [DataType](/ar/reference/data-types/float)
- `arg2` — Description of the argument. [DataType](/ar/reference/data-types/float)
- `arg3` — Description of optional argument (optional). [DataType](/ar/reference/data-types/float)
...
- Returns {insert what the function returns here}. [DataType](/ar/reference/data-types/float)
