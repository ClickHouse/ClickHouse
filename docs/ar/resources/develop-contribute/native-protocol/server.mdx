...
استجابة لـ [العميل hello](/ar/resources/develop-contribute/native-protocol/client#hello).
...
| display&#95;name  | String  | `<display_name-or-hostname>` | اسم الخادم في واجهة المستخدم |
