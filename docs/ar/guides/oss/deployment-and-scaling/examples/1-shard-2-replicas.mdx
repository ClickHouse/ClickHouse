---
slug: /ar/guides/oss/deployment-and-scaling/examples/1-shard-2-replicas
...
<div id="pre-requisites">
  ## المتطلبات المسبقة {#pre-requisites}
</div>
...
#### تهيئة العنقود {#cluster-configuration}
...
### إعداد Keeper {#configuration-explanation}
