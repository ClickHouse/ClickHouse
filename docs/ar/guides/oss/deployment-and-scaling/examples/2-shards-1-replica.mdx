---
slug: /ar/guides/oss/deployment-and-scaling/examples/2-shards-1-replica
sidebarTitle: 'التوسع'
title: 'التوسع'
...
<div id="pre-requisites">
  ## المتطلبات الأساسية {#pre-requisites}
</div>
...
#### تهيئة الكلستر {#cluster-configuration}
...
#### تهيئة Keeper {#keeper-config-explanation}
...
#### تهيئة الماكرو {#macros-config-explanation}
...
### إعداد ClickHouse Keeper {#configuration-explanation}
