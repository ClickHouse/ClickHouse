...
يوضح المخطط التالي عنقود ClickHouse يضم ستة خوادم، حيث إن الشظيتين `Shard-1` و`Shard-2` من الجدول، اللتين قُدِّمتا سابقًا، تمتلك كلٌّ منهما ثلاث نسخ متماثلة. ويُرسَل استعلام إلى هذا العنقود:
