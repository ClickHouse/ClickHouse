...
### لم تعد الاستعلامات غير الصالحة تُحسَّن {#invalid-queries-are-no-longer-optimized}
...
#### التعامل مع معدِّلات النوع للأعمدة في بند `USING` {#handling-of-type-modifiers-for-columns-in-using-clause}
...
### تُفسَّر عمليات التعديل بواسطة المحلّل السابق {#mutations-are-interpreted-by-previous-analyzer}
...
### أسماء تعبيرات الجدول الشائعة المكررة {#duplicate-cte-names}
