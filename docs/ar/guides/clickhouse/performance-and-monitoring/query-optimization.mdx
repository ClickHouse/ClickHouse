...
نأمل أن يكون هذا الدليل قد ساعدك على فهم كيفية استقصاء الاستعلامات البطيئة في ClickHouse وكيفية تسريعها. وللتعمق أكثر في هذا الموضوع، يمكنك قراءة المزيد عن [محلل الاستعلام](/ar/guides/clickhouse/performance-and-monitoring/analyzer) و[التنميط](/ar/concepts/features/performance/troubleshoot/sampling-query-profiler) لفهم كيفية تنفيذ ClickHouse لاستعلامك بصورة أدق.

ومع ازدياد إلمامك بخصائص ClickHouse، أوصي بقراءة المزيد عن [مفاتيح التقسيم](/ar/concepts/best-practices/partitioning-keys) و[فهارس تخطي البيانات](/ar/concepts/features/performance/skip-indexes/skipping-indexes) للتعرّف على تقنيات أكثر تقدمًا يمكنك استخدامها لتسريع استعلاماتك.