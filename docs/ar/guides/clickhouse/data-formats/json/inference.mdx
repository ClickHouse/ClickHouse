...
تأمل المثال التالي من إصدار موسَّع من مجموعة بيانات [مجموعة بيانات Python PyPI](https://clickpy.clickhouse.com/) المذكورة أعلاه. هنا أضفنا عمود `tags` عشوائيًا يضم أزواجًا عشوائية من المفاتيح والقيم.
