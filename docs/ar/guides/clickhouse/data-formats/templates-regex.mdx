...
بشكلٍ افتراضي، سيُصدر ClickHouse خطأً عند وجود صفوف غير متطابقة. إذا كنت تريد تخطي الصفوف غير المتطابقة بدلًا من ذلك، ففعِّل هذا السلوك باستخدام الخيار [format&#95;regexp&#95;skip&#95;unmatched](/ar/reference/settings/formats/format-regexp#format_regexp_skip_unmatched):
