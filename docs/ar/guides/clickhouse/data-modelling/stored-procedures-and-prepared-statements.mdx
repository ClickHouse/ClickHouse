...
## بدائل العبارات المُحضَّرة في ClickHouse {#alternatives-to-prepared-statements-in-clickhouse}
...
### العبارات المُحضَّرة في بروتوكول MySQL {#mysql-protocol-prepared-statements}
