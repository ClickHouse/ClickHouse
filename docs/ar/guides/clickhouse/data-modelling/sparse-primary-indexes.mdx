...
<Accordion title="فحص محتوى الفهرس الأساسي">
  ...
  ولتحقيق ذلك، نحتاج أولًا إلى نسخ ملف الفهرس الأساسي إلى [user&#95;files&#95;path](/ar/reference/settings/server-settings/settings#user_files_path) الخاصة بإحدى العقد في العنقود قيد التشغيل:
