...
بدءًا من ClickHouse 25.7، يتضمن كلٌّ من [ClickHouse Client](/ar/concepts/features/interfaces/cli) و[clickhouse-local](/ar/concepts/features/tools-and-utilities/clickhouse-local) [وظائف مدعومة بالذكاء الاصطناعي](/ar/concepts/features/interfaces/client#ai-sql-generation) تحوّل الأوصاف المكتوبة باللغة الطبيعية إلى استعلامات SQL. تتيح لك هذه الميزة وصف متطلباتك المتعلقة بالبيانات بنص عادي، ثم يترجم النظام ذلك إلى عبارات SQL المقابلة.
