...
يمكن لـ ClickHouse تخزين مقاييس Prometheus في جدول [`TimeSeries`](/ar/reference/engines/table-engines/integrations/time-series) وتنفيذ استعلامات PromQL. راجع [بروتوكولات Prometheus وPromQL](/ar/interfaces/prometheus) لإعداد الإدخال والاستعلام والتصور.