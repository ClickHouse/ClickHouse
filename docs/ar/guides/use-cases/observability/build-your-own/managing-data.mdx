...
وعلاوة على ذلك، يمكن حذف البيانات بكفاءة بحسب القسم. وهذا أكثر كفاءةً بكثير من حيث استهلاك الموارد من التقنيات البديلة (عمليات التغيير أو lightweight deletes)، لذا يُفضَّل اعتماده.
