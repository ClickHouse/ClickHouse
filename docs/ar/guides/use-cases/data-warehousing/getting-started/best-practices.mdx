...
يوفّر [Paimon](/ar/reference/functions/table-functions/paimon) دوال جدولية فقط.
...
* [البدء](/ar/guides/use-cases/data-warehousing/getting-started/overview) — دليل شامل بدءًا من الاستعلام المباشر وصولًا إلى إعادة كتابة البيانات
* [الاستعلام المباشر](/ar/guides/use-cases/data-warehousing/getting-started/querying-directly) — دوال جدولية والمحركات وإصدارات العنقود للتنسيقات الأربعة
...
* [مصفوفة الدعم](/ar/guides/use-cases/data-warehousing/getting-started/support-matrix) — مقارنة الميزات عبر التنسيقات والكتالوجات وواجهات التخزين الخلفية