...
<div id="choose-access-method">
  ## اختر طريقة الوصول {#choose-access-method}
</div>
...
<div id="datalakecatalog">
  ### محرك قاعدة البيانات `DataLakeCatalog` {#datalakecatalog}
</div>
...
<div id="query-performance">
  ## حسّن أداء الاستعلامات {#query-performance}
</div>
...
<div id="parallel-cluster-reads">
  ### القراءة المتوازية على العناقيد متعددة العقد {#parallel-cluster-reads}
</div>
...
<div id="snapshot-bounds">
  ### قيّد قراءات الدُفعات بنطاق اللقطات {#snapshot-bounds}
</div>
...
<div id="filesystem-cache">
  ### تخزين ملفات Parquet مؤقتًا محليًا {#filesystem-cache}
</div>
...
<div id="iceberg-read-settings">
  #### إعدادات القراءة {#iceberg-read-settings}
</div>
...
<div id="iceberg-catalog-latency">
  #### تقليل زمن وصول الكتالوج {#iceberg-catalog-latency}
</div>
...
<div id="iceberg-time-travel">
  #### السفر عبر الزمن {#iceberg-time-travel}
</div>
...
<div id="iceberg-write-settings">
  #### عمليات الكتابة في Iceberg {#iceberg-write-settings}
</div>
...
<div id="iceberg-read-settings">
  #### إعدادات القراءة {#delta-read-settings}
</div>
...
<div id="delta-incremental-sync">
  #### تغذية بيانات التغيير في Delta {#delta-incremental-sync}
</div>
...
<div id="debug-system-tables">
  ## استكشاف أخطاء استعلامات بحيرة البيانات وإصلاحها {#debug-system-tables}
</div>
...
<div id="debug-catalog">
  ### التحقق من اتصال الكتالوج {#debug-catalog}
</div>
...
<div id="debug-files">
  ### اعرف الملفات التي تتم قراءتها {#debug-files}
</div>
...
<div id="debug-query-log">
  ### تحقّق من حجم المسح {#debug-query-log}
</div>
...
<div id="debug-metadata-logs">
  ### سجلات البيانات الوصفية {#debug-metadata-logs}
</div>
