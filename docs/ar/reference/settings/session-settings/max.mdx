...
<Note>
  يتجاوز إعداد الاستعلام هذا إعداد الخادم المقابل له. راجع [max&#95;partition&#95;size&#95;to&#95;drop](/ar/reference/settings/server-settings/settings/max#max_partition_size_to_drop)
</Note>
...
<Note>
  يتجاوز إعداد الاستعلام هذا الإعداد المكافئ له على مستوى الخادم، راجع [max&#95;table&#95;size&#95;to&#95;drop](/ar/reference/settings/server-settings/settings/max-table#max_table_size_to_drop)
</Note>
