...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | ----------------- |
| [`output_format_orc_string_as_string`](/ar/reference/settings/formats#output_format_orc_string_as_string)                                                                                  | استخدام النوع String في ORC بدلًا من Binary لأعمدة String.                       | `true`             |
| [`output_format_orc_compression_method`](/ar/reference/settings/formats#output_format_orc_compression_method)                                                                             | طريقة الضغط المستخدمة في تنسيق ORC للإخراج. القيمة الافتراضية                    | `zstd`            |
| [`input_format_orc_case_insensitive_column_matching`](/ar/reference/settings/formats#input_format_orc_case_insensitive_column_matching)                                                    | تجاهل حالة الأحرف عند مطابقة أعمدة ORC مع أعمدة ClickHouse.                      | `false`            |
| [`input_format_orc_allow_missing_columns`](/ar/reference/settings/formats#input_format_orc_allow_missing_columns)                                                                          | السماح بالأعمدة المفقودة أثناء قراءة بيانات ORC.                                 | `true`             |
| [`input_format_orc_skip_columns_with_unsupported_types_in_schema_inference`](/ar/reference/settings/formats#input_format_orc_skip_columns_with_unsupported_types_in_schema_inference)      | السماح بتخطي الأعمدة ذات الأنواع غير المدعومة أثناء استنتاج المخطط لتنسيق ORC.   | `false`            |
