...
<Note>
  ...
  فستُطابَق أعمدة بيانات الإدخال مع أعمدة الجدول حسب أسمائها، كما سيُتجاوز أي عمود ذي اسم غير معروف إذا كان الإعداد [`input_format_skip_unknown_fields`](/ar/reference/settings/formats#input_format_skip_unknown_fields) مضبوطًا على `1`.
