...
| `TIMESTAMP`, `TIME32`, `TIME64`         | [DateTime64](/ar/reference/data-types/datetime64)                                                            | `TIMESTAMP`                 |
...
ليس من الضروري أن تتطابق أنواع البيانات في أعمدة جدول ClickHouse مع حقول بيانات Arrow المقابلة. عند إدراج البيانات، يفسّر ClickHouse أنواع البيانات وفقًا للجدول أعلاه ثم [يحوّل](/ar/reference/functions/regular-functions/type-conversion-functions#CAST) البيانات إلى نوع البيانات المحدَّد لعمود جدول ClickHouse.
