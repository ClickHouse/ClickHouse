...
| جسم كتلة      | —      | —     | راجع [بنية كتلة &amp; والعمود](/ar/reference/interfaces/specs/NativeFormat#block-and-column-structure).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
تُوثَّق متغيرات كتلة وما تعنيه ضمن [متغيرات كتلة](/ar/reference/interfaces/specs/NativeFormat#block-variants).
