...
تعيد أكبر قيمة بين الوسيطات.
يتم تجاهل الوسيطات `NULL`.
...
<Info>
  **استخدم الإعداد `least_greatest_legacy_null_behavior` لتغيير سلوك `NULL`**
  ...
  قدّم الإصدار [24.12](/ar/resources/changelogs/oss/2024#a-id2412a-clickhouse-release-2412-2024-12-19) تغييرًا غير متوافق مع الإصدارات السابقة، بحيث يتم تجاهل قيم `NULL`، بينما كان يُرجِع سابقًا `NULL` إذا كانت إحدى الوسيطات `NULL`.
...
تُرجِع أكبر قيمة بين الوسائط، مع ترقيتها إلى أوسع نوع متوافق. [`Any`](/ar/reference/data-types/index)
