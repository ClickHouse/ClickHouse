---
description: 'تنشئ جدولًا من ملفات موجودة في HDFS. تشبه دالة الجدول هذه دالتي الجداول url وfile.'
sidebarTitle: 'hdfs'
...
تنشئ جدولًا من ملفات موجودة في HDFS. تشبه دالة الجدول هذه دالتي الجداول [url](/ar/reference/functions/table-functions/url) و[file](/ar/reference/functions/table-functions/file).
