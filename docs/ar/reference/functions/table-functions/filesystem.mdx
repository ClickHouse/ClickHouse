---
description: 'يوفّر إمكانية الوصول إلى نظام الملفات لعرض الملفات وإرجاع بياناتها الوصفية ومحتواها.'
...
في وضع `clickhouse-server`، يجب أن يكون مسار ضمن دليل ‏[user&#95;files&#95;path](/ar/reference/settings/server-settings/settings#user_files_path). تتم متابعة الروابط الرمزية داخل `user_files_path` التي تشير إلى مسارات خارجه، ولكن لا تُرجع إلا الإدخالات التي يبدأ مسار الخاص بها (عبر الرابط الرمزي) بـ `user_files_path`.
