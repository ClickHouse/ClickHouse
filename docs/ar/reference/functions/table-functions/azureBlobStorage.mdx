...
يوفّر واجهة مشابهة للجداول لتنفيذ select/insert على الملفات في [Azure Blob Storage](https://azure.microsoft.com/en-us/products/storage/blobs). دالة الجدول هذه مشابهة لـ [دالة s3](/ar/reference/functions/table-functions/s3).
