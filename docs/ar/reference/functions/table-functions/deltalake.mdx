...
تُعد عمليات الكتابة في Delta Lake ميزة Beta، وهي معطّلة افتراضيًا. فعِّلها باستخدام ما يلي (يتوفر `allow_delta_lake_writes` بدءًا من الإصدار 26.7؛ وفي الإصدارات الأقدم استخدم `allow_experimental_delta_lake_writes`):
