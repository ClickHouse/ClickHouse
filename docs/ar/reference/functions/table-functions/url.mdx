...
* تُوسَّع قوالب `URL` قبل جلب صفحات الفهرس، بما في ذلك توسيع الشظايا المفصولة بفواصل ونطاقات الأرقام وخيارات `|` للتبديل الاحتياطي خارج مكوّن المسار.
...
* إذا كان عنوان URL المُدرَج يحتوي بالفعل على سلسلة استعلام أو جزء، فستكون لهما الأولوية على نظيريهما من عنوان URL المصدر. وإلا، فستُستخدم سلسلة الاستعلام والجزء من عنوان URL المصدر.
* يُسمح بسرد فارغ؛ أما أخطاء HTTP ‏(مثل 404) في صفحات الفهرس فتؤدي إلى ظهور استثناءات.
* يُقيَّد الحد الأقصى لحجم صفحة الفهرس بواسطة [max&#95;http&#95;index&#95;page&#95;size](/ar/reference/settings/server-settings/settings/max#max_http_index_page_size).
* يُقيَّد الحد الأقصى لعدد الدلائل المقروءة أثناء التوسيع التكراري بواسطة [url&#95;wildcard&#95;max&#95;directories&#95;to&#95;read](/ar/reference/settings/session-settings/url#url_wildcard_max_directories_to_read).
