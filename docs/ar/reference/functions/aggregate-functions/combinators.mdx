...
يحوّل هذا المُركِّب ناتج الدالة التجميعية إلى نوع البيانات [Nullable](/ar/reference/data-types/nullable). وإذا لم تتوفر للدالة التجميعية قيم لإجراء الحساب عليها، فإنها تُرجع [NULL](/ar/reference/settings/formats/input-format#input_format_null_as_default).
...
يمكن أيضًا استخدام `-OrNull` مع مُركِّبات أخرى. ويكون ذلك مفيدًا عندما لا تقبل الدالة التجميعية مُدخلًا فارغًا.
