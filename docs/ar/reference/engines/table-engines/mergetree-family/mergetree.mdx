...
<Warning>
  إحصاءات النوع `tdigest` لها تكاليف إنشاء مرتفعة وقد تؤدي إلى إبطاء إدخال البيانات.
</Warning>
...
<Warning>
  إحصاءات النوع `countmin` لها تكاليف إنشاء مرتفعة وقد تؤدي إلى إبطاء إدخال البيانات.
</Warning>
