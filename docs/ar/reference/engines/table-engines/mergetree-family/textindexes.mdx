...
<a id="preprocessor-argument-optional" />**وسيطة المعالج المسبق (اختيارية)**. يشير المعالج المسبق إلى تعبير يُطبَّق على سلسلة الإدخال قبل تقسيمها إلى رموز.
...
يُحوِّل تعبير المُعالج اللاحق الرموز المميزة من نوع [String](/ar/reference/data-types/string) إلى رموز مميزة من النوع ذاته.
