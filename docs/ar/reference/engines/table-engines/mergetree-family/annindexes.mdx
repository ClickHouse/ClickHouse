...
ويُضرَب عدد أقرب الجيران التي يجري جلبها من فهرس المتجهات في قيمة هذا الإعداد، ثم يُطبَّق عامل تصفية إضافي على تلك الصفوف لإرجاع عدد من الصفوف يساوي قيمة LIMIT.
