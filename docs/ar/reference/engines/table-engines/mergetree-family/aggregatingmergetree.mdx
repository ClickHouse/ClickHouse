...
إلى وقت الدمج. في العادة، يكون من الضروري تضمين الأعمدة التي لا تشكّل جزءًا من التجميع في جملة `GROUP BY`
الخاصة بتعريف الـ materialized view لتفادي حدوث خطأ. غير أنه يمكنك الاستفادة من الدالة [`initializeAggregation`](/ar/reference/functions/regular-functions/other-functions#initializeAggregation)
