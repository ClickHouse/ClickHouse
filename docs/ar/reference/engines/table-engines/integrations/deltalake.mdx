...
<Note>
  ...
  تُعد عمليات الكتابة إلى Delta Lake ميزة Beta ويجب تمكينها باستخدام `SET allow_delta_lake_writes = 1` (متاح بدءًا من الإصدار 26.7؛ وفي الإصدارات الأقدم استخدم `SET allow_experimental_delta_lake_writes = 1`).
</Note>
