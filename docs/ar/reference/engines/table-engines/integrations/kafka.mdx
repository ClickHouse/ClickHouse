...
<div id="static-partition-to-shard-affinity">
  ### التخصيص الثابت للأقسام إلى الشظايا
</div>
...
* عند استخدام ألفة الأقسام، يجب أن تستخدم جميع الأجزاء `kafka_shard_count` نفسه؛ وإلا فقد تُستهلك بعض الأقسام بواسطة أجزاء متعددة أو تظل دون استهلاك.
