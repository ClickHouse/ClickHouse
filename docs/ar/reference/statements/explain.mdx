...
<Note>
  لا يدعم الإصدار الحالي من `EXPLAIN ANALYZE` الاستعلامات التي تُنفَّذ في الوضع الموزّع.
</Note>
...
لنفحص الناتج. لنبدأ بالنظر إلى العنوان.
...
* `Time` — إجمالي الوقت، مقسّم إلى مرحلتَي التخطيط (أي إنشاء الخطة + تحسينها + بناء مسار التنفيذ) والتنفيذ (تشغيل مسار التنفيذ).
* `Read` — الصفوف والبايتات غير المضغوطة المقروءة من الجداول، مع معدل النقل — وهي الأرقام نفسها التي يعرضها تذييل الاستعلام العادي على أنها &quot;Processed&quot;.
* `Peak memory` — ذروة الذاكرة التي استخدمها الاستعلام.

الآن، لنلقِ نظرة على الأسطر الجديدة التي تظهر في خطة الاستعلام.
