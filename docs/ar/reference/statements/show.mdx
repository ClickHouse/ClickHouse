...
<Note>
  ...
  * [`display_secrets_in_show_and_select`](/ar/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select) (إعداد الخادم)
  * [`format_display_secrets_in_show_and_select` ](/ar/reference/settings/formats/format#format_display_secrets_in_show_and_select) (إعداد التنسيق)
