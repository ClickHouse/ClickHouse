...
* إعداد [insert&#95;null&#95;as&#95;default](/ar/reference/settings/session-settings/insert#insert_null_as_default).
* إعداد [union&#95;default&#95;mode](/ar/reference/settings/session-settings/other#union_default_mode).