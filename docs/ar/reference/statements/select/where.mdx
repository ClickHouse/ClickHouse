...
غالبًا ما تُستخدم تعبير التي تلي عبارة `WHERE` مع [عوامل المقارنة](/ar/reference/operators/index#comparison-operators) و[العوامل المنطقية](/ar/reference/operators/index#operators-for-working-with-data-sets)، أو مع إحدى [الدوال العادية](/ar/reference/functions/regular-functions/overview) العديدة.
