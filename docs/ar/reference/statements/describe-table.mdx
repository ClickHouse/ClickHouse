...
* `codec_expression` — [codec](/ar/reference/statements/create/table/codec) مُطبَّق على العمود.
* `ttl_expression` — تعبير [TTL](/ar/reference/engines/table-engines/mergetree-family/mergetree#table_engine-mergetree-ttl).
* `is_subcolumn` — علامة تساوي `1` للأعمدة الفرعية الداخلية. ولا يُضمَّن هذا الحقل في النتيجة إلا إذا كان وصف الأعمدة الفرعية مُمكّنًا بواسطة الإعداد [describe&#95;include&#95;subcolumns](/ar/reference/settings/session-settings/describe-include#describe_include_subcolumns).
...
لعرض الأعمدة الفرعية الداخلية لأنواع البيانات الأخرى، استخدم الإعداد [describe&#95;include&#95;subcolumns](/ar/reference/settings/session-settings/describe-include#describe_include_subcolumns).
...
* إعداد [describe&#95;include&#95;subcolumns](/ar/reference/settings/session-settings/describe-include#describe_include_subcolumns).