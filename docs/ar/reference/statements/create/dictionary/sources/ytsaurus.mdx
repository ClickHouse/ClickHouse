...
<Info>
  ...
  باستخدام الإعداد [`allow_experimental_ytsaurus_dictionary_source`](/ar/reference/settings/session-settings/allow-experimental#allow_experimental_ytsaurus_dictionary_source).
</Info>
