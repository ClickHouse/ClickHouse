---
description: 'توثيق clickhouse_backupview {#clickhouse_backupview}'
slug: /operations/utilities/backupview
title: 'clickhouse_backupview'
doc_type: 'reference'
---

وحدة بايثون للمساعدة في تحليل النسخ الاحتياطية التي يُنشئها الأمر [BACKUP](/ar/operations/backup/overview).
وكان الدافع الرئيسي وراءها هو إتاحة الحصول على بعض المعلومات من نسخة احتياطية من دون استعادتها فعليًا.

توفر هذه الوحدة دوالًا تتيح ما يلي:

* سرد الملفات الموجودة في نسخة احتياطية
...
للاطّلاع على المزيد من الأمثلة، راجع [test](https://github.com/ClickHouse/ClickHouse/blob/master/utils/backupview/test/test.py).