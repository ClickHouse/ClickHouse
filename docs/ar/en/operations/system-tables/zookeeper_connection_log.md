---
description: 'يعرض سجل اتصالات ZooKeeper (بما في ذلك مثيلات ZooKeeper الإضافية).'
...
يعرض الجدول &#39;system.zookeeper&#95;connection&#95;log&#39; سجل اتصالات ZooKeeper (بما في ذلك مثيل ZooKeeper إضافي). ويعرض كل صف معلومات عن حدث واحد متعلق بهذه الاتصالات.
...
* `hostname` ([LowCardinality(String)](/ar/sql-reference/data-types/lowcardinality)) — اسم مضيف الخادم المتصل بـ ZooKeeper أو المنقطع عنه.
* `type` ([Enum8(&#39;Connected&#39; = 0, &#39;Disconnected&#39; = 1)](/ar/sql-reference/data-types/enum)) — نوع الحدث. القيم الممكنة: Connected, Disconnected.
...
* `name` ([String](/ar/sql-reference/data-types/string)) — اسم عنقود ZooKeeper.
* `host` ([String](/ar/sql-reference/data-types/string)) — اسم المضيف/عنوان IP لعقدة ZooKeeper التي اتصل بها ClickHouse أو انقطع عنها.
* `port` ([UInt16](/ar/sql-reference/data-types/int-uint)) — منفذ عقدة ZooKeeper التي اتصل بها ClickHouse أو انقطع عنها.
* `index` ([UInt8](/ar/sql-reference/data-types/int-uint)) — فهرس عقدة ZooKeeper التي اتصل بها ClickHouse أو انقطع عنها. الفهرس مأخوذ من إعدادات ZooKeeper.
* `client_id` ([Int64](/ar/sql-reference/data-types/int-uint)) — معرّف جلسة الاتصال.
* `keeper_api_version` ([UInt8](/ar/sql-reference/data-types/int-uint)) — إصدار واجهة برمجة تطبيقات Keeper.
* `enabled_feature_flags` ([Array(Enum16(&#39;FILTERED&#95;LIST&#39; = 0, &#39;MULTI&#95;READ&#39; = 1, &#39;CHECK&#95;NOT&#95;EXISTS&#39; = 2, &#39;CREATE&#95;IF&#95;NOT&#95;EXISTS&#39; = 3, &#39;REMOVE&#95;RECURSIVE&#39; = 4, &#39;MULTI&#95;WATCHES&#39; = 5, &#39;CHECK&#95;STAT&#39; = 6, &#39;PERSISTENT&#95;WATCHES&#39; = 7, &#39;CREATE&#95;WITH&#95;STATS&#39; = 8, &#39;TRY&#95;REMOVE&#39; = 9, &#39;LIST&#95;WITH&#95;STAT&#95;AND&#95;DATA&#39; = 10, &#39;GET&#95;CHILDREN&#95;RECURSIVE&#39; = 11))](/ar/sql-reference/data-types/array)) — علامات الميزات المفعّلة. ينطبق ذلك فقط على ClickHouse Keeper.
* `availability_zone` ([String](/ar/sql-reference/data-types/string)) — منطقة التوافر
* `reason` ([LowCardinality(String)](/ar/sql-reference/data-types/lowcardinality)) — سبب الاتصال أو الانقطاع.
