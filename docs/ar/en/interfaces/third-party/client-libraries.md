---
description: 'نظرة عامة على مكتبات العميل الخارجية المتاحة لمختلف لغات البرمجة'
sidebar_label: 'مكتبات العميل'
sidebar_position: 26
slug: /interfaces/third-party/client-libraries
title: 'مكتبات العميل من مطورين خارجيين'
doc_type: 'reference'
---

:::note
لا تتولى ClickHouse Inc صيانة المكتبات المدرجة أدناه، ولم تُجرِ اختبارات موسعة للتحقق من جودتها.
:::
...
* [عميل SeasClick لـ C++](https://github.com/SeasX/SeasClick)
