...
قد يبدو هذا غريبًا للوهلة الأولى، لكن من المهم ملاحظة أنه رغم عدم إخراج أي شيء، يظل الاستعلام يُعالَج،
وعند استخدام عميل سطر الأوامر، تُنقَل البيانات إلى العميل.

:::tip
يمكن أن يكون تنسيق `Null` مفيدًا لاختبار الأداء.
:::
...
سيعالج الاستعلام البيانات، لكنه لن يعرض أي ناتج.
