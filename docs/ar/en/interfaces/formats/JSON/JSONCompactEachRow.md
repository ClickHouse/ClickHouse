---
alias: []
description: 'توثيق تنسيق JSONCompactEachRow'
input_format: true
...
يختلف عن [`JSONEachRow`](./JSONEachRow.md) فقط في أن صفوف البيانات تُخرَج كمصفوفات، لا ككائنات.
...
اقرأ البيانات باستخدام تنسيق `JSONCompactEachRow`:
