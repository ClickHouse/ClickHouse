...
description: 'وثائق تنسيق PrettyJSONLines'
input_format: false
...
يختلف عن [JSONEachRow](./JSONEachRow.md) فقط في أن JSON يُنسَّق بصورة مُحسَّنة باستخدام فواصل أسطر جديدة ومسافة بادئة من 4 فراغات.
