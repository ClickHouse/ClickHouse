...
في هذا التنسيق، يُخرج ClickHouse كل صفّ على شكل كائن JSON مستقل، بحيث يكون كل كائن في سطر جديد.
...
اقرأ البيانات باستخدام التنسيق `JSONEachRow`:
...
سيتم تخطي استيراد أعمدة البيانات ذات الأسماء غير المعروفة إذا تم تعيين الإعداد [input&#95;format&#95;skip&#95;unknown&#95;fields](/ar/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) إلى 1.
