---
alias: []
description: 'توثيق تنسيق JSONStrings'
input_format: false
...
يختلف عن تنسيق [JSON](./JSON.md) فقط في أن حقول البيانات تُعرَض كسلاسل نصية، لا كقيم JSON ذات أنواع محددة. وهذا تنسيق مخصّص للإخراج فقط.
...
اقرأ البيانات باستخدام التنسيق `JSONStrings`:
