---
alias: []
description: 'وثائق تنسيق JSONStringsEachRow'
input_format: true
...
يختلف عن [`JSONEachRow`](./JSONEachRow.md) فقط في أن حقول البيانات تُخرَج على هيئة سلاسل نصية، وليس كقيم JSON ذات أنواع محددة.
...
اقرأ البيانات باستخدام صيغة `JSONStringsEachRow`:
