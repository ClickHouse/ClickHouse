---
alias: []
description: 'توثيق لتنسيق JSONCompactStringsEachRow'
input_format: true
...
يختلف عن [`JSONCompactEachRow`](./JSONCompactEachRow.md) فقط في أن حقول البيانات تُخرَج كسلاسل نصية، لا كقيم JSON مكتوبة بأنواعها.
