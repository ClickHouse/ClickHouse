...
description: 'توثيق لتنسيق TabSeparatedRawWithNamesAndTypes'
input_format: true
...
يختلف عن التنسيق [`TabSeparatedWithNamesAndTypes`](./TabSeparatedWithNamesAndTypes.md)،
إذ تُكتب الصفوف من دون إفلات للمحارف.

:::note
عند تحليل البيانات بهذا التنسيق، لا يُسمح باستخدام علامات الجدولة أو محارف السطر الجديد داخل أي حقل.
:::
...
اقرأ البيانات باستخدام التنسيق `TabSeparatedRawWithNamesAndTypes`:
...
سيكون الإخراج بتنسيق مفصول بعلامات الجدولة مع صفَّي رؤوس لأسماء الأعمدة وأنواعها:
