---
description: 'وثائق تنسيق TabSeparatedWithNamesAndTypes'
...
يختلف عن تنسيق [`TabSeparated`](./TabSeparated.md) في أن أسماء الأعمدة تُكتب في الصف الأول، بينما تُكتب أنواع الأعمدة في الصف الثاني.
...
* إذا كان الإعداد [`input_format_with_names_use_header`](../../../operations/settings/settings-formats.md/#input_format_with_names_use_header) مضبوطًا على `1`،
  فستُطابَق أعمدة بيانات الإدخال مع أعمدة الجدول بحسب أسمائها، وسيتم تخطي الأعمدة ذات الأسماء غير المعروفة إذا كان الإعداد [`input_format_skip_unknown_fields`](../../../operations/settings/settings-formats.md/#input_format_skip_unknown_fields) مضبوطًا على `1`.
...
اقرأ البيانات بتنسيق `TabSeparatedWithNamesAndTypes`:
...
سيكون الإخراج بتنسيق مفصول بعلامات تبويب مع صفَّي رؤوس لأسماء الأعمدة والأنواع:
