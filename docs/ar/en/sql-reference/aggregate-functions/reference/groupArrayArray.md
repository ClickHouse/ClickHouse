---
description: 'يجمع المصفوفات في مصفوفة أكبر تتكوّن من تلك المصفوفات.'
...
يجمع المصفوفات في مصفوفة أكبر تتكوّن من تلك المصفوفات.
يجمع بين الدالة [`groupArray`](/ar/sql-reference/aggregate-functions/reference/grouparray) والمُركِّب [Array](/ar/sql-reference/aggregate-functions/combinators#-array).

الاسم المستعار: `array_concat_agg`

**مثال**

لدينا بيانات تسجّل جلسات تصفّح المستخدمين. تسجّل كل جلسة تسلسلاً للصفحات التي زارها مستخدم معيّن.
