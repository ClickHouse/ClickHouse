---
description: 'يمثل قاموس الفهرس النصي في جدول MergeTree.
  ويمكن استخدامه لأغراض الفحص الداخلي.'
...
يمثل قاموس الفهرس النصي في جداول MergeTree.
ويُرجع الرموز مع البيانات الوصفية لقوائم الترحيل الخاصة بها.
ويمكن استخدامه لأغراض الفحص الداخلي.
...
| الوسيطة      | الوصف                                            |
| ------------ | ------------------------------------------------ |
| `database`   | اسم قاعدة البيانات التي يُقرأ منها الفهرس النصي. |
| `table`      | اسم الجدول الذي يُقرأ منه الفهرس النصي.          |
| `index_name` | اسم الفهرس النصي المطلوب القراءة منه.            |

<div id="returned_value">
  ## القيمة المُعادة
</div>

جدول يضم الرموز والبيانات الوصفية لقوائم الترحيل الخاصة بها.
