...
تُرجِع أول قيمة غير NULL جرى تقييمها عند الصف رقم n (الإزاحة) ضمن إطارها المرتَّب.
...
لمزيد من التفاصيل حول بناء جملة دوال النافذة، راجع: [دوال النافذة - بناء الجملة](./index.md/#syntax).
...
* أول قيمة غير NULL جرى تقييمها بالنسبة إلى الصف رقم n (`offset`) ضمن إطارها المرتب.
