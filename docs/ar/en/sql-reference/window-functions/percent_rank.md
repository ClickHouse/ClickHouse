---
description: 'توثيق لدالة النافذة percent_rank'
...
تعيد الرتبة النسبية (أي المئين) للصفوف داخل partition النافذة.

**الصياغة**

الاسم المستعار: `percentRank` (حساس لحالة الأحرف)
...
لمزيد من التفاصيل حول بنية دوال النوافذ، راجع: [دوال النوافذ - الصياغة](./index.md/#syntax).
