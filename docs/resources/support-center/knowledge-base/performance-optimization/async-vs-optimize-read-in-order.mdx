...
<Image img="/images/knowledgebase/sync_read.webp" size="md" alt="Synchronous data reading diagram" />
...
<Image img="/images/knowledgebase/async_read.webp" size="md" alt="Asynchronous data reading diagram" />
