...
updates its repaired child counters — could replay differently. Nodes further up the chain are not
...
observe the removed nodes and conflict at any height. The same applies to a session close
