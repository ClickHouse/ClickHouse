...
To estimate how far along a running mutation is (not just how many are queued), see [Estimating mutation progress](/reference/system-tables/mutations#estimating-mutation-progress).
