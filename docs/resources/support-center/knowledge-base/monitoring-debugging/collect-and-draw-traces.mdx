...
<opentelemetry_span_log>
    ...
    <!-- <order_by>event_date, finish_time_us</order_by> -->
...
Make sure that the `<opentelemetry_span_log>` element itself is not commented out, or else you won't be able to see `system.opentelemetry_span_log` in the following steps. The settings inside it are commented out because they are equal to the defaults.
