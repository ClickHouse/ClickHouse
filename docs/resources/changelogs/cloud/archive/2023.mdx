...
- Set the [compatibility](/reference/settings/session-settings/compatibility#compatibility) setting to the version with which the service is initially launched, for newly launched services
