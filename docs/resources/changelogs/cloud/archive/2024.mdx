...
<Image img="/images/cloud/reference/oct-4-latency-insights.webp" size="lg" alt="ClickPipes interface showing latency metrics graph for data ingestion performance" border caption="Scaling Controls for Kafka and Kinesis (Private Beta)" />
