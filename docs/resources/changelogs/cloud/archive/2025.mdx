...
- **ClickHouse Connector for AWS Glue**  
  ...
  started by following along with the announcement [blogpost](https://clickhouse.com/blog/clickhouse-connector-aws-glue) for how to create tables, write and read data between ClickHouse and Spark.
...
- Introduced **AWS PrivateLink for ClickPipes**. You can use AWS PrivateLink to 
  ...
  PrivateLink connectivity set-up is now [fully self-serve](/integrations/clickpipes/networking/aws-privatelink)
  through ClickPipes.
