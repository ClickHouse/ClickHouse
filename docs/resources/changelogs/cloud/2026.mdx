...
- **Bring Your Own Cloud (BYOC) on GCP is now generally available:** ClickHouse BYOC is now GA on Google Cloud, allowing you to deploy ClickHouse services in your own GCP project, and comply with strict data residency requirements. Read the [documentation](/products/bring-your-own-cloud/overview/overview) and the [blog post](https://clickhouse.com/blog/byoc-gcp-ga) for more details. You can [contact us](https://clickhouse.com/cloud/bring-your-own-cloud) to request access.
