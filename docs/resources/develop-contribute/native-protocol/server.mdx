...
The `Data`, `Totals`, `Extremes`, and `ProfileTraces` block bodies can be compressed. The current [native protocol specification](/reference/interfaces/specs/NativeProtocol) defines the revision gates and interleaving rules.
