...
ClickHouse uses version 1.0.2 of [CityHash from Google](https://github.com/google/cityhash).
...
Because we exposed this function to users, ClickHouse keeps its CityHash implementation fixed at version 1.0.2. We guarantee that the behaviour of CityHash functions available in SQL won't change.
...
Google's maintained CityHash implementation [differs](https://github.com/ClickHouse/ClickHouse/issues/8354) from the ClickHouse `cityHash64` variant.
