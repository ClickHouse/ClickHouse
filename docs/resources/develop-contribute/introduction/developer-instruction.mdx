...
- `arg2` — Description of the argument. [DataType](/reference/data-types/float.md)
...
- Returns {insert what the function returns here}. [DataType](/reference/data-types/float.md)
