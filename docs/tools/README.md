...
release.sh also pulls static files needed for [official ClickHouse website](https://clickhouse.tech) from ../../website folder, packs them alongside docs into Docker container and tries to deploy it (possible only from Yandex private network).
