...
<Steps>
<Step title="Clone the Repository" id="clone-the-repository">
...
<Step title="Configure installation options" id="configure-installation-options">
...
<Step title="Build and Deploy" id="build-and-deploy">
