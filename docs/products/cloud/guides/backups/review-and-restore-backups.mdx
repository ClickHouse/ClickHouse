...
By default, services are backed up once every 24 hours, and each backup is retained for 24 hours. Backup schedules vary by service and plan, and can be configured on Scale and Enterprise services. Choosing a schedule that requires retaining more data, or causes more frequent backups can cause additional storage charges for backups.
...
In our testing, a backup of roughly 1 TB has taken about 10 to 15 minutes, and 20 TB about an hour. Larger datasets take proportionally longer, and backups of several hundred TB or more can take many hours, although theer are economies of scale that help at larger sizes.
