...
Cloud roles determine whether a user can open a console feature. Database roles determine which data the user can access. See [Manage database permissions](/products/cloud/guides/security/cloud-access-management/common-access-management-queries) for database-level access guidance.
