...
<Image img="/images/cloud/security/jwt/jwt-manage-providers.png" size="lg" alt="JWT providers flyout with a new provider form" force/>
</Step>
...
| **Roles claim** (optional) | The token claim to read ClickHouse roles from. Leave blank to use the default claim name `clickhouse:roles`. |
