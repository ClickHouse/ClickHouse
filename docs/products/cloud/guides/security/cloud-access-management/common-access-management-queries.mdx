---
sidebarTitle: 'Database permissions'
title: 'Manage database permissions'
slug: /cloud/security/common-access-management-queries
description: 'Define SQL users and roles, customize database permissions for SQL console users, and apply privileges to databases, tables, rows, and columns.'
keywords: ['ClickHouse Cloud', 'access management', 'database permissions', 'SQL console roles']
doc_type: 'guide'
---
...
This article shows how to define SQL users and roles, customize database permissions for SQL console users, and apply privileges to databases, tables, rows, and columns.
...
## Customize SQL console database permissions {#passwordless-authentication}

<Note>
Access to SQL console and access to the underlying ClickHouse data are separate permissions. Cloud roles determine whether a user can open SQL console. Database roles determine which databases, tables, columns, or rows the user can access.

To configure which users can open SQL console:

- For organizations that have migrated to custom roles, see [Manage custom roles](/products/cloud/guides/security/cloud-access-management/manage-custom-roles).
- For organizations that have not migrated to custom roles, see [Configure legacy SQL console role assignments](/products/cloud/guides/security/cloud-access-management/manage-sql-console-role-assignments).

To review the permissions included in predefined Cloud roles, see [Console roles and permissions](/products/cloud/reference/security/console-roles).
</Note>
