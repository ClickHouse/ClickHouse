...
To configure which users can open SQL console, see [Manage custom roles](/products/cloud/guides/security/cloud-access-management/manage-custom-roles). To review the permissions included in predefined Cloud roles, see [Console roles and permissions](/products/cloud/reference/security/console-roles).
</Note>
