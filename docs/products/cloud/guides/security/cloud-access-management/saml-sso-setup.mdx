...
We support service provider-initiated SSO, multiple organizations using separate connections, and just-in-time provisioning. We also support SCIM provisioning in private preview with [Okta](/products/cloud/guides/security/cloud-access-management/scim-setup) and [Microsoft Entra ID](/products/cloud/guides/security/cloud-access-management/scim-setup-entra). We don't yet support attribute mapping.
...
- SCIM provisioning — automate user and group provisioning with [Okta](/products/cloud/guides/security/cloud-access-management/scim-setup) or [Microsoft Entra ID](/products/cloud/guides/security/cloud-access-management/scim-setup-entra) (private preview).
