...
You can also manage database roles directly from the ClickHouse Cloud console by adding data permissions to custom roles. This feature is in beta and is available for services running ClickHouse version 26.4 and above. For more information, see [Manage database roles](/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles).
</Note>
