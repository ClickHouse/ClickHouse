...
| Kubernetes API server (Kubernetes installs) | Outbound, inside your environment | HTTPS | ServiceAccounts bound to namespace-scoped Roles | Read-only workload views for the troubleshooter; both daemons persist the automatically renewed client certificate back to the mTLS Secret |
