...
- **Admin access to a Kubernetes API server during provisioning**, on both install targets: access bundles are anchored to Kubernetes ServiceAccounts. See [onboarding](/products/cloud/guides/infrastructure/deployment-options/byoc/connector/onboarding).
