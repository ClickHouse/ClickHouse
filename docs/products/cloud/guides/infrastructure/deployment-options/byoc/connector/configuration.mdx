...
<Note>
Day-2 commands on this page and in [operations](/products/cloud/guides/infrastructure/deployment-options/byoc/connector/operations) use the `helm` CLI. Only `init` carries a built-in Helm client.
</Note>
