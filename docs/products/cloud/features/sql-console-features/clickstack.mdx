...
Managed ClickStack access is controlled at three levels.

| Access level | What it controls | Guide |
|---|---|---|
| ClickHouse Cloud | Whether the user can access the service and open Managed ClickStack | [Manage SQL console role assignments](/products/cloud/guides/security/cloud-access-management/manage-sql-console-role-assignments) |
| Managed ClickStack | Access to dashboards, sources, searches, and alerts | [ClickStack RBAC](/clickstack/managing/rbac) |
| ClickHouse database | Access to the underlying data | [Customize SQL console database permissions](/products/cloud/guides/security/cloud-access-management/common-access-management-queries#passwordless-authentication) |
