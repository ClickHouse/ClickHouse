...
|---|---|---|
| ClickHouse Cloud | Whether the user can access the service and open Managed ClickStack | [Manage custom roles](/products/cloud/guides/security/cloud-access-management/manage-custom-roles) |
