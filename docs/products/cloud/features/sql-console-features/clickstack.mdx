...
|---|---|---|
| ClickHouse Cloud | Whether the user can access the service and open Managed ClickStack | [Managed ClickStack access prerequisites](/clickstack/managing/rbac#user-access-prerequisites) |
| Managed ClickStack | Access to dashboards, sources, searches, and alerts | [Assign ClickStack roles](/clickstack/managing/rbac#assigning-roles) |
| ClickHouse database | Access to the underlying data | [Manage database permissions](/products/cloud/guides/security/cloud-access-management/common-access-management-queries#passwordless-authentication) |
