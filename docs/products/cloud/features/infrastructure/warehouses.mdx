...
<Image img="/images/cloud/reference/compute-compute-1.webp" size="md" alt="Single Service in ClickHouse Cloud" caption="Fig. 1 - Single service in ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-2.webp" size="md" alt="Compute separation in ClickHouse Cloud" caption="Fig. 2 - Compute separation in ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-8.webp" size="lg" alt="Warehouse example with primary and secondary services" background='white' caption="Fig. 3 - Warehouse example" />
...
<Image img="/images/cloud/reference/compute-compute-3.webp" size="md" alt="User access across services sharing same data" caption="Fig. 4 - User Alice was created in Service 1, but she can use the same credentials to access all services that share same data" />
...
<Image img="/images/cloud/reference/compute-compute-4.webp" size="md" alt="Network access control settings" caption="Fig. 5 - Alice is restricted from accessing service 2 because of network access control settings"/>
...
<Image img="/images/cloud/reference/compute-compute-5.webp" size="lg" alt="Read-write and Read-only services in a warehouse" caption="Fig. 6 - Read-write and Read-only services in a warehouse"/>
...
<Image img="/images/cloud/reference/compute-compute-7.webp" size="md" alt="Creating a new service in a warehouse" caption="Fig. 7 - Click the plus sign to create a new service in a warehouse"/>
