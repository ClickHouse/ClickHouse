...
| Unity Catalog | Iceberg and Delta (external storage locations only) | OAuth client credentials               | Cloud (Iceberg only) & [Core](/guides/use-cases/data-warehousing/unity-catalog) | 25.10+ |
