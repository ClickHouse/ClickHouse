...
<Image img="/images/cloud/manage/scaling-patch-request.webp" size="lg" alt="Scaling PATCH request" border caption="`PATCH` request to update `numReplicas`"/>

<Image img="/images/cloud/manage/scaling-patch-response.webp" size="md" alt="Scaling PATCH response" border caption="Response from `PATCH` request"/>
...
<Image img="/images/cloud/manage/scaling-configure.webp" size="md" alt="Scaling configuration settings" border caption="Service scaling settings from the ClickHouse Cloud console"/>
