...
<Note>
  Scaling support varies by service tier and profile. Horizontal autoscaling is in private preview. On-Demand Compute is also in private preview and supports eligible select queries only.
</Note>
