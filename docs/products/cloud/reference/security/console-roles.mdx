...
<Note>
Console feature access and database permissions are separate. To customize database permissions, see:

- [Customize SQL console database permissions](/products/cloud/guides/security/cloud-access-management/common-access-management-queries#passwordless-authentication)
