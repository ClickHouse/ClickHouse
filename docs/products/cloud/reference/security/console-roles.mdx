...
For migrated organizations, use [custom Cloud roles](/products/cloud/guides/security/cloud-access-management/manage-custom-roles) to grant console and database permissions. For organizations that have not migrated, see [Configure legacy SQL console role assignments](/products/cloud/guides/security/cloud-access-management/manage-sql-console-role-assignments).

<Note>
Console access and database access are separate permission scopes, although a custom Cloud role can grant both. For more information, see:

- [Manage custom Cloud database roles](/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles)
- [Customize SQL console database permissions directly in SQL](/products/cloud/guides/security/cloud-access-management/common-access-management-queries#passwordless-authentication)
- [Managed ClickStack access and permissions](/products/cloud/features/sql-console-features/clickstack#access-and-permissions)
</Note>
