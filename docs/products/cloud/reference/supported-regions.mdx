...
The following tables list supported regions by cloud provider. A checkmark indicates that an option is available, while a dash indicates that it isn't currently available. Regions marked as Private but not Public are available only as Private Regions.

### AWS regions {#aws-regions}

| Region | Location | Public | Private | HIPAA | PCI |
| --- | --- | :---: | :---: | :---: | :---: |
