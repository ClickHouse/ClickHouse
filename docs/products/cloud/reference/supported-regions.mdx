...
| `ap-south-1` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
...
| `ca-central-1` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
| `eu-central-1` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
| `eu-north-1` | <Badge color="purple">Private</Badge> <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
| `eu-west-1` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
| `eu-west-2` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
...
| `us-east-1` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
| `us-east-2` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
| `us-west-2` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
...
| `europe-west4` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
| `europe-west6` | <Badge color="purple">Private</Badge> |
| `northamerica-northeast1` | <Badge color="purple">Private</Badge> |
| `us-central1` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
| `us-east1` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
