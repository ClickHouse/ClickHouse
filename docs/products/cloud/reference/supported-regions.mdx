...
| `ap-northeast-1` | <Badge color="gray">Public</Badge> |
| `ap-northeast-2` | <Badge color="gray">Public</Badge> |
| `ap-south-1` | <Badge color="orange">HIPAA</Badge> <Badge color="blue">PCI</Badge> |
| `ap-southeast-1` | <Badge color="gray">Public</Badge> |
| `ap-southeast-2` | <Badge color="gray">Public</Badge> |
...
| `il-central-1` | <Badge color="gray">Public</Badge> |
| `me-central-1` | <Badge color="gray">Public</Badge> |
...
| Region | Availability |
| --- | --- |
| `asia-northeast1` | <Badge color="gray">Public</Badge> |
| `asia-southeast1` | <Badge color="gray">Public</Badge> |
| `australia-southeast1` | <Badge color="purple">Private</Badge> |
| `europe-west2` | <Badge color="gray">Public</Badge> |
...
| `East US 2` | <Badge color="gray">Public</Badge> |
| `Germany West Central` | <Badge color="gray">Public</Badge> |
| `Japan East` | <Badge color="purple">Private</Badge> |
| `UAE North` | <Badge color="purple">Private</Badge> |
| `West US 3` | <Badge color="gray">Public</Badge> |
