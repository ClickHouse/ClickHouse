...
<Image img="/images/cloud/manage/billing/marketplace/aws-marketplace-payg-13.webp" size="md" alt="Link the default organization to the AWS Marketplace subscription" border/>
