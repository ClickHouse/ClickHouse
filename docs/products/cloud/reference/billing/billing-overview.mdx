...
When a user converts from trial to paid before the 30 day trial period ends but still has remaining trial credits, we continue to draw down from those trial credits until they expire. Trial credits do expire at the end of the trial time period, even after a payment method has been added. Once the credits expire, charges will be applied to the credit card on file. You can confirm your trial credit expiration date on the Billing page in the ClickHouse Cloud console.
