...
Some ClickHouse Cloud usage statements follow a different billing cycle. Usage is metered and reported over 30 days starting on a day other than the first of the month.
