...
You can [sign up for ClickHouse Cloud](https://clickhouse.cloud/signUp?loc=docs.products.cloud.getting-started.intro) and start with $300 in credits during a 30-day free trial.
