...
In the cloud account: yes, as long as your resources do not touch ClickHouse-provisioned ones (on AWS these all carry the tag `clickhouse-byoc=true`), though a dedicated account remains the recommendation.
