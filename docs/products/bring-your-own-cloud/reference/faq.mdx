...
Two separate bills: ClickHouse Cloud charges based on the memory allocated to your services, and your cloud provider bills you directly for the underlying infrastructure at cost, with no markup. See the [cost model](/products/bring-your-own-cloud/reference/cost-model) for AWS and GCP. For quota planning, see the [AWS service limits](/products/bring-your-own-cloud/reference/aws-service-limits) and [GCP service limits](/products/bring-your-own-cloud/reference/gcp-service-limits); the [billable AWS services](/products/bring-your-own-cloud/reference/billable-aws-services) page lists the AWS resources BYOC provisions.
</Accordion>
