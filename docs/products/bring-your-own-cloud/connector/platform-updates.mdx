...
<Note>
Kubernetes platform approval requires support in both the CLI and the executor chart that is not yet in the public release. Before using these workflows, confirm [managed-mode availability](/products/bring-your-own-cloud/connector/onboarding#managed-mode-availability) with your account team.
</Note>
