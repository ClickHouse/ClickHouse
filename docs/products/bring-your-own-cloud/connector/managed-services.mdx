...
<Note>
The customer-create workflow below requires support in the CLI, your connector endpoint, and ClickHouse Cloud that is not yet in the public release. Confirm [managed-mode availability](/products/bring-your-own-cloud/connector/onboarding#managed-mode-availability) with your account team before preparing resources.
</Note>
