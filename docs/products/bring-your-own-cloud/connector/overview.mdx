...
- **Admin access to a Kubernetes API server during provisioning**, on both install targets: access bundles are anchored to Kubernetes ServiceAccounts. See [onboarding](/products/bring-your-own-cloud/connector/onboarding).

See [onboarding](/products/bring-your-own-cloud/connector/onboarding) for the full walkthrough of both install targets.
...
- [FAQ](/products/bring-your-own-cloud/connector/reference/faq): common questions, including data egress and revocation.
