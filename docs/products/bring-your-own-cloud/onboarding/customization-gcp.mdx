...
<Note>
Before provisioning, run [pre-flight validation](/products/bring-your-own-cloud/onboarding/standard#validate-cloud-setup) from the console to confirm your customized VPC and account meet the requirements — it surfaces subnet, permission, and quota issues up front so you can fix them before setup begins.
</Note>
