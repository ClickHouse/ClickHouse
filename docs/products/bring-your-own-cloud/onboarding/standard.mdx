...
To resolve the failures, re-run the latest ClickHouse CloudFormation or Terraform stack — or grant the reported actions to the ClickHouse management role — then choose one of:
