...
<Steps>
<Step title="Request PSC service setup" id="step-1-request-psc-setup">
...
<Step title="Obtain GCP PSC service name and DNS name" id="step-2-obtain-gcp-service-attachment-and-dns-name-for-private-service-connect">
...
<Step title="Create a PSC endpoint in your network" id="step-3-create-endpoint">
...
<Step title="Set private DNS name for endpoint" id="step-4-set-private-dns-name-for-endpoint">
...
<Step title="Add endpoint's PSC Connection ID to service allowlist" id="step-5-add-endpoint-id-allowlist">
...
<Step title="Connect to ClickHouse via PSC" id="step-6-connect-via-psc-endpoint">
