...
<Step title="Phase 1: Create FIPS Certificates" id="phase-1-create-fips-certificates">
...
<Step title="Phase 2: Install Kubernetes Prerequisites" id="phase-2-install-kubernetes-prerequisites">
...
<Step title="Phase 3: Install Operator" id="phase-3-install-operator">
...
<Step title="Phase 4: Create Certificate Secrets" id="phase-4-create-certificate-secrets">
...
<Step title="Phase 5: Deploy ClickHouse Cluster" id="phase-5-deploy-clickhouse-cluster">
...
<Step title="Phase 6: Verify Installation" id="phase-6-verify-installation">
