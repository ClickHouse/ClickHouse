...
<Step title="1. At least 2 Server replicas" id="1-at-least-2-server-replicas">
...
<Step title="2. All databases use the Replicated engine" id="2-all-databases-use-the-replicated-engine">
...
<Step title="3. All tables use non-replicated table engines" id="3-all-tables-use-non-replicated-table-engines">
...
<Step title="4. No detached tables exist" id="4-no-detached-tables-exist">
...
<Step title="2. Add the migration markers" id="2-add-the-migration-markers">
...
<Step title="4. Remove the migration markers" id="4-remove-the-migration-markers">
...
<Step title="1. Remove the migration markers" id="1-remove-the-migration-markers">

Set `featureFlags.migrateToSharedCatalog` to `false` in your Helm values.

</Step>

<Step title="2. Remove the Shared Catalog settings" id="2-remove-the-shared-catalog-settings">

Set `featureFlags.enableSharedCatalog` to `false` in your Helm values. This will trigger the Operator to revert the changes.

</Step>

<Step title="3. Remove the Catalog in Keeper" id="3-remove-the-catalog-in-keeper">
...
<Step title="4. Verify rollback" id="4-verify-rollback">
