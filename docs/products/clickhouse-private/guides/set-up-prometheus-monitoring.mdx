...
<Step title="1. Install kube-prometheus-stack" id="1-install-kube-prometheus-stack">
...
<Step title="2. Enable PodMonitors in the ClickHouse Operator" id="2-enable-podmonitors-in-the-clickhouse-operator">
...
<Step title="3. Enable the Custom Metrics Handler (Optional)" id="3-enable-the-custom-metrics-handler-optional">
...
<Step title="4. Verify Prometheus Targets" id="4-verify-prometheus-targets">
...
<Step title="5. Import the ClickHouse Grafana Mixin Dashboards" id="5-import-the-clickhouse-grafana-mixin-dashboards">
...
<Step title="6. Configure Alert Rules (Optional)" id="6-configure-alert-rules-optional">
