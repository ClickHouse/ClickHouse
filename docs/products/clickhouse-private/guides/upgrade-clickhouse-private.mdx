...
<Step title="1. Upgrade the Operator Helm Chart" id="1-upgrade-the-operator-helm-chart">
...
<Step title="2. Validate the Upgraded Operator" id="2-validate-the-upgraded-operator">
...
<Step title="3. Upgrade the onprem-clickhouse-cluster Helm Chart" id="3-upgrade-the-onprem-clickhouse-cluster-helm-chart">
...
<Step title="4. Validate the Upgraded Cluster" id="4-validate-the-upgraded-cluster">
