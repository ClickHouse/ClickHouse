...
Private Link enables private connectivity between your ClickHouse Managed Postgres instance and your Virtual Private Cloud (VPC) without exposing traffic to the public internet. This provides an additional layer of network isolation and security.
...
To enable Private Link for your ClickHouse Managed Postgres instance:
