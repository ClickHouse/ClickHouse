...
2. **Provide the following information**:
   - Your ClickHouse organization ID
   - ID/hostname of postgres service
   - GCP project IDs which you'd like to connect the Private Service Connect endpoint from
...
4. **Setup your GCP Private Service Connect**:
   - Create the Private Service Connect endpoint in your VPC, in the same region as the Postgres service and from one of the GCP projects you provided, using the service attachment ID provided by the ClickHouse support.
