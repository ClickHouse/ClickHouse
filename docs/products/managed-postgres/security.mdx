...
Private Service Connect enables private connectivity between your ClickHouse Managed Postgres instance and your GCP Virtual Private Cloud (VPC) without exposing traffic to the public internet.

To enable Private Service Connect for your ClickHouse Managed Postgres instance, contact ClickHouse support by creating a support ticket.
