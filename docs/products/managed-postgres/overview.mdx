...
<Note>
ClickHouse Managed Postgres on GCP is in Private Preview. You can sign up for the GCP Private Preview waitlist [here](https://clickhouse.com/cloud/postgres#gcp-waitlist). Read the [announcement](TODO KG GCP Blog HERE) to learn more.
</Note>
