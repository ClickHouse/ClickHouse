...
<Image img="/images/managed-postgres/pg_dump_restore/automated.png" alt="Step 2: Automated schema migration with destination database selector" size="lg" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/newdb.png" alt="Create a new Postgres database dialog" size="lg" border />
...
<Image img="/images/managed-postgres/pg_dump_restore/manual.png" alt="Step 2: Manual schema migration with pg_dump export command" size="lg" border />
