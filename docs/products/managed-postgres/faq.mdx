...
ClickHouse Managed Postgres is available on AWS in public beta. GCP is in Private Preview. You can sign up for the GCP Private Preview waitlist [here](TODO KG GCP Waitlist HERE) and read the [announcement](TODO KG GCP Blog HERE) to learn more. See [Supported cloud providers](/products/managed-postgres/overview#supported-cloud-providers) for details.
