...
The tables below map each Snowflake concept to its ClickHouse equivalent. For function-by-function SQL syntax mapping, see the [SQL translation reference](/migrations/snowflake-translation-reference). For the end-to-end migration walkthrough, see [Migrating from Snowflake to ClickHouse](./migration-guide).
...
<Note title="Warehouse terminology">
...
<Note title="Per-user SQL console access">
...
- For the end-to-end migration walkthrough, see [Migrating from Snowflake to ClickHouse](./migration-guide).
