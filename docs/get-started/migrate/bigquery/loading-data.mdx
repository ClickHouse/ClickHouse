...
This guide shows how to migrate data from [BigQuery](https://cloud.google.com/bigquery) to ClickHouse. A change.
...
If you're having issues transferring data from BigQuery to ClickHouse, please feel free to contact us at [support@clickhouse.com](mailto:support@clickhouse.com).