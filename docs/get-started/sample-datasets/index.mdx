...
The [ClickHouse playground](/get-started/sample-datasets/playground) is also available for
trying ClickHouse without installing anything.

<Tip>
**Try these datasets without installing ClickHouse**

Load any of them into a [ClickHouse Cloud](/products/cloud/getting-started/intro) trial and follow the tutorials as written.

[Get started free](https://clickhouse.cloud/signUp?loc=docs.get-started.sample-datasets)
</Tip>
