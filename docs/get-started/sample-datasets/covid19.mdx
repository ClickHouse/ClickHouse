...
<Note>
The following commands were executed on a **Production** instance of [ClickHouse Cloud](/products/cloud/getting-started/intro). You can easily run them on a local install as well.
</Note>
