...
<Tip>
**Try this dataset without installing ClickHouse**

Load it into a [ClickHouse Cloud](/products/cloud/getting-started/intro) trial and run the queries on this page as written.

[Get started free](https://clickhouse.cloud/signUp?loc=docs.get-started.sample-datasets.anon-web-analytics-metrica)
</Tip>
