...
- A [ClickHouse Cloud account](https://clickhouse.cloud/signUp?loc=docs-sample-datasets-uk-price-paid).

## Run this guide in ClickHouse Cloud {#run-this-guide-in-clickhouse-cloud}

Open the SQL console and run the statements in this guide. ClickHouse streams the source data directly into your service.
