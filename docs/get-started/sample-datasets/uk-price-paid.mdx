...
[Create a free ClickHouse Cloud service](https://clickhouse.cloud/signUp?loc=docs-sample-datasets-uk-price-paid), open the SQL console, and run the statements in this guide. ClickHouse streams the source data directly into your service.
