...
<Image img="/images/getting-started/example-datasets/superset-cell-tower-dashboard.webp" size="md" alt="Dashboard of cell towers by radio type in mcc 204"/>
...
### Load the sample data {#load-the-sample-data-in-clickhouse-cloud}

Run this guide in ClickHouse Cloud without downloading the dataset. [Create a free service](https://clickhouse.cloud/signUp?loc=docs-sample-datasets-cell-towers), then open your service and select **Load data**.

ClickHouse Cloud provides a guided way to load this dataset from S3.
<ActionsMenu menu="Load Data" />

Choose the **Cell Towers** dataset from the **Sample data** tab, and **Load data**:

<Image img="/images/_snippets/cloud-load-data-sample.webp" size='md' alt='Load cell towers dataset' />
...
### Load the sample data {#load-the-sample-data-on-an-open-source-deployment}
...
<ConnectionDetails />
  ...
  <Image img="/images/getting-started/example-datasets/superset-add.webp" size="md" alt="Add a database"/>
  
  Choose **ClickHouse Connect** from the list:

  <Image img="/images/getting-started/example-datasets/superset-choose-a-database.webp" size="md" alt="Choose clickhouse connect as database type"/>
...
<Tip>
  ...
  <Image img="/images/getting-started/example-datasets/superset-connect-a-database.webp" size="md" alt="Add ClickHouse as a Superset data source"/>
...
<Image img="/images/getting-started/example-datasets/superset-add-dataset.webp" size="md" alt="Add cell_towers table as a dataset"/>
...
<Image img="/images/getting-started/example-datasets/superset-create-map.webp" size="md" alt="Create a map in Superset"/>
...
<Image img="/images/getting-started/example-datasets/superset-lon-lat.webp" size="md" alt="Specify longitude and latitude fields"/>

Add a filter with `mcc` = `204` (or substitute any other `mcc` value):

<Image img="/images/getting-started/example-datasets/superset-mcc-204.webp" size="md" alt="Filter on MCC 204"/>
...
<Image img="/images/getting-started/example-datasets/superset-radio-umts.webp" size="md" alt="Filter on radio equal to UMTS"/>

This is the full configuration for the chart that filters on `radio = 'UMTS'` and `mcc = 204`:

<Image img="/images/getting-started/example-datasets/superset-umts-netherlands.webp" size="md" alt="Chart for UMTS radios in MCC 204"/>
