...
<Steps titleSize="h2">
    ...
    <Step title="Run basic queries">
        ...
        PRIMARY KEY MCC
        SOURCE(HTTP(
        url 'https://raw.githubusercontent.com/Blargian/examples/2a95fbc746bf9ba35ff6f331217756882d860b2d/datasets/mcc-countries.csv'
        format 'CSVWithNames'
        ))
        LAYOUT(HASHED())
        ...
        724	Brazil	1836150
        404	India	1729151
        234	United Kingdom	1618924
        510	Indonesia	1353998
        440	Japan	1343355
        311	Guam	1332798
        ```
    </Step>
    ...
    <Step title="Visualize the data with ClickHouse Agents">
        Next we'd like to visualize this data.
        ...
        You'll be able to observe what the agent is doing as it works through the request in steps:
