...
<View title="ClickHouse Cloud">

## Run this guide in ClickHouse Cloud {#run-this-guide-in-clickhouse-cloud}

[Create a free ClickHouse Cloud service](https://clickhouse.cloud/signUp?loc=docs-sample-datasets-nyc-taxi), open the SQL console, and run the statements in this guide. The sample data streams directly from object storage into your service.

</View>

<View title="Open-source">

## Run this guide on an open-source deployment {#run-this-guide-on-an-open-source-deployment}

Run the statements in this guide with `clickhouse-client` or another SQL client connected to your ClickHouse server.
