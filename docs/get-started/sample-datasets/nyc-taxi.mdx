...
- A [ClickHouse Cloud account](https://clickhouse.cloud/signUp?loc=docs-sample-datasets-nyc-taxi).

## Run this guide in ClickHouse Cloud {#run-this-guide-in-clickhouse-cloud}

Open the SQL console and run the statements in this guide. The sample data streams directly from object storage into your service.
