---
slug: /fr/clickstack/deployment/managed
title: 'Managed'
...
### Démarrer un collecteur {#start-a-collector-existing}
...
### Configurer des collecteurs existants {#configure-existing-collectors-existing}
...
### Démarrer l’ingestion (facultatif) {#start-ingestion-existing}
...
### Créer une base de données et une table {#create-database-and-tables}
...
<div id="additional-tasks">
  ## Tâches supplémentaires {#additional-tasks}
</div>
...
<div id="clickstack-read-only-compute">
  ### Utiliser ClickStack avec des ressources de calcul en lecture seule {#clickstack-read-only-compute}
</div>
...
<div id="how-clickstack-selects-compute">
  #### Comment ClickStack sélectionne la ressource de calcul {#how-clickstack-selects-compute}
</div>
...
<div id="adding-data-sources">
  ### Ajouter d’autres sources de données {#adding-data-sources}
</div>
...
<div id="using-custom-schemas">
  #### Utiliser des schémas personnalisés {#using-custom-schemas}
</div>
