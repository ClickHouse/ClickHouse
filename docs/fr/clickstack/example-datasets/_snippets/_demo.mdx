...
<Image img="/images/use-cases/observability/hyperdx-demo/architecture.webp" alt="Architecture" size="lg" caption="Crédit : https://opentelemetry.io/docs/demo/architecture/" />
