...
export const INFRA = [
  ...
  { title: 'Journaux de l’hôte',     img: '/images/logo-hostlogs.svg',            href: '/clickstack/integration-examples/host-logs' },
...
export const DATABASES = [
  { title: 'Journaux PostgreSQL',    img: '/images/logo-postgres.svg',  href: '/clickstack/integration-examples/postgres-logs' },
  ...
  { title: 'Journaux Redis',         img: '/images/icons/redis-logo.svg',          href: '/clickstack/integration-examples/redis-logs' },
  ...
  { title: 'Journaux Kafka',         img: '/images/kafka-logo.svg',  darkImg: '/images/kafka-logo-dark.svg',  href: '/clickstack/integration-examples/kafka-logs' },
  ...
  { title: 'Journaux Nginx',         img: '/images/logo-nginx.svg',     href: '/clickstack/integration-examples/nginx-logs' },
