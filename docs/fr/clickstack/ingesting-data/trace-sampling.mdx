...
<Image img="/images/clickstack/trace-sampling-source-settings.webp" alt="Champ Expression du taux d’échantillonnage dans les paramètres de la source ClickStack" size="lg" />
