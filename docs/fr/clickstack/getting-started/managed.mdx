...
<Steps>
  <Step title="Inscrivez-vous à ClickHouse Cloud" id="signup-to-clickhouse-cloud">
  ...
  <Step title="Configurer l’ingestion" id="setup-ingestion">
  ...
  <Step title="Accéder à la ClickStack UI" id="navigate-to-clickstack-ui-cloud">
    <NavigateClickStackUI />
  </Step>

  <Step title="Étapes suivantes" id="next-steps">
    <Warning>
