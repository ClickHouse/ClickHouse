---
slug: /fr/clickstack/architecture
...
### ClickHouse Cloud : le moteur {#clickhouse-cloud}
...
### Collecteur OpenTelemetry : ingestion des données {#open-telemetry-collector-managed}
...
### ClickStack UI (HyperDX) : l’interface {#hyperdx}
...
### ClickHouse : le moteur de base de données {#clickhouse}
...
### Collecteur OpenTelemetry : ingestion des données {#open-telemetry-collector}
...
### ClickStack UI (HyperDX) : l’interface {#hyperdx-ui}
...
### MongoDB : état de l’application {#mongo}
