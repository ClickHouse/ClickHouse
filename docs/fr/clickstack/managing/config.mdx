...
| `Section`                                | Libellé facultatif permettant de regrouper les sources dans le sélecteur de sources. Les sources appartenant à une même section apparaissent ensemble, et la recherche tient compte du nom de la section en plus de celui de la source.                                                                                                                                                                                                                                                                                                                                                                             | Non         | Non                              | –                                                  |
...
| `Activé`                                 | Une source désactivée est conservée, mais masquée dans les sélecteurs de sources et n’est jamais sélectionnée automatiquement.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Non         | No                               | Activé                                             |
...
| `Colonne d’horodatage affichée`          | Colonne d’horodatage facultative, de précision supérieure, utilisée pour l’affichage dans l’UI. Si elle n’est pas renseignée, la colonne Timestamp est utilisée par défaut.                                                                                                                                                                                                                                                                                                                                                                                                                                         | Non         | Oui                              | `Timestamp`                                        |
| `Source de métriques corrélée`           | Source de métriques associée (par ex. les métriques HyperDX).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Non         | No                               | –                                                  |
...
| `Highlighted Trace Attributes`           | Expressions ou colonnes extraites de chaque journal d&#39;une trace, affichées au-dessus de la vue en cascade de la trace. Les expressions qui renvoient des URL s&#39;affichent sous forme de liens.                                                                                                                                                                                                                                                                                                                                                                                                               | No          | No                               | –                                                  |
