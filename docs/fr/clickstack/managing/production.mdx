...
### Sécuriser l’ingestion {#secure-ingestion-managed}
...
#### Créer un utilisateur d’ingestion {#create-a-database-ingestion-user-managed}
...
### Configurer le Time To Live (TTL) {#configure-ttl-managed}
...
### Estimation des ressources {#estimating-resources}
...
#### Isoler les charges de travail d’observabilité {#isolating-workloads}
...
#### Isoler les charges de travail de lecture et d’écriture {#isolating-read-write}
...
### Sécurité réseau et des ports {#network-security}
...
### Configuration du secret de session {#session-secret}
...
### Sécuriser l’ingestion {#secure-ingestion}
...
#### Créer un utilisateur d’ingestion {#create-a-database-ingestion-user-oss}
...
#### Bonnes pratiques de sécurité {#self-managed-security}
...
#### Permissions utilisateur pour le ClickStack UI {#user-permissions}
...
### Configurer le Time To Live (TTL) {#configure-ttl}
...
### Directives MongoDB {#mongodb-guidelines}
