---
slug: /fr/guides/oss/deployment-and-scaling/examples/2-shards-1-replica
...
#### Réseau et journalisation {#networking}
...
#### Configuration de Keeper {#keeper-config-explanation}
...
#### Configuration des macros {#macros-config-explanation}
...
### Configuration utilisateur {#user-config}
...
### Configuration de ClickHouse Keeper {#configuration-explanation}
