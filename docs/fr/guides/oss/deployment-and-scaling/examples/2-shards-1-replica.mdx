...
> évolutif. Cinq serveurs sont configurés. Deux servent à partitionner les données.
...
<Steps>
  ...
  <Step>
    ...
    Depuis `clickhouse-02`, exécutez maintenant la même requête select que précédemment sur la table Distributed :
