---
slug: /fr/guides/oss/deployment-and-scaling/examples/2-shards-2-replicas
...
#### Configuration du cluster {#cluster-config}
...
### Configuration utilisateur {#cluster-configuration}
...
### Configuration de Keeper {#configuration-explanation}
