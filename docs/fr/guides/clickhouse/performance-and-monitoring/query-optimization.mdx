...
Commencez par identifier vos requêtes lentes à partir des journaux de requêtes, puis examinez les améliorations possibles de manière isolée. Lors du test de la requête, veillez à désactiver le cache du système de fichiers. 
