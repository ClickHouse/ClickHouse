...
slug: /fr/guides/clickhouse/data-modelling/sparse-primary-indexes
...
<div id="a-full-table-scan">
  ### Un parcours complet de la table {#a-full-table-scan}
</div>
...
<div id="clickhouse-index-design">
  ## Conception des index dans ClickHouse {#clickhouse-index-design}
</div>

<div id="an-index-design-for-massive-data-scales">
  ### Une conception d’index pour des volumes de données massifs {#an-index-design-for-massive-data-scales}
</div>
...
<div id="a-table-with-a-primary-key">
  ### Une table avec une clé primaire {#a-table-with-a-primary-key}
</div>
...
### Les données sont stockées sur disque dans l&#39;ordre des colonnes de la clé primaire {#data-is-stored-on-disk-ordered-by-primary-key-columns}
...
### Les données sont organisées en granules pour leur traitement en parallèle {#data-is-organized-into-granules-for-parallel-data-processing}
...
### L’index primaire comporte une entrée par granule {#the-primary-index-has-one-entry-per-granule}
...
### L&#39;index primaire sert à sélectionner les granules {#the-primary-index-is-used-for-selecting-granules}
...
### Les fichiers de marks servent à localiser les granules {#mark-files-are-used-for-locating-granules}
...
<div id="using-multiple-primary-indexes">
  ## Utiliser plusieurs index primaires {#using-multiple-primary-indexes}
</div>

<a name="filtering-on-key-columns-after-the-first" />

### Les colonnes de clé secondaires peuvent être inefficaces… ou non {#secondary-key-columns-can-not-be-inefficient}
...
### Algorithme de recherche par exclusion générique {#generic-exclusion-search-algorithm}
...
### Remarque sur l’index de saut de données {#note-about-data-skipping-index}
...
<div id="a-need-to-use-multiple-primary-indexes">
  ### Nécessité d’utiliser plusieurs index primaires {#a-need-to-use-multiple-primary-indexes}
</div>
...
### Options pour créer des index primaires supplémentaires {#options-for-creating-additional-primary-indexes}
...
### Option 1 : Tables secondaires {#option-1-secondary-tables}
...
### Option 2 : Vues matérialisées {#option-2-materialized-views}
...
<div id="ordering-key-columns-efficiently">
  ## Ordonner efficacement les colonnes de clé {#ordering-key-columns-efficiently}
</div>
...
<div id="efficient-filtering-on-secondary-key-columns">
  ### Filtrage efficace sur les colonnes secondaires de la clé {#efficient-filtering-on-secondary-key-columns}
</div>
...
### Taux de compression optimal des fichiers de données {#optimal-compression-ratio-of-data-files}
...
<div id="identifying-single-rows-efficiently">
  ## Identifier efficacement des lignes individuelles {#identifying-single-rows-efficiently}
</div>
