...
Pour les écritures, Iceberg nécessite [allow&#95;insert&#95;into&#95;iceberg](/fr/reference/settings/session-settings/allow#allow_insert_into_iceberg) (25.7+, Beta à partir de 26.2). Consultez [Écriture dans les lacs de données](/fr/guides/use-cases/data-warehousing/getting-started/writing-data). Delta Lake nécessite [allow&#95;delta&#95;lake&#95;writes](/fr/reference/settings/session-settings/allow-experimental#allow_experimental_delta_lake_writes) (25.9+). La [matrice de compatibilité](/fr/guides/use-cases/data-warehousing/support-matrix) indique quels flags s’appliquent à chaque format et à chaque opération.
