...
<Image img="/images/knowledgebase/sync_read.webp" size="md" alt="Schéma de lecture synchrone des données" />
...
<Image img="/images/knowledgebase/async_read.webp" size="md" alt="Schéma de lecture asynchrone des données" />
