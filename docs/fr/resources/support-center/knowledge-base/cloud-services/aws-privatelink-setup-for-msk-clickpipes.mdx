...
Ce guide vous aidera à démarrer la configuration d’un **MSK multi-VPC** à utiliser avec le [point de terminaison privé inverse de ClickPipes](/fr/integrations/clickpipes/networking/aws-privatelink#msk-multi-vpc).
...
Suivez les étapes de création d’un point de terminaison privé inverse dans la [documentation ClickPipes](/fr/integrations/clickpipes/networking/aws-privatelink#creating-clickpipe).