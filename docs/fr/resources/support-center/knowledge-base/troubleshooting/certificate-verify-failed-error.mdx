...
Vous pouvez aussi faire pointer directement votre client vers le bundle certifi. [ClickHouse Connect](/fr/integrations/language-clients/python) ne bascule pas automatiquement sur certifi, donc transmettez le bundle via le paramètre `ca_cert` :
