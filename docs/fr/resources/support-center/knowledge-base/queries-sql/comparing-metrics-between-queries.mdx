---
date: 2023-01-14
title: Comparaison des métriques entre deux requêtes en décibels
description: Une requête permettant de comparer les métriques de deux requêtes dans ClickHouse.
tags: ['Performances et optimisations']
keywords: [comparaison de requêtes, comparaison de métriques, performances des requêtes]
---
...
<div id="compare-metrics-between-two-queries">
  ## Comparer des métriques entre deux requêtes
</div>

Pour comparer des métriques entre deux requêtes, vous devez d&#39;abord obtenir le `query_id` de chacune des deux requêtes.
...
Vous recevrez un tableau de métriques comparant les deux requêtes :
