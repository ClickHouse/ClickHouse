...
<Steps>
  <Step title="Créer des embeddings">
    ...
    Vous pouvez considérer un embedding comme un grand tableau de nombres à virgule flottante qui représente vos données. [Consultez ce guide d’OpenAI pour en savoir plus sur les embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings).
  </Step>
