...
| display&#95;name  | String  | `<display_name-or-hostname>` | Nom du serveur pour l&#39;UI  |
...
[codes]: https://github.com/ClickHouse/ClickHouse/blob/master/src/Common/ErrorCodes.cpp "Liste des codes d’erreur"
