...
- `arg1` — Description of the argument. [DataType](/fr/reference/data-types/float)
- `arg2` — Description of the argument. [DataType](/fr/reference/data-types/float)
- `arg3` — Description of optional argument (optional). [DataType](/fr/reference/data-types/float)
...
- Returns {insert what the function returns here}. [DataType](/fr/reference/data-types/float)
