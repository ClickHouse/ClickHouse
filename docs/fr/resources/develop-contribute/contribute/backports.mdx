...
<div id="cherry-pick-stage">
  #### 3. Étape de cherry-pick (`ReleaseBranch.create_cherrypick`)
</div>
...
<div id="auto-merge-conflict-free-cherry-pick-prs">
  #### 4. Fusion automatique des PR de cherry-pick sans conflit
</div>
...
<div id="backport-stage">
  #### 5. Étape de backport (`ReleaseBranch.create_backport`)
</div>
