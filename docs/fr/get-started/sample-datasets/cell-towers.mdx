...
Un Scatterplot deck.gl nécessite une longitude et une latitude, et il est également possible d’appliquer un ou plusieurs filtres à la requête. Dans cet exemple, deux filtres sont appliqués : l’un pour les antennes-relais utilisant la technologie UMTS, et l’autre pour le code pays mobile attribué aux Pays-Bas.
