...
<Visibility for="humans">
  <View title="UI Cloud">
    ...
    * Le [tutoriel](/fr/get-started/sample-datasets/nyc-taxi) vous guide dans l’insertion de 2 millions de lignes dans une table et la rédaction de requêtes analytiques
