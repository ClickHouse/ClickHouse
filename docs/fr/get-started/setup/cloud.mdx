...
<Steps>
  ...
  <Step title="Ajouter des données" id="3-add-data">
    ...
    * dans ClickHouse, les clés primaires ne sont ***pas uniques*** pour chaque ligne d’une table
    ...
    Une tâche courante lorsque l&#39;on commence à utiliser une base de données consiste à insérer des données que vous avez déjà dans des fichiers. Nous proposons des données d&#39;exemple en ligne que vous pouvez insérer, représentant des données de clickstream : elles comprennent un identifiant utilisateur, une URL visitée et l&#39;horodatage de l&#39;événement.
