    ...
    <Steps>
      ...
      <Step title="Se connecter à ClickHouse" id="2-connect-to-clickhouse">
        ...
        * Vous connecter avec votre application
        ...
        ### Utiliser la console SQL {#connect-using-sql-console}
        ...
        ### Connectez votre application {#connect-with-your-app}
      ...
      <Step title="Ajouter des données" id="3-add-data">
        ...
        * Téléversez des données à partir de l’URL d’un fichier
        ...
        ### Ajouter des données avec la console SQL {#add-data-using-the-sql-console}
        ...
        * `metric` : un nombre à virgule flottante de 32 bits ([Float32](/fr/reference/data-types/float))
        ...
        #### Brève introduction aux clés primaires {#a-brief-intro-to-primary-keys}
        ...
        * les clés primaires dans ClickHouse ne sont ***pas uniques*** pour chaque ligne d’une table
        ...
        #### Insérer des données dans votre table {#insert-data-into-your-table}
        ...
        ### Ajouter des données à l&#39;aide du ClickHouse Client {#add-data-using-the-clickhouse-client}
