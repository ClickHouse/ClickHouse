...
<Steps>
  <Step title="Installer ClickHouse à l’aide de curl" id="install-clickhouse-using-curl">
    ...
    Sous Linux et macOS, cela installe également [`clickhousectl`](/fr/install/clickhousectl),
    ...
    en arrière-plan et à gérer ClickHouse Cloud. Consultez la [page d’installation de clickhousectl](/fr/install/clickhousectl)
