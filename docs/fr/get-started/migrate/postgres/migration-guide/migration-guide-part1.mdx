...
<Image img="/images/migrations/postgres-stackoverflow-schema.webp" size="lg" alt="Schéma PostgreSQL de Stack Overflow" caption="Les commandes DDL permettant de créer les tables dans PostgreSQL sont disponibles [ici](https://pastila.nl/?001c0102/eef2d1e4c82aab78c4670346acb74d83#TeGvJWX9WTA1V/5dVVZQjg==)." />
