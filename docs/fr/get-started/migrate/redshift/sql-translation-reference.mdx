...
<sub><span>*</span> ClickHouse prend également en charge les entiers non signés avec des plages de valeurs étendues, c.-à-d. <a href="/fr/sql-reference/data-types/int-uint">`UInt8`, `UInt32`, `UInt32` et `UInt64`</a>.</sub><br />
<sub><span>**</span>Le type String de ClickHouse n’est pas limité par défaut, mais il peut être restreint à des longueurs spécifiques à l’aide de <a href="/fr/sql-reference/statements/create/table#constraints">contraintes</a>.</sub>
