...
slug: /fr/get-started/migrate/bigquery/overview
...
<div id="bigquery-projects-vs-clickhouse-cloud-services">
  ### Projets BigQuery vs services ClickHouse Cloud {#bigquery-projects-vs-clickhouse-cloud-services}
</div>
...
<div id="bigquery-datasets-vs-clickhouse-cloud-databases">
  ### Jeux de données BigQuery vs bases de données ClickHouse Cloud {#bigquery-datasets-vs-clickhouse-cloud-databases}
</div>
...
<div id="bigquery-folders">
  ### Dossiers BigQuery {#bigquery-folders}
</div>
...
<div id="bigquery-slot-reservations-and-quotas">
  ### Réservations de slots BigQuery et quotas {#bigquery-slot-reservations-and-quotas}
</div>
...
<div id="query-acceleration-techniques">
  ## Techniques d’accélération des requêtes {#query-acceleration-techniques}
</div>

<div id="primary-and-foreign-keys-and-primary-index">
  ### Clés primaires, clés étrangères et index primaire {#primary-and-foreign-keys-and-primary-index}
</div>
...
<div id="secondary-indexes-only-available-in-clickhouse">
  ## Index secondaires (disponibles uniquement dans ClickHouse) {#secondary-indexes-only-available-in-clickhouse}
</div>
...
<div id="search-indexes">
  ## Index de recherche {#search-indexes}
</div>
...
<div id="vector-indexes">
  ## Index vectoriels {#vector-indexes}
</div>
...
<div id="querying-materialized-views">
  ## Interroger les vues matérialisées {#querying-materialized-views}
</div>
...
<div id="data-sources-and-file-formats">
  ## Sources de données et formats de fichiers {#data-sources-and-file-formats}
</div>
...
<div id="sql-language-features">
  ## Fonctionnalités du langage SQL {#sql-language-features}
</div>
