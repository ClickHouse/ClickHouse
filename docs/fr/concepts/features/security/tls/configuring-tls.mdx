---
slug: /fr/concepts/features/security/tls/configuring-tls
...
<div id="configure-openssl-for-standalone-clickhouse-keeper">
  ## Configurer OpenSSL pour un ClickHouse Keeper autonome {#configure-openssl-for-standalone-clickhouse-keeper}
</div>
...
<div id="openssl-verification-modes">
  ## Modes de vérification d’OpenSSL et gestionnaires de certificats {#openssl-verification-modes}
</div>
...
<div id="verification-modes">
  ### Modes de vérification {#verification-modes}
</div>
...
<div id="invalid-certificate-handlers">
  ### Gestionnaires de certificats invalides {#invalid-certificate-handlers}
</div>
...
<div id="disabling-certificate-verification">
  ### Exemple : désactiver la vérification des certificats {#disabling-certificate-verification}
</div>
