...
slug: /fr/concepts/features/security/external-authenticators/http
title: 'HTTP'
doc_type: 'reference'
---
...
<div id="http-auth-server-definition">
  ## Définition du serveur d’authentification HTTP {#http-auth-server-definition}
</div>
...
<div id="enabling-http-auth-using-sql">
  ### Activer l&#39;authentification HTTP avec SQL {#enabling-http-auth-using-sql}
</div>
...
<div id="passing-session-settings">
  ### Transmission des paramètres de session {#passing-session-settings}
</div>
