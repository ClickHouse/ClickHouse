...
sidebarTitle: 'JWT'
slug: /fr/concepts/features/security/external-authenticators/jwt
...
<div id="token-claims">
  ## Claim du jeton {#token-claims}
</div>

<div id="required-claims">
  ### Claims obligatoires {#required-claims}
</div>
...
<div id="other-recognized-claims">
  ### Autres claims reconnues {#other-recognized-claims}
</div>
...
<div id="optional-claims">
  ### Claims facultatifs {#optional-claims}
</div>
...
<div id="example-token-header-and-payload">
  ### Exemple de jeton, d’en-tête et de charge utile {#example-token-header-and-payload}
</div>
...
<div id="ephemeral-user-behavior">
  ## Comportement des utilisateurs éphémères {#ephemeral-user-behavior}
</div>
...
<div id="identity-and-naming">
  ### Identité et nommage {#identity-and-naming}
</div>
...
<div id="token-freshness">
  ### Fraîcheur du jeton {#token-freshness}
</div>
...
<div id="lifetime-and-garbage-collection">
  ### Durée de vie et garbage collection {#lifetime-and-garbage-collection}
</div>
...
<div id="persistent-access-assignments">
  ### Attributions d’accès persistantes {#persistent-access-assignments}
</div>
...
<div id="differences-from-regular-users">
  ## Différences avec les utilisateurs classiques {#differences-from-regular-users}
</div>
...
<div id="sql-security-definer-views">
  ## Vues avec SQL SECURITY DEFINER {#sql-security-definer-views}
</div>
...
<div id="client-usage">
  ## Utilisation du client {#client-usage}
</div>

<div id="passing-token-directly">
  ### Passer directement un jeton {#passing-token-directly}
</div>
...
<div id="oauth2-device-code-login">
  ### Connexion OAuth2 par code d’appareil {#oauth2-device-code-login}
</div>
...
<div id="clickhouse-cloud-built-in">
  ## Authentificateur JWT intégré à ClickHouse Cloud {#clickhouse-cloud-built-in}
</div>
...
<div id="interserver-communication">
  ## Communication interserveur {#interserver-communication}
</div>
