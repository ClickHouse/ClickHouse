...
slug: /fr/concepts/features/configuration/server-config/configuration-files
...
<div id="merging">
  ## Fusion des fichiers de configuration {#merging}
</div>
...
<div id="from_env_zk">
  ### Substitution à l’aide de variables d’environnement et de nœuds ZooKeeper {#from_env_zk}
</div>
...
<div id="substitution-with-file-content">
  ## Substitution avec le contenu d’un fichier {#substitution-with-file-content}
</div>
...
<div id="encryption">
  ## Chiffrement et masquage de la configuration {#encryption}
</div>
