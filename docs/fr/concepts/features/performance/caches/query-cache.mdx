...
slug: /fr/concepts/features/performance/caches/query-cache
...
<div id="background-design-and-limitations">
  ## Contexte, conception et limites {#background-design-and-limitations}
</div>
...
<div id="subquery-caching">
  ## Mise en cache des sous-requêtes {#subquery-caching}
</div>
