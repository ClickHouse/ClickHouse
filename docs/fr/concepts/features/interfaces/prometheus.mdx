...
La section `<prometheus.handlers>` peut être utilisée pour créer des gestionnaires plus étendus.
Cette section est similaire à [<http_handlers>](/concepts/features/interfaces/http), mais fonctionne pour les protocoles Prometheus :
