...
## Exposer les métriques du serveur ClickHouse {#expose}
...
## API HTTP Prometheus et PromQL {#prometheus-http-api-and-promql}
...
### Configurer l’API Prometheus {#configure-prometheus-api}
