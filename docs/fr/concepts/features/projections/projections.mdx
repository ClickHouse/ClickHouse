---
slug: /fr/concepts/features/projections/projections
title: 'Projections'
...
<div id="how-do-projections-work">
  ## Comment fonctionnent les projections ? {#how-do-projections-work}
</div>
...
<div id="smarter_storage_with_part_offset">
  ### Un stockage plus intelligent avec `_part_offset` {#smarter_storage_with_part_offset}
</div>
...
<div id="when-to-use-projections">
  ## Quand utiliser les projections ? {#when-to-use-projections}
</div>
...
<div id="filtering-without-using-primary-keys">
  ### Filtrage sur des colonnes qui ne font pas partie de la clé primaire {#filtering-without-using-primary-keys}
</div>
...
<div id="further-examples">
  ### Autres exemples {#further-examples}
</div>
...
<div id="average-price-projections">
  #### Requête 1. Prix moyen par année {#average-price-projections}
</div>
...
<div id="average-price-london-projections">
  #### Requête 2. Prix moyen par année à Londres {#average-price-london-projections}
</div>
...
<div id="most-expensive-neighborhoods-projections">
  #### Requête 3. Les quartiers les plus chers {#most-expensive-neighborhoods-projections}
</div>
...
<div id="combining-projections">
  ### Combiner plusieurs projections dans une même requête {#combining-projections}
</div>
