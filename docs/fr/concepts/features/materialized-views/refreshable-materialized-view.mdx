---
slug: /fr/concepts/features/materialized-views/refreshable-materialized-view
...
<div id="when-should-refreshable-materialized-views-be-used">
  ## Quand utiliser les vues matérialisées actualisables ? {#when-should-refreshable-materialized-views-be-used}
</div>
...
<div id="when-was-a-refreshable-materialized-view-last-refreshed">
  ## À quand remonte le dernier rafraîchissement d’une vue matérialisée actualisable ? {#when-was-a-refreshable-materialized-view-last-refreshed}
</div>
...
<div id="how-can-i-change-the-refresh-rate">
  ## Comment puis-je modifier la fréquence d’actualisation ? {#how-can-i-change-the-refresh-rate}
</div>
...
<div id="using-append-to-add-new-rows">
  ## Utiliser `APPEND` pour ajouter de nouvelles lignes {#using-append-to-add-new-rows}
</div>
