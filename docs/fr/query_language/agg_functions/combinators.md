...
-   [AggregatingMergeTree](../../operations/table_engines/aggregatingmergetree.md) tableau moteur.
-   [finalizeAggregation](../functions/other_functions.md#function-finalizeaggregation) fonction.
-   [runningAccumulate](../functions/other_functions.md#function-runningaccumulate) fonction.
