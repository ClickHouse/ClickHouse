...
-   [Le ‘MySQL’ tableau moteur](../../operations/table_engines/mysql.md)
-   [Utilisation de MySQL comme source de dictionnaire externe](../dicts/external_dicts_dict_sources.md#dicts-external_dicts_dict_sources-mysql)
