...
Sorties le contenu de la [système.processus](../operations/system_tables.md#system_tables-processes) table, qui contient une liste de requêtes en cours de traitement en ce moment, à l'exception `SHOW PROCESSLIST` requête.
...
Affiche une liste de [dictionnaires externes](dicts/external_dicts.md).
