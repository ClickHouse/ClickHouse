...
-   `arrays` – Arbitrary number of arguments of [Tableau](../../data_types/array.md) type.
    **Exemple**
...
Synonyme de [“arrayReverse”](#array_functions-arrayreverse)
...
-   `array_of_arrays` — [Tableau](../../data_types/array.md) de tableaux. Exemple, `[[1,2,3], [4,5]]`.
...
`arr` — The [tableau](../../data_types/array.md) inspecter.
...
`arr` — Any number of [tableau](../../data_types/array.md) tapez les colonnes à combiner.
