...
-   `separator` — The separator which should contain exactly one character. [Chaîne](../../data_types/string.md).
-   `s` — The string to split. [Chaîne](../../data_types/string.md).
...
Type: [Tableau](../../data_types/array.md) de [Chaîne](../../data_types/string.md).
...
-   `separator` — The separator. [Chaîne](../../data_types/string.md).
-   `s` — The string to split. [Chaîne](../../data_types/string.md).
