...
-   `[(a, b), (c, d) ...]` — Polygon vertices. Data type — [Tableau](../../data_types/array.md). Chaque sommet est représenté par une paire de coordonnées `(a, b)`. Les sommets doivent être spécifiés dans le sens horaire ou antihoraire. Le nombre minimum de sommets est 3. Le polygone doit être constante.
...
-   Numéro de cellule de base hexagonale. Type: [UInt8](../../data_types/int_uint.md).
...
-   Retourner `1` si les index sont voisins, `0` autrement. Type: [UInt8](../../data_types/int_uint.md).
...
-   Tableau avec les index H3 enfants. Tableau de type: [UInt64](../../data_types/int_uint.md).
...
-   Représentation en chaîne de l'index H3. Type: [Chaîne](../../data_types/string.md).
...
-   `index_str` — String representation of the H3 index. Type: [Chaîne](../../data_types/string.md).

**Valeurs renvoyées**

-   Numéro d'indice hexagonal. Renvoie 0 en cas d'erreur. Type: [UInt64](../../data_types/int_uint.md).
...
-   L'indice de la résolution. Gamme: `[0, 15]`. Type: [UInt8](../../data_types/int_uint.md).
