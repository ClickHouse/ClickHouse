...
Vérifie si l'argument est [NULL](../syntax.md#null).
...
Résultats dans une valeur de type [Nullable](../../data_types/nullable.md) pour un non- `Nullable` si la valeur n'est pas `NULL`.
