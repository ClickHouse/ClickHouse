...
| STRING&#95;WITH&#95;SIZE&#95;STREAM&#95;SERIALIZATION        | 54492   | Block (Column)                      | Les colonnes `String` passent d’une disposition avec préfixe de longueur par valeur à un flux distinct de décalages cumulés en octets (la même disposition de décalages qu’utilise un `Array`), envoyé tel quel : `[UInt64 × num_rows offsets][data blob]`. Dépend de la révision négociée ; en dessous de 54492, l’émetteur utilise les préfixes de longueur par valeur. Le format binaire ne contient aucun marqueur par colonne pour cela — les deux pairs le déduisent uniquement de la révision. Voir [String column layout](/fr/reference/interfaces/specs/NativeFormat#string-type).                                                                                                                                                                                                                        |
...
<div id="log-streaming">
  #### Transmission des logs en continu
</div>
