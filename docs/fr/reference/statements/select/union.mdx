...
* paramètre [insert&#95;null&#95;as&#95;default](/fr/reference/settings/session-settings/insert#insert_null_as_default).
* paramètre [union&#95;default&#95;mode](/fr/reference/settings/session-settings/other#union_default_mode).