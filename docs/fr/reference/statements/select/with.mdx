...
**Exemple 6 :** Réutilisation d’une expression scalaire commune définie par une fonction lambda dans une sous-requête

Définissez l’expression scalaire commune sous forme de fonction lambda afin que son argument soit explicitement lié :
