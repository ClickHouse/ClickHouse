...
<Warning>
  **Obsolète**
  ...
  Les window views sont obsolètes et pourront être supprimées dans une prochaine release. Leur utilisation reste conditionnée par le paramètre [allow&#95;experimental&#95;window&#95;view](/fr/reference/settings/session-settings/allow-experimental#allow_experimental_window_view) (`SET allow_experimental_window_view = 1`) et elles ne sont pas recommandées pour les nouveaux usages.
</Warning>
