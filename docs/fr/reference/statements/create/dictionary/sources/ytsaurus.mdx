...
<Info>
  ...
  à l’aide du paramètre [`allow_experimental_ytsaurus_dictionary_source`](/fr/reference/settings/session-settings/allow-experimental#allow_experimental_ytsaurus_dictionary_source).
</Info>
