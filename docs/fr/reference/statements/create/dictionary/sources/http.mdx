...
Pour que ClickHouse puisse accéder à une ressource HTTPS, vous devez [configurer openSSL](/fr/reference/settings/server-settings/settings/other#openssl) dans la configuration du serveur.
