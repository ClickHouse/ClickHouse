...
| [hierarchical](/fr/reference/statements/create/dictionary/layouts/hierarchical)                                                  | Prise en charge des hiérarchies avec une clé numérique décrivant les relations parent-enfant.                                                                                       |
| [polygon](/fr/reference/statements/create/dictionary/layouts/polygon)                                                            | Recherches point-dans-polygone efficaces (géocodage inversé).                                                                                                                       |
| [regexp&#95;tree](/fr/reference/statements/create/dictionary/layouts/regexp-tree)                                                | Fait correspondre les clés à un arbre d’expressions régulières.                                                                                                                     |
