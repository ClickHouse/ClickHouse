...
<Note>
  ...
  * [`display_secrets_in_show_and_select`](/fr/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select) (paramètre serveur)
  * [`format_display_secrets_in_show_and_select` ](/fr/reference/settings/formats/format#format_display_secrets_in_show_and_select) (paramètre de format)
