...
Vous pouvez spécifier combien de temps (en secondes) attendre l&#39;exécution des requêtes `TRUNCATE` par des répliques inactives avec le paramètre [replication&#95;wait&#95;for&#95;inactive&#95;replica&#95;timeout](/fr/reference/settings/session-settings/other#replication_wait_for_inactive_replica_timeout).
