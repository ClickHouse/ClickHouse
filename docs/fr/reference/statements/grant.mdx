...
* `ALTER CONSTRAINT` inclut les privilèges `ALTER ADD CONSTRAINT`, `ALTER DROP CONSTRAINT` et `ALTER MODIFY CONSTRAINT`.
...
* `ALTER`. Niveau : `COLUMN`.
  ...
  * `ALTER MODIFY CONSTRAINT`. Niveau : `TABLE`. Alias : `MODIFY CONSTRAINT`
...
* `SYSTEM`. Niveau : `GROUP`
  ...
  * `SYSTEM RELOAD`. Niveau : `GROUP`
    ...
    * `SYSTEM RELOAD DICTIONARY`. Niveau : `GLOBAL`. Alias : `SYSTEM RELOAD DICTIONARIES`, `RELOAD DICTIONARY`, `RELOAD DICTIONARIES`, `SYSTEM UNLOAD DICTIONARY`, `SYSTEM UNLOAD DICTIONARIES`, `UNLOAD DICTIONARY`, `UNLOAD DICTIONARIES`
  ...
  * `SYSTEM BACKGROUND`. Niveau : `GROUP`
    * `SYSTEM STREAMING ENGINES`. Niveau : `TABLE`
    * `SYSTEM VIEWS`. Niveau : `VIEW`. Alias : `SYSTEM REFRESH VIEW`, `SYSTEM START VIEWS`, `SYSTEM STOP VIEWS`, `SYSTEM START VIEW`, `SYSTEM STOP VIEW`, `SYSTEM PAUSE VIEWS`, `SYSTEM PAUSE VIEW`, `SYSTEM CANCEL VIEW`, `REFRESH VIEW`, `START VIEWS`, `STOP VIEWS`, `START VIEW`, `STOP VIEW`, `PAUSE VIEWS`, `PAUSE VIEW`, `CANCEL VIEW`
...
[`paramètre du serveur display_secrets_in_show_and_select`](/fr/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select)
et
[`paramètre de format format_display_secrets_in_show_and_select`](/fr/reference/settings/formats/format#format_display_secrets_in_show_and_select).
