...
| [hasPhrase](/fr/reference/functions/regular-functions/string-search-functions#hasPhrase)                   | oui                                                                 | `splitByNonAlpha`, `splitByString`, `ngrams`, `asciiCJK`, `icu` | oui                               |
...
Notez que la fonction nécessite l’un des tokenizers `splitByNonAlpha`, `splitByString`, `ngrams`, `asciiCJK` ou `icu`.
...
`hasPhrase` peut être utilisé avec les tokenizers `splitByNonAlpha`, `splitByString`, `ngrams`, `asciiCJK` et `icu`.
