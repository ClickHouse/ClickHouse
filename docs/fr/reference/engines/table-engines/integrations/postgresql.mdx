...
* `table` — Nom de la table distante, ou une requête transmise telle quelle à PostgreSQL (voir [Transmettre une requête au lieu d’un nom de table](#passing-a-query)).
