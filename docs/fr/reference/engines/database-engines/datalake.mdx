...
| Setting                 | Description                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `catalog_type`          | Type de catalogue : `glue`, `unity` (Delta), `rest` (Iceberg), `hive`, `onelake` (Iceberg), `delta_sharing` (Iceberg, espaces de noms plats)                                                                                                                                                                                                                                                                                                             |
...
Pour vous authentifier sans partager de secret client, définissez `onelake_bearer_token` sur un Bearer token obtenu au préalable (limité à `https://storage.azure.com`) au lieu de `onelake_client_id`/`onelake_client_secret`. ClickHouse ne renouvelle pas le jeton ; la database doit donc être recréée après son expiration.