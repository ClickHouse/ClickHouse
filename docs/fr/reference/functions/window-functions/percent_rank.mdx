---
description: 'Documentation de la fonction de fenêtre percent_rank'
...
renvoie le rang relatif (c.-à-d. le percentile) des lignes au sein d’une partition de fenêtre.

**Syntaxe**

Alias : `percentRank` (sensible à la casse)
...
La définition du cadre de fenêtre, utilisée par défaut et requise, est `RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING`.
