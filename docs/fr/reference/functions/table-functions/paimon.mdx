...
Fournit une interface de type table en lecture seule pour les tables Apache [Paimon](https://paimon.apache.org/) stockées dans Amazon S3, Azure, HDFS ou en local.
