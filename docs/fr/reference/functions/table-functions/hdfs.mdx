...
Crée une table à partir de fichiers stockés dans HDFS. Cette fonction de table est similaire aux fonctions de table [url](/fr/reference/functions/table-functions/url) et [file](/fr/reference/functions/table-functions/file).
