...
Prend en charge la conversion depuis `String`, `FixedString`, `Date`, `Date32`, `Time`, `DateTime`, `DateTime64` ou des types numériques (`(U)Int8`, `(U)Int16`, `(U)Int32`, `(U)Int64`, `BFloat16`, `Float32`, `Float64`). Les valeurs `Decimal` et `Time64` ne sont pas prises en charge et lèvent une exception ; le type `Time` et les types d’entiers de grande taille tels que `(U)Int128`/`(U)Int256` effectuent un bouclage au lieu de saturer.
...
Les conversions depuis d’autres types de date et d’heure, tels que `Date32` ou `DateTime64`, suivent le paramètre `date_time_overflow_behavior` : le mode `ignore` par défaut peut produire des valeurs ayant subi un bouclage, `saturate` les ramène aux bornes de la plage et `throw` lève une exception.
...
* `x` — Valeur d’entrée à convertir. [`String`](/fr/reference/data-types/string), [`FixedString`](/fr/reference/data-types/fixedstring), [`(U)Int*`](/fr/reference/data-types/int-uint), [`Float*`](/fr/reference/data-types/float), [`BFloat16`](/fr/reference/data-types/float), [`Date`](/fr/reference/data-types/date), [`Date32`](/fr/reference/data-types/date32), [`Time`](/fr/reference/data-types/time), [`DateTime`](/fr/reference/data-types/datetime) ou [`DateTime64`](/fr/reference/data-types/datetime64)
...
* `x` — Valeur d’entrée à convertir. [`String`](/fr/reference/data-types/string) ou [`FixedString`](/fr/reference/data-types/fixedstring) ou [`DateTime`](/fr/reference/data-types/datetime) ou [`DateTime64`](/fr/reference/data-types/datetime64) ou [`(U)Int*`](/fr/reference/data-types/int-uint) ou [`BFloat16`](/fr/reference/data-types/float) ou [`Float*`](/fr/reference/data-types/float)
