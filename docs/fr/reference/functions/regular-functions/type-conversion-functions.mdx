...
:::note
Si la valeur d&#39;entrée ne peut pas être représentée dans les limites de [Int16](/fr/reference/data-types/int-uint), un dépassement de capacité du résultat se produit dans le résultat.
Cela n&#39;est pas considéré comme une erreur.
...
:::note
Si la valeur en entrée ne peut pas être représentée dans les limites de [Int32](/fr/reference/data-types/int-uint), le résultat peut déborder.
Cela n&#39;est pas considéré comme une erreur.
:::
...
:::note
Si la valeur d&#39;entrée ne peut pas être représentée dans les limites de [`UInt128`](/fr/reference/data-types/int-uint), un dépassement de capacité inférieur ou supérieur du résultat se produit.
Cela n&#39;est pas considéré comme une erreur.
:::
...
:::note
Si la valeur d&#39;entrée ne peut pas être représentée dans les limites de [`UInt16`](/fr/reference/data-types/int-uint), un dépassement de capacité (dépassement de capacité inférieur ou supérieur) se produit dans le résultat.
Cela n&#39;est pas considéré comme une erreur.
:::
...
:::note
Si la valeur d’entrée ne peut pas être représentée dans les bornes de UInt256, le résultat présente un dépassement de capacité par excès ou par défaut.
Cela n’est pas considéré comme une erreur.
:::
...
:::note
Si la valeur d&#39;entrée ne peut pas être représentée dans la plage de [`UInt32`](/fr/reference/data-types/int-uint), le résultat présente un dépassement de capacité par excès ou par défaut.
Cela n&#39;est pas considéré comme une erreur.
