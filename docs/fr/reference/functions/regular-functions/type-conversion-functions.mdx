...
Prend en charge la conversion depuis `String`, `FixedString`, `Date`, `Date32`, `Time`, `DateTime`, `DateTime64` ou des types numériques (`(U)Int8`, `(U)Int16`, `(U)Int32`, `(U)Int64`, `(U)Int128`, `(U)Int256`, `BFloat16`, `Float32`, `Float64`). Les valeurs `Decimal` et `Time64` ne sont pas prises en charge et lèvent une exception ; une valeur du type `Time` effectue un bouclage au lieu de saturer.
