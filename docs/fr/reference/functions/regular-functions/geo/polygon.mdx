...
(`Point`, `LineString`, `MultiLineString`, `Ring`, `Polygon`, `MultiPolygon`), y compris le type commun
...
(`Point`, `LineString`, `MultiLineString`, `Ring`, `Polygon`, `MultiPolygon`), y compris le type
[`Geometry`](/fr/reference/data-types/geo#geometry), et les deux arguments peuvent être de types différents.
