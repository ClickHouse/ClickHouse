...
* `dict_name` — Nom du dictionnaire. [`String`](/fr/reference/data-types/string)
* `attr_name` — Nom de la colonne du dictionnaire. [`String`](/fr/reference/data-types/string) ou [`Tuple(String)`](/fr/reference/data-types/tuple)
* `id_expr` — Valeur de clé. Expression renvoyant une valeur de type clé du dictionnaire ou une valeur de tuple (selon la configuration du dictionnaire). [`Expression`](/fr/reference/data-types/special-data-types/expression) ou [`Tuple(T)`](/fr/reference/data-types/tuple)
