...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------- |
| [`output_format_orc_string_as_string`](/fr/reference/settings/formats#output_format_orc_string_as_string)                                                                                  | Utiliser le type String d’ORC au lieu de Binary pour les colonnes String.                                                | `true`      |
| [`output_format_orc_compression_method`](/fr/reference/settings/formats#output_format_orc_compression_method)                                                                             | Méthode de compression utilisée pour le format ORC de sortie. Valeur par défaut                                          | `zstd`     |
| [`input_format_orc_case_insensitive_column_matching`](/fr/reference/settings/formats#input_format_orc_case_insensitive_column_matching)                                                    | Ignorer la casse lors de la correspondance entre les colonnes ORC et ClickHouse.                                         | `false`     |
| [`input_format_orc_allow_missing_columns`](/fr/reference/settings/formats#input_format_orc_allow_missing_columns)                                                                          | Autoriser les colonnes manquantes lors de la lecture des données ORC.                                                    | `true`      |
| [`input_format_orc_skip_columns_with_unsupported_types_in_schema_inference`](/fr/reference/settings/formats#input_format_orc_skip_columns_with_unsupported_types_in_schema_inference)      | Autoriser l’omission des colonnes ayant des types non pris en charge lors de l’inférence du schéma pour le format ORC.   | `false`     |
