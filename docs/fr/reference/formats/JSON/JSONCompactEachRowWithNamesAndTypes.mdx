...
<Note>
  ...
  les colonnes des données d&#39;entrée seront mises en correspondance avec les colonnes de la table selon leur nom, et les colonnes dont le nom est inconnu seront ignorées si le paramètre [input&#95;format&#95;skip&#95;unknown&#95;fields](/fr/reference/settings/formats#input_format_skip_unknown_fields) est défini sur 1.
