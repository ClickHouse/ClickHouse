...
Les colonnes de données importées dont les noms sont inconnus seront ignorées si le paramètre [input&#95;format&#95;skip&#95;unknown&#95;fields](/fr/reference/settings/formats#input_format_skip_unknown_fields) est défini sur 1.
