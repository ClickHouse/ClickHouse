...
-   `arrays` – Arbitrary number of arguments of [Tableau](../../sql_reference/data_types/array.md) type.
    **Exemple**
...
-   `array_of_arrays` — [Tableau](../../sql_reference/data_types/array.md) de tableaux. Exemple, `[[1,2,3], [4,5]]`.
...
`arr` — Any number of [tableau](../../sql_reference/data_types/array.md) tapez les colonnes à combiner.
