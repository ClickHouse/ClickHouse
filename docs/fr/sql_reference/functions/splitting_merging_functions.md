...
-   `separator` — The separator which should contain exactly one character. [Chaîne](../../sql_reference/data_types/string.md).
-   `s` — The string to split. [Chaîne](../../sql_reference/data_types/string.md).
...
Type: [Tableau](../../sql_reference/data_types/array.md) de [Chaîne](../../sql_reference/data_types/string.md).
...
-   `separator` — The separator. [Chaîne](../../sql_reference/data_types/string.md).
-   `s` — The string to split. [Chaîne](../../sql_reference/data_types/string.md).
