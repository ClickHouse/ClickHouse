...
Ce moteur prend en charge le [Nullable](../../../sql_reference/data_types/nullable.md) type de données.
...
-   Les types de colonnes peuvent différer de ceux de la table source. ClickHouse essaie de [jeter](../../../sql_reference/functions/type_conversion_functions.md#type_conversion_function-cast) valeurs des types de données ClickHouse.
...
-   [Fonction de table ODBC](../../../sql_reference/table_functions/odbc.md)
