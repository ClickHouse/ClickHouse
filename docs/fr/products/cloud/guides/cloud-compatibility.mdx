...
Les moteurs de table suivants sont également pris en charge et utilisés tels quels. Le moteur de table `MySQL` pris en charge est distinct du moteur de base de données `MySQL`, qui n’est pas pris en charge :
...
## Liste des fonctionnalités non prises en charge {#list-of-unsupported-features}
