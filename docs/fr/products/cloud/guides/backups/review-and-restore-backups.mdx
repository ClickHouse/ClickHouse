...
<div id="working-with-your-restored-service">
  ## Utiliser votre service restauré {#working-with-your-restored-service}
</div>
...
<div id="use-the-new-restored-service">
  ### Utiliser le **nouveau service restauré** {#use-the-new-restored-service}
</div>
...
<div id="migrate-data-from-the-newly-restored-service-back-to-the-original-service">
  ### Migrer les données du **service récemment restauré** vers le **service d&#39;origine** {#migrate-data-from-the-newly-restored-service-back-to-the-original-service}
</div>
...
<div id="undeleting-or-undropping-tables">
  ## Restauration de tables supprimées {#undeleting-or-undropping-tables}
</div>
...
<div id="configurable-backups">
  ## Sauvegardes configurables {#configurable-backups}
</div>
