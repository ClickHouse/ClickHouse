...
<div id="taking-backups-to-aws">
  ### Effectuer des sauvegardes sur AWS {#taking-backups-to-aws}
</div>
...
<div id="taking-backups-to-gcp">
  ### Effectuer des sauvegardes sur GCP {#taking-backups-to-gcp}
</div>
...
<div id="taking-backups-to-azure">
  ### Effectuer des sauvegardes sur Azure {#taking-backups-to-azure}
</div>
