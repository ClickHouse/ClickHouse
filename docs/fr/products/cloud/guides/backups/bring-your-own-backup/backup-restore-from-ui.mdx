...
<Steps>
  ...
  <Step>
    ...
    Ajoutez l’ARN du service nouvellement créé (depuis la page des paramètres du service dans la console ClickHouse Cloud) à la stratégie d’approbation du rôle IAM. Il s’agit de la même opération que la [deuxième étape](#create-iam-role) de la section Étapes AWS ci-dessus. Cela est nécessaire pour que le nouveau service puisse accéder au bucket S3.
  </Step>
...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/manage/backups/azure_connection_details.webp" alt="Indiquer la chaîne de connexion et le nom du conteneur de votre compte de stockage Azure" size="md" />
  </Step>
