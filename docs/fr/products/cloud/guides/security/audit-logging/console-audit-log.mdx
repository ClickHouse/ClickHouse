...
des événements d’audit. Vous trouverez plus d’informations dans la [référence de l’API](/fr/products/cloud/api-reference/organization/get-list-of-available-organizations).
