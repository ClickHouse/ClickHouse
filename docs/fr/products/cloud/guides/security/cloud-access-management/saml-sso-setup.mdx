...
Nous prenons en charge le SSO initié par le fournisseur de services, plusieurs organisations utilisant des connexions distinctes, ainsi que le provisionnement juste à temps. Nous prenons également en charge le provisionnement SCIM en avant-première privée avec [Okta](/fr/products/cloud/guides/security/cloud-access-management/scim-setup) et [Microsoft Entra ID](/fr/products/cloud/guides/security/cloud-access-management/scim-setup-entra). Nous ne prenons pas encore en charge le mappage des attributs.
...
* provisionnement SCIM — automatisez le provisionnement des utilisateurs et des groupes avec [Okta](/fr/products/cloud/guides/security/cloud-access-management/scim-setup) ou [Microsoft Entra ID](/fr/products/cloud/guides/security/cloud-access-management/scim-setup-entra) (avant-première privée).
