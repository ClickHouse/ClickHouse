...
## Gérer les rôles de base de données (bêta) {#manage-database-roles}
...
<div id="update-custom-role">
  ## Mettre à jour les rôles personnalisés {#update-custom-role}
</div>
...
<div id="delete-custom-role">
  ## Supprimer les rôles personnalisés {#delete-custom-role}
</div>
