...
Pour savoir comment gérer les rôles à l’avenir, consultez [Gérer les rôles personnalisés](/fr/cloud/guides/security/manage-custom-roles) et [Gestion des accès au Cloud](/fr/cloud/security/cloud_access_management).