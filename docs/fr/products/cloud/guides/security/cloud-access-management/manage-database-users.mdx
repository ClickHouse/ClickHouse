...
<div id="sql-console-passwordless-authentication">
  ### Authentification sans mot de passe de la console SQL {#sql-console-passwordless-authentication}
</div>
...
<Tip>
  Préférez les [rôles de base de données gérés par ClickHouse Cloud](/fr/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles) (bêta) pour gérer l’accès aux bases de données depuis la console. Les rôles `sql-console-role:<email>` ne sont pas compatibles avec l’[authentification JWT](/fr/products/cloud/guides/security/cloud-access-management/jwt-authentication-setup).
</Tip>
...
<div id="database-authentication">
  ## Authentification à la base de données {#database-authentication}
</div>

<div id="database-user-id--password">
  ### ID et mot de passe de l’utilisateur de base de données {#database-user-id--password}
</div>
...
<div id="database-ssh">
  ### Utilisateur de base de données avec authentification SSH {#database-ssh}
</div>
...
<div id="database-permissions">
  ## Permissions de la base de données {#database-permissions}
</div>
...
<div id="initial-settings">
  ### Paramètres initiaux {#initial-settings}
</div>
