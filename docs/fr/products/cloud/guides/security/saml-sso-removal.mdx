...
<Steps>
  ...
  <Step>
    ### Identifier les utilisateurs à réinviter

    Cliquez sur le nom de l&#39;organisation en bas à gauche, puis sélectionnez `Users and Roles`. Vérifiez la colonne `Provider` pour chaque utilisateur ; tout utilisateur affichant `Signed in with SSO` devra être réinvité dans l&#39;organisation après la suppression de SAML.
...
<Steps>
  <Step>
    ...
    Cliquez sur le nom de l’organisation en bas à gauche, puis sélectionnez `Users and Roles`. Suivez les instructions pour [inviter des utilisateurs](/fr/products/cloud/guides/security/cloud-access-management/manage-cloud-users#invite-users).
  </Step>
  ...
  <Step>
    ### Enregistrer les requêtes et les tableaux de bord
