...
Les tableaux suivants répertorient les régions prises en charge par fournisseur de Cloud. Les badges indiquent la disponibilité des options région privée, HIPAA et PCI. Les régions sans badge ne proposent actuellement aucune de ces options.
