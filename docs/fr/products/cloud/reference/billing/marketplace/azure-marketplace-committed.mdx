...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-committed-5.webp" size="md" alt="Page Private Offer Management d'Azure Marketplace avec achat activé" border />
...
<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-payg-11.webp" size="sm" alt="Formulaire d'informations d'inscription ClickHouse Cloud" border />

<br />

<br />

<Image img="/images/cloud/manage/billing/marketplace/azure-marketplace-payg-12.webp" size="md" alt="Formulaire d'informations d'inscription ClickHouse Cloud" border />
