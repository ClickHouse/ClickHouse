...
<div id="how-can-i-verify-that-my-organization-is-connected-to-marketplace-billing">
  ### Comment puis-je vérifier que mon organisation utilise la facturation via marketplace ?​ {#how-can-i-verify-that-my-organization-is-connected-to-marketplace-billing}
</div>
...
<div id="i-am-an-existing-clickhouse-cloud-user-what-happens-when-i-subscribe-to-clickhouse-cloud-via-aws--gcp--azure-marketplace">
  ### Je suis déjà utilisateur de ClickHouse Cloud. Que se passe-t-il lorsque je m’abonne à ClickHouse Cloud via la marketplace AWS / GCP / Azure​ ? {#i-am-an-existing-clickhouse-cloud-user-what-happens-when-i-subscribe-to-clickhouse-cloud-via-aws--gcp--azure-marketplace}
</div>
...
<div id="i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-how-can-i-unsubscribe">
  ### J’ai souscrit à ClickHouse Cloud en tant qu’utilisateur de la marketplace. Comment me désabonner ?​ {#i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-how-can-i-unsubscribe}
</div>
...
<div id="i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-and-then-unsubscribed-now-i-want-to-subscribe-back-what-is-the-process">
  ### Je me suis abonné à ClickHouse Cloud en tant qu&#39;utilisateur d&#39;une marketplace, puis je me suis désabonné. Je souhaite maintenant me réabonner : quelle est la procédure ?​ {#i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-and-then-unsubscribed-now-i-want-to-subscribe-back-what-is-the-process}
</div>
...
<div id="how-do-i-access-my-invoice-for-my-marketplace-subscription-to-the-clickhouse-cloud-service">
  ### Comment puis-je accéder à la facture de mon abonnement Marketplace pour mon service ClickHouse Cloud ?​ {#how-do-i-access-my-invoice-for-my-marketplace-subscription-to-the-clickhouse-cloud-service}
</div>
...
<div id="why-do-the-dates-on-the-usage-statements-not-match-my-marketplace-invoice">
  ### Pourquoi les dates figurant sur les relevés Usage ne correspondent-elles pas à celles de ma facture Marketplace​ ? {#why-do-the-dates-on-the-usage-statements-not-match-my-marketplace-invoice}
</div>
...
<div id="is-there-a-difference-in-clickhouse-cloud-pricing-whether-paying-through-the-cloud-provider-marketplace-or-directly-to-clickhouse">
  ### Y a-t-il une différence dans la tarification de ClickHouse Cloud selon que le paiement s’effectue via la marketplace du fournisseur cloud ou directement auprès de ClickHouse ? {#is-there-a-difference-in-clickhouse-cloud-pricing-whether-paying-through-the-cloud-provider-marketplace-or-directly-to-clickhouse}
</div>
...
<div id="multiple-organizations-to-bill-to-single-cloud-marketplace-account">
  ### Puis-je configurer plusieurs organisations ClickHouse pour les facturer sur un même compte de facturation de cloud marketplace (AWS, GCP ou Azure) ? {#multiple-organizations-to-bill-to-single-cloud-marketplace-account}
</div>
