...
<div id="billing-compliance">
  ## Conformité de la facturation {#billing-compliance}
</div>
...
<div id="direct-payg">
  ### Facturation Pay-As-You-Go avec une carte de crédit {#direct-payg}
</div>
...
<div id="cloud-marketplace-payg">
  ### Facturation à l’usage via la place de marché cloud {#cloud-marketplace-payg}
</div>
...
<div id="committed-spend-contract">
  ### Facturation des contrats d&#39;engagement {#committed-spend-contract}
</div>
...
<div id="marketplace-payg">
  ## Comment payer via les places de marché {#marketplace-payg}
</div>
