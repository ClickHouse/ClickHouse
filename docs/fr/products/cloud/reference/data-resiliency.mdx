...
<div id="restoring-from-a-backup">
  ## Restauration à partir d’une sauvegarde {#restoring-from-a-backup}
</div>
...
<div id="recovery-process">
  ## Procédure de récupération {#recovery-process}
</div>
...
<div id="primary-service-data-corruption">
  ### Corruption des données du service principal {#primary-service-data-corruption}
</div>
...
<div id="primary-region-downtime">
  ### Indisponibilité de la région principale {#primary-region-downtime}
</div>
