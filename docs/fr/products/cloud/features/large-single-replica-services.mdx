...
Les limites du niveau Basic, soit `100` bases de données et `500` tables, s’appliquent uniquement aux services à réplique unique de ce niveau. Les services à réplique unique des niveaux Scale et Enterprise sont soumis aux limites standard des services. Pour en savoir plus, consultez [Limites d’utilisation](/fr/products/cloud/guides/best-practices/usagelimits).