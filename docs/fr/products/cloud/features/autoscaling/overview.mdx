...
<Note>
  Les niveaux Scale et Enterprise prennent en charge les services à réplique unique comme les services à plusieurs répliques, tandis que le niveau Basic ne prend en charge que les services à réplique unique. Les services à réplique unique ont une taille fixe et ne permettent pas de mise à l’échelle verticale ou horizontale. Vous pouvez passer au niveau Scale ou Enterprise pour mettre vos services à l’échelle.
</Note>
