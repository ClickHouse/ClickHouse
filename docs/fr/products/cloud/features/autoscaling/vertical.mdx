...
<Note>
  Pour les services du niveau Enterprise, les profils standard 1:4 prennent en charge la mise à l’échelle verticale automatique. Les profils personnalisés ne prennent pas en charge la mise à l’échelle verticale automatique ni la mise à l’échelle verticale manuelle. Toutefois, ces services peuvent être mis à l’échelle verticalement en contactant le support.
</Note>