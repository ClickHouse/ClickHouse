...
<Image img="/images/cloud/manage/scaling-patch-request.webp" size="lg" alt="Requête PATCH de mise à l’échelle" border caption="Requête `PATCH` pour mettre à jour `numReplicas`" />

<Image img="/images/cloud/manage/scaling-patch-response.webp" size="md" alt="Réponse PATCH de mise à l’échelle" border caption="Réponse à la requête `PATCH`" />
...
<Image img="/images/cloud/manage/scaling-configure.webp" size="md" alt="Paramètres de configuration de la mise à l’échelle" border caption="Paramètres de mise à l’échelle du service dans la ClickHouse Cloud console" />
