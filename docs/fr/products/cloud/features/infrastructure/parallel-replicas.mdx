...
<div id="sharded-architecture">
  ## Architecture shardée {#sharded-architecture}
</div>
...
<div id="managing-cache-locality">
  ### Gestion de la localité du cache {#managing-cache-locality}
</div>
...
<div id="settings-related-to-parallel-replicas">
  ## Paramètres liés aux répliques parallèles {#settings-related-to-parallel-replicas}
</div>
...
## Investiguer les problèmes liés aux répliques parallèles {#investigating-issues-with-parallel-replicas}
