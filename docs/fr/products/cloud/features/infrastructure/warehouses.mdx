...
<Image img="/images/cloud/reference/compute-compute-1.webp" size="md" alt="Service unique dans ClickHouse Cloud" caption="Fig. 1 - Service unique dans ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-2.webp" size="md" alt="Compute separation dans ClickHouse Cloud" caption="Fig. 2 - Compute separation dans ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-8.webp" size="lg" alt="Exemple de warehouse avec services principal et secondaire" background="white" caption="Fig. 3 - Exemple de warehouse" />
...
<Image img="/images/cloud/reference/compute-compute-3.webp" size="md" alt="Accès des utilisateurs entre des services partageant les mêmes données" caption="Fig. 4 - L’utilisatrice Alice a été créée dans le Service 1, mais elle peut utiliser les mêmes identifiants pour accéder à tous les services qui partagent les mêmes données" />
...
<Image img="/images/cloud/reference/compute-compute-4.webp" size="md" alt="Paramètres de contrôle d’accès réseau" caption="Fig. 5 - L’accès d’Alice au service 2 est restreint en raison des paramètres de contrôle d’accès réseau" />
...
<Image img="/images/cloud/reference/compute-compute-5.webp" size="lg" alt="Services read-write et read-only dans un warehouse" caption="Fig. 6 - Services read-write et read-only dans un warehouse" />
...
<Image img="/images/cloud/reference/compute-compute-7.webp" size="md" alt="Création d’un nouveau service dans un warehouse" caption="Fig. 7 - Cliquez sur l’icône plus pour créer un nouveau service dans un warehouse" />
