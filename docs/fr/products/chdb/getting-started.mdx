---
title: 'Premiers pas avec chDB'
sidebarTitle: 'Premiers pas'
slug: /chdb/getting-started
description: 'chDB est un moteur SQL OLAP in-process alimenté par ClickHouse'
keywords: ['chdb', 'embarqué', 'clickhouse-lite', 'in-process', 'dans le processus']
doc_type: 'guide'
---
...
Le [jeu de données des dislikes YouTube](/fr/get-started/sample-datasets/youtube-dislikes) contient plus de 4 milliards de lignes correspondant aux dislikes de vidéos YouTube jusqu&#39;en 2021.
...
chDB prend en charge les formats de données de ClickHouse, ainsi que [certains formats qui lui sont propres](/fr/products/chdb/reference/data-formats), notamment `DataFrame`, qui renvoie un Pandas DataFrame :
...
Nous utiliserons le paramètre [`schema_inference_make_columns_nullable`](/fr/reference/settings/formats#schema_inference_make_columns_nullable) afin que les types de colonnes ne soient pas tous convertis en `Nullable`.
...
Vous pouvez également en savoir plus sur l’interrogation de DataFrames Pandas dans le [guide du développeur « Interroger des DataFrames Pandas »](/fr/products/chdb/guides/querying-pandas).
...
* [Interroger des DataFrames Pandas](/fr/products/chdb/guides/querying-pandas)
* [Interroger Apache Arrow](/fr/products/chdb/guides/querying-apache-arrow)
* [Utiliser chDB dans JupySQL](/fr/products/chdb/guides/jupysql)
* [Utiliser chDB avec une base de données clickhouse-local existante](/fr/products/chdb/guides/clickhouse-local)