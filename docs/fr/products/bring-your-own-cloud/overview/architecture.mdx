...
<div id="key-requirements">
  ## Exigences clés pour le BYOC {#key-requirements}
</div>
...
<div id="cross-account-iam-permissions">
  ### Autorisations IAM inter-comptes {#cross-account-iam-permissions}
</div>
...
<div id="tailscale-private-network">
  ### Connexion au réseau privé Tailscale {#tailscale-private-network}
</div>
...
<div id="why-requirements-matter">
  ### Pourquoi ces exigences sont importantes {#why-requirements-matter}
</div>
