...
<div id="step-2-create-a-peering-connection">
  #### Étape 2 Créer une connexion de peering
</div>
...
<img src="/images/cloud/reference/byoc-vpcpeering-1.webp" alt="BYOC Créer une connexion de peering" />
...
6. Sélectionnez “Peering Connection”, puis l’ID de la connexion de peering dans le champ Target.
