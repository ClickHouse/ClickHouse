...
<div id="prometheus-monitoring">
  ## Approches de monitoring Prometheus {#prometheus-monitoring}
</div>
...
<div id="monitoring-approaches-comparison">
  ### Comparaison des méthodes de supervision {#monitoring-approaches-comparison}
</div>
...
<div id="builtin-prometheus-stack">
  ## La stack Prometheus BYOC intégrée {#builtin-prometheus-stack}
</div>
...
<div id="prometheus-stack-integration">
  ### Intégration à vos outils de monitoring {#prometheus-stack-integration}
</div>
...
<div id="direct-prometheus-integration">
  ## Intégration du service ClickHouse avec Prometheus {#direct-prometheus-integration}
</div>
