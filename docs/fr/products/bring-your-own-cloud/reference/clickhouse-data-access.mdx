...
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Exportateur d’état        | État du service et des sauvegardes (santé, statut — événements opérationnels, et non contenu des sauvegardes) vers une file d’attente `SQS` appartenant à ClickHouse Cloud. |
| Collecteur de facturation | Métriques CPU et mémoire vers un bucket de stockage d’objets appartenant à ClickHouse Cloud.                                                                                |
