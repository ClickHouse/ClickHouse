...
## Cycle de vie des certificats {#certificate-lifecycle}
...
### Ce qui ne quitte jamais l’environnement par défaut {#what-never-leaves}
...
## Périmètres de confiance {#trust-boundaries}
