...
sidebarTitle: 'CLI'
description: 'Référence des commandes clicklink clctl : init, preflight, sessions de support, approbation de la passerelle, audit et provisionnement des accès'
...
### Options communes {#init-common-flags}
