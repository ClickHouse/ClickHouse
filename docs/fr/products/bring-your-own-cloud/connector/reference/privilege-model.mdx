...
description: "Ce que le Connecteur ClickHouse peut et ne peut pas faire : connexions sortantes, Autorisations ClickHouse, RBAC Kubernetes, attribution et minimisation des données"
...
## Ce que le connecteur ne peut pas faire {#what-the-connector-cannot-do}
...
## Attribution des accès {#how-access-is-attributed}
...
## Paramètres par défaut de minimisation des données {#data-minimization-defaults}
