...
* **Un egress sur le port 443** vers `https://<subdomain>.<connector-domain>` et `https://<subdomain>.enroll.<connector-domain>`, ainsi que vers `releases.clicklink.clickhouse.com` et Amazon ECR Public au moment de l&#39;installation. En mode managé, l&#39;executor contacte également Amazon ECR et STS lorsqu&#39;une synchronisation ou une création de plateforme récupère un chart depuis ECR. Si l&#39;un de ces éléments est inaccessible, consultez [air-gapped and mirrored installs](#air-gapped-and-mirrored-installs).
...
* **Les droits d&#39;administration du cluster pour le grant de l&#39;executor.** Le grant crée un ClusterRole, un ClusterRoleBinding et une ValidatingAdmissionPolicy qui confinent l&#39;executor aux namespaces situés sous votre prefix. Sur Kubernetes, le kubeconfig avec lequel vous exécutez `init` doit disposer de ces droits. Sur une VM, c&#39;est le kubeconfig de l&#39;hôte qui doit en disposer ; si l&#39;hôte ne les possède pas, `init` affiche la commande à exécuter depuis un hôte qui en dispose.
