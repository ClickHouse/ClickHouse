...
Private Link permet une connectivité privée entre votre instance ClickHouse Managed Postgres et votre Virtual Private Cloud (VPC), sans exposer le trafic à l’internet public. Cela ajoute une couche supplémentaire d’isolation réseau et de sécurité.
...
Pour activer Private Link pour votre instance ClickHouse Managed Postgres :
