...
<Visibility for="humans">
  <View title="UI Cloud">
    ...
    * Interrogez directement ClickHouse depuis Postgres à l’aide de `pg_clickhouse`
    ...
    ## Partie 1 : Premiers pas avec NVMe Postgres {#part-1}

    ### Créer une base de données {#create-postgres-database}
    ...
    ### Connectez-vous à votre base de données {#connect}
    ...
    ### Découvrez les performances du NVMe {#nvme-performance}
    ...
    ### Exécuter des requêtes sur vos données {#run-queries}
    ...
    ***
    ...
    ## Partie 2 : Ajoutez des analyses en temps réel avec ClickHouse {#part-2}
    ...
    * **ClickHouse** pour des analyses sur des milliards de lignes en moins d’une seconde
    ...
    ### Configurer l&#39;intégration ClickHouse {#setup-integrate-clickhouse}
    ...
    * Cliquez sur **Replicate data to ClickHouse**.
    ...
    ### Interroger ClickHouse depuis Postgres {#pg-clickhouse-extension}
    ...
    ### Visualisez vos analyses en action {#analytics-after-integration}
    ...
    ### Comparer les performances de Postgres et ClickHouse {#performance-comparison}
