...
<Note>
  Si vous rencontrez des problèmes pendant la migration, consultez la [FAQ des migrations Managed Postgres](/fr/cloud/managed-postgres/migrations/faq) pour connaître les erreurs courantes et leurs solutions.
</Note>
