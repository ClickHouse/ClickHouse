...
<Image img="/images/managed-postgres/pgpg/nextimport.webp" alt="Étape 3 : commande psql pour l’importation du schéma" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/psqlimport.webp" alt="Sortie du terminal après l’import du schéma avec psql" size="lg" border />
