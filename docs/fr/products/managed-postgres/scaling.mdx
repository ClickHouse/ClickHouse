---
slug: /fr/products/managed-postgres/scaling
...
<div id="choosing-instance">
  ### Choisir le bon type d’instance {#choosing-instance}
</div>
...
<div id="scaling-process">
  ### Processus de mise à l’échelle {#scaling-process}
</div>
...
<div id="scaling-duration">
  ### Durée de la mise à l’échelle {#scaling-duration}
</div>
...
<div id="read-replicas">
  ### Répliques de lecture pour la mise à l’échelle horizontale {#read-replicas}
</div>
...
<div id="cdc-scaling">
  ### Mise à l’échelle du CDC pour l’intégration ClickHouse {#cdc-scaling}
</div>

Si vous répliquez des données vers ClickHouse à l’aide de [ClickPipes](/fr/products/managed-postgres/clickpipes), vous pouvez mettre à l’échelle le pipeline CDC (capture des changements de données) indépendamment :
