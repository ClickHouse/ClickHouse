...
[cloud-api]: /fr/products/cloud/features/admin-features/api/api-overview "Cloud API"

[API keys]: /fr/products/cloud/features/admin-features/api/openapi "Gestion des clés API"