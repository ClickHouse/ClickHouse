...
ClickHouse Managed Postgres gère les mises à niveau de version de PostgreSQL pour que vos instances restent sécurisées et à jour. Les mises à niveau mineures comme les mises à niveau de version majeure sont prises en charge avec une interruption minimale.
