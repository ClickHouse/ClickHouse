...
<div id="metrics-access">
  ### Comment puis-je accéder aux métriques de mon instance ClickHouse Managed Postgres ?
</div>
...
ClickHouse Managed Postgres inclut des sauvegardes automatiques quotidiennes avec archivage continu du WAL, permettant une restauration à un instant donné à tout moment dans une période de rétention de 7 jours. Les sauvegardes sont stockées dans S3.
...
<div id="terraform-support">
  ### Terraform est-il pris en charge pour ClickHouse Managed Postgres ?
</div>

Terraform n&#39;est pas actuellement pris en charge pour ClickHouse Managed Postgres. Nous recommandons d&#39;utiliser la console ClickHouse Cloud ou [OpenAPI](/fr/products/managed-postgres/openapi) pour créer et gérer vos instances.
...
<div id="migration-tools">
  ### Quels outils sont disponibles pour migrer vers ClickHouse Managed Postgres ?
</div>
