...
<div id="price-performance">
  ## Rapport prix/performances {#price-performance}
</div>
...
<div id="tier-based-pricing">
  ### Tarification par niveau {#tier-based-pricing}
</div>
...
### Types d’instance {#instance-types}
...
<div id="pricing-calculator">
  ## Calculateur de tarification {#pricing-calculator}
</div>
...
<div id="beta-pricing-highlights">
  ## Points clés de la tarification bêta {#beta-pricing-highlights}
</div>

<div id="aws-public-beta-pricing">
  ### Tarification de la bêta publique sur AWS {#aws-public-beta-pricing}
</div>
...
### Tarification de la Private Preview sur GCP {#gcp-private-preview-pricing}
