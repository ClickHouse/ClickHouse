...
<Steps>
  <Step stepNumber={0}>
    ## Étape 0 : Configuration du compte de service
  ...
  <Step stepNumber={1}>
    ## Étape 1 : Définir les variables d&#39;environnement (`00-env.sh`)
  ...
  <Step stepNumber={2}>
    ## Étape 2 : Créer l’Artifact Registry (`01-artifact-registry.sh`)
  ...
  <Step stepNumber={3}>
    ## Étape 3 : Copier les images de conteneur (`02-copy-images.sh`)
  ...
  <Step stepNumber={4}>
    ## Étape 4 : Configurer le VPC et le sous-réseau (`03-vpc-subnet.sh`)
  ...
  <Step stepNumber={5}>
    ## Étape 5 : Créer Cloud NAT (`04-cloud-nat.sh`)
  ...
  <Step stepNumber={6}>
    ## Étape 6 : Créer un compte de service GCP (`05-service-account.sh`)
  ...
  <Step stepNumber={7}>
    ## Étape 7 : Créer un bucket GCS (`06-gcs-bucket.sh`)
  ...
  <Step stepNumber={8}>
    ## Étape 8 : Créer le cluster GKE (`07-gke-cluster.sh`)
  ...
  <Step stepNumber={9}>
    ## Étape 9 : Créer des pools de nœuds (`08-node-pools.sh`)
  ...
  <Step stepNumber={10}>
    ## Étape 10 : Déployer le DaemonSet Local SSD (`09-local-ssd-daemonset.sh`)
  ...
  <Step stepNumber={11}>
    ## Étape 11 : Ajouter des labels de topologie (`10-topology-labels.sh`)
  ...
  <Step stepNumber={12}>
    ## Étape 12 : Installer les prérequis Kubernetes
  ...
  <Step stepNumber={13}>
    ## Étape 13 : Procédure FIPS (conditionnel)
  ...
  <Step stepNumber={14}>
    ## Étape 14 : Installer l’Operator (`16-install-operator.sh`)
  ...
  <Step stepNumber={15}>
    ## Étape 15 : Déployer le cluster ClickHouse (`17-install-cluster.sh`)
  ...
  <Step stepNumber={16}>
    ## Étape 16 : Associer Workload Identity (`18-bind-helm-workload-identity.sh`)
  ...
  <Step stepNumber={17}>
    ## Étape 17 : Vérifier l’installation
