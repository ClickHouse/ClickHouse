---
position: 2
slug: /fr/products/kubernetes-operator/guides/configuration
...
<div id="clickhousecluster-configuration">
  ## Configuration de ClickHouseCluster {#clickhousecluster-configuration}
</div>
...
<div id="replicas-and-shards">
  ### Répliques et shards {#replicas-and-shards}
</div>
...
<div id="keeper-integration">
  ### Intégration de Keeper {#keeper-integration}
</div>
...
<div id="keepercluster-configuration">
  ## Configuration de KeeperCluster {#keepercluster-configuration}
</div>
...
<div id="cluster-domain">
  ## Domaine du cluster {#cluster-domain}
</div>
...
<div id="pod-configuration">
  ## Configuration du pod {#pod-configuration}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencepodtemplatespec-for-all-supported-pod-template-options">
  ### Consultez la [Référence de l’API](/fr/products/kubernetes-operator/reference/api-reference#podtemplatespec) pour voir toutes les options de modèle de pod prises en charge. {#see-api-reference-for-all-supported-pod-template-options}
</div>

<div id="pod-disruption-budgets">
  ## Budgets de perturbation des pods {#pod-disruption-budgets}
</div>
...
<div id="pdb-defaults">
  ### Valeurs par défaut {#pdb-defaults}
</div>
...
<div id="pdb-overrides">
  ### Surcharger les valeurs par défaut {#pdb-overrides}
</div>
...
<div id="pdb-cluster-wide-disable">
  ### Désactivation à l’échelle du cluster {#pdb-cluster-wide-disable}
</div>
...
<div id="container-configuration">
  ## Configuration du conteneur {#container-configuration}
</div>
...
<div id="container-resources">
  ### Ressources des conteneurs {#container-resources}
</div>
...
<div id="volume-mounts">
  ### Points de montage de volumes {#volume-mounts}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencecontainertemplatespec-for-all-supported-container-template-options">
  ### Voir la [Référence de l’API](/fr/products/kubernetes-operator/reference/api-reference#containertemplatespec) pour toutes les options prises en charge des modèles de conteneur. {#see-api-reference-for-all-supported-container-template-options}
</div>

<div id="tls-ssl-configuration">
  ## Configuration du TLS/SSL {#tls-ssl-configuration}
</div>

<div id="configure-secure-endpoints">
  ### Configurer des endpoints sécurisés {#configure-secure-endpoints}
</div>
...
<div id="ssl-certificate-secret-format">
  ### Format du Secret pour le certificat SSL {#ssl-certificate-secret-format}
</div>
...
<div id="clickhouse-keeper-communication-over-tls">
  ### Communication de ClickHouse Keeper via TLS {#clickhouse-keeper-communication-over-tls}
</div>
...
<div id="external-secret-required-keys">
  ### Clés requises {#external-secret-required-keys}
</div>
...
<div id="external-secret-policy">
  ### Politique : Observe ou Manage {#external-secret-policy}
</div>
...
<div id="external-secret-status">
  ### Condition d’état et dépannage {#external-secret-status}
</div>
...
<div id="additional-ports">
  ## Ports supplémentaires {#additional-ports}
</div>
...
<div id="additional-ports-mysql-example">
  ### Exemple complet : protocole MySQL wire {#additional-ports-mysql-example}
</div>
...
<div id="additional-ports-constraints">
  ### Contraintes sur les champs {#additional-ports-constraints}
</div>
...
<div id="additional-ports-reserved">
  ### Ports et noms réservés {#additional-ports-reserved}
</div>
...
<div id="version-probe-and-upgrade-channel">
  ## Sonde de version et canal de mise à niveau {#version-probe-and-upgrade-channel}
</div>
...
<div id="upgrade-channel-choosing">
  ### Choisir un canal de publication {#upgrade-channel-choosing}
</div>
...
<div id="version-status-conditions">
  ### Conditions d’état {#version-status-conditions}
</div>
...
<div id="version-probe-template">
  ### Redéfinition du Job de sonde de version {#version-probe-template}
</div>
...
<div id="version-operator-flags">
  ### Contrôles globaux de l’opérateur {#version-operator-flags}
</div>
...
<div id="clickhouse-settings">
  ## Paramètres de ClickHouse {#clickhouse-settings}
</div>

<div id="default-user-password">
  ### Mot de passe de l’utilisateur `default` {#default-user-password}
</div>
...
<div id="password-types">
  #### Types de mot de passe {#password-types}
</div>
...
<div id="default-password-secret-example">
  #### Exemple complet avec un Secret {#default-password-secret-example}
</div>
...
<div id="using-configmap-for-user-passwords">
  #### Utiliser un ConfigMap {#using-configmap-for-user-passwords}
</div>
...
<div id="database-sync">
  ### Synchronisation de la base de données {#database-sync}
</div>
...
<div id="embedded-extra-configuration">
  ### Configuration supplémentaire intégrée {#embedded-extra-configuration}
</div>
...
<div id="embedded-extra-users-configuration">
  ### Configuration intégrée d’utilisateurs supplémentaires {#embedded-extra-users-configuration}
</div>
...
<div id="see-documentationconceptsfeaturesconfigurationsettingssettings-users-for-all-supported-clickhouse-users-configuration-options">
  #### Consultez la [documentation](/fr/concepts/features/configuration/settings/settings-users) pour connaître toutes les options de configuration prises en charge pour les utilisateurs ClickHouse. {#see-documentation-for-all-supported-clickhouse-users-configuration-options}
</div>
