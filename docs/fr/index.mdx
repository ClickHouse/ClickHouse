...
export const IntegrationsBanner = () => {
    const assetBase = typeof window !== 'undefined' && window.location.pathname.startsWith('/docs') ? '/docs' : '';
    const href = '/fr/integrations/home';
    return (
        <a
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "Concepts de ClickHouse", href: "/fr/concepts/core-concepts/index" },
        ...
        { label: "Tables système", href: "/fr/reference/system-tables/overview" },
        ...
        { label: "ClickHouse Managed Postgres", href: "/fr/products/managed-postgres/overview" },
        { label: "Langfuse", href: "https://langfuse.com/docs", external: true },
        { label: "chDB", href: "/fr/chdb" },
        { label: "Opérateur Kubernetes", href: "/fr/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="Analyse en temps réel" galaxyEvent="docs.home.real-time-analytics" description="Obtenez des insights instantanés et des dashboards à grande échelle. Analysez des milliards de lignes en temps réel avec des résultats en quelques millisecondes." href="/fr/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="Observabilité" galaxyEvent="docs.home.observability" description="Stockez et interrogez logs, métriques et traces à grande échelle avec ClickStack, la stack d’observabilité open source propulsée par ClickHouse." href="/fr/clickstack/overview" showArrow />

        <HeroCard title="Data warehousing" galaxyEvent="docs.home.data-warehousing" description="Analysez et explorez les données instantanément pour en tirer des insights et alimenter vos applications. Passez plus rapidement à l’échelle en déchargeant les workloads les plus lourds." href="/fr/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="Analytique agentique" galaxyEvent="docs.home.agentic-analytics" description="Permettez aux agents d’IA d’interroger directement vos données en temps réel pour fournir instantanément des insights conversationnels et des visualisations" href="/fr/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. Comment ingérer des données depuis des sources courantes avec un minimum d’effort", href: "/fr/integrations/home" },
              { label: "2. Bonnes pratiques pour organiser les données pour l’analytics et la croissance", href: "/fr/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. Comment interroger de grands jeux de données en temps réel", href: "/fr/get-started/use-cases/real-time-analytics" },
              { label: "4. Comment créer des dashboards, des alertes et des fonctionnalités pilotées par les événements", href: "/fr/get-started/use-cases/data-warehousing" },
              { label: "5. Conseils pour maintenir les coûts à un niveau bas tout en conservant des performances élevées", href: "/fr/concepts/best-practices/index" },
          ]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" galaxyEvent="docs.home.clickstack" description="La stack d’observabilité tout-en-un propulsée par ClickHouse, qui vous offre des requêtes ultra-rapides et de puissantes agrégations sur les logs, metrics, traces, session replays et errors." href="/fr/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Opérateur Kubernetes" galaxyEvent="docs.home.kubernetes-operator" description="Automatise le déploiement, la configuration et la gestion des clusters ClickHouse et ClickHouse Keeper sur Kubernetes." href="/fr/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" galaxyEvent="docs.home.chdb" description="Une base de données in-process rapide, fiable et évolutive. Découvrez la puissance de ClickHouse, in-process." href="/fr/chdb/index" showArrow />
        </div>
      </div>
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-0">Configurer le MCP Server de la documentation</h2>
        <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Interrogez directement la documentation ClickHouse depuis vos outils d’IA à l’aide du Model Context Protocol.</p>
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          ...
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">Installez les Skills ClickHouse pour donner à votre agent une expertise ClickHouse et les bonnes pratiques associées.</p>
