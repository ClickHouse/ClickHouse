  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "Concepts de ClickHouse", href: "/concepts/core-concepts/index" },
        ...
        { label: "Opérateur Kubernetes", href: "/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="Analyse en temps réel" description="Obtenez des insights instantanés et des dashboards à grande échelle. Analysez des milliards de lignes en temps réel avec des résultats en quelques millisecondes." href="/fr/get-started/use-cases/real-time-analytics" showArrow />
        ...
        <HeroCard title="Data warehousing" description="Analysez et explorez les données instantanément pour en tirer des insights et alimenter vos applications. Passez plus rapidement à l’échelle en déchargeant les workloads les plus lourds." href="/fr/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="Analytique agentique" description="Permettez aux agents d’IA d’interroger directement vos données en temps réel pour fournir instantanément des insights conversationnels et des visualisations" href="/fr/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              { label: "2. Bonnes pratiques pour organiser les données pour l’analytics et la croissance", href: "/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. Comment interroger de grands jeux de données en temps réel", href: "/get-started/use-cases/real-time-analytics" },
              { label: "4. Comment créer des dashboards, des alertes et des fonctionnalités pilotées par les événements", href: "/get-started/use-cases/data-warehousing" },
              { label: "5. Conseils pour maintenir les coûts à un niveau bas tout en conservant des performances élevées", href: "/concepts/best-practices/index" },
          ]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" description="La stack d’observabilité tout-en-un propulsée par ClickHouse, qui vous offre des requêtes ultra-rapides et de puissantes agrégations sur les logs, metrics, traces, session replays et errors." href="/fr/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard filename="thumbnail-postgres-light.webp" title="Managed Postgres" description="Un service Postgres rapide, évolutif et de niveau entreprise, intégré nativement à ClickHouse. Combinez facilement Postgres pour les transactions et ClickHouse pour l’analytics." href="/fr/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="Plateforme d’ingénierie LLM open-source pour l’observabilité, les métriques, les évaluations et la gestion des prompts." href="https://langfuse.com/docs" showArrow external />
          ...
          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="Une base de données in-process rapide, fiable et évolutive. Découvrez la puissance de ClickHouse, in-process." href="/fr/products/chdb/index" showArrow />
        </div>
      </div>
