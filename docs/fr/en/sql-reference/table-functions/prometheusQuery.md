---
description: 'Évalue une requête Prometheus en utilisant les données d''une table TimeSeries.'
...
Évalue une requête Prometheus en utilisant les données d&#39;une table TimeSeries.
...
La fonction peut renvoyer différentes colonnes en fonction du type de résultat de la requête passée au paramètre `promql_query` :

| Type de résultat | Colonnes de résultat                                                                      | Exemple                                             |
| ---------------- | ----------------------------------------------------------------------------------------- | --------------------------------------------------- |
...
Sélecteurs instantanés, sélecteurs de plage, filtres sur les labels (`=`, `!=`, `=~`, `!~`), modificateurs offset, modificateurs d’horodatage `@` et sous-requêtes.
