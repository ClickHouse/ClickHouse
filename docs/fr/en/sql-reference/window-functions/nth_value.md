...
Renvoie la première valeur non NULL évaluée à la n-ième ligne (offset) de son frame ordonné.
...
* `x` — Nom de la colonne.
* `offset` — énième ligne par rapport à laquelle évaluer la ligne en cours.

**Valeur retournée**

* La première valeur non-NULL évaluée par rapport à la énième ligne (`offset`) dans son frame ordonné.
