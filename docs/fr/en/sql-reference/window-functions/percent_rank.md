---
description: 'Documentation de référence sur la fonction de fenêtre percent_rank'
...
renvoie le rang relatif (c’est-à-dire le percentile) des lignes au sein d’une partition de fenêtre.
...
La définition du frame de fenêtre, par défaut et obligatoire, est `RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING`.
