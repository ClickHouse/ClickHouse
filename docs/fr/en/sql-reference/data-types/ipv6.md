---
description: 'Documentation sur le type de données IPv6 de ClickHouse, qui stocke les adresses IPv6
  sous forme de valeurs de 16 octets'
sidebar_label: 'IPv6'
sidebar_position: 30
...
Ou bien, vous pouvez utiliser le domaine `IPv6` comme clé :
...
* [Fonctions de manipulation des adresses IPv4 et IPv6](../functions/ip-address-functions.md)