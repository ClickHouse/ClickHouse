...
Semblable à [`JSONCompactEachRowWithProgress`](/fr/interfaces/formats/JSONCompactEachRowWithProgress), mais toutes les valeurs sont converties en chaînes de caractères.
Ceci est utile lorsque vous avez besoin d&#39;une représentation textuelle cohérente pour tous les types de données.

Caractéristiques principales :

* Même structure que `JSONCompactEachRowWithProgress`
* Toutes les valeurs sont représentées sous forme de chaînes de caractères (les nombres, les tableaux, etc. sont tous des chaînes entre guillemets)
