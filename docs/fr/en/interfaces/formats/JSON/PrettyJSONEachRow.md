...
Ne diffère de [JSONEachRow](./JSONEachRow.md) que par le fait que le JSON est mis en forme de manière plus lisible, avec des retours à la ligne comme délimiteurs et une indentation de 4 espaces.
