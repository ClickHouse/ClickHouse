---
description: 'Documentation sur le format JSONCompactStringsEachRowWithNamesAndTypes'
...
Se distingue du format `JSONCompactEachRow` en ce qu’il affiche également deux lignes d’en-tête contenant les noms et les types des colonnes, comme [TabSeparatedWithNamesAndTypes](/fr/interfaces/formats/TabSeparatedRawWithNamesAndTypes).
