...
Ne diffère du format [JSON](./JSON.md) que par le fait que les champs de données sont renvoyés sous forme de chaînes de caractères, et non sous forme de valeurs JSON typées. Il s’agit d’un format de sortie uniquement.
