...
Se distingue du format [`JSONCompactEachRow`](./JSONCompactEachRow.md) en ce qu’il affiche également deux lignes d’en-tête avec les noms et les types des colonnes, comme le format [TabSeparatedWithNamesAndTypes](../TabSeparated/TabSeparatedWithNamesAndTypes.md).
...
les colonnes des données d&#39;entrée seront associées aux colonnes de la table par leur nom, et les colonnes portant des noms inconnus seront ignorées si le paramètre [input&#95;format&#95;skip&#95;unknown&#95;fields](/fr/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) est défini sur 1.
