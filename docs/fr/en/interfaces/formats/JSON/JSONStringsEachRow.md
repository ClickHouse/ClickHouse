...
Se distingue de [`JSONEachRow`](./JSONEachRow.md) uniquement par le fait que les champs de données sont renvoyés sous forme de chaînes, et non de valeurs JSON typées.
...
Lisez les données au format `JSONStringsEachRow` :
