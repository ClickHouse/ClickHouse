...
description: 'Documentation du format JSONEachRow'
...
Dans ce format, ClickHouse génère chaque ligne sous la forme d’un objet JSON distinct, délimité par des retours à la ligne.
...
Les colonnes de données dont le nom est inconnu seront ignorées lors de l’importation si le paramètre [input&#95;format&#95;skip&#95;unknown&#95;fields](/fr/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) est défini sur 1.
