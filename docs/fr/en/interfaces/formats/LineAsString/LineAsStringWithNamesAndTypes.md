...
Le format `LineAsStringWithNames` est similaire au format [`LineAsString`](./LineAsString.md),
mais il affiche deux lignes d’en-tête : l’une avec les noms des colonnes, l’autre avec les types.
