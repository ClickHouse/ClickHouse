---
alias: []
description: 'Documentation du format CustomSeparatedWithNamesAndTypes'
input_format: true
...
Affiche également deux lignes d’en-tête contenant les noms et les types des colonnes, comme [TabSeparatedWithNamesAndTypes](../TabSeparated/TabSeparatedWithNamesAndTypes.md).
...
Lisez des données à l’aide du format `CustomSeparatedWithNamesAndTypes` :
...
les colonnes des données d&#39;entrée seront associées aux colonnes de la table par leur nom ; les colonnes dont le nom est inconnu seront ignorées si le paramètre [`input_format_skip_unknown_fields`](../../../operations/settings/settings-formats.md/#input_format_skip_unknown_fields) est défini sur `1`.
