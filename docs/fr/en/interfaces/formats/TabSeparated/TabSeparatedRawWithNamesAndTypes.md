...
Diffère du format [`TabSeparatedWithNamesAndTypes`](./TabSeparatedWithNamesAndTypes.md),
car les lignes sont écrites sans échappement des caractères.
...
Lisez les données à l’aide du format `TabSeparatedRawWithNamesAndTypes` :
