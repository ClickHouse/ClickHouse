...
| `input_format_arrow_use_native_reader`                                       | Utiliser le lecteur natif de ClickHouse pour les formats `Arrow` et `ArrowStream` au lieu de la bibliothèque Apache Arrow. Définissez la valeur `0` pour utiliser le lecteur de la bibliothèque Apache Arrow.                                                         | `1`         |
...
| `output_format_arrow_unsupported_types_as_binary`                            | Exporter un type qui n&#39;a pas d&#39;équivalent Arrow (par exemple `BFloat16`, `AggregateFunction`) sous forme de données binaires brutes. Si false, ce type déclenche une exception. S&#39;applique au writer natif comme à celui de la bibliothèque Apache Arrow. | `1`         |
...
| `output_format_arrow_use_native_writer`                                      | Utiliser le writer natif de ClickHouse pour les formats `Arrow` et `ArrowStream` au lieu de la bibliothèque Apache Arrow. Définissez la valeur `0` pour utiliser le writer de la bibliothèque Apache Arrow.                                                           | `1`         |
