...
La table &#39;system.zookeeper&#95;connection&#95;log&#39; affiche l’historique des connexions à ZooKeeper (y compris aux ZooKeeper auxiliaires). Chaque ligne contient des informations sur un événement lié aux connexions.

:::note
La table ne contient pas les événements de déconnexion provoqués par l’arrêt du serveur.
:::
...
* `hostname` ([LowCardinality(String)](/fr/sql-reference/data-types/lowcardinality)) — Nom d’hôte du serveur qui s’est connecté à ZooKeeper ou qui s’en est déconnecté.
* `type` ([Enum8(&#39;Connected&#39; = 0, &#39;Disconnected&#39; = 1)](/fr/sql-reference/data-types/enum)) — Le type de l’événement. Valeurs possibles : Connected, Disconnected.
...
* `name` ([String](/fr/sql-reference/data-types/string)) — Nom du cluster ZooKeeper.
* `host` ([String](/fr/sql-reference/data-types/string)) — Nom d’hôte/IP du nœud ZooKeeper auquel ClickHouse s’est connecté ou duquel il s’est déconnecté.
* `port` ([UInt16](/fr/sql-reference/data-types/int-uint)) — Port du nœud ZooKeeper auquel ClickHouse s’est connecté ou duquel il s’est déconnecté.
* `index` ([UInt8](/fr/sql-reference/data-types/int-uint)) — Index du nœud ZooKeeper auquel ClickHouse s’est connecté ou duquel il s’est déconnecté. L’index provient de la configuration ZooKeeper.
* `client_id` ([Int64](/fr/sql-reference/data-types/int-uint)) — ID de session de la connexion.
* `keeper_api_version` ([UInt8](/fr/sql-reference/data-types/int-uint)) — Version de l’API Keeper.
* `enabled_feature_flags` ([Array(Enum16(&#39;FILTERED&#95;LIST&#39; = 0, &#39;MULTI&#95;READ&#39; = 1, &#39;CHECK&#95;NOT&#95;EXISTS&#39; = 2, &#39;CREATE&#95;IF&#95;NOT&#95;EXISTS&#39; = 3, &#39;REMOVE&#95;RECURSIVE&#39; = 4, &#39;MULTI&#95;WATCHES&#39; = 5, &#39;CHECK&#95;STAT&#39; = 6, &#39;PERSISTENT&#95;WATCHES&#39; = 7, &#39;CREATE&#95;WITH&#95;STATS&#39; = 8, &#39;TRY&#95;REMOVE&#39; = 9, &#39;LIST&#95;WITH&#95;STAT&#95;AND&#95;DATA&#39; = 10, &#39;GET&#95;CHILDREN&#95;RECURSIVE&#39; = 11))](/fr/sql-reference/data-types/array)) — Feature flags activés. S’applique uniquement à ClickHouse Keeper.
* `availability_zone` ([String](/fr/sql-reference/data-types/string)) — Zone de disponibilité
* `reason` ([LowCardinality(String)](/fr/sql-reference/data-types/lowcardinality)) — Motif de la connexion ou de la déconnexion.
