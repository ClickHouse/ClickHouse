...
Module Python destiné à faciliter l’analyse des sauvegardes effectuées par la commande [BACKUP](/fr/operations/backup/overview).
L’objectif principal était de permettre d’obtenir certaines informations d’une sauvegarde sans avoir à la restaurer effectivement.

Ce module fournit des fonctions pour

* répertorier les fichiers contenus dans une sauvegarde
...
Pour plus d’exemples, consultez le [test](https://github.com/ClickHouse/ClickHouse/blob/master/utils/backupview/test/test.py).