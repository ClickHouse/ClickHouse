...
Si votre service ne peut pas utiliser le DNS privé géré par PrivateLink (par exemple, si le provider exige
que les consumers gèrent la résolution DNS, comme le fait Confluent Cloud), consultez [DNS privé personnalisé](#custom-private-dns).
