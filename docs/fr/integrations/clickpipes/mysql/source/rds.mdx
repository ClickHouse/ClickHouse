...
Consultez [AWS IAM DB authentication (RDS/Aurora)](/fr/integrations/clickpipes/postgres/auth) pour obtenir la procédure complète de configuration du rôle IAM et de la policy requis afin que ClickPipes puisse s’authentifier de cette manière.
