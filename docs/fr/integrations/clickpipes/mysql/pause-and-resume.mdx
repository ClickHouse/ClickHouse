...
<div id="resume-clickpipe-steps">
  ## Étapes pour relancer un MySQL ClickPipe
</div>

1. Dans l&#39;onglet Sources de données, cliquez sur le MySQL ClickPipe que vous souhaitez relancer. Le mirror doit d&#39;abord avoir le statut **En pause**.
