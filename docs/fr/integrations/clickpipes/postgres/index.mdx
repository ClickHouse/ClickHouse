...
8. En outre, vous pouvez fournir une expression `PARTITION BY <expr>` personnalisée pour contrôler le [partitionnement des tables ClickHouse](/fr/concepts/core-concepts/partitions) dans la destination.
