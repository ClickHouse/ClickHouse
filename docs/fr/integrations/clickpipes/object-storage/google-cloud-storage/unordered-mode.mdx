...
<Steps>
  ...
  <Step>
    ...
    **2.** Activez **Continuous ingestion**, puis sélectionnez **Any order** comme mode d’ingestion et indiquez le nom de l’**abonnement Pub/Sub** correspondant à l’abonnement connecté à votre bucket. Le nom de l’abonnement doit respecter le format suivant :
