...
slug: /fr/integrations/clickpipes/kinesis/overview
...
<div id="supported-data-formats">
  ## Formats de données pris en charge {#supported-data-formats}
</div>
...
<div id="standard-types-support">
  ### Prise en charge des types standard {#standard-types-support}
</div>
...
<div id="variant-type-support">
  ### Prise en charge des types Variant {#variant-type-support}
</div>
...
<div id="json-type-support">
  ### Prise en charge du type JSON {#json-type-support}
</div>
...
<div id="kinesis-virtual-columns">
  ## Colonnes virtuelles Kinesis {#kinesis-virtual-columns}
</div>
