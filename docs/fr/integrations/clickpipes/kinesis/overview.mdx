...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_kinesis.webp" alt="Renseigner les détails de connexion" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_kinesis.webp" alt="Définir le format de données et le topic" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_success.webp" alt="Avis de réussite" size="sm" border />

<Image img="/images/integrations/data-ingestion/clickpipes/cp_remove.webp" alt="Avis de suppression" size="lg" border />
