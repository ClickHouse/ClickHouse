...
| **http&#95;agent**?: http.Agent | https.Agent <br /><Badge color="green" icon="flask">Expérimental</Badge>   | Agent HTTP personnalisé pour le client.                                          | -                 | [Documentation sur l’agent HTTP](/fr/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only)                                     |
| **set&#95;basic&#95;auth&#95;header**?: boolean <br /><Badge color="green" icon="flask">Expérimental</Badge> | Ajoute l’en-tête `Authorization` avec des identifiants d’authentification Basic. | `true`            | [utilisation de ce paramètre dans la documentation sur l’agent HTTP](/fr/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only) |
