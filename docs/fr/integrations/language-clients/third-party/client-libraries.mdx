---
description: 'Vue d’ensemble des bibliothèques clientes tierces disponibles pour différents langages
  de programmation'
sidebarTitle: 'Bibliothèques clientes'
slug: /interfaces/third-party/client-libraries
title: 'Bibliothèques clientes développées par des tiers'
doc_type: 'reference'
---

<Note>
  ClickHouse Inc **n’assure pas** la maintenance des bibliothèques listées ci-dessous et n’a pas effectué de tests approfondis pour en garantir la qualité.
</Note>
...
* [extension PHP ClickHouse de kolya7k](https://github.com//kolya7k/clickhouse-php)
...
* [Driver ClickHouse pour le framework userver](https://userver.tech/docs/v1.0/dd/ddb/clickhouse_driver.html)
