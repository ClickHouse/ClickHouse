...
| `show_clickhouse_errors`   | bool ou None                    | `True`                                                         | Inclut les détails des erreurs du serveur et les noms symboliques des exceptions dans les exceptions du client.                                                                                                          |
...
Le module `clickhouse_connect.dbapi` implémente l&#39;interface de connexion et de curseur définie par la PEP 249. Il déclare un niveau d&#39;API de 2.0, `threadsafety=2` et `paramstyle="pyformat"`.
