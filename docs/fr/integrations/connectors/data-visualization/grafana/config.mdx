...
slug: /fr/integrations/connectors/data-visualization/grafana/config
...
<div id="column-aliases">
  ### Alias de colonnes {#column-aliases}
</div>
...
<div id="table-defined-alias-columns">
  #### Colonnes ALIAS définies au niveau de la table {#table-defined-alias-columns}
</div>
