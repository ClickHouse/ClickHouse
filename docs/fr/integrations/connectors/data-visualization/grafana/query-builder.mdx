...
slug: /fr/integrations/connectors/data-visualization/grafana/query-builder
...
<div id="how-to-make-a-data-link">
  ### Comment créer un lien de données {#how-to-make-a-data-link}
</div>
...
<div id="using-macros">
  ### Utilisation des macros {#using-macros}
</div>
...
<div id="list-of-macros">
  ### Liste des macros {#list-of-macros}
</div>
