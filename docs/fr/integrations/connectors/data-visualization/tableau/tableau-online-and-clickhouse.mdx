...
<Image size="md" img="/images/integrations/data-visualization/tableau_online_03.webp" alt="Écran de configuration de la connexion MySQL de Tableau Online avec les champs server, port, database et d'identifiants" border />
