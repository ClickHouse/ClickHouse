...
Sélectionnez d’abord ClickHouse comme type de connexion et renseignez les informations de connexion. Cliquez ensuite sur le bouton `Test connection & Save` pour enregistrer les paramètres.
...
Sélectionnez jusqu&#39;à 9 étapes pour un funnel. Choisissez l’intervalle de temps dans lequel vos utilisateurs peuvent effectuer le funnel.
...
<Image size="lg" img="/images/integrations/data-visualization/mitzu_10.webp" alt="Tableau de bord d’analyse des revenus de Mitzu affichant des métriques MRR" border />

<div id="9-sql-native">
  ## 9. SQL natif
</div>

Mitzu est SQL natif, ce qui signifie qu’il génère du code SQL natif à partir de la configuration choisie sur la page Explore.

<Image size="lg" img="/images/integrations/data-visualization/mitzu_11.webp" alt="Vue de génération de code SQL de Mitzu montrant une requête ClickHouse native" border />
...
<Tip>
  **Poursuivez votre travail dans un outil BI**
  ...
  Si vous rencontrez une limitation dans l’UI de Mitzu, copiez le code SQL et poursuivez votre travail dans un outil BI.
</Tip>
