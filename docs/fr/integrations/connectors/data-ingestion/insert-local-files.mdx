...
Consultez la [page de documentation sur `clickhouse-client`](/fr/concepts/features/interfaces/cli) pour savoir comment installer `clickhouse-client` sur votre système d’exploitation.