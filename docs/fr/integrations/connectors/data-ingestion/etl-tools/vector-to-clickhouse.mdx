...
description: 'Comment acheminer en continu un fichier de logs vers ClickHouse avec Vector'
...
Ce guide vous montre comment utiliser le pipeline de données populaire [Vector](https://vector.dev/docs/about/what-is-vector/) pour lire en continu un fichier de log Nginx et l’envoyer vers ClickHouse.
