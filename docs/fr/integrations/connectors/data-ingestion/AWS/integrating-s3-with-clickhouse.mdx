---
slug: /fr/integrations/connectors/data-ingestion/AWS/integrating-s3-with-clickhouse
...
<div id="splitting-large-files">
  ### Fractionnement des fichiers volumineux {#splitting-large-files}
</div>
...
<div id="managing-credentials">
  ## Gestion des identifiants {#managing-credentials}
</div>
...
<div id="s3-optimizing-performance">
  ## Optimiser les performances {#s3-optimizing-performance}
</div>
...
<div id="s3-storage-tuning">
  ### Optimisation du stockage S3 {#s3-storage-tuning}
</div>
...
<div id="s3-backed-mergetree">
  ## MergeTree adossé à S3 {#s3-backed-mergetree}
</div>
...
<div id="storage-tiers">
  ### Niveaux de stockage {#storage-tiers}
</div>
...
<div id="creating-a-disk">
  ### Création d’un disque {#creating-a-disk}
</div>
...
<div id="creating-a-storage-policy">
  ### Création d’une politique de stockage {#creating-a-storage-policy}
</div>
...
<div id="modifying-a-table">
  ### Modification d’une table {#modifying-a-table}
</div>
...
<div id="handling-replication">
  ### Gestion de la réplication {#handling-replication}
</div>
...
<div id="configuring-s3-for-clickhouse-use">
  ## Utiliser le stockage objet S3 comme disque ClickHouse {#configuring-s3-for-clickhouse-use}
</div>
...
<div id="configure-clickhouse-to-use-the-s3-bucket-as-a-disk">
  ### Configurer ClickHouse pour utiliser le bucket S3 comme disque {#configure-clickhouse-to-use-the-s3-bucket-as-a-disk}
</div>
...
<div id="s3-multi-region">
  ## Répliquer un seul shard sur deux régions AWS à l’aide du stockage objet S3 {#s3-multi-region}
</div>
...
<div id="plan-the-deployment">
  ### Planifier le déploiement {#plan-the-deployment}
</div>
...
<div id="install-software">
  ### Installer les logiciels {#install-software}
</div>

<div id="clickhouse-server-nodes">
  #### Nœuds du serveur ClickHouse {#clickhouse-server-nodes}
</div>
...
<div id="deploy-clickhouse">
  #### Déployer ClickHouse {#deploy-clickhouse}
</div>
...
<div id="deploy-clickhouse-keeper">
  #### Déployer ClickHouse Keeper {#deploy-clickhouse-keeper}
</div>
...
<div id="create-s3-buckets">
  ### Créer des buckets S3 {#create-s3-buckets}
</div>
...
<div id="configure-clickhouse-keeper">
  ### Configurer ClickHouse Keeper {#configure-clickhouse-keeper}
</div>
...
<div id="configure-clickhouse-server">
  ### Configurer le serveur ClickHouse {#configure-clickhouse-server}
</div>

<div id="define-a-cluster">
  #### Définir un cluster {#define-a-cluster}
</div>
...
<div id="disable-zero-copy-replication">
  #### Désactiver la réplication zero-copy {#disable-zero-copy-replication}
</div>
...
<div id="configure-networking">
  ### Configurer le réseau {#configure-networking}
</div>
...
<div id="start-the-servers">
  ### Démarrez les serveurs {#start-the-servers}
</div>

<div id="run-clickhouse-keeper">
  #### Démarrer ClickHouse Keeper {#run-clickhouse-keeper}
</div>
...
<div id="check-clickhouse-keeper-status">
  #### Vérifier l’état de ClickHouse Keeper {#check-clickhouse-keeper-status}
</div>
...
<div id="run-clickhouse-server">
  #### Démarrer le serveur ClickHouse {#run-clickhouse-server}
</div>
