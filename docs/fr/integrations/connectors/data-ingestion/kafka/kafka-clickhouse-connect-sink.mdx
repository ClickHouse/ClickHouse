...
À partir de la version 26.1 de CH, ce schéma est pris en charge si `allow_experimental_nullable_tuple_type=1` (voir [cette page de la documentation](/fr/reference/settings/session-settings/allow-experimental#allow_experimental_nullable_tuple_type)).
