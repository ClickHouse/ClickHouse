...
Créez une API Key, donnez-lui un nom explicite et sélectionnez les privilèges `Admin`. Cliquez sur Generate API Key.

<Image img="/images/integrations/tools/data-integration/splunk/splunk_006.webp" size="lg" alt="Console ClickHouse Cloud affichant l’interface de création d’API Key avec les privilèges Admin sélectionnés" border />

Enregistrez l’API Key et le secret dans un endroit sûr.

<Image img="/images/integrations/tools/data-integration/splunk/splunk_007.webp" size="lg" alt="Console ClickHouse Cloud affichant l’API Key générée et le secret à enregistrer" border />
