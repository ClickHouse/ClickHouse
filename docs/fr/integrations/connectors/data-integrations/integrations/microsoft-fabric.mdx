...
### Charger les données des taxis de NYC
...
<Frame>
  ![La table yellow\_tripdata et ses colonnes dans un Lakehouse Fabric](/images/integrations/tools/data-integration/microsoft-fabric/fabric-08-tutorial-lakehouse-table.webp)
</Frame>
...
<Frame>
  ![Les trois requêtes du tutoriel dans la console SQL ClickHouse intégrée](/images/integrations/tools/data-integration/microsoft-fabric/fabric-09-tutorial-sample-queries.webp)
</Frame>
...
### La vérification de l&#39;e-mail échoue à l&#39;ouverture d&#39;un élément ClickHouse
...
### Impossible de se connecter à la console ClickHouse Cloud
...
### Accès refusé lors de l&#39;ouverture d&#39;un élément Fabric
