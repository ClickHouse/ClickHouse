...
- `{N..M}` — Substitutes any number in range from N to M including both borders (similar to the [remote table function](../../query_language/table_functions/remote.md)).

**Example**

1. Suppose that we have several files in TSV format with following URIs on HDFS:
...
2. There are several ways to make table consists of all six files:
