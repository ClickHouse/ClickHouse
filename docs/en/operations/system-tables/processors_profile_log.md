...
- `input_blocks` ([UInt64](../../sql-reference/data-types/int-uint.md)) — The number blocks consumed by processor.
- `input_allocated_bytes` ([UInt64](../../sql-reference/data-types/int-uint.md)) — The number of allocated bytes consumed by processor.
- `input_blocks` ([UInt64](../../sql-reference/data-types/int-uint.md)) — The number blocks generated by processor.
- `input_allocated_bytes` ([UInt64](../../sql-reference/data-types/int-uint.md)) — The number of allocated bytes generated by processor.
- `alloc_bytes` ([UInt64](../../sql-reference/data-types/int-uint.md)) — The number of bytes allocated by processor.
- `alloc_calls` ([UInt64](../../sql-reference/data-types/int-uint.md)) — The number of allocations in processor.
- `free_bytes` ([UInt64](../../sql-reference/data-types/int-uint.md)) — The number of bytes freed by processor.
- `free_calls` ([UInt64](../../sql-reference/data-types/int-uint.md)) — The number of free in processor.
- `peak_memory_usage` ([Int64](../../sql-reference/data-types/int-uint.md)) - The peak memory usage in processor.
**Example**
