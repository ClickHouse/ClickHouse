...
- `finish_time` ([DateTime](/sql-reference/data-types/datetime)) — Date and time when the mutation command was completed. Unfinished mutations have zero finish time.
