...
- `auth_grants` ([Array(String)](/sql-reference/data-types/array)) — For each authentication method: the limit of the access rights specified in the GRANTS clause, or an empty string if the access rights are not limited.
