...
- `settings` ([Map(LowCardinality(String), String)](/sql-reference/data-types/map)) — Backup/restore-specific settings requested for this operation. Sensitive settings are not exposed.
- `engine_settings` ([Map(LowCardinality(String), String)](/sql-reference/data-types/map)) — Settings effectively used by the backup engine's reader/writer (e.g. S3 `allow_native_copy`).
<!--AUTOGENERATED_END-->
