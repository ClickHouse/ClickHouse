...
The built-in dashboards need both [metric_log](/operations/server-configuration-parameters/settings#metric_log) and [asynchronous_metric_log](/operations/server-configuration-parameters/settings#asynchronous_metric_log) settings to be enabled.
