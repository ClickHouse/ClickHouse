...
- `ordinal_position` ([UInt64](../../sql-reference/data-types/int-uint.md)) — Ordinal position of the column in the table, starting at 1.
- `column_default` ([String](../../sql-reference/data-types/string.md)) — Default expression of the column, or an empty string if none is set.
- `is_nullable` ([String](../../sql-reference/data-types/string.md)) — Whether the column type is [Nullable](../../sql-reference/data-types/nullable.md).
- `data_type` ([String](../../sql-reference/data-types/string.md)) — The column data type.
- `character_maximum_length` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt64](../../sql-reference/data-types/int-uint.md))) — Maximum length in bytes for string columns, otherwise `NULL`.
- `character_octet_length` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt64](../../sql-reference/data-types/int-uint.md))) — Maximum length in bytes for string columns, otherwise `NULL`.
- `numeric_precision` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt64](../../sql-reference/data-types/int-uint.md))) — Numeric precision for numeric columns, otherwise `NULL`.
- `numeric_precision_radix` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt64](../../sql-reference/data-types/int-uint.md))) — The base of the numeric precision (`2` for integers/floats, `10` for decimals), otherwise `NULL`.
- `numeric_scale` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt64](../../sql-reference/data-types/int-uint.md))) — Numeric scale for numeric columns, otherwise `NULL`.
- `datetime_precision` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt64](../../sql-reference/data-types/int-uint.md))) — Fractional-seconds precision for date/time columns, otherwise `NULL`.
...
- `extra` ([Nullable](../../sql-reference/data-types/nullable.md)([String](../../sql-reference/data-types/string.md))) — Additional information: `DEFAULT_GENERATED` for `DEFAULT` columns, `STORED GENERATED` for `MATERIALIZED` columns, `VIRTUAL GENERATED` for `ALIAS` columns, empty otherwise.
- `column_comment` ([String](../../sql-reference/data-types/string.md)) — The comment attached to the column.
- `column_type` ([String](../../sql-reference/data-types/string.md)) — The column data type, including full type parameters.
- `column_key` ([String](../../sql-reference/data-types/string.md)) — `PRI` if the column is part of the primary key, empty otherwise. Provided for MySQL compatibility.
- `privileges` ([String](../../sql-reference/data-types/string.md)) — The privileges the current user has on the column. Currently always empty (not yet derived from the user's grants). Provided for MySQL compatibility.
- `generation_expression` ([String](../../sql-reference/data-types/string.md)) — For `MATERIALIZED` and `ALIAS` columns, the defining expression; empty otherwise. Provided for MySQL compatibility.
- `srs_id` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt32](../../sql-reference/data-types/int-uint.md))) — Always `NULL`. Provided for MySQL compatibility.
<!--AUTOGENERATED_END-->
...
- `character_set_name` ([Nullable](../../sql-reference/data-types/nullable.md)([String](../../sql-reference/data-types/string.md))) — The associated character set (`utf8mb4` for `utf8mb4_0900_ai_ci`, `binary` for `binary`, otherwise `NULL`). Provided for MySQL compatibility.
- `id` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt64](../../sql-reference/data-types/int-uint.md))) — The MySQL collation id (`255` for `utf8mb4_0900_ai_ci`, `63` for `binary`, otherwise `NULL`). Provided for MySQL compatibility.
- `is_default` ([Nullable](../../sql-reference/data-types/nullable.md)([String](../../sql-reference/data-types/string.md))) — Whether the collation is the default of its character set (`Yes` for both MySQL-compatibility rows, otherwise `NULL`). Provided for MySQL compatibility.
- `is_compiled` ([Nullable](../../sql-reference/data-types/nullable.md)([String](../../sql-reference/data-types/string.md))) — Whether the collation is compiled into the server (`Yes` for both MySQL-compatibility rows, otherwise `NULL`). Provided for MySQL compatibility.
- `sortlen` ([Nullable](../../sql-reference/data-types/nullable.md)([UInt64](../../sql-reference/data-types/int-uint.md))) — The minimum sort length (`0` for `utf8mb4_0900_ai_ci`, `1` for `binary`, otherwise `NULL`). Provided for MySQL compatibility.
- `pad_attribute` ([Nullable](../../sql-reference/data-types/nullable.md)([String](../../sql-reference/data-types/string.md))) — The pad attribute, `NO PAD` or `PAD SPACE` (`NO PAD` for both MySQL-compatibility rows, otherwise `NULL`). Provided for MySQL compatibility.
