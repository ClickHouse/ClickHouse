...
<!--AUTOGENERATED_START-->
- `metric` ([String](/sql-reference/data-types/string)) — Metric name.
- `value` ([Int64](/sql-reference/data-types/int-uint)) — Metric value.
- `description` ([String](/sql-reference/data-types/string)) — Metric description.
- `labels` ([Map(String, String)](/sql-reference/data-types/map)) — Metric labels.
<!--AUTOGENERATED_END-->
