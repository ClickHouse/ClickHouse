...
<!--AUTOGENERATED_START-->
- `key_hash` ([UInt128](/sql-reference/data-types/int-uint)) — Hash of (`table_uuid`, `part_name`, `condition_hash`).
- `table_uuid` ([UUID](/sql-reference/data-types/uuid)) — The table UUID.
- `part_name` ([String](/sql-reference/data-types/string)) — The part name.
- `condition` ([String](/sql-reference/data-types/string)) — The hashed filter condition.
- `condition_hash` ([UInt64](/sql-reference/data-types/int-uint)) — The hash of the filter condition.
- `entry_size` ([UInt64](/sql-reference/data-types/int-uint)) — The size of the entry in bytes.
- `matching_marks` ([String](/sql-reference/data-types/string)) — Matching marks.
<!--AUTOGENERATED_END-->
