...
<!--AUTOGENERATED_START-->
- `thread_name` ([String](/sql-reference/data-types/string)) — The name of the thread.
- `thread_id` ([UInt64](/sql-reference/data-types/int-uint)) — The thread identifier
- `query_id` ([String](/sql-reference/data-types/string)) — The ID of the query this thread belongs to.
- `trace` ([Array(UInt64)](/sql-reference/data-types/array)) — The stacktrace of this thread. Basically just an array of absolute (runtime) virtual addresses, in the same representation that `addressToSymbol` and `addressToLine` expect. Reading this column requires the `INTROSPECTION` privilege, because runtime addresses disclose the load bases of the process.
- `untracked_memory` ([Int64](/sql-reference/data-types/int-uint)) — Per-thread atomic-less counter of memory allocations not yet propagated to the parent MemoryTracker. May be negative if more was freed than allocated since the last flush.
<!--AUTOGENERATED_END-->
