...
- `skip_indices` ([Array](../../sql-reference/data-types/array.md)([String](../../sql-reference/data-types/string.md))) — Names of any data skipping indices that were used during query execution
