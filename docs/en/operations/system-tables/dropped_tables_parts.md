...
- `part_storage_type` ([String](/sql-reference/data-types/string)) — The type of `DataPartStorage`. Possible values: `Packed` - all files are stored in a single file, `Full` - each file is stored separately.
