...
<!--AUTOGENERATED_START-->
- `table_engine` ([Enum8('Kafka' = 1, 'RabbitMQ' = 2)](/sql-reference/data-types/enum)) — Stream type. Possible values: 'Kafka', 'RabbitMQ'.
...
- `kafka_partition` ([UInt64](/sql-reference/data-types/int-uint)) — Kafka partition of the topic.
- `kafka_offset` ([UInt64](/sql-reference/data-types/int-uint)) — Kafka offset of the message.
- `kafka_key` ([String](/sql-reference/data-types/string)) — Kafka key of the message.
- `rabbitmq_exchange_name` ([String](/sql-reference/data-types/string)) — RabbitMQ exchange name.
- `rabbitmq_message_id` ([String](/sql-reference/data-types/string)) — RabbitMQ message id.
- `rabbitmq_message_timestamp` ([DateTime](/sql-reference/data-types/datetime)) — RabbitMQ message timestamp.
- `rabbitmq_message_redelivered` ([UInt8](/sql-reference/data-types/int-uint)) — RabbitMQ redelivered flag.
- `rabbitmq_message_delivery_tag` ([UInt64](/sql-reference/data-types/int-uint)) — RabbitMQ delivery tag.
