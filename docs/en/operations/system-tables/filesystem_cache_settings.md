...
- `expose_prometheus_usage_metrics` ([UInt8](/sql-reference/data-types/int-uint)) — Expose Prometheus gauges for filesystem cache usage by cache name and user id. Off by default. Cardinality grows with distinct cache users.
