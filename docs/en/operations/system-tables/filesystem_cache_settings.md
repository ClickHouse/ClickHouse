...
- `prometheus_cache_usage_metrics_per_user` ([UInt8](/sql-reference/data-types/int-uint)) — Expose Prometheus gauges for filesystem cache usage by cache name and user id. Off by default. Cardinality grows with distinct cache users.
