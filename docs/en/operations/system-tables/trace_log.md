...
ClickHouse creates this table when the [trace_log](https://clickhouse.tech/docs/en/operations/server-configuration-parameters/settings/#server_configuration_parameters-trace_log) server configuration section is set. Also the [query_profiler_real_time_period_ns](https://clickhouse.tech/docs/en/operations/settings/settings/#query_profiler_real_time_period_ns) and [query_profiler_cpu_time_period_ns](https://clickhouse.tech/docs/en/operations/settings/settings/#query_profiler_cpu_time_period_ns) settings should be set.
