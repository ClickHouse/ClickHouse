...
- `-m`, `--multiquery` — Instead of reading the list of queries as a TSV-formatted data, parse them directly as a script with multiple queries, separated by semicolons. Limitations: INSERT ... FORMAT queries must be single line.
