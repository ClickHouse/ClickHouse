...
| [`certificateFile`](/operations/server-configuration-parameters/settings#openSSL.certificateFile) | Path to the client/server certificate file in PEM format. You can omit it if `privateKeyFile` contains the certificate.                                                                                                                                                                                                                                                                                                                                                |                                            |
...
| [`privateKeyFile`](/operations/server-configuration-parameters/settings#openSSL.privateKeyFile) | Path to the file with the secret key of the PEM certificate. The file may contain a key and certificate at the same time.                                                                                                                                                                                                                                                                                                                                              |                                            |
...
| Field     | Description                         |
|-----------|-------------------------------------|
| [`<http>`](/operations/server-configuration-parameters/settings#proxy.<http>) | A list of one or more HTTP proxies  |
| [`<https>`](/operations/server-configuration-parameters/settings#proxy.<https>) | A list of one or more HTTPS proxies |
