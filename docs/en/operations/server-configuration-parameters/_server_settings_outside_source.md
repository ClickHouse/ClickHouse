...
| `throw_if_no_row_policies` | Sets whether reading from a table should throw an exception if the table has row policies, but none of them are for the current user | `false` |
...
<access_control_improvements>
    <throw_if_no_row_policies>true</throw_if_no_row_policies>
