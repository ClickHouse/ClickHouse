...
Enables or disables throwing an exception in the [pointInPolygon](../../sql-reference/functions/geo/geographical-coordinates.md#pointinpolygon) function, if the polygon is self-intersecting or self-tangent.
