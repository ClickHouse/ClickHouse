...
Sets the ([nice](https://en.wikipedia.org/wiki/Nice_(Unix))) priority for threads that execute queries. The OS scheduler considers this priority when choosing the next thread to run on each available CPU core.
