...
If at least as many bytes are read from one file, the [MergeTree](../../engines/table-engines/mergetree-family/mergetree.md) engine can reads parallelized, when reading from remote filesystem.
