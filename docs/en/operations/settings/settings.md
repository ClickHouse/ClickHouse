...
## distributed\_product\_mode {#distributed_product_mode}
...
## force\_primary\_key {#force_primary_key}
...
## format\_schema {#format_schema}

This parameter is useful when you are using formats that require a schema definition, such as [Cap’n Proto](https://capnproto.org/) or [Protobuf](https://developers.google.com/protocol-buffers/). The value depends on the format.

## fsync\_metadata {#fsync_metadata}
...
## input\_format\_values\_accurate\_types\_of\_literals {#settings-input_format_values_accurate_types_of_literals}
...
## input\_format\_tsv\_empty\_as\_default {#settings-input_format_tsv_empty_as_default}
...
## input\_format\_null\_as\_default {#settings-input_format_null_as_default}
...
## input\_format\_skip\_unknown\_fields {#settings-input_format_skip_unknown_fields}
...
## preferred\_block\_size\_bytes {#preferred_block_size_bytes}
...
## merge\_tree\_min\_rows\_for\_concurrent\_read {#setting-merge_tree_min_rows_for_concurrent_read}
...
## merge\_tree\_min\_bytes\_for\_concurrent\_read {#setting-merge_tree_min_bytes_for_concurrent_read}
...
## merge\_tree\_min\_bytes\_for\_seek {#setting-merge_tree_min_bytes_for_seek}
...
## merge\_tree\_coarse\_index\_granularity {#setting-merge_tree_coarse_index_granularity}
...
## merge\_tree\_max\_bytes\_to\_use\_cache {#setting-merge_tree_max_bytes_to_use_cache}
...
## min\_bytes\_to\_use\_direct\_io {#settings-min_bytes_to_use_direct_io}
...
## max\_insert\_threads {#settings-max_insert_threads}
...
## max\_compress\_block\_size {#max_compress_block_size}
...
## min\_compress\_block\_size {#min_compress_block_size}
...
## interactive\_delay {#interactive_delay}
...
## connect\_timeout, receive\_timeout, send\_timeout {#connect_timeout-receive_timeout-send_timeout}

Timeouts in seconds on the socket used for communicating with the client.

Default value: 10, 300, 300.

## cancel\_http\_readonly\_queries\_on\_client\_close {#cancel_http_readonly_queries_on_client_close}

Cancels HTTP read-only queries (e.g. SELECT) when a client closes the connection without waiting for the response.

Default value: 0

## poll\_interval {#poll_interval}

Lock in a wait loop for the specified number of seconds.

Default value: 10.

## max\_distributed\_connections {#max_distributed_connections}
...
## distributed\_connections\_pool\_size {#distributed_connections_pool_size}

The maximum number of simultaneous connections with remote servers for distributed processing of all queries to a single Distributed table. We recommend setting a value no less than the number of servers in the cluster.

Default value: 1024.

## connect\_timeout\_with\_failover\_ms {#connect_timeout_with_failover_ms}
...
## connections\_with\_failover\_max\_tries {#connections_with_failover_max_tries}
...
## replace\_running\_query {#replace_running_query}
...
## stream\_flush\_interval\_ms {#stream_flush_interval_ms}
...
## prefer\_localhost\_replica {#settings-prefer_localhost_replica}
...
## totals\_auto\_threshold {#totals_auto_threshold}
...
## min\_count\_to\_compile {#min_count_to_compile}
...
## output\_format\_csv\_crlf\_end\_of\_line {#settings-output_format_csv_crlf_end_of_line}

Use DOS/Windows-style line separator (CRLF) in CSV instead of Unix style (LF).

## output\_format\_tsv\_crlf\_end\_of\_line {#settings-output_format_tsv_crlf_end_of_line}
...
## deduplicate\_blocks\_in\_dependent\_materialized\_views {#settings-deduplicate_blocks_in_dependent_materialized_views}
...
## max\_network\_bytes {#settings-max_network_bytes}
...
## max\_network\_bandwidth {#settings-max_network_bandwidth}
...
## max\_network\_bandwidth\_for\_user {#settings-max_network_bandwidth_for_user}
...
## max\_network\_bandwidth\_for\_all\_users {#settings-max_network_bandwidth_for_all_users}
