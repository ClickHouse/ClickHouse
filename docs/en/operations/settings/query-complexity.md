...
| [`max_estimated_rows_to_read`](/operations/settings/settings#max_estimated_rows_to_read)                               | The maximum number of rows estimated to be read from a table when executing a query.                                                                             |
