...
| [`max_rows_in_join`](/operations/settings/settings#max_rows_in_join)                                                   | Limits the number of rows in the data structure (typically a hash table) that is used when joining tables.                                                                                   |
| [`max_bytes_in_join`](/operations/settings/settings#max_bytes_in_join)                                                 | The maximum size in number of bytes of the data structure (typically a hash table) used when joining tables.                                                                                 |
