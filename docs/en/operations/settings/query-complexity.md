...
| [`max_partitions_per_insert_block`](/operations/settings/settings#max_partitions_per_insert_block)                     | Limits the maximum number of partitions in a single inserted block and an excception is thrown if the block contains too many partitions.                        |
