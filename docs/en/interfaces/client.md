...
| Option                            | Description                                                                                                                                                                                                                                                                                                         | Default                                                             |
|-----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| `--chime [N]`                     | Ring the terminal bell (`BEL`) when a query finishes after running for at least `N` seconds. Only emitted when the output is a terminal (TTY). Passing `--chime` without a value uses the default threshold. Set `--chime 0` to disable.                                                                              | `5` seconds                                                         |
