...
- [input_format_parquet_min_read_batch_size_rows](/docs/en/operations/settings/settings-formats.md/#input_format_parquet_min_read_batch_size_rows) - minimum number of rows to read in one thread in Parquet format. Default value - `100000`.
- [input_format_parquet_min_read_batch_size_rows](/docs/en/operations/settings/settings-formats.md/#input_format_parquet_min_read_batch_size_rows) - minimum number of bytes (uncompressed) to read in one thread in Parquet format. Default value - `25'600'000`.
