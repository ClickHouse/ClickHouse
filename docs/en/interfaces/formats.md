...
- [input_format_csv_allow_set_column_default_value_if_no_input](/docs/en/operations/settings/settings-formats.md/# input_format_csv_allow_set_column_default_value_if_no_input) - Allow to set column default value if the column has no input in deserialization. Default value - `false`.
