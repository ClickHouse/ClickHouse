...
- [output_format_parquet_fixed_string_as_fixed_byte_array](/docs/en/operations/settings/settings.md/#output_format_parquet_fixed_string_as_fixed_byte_array) -  use Parquet FIXED_LENGTH_BYTE_ARRAY type instead of Binary/String for FixedString columns. Default value - `true`.
...
- [output_format_arrow_fixed_string_as_fixed_byte_array](/docs/en/operations/settings/settings.md/#output_format_arrow_fixed_string_as_fixed_byte_array) - use Arrow FIXED_SIZE_BINARY type instead of Binary/String for FixedString columns. Default value - `true`.
