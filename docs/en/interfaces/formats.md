...
If you don't have an external CapnProto schema for your data, you can still output/input data in CapnProto format by using autogenerated schema.
For example:
...
If you don't have an external Protobuf schema for your data, you can still output/input data in Protobuf format by using autogenerated schema.
For example:
