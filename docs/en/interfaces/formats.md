...
- [input_format_csv_empty_not_as_null_for_nullable_string_field](/docs/en/operations/settings/settings-formats.md/#input_format_csv_empty_not_as_null_for_nullable_string_field) - not treat empty as null for nullable string type field while `input_format_csv_empty_as_default` enabled. Default value - `false`.
