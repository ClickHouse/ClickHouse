...
- [input_format_csv_with_names](/docs/en/operations/settings/settings-formats.md/#input_format_csv_with_names) - get names from data file in CSV format. Default value - `false`.
- [input_format_csv_with_types](/docs/en/operations/settings/settings-formats.md/#input_format_csv_with_types) - get types from data file in CSV format. Default value - `false`.
