...
- [input_format_csv_ignore_if_input_too_many_fields](/docs/en/operations/settings/settings-formats.md/# input_format_csv_ignore_if_input_too_many_fields) - Ignore the input value while input row has too many fields than defined in CSV strings. Default value - `false`.
