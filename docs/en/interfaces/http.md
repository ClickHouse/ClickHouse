...
You can create a query with parameters and pass HTTP request parameter values to them. For more information, see [CLI Formatted Queries](cli.md#cli-queries-with-parameters).
