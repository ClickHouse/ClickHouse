...
:::note
Generic tools that support common API like [ODBC](../../integrations/interfaces/odbc.md) or [JDBC](../../integrations/interfaces/jdbc.md) usually can work with ClickHouse as well, but are not listed here because there are way too many of them.
:::