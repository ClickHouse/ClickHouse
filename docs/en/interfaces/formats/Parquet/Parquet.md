...
| [LineString](/sql-reference/data-types/geo.md#linestring), [Ring](/sql-reference/data-types/geo.md#ring) | `BYTE_ARRAY` (WKB) + GeoParquet metadata |
...
| [Geometry](/sql-reference/data-types/geo.md#geometry) | `BYTE_ARRAY` (WKB) + GeoParquet metadata |
...
* If the requested column type is `String`, the GeoParquet metadata is ignored and the raw WKB bytes are returned. This is also true if the setting [`input_format_parquet_allow_geoparquet_parser`](/operations/settings/settings-formats.md#input_format_parquet_allow_geoparquet_parser) is set to `0`.

On write, ClickHouse geo columns are encoded as `BYTE_ARRAY` (WKB) and the appropriate `geo` JSON metadata is appended to the Parquet file footer. This can be disabled by setting [`output_format_parquet_geometadata`](/operations/settings/settings-formats.md#output_format_parquet_geometadata) to `0`, in which case the columns are written as plain binary strings without GeoParquet metadata.
...
| `input_format_parquet_allow_geoparquet_parser`                                  | When reading Parquet files, recognize the GeoParquet `geo` metadata and decode WKB-encoded geometry columns as ClickHouse geo data types. If `0`, geometry columns are exposed as their raw physical (`String`) representation.                                                                                                                                              | `1`         |
...
| `output_format_parquet_geometadata`                                            | Write GeoParquet `geo` metadata into the Parquet file footer and encode ClickHouse geo columns ([`Point`](/sql-reference/data-types/geo.md#point), [`LineString`](/sql-reference/data-types/geo.md#linestring), [`Polygon`](/sql-reference/data-types/geo.md#polygon), [`MultiLineString`](/sql-reference/data-types/geo.md#multilinestring), [`MultiPolygon`](/sql-reference/data-types/geo.md#multipolygon), [`Geometry`](/sql-reference/data-types/geo.md#geometry)) as WKB. If `0`, geo columns are written as their raw physical types without GeoParquet metadata.                                                                                                                                                                          | `1`         |
