...
| [`input_format_json_read_numbers_as_strings`](/operations/settings/settings-formats.md/#input_format_json_read_numbers_as_strings)                                          | allow parsing numbers as strings in JSON input formats, including inferring out-of-range integers as `String`.                                                          | `true`   |                                                                                                                                                                                               |
