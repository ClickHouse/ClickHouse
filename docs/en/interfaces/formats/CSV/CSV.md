...
- Date, date-time, and time values are enclosed in double quotes by default. This can be disabled with the setting [output_format_csv_quote_date_time_types](/operations/settings/settings-formats.md/#output_format_csv_quote_date_time_types).
...
| [output_format_csv_quote_date_time_types](/operations/settings/settings-formats.md/#output_format_csv_quote_date_time_types)                               | if it is set to false, date and time values are written without surrounding double quotes in CSV output.            | `true`  |                                                                                                                                                                                              |
