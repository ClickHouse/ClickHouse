...
functions in ClickHouse. The example datasets include:
...
- The [New York Taxi Data](../getting-started/example-datasets/nyc-taxi.md) has an example of how to move data from PostgeSQL to ClickHouse
...
View the "Tutorials and Datasets" menu for a complete list of datasets.