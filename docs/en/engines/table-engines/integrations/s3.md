...
-   `use_sts_get_caller_identity_credentials` — If set to `true`, S3 client will try to obtain credentials from STS GetCallerIdentity request for given endpoint. Optional, default value is `false`.
...
<s3>
    <endpoint-name>
        ...
        <!-- <use_sts_get_caller_identity_credentials>false</use_sts_get_caller_identity_credentials> -->
