...
sidebar_label: NATS
title: "NATS Engine"
description: "his engine allows integrating ClickHouse with NATS to publish or subscribe to message subjects, and process new messages as they becoem available."
---
