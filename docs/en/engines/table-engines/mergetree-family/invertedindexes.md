...
It can be enabled via the setting [use_text_index_dictionary_cache](/operations/server-configuration-parameters/settings.md#use_text_index_dictionary_cache). By default, it is disabled.
