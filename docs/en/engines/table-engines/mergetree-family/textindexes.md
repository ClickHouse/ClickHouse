...
Currently, there are caches for the deserialized headers and posting lists of the text index to reduce I/O.
They can be enabled via settings [use_text_index_header_cache](/operations/settings/settings#use_text_index_header_cache), and [use_text_index_postings_cache](/operations/settings/settings#use_text_index_postings_cache).By default, all caches are disabled.
