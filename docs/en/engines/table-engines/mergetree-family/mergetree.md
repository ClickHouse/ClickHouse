...
(
    name1 [type1] [DEFAULT|MATERIALIZED|ALIAS|EPHEMERAL expr1] [COMMENT ...] [CODEC(codec1)] [TTL expr1] [[NOT] NULL|PRIMARY KEY],
    name2 [type2] [DEFAULT|MATERIALIZED|ALIAS|EPHEMERAL expr2] [COMMENT ...] [CODEC(codec2)] [TTL expr2] [[NOT] NULL|PRIMARY KEY],
    ...
