...
- [engine_file_skip_failed_data_files](/operations/settings/settings.md#engine_file_skip_failed_data_files) - allows to skip files that fail to open or read (e.g. corrupted gzip files) while reading. Disabled by default.
