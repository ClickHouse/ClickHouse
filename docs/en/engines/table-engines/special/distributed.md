...
`async_insert_batch` - same as [distributed_async_insert_batch](../../../operations/settings/settings.md#distributed_async_insert_batch)

#### async_insert_split_batch_on_failure

`async_insert_split_batch_on_failure` - same as [distributed_async_insert_split_batch_on_failure](../../../operations/settings/settings.md#distributed_async_insert_split_batch_on_failure)

#### async_insert_sleep_time_ms

`async_insert_sleep_time_ms` - same as [distributed_async_insert_sleep_time_ms](../../../operations/settings/settings.md#distributed_async_insert_sleep_time_ms)

#### async_insert_max_sleep_time_ms

`async_insert_max_sleep_time_ms` - same as [distributed_async_insert_max_sleep_time_ms](../../../operations/settings/settings.md#distributed_async_insert_max_sleep_time_ms)
