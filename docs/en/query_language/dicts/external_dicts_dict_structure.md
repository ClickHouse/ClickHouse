...
`expression` | [Expression](../syntax.md#syntax-expressions) that ClickHouse executes with the value.<br/>The expression can be a column name in the remote SQL database. Thus, you can use it to create an alias for the remote column.<br/><br/>Default value: no expression. | No
