...
- `T64` — compression approach that croppes unused most significant bits in numeric data (including Enums, Date and DateTime). Bits that are not differs between min and max value in part are cropped.
