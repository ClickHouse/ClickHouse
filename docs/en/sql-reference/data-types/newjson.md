...
The chunk size is controlled by the MergeTree setting [object_shared_data_target_chunk_rows](../../operations/settings/merge-tree-settings.md#object_shared_data_target_chunk_rows) (8192 by default).
