...
│ {"a":{"b":"42"},"c":["1","2","3"]}                             │ ['a.b','c']            │ []                        │
│ {"a":{"b":"43"},"d":"2020-01-01"}                              │ ['a.b','d']            │ []                        │
│ {"a":{"b":"44"},"c":["4","5","6"]}                             │ ['a.b','c']            │ []                        │
│ {"a":{"b":"43"},"d":"2020-01-02","e":"Hello","f":{"g":42.42}}  │ ['a.b','d']            │ ['e','f.g']               │
│ {"a":{"b":"43"},"c":["7","8","9"],"f":{"g":43.43},"h":"World"} │ ['a.b','c']            │ ['f.g','h']               │
└────────────────────────────────────────────────────────────────┴────────────────────────┴───────────────────────────┘
```
