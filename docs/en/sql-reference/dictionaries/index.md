...
You can add your own dictionaries from various data sources. The source for a dictionary can be a ClickHouse table, a local text or executable file, an HTTP(s) resource, or another DBMS. For more information, see “[Dictionary Sources](#dictionary_sources)”.
...
You can [configure](#configuring_a_dictionary) any number of dictionaries in the same file.
...
## Configuring a Dictionary {#configuring_a_dictionary}
...
All types of [sources](#dictionary_sources), except local files, are supported.
...
When updating the dictionaries, the ClickHouse server applies different logic depending on the type of [source](#dictionary_sources):
...
- `invalidate_query` – Query for checking the dictionary status. Optional parameter. Read more in the section [Refreshing dictionary data using LIFETIME](#lifetime).
...
| <a name="hierarchical-dict-attr"></a> `hierarchical` | If `true`, the attribute contains the value of a parent key for the current key. See [Hierarchical Dictionaries](#hierarchical_dictionaries).<br/><br/>Default value: `false`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | No       |
...
## Hierarchical Dictionaries {#hierarchical_dictionaries}
