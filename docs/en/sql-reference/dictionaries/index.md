...
-   [Plug-in (external) dictionaries](external-dictionaries/external-dicts.md#external-dicts) with a [net of functions](../../sql-reference/functions/ext-dict-functions.md).
