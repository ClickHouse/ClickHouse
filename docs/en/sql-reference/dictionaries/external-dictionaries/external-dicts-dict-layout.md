...
- [Storing Dictionaries in Memory](#storing-dictionaries-in-memory)
  - [Ways to Store Dictionaries in Memory](#ways-to-store-dictionaries-in-memory)
    - [flat](#flat)
    - [hashed](#hashed)
    - [sparse\_hashed](#sparse_hashed)
    - [complex\_key\_hashed](#complex_key_hashed)
    - [complex\_key\_sparse\_hashed](#complex_key_sparse_hashed)
    - [hashed\_array](#hashed_array)
    - [complex\_key\_hashed\_array](#complex_key_hashed_array)
    - [range\_hashed](#range_hashed)
    - [complex\_key\_range\_hashed](#complex_key_range_hashed)
    - [cache](#cache)
    - [complex\_key\_cache](#complex_key_cache)
    - [ssd\_cache](#ssd_cache)
    - [complex\_key\_ssd\_cache](#complex_key_ssd_cache)
    - [direct](#direct)
    - [complex\_key\_direct](#complex_key_direct)
    - [ip\_trie](#ip_trie)
