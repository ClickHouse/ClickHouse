...
- `SETTINGS`: (Optional) Allows additional settings.
  - (Optional): [check_query_single_value_result](../../operations/settings/settings#check_query_single_value_result): This setting allows you to toggle between a detailed result (`0`) or a summarized result (`1`).
