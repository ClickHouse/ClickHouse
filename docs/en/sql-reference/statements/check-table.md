...
- `SETTINGS`: (Optional) Allows additional settings.
  - (Optional): [check_query_single_value_result](../../operations/settings/settings#check_query_single_value_result): This setting controls if the output is detailed (`0`) or a summarized (`1`).
