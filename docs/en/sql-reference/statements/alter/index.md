...
[ALTER TABLE ... MODIFY ENGINE](/docs/en/sql-reference/statements/alter/engine.md) statement allows to convert MergeTree table to ReplicatedMergeTree and vice versa.
