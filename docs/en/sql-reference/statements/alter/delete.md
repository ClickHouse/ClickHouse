...
Deletes data matching the specified filtering expression. Implemented as a [mutation](/docs/en/sql-reference/statements/alter/overview.md/#mutations).
...
-   [Synchronicity of ALTER Queries](/docs/en/sql-reference/statements/alter/overview.md/#synchronicity-of-alter-queries)
