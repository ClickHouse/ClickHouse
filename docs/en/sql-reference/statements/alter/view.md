...
If a materialized view uses the `TO [db.]name` construction, you must `DETACH` the view, run [ALTER TABLE](index.md) query for the target table, and then `ATTACH` the previously detached (`DETACH`) view.
