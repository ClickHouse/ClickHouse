...
Allows you to limit the access rights available to a session authenticated with a particular authentication method. See the [GRANTS clause of CREATE USER](../../../sql-reference/statements/create/user.md#grants-clause) for details.
