...
| [`RENAME`](./rename_modifier.md)   | Specifies one or more output column names to change after a `SELECT *` or `COLUMNS` expression is expanded. This modifier does not change column values, column types, or column order.                                                                                                                                                                                                  |
