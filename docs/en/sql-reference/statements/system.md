...
Reloads all registered [executable user defined functions](/docs/en/sql-reference/functions/#executable-user-defined-functions) or one of them from a configuration file.
