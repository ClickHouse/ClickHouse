...
The result of the profiling is stored in [`system.trace_log`](/operations/system-tables/trace_log) and can be converted
to [Chrome Event Trace Format](/operations/system-tables/trace_log#chrome-event-trace-format).
