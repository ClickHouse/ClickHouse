...
Creates new [roles](/sql-reference/statements/create/role). Role is a set of [privileges](/sql-reference/statements/grant#granting-privilege-syntax). A [user](../../../sql-reference/statements/create/user.md) assigned a role gets all the privileges of this role.
