...
If `DEFINER`/`SQL SECURITY` aren't specified, the result depends on the [`ignore_empty_sql_security_in_create_view_query`](../../../operations/server-configuration-parameters/settings.md#ignore_empty_sql_security_in_create_view_query) server setting.
