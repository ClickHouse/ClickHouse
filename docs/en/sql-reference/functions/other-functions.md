...
## getMacro {#other_functions-getMacro}
...
## blockSize() {#other_functions-blockSize}
...
## currentUser() {#other_functions-currentUser}
...
## rowNumberInBlock() {#other_functions-rowNumberInBlock}
...
## queryID {#other_functions-queryID}
