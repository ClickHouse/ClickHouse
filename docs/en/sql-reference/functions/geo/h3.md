...
## h3PolygonToCellsExperimental {#h3polygontocellsexperimental}
...
``` sql
h3PolygonToCellsExperimental(geometry, resolution, flags)
```
...
- `geometry` can be one of the following [Geo Data Types](../../data-types/geo.md) or their underlying primitive types:
  ...
  - [MultiPolygon](../../data-types/geo.md#multipolygon)
- `resolution` — Index resolution. Range: `[0, 15]`. [UInt8](../../data-types/int-uint.md).
- `flags` — Containment mode. Range: `[0, 3]`. Values are internally converted to [UInt32](../../data-types/int-uint.md), so integer literals like `0`, `1`, `2`, and `3` are accepted directly.
...
``` sql
SELECT
    h3PolygonToCellsExperimental([(-122.40898669999721, 37.81331899998324), (-122.35447369999936, 37.71980619999785), (-122.4798767000009, 37.815157199999845)], 7, 0) AS center_cells,
    h3PolygonToCellsExperimental([(-122.40898669999721, 37.81331899998324), (-122.35447369999936, 37.71980619999785), (-122.4798767000009, 37.815157199999845)], 7, 2) AS overlap_cells;
```
