...
* `enable_extended_results_for_datetime_functions = 1`:
  ...
  * Functions `toStartOfDay`, `toStartOfHour`, `toStartOfMinute`, `toStartOfFiveMinutes`, `toStartOfTenMinutes`, `toStartOfFifteenMinutes`, `timeSlot` return `DateTime` if their argument is a `Date` or `DateTime`, and they return `DateTime64` if their argument is a `Date32` or `DateTime64`.
:::
