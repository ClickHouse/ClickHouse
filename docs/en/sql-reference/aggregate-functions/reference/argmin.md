...
### argMinIf
Returns the argument value corresponding to the minimum value only for rows that match the given condition.

### argMinArray
Returns the argument value corresponding to the minimum value among elements in the array.

### argMinMap
Returns the argument value corresponding to the minimum value for each key in the map separately.

### argMinSimpleState
Returns the argument value corresponding to the minimum with SimpleAggregateFunction type.

### argMinState
Returns the intermediate state of argMin calculation.

### argMinMerge
Combines intermediate states to get the final argument value corresponding to the minimum.

### argMinMergeState
Combines intermediate states but returns an intermediate state.

### argMinForEach
Returns argument values corresponding to minimums for corresponding elements in multiple arrays.

### argMinDistinct
Returns the argument value corresponding to the minimum among distinct values only.

### argMinOrDefault
Returns the default value for the argument type if there are no rows.
