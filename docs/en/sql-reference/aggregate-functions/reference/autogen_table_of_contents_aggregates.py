...
"""
This script is used to automatically generate a table of contents from the aggregate functions markdown files.
The table of contents is used in index.md.

It is only necessary to run this script if a new aggregate function .md file has been added to the /reference
directory.
"""
