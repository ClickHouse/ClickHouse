...
See also table function [timeSeriesSelectorToGrid()](./timeSeriesSelectorToGrid.md).

## Syntax {#syntax}

```sql
timeSeriesSelector('db_name', 'time_series_table', 'instant_selector', min_time, max_time)
timeSeriesSelector(db_name.time_series_table, 'instant_selector', min_time, max_time)
timeSeriesSelector('time_series_table', 'instant_selector', min_time, max_time)
```
