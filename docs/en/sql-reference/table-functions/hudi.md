...
Provides a read-only table-like interface to Apache [Hudi](https://github.com/delta-io/delta) tables in Amazon S3.
...
- [Hudi engine](/docs/en/engines/table-engines/integrations/deltalake.md)
