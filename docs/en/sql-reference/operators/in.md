...
If a table doesn't have a sampling key, more flexible options for [parallel_replicas_custom_key](#settings_parallel_replicas_custom_key) can be used that can produce different and more optimal behaviour.
