...
`rawdata_dir` means it will store raw data generated by dbgen.
...
The files expected to output `./rawdata_dir`:
``` text
customer.tbl
part.tbl
supplier.tbl
...
- Inserting data. Here should use ./rawdata_dir/*.tbl as input data.
