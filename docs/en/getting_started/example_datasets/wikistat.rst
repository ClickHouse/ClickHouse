...
.. code-block:: bash
    ...
    for i in {2007..2016}; do for j in {01..12}; do echo $i-$j >&2; curl -sSL "https://dumps.wikimedia.org/other/pagecounts-raw/$i/$i-$j/" | grep -oE 'pagecounts-[0-9]+-[0-9]+\.gz'; done; done | sort | uniq | tee links.txt
