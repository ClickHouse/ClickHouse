...
description: 'Настройка коннектора ClickHouse: экземпляры ClickHouse, списки разрешённых операторов, сетевые политики, маскирование, частные зеркала и хранилище'
