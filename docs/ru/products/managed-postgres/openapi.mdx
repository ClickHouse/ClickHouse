...
[ClickHouse OpenAPI]: /ru/products/cloud/features/admin-features/api/api-overview "Cloud API"
...
[Prometheus endpoint]: /ru/products/managed-postgres/monitoring/prometheus "Конечная точка Prometheus для ClickHouse Managed Postgres"

[metrics reference]: /ru/products/managed-postgres/monitoring/metrics "Справочник метрик ClickHouse Managed Postgres"

[Query Insights]: /ru/products/managed-postgres/monitoring/query-insights "Query Insights для Postgres"

[detail flyout]: /ru/products/managed-postgres/monitoring/query-insights#detail "Выдвижная панель сведений Query Insights"

[счётчики по каждому выполнению]: /ru/products/managed-postgres/monitoring/query-insights#counters "Счётчики Query Insights по каждому выполнению"
