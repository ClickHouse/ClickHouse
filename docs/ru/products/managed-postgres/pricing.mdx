...
<div id="beta-pricing-highlights">
  ## Основные моменты бета-цен {#beta-pricing-highlights}
</div>

<div id="aws-public-beta-pricing">
  ### Цены в период Public Beta на AWS {#aws-public-beta-pricing}
</div>
...
### Стоимость в закрытой предварительной версии на GCP {#gcp-private-preview-pricing}
