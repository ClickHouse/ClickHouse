...
<Visibility for="humans">
  <View title="Интерфейс Cloud">
    ...
    * **ClickHouse** для аналитики по миллиардам строк за доли секунды
    ...
    <Image img="/images/managed-postgres/integration-landing.webp" alt="Интеграция ClickHouse Managed Postgres пуста" size="md" border />
    ...
    <Image img="/images/managed-postgres/postgres-analytics-form.webp" alt="Форма интеграции ClickHouse в Managed Postgres" size="md" border />
