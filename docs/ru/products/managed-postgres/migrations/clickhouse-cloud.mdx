...
title: Миграция в ClickHouse Managed Postgres с помощью ClickHouse Cloud
...
ClickHouse Cloud включает встроенный мастер импорта, который переносит вашу внешнюю базу данных PostgreSQL в сервис ClickHouse Managed Postgres. Этот мастер выполняет подключение к источнику, экспорт и импорт схемы, настройку репликации и выбор таблиц в рамках пяти пошаговых этапов.
...
<Steps>
  ...
  <Step title="Импортируйте схему в сервис ClickHouse Managed Postgres" id="step-3-import-schema">
  ...
  <Step title="Выберите таблицы" id="step-5-select-tables">
    ...
    <Image img="/images/managed-postgres/pgpg/tablepicker.webp" alt="Шаг 5: выбор таблиц, сгруппированных по схеме, с кнопкой создать миграцию" size="lg" border />
...
**Переведите трафик приложения.** Направьте операции чтения и записи на ваш сервис ClickHouse Managed Postgres и отслеживайте ошибки, нарушения ограничений и состояние репликации.
...
* [Быстрый старт по ClickHouse Managed Postgres](/ru/products/managed-postgres/quickstart)
