...
<Note>
  Если во время миграции возникнут проблемы, ознакомьтесь с [FAQ по миграциям Managed Postgres](/ru/cloud/managed-postgres/migrations/faq), где описаны распространённые ошибки и способы их устранения.
</Note>
