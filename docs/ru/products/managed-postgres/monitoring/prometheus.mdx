...
[cloud-api]: /ru/products/cloud/features/admin-features/api/api-overview "Cloud API"

[API keys]: /ru/products/cloud/features/admin-features/api/openapi "Управление ключами API"