---
position: 2
slug: /ru/products/kubernetes-operator/guides/configuration
...
<div id="pod-configuration">
  ## Настройка пода {#pod-configuration}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencepodtemplatespec-for-all-supported-pod-template-options">
  ### Все поддерживаемые параметры шаблона пода см. в [справочнике по API](/ru/products/kubernetes-operator/reference/api-reference#podtemplatespec). {#see-api-reference-for-all-supported-pod-template-options}
</div>

<div id="pod-disruption-budgets">
  ## Бюджеты сбоев подов {#pod-disruption-budgets}
</div>
...
<div id="pdb-defaults">
  ### Значения по умолчанию {#pdb-defaults}
</div>
...
<div id="pdb-overrides">
  ### Переопределение значений по умолчанию {#pdb-overrides}
</div>
...
<div id="pdb-cluster-wide-disable">
  ### Отключение на уровне всего кластера {#pdb-cluster-wide-disable}
</div>
...
<div id="container-configuration">
  ## Настройка контейнера {#container-configuration}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencecontainertemplatespec-for-all-supported-container-template-options">
  ### Все поддерживаемые параметры шаблона контейнера см. в [справочнике по API](/ru/products/kubernetes-operator/reference/api-reference#containertemplatespec). {#see-api-reference-for-all-supported-container-template-options}
</div>

<div id="tls-ssl-configuration">
  ## Конфигурация TLS/SSL {#tls-ssl-configuration}
</div>
...
<div id="ssl-certificate-secret-format">
  ### Формат Secret с SSL-сертификатом {#ssl-certificate-secret-format}
</div>
...
<div id="clickhouse-keeper-communication-over-tls">
  ### Взаимодействие ClickHouse-Keeper по TLS {#clickhouse-keeper-communication-over-tls}
</div>
...
<div id="external-secret-required-keys">
  ### Обязательные ключи {#external-secret-required-keys}
</div>
...
<div id="external-secret-policy">
  ### Политика: Observe или Manage {#external-secret-policy}
</div>
...
<div id="external-secret-status">
  ### Условие состояния и устранение неполадок {#external-secret-status}
</div>
...
<div id="additional-ports-mysql-example">
  ### Полный пример: протокол MySQL {#additional-ports-mysql-example}
</div>
...
<div id="additional-ports-constraints">
  ### Ограничения для полей {#additional-ports-constraints}
</div>
...
<div id="additional-ports-reserved">
  ### Зарезервированные порты и имена {#additional-ports-reserved}
</div>
...
<div id="version-probe-and-upgrade-channel">
  ## Проверка версии и канал обновления {#version-probe-and-upgrade-channel}
</div>
...
<div id="upgrade-channel-choosing">
  ### Выбор канала обновления {#upgrade-channel-choosing}
</div>
...
<div id="version-status-conditions">
  ### Условия {#version-status-conditions}
</div>
...
<div id="version-probe-template">
  ### Переопределение задачи проверки версии {#version-probe-template}
</div>
...
<div id="version-operator-flags">
  ### Глобальные настройки оператора {#version-operator-flags}
</div>
...
<div id="default-user-password">
  ### Пароль пользователя `default` {#default-user-password}
</div>
...
<div id="default-password-secret-example">
  #### Полный пример с объектом Secret {#default-password-secret-example}
</div>
...
<div id="using-configmap-for-user-passwords">
  #### Использование ConfigMap {#using-configmap-for-user-passwords}
</div>
...
<div id="server-logging">
  ### Логирование сервера {#server-logging}
</div>
...
<div id="see-documentationconceptsfeaturesconfigurationsettingssettings-users-for-all-supported-clickhouse-users-configuration-options">
  #### См. [документацию](/ru/concepts/features/configuration/settings/settings-users) с полным перечнем поддерживаемых параметров конфигурации пользователей ClickHouse. {#see-documentation-for-all-supported-clickhouse-users-configuration-options}
</div>
