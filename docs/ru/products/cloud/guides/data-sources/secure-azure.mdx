...
<Steps>
  <Step title="Найдите исходящие IP-адреса ClickHouse Cloud" id="find-egress-ips">
  ...
  <Step title="Настройте брандмауэр хранилища Azure" id="configure-firewall">
    ...
    Подробнее см. в [документации по настройке брандмауэра Azure Storage](https://learn.microsoft.com/en-us/azure/storage/common/storage-network-security?tabs=azure-portal).
  </Step>
</Steps>
...
<Note>
  ...
  Если вы используете правила брандмауэра на основе IP-адресов, эти адреса необходимо добавить в список разрешённых.

  См. [&quot;Список статических IP-адресов&quot;](/ru/integrations/clickpipes/networking/static-ips)
</Note>
