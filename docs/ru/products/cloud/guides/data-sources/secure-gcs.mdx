...
<Steps>
  <Step title="Создайте сервисный аккаунт Google Cloud" id="create-gcs-account">
  ...
  <Step title="Предоставьте сервисному аккаунту доступ к бакету" id="grant-bucket-access-to-service-account">
  ...
  <Step title="Сгенерируйте HMAC-ключи для сервисного аккаунта" id="generate-hmac-keys-for-service-account">
