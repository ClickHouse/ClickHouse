...
Обратите внимание, что число сервисов в хранилище отдельно не ограничивается, но суммарное количество реплик по всем сервисам хранилища ограничено. См. [Ограничения использования](/ru/cloud/bestpractices/usage-limits) и [масштабирование хранилища](/ru/products/cloud/features/infrastructure/warehouses#scaling).
