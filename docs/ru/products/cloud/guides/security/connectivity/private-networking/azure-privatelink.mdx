...
<Image img="/images/cloud/security/azure-private-link-center.webp" size="lg" alt="Открытие Azure Private Center" border />
...
<Image img="/images/cloud/security/azure-pe-create-basic.webp" size="md" alt="Создание частной конечной точки: Basic" border />
...
<Image img="/images/cloud/security/azure-pe-resource.webp" size="md" alt="Выбор ресурса для частной конечной точки" border />
...
<Image img="/images/cloud/security/azure-pe-ip.webp" size="lg" alt="IPv4-адрес частной конечной точки" border />
