...
Пользователи ClickHouse OSS, которым нужно маскировать именно данные в журналах, могут использовать [правила маскирования запросов](/ru/reference/settings/server-settings/settings/query#query_masking_rules) (маскирование журналов).
