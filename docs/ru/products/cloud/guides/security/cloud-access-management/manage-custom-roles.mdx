...
## Управление ролями базы данных (бета) {#manage-database-roles}
...
### Предварительные требования {#manage-database-roles-prerequisites}
...
### Проверка ролей базы данных {#verify-database-roles}
