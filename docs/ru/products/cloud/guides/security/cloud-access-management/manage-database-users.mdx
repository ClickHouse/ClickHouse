...
<div id="sql-console-passwordless-authentication">
  ### Беспарольная аутентификация в консоли SQL {#sql-console-passwordless-authentication}
</div>
...
Базовые роли консоли SQL можно назначать пользователям с разрешениями Service Read Only и Service Admin. Подробнее см. в разделе [Управление пользователями Cloud](/ru/products/cloud/guides/security/cloud-access-management/manage-cloud-users#manage-role-assignments). В этом руководстве показано, как создать пользовательскую роль для пользователя консоли SQL.

<Tip>
  Предпочтительно используйте [роли базы данных, управляемые Cloud](/ru/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles) для управления доступом к базе данных из консоли. Роли `sql-console-role:<email>` несовместимы с JWT-сеансами в консоли SQL.
</Tip>
...
<Steps>
  <Step title={<>Создайте <code>database_developer</code> и выдайте разрешения</>} id="create-role-grant-permissions">
  ...
  <Step title="Создайте роль пользователя консоли SQL" id="create-sql-console-user-role">
  ...
  <Step title="При использовании консоли SQL пользователю назначается новая роль" id="use-assigned-new-role">
...
<div id="database-ssh">
  ### Пользователь базы данных с SSH-аутентификацией {#database-ssh}
</div>
...
## Разрешения на уровне базы данных {#database-permissions}
...
### Списки доступа к базе данных для пользователей консоли SQL {#database-access-listings-with-sql-console-users}

Следующий процесс можно использовать, чтобы получить полный список доступа в консоли SQL и базах данных вашей организации.

<Steps>
  <Step title="Получите список всех привилегий в базе данных" id="get-a-list-of-all-database-grants">
  ...
  <Step title="Сопоставьте список привилегий с пользователями консоли, у которых есть доступ к консоли SQL" id="associate-grant-list-to-console-users-with-access-to-sql-console">
...
Пользователи хранилища общие для всех сервисов в рамках одного хранилища. Подробнее см. в разделе [управление доступом к хранилищу](/ru/products/cloud/features/infrastructure/warehouses#access-controls).