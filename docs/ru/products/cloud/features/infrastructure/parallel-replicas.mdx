...
## Архитектура с сегментированием {#sharded-architecture}
...
## Архитектура без сегментирования {#non-sharded-architecture}
...
для получения дополнительной информации). Благодаря разделению вычислительных ресурсов и хранилища, а также практически
...
<ol className="docs-ordered-list">
  ...
  <li>
    Нужно как-то учитывать хвостовую задержку на отдельных репликах.
  </li>
...
<ol className="docs-ordered-list">
  ...
  <li>
    ...
    и состояние, пригодное для слияния, было отправлено обратно координатору,
...
<ol className="docs-ordered-list">
  ...
  <li>
    ...
    Теперь он объединит все состояния, пригодные для слияния, и вернёт ответ на запрос.
  </li>
</ol>
...
| Совместимость с анализатором                              | Анализатор в некоторых сценариях может как значительно замедлить, так и ускорить выполнение запроса.                                                                                                                                                                                                                                                                                                                                                                                                                    |
