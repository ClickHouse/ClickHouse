...
<Steps>
  <Step title="Откройте настройки ключа API" id="open-settings">
    1. Перейдите в консоль ClickHouse Cloud → **Organization** → **API Keys**
  ...
  <Step title="Добавьте разрешенные IP-адреса" id="add-ips">
