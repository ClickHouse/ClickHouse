---
slug: /ru/clickstack/deployment/managed
title: 'Управляемый'
...
### Запуск коллектора {#start-a-collector-existing}
...
### Настройка существующих коллекторов {#configure-existing-collectors-existing}
...
### Начало ингестии (необязательно) {#start-ingestion-existing}
...
<div id="clickstack-read-only-compute">
  ### Использование ClickStack с вычислительными ресурсами в режиме только для чтения {#clickstack-read-only-compute}
</div>
