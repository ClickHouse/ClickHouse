...
<Tabs>
  ...
  <Tab title="ClickStack с открытым исходным кодом">
    ...
    <Image img="/images/use-cases/observability/hyperdx-21.webp" alt="Memory с течением времени" size="lg" />
    ...
    <Image img="/images/use-cases/observability/hyperdx-23.webp" alt="Память, % времени" size="lg" />
  </Tab>
</Tabs>