...
<Accordion title="Проверка содержимого первичного индекса">
  ...
  Для этого нам сначала нужно скопировать файл первичного индекса в [user&#95;files&#95;path](/ru/reference/settings/server-settings/settings#user_files_path) одного из узлов работающего кластера:
