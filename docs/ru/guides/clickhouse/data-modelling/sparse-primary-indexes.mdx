...
slug: /ru/guides/clickhouse/data-modelling/sparse-primary-indexes
...
<div id="an-index-design-for-massive-data-scales">
  ### Проектирование индексов для огромных объёмов данных {#an-index-design-for-massive-data-scales}
</div>
...
### Данные организуются в гранулы для параллельной обработки {#data-is-organized-into-granules-for-parallel-data-processing}
...
### У первичного индекса одна запись на гранулу {#the-primary-index-has-one-entry-per-granule}
...
<div id="using-multiple-primary-indexes">
  ## Использование нескольких индексов первичного ключа {#using-multiple-primary-indexes}
</div>

<a name="filtering-on-key-columns-after-the-first" />

### Второстепенные столбцы ключа могут быть (не)эффективны {#secondary-key-columns-can-not-be-inefficient}
...
### Вариант 2: Materialized Views {#option-2-materialized-views}
