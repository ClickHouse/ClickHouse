...
В этом руководстве вы узнаете, как анализировать набор данных из ClickHouse Cloud в ноутбуке Marimo с помощью [chDB](/chdb/index) — быстрого встраиваемого SQL OLAP-движка на базе ClickHouse.
