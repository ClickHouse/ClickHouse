...
<Steps>
  ...
  <Step title="Выполните запрос" id="issue-query">
    Независимо от того, какой метод вы использали выше — table function, движок таблицы или каталог, — во всех случаях используется один и тот же ClickHouse SQL:
...
* [Подключение к каталогам](/ru/guides/use-cases/data-warehousing/getting-started/connecting-catalogs) — Полное пошаговое руководство по Unity Catalog с Delta и Iceberg
