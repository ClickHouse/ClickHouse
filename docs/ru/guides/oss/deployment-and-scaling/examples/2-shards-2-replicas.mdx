---
slug: /ru/guides/oss/deployment-and-scaling/examples/2-shards-2-replicas
...
#### Настройка макросов {#macros-config-explanation}
...
### Конфигурация пользователя {#cluster-configuration}
