...
!!! info "Вам не нужно собирать ClickHouse самостоятельно"
     Вы можете установить готовый ClickHouse, как описано в [Быстрый старте](https://clickhouse.com/#quick-start).
     Следуйте инструкциям по установке `macOS (Intel)` или `macOS (Apple Silicon)`.
