...
<Accordion title="Мониторинг">
  ...
  * [QueryBurn](https://github.com/ofeliacode/queryburn) - Агент только для чтения, который просматривает `system.query_log` и отправляет уведомления в Telegram о ресурсоёмких запросах ClickHouse.
</Accordion>
