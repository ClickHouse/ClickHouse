...
Начиная с версии CH 26.1 эта схема поддерживается при `allow_experimental_nullable_tuple_type=1` (см. [эту страницу документации](/ru/reference/settings/session-settings/allow-experimental#allow_experimental_nullable_tuple_type)).
