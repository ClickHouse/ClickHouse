...
Estuary предоставляет коннектор прямой материализации для ClickHouse, использующий [собственный протокол ClickHouse](/ru/interfaces/tcp) и [собственный формат ClickHouse](/ru/interfaces/formats/Native).
