...
3. В меню слева выберите **Manage**, затем перейдите в **Linked services**
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-create-linked-service-button.webp" size="lg" alt="Кнопка New Linked Service в Azure Data Factory" border />
...
4. В **строке поиска New linked service** введите **REST**, выберите **REST** и нажмите **Continue**,
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-search.webp" size="lg" alt="Поиск New Linked Service в Azure Data Factory" border />
...
6. На панели динамического содержимого можно создать параметризованный URL,
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-base-url-empty.webp" size="lg" alt="Пустой Base URL в New Linked Service" border />
...
7. Нажмите **&quot;+&quot;** рядом с полем фильтра и добавьте новый параметр, назовите его
   ...
   Нажмите **Save**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-params.webp" size="lg" alt="Параметры New Linked Service" border />
...
8. В поле выражения введите следующий текст и нажмите **OK**. Замените
   ...
   ```
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-expression-field-filled.webp" size="lg" alt="Заполненное поле Expression в New Linked Service" border />
...
9. Вернувшись в основную форму, выберите базовую аутентификацию, введите имя пользователя и
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-check-connection.webp" size="lg" alt="Проверка соединения в New Linked Service" border />

10. Нажмите **Create**, чтобы завершить настройку.
    <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-linked-services-list.webp" size="lg" alt="Список Linked Services" border />
...
2. В Azure Data Factory Studio выберите Author на левой панели. Наведите указатель
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-item.webp" size="lg" alt="Элемент New Dataset" border />
...
3. В строке поиска введите **REST**, выберите **REST** и нажмите **Continue**.
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-page.webp" size="lg" alt="Страница New Dataset" border />
...
4. Теперь в разделе Datasets
   ...
   content.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-properties.webp" size="lg" alt="Свойства New Dataset" border />
...
<Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-query.webp" size="xl" alt="Запрос New Dataset" border />
...
6. Нажмите OK, чтобы сохранить выражение. Нажмите Test connection. Если всё
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-dataset-connection-successful.webp" size="xl" alt="Успешное подключение New Dataset" border />
