---
slug: /ru/integrations/connectors/data-ingestion/AWS/integrating-s3-with-clickhouse
...
<div id="handling-replication">
  ### Репликация {#handling-replication}
</div>
...
<div id="configuring-s3-for-clickhouse-use">
  ## Используйте объектное хранилище S3 как диск ClickHouse {#configuring-s3-for-clickhouse-use}
</div>
...
<div id="configure-clickhouse-to-use-the-s3-bucket-as-a-disk">
  ### Настройте ClickHouse для использования S3 бакета в качестве диска {#configure-clickhouse-to-use-the-s3-bucket-as-a-disk}
</div>
...
<div id="s3-multi-region">
  ## Репликация одного сегмента в двух регионах AWS с использованием объектного хранилища S3 {#s3-multi-region}
</div>
...
<div id="plan-the-deployment">
  ### Спланируйте развертывание {#plan-the-deployment}
</div>
...
<div id="clickhouse-server-nodes">
  #### Узлы сервер ClickHouse {#clickhouse-server-nodes}
</div>
...
<div id="create-s3-buckets">
  ### Создайте S3 бакеты {#create-s3-buckets}
</div>
...
<div id="disable-zero-copy-replication">
  #### Отключите репликацию zero-copy {#disable-zero-copy-replication}
</div>
...
<div id="configure-networking">
  ### Настройте сетевое взаимодействие {#configure-networking}
</div>
...
<div id="check-clickhouse-keeper-status">
  #### Проверьте состояние ClickHouse Keeper {#check-clickhouse-keeper-status}
</div>
