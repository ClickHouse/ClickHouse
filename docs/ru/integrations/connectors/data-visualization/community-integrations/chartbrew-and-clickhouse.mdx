...
<Image img="/images/integrations/data-visualization/chartbrew_05.webp" size="lg" alt="Выберите подключение ClickHouse для датасета" />
...
<Image img="/images/integrations/data-visualization/chartbrew_07.webp" size="lg" alt="Запрос ClickHouse SQL в Chartbrew" />
...
<Image img="/images/integrations/data-visualization/chartbrew_06.webp" size="lg" alt="AI SQL assistant ClickHouse в Chartbrew" />
