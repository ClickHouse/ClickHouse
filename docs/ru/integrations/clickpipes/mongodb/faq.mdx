...
Подробности см. в документации [AWS PrivateLink for ClickPipes](/ru/integrations/clickpipes/networking/aws-privatelink). Если вам нужна помощь, обратитесь в ClickHouse Support.