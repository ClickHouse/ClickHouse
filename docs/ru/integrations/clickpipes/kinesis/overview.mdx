...
5. Выберите Kinesis Stream и начальное смещение. В интерфейсе отобразится образец документа из выбранного источника (топика Kafka и т. д.). Вы также можете включить Enhanced Fan-out для потоков Kinesis, чтобы повысить производительность и стабильность ClickPipe (подробнее об Enhanced Fan-out читайте [здесь](https://aws.amazon.com/blogs/aws/kds-enhanced-fanout))
