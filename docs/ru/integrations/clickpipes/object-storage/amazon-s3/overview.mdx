...
| **Cloudflare R2** <br /> *S3-совместимый*       | <img src="/images/integrations/logos/cloudflare.svg" alt="Логотип Cloudflare R2" width="32" />  | Для непрерывной ингестии требуется [лексикографический порядок](#continuous-ingestion-lexicographical-order). Неупорядоченный режим не поддерживается.                                                               |
| **DigitalOcean Spaces** <br /> *S3-совместимый* | <img src="/images/integrations/logos/digitalocean.svg" alt="Логотип DigitalOcean" width="32" /> | Для непрерывной ингестии требуется [лексикографический порядок](#continuous-ingestion-lexicographical-order). Неупорядоченный режим не поддерживается.                                                               |
| **OVH Object Storage** <br /> *S3-совместимый*  | <img src="/images/integrations/logos/ovh.webp" alt="Логотип OVH Object Storage" width="32" />   | Для непрерывной ингестии требуется [лексикографический порядок](#continuous-ingestion-lexicographical-order). Неупорядоченный режим не поддерживается.                                                               |
