...
| **http&#95;agent**?: http.Agent | https.Agent <br /><Badge color="green" icon="flask">Экспериментальный</Badge>   | Пользовательский HTTP-агент для клиента.                               | -                     | [Документация по HTTP-агенту](/ru/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only)                                 |
| **set&#95;basic&#95;auth&#95;header**?: boolean <br /><Badge color="green" icon="flask">Экспериментальный</Badge> | Устанавливает заголовок `Authorization` с учетными данными Basic Auth. | `true`                | [Использование этого параметра в документации по HTTP-агенту](/ru/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only) |
