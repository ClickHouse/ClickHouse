...
### Встроенное backend-соединение chDB {#embedded-chdb-backend}
...
## Жизненный цикл клиента и рекомендации {#client-lifecycle-and-best-practices}
...
### Основные рекомендации {#basic-patterns}
...
## Метод `query` клиента `Client` {#client-query-method}
...
## Методы потокового выполнения запросов в клиенте {#client-streaming-query-methods}
...
#### Вставка в определённую базу данных {#insert-into-specific-database}
