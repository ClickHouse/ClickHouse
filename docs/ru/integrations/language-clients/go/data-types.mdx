...
Поле Nested эквивалентно Array из именованных Tuple. Использование зависит от того, установил ли пользователь для [flatten&#95;nested](/ru/reference/settings/session-settings/other#flatten_nested) значение 1 или 0.
