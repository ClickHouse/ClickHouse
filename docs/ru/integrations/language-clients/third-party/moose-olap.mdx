...
<Steps>
  <Step title="Установите Moose" id="step-1-install-moose">
  ...
  <Step title="Настройте проект" id="step-2-set-up-project">
  ...
  <Step title="Установите зависимости" id="step-3-install-dependencies">
    ```bash
    # TypeScript
    cd my-project
    npm install
  ...
  <Step title="Изучите сгенерированные модели" id="step-4-explore-models">
  ...
  <Step title="Начните разработку" id="step-5-start-development">
  ...
  <Step title="Заполните локальную базу данных тестовыми данными" id="step-6-seed-database">
  ...
  <Step title="Разработка с Moose OLAP" id="step-7-building-with-moose-olap">
