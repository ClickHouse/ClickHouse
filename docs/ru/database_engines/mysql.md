...
Движок баз данных `MySQL` передаёт запросы на сервер MySQL, и делает возможными запросы типа `SHOW TABLES` или `SHOW CREATE TABLE`.

Невозможно выполнить следующие запросы:
