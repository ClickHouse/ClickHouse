...
-   [Внешние словари ODBC](../../sql_reference/table_functions/odbc.md#dicts-external_dicts_dict_sources-odbc)
-   [Движок таблиц ODBC](../../sql_reference/table_functions/odbc.md).
