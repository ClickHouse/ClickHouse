...
При создании массива "на лету" ClickHouse автоматически определяет тип аргументов как тип, в котором можно хранить все перечисленные аргументы. Если среди аргументов есть [NULL](../query_language/syntax.md#null-literal), то тип элементов массива — [Nullable](nullable.md#data_type-nullable).
