...
-   Понадобится ли быстрое зондирование с bitmaps, вставка строчных ключей, поддержка неперемещаемых значений, предварительная выборка и пакетирование?
