...
Возможные значения:
    ...
    - `tagged` - правило для теггированных метрик (в формате `someName?tag1=value1&tag2=value2`), регулярное выражение должно быть отсортированно по именам тегов, первым - значение тега `__name__`, если есть). Регулярное выражение в regexp
