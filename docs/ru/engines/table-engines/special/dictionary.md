...
В таком виде данные из словаря можно получить при помощи функций [dictGet\*](/sql-reference/functions/ext-dict-functions#dictget-dictgetordefault-dictgetornull).
