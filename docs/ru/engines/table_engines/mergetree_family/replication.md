...
Для использовании репликации, установите параметры в секции [zookeeper](../server_configuration_parameters/settings.md#server-settings_zookeeper) конфигурации сервера.
