...
Принимает массив, возвращает массив разностей между парами соседних элементов. 
...
Принимает массивы, возвращает пересечение элементов массивов.
...
Применяет агрегатную функцию к массиву и возвращает ее результат.
