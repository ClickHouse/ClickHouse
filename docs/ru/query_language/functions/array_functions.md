...
Объединяет несколько массивов в один. Результирующий массив содержит объединенные по индексу элементы исходных массивов, сгрупированные в кортежи в указанном порядке аргументов.
...
- `arrN` — [Массив](../../data_types/array.md). Функция принимает любое количество массивов. Все массивы должны иметь одинаковую длину.

**Возвращаемое значение**

- Массив с элементами исходных массивов, сгрупированными в [кортежи](../../data_types/tuple.md).
