...
- Оперирует с массивами любой вложенности, однако все элементы всех массивов должны находиться на одном уровне.

    Например, массив `[[[1]], [[2], [3]]]` функция сделает плоским, а массив `[[1], [[2], [3]]]` нет.
