...
Функция `arraySort` поддерживает работу с лямбда-функциями. Подробнее см. в разделе [Функции высшего порядка](higher_order_functions.md).

## arrayReverseSort(arr)

Возвращает массив `arr`, отсортированный в нисходящем порядке. Примеры:
...
└──────────────────────────────────────────────────────┘
```
Функция `arrayReverseSort` поддерживает работу с лямбда-функциями.  Подробнее см. в разделе [Функции высшего порядка](higher_order_functions.md).
