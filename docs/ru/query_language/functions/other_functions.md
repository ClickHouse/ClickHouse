...
Выводит данные в диапазоне, выбранном индексом, без фильтрации по выражению, указанному в качестве аргумента. Индекс в ClickHouse разреженный, при чтении диапазона в ответ попадают «лишние» соседние данные.
...
=======
## indexHint {#indexhint}
>>>>>>> 530d036048... docs(indexHint):The new description of `indexHint` function was edited.
