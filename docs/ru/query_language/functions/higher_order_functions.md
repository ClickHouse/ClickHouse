...
Создает массив элементов, разбитых на группы по длине размера (возвращаемое значение из функции `func`). Если `func` возвращает число отличное от 0, массив разбивается слева направо. Если массив не может быть разбит равномерно, конечной частью будут оставшиеся элементы.
...
- `func` — лямбда-функция **Обязательный аргумент**.
- `arr1`, `arrN` — Любое количество [массивов](../../data_types/array.md) для обхода.
...
Создает массив элементов, разбитых на группы по длине размера (возвращаемое значение из функции `func`). Если `func` возвращает число отличное от 0, массив разбивается справа от конкретного элемента. Если массив не может быть разбит равномерно, конечной частью будут оставшиеся элементы.
