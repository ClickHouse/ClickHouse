...
## Оператор `->`, функция lambda(params, expr) {#lambda}
...
Разбивает массив на несколько массивов. Разбивка происходит слева направо. Если массив не может быть разбит равномерно, конечной частью будут оставшиеся элементы.
...
Разбивает массив на несколько массивов. Разбивка происходит справа налево. Если массив не может быть разбит равномерно, конечной частью будут оставшиеся элементы.
