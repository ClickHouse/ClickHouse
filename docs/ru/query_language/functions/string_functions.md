...
Удаляет пробельные символы с левого конца строки. Пробел в данном контексте — это все символы пробела (пробел, табуляция, пробел без разрыва и т. д.).
...
Исходную строку без пробельных символов слева.
...
Удаляет пробельные символы с правого конца строки. Пробел в данном контексте — это все символы пробела (пробел, табуляция, пробел без разрыва и т. д.).
...
Исходную строку без пробельных символов справа.
...
Удаляет пробельные символы с обоих концов строки. Пробел в данном контексте — это все символы пробела (пробел, табуляция, пробел без разрыва и т. д.).
