...
Содержит информацию о всех событиях, произошедших с [кусками данных](table_engines/custom_partitioning_key.md) таблиц семейства [MergeTree](table_engines/mergetree.md) (например, события добавления, удаления или мержа данных).
...
- `database` (String) — база данных, которой принадлежит кусок;
- `table` (String) — таблица, в которой находится кусок;
