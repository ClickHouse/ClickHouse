...
:::note Информация
Для управления профилями настроек рекомендуется использовать [SQL-ориентированный воркфлоу](/operations/access-rights), который также поддерживается в ClickHouse.
:::
