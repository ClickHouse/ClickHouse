...
Включает открепление куска данных вместо его удаления, если кусок отличается от других реплик после выполнения слияния или мутации. Активируйте это поведение, если хотите анализировать такие куски позже.

Эта настройка применяется к таблицам [MergeTree с включенной репликацией](../../engines/table-engines/mergetree-family/replication.md).
