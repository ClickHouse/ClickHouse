...
Устанавливает минимальный размер блока в строках при выполнении запроса `INSERT`. Блоки меньшего размера склеиваются в один блок.
...
Устанавливает минимальный размер блока в байтах при выполнении запроса `INSERT`. Блоки меньшего размера склеиваются в один блок.
