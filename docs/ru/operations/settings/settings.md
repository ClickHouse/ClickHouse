...
Задаёт значение часового пояса (timezone) по умолчанию для текущей сессии вместо часового пояса сервера. То есть, все значения DateTime/DateTime64, для которых явно не указан параметр timezone, будут по умолчанию иметь указанный timezone, в отличие от .
