...
-   1 — ждать выполнения действия на одной партиции. Означает, что следующее действие на партиции начинается только после завершения предыдущего действия на ней.
