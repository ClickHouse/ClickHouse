...
Время ожидания для слияния выборки, если ни один кусок не выбран. Снижение времени ожидания приведет к частому выбору задач в пуле `background_schedule_pool`, и увеличению количества запросов к zookeeper в крупных масштабируемых кластерах.
