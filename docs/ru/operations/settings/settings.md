...
Определяет, как выполняются действия, управляющие партициями.

Возможные значения:

-   0 — не ждать. Означает, что следующее действие может начаться в любое время, не дожидаясь завершения предыдущего действия.
-   1 — ждать выполнения действия на одной партиции. Означает, что следующее действие на партиции начинается только после завершения предыдущего действия на этой партиции.
-   2 — ждать выполнения действия на всех партициях. Означает, что следующее действие начинается только после завершения предыдущего действия на всех партициях.
