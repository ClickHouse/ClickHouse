...
Время ожидания для слияния выборки, если ни один кусок не выбран. Снижение времени ожидания приведет к частому выбору задач в пуле background_schedule_pool, что приведет к большому количеству запросов к zookeeper в крупных масштабируемых кластерах.
