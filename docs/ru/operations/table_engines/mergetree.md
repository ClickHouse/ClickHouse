...
### Индексы пропуска данных (экспериментальная функциональность) {#table-engine-mergetree-data-skipping-indexes}
...
## TTL для столбцов и таблиц {#table-engine-mergetree-ttl}
...
## Хранение данных таблицы на нескольких блочных устройствах {#table-engine-mergetree-multiple-volumes}
...
### Конфигурация {#table-engine-mergetree-multiple-volumes-configure}
