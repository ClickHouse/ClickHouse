...
Если `true`, то на неверные данные от клиента будет выброшено исключение. clickhouse-client, использующие версию 23.7 и более старые не совместимы с новой версией сервера 23.8+.
