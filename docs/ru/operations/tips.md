...
Не выключайте overcommit. Значение `cat /proc/sys/vm/overcommit_memory` должно быть 0 or 1. Запустите
...
[Original article](https://clickhouse.yandex/docs/ru/operations/tips/) <!--hide-->
