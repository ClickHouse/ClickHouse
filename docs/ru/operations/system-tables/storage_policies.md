...
-   `prefer_not_to_merge` ([UInt8](../../sql-reference/data-types/int-uint.md)) — Настройка для отключения слияния томов с многодисковой конфигурацией. Если данная настройка включена, то слияние диска не допускается.
