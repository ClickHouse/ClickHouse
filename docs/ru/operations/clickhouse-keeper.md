...
# [пре-продакшн] ClickHouse Keeper {#clickHouse_keeper}
...
## 4-х буквенные команды {#four_letter_word_commands}
...
- `dump`: Выводит список незавершенных сеансов и эфемерных узлов. Это работает только с репликой-лидером.
...
## [экспериментально] Переход с ZooKeeper {#migration_from_zookeeper}
