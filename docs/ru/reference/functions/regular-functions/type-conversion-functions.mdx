...
Преобразует аргумент в тип данных [Date32](/ru/reference/data-types/date32). Если аргумент невозможно преобразовать, в том числе если числовое значение выходит за пределы диапазона [Date32](/ru/reference/data-types/date32), функция возвращает значение по умолчанию: второй аргумент (если указан) или, в противном случае, нижнюю границу [Date32](/ru/reference/data-types/date32). Если аргумент имеет тип [Date](/ru/reference/data-types/date), учитываются его границы.
