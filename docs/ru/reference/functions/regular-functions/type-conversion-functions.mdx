...
Поддерживает преобразование из `String`, `FixedString`, `Date`, `Date32`, `Time`, `DateTime`, `DateTime64` или числовых типов (`(U)Int8`, `(U)Int16`, `(U)Int32`, `(U)Int64`, `BFloat16`, `Float32`, `Float64`). Значения `Decimal` и `Time64` не поддерживаются и приводят к исключению; тип `Time` и широкие целочисленные типы, такие как `(U)Int128`/`(U)Int256`, выполняют циклическое переполнение вместо насыщения.
...
Преобразования из других типов даты и времени, таких как `Date32` или `DateTime64`, выполняются в соответствии с настройкой `date_time_overflow_behavior`: режим `ignore` по умолчанию может приводить к циклическому переполнению, `saturate` ограничивает значения границами диапазона, а `throw` генерирует исключение.
...
* `x` — Входное значение для преобразования. [`String`](/ru/reference/data-types/string), [`FixedString`](/ru/reference/data-types/fixedstring), [`(U)Int*`](/ru/reference/data-types/int-uint), [`Float*`](/ru/reference/data-types/float), [`BFloat16`](/ru/reference/data-types/float), [`Date`](/ru/reference/data-types/date), [`Date32`](/ru/reference/data-types/date32), [`Time`](/ru/reference/data-types/time), [`DateTime`](/ru/reference/data-types/datetime) или [`DateTime64`](/ru/reference/data-types/datetime64)
...
* `x` — Входное значение для преобразования. [`String`](/ru/reference/data-types/string) or [`FixedString`](/ru/reference/data-types/fixedstring) or [`DateTime`](/ru/reference/data-types/datetime) or [`DateTime64`](/ru/reference/data-types/datetime64) or [`(U)Int*`](/ru/reference/data-types/int-uint) or [`BFloat16`](/ru/reference/data-types/float) or [`Float*`](/ru/reference/data-types/float)
