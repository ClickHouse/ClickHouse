...
<Note>
  Функции ИИ являются экспериментальными. Чтобы включить их, установите [`allow_experimental_ai_functions`](/ru/reference/settings/session-settings/allow-experimental#allow_experimental_ai_functions).
