...
Предоставляет табличный интерфейс для выборки/вставки файлов в [Azure Blob Storage](https://azure.microsoft.com/en-us/products/storage/blobs). Аналогична [функции s3](/ru/reference/functions/table-functions/s3).
