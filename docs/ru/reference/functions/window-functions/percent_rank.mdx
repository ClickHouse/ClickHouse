...
возвращает относительный ранг (то есть процентиль) строк в пределах оконной партиции.
...
Определение рамки окна по умолчанию и одновременно обязательное — `RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING`.
