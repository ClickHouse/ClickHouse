...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------ |
| [`output_format_orc_string_as_string`](/ru/reference/settings/formats#output_format_orc_string_as_string)                                                                                  | Использовать тип ORC String вместо Binary для столбцов String.                                                  | `true`        |
| [`output_format_orc_compression_method`](/ru/reference/settings/formats#output_format_orc_compression_method)                                                                             | Метод сжатия, используемый для выходного формата ORC. Значение по умолчанию                                     | `zstd`       |
| [`input_format_orc_case_insensitive_column_matching`](/ru/reference/settings/formats#input_format_orc_case_insensitive_column_matching)                                                    | Игнорировать регистр при сопоставлении столбцов ORC со столбцами ClickHouse.                                    | `false`       |
| [`input_format_orc_allow_missing_columns`](/ru/reference/settings/formats#input_format_orc_allow_missing_columns)                                                                          | Разрешить отсутствующие столбцы при чтении данных ORC.                                                          | `true`        |
| [`input_format_orc_skip_columns_with_unsupported_types_in_schema_inference`](/ru/reference/settings/formats#input_format_orc_skip_columns_with_unsupported_types_in_schema_inference)      | Разрешить пропускать столбцы с неподдерживаемыми типами при автоматическом определении схемы для формата ORC.   | `false`       |
