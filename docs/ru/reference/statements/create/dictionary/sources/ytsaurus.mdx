...
<Info>
  ...
  с помощью настройки [`allow_experimental_ytsaurus_dictionary_source`](/ru/reference/settings/session-settings/allow-experimental#allow_experimental_ytsaurus_dictionary_source).
</Info>
