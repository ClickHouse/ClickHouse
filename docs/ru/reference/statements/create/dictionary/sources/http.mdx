...
Чтобы ClickHouse мог получить доступ к HTTPS-ресурсу, необходимо [настроить openSSL](/ru/reference/settings/server-settings/settings/other#openssl) в конфигурации сервера.
