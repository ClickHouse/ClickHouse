...
<Note>
  ...
  * [`display_secrets_in_show_and_select`](/ru/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select) (настройка сервера)
  * [`format_display_secrets_in_show_and_select` ](/ru/reference/settings/formats/format#format_display_secrets_in_show_and_select) (настройка формата)
