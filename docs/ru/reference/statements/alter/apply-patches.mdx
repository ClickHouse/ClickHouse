...
Патч-части обычно применяются автоматически в ходе слияний, когда включена настройка [`apply_patches_on_merge`](/ru/reference/settings/merge-tree-settings/other#apply_patches_on_merge) (по умолчанию). Однако в следующих случаях может потребоваться вручную запустить применение патчей:
...
* [настройка `apply_patches_on_merge`](/ru/reference/settings/merge-tree-settings/other#apply_patches_on_merge) - Управление автоматическим применением патчей во время слияний