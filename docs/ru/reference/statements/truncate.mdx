...
Вы можете использовать настройку [alter&#95;sync](/ru/reference/settings/session-settings/alter#alter_sync), чтобы задать ожидание выполнения действий на репликах.

Вы можете указать, как долго (в секундах) ждать выполнения запросов `TRUNCATE` на неактивных репликах, с помощью настройки [replication&#95;wait&#95;for&#95;inactive&#95;replica&#95;timeout](/ru/reference/settings/session-settings/other#replication_wait_for_inactive_replica_timeout).
