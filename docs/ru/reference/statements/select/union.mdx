...
* настройка [insert&#95;null&#95;as&#95;default](/ru/reference/settings/session-settings/insert#insert_null_as_default).
* настройка [union&#95;default&#95;mode](/ru/reference/settings/session-settings/other#union_default_mode).