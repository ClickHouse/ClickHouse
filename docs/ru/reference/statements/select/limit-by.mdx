...
Если вы хотите использовать номера столбцов вместо имен столбцов в предложении `LIMIT BY`, включите настройку [enable&#95;positional&#95;arguments](/ru/reference/settings/session-settings/enable-positional-arguments#enable_positional_arguments).
