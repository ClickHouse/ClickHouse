...
Чтобы отключить сортировку по номерам столбцов, установите настройку [enable&#95;positional&#95;arguments](/ru/reference/settings/session-settings/enable-positional-arguments#enable_positional_arguments) = 0.
Чтобы отключить сортировку по `ALL`, установите настройку [enable&#95;order&#95;by&#95;all](/ru/reference/settings/session-settings/enable#enable_order_by_all) = 0.
...
Если выражение `ORDER BY` имеет префикс, совпадающий с ключом сортировки таблицы, запрос можно оптимизировать с помощью настройки [optimize&#95;read&#95;in&#95;order](/ru/reference/settings/session-settings/optimize#optimize_read_in_order).
