...
<Note>
  ...
  Запись в Delta Lake — это бета-возможность, и её необходимо включить с помощью `SET allow_delta_lake_writes = 1` (доступно начиная с версии 26.7; в более ранних версиях используйте `SET allow_experimental_delta_lake_writes = 1`).
</Note>
