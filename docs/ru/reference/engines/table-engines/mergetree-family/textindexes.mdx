...
Поэтому для создания индекса с `support_phrase_search = 1` требуется, чтобы была включена настройка MergeTree [`allow_experimental_text_index_phrase_search`](/ru/reference/settings/merge-tree-settings#allow_experimental_text_index_phrase_search).
...
<Warning>
  ...
  Чтобы включить хранение позиций, установите настройку MergeTree [`allow_experimental_text_index_phrase_search`](/ru/reference/settings/merge-tree-settings#allow_experimental_text_index_phrase_search).
</Warning>
