...
[JupySQL](https://jupysql.readthedocs.io/en/latest/quick-start.html) — это библиотека Python, которая позволяет выполнять SQL в среде Jupyter Notebook и оболочке IPython.
