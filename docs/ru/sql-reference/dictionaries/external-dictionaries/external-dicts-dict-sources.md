...
-   `format` — формат файла. Поддерживаются все форматы, описанные в разделе [Форматы](/interfaces/formats#formats-overview).
...
-   `format` — формат файла. Поддерживаются все форматы, описанные в “[Форматы](/interfaces/formats#formats-overview)”.
