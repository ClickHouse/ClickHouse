...
Если настройка [flatten_nested](../../../operations/settings/settings.md/operations/settings/settings#flatten_nested) установлена в значение `0` (что не является значением по умолчанию), поддерживаются любые уровни вложенности.
