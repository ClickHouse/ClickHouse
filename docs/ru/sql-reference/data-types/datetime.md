...
Также имена часовых поясов можно посмотреть на [странице базы данных](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones) в Википедии или выполнив запрос `SELECT * FROM system.time_zones`.
