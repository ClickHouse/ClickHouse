...
- [density](https://github.com/centaurean/density) — работает не с байтами, а с группами из 4 байлов. Для обработки данных активно использует регистры (а не оперативную память). Имеет "защиту от взрывного роста", которая существенно увеличивает скорость обработки несжимаемых исходных данных. 
