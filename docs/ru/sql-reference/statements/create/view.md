...
### Функции окна времени {#window-view-timewindowfunctions}

[Функции окна времени](../../functions/time-window-functions.md) используют, чтобы получить нижний и верхний пределы окна записей. Оконное представление нужно использовать с функцией окна времени.
