...
Оконное представление может агрегировать данные к временному окну и выводить результаты, когда окно готово к запуску. Оно хранит результаты частичной агрегации во внутренней (или заявленной) таблице, чтобы сократить время задержки. Результат обработки отправляется в заявленную таблицу и/или в виде уведомления с помощью запроса `WATCH`.
