...
2.  Установите значение параметра [max_threads](/operations/settings/settings#max_threads) в 1. Это нужно для того, чтобы выполнить следующий запрос в одном потоке. Установить значение параметра можно через запрос: `SET max_threads = 1`.
