...
Вычисляет сумму длин всех интервалов (отрезков на числовой оси), исключая пересечения.
...
-   Сумма длин всех интервалов (отрезков на числовой оси), исключая пересечения. В зависимости от типа аргумента возвращаемое значение может быть типа [UInt64](../../../sql-reference/data-types/int-uint.md#uint8-uint16-uint32-uint64-int8-int16-int32-int64) или [Float64](../../../sql-reference/data-types/float.md#float32-float64).
