...
Запрос `SELECT count() FROM table` оптимизирован по умолчанию с использованием метаданных из MergeTree. Если в таблице установлена безопасность на уровне строк, отключите [optimize_trivial_count_query](../../../operations/settings/settings.md#optimize-trivial-count-query), установив `optimize_trivial_count_query = 0`. 
