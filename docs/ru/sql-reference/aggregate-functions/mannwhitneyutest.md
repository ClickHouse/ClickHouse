...
Вычисляет U-критерий Манна — Уитни для двух выборок.
...
Проверяется нулевая гипотеза, что средние значения генеральных совокупностей совпадают. Наряду с двусторонней гипотезой могут быть проверены и односторонние.
U-критерий Манна — Уитни применяется, когда закон распределения неизвестен.
...
[Original article](https://clickhouse.tech/docs/ru/sql-reference/aggregate-functions/reference/mannwhitneyutest/) <!--hide-->
