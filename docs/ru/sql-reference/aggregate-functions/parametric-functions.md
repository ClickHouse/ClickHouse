...
## sequenceMatchEvents(pattern)(time, cond1, cond2, ...) {#function-sequencematchevents}

Возвращает значения меток времени для условий самой длинной цепочки удвлетворяющей шаблону.
...
- Массив меток времени условий (?N) для самой длинной цепочки. Позиция метки времени в массиве совпадает с позицией условия в шаблоне.
