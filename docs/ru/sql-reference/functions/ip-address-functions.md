...
Приводит строку с адресом IPv6 к типу [IPv6](../../sql-reference/data-types/domains/ipv6.md). Возвращает пустое значение, если `string` не является корректным IP адресом.
