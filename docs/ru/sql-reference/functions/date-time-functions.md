...
| %G          | четырехзначный формат вывода ISO-года (т.н. "недельного"), основывается на особом подсчете недель, в котором учтена, например, проблема нулевых годов, согласно [стандарту ISO 8601](https://ru.wikipedia.org/wiki/ISO_8601), обычно используется вместе с %V   | 2018       |
