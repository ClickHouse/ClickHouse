...
Даннвые функции реализуют шифрование и расшифровку данных с помощьюе AES (Advanced Encryption Standard) алгоритма.

Длина ключа зависит на режими шифрования. Он может быть длинной шестнадцать, двадцать четыре и тридцать два байта для режимов шифрования `-128-`, `-196-` и `-256` соответственно.
...
-   `add` — дополнительные аутентифицированные данные. Не шифруется, но влияет на дешифровку. Работает только с `-gcm` режимами. Для остальных вызовет исключение. [String](../../sql-reference/data-types/string.md#string).
...
Совместимо с шифрованием myqsl и может быть расшифровано функцией `AES_DECRYPT`.
...
Совместимо с шифрованием myqsl и может расшифровать данные, зашифрованные функцией `AES_ENCRYPT`. 
