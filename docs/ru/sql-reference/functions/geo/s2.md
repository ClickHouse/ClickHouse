...
Увеличивает размер ограничивающего прямоугольника, чтобы включить в себя заданный S2-индекс. 

В системе S2 прямоугольник представлен типом S2Region, называемым `S2LatLngRect`, который задается прямоугольник в пространстве широта-долгота.
...
-   `s2PointLow` — идентификатор нижней ячейки S2, соответствующий увеличенному прямоугольнику. Тип: [UInt64](../../../sql-reference/data-types/int-uint.md).
-   `s2PointHigh` — идентификатор верхней ячейки S2, соответствующий увеличенному прямоугольнику. Тип: [UInt64](../../../sql-reference/data-types/float.md).
...
Проверяет, содержит ли данный прямоугольник указанный S2-индекс точки.
...
-   `s2PointLow` — самая низкая точка S2-индекса, соответствующая прямоугольнику. [UInt64](../../../sql-reference/data-types/int-uint.md).
-   `s2PointHigh` — самая высокая точка S2-индекса, соответствующая прямоугольнику. [UInt64](../../../sql-reference/data-types/int-uint.md).
-   `s2Point` — указанный S2-индекс точки. [UInt64](../../../sql-reference/data-types/int-uint.md).
...
Возвращает наименьший прямоугольник, содержащий объединение двух заданных прямоугольников.
