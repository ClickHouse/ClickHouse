...
Проверяет корректность [H3](/docs/ru/sql-reference/functions/geo/h3)-индекса.
...
Извлекает разрешение [H3](/docs/ru/sql-reference/functions/geo/h3)-индекса.
...
Рассчитывает средний размер стороны шестиугольника [H3](/docs/ru/sql-reference/functions/geo/h3) в градусах.
...
-   Средняя длина стороны шестиугольника [H3](/docs/ru/sql-reference/functions/geo/h3) в градусах. Тип данных: [Float64](../../../sql-reference/data-types/float.md).
...
Рассчитывает средний размер стороны шестиугольника [H3](/docs/ru/sql-reference/functions/geo/h3) в метрах.
...
Возвращает [H3](/docs/ru/sql-reference/functions/geo/h3) индекс точки `(lon, lat)` с заданным разрешением.
...
Возвращает географические координаты долготы и широты центра шестиугольника, соответствующие указанному [H3](/docs/ru/sql-reference/functions/geo/h3)-индексу.
...
-   `h3Index` — [H3](/docs/ru/sql-reference/functions/geo/h3)-индекс. [UInt64](../../../sql-reference/data-types/int-uint.md).
...
Возвращает [H3](/docs/ru/sql-reference/functions/geo/h3)-индексы шестиугольника в радиусе `k` от данного в произвольном порядке.
...
Определяет номер базовой (верхнеуровневой) шестиугольной [H3](/docs/ru/sql-reference/functions/geo/h3)-ячейки для указанной ячейки.
...
Определяет среднюю площадь шестиугольной [H3](/docs/ru/sql-reference/functions/geo/h3)-ячейки заданного разрешения в квадратных метрах.
...
Определяет, являются ли [H3](/docs/ru/sql-reference/functions/geo/h3)-ячейки соседями.
...
Формирует массив дочерних (вложенных) [H3](/docs/ru/sql-reference/functions/geo/h3)-ячеек для указанной ячейки.
...
Определяет родительскую (более крупную) [H3](/docs/ru/sql-reference/functions/geo/h3)-ячейку, содержащую указанную ячейку.
...
Преобразует [H3](/docs/ru/sql-reference/functions/geo/h3)-индекс из числового представления `H3Index` в строковое.
...
Преобразует [H3](/docs/ru/sql-reference/functions/geo/h3)-индекс из строкового представления в числовое представление `H3Index`.
...
Определяет разрешение [H3](/docs/ru/sql-reference/functions/geo/h3)-ячейки.
...
Проверяет, имеет ли индекс [H3](/docs/ru/sql-reference/functions/geo/h3) разрешение с ориентацией Class III.
...
Проверяет, является ли указанный индекс [H3](/docs/ru/sql-reference/functions/geo/h3) пятиугольной ячейкой.
...
Возвращает все грани многоугольника (икосаэдра), пересекаемые заданным [H3](/docs/ru/sql-reference/functions/geo/h3) индексом.
