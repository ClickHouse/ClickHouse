...
Возвращает кортеж, в котором все значения умножены на заданное число.
...
Возвращает кортеж, в котором все значения поделены на заданное число. Обратите внимание, что при делении на ноль возвращается значение `inf`.
