...
[ClickVisual](https://clickvisual.gocn.vip/) ClickVisual — это легкодоступная платформа для запросов, анализа, вызовов в полицию.

Основные возможности:

- поддерживаем создание первой клавиши в аналитической библиотеке журнала
- поддержка управления конфигурацией
- поддержка самоопределения конфигурации индекса
- поддерживаю настройку сигнализации
- поддерживаем распределение допуска в библиотеку и таблицу
