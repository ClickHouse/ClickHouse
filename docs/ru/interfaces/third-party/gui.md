...
-   Интегрируется С ClickHouse, используя собственную точку приема запроса TCP/IP или интерфейс HTTP(S) (2 разных драйвера).
-   Поддерживает всю мощь диалекта ClickHouse SQL для работы с различными единицами измерений.
