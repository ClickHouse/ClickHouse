...
Включить вычисление полей с выражениями по-умолчанию для отсутствующих в загружаемых данных значений можно с помощью опции `insert_sample_with_metadata=1`.
