  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="space-y-4 mt-6">
        {/* Строка 1: ClickHouse Cloud (col-span-2) + 2 карточки одна под другой (col-span-1) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. Как организовать приём данных из распространённых источников с минимальными усилиями", href: "/ru/integrations" },
