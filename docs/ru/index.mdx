  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "Концепции ClickHouse", href: "/concepts/core-concepts/index" },
        { label: "Примеры датасетов", href: "/get-started/sample-datasets/index" },
        { label: "Руководства по миграции", href: "/get-started/migrate/overview" },
        { label: "Рекомендации", href: "/concepts/best-practices/index" },
    ]}
        />
        ...
        { label: "Сценарии применения", href: "/guides/use-cases" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Справочник по ClickHouse SQL", href: "/reference/statements" },
        ...
        { label: "Системные таблицы", href: "/reference/system-tables/overview" },
        ...
        { label: "Оператор Kubernetes", href: "/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. Как организовать приём данных из распространённых источников с минимальными усилиями", href: "/integrations/home" },
              { label: "2. Лучшие практики организации данных для аналитики и роста", href: "/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. Способы выполнять запросы к большим датасетам в реальном времени", href: "/get-started/use-cases/real-time-analytics" },
              { label: "4. Как создавать панели мониторинга, оповещения и событийно-ориентированные возможности на этой платформе", href: "/get-started/use-cases/data-warehousing" },
              { label: "5. Как снижать затраты без ущерба для производительности", href: "/concepts/best-practices/index" },
          ]}
            />
          </div>
