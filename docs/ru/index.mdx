...
export const IntegrationsBanner = () => {
    const assetBase = typeof window !== 'undefined' && window.location.pathname.startsWith('/docs') ? '/docs' : '';
    const href = '/ru/integrations/home';
    return (
        <a
        ...
        >
            <div>
                ...
                <span className="block text-[#6b7280] dark:text-[#a1a1aa] mt-1 text-sm font-normal leading-normal">100+ интеграций to connect the tools and services that you love with ClickHouse.</span>
            </div>
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "Концепции ClickHouse", href: "/ru/concepts/core-concepts/index" },
        { label: "Примеры датасетов", href: "/ru/get-started/sample-datasets/index" },
        { label: "Руководства по миграции", href: "/ru/get-started/migrate/overview" },
        { label: "Рекомендации", href: "/ru/concepts/best-practices/index" },
    ]}
        />
        ...
        { label: "Сценарии применения", href: "/ru/guides/use-cases" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Справочник по ClickHouse SQL", href: "/ru/reference/statements" },
        ...
        { label: "Системные таблицы", href: "/ru/reference/system-tables/overview" },
        ...
        { label: "ClickHouse Managed Postgres", href: "/ru/products/managed-postgres/overview" },
        { label: "Langfuse", href: "https://langfuse.com/docs", external: true },
        { label: "chDB", href: "/ru/chdb" },
        { label: "Оператор Kubernetes", href: "/ru/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="Real-time аналитика" galaxyEvent="docs.home.real-time-analytics" description="Получайте мгновенные инсайты и панели мониторинга в любом масштабе. Анализируйте миллиарды строк в реальном времени с результатами за миллисекунды." href="/ru/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="Обсервабилити" galaxyEvent="docs.home.observability" description="Храните и запрашивайте журналы, метрики и трейсы в любом масштабе с помощью ClickStack — стека обсервабилити с открытым исходным кодом на базе ClickHouse." href="/ru/clickstack/overview" showArrow />

        <HeroCard title="Хранилище данных" galaxyEvent="docs.home.data-warehousing" description="Мгновенно анализируйте и изучайте данные для получения инсайтов и создания приложений. Быстрее масштабируйтесь, перенося ресурсоемкие рабочие нагрузки." href="/ru/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="Агентная аналитика" galaxyEvent="docs.home.agentic-analytics" description="Позвольте AI-агентам напрямую запрашивать ваши данные в реальном времени, чтобы мгновенно получать инсайты и визуализации в диалоговом формате" href="/ru/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        {/* Строка 1: ClickHouse Cloud (col-span-2) + 2 карточки, расположенные одна под другой (col-span-1) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. Как организовать приём данных из распространённых источников с минимальными усилиями", href: "/ru/integrations/home" },
              { label: "2. Лучшие практики организации данных для аналитики и роста", href: "/ru/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. Способы выполнять запросы к большим датасетам в реальном времени", href: "/ru/get-started/use-cases/real-time-analytics" },
              { label: "4. Как создавать панели мониторинга, оповещения и событийно-ориентированные возможности на этой платформе", href: "/ru/get-started/use-cases/data-warehousing" },
              { label: "5. Как снижать затраты без ущерба для производительности", href: "/ru/concepts/best-practices/index" },
          ]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" galaxyEvent="docs.home.clickstack" description="Универсальный стек обсервабилити на базе ClickHouse, который обеспечивает молниеносные запросы и мощные агрегации по журналам, метрикам, трассировкам, воспроизведениям сеансов и ошибкам." href="/ru/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Kubernetes Operator" galaxyEvent="docs.home.kubernetes-operator" description="Автоматизирует развертывание, настройку и управление кластерами ClickHouse и ClickHouse Keeper в Kubernetes." href="/ru/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" galaxyEvent="docs.home.chdb" description="Быстрая, надёжная и масштабируемая встраиваемая база данных. Оцените возможности ClickHouse прямо в приложении." href="/ru/chdb/index" showArrow />
        </div>
      </div>
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-0">Настройте MCP-сервер для документации</h2>
        <p className="text-sm text-gray-500 dark:text-zinc-500 mb-6">Обращайтесь к документации ClickHouse напрямую из ваших AI-инструментов с помощью Model Context Protocol.</p>
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50 mb-1">Добавьте навыки ClickHouse своему агенту для программирования</p>
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">Установите навыки ClickHouse, чтобы дать вашему агенту экспертные знания по ClickHouse и понимание передовых практик.</p>
