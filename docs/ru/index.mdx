  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        ...
        <HeroCard title="Обсервабилити" description="Храните и запрашивайте журналы, метрики и трейсы в любом масштабе с помощью ClickStack — стека обсервабилити с открытым исходным кодом на базе ClickHouse." href="/ru/clickstack/overview" showArrow />

        <HeroCard title="Хранилище данных" description="Мгновенно анализируйте и изучайте данные для получения инсайтов и создания приложений. Быстрее масштабируйтесь, перенося ресурсоемкие рабочие нагрузки." href="/ru/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="Агентная аналитика" description="Позвольте AI-агентам напрямую запрашивать ваши данные в реальном времени, чтобы мгновенно получать инсайты и визуализации в диалоговом формате" href="/ru/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. Как организовать приём данных из распространённых источников с минимальными усилиями", href: "/integrations" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="Платформа для LLM-разработки с открытым исходным кодом для обсервабилити, метрик, оценки и управления промптами." href="https://langfuse.com/docs" showArrow external />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Kubernetes Operator" description="Автоматизирует развертывание, настройку и управление кластерами ClickHouse и ClickHouse Keeper в Kubernetes." href="/ru/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="Быстрая, надёжная и масштабируемая встраиваемая база данных. Оцените возможности ClickHouse прямо в приложении." href="/ru/products/chdb/index" showArrow />
        </div>
      </div>
