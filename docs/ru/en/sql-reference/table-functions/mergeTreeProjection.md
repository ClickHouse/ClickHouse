---
description: 'Представляет содержимое одной из проекций в таблицах семейства MergeTree.
...
Представляет содержимое одной из проекций в таблицах семейства MergeTree. Может использоваться для интроспекции.
...
| `projection` | Имя проекции, из которой выполняется чтение.      |

<div id="returned_value">
  ## Возвращаемое значение
</div>

Объект таблицы со столбцами, предоставляемыми указанной проекцией.
