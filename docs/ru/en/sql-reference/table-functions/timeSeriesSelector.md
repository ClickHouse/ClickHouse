---
description: 'Читает временные ряды из таблицы TimeSeries, отфильтрованные селектором, с временными метками в указанном интервале.'
...
Читает временные ряды из таблицы TimeSeries, отфильтрованные селектором, с временными метками в указанном интервале.
...
* &#96;min&#95;time - Начальная временная метка, включая указанное значение.
* &#96;max&#95;time - Конечная временная метка, включая указанное значение.
