...
| `max_query_length` | (UInt64) - Максимальная длина, которой может достигать запрос в процессе фаззинга.                  |
...
Табличный объект с одним столбцом, содержащим модифицированные строки запроса.
