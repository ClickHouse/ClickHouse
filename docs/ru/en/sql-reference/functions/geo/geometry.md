...
title: 'Функции для работы с типом Geometry'
doc_type: 'reference'
---
...
Функции Geometry позволяют вычислять периметр и площадь для таких геометрических типов, как POLYGON, LINESTRING, MULTIPOLYGON, MULTILINESTRING, RING и POINT. Используйте объекты типа Geometry. Если входное значение — `NULL`, все приведённые ниже функции вернут 0.
...
* Число — периметр объекта в единицах системы координат. [Float64](../../data-types/float.md).
...
* Число — площадь объекта в единицах координатной системы. [Float64](../../data-types/float.md).
...
Вычисляет периметр объекта типа Geometry на поверхности сферы.
