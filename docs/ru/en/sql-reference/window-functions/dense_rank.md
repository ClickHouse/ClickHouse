...
Присваивает текущей строке ранг в пределах её партиции без пропусков. Иными словами, если значение очередной строки совпадает со значением одной из предыдущих строк, ей присваивается следующий ранг по порядку без пропусков в ранжировании.

Функция [rank](./rank.md) работает аналогично, но с пропусками в ранжировании.
...
* Число для текущей строки в пределах её партиции, без пропусков в рангах. [UInt64](../data-types/int-uint.md).
