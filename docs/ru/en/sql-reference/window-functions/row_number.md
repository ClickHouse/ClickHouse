...
Нумерует текущую строку в её партиции, начиная с 1.
...
Следующий пример основан на материале из обучающего видео [Ранжирование оконных функций в ClickHouse](https://youtu.be/Yku9mmBYm_4?si=XIMu1jpYucCQEoXA).
