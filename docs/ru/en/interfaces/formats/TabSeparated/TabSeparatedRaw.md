...
Отличается от формата [`TabSeparated`](/ru/interfaces/formats/TabSeparated) тем, что строки записываются без экранирования.
...
Прочитайте данные в формате `TabSeparatedRaw`:
...
Вывод будет в формате, где поля разделены табуляцией:
