...
Аналогично [`JSONCompactEachRowWithProgress`](/ru/interfaces/formats/JSONCompactEachRowWithProgress), но все значения преобразуются в строки.
...
* Все значения представлены в виде строк (числа, массивы и т. д. — всё передаётся как строки в кавычках)
* Включает обновления прогресса, итоговые значения и обработку исключений
* Полезно для клиентов, которые предпочитают или требуют данные в строковом виде
