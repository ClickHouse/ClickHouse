...
Отличается от [JSONEachRow](./JSONEachRow.md) только тем, что JSON форматируется в удобочитаемом виде с разделителями в виде символов новой строки и отступами в 4 пробела.
...
Чтобы прочитать данные, используйте формат `PrettyJSONEachRow`:
