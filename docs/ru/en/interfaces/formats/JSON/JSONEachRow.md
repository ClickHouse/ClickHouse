...
В этом формате ClickHouse выводит каждую строку как отдельный объект JSON, разделённый символом новой строки.
...
При импорте столбцы данных с неизвестными именами будут пропущены, если параметр [input&#95;format&#95;skip&#95;unknown&#95;fields](/ru/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) установлен в 1.
