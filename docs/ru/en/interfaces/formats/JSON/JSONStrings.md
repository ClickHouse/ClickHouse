...
Отличается от формата [JSON](./JSON.md) только тем, что поля данных выводятся как строки, а не как типизированные значения JSON. Этот формат предназначен только для вывода.
...
Для чтения данных используйте формат `JSONStrings`:
