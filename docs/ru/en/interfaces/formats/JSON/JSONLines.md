...
Этот формат также известен как `JSONEachRow`, `JSONLines`, `NDJSON` (Newline Delimited JSON) или `JSONL`. Все эти названия — псевдонимы одного и того же формата, и их можно использовать взаимозаменяемо как для входных, так и для выходных данных.
...
При импорте столбцы данных с неизвестными именами будут пропущены, если для настройки [input&#95;format&#95;skip&#95;unknown&#95;fields](/ru/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) установлено значение 1.
