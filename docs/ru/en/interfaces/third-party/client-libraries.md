---
description: 'Обзор доступных сторонних клиентских библиотек для разных языков
  программирования'
sidebar_label: 'Клиентские библиотеки'
sidebar_position: 26
slug: /interfaces/third-party/client-libraries
title: 'Клиентские библиотеки от сторонних разработчиков'
doc_type: 'reference'
---
...
* [клиент SeasClick на C++](https://github.com/SeasX/SeasClick)
...
* [расширение ClickHouse для PHP от kolya7k](https://github.com//kolya7k/clickhouse-php)
