...
* `key_hash` ([UInt128](/ru/sql-reference/data-types/int-uint)) — Хеш для (table&#95;uuid, part&#95;name, condition&#95;hash).
* `entry_size` ([UInt64](/ru/sql-reference/data-types/int-uint)) — Размер записи в байтах.
* `matching_marks` ([String](/ru/sql-reference/data-types/string)) — Соответствующие marks.
