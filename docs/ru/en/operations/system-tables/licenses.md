...
* `library_name` ([String](/ru/sql-reference/data-types/string)) — Название библиотеки.
* `license_type` ([String](/ru/sql-reference/data-types/string)) — Тип лицензии — например, Apache, MIT.
* `license_path` ([String](/ru/sql-reference/data-types/string)) — Путь к файлу с текстом лицензии.
* `license_text` ([String](/ru/sql-reference/data-types/string)) — Текст лицензии.
