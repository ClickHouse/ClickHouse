...
Предположим, что у нас адресная книга, в которой может быть указано несколько способов связи с клиентом.
...
- То же значение с не `Nullable` типом, если значение не `NULL`.
