---
title: Как выводить трассировки уровня send_logs_level в файл с помощью clickhouse-client
description: "Как выводить трассировки уровня send_logs_level в файл с помощью clickhouse-client"
date: 2024-11-21
tags: ['Экспорт данных']
keywords: ['трассировки уровня send_logs_level', 'clickhouse-client']
---
...
Как с помощью клиента ClickHouse вывести вывод `send_logs_level` в файл при выполнении нескольких команд в несколько строк?

<div id="answer">
  ## Ответ
</div>

* Создайте SQL-файл с командами, например `send_logs_level_example.sql`:
...
* Выполните команду, чтобы вывести данные на экран и записать их в файл:
...
[Ссылка на справочную документацию](/ru/reference/settings/session-settings/send-logs#send_logs_level)