...
Обычно настройка [max&#95;threads](/ru/reference/settings/session-settings/max-threads#max_threads) [определяет](https://clickhouse.com/company/events/query-performance-introspection) количество потоков для параллельного чтения и параллельной обработки запросов:

<Image img="/images/knowledgebase/sync_read.webp" size="md" alt="Диаграмма синхронного чтения данных" />
...
<Image img="/images/knowledgebase/async_read.webp" size="md" alt="Диаграмма асинхронного чтения данных" />
