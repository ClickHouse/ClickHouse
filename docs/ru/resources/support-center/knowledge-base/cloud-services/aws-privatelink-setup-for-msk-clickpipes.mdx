...
Выполните шаги по созданию обратной частной конечной точки, описанные в [документации ClickPipes](/ru/integrations/clickpipes/networking/aws-privatelink#creating-clickpipe).