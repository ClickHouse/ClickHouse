---
date: 2023-01-14
title: Сравнение метрик двух запросов в децибелах
description: Запрос для сравнения метрик двух запросов в ClickHouse.
...
<div id="compare-metrics-between-two-queries">
  ## Сравнение метрик для двух запросов
</div>

Чтобы сравнить метрики для двух запросов, сначала нужно получить `query_id` для обоих запросов.
