...
```sql
-- ВХОД ПОД ПОЛЬЗОВАТЕЛЕМ default (права администратора)
...
-- назначить 'role_a' пользователям 'foo' и 'bar'
...
-- назначить 'role_b' пользователю 'bar'
...
-- Каким пользователям назначена 'role_a'?
