...
<Tip>
  Для управления доступом к базе данных из консоли предпочтительно использовать [роли базы данных, управляемые Cloud](/ru/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles). Роли `sql-console-role:<email>` несовместимы с JWT-сеансами в SQL console.
</Tip>
...
## Как работают роли пользователей в SQL Console {#how-sql-console-user-roles-work}
...
## Настройка постоянных разрешений {#configure-persistent-permissions}
...
## Не изменяйте управляемые роли {#avoid-modifying-managed-roles}
