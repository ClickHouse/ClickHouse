...
slug: /ru/concepts/features/configuration/server-config/configuration-files
...
<div id="from_env_zk">
  ### Подстановка с использованием переменных окружения и узлов ZooKeeper {#from_env_zk}
</div>
...
<div id="substitution-with-file-content">
  ## Подстановка содержимого файла {#substitution-with-file-content}
</div>
