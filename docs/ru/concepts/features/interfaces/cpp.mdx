...
sidebarTitle: 'C++'
slug: /interfaces/cpp
title: 'Клиентская библиотека для C++'
doc_type: 'reference'
---
...
<Note>
  ...
  некоторые возможности и типы данных могут быть ещё не полностью реализованы или не поддерживаться.
...
Самый простой способ подключить библиотеку к вашему проекту — использовать модуль CMake `FetchContent`.
...
Чтобы выполнить запрос, который не возвращает данных, например для создания таблиц, используйте метод `Execute`.
