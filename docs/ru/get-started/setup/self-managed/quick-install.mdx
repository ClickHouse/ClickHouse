...
<Steps>
  <Step title="Установка ClickHouse с помощью curl" id="install-clickhouse-using-curl">
    ...
    В Linux и macOS при этом также устанавливается [`clickhousectl`](/ru/install/clickhousectl),
    ...
    в фоновом режиме и управлять ClickHouse Cloud. Инструкции по работе через CLI см. на [странице установки clickhousectl](/ru/install/clickhousectl).
