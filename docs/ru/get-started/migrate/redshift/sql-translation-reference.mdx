...
<sub><span>*</span> ClickHouse также поддерживает беззнаковые целые числа с более широкими диапазонами, а именно <a href="/ru/sql-reference/data-types/int-uint">`UInt8`, `UInt32`, `UInt32` и `UInt64`</a>.</sub><br />
<sub><span>**</span>Тип String в ClickHouse по умолчанию не имеет ограничений, но его длину можно ограничить с помощью <a href="/ru/sql-reference/statements/create/table#constraints">ограничений</a>.</sub>
