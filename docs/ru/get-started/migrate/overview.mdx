...
| OSS to Cloud                                                             | Перенос данных из самоуправляемого развертывания ClickHouse с помощью [`remoteSecure`](/ru/get-started/migrate/oss-to-cloud/clickhouse-to-cloud) или [`BACKUP` и `RESTORE`](/ru/get-started/migrate/oss-to-cloud/oss-to-cloud-backup-restore). |
