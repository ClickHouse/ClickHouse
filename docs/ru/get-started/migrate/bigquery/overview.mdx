...
slug: /ru/get-started/migrate/bigquery/overview
...
<div id="bigquery-datasets-vs-clickhouse-cloud-databases">
  ### Датасеты BigQuery и базы данных ClickHouse Cloud {#bigquery-datasets-vs-clickhouse-cloud-databases}
</div>
...
<div id="bigquery-slot-reservations-and-quotas">
  ### Резервирование Slot и квоты BigQuery {#bigquery-slot-reservations-and-quotas}
</div>
...
<div id="querying-materialized-views">
  ## Запросы к materialized view {#querying-materialized-views}
</div>
