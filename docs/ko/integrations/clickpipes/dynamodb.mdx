...
이제 Kinesis 스트림의 실시간 변경 사항을 capture하도록 Kinesis ClickPipe를 설정할 수 있습니다. [여기](/ko/integrations/clickpipes/kinesis/overview)에 있는 Kinesis ClickPipe 가이드를 따르되, 다음 설정을 사용하십시오.
