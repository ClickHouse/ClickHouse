...
| 이름               | 로고                                                                                                 | 유형   | 상태 | 설명                                                                         |
| ---------------- | -------------------------------------------------------------------------------------------------- | ---- | -- | -------------------------------------------------------------------------- |
| Apache Kafka     | <img src="/images/integrations/logos/kafka.svg" alt="Apache Kafka 로고" width="32" />                | 스트리밍 | 안정 | ClickPipes를 구성하여 Apache Kafka의 스트리밍 데이터를 ClickHouse Cloud로 수집할 수 있습니다.     |
...
| Redpanda         | <img src="/images/integrations/logos/logo_redpanda.webp" alt="Redpanda 로고" width="32" />           | 스트리밍 | 안정 | ClickPipes를 구성하여 Redpanda의 스트리밍 데이터를 ClickHouse Cloud로 수집할 수 있습니다.         |
| AWS MSK          | <img src="/images/integrations/logos/msk.svg" alt="AWS MSK 로고" width="32" />                       | 스트리밍 | 안정 | ClickPipes를 구성하여 AWS MSK의 스트리밍 데이터를 ClickHouse Cloud로 수집할 수 있습니다.          |
| Azure Event Hubs | <img src="/images/integrations/logos/azure_event_hubs.svg" alt="Azure Event Hubs 로고" width="32" /> | 스트리밍 | 안정 | ClickPipes를 구성하여 Azure Event Hubs의 스트리밍 데이터를 ClickHouse Cloud로 수집할 수 있습니다. |
| WarpStream       | <img src="/images/integrations/logos/warpstream.svg" alt="WarpStream 로고" width="32" />             | 스트리밍 | 안정 | ClickPipes를 구성하여 WarpStream의 스트리밍 데이터를 ClickHouse Cloud로 수집할 수 있습니다.       |
