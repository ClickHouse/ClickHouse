...
서비스에서 PrivateLink 관리형 Private DNS를 사용할 수 없는 경우(예: Confluent Cloud처럼 provider가
consumer가 DNS 해석을 관리하도록 요구하는 경우), [Custom private DNS](#custom-private-dns)를 참조하십시오.
...
source에 비공개 연결을 통해 자체 호스트명으로 접근할 수 있습니다.
