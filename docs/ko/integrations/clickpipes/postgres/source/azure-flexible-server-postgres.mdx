...
<Image img="/images/integrations/data-ingestion/clickpipes/postgres/source/azure-flexible-server-postgres/firewall.webp" alt="Azure Flexible Server for Postgres의 방화벽에 ClickPipes IP 추가" size="lg" />
