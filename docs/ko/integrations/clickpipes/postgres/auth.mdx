...
RDS/Aurora 인스턴스에 연결한 다음 IAM 인증이 활성화된 데이터베이스 사용자를 생성하십시오. 그런 다음 ClickPipes용 인스턴스를 구성할 수 있도록 소스 설정 가이드의 나머지 단계를 따르십시오.

* [AWS Aurora for PostgreSQL 소스 설정 가이드](/ko/integrations/clickpipes/postgres/source/aurora#configure-database-user)
* [AWS RDS for PostgreSQL 소스 설정 가이드](/ko/integrations/clickpipes/postgres/source/rds#configure-database-user)
* [AWS Aurora for MySQL 소스 설정 가이드](/ko/integrations/clickpipes/mysql/source/aurora#configure-database-user)
* [AWS RDS for MySQL 소스 설정 가이드](/ko/integrations/clickpipes/mysql/source/rds#configure-database-user)
