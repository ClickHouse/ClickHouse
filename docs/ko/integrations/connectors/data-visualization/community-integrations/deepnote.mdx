...
***참고:*** ClickHouse 연결이 IP 액세스 목록으로 보호되는 경우 Deepnote의 IP 주소를 허용해야 할 수 있습니다. 자세한 내용은 [Deepnote 문서](https://docs.deepnote.com/integrations/authorize-connections-from-deepnote-ip-addresses)를 참조하십시오.
