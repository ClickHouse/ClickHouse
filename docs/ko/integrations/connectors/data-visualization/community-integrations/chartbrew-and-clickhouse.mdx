...
<Image img="/images/integrations/data-visualization/chartbrew_05.webp" size="lg" alt="데이터셋에 사용할 ClickHouse 연결 선택" />
...
<Image img="/images/integrations/data-visualization/chartbrew_08.webp" size="lg" alt="ClickHouse 데이터가 있는 Chartbrew 대시보드" />

데이터의 다양한 측면을 시각화할 수 있도록 필요한 만큼 데이터셋을 만들 수 있습니다. 이러한 데이터셋을 사용해 서로 다른 메트릭을 추적하는 여러 대시보드를 만들 수 있습니다.

<Image img="/images/integrations/data-visualization/chartbrew_01.webp" size="lg" alt="ClickHouse 데이터가 있는 Chartbrew 대시보드" />
