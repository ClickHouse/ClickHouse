...
<Image size="md" img="/images/integrations/data-visualization/looker_studio_01.webp" alt="Looker Studio 인터페이스에서 새 데이터 소스 만들기" border />
...
<Image size="md" img="/images/integrations/data-visualization/looker_studio_03.webp" alt="Looker Studio에서 ClickHouse MySQL 연결 정보 입력하기" border />

<br />

이제 ClickHouse에서 데이터를 가져오는 방법은 두 가지입니다. 첫 번째는 Table Browser 기능을 사용하는 것입니다:

<Image size="md" img="/images/integrations/data-visualization/looker_studio_04.webp" alt="Looker Studio에서 Table Browser를 사용해 ClickHouse 테이블 선택하기" border />

<br />

또는 데이터를 가져오기 위해 사용자 지정 쿼리를 지정할 수 있습니다:

<Image size="md" img="/images/integrations/data-visualization/looker_studio_05.webp" alt="Looker Studio에서 사용자 지정 SQL 쿼리를 사용해 ClickHouse에서 데이터 가져오기" border />

<br />

마지막으로, 검사된 테이블 구조를 확인하고 필요한 경우 데이터 타입을 조정할 수 있습니다.

<Image size="md" img="/images/integrations/data-visualization/looker_studio_06.webp" alt="Looker Studio에서 검사된 ClickHouse 테이블 구조 보기" border />
