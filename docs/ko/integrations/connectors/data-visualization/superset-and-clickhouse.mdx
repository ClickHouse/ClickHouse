  ...
  <Step title="드라이버 설치하기" id="2-install-the-driver">
    ...
    <Info>
      **Docker Compose Setup**
      ...
      Docker 기반 설치의 경우, 컨테이너에 `clickhouse-connect`를 추가하는 방법은 [Superset 데이터베이스 구성 가이드](https://superset.apache.org/docs/configuration/databases/#clickhouse)를 참조하십시오.
    </Info>
