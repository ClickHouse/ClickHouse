...
<Frame>
  ![Fabric Lakehouse의 yellow\_tripdata 테이블과 해당 컬럼](/images/integrations/tools/data-integration/microsoft-fabric/fabric-08-tutorial-lakehouse-table.webp)
</Frame>
...
<Frame>
  ![내장 ClickHouse SQL 콘솔에서 실행한 튜토리얼 쿼리 3개](/images/integrations/tools/data-integration/microsoft-fabric/fabric-09-tutorial-sample-queries.webp)
</Frame>
...
### ClickHouse Cloud Console에 로그인할 수 없음
