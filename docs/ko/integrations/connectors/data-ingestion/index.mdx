...
| [Apache Airflow](/ko/integrations/connectors/data-ingestion/etl-tools/airflow-and-clickhouse)   | 코드로 workflow를 작성, 예약, 모니터링할 수 있는 오픈소스 플랫폼으로, DAG에서 ClickHouse 쿼리 실행 및 데이터 적재를 위한 provider를 제공합니다.                                 |
