...
[EMQX Cloud Data Integrations](https://docs.emqx.com/en/cloud/latest/rule_engine/introduction.html#general-flow)는 EMQX 메시지 흐름과 디바이스 이벤트를 처리하고 이에 대응하는 규칙을 구성하는 데 사용됩니다. Data Integrations는 명확하고 유연한 &quot;구성 가능한&quot; 아키텍처를 제공할 뿐만 아니라 개발 프로세스를 간소화하고 사용성을 높이며 비즈니스 시스템과 EMQX Cloud 간의 결합도를 낮춥니다. 또한 EMQX Cloud의 고유 capability를 사용자 지정할 수 있도록 뛰어난 인프라를 제공합니다.
