...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_1.webp" size="md" border alt="SQL 쿼리를 보여주는 EMQX Cloud 데이터 통합 규칙 생성 1단계" />

SQL 테스트를 실행해 결과를 확인할 수 있습니다.

<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_2.webp" size="md" border alt="테스트 결과를 보여주는 EMQX Cloud 데이터 통합 규칙 생성 2단계" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_rule_action.webp" size="md" border alt="SQL 템플릿을 사용한 EMQX Cloud 데이터 통합 규칙 작업 설정" />
...
<Image img="/images/integrations/data-ingestion/emqx/data_integration_details.webp" size="md" border alt="구성 요약을 보여주는 EMQX Cloud 데이터 통합 규칙 세부 정보" />
