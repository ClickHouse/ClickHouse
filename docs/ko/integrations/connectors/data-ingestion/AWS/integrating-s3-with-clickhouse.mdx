---
slug: /ko/integrations/connectors/data-ingestion/AWS/integrating-s3-with-clickhouse
...
<div id="creating-a-storage-policy">
  ### 스토리지 정책 만들기 {#creating-a-storage-policy}
</div>
...
<div id="configuring-s3-for-clickhouse-use">
  ## S3 객체 스토리지를 ClickHouse 디스크로 사용 {#configuring-s3-for-clickhouse-use}
</div>
...
<div id="configure-clickhouse-to-use-the-s3-bucket-as-a-disk">
  ### ClickHouse에서 S3 버킷을 디스크로 사용하도록 구성 {#configure-clickhouse-to-use-the-s3-bucket-as-a-disk}
</div>
...
<div id="s3-multi-region">
  ## S3 객체 스토리지를 사용해 단일 세그먼트를 2개의 AWS 리전에 걸쳐 복제하기 {#s3-multi-region}
</div>
...
<div id="configure-clickhouse-server">
  ### ClickHouse 서버 설정 {#configure-clickhouse-server}
</div>
...
<div id="disable-zero-copy-replication">
  #### zero-copy 복제 비활성화 {#disable-zero-copy-replication}
</div>
