...
6. 동적 콘텐츠 창에서는 매개변수화된 URL을 만들 수 있으며, 이를 사용하면
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-base-url-empty.webp" size="lg" alt="비어 있는 새 Linked Service Base Url" border />
