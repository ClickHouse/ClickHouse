...
<Image img="/images/integrations/sql-clients/marimo/add-db-details.webp" size="md" border alt="데이터베이스 정보 입력" />

그러면 연결을 설정할 수 있는 셀이 생성됩니다.

<Image img="/images/integrations/sql-clients/marimo/run-cell.webp" size="md" border alt="ClickHouse에 연결하려면 셀 실행" />
