...
| fmt           | str               | 데이터의 ClickHouse [입력 형식](/ko/reference/formats/index)입니다. 기본값은 `TSV`입니다                   |
