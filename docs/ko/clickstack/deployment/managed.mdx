---
slug: /ko/clickstack/deployment/managed
title: '관리형'
...
### collector 시작 {#start-a-collector-existing}
...
### 기존 collector 구성 {#configure-existing-collectors-existing}
...
### 수집 시작(선택 사항) {#start-ingestion-existing}
...
<div id="clickstack-read-only-compute">
  ### 읽기 전용 컴퓨트에서 ClickStack 사용하기 {#clickstack-read-only-compute}
</div>
...
<div id="how-clickstack-selects-compute">
  #### ClickStack에서 컴퓨트를 선택하는 방식 {#how-clickstack-selects-compute}
</div>
...
<div id="adding-data-sources">
  ### 데이터 소스 추가하기 {#adding-data-sources}
</div>
