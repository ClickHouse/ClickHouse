---
slug: /ko/clickstack/architecture
...
### ClickHouse Cloud: 엔진 {#clickhouse-cloud}
...
### OpenTelemetry collector: 데이터 수집 {#open-telemetry-collector-managed}
...
### ClickStack UI (HyperDX): 인터페이스 {#hyperdx}
...
### ClickHouse: 데이터베이스 엔진 {#clickhouse}
...
### OpenTelemetry collector: 데이터 수집 {#open-telemetry-collector}
...
### ClickStack UI (HyperDX): 인터페이스 {#hyperdx-ui}
