...
#### 수집용 사용자 생성 {#create-a-database-ingestion-user-managed}
...
#### 읽기 및 쓰기 워크로드 격리 {#isolating-read-write}
...
#### 수집용 사용자 생성 {#create-a-database-ingestion-user-oss}
...
#### ClickStack UI 사용자 권한 {#user-permissions}
...
### Time To Live (TTL) 구성 {#configure-ttl}
