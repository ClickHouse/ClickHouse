...
ClickHouse는 Prometheus 메트릭을 [`TimeSeries`](/ko/reference/engines/table-engines/integrations/time-series) 테이블에 저장하고 PromQL 쿼리를 실행할 수 있습니다. 수집, 쿼리 및 시각화 구성에 대해서는 [Prometheus 프로토콜 및 PromQL](/ko/interfaces/prometheus)을 참조하십시오.