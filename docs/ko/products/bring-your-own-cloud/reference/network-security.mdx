...
| 목적                            | 연결 유형                                                             | 비고                                                                                                                                 |
| ----------------------------- | ----------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| **일상 운영 — Kubernetes API 서버** | IP 필터링이 적용된 공개 연결(기본값), 또는 Tailscale이나 AWS VPC Lattice를 통한 비공개 연결 | 관리 서비스는 IP 허용 목록으로 제한된 공개 네트워크를 통해 EKS API 서버와 통신합니다. 초기 배포 후에는 필요에 따라 이를 Tailscale 또는 AWS에서는 VPC Lattice를 통한 비공개 접근으로 전환할 수 있습니다. |
