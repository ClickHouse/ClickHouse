...
서비스 제공자 시작 SSO, 각기 별도의 연결을 사용하는 여러 조직, 그리고 Just-in-Time 프로비저닝을 지원합니다. 또한 Okta를 지원하는 [SCIM provisioning](/ko/products/cloud/guides/security/cloud-access-management/scim-setup)을 비공개 프리뷰로 제공합니다. 아직 속성 매핑은 지원하지 않습니다.
