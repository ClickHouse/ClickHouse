...
서비스 제공자 시작 SSO, 각기 별도의 연결을 사용하는 여러 조직, 그리고 Just-in-Time 프로비저닝을 지원합니다. 또한 [Okta](/ko/products/cloud/guides/security/cloud-access-management/scim-setup) 및 [Microsoft Entra ID](/ko/products/cloud/guides/security/cloud-access-management/scim-setup-entra)와 함께 SCIM provisioning을 비공개 프리뷰로 지원합니다. 아직 속성 매핑은 지원하지 않습니다.
...
* SCIM provisioning — [Okta](/ko/products/cloud/guides/security/cloud-access-management/scim-setup) 또는 [Microsoft Entra ID](/ko/products/cloud/guides/security/cloud-access-management/scim-setup-entra)를 사용하여 사용자 및 그룹 프로비저닝을 자동화합니다(비공개 프리뷰).
