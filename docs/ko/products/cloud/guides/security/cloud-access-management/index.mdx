...
| [사용자 지정 역할로 RBAC 마이그레이션](/ko/products/cloud/guides/security/cloud-access-management/migrating-rbac-custom-roles)  | 새로운 역할 기반 접근 제어 시스템으로 마이그레이션하는 방법을 안내하는 관리자용 가이드입니다                      |
