...
ClickHouse Cloud API의 `activity` 엔드포인트를 사용하여 감사 이벤트 내보내기 데이터를 가져올 수 있습니다. 자세한 내용은 [API 참조](/ko/products/cloud/api-reference/organization/get-list-of-available-organizations)에서 확인할 수 있습니다.
