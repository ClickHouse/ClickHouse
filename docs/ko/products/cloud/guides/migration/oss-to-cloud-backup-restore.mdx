...
<Steps>
  ...
  <Step>
    ...
    1. [&quot;Accessing S3 data securely&quot;](/ko/products/cloud/guides/data-sources/accessing-s3-data-securely)의 단계에 따라 액세스 역할을 생성하고 role ARN을 가져오십시오.

    2. 이전 단계에서 얻은 role ARN을 추가하여 [&quot;How to create an S3 bucket and IAM role&quot;](/ko/integrations/connectors/data-ingestion/AWS/creating-an-s3-iam-role-and-bucket)에서 생성한 S3 버킷 정책을 업데이트하십시오.
