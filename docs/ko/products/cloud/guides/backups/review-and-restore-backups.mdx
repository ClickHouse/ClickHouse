...
<div id="working-with-your-restored-service">
  ## 복원된 서비스 사용하기 {#working-with-your-restored-service}
</div>
...
<div id="use-the-new-restored-service">
  ### **새로 복원된 서비스** 사용 {#use-the-new-restored-service}
</div>
...
<div id="migrate-data-from-the-newly-restored-service-back-to-the-original-service">
  ### **새로 복원된 서비스**의 데이터를 **원본 서비스**로 다시 마이그레이션 {#migrate-data-from-the-newly-restored-service-back-to-the-original-service}
</div>
...
<div id="undeleting-or-undropping-tables">
  ## 삭제된 테이블 복구 {#undeleting-or-undropping-tables}
</div>
