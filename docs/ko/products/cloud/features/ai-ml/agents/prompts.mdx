...
<Image img="/images/cloud/agent-builder/prompts/create-prompt.webp" alt="왼쪽에서 + 버튼이 강조 표시된 Prompts 패널과 오른쪽에서 Prompt Name, Text, Category, Special variables, Description, Command 필드 및 Create Prompt 버튼이 표시된 Create Prompt 양식" size="lg" />
