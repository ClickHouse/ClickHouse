...
<Image img="/images/cloud/manage/openapi1.webp" size="sm" alt="API Key 탭" border />
...
<Image img="/images/cloud/manage/openapi2.webp" size="md" alt="API Key 페이지" border />
...
<Image img="/images/cloud/manage/openapi5.webp" size="md" alt="API Key 관리 페이지" border />
