...
Basic 티어의 데이터베이스 `100`개 및 테이블 `500`개 한도는 해당 티어의 단일 레플리카 서비스에만 적용됩니다. Scale 및 Enterprise 티어의 단일 레플리카 서비스에는 표준 서비스 가드레일이 적용됩니다. 자세한 내용은 [사용량 한도](/ko/products/cloud/guides/best-practices/usagelimits)를 참조하십시오.