...
<Image img="/images/cloud/reference/compute-compute-1.webp" size="md" alt="ClickHouse Cloud의 단일 서비스" caption="그림 1 - ClickHouse Cloud의 단일 서비스" />
...
<Image img="/images/cloud/reference/compute-compute-2.webp" size="md" alt="ClickHouse Cloud의 컴퓨트 분리" caption="그림 2 - ClickHouse Cloud의 컴퓨트 분리" />
...
<Image img="/images/cloud/reference/compute-compute-8.webp" size="lg" alt="기본 서비스와 보조 서비스가 있는 웨어하우스 예시" background="white" caption="그림 3 - 웨어하우스 예시" />
...
<Image img="/images/cloud/reference/compute-compute-3.webp" size="md" alt="동일한 데이터를 공유하는 서비스 간 사용자 액세스" caption="그림 4 - 사용자 Alice는 Service 1에서 생성되었지만, 동일한 자격 증명을 사용해 동일한 데이터를 공유하는 모든 서비스에 액세스할 수 있습니다" />
...
<Image img="/images/cloud/reference/compute-compute-4.webp" size="md" alt="네트워크 액세스 제어 설정" caption="그림 5 - 네트워크 액세스 제어 설정으로 인해 Alice는 서비스 2에 액세스할 수 없습니다" />
...
<Image img="/images/cloud/reference/compute-compute-5.webp" size="lg" alt="웨어하우스의 읽기-쓰기 및 읽기 전용 서비스" caption="그림 6 - 웨어하우스의 읽기-쓰기 및 읽기 전용 서비스" />
...
<Image img="/images/cloud/reference/compute-compute-7.webp" size="md" alt="웨어하우스에서 새 서비스 생성하기" caption="그림 7 - 더하기 기호를 클릭하여 웨어하우스에 새 서비스를 생성합니다" />
