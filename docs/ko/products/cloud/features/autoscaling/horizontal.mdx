...
<Image img="/images/cloud/manage/scaling-patch-request.webp" size="lg" alt="스케일링 PATCH 요청" border caption="`numReplicas`를 업데이트하는 `PATCH` 요청" />

<Image img="/images/cloud/manage/scaling-patch-response.webp" size="md" alt="스케일링 PATCH 응답" border caption="`PATCH` 요청에 대한 응답" />
...
<Image img="/images/cloud/manage/scaling-configure.webp" size="md" alt="스케일링 구성 설정" border caption="ClickHouse Cloud 콘솔의 서비스 스케일링 설정" />
