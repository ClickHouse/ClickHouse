---
sidebarTitle: '사용자 정의 FUNCTION'
slug: /cloud/features/user-defined-functions
title: 'Cloud의 사용자 정의 FUNCTION'
description: 'Cloud에 실행형 Python 사용자 정의 FUNCTION을 추가합니다'
doc_type: 'guide'
keywords: ['사용자 정의 FUNCTION', 'UDF']
---
...
UI에서 제공되는 모든 기능은 [ClickHouse Cloud API](/ko/cloud/manage/api/api-overview)를 통해 프로그래밍 방식으로도 사용할 수 있습니다.
