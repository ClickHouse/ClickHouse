...
### Scale (상시 실행, 자동 스케일링): 월 $499.38부터 {#scale-always-on-auto-scaling-from-49938-per-month}
...
### Enterprise: 시작 가격은 달라질 수 있습니다 {#enterprise-starting-prices-vary}
...
### 이전 요금 정보는 어디에서 확인할 수 있습니까? {#find-legacy-pricing}
...
### 디스크 스토리지는 어떻게 계산됩니까? {#how-is-storage-on-disk-calculated}
...
### 백업은 총 저장소 사용량에 포함됩니까? {#do-backups-count-toward-total-storage}
...
### 압축률은 어떻게 추정하나요? {#how-do-i-estimate-compression}
...
### 자가 관리형 배포를 사용 중인 경우, 클라우드에서 서비스 운영 비용을 추정할 수 있도록 ClickHouse는 어떤 도구를 제공하나요? {#what-tools-does-clickhouse-offer-to-estimate-the-cost-of-running-a-service-in-the-cloud-if-i-have-a-self-managed-deployment}
...
### ClickHouse Cloud에서 사용할 수 있는 청구 옵션은 무엇입니까? {#what-billing-options-are-available-for-clickhouse-cloud}
...
### 신용카드를 삭제할 수 있나요? {#can-i-delete-my-credit-card}
...
### 환불 내역은 어디에서 확인할 수 있나요? {#where-can-i-see-my-refunds}
...
### 활성화된 PAYG marketplace subscription이 있는 상태에서 약정 계약을 체결하면, 약정 크레딧이 먼저 소진됩니까? {#committed-credits-consumed-first-with-active-payg-subscription}
...
### ClickHouse Cloud는 Scale 및 Enterprise 서비스의 비용 관리를 위해 어떤 제어 기능을 제공합니까? {#what-controls-does-clickhouse-cloud-offer-to-manage-costs-for-scale-and-enterprise-services}
...
### Basic 서비스의 비용 관리를 위해 ClickHouse Cloud는 어떤 제어 기능을 제공합니까? {#what-controls-does-clickhouse-cloud-offer-to-manage-costs-for-basic-services}
...
### 여러 service가 있는 경우, service별로 인보이스가 발행됩니까, 아니면 통합 인보이스가 발행됩니까? {#if-i-have-multiple-services-do-i-get-an-invoice-per-service-or-a-consolidated-invoice}

특정 조직의 모든 service에 대해 청구 기간별로 하나의 통합 인보이스가 발행됩니다.

### 체험 기간과 크레딧이 만료되기 전에 신용카드를 추가하고 업그레이드하면 요금이 청구되나요? {#if-i-add-my-credit-card-and-upgrade-before-my-trial-period-and-credits-expire-will-i-be-charged}
...
### 지출 내역은 어떻게 확인할 수 있습니까? {#how-can-i-keep-track-of-my-spending}

ClickHouse Cloud 콘솔은 서비스별 사용량을 자세히 보여주는 사용량 표시를 제공합니다. 이 내역은 사용량 차원별로 구성되어 있어 각 계량 단위에 따른 비용을 파악하는 데 도움이 됩니다.

### ClickHouse Cloud 서비스 구독의 인보이스는 어떻게 확인합니까? {#how-do-i-access-my-invoice-for-my-subscription-to-the-clickhouse-cloud-service}
...
### 사용 내역서의 날짜가 AWS Marketplace 인보이스와 일치하지 않는 이유는 무엇인가요? {#why-do-the-dates-on-the-usage-statements-not-match-my-marketplace-invoice}
...
### 선불 크레딧 사용에 제한이 있습니까? {#are-there-any-restrictions-around-the-usage-of-prepaid-credits}
...
### 클라우드 제공업체 마켓플레이스를 통해 청구되든 ClickHouse에 직접 결제하든 ClickHouse Cloud 가격에 차이가 있습니까? {#is-there-a-difference-in-clickhouse-cloud-pricing-whether-paying-through-the-cloud-provider-marketplace-or-directly-to-clickhouse}
...
### 컴퓨트-컴퓨트 분리는 어떻게 과금되나요? {#how-is-compute-compute-separation-billed}
