...
<Tabs>
  <Tab title="AWS" id="aws-regions" icon="aws">
    ...
    | `ap-northeast-2` | <Badge color="yellow">공개</Badge> <Badge color="green">HIPAA</Badge> <Badge color="blue">PCI</Badge>  |
    ...
    | `ap-southeast-2` | <Badge color="yellow">공개</Badge> <Badge color="green">HIPAA</Badge> <Badge color="blue">PCI</Badge>  |
