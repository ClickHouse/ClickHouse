---
position: 2
slug: /ko/products/kubernetes-operator/guides/configuration
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencepodtemplatespec-for-all-supported-pod-template-options">
  ### 지원되는 모든 파드 템플릿 옵션은 [API 참조](/ko/products/kubernetes-operator/reference/api-reference#podtemplatespec)를 참조하십시오. {#see-api-reference-for-all-supported-pod-template-options}
</div>

<div id="pod-disruption-budgets">
  ## 파드 중단 예산 {#pod-disruption-budgets}
</div>
...
<div id="pdb-cluster-wide-disable">
  ### 클러스터 전체 비활성화 {#pdb-cluster-wide-disable}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencecontainertemplatespec-for-all-supported-container-template-options">
  ### 지원되는 모든 컨테이너 템플릿 옵션은 [API 참조](/ko/products/kubernetes-operator/reference/api-reference#containertemplatespec)에서 확인하십시오. {#see-api-reference-for-all-supported-container-template-options}
</div>
...
<div id="configure-secure-endpoints">
  ### 보안 endpoint 구성 {#configure-secure-endpoints}
</div>
...
<div id="ssl-certificate-secret-format">
  ### SSL 인증서 시크릿 포맷 {#ssl-certificate-secret-format}
</div>
...
<div id="external-secret-required-keys">
  ### 필수 키 {#external-secret-required-keys}
</div>
...
<div id="external-secret-policy">
  ### 정책: Observe와 Manage {#external-secret-policy}
</div>
...
<div id="external-secret-status">
  ### 상태 조건과 문제 해결 {#external-secret-status}
</div>
...
<div id="additional-ports-mysql-example">
  ### 종단 간 예시: MySQL wire protocol {#additional-ports-mysql-example}
</div>
...
<div id="additional-ports-constraints">
  ### 필드 제약 조건 {#additional-ports-constraints}
</div>
...
<div id="additional-ports-reserved">
  ### 예약된 포트 및 이름 {#additional-ports-reserved}
</div>
...
<div id="version-probe-and-upgrade-channel">
  ## 버전 프로브 및 업그레이드 채널 {#version-probe-and-upgrade-channel}
</div>
...
<div id="upgrade-channel-choosing">
  ### 릴리스 채널 선택 {#upgrade-channel-choosing}
</div>
...
<div id="version-status-conditions">
  ### 상태 조건 {#version-status-conditions}
</div>
...
<div id="version-probe-template">
  ### 버전 프로브 Job 재정의 {#version-probe-template}
</div>
...
<div id="version-operator-flags">
  ### Operator 전체 제어 {#version-operator-flags}
</div>
...
<div id="default-user-password">
  ### 기본 `default` 사용자 비밀번호 {#default-user-password}
</div>
...
<div id="default-password-secret-example">
  #### 시크릿을 사용하는 전체 예시 {#default-password-secret-example}
</div>
...
<div id="using-configmap-for-user-passwords">
  #### ConfigMap 사용하기 {#using-configmap-for-user-passwords}
</div>
...
<div id="embedded-extra-configuration">
  ### 내장 추가 구성 {#embedded-extra-configuration}
</div>
...
<div id="embedded-extra-users-configuration">
  ### 내장된 추가 사용자 구성 {#embedded-extra-users-configuration}
</div>
...
<div id="see-documentationconceptsfeaturesconfigurationsettingssettings-users-for-all-supported-clickhouse-users-configuration-options">
  #### 지원되는 모든 ClickHouse 사용자 구성 옵션은 [문서](/ko/concepts/features/configuration/settings/settings-users)를 참조하십시오. {#see-documentation-for-all-supported-clickhouse-users-configuration-options}
</div>
