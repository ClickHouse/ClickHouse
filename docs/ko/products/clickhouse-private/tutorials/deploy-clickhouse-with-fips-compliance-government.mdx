...
<Steps>
  <Step title="단계 1: FIPS 인증서 생성" id="phase-1-create-fips-certificates">
  ...
  <Step title="단계 2: Kubernetes 필수 구성 요소 설치" id="phase-2-install-kubernetes-prerequisites">
  ...
  <Step title="단계 3: Operator 설치" id="phase-3-install-operator">
  ...
  <Step title="단계 4: 인증서 시크릿 생성" id="phase-4-create-certificate-secrets">
  ...
  <Step title="5단계: ClickHouse 클러스터 배포" id="phase-5-deploy-clickhouse-cluster">
  ...
  <Step title="단계 6: 설치 확인" id="phase-6-verify-installation">
    ### TLS 포트로 포트 포워딩
