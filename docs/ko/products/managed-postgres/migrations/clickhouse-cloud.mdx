...
<Image img="/images/managed-postgres/pgpg/psqlimport.webp" alt="psql로 스키마를 가져온 후의 터미널 출력" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/tablepicker.webp" alt="5단계: Create migration 버튼이 있는 스키마별 그룹화 테이블 선택기" size="lg" border />
