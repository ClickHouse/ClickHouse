---
slug: /ko/products/managed-postgres/scaling
sidebarTitle: '스케일링'
title: '스케일링'
...
<div id="choosing-instance">
  ### 적합한 인스턴스 유형 선택 {#choosing-instance}
</div>
...
<div id="read-replicas">
  ### 수평 스케일링을 위한 읽기 레플리카 {#read-replicas}
</div>
...
<div id="cdc-scaling">
  ### ClickHouse integration의 CDC 스케일링 {#cdc-scaling}
</div>

[ClickPipes](/ko/products/managed-postgres/clickpipes)를 사용해 데이터를 ClickHouse로 복제하는 경우, CDC(Change Data Capture) 파이프라인을 독립적으로 스케일링할 수 있습니다:
