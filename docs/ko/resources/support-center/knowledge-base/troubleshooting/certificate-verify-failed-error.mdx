...
또는 클라이언트가 certifi 번들을 직접 사용하도록 지정할 수 있습니다. [ClickHouse Connect](/ko/integrations/language-clients/python)는 자동으로 certifi로 폴백되지 않으므로 번들을 `ca_cert` 매개변수로 전달하십시오:
