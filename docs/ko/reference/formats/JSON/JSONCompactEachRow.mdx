---
alias: []
description: 'JSONCompactEachRow 포맷에 대한 문서'
input_format: true
...
[`JSONEachRow`](/ko/reference/formats/JSON/JSONEachRow)와의 차이점은 데이터 행이 객체가 아니라 배열로 출력된다는 점뿐입니다.
...
`JSONCompactEachRow` 포맷으로 데이터를 읽습니다:
