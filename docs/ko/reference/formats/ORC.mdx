...
| ------------------------------------- | ----------------------------------------------------------------------------------- | --------------------- |
| `Boolean`                             | [Bool](/ko/reference/data-types/boolean)                                               | `Boolean`             |
...
| `Bigint`                              | [Int64/UInt64](/ko/reference/data-types/int-uint)                                      | `Bigint`              |
...
| `String`, `Varchar`, `Binary`          | [String](/ko/reference/data-types/string)                                              | `String`               |
| `Char`                                 | [FixedString](/ko/reference/data-types/fixedstring)                                    | `String`               |
...
| 설정                                                                                                                                                                                     | 설명                                                   | 기본값     |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ------- |
| [`output_format_orc_string_as_string`](/ko/reference/settings/formats#output_format_orc_string_as_string)                                                                                  | String 컬럼에 Binary 대신 ORC String 타입을 사용합니다.           | `true`   |
| [`output_format_orc_compression_method`](/ko/reference/settings/formats#output_format_orc_compression_method)                                                                             | 출력 ORC 포맷에서 사용하는 압축 방식입니다.                           | `zstd`  |
| [`input_format_orc_case_insensitive_column_matching`](/ko/reference/settings/formats#input_format_orc_case_insensitive_column_matching)                                                    | ORC 컬럼을 ClickHouse 컬럼과 매칭할 때 대소문자를 구분하지 않습니다.        | `false`  |
| [`input_format_orc_allow_missing_columns`](/ko/reference/settings/formats#input_format_orc_allow_missing_columns)                                                                          | ORC 데이터를 읽을 때 누락된 컬럼을 허용합니다.                         | `true`   |
| [`input_format_orc_skip_columns_with_unsupported_types_in_schema_inference`](/ko/reference/settings/formats#input_format_orc_skip_columns_with_unsupported_types_in_schema_inference)      | ORC 형식의 스키마 추론 중 지원되지 않는 타입의 컬럼을 스키핑할 수 있도록 허용합니다.   | `false`  |
