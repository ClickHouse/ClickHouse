...
* `x1[, x2, ...]` — 비교할 하나 이상의 값입니다. 모든 인수는 서로 비교 가능한 타입이어야 합니다. [`Any`](/ko/reference/data-types/index)

**반환 값**

인수 중 가장 큰 값을 반환하며, 호환되는 가장 큰 타입으로 승격됩니다. [`Any`](/ko/reference/data-types/index)
