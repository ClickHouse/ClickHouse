...
`WHERE` 절 뒤의 표현식은 [비교](/ko/reference/operators/index#comparison-operators) 및 [논리 연산자](/ko/reference/operators/index#operators-for-working-with-data-sets), 또는 여러 [일반 함수](/ko/reference/functions/regular-functions/overview)와 함께 자주 사용됩니다.
