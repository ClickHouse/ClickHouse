...
<Note>
  ...
  * [`display_secrets_in_show_and_select`](/ko/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select) (server 설정)
  * [`format_display_secrets_in_show_and_select` ](/ko/reference/settings/formats/format#format_display_secrets_in_show_and_select) (포맷 설정)
