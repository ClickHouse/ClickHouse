...
<Info>
  ...
  설정 [`allow_experimental_ytsaurus_dictionary_source`](/ko/reference/settings/session-settings/allow-experimental#allow_experimental_ytsaurus_dictionary_source)을 사용하여
