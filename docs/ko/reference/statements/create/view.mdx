...
<Warning>
  **Deprecated**
  ...
  윈도우 뷰는 더 이상 사용되지 않으며 향후 릴리스에서 제거될 수 있습니다. 이 기능은 계속해서 [allow&#95;experimental&#95;window&#95;view](/ko/reference/settings/session-settings/allow-experimental#allow_experimental_window_view) 설정(`SET allow_experimental_window_view = 1`)을 통해서만 사용할 수 있으며, 새로 사용하는 것은 권장하지 않습니다.
</Warning>
