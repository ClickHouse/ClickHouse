  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "샘플 데이터셋", href: "/get-started/sample-datasets/index" },
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "SQL 레퍼런스", href: "/reference/statements" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. 일반적인 데이터 소스에서 최소한의 작업으로 데이터를 수집하는 방법", href: "/integrations" },
              { label: "2. analytics와 확장성을 위해 데이터를 구성하는 모범 사례", href: "/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. 대규모 데이터셋을 실시간으로 쿼리하는 방법", href: "/get-started/use-cases/real-time-analytics" },
              { label: "4. 그 위에 대시보드, 알림, 이벤트 기반 기능을 구축하는 방법", href: "/get-started/use-cases/data-warehousing" },
              { label: "5. 높은 성능을 유지하면서 비용을 낮추는 팁", href: "/concepts/best-practices/index" },
          ]}
            />
          </div>
