    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" galaxyEvent="docs.home.chdb" description="빠르고 안정적이며 확장 가능한 in-process 데이터베이스입니다. 프로세스 내에서 ClickHouse의 강력함을 경험할 수 있습니다." href="/chdb/index" showArrow />
        </div>
      </div>
