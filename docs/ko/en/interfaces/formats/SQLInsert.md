...
이 포맷으로 출력된 데이터를 읽으려면 [MySQLDump](../formats/MySQLDump.md) 입력 형식을 사용할 수 있습니다.
...
| [`output_format_sql_insert_table_name`](../../operations/settings/settings-formats.md/#output_format_sql_insert_table_name)                     | 출력 INSERT 쿼리에 사용할 테이블 이름입니다.       | `'table'` |
...
| [`output_format_sql_insert_quote_names`](../../operations/settings/settings-formats.md/#output_format_sql_insert_quote_names)                   | 컬럼 이름을 &quot;&#96;&quot; 문자로 묶습니다. | `true`    |