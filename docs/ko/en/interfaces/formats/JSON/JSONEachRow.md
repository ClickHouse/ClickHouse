...
이 포맷에서는 ClickHouse가 각 행을 줄바꿈으로 구분되는 개별 JSON 객체로 출력합니다.
...
이름을 알 수 없는 데이터 컬럼은 [input&#95;format&#95;skip&#95;unknown&#95;fields](/ko/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) 설정이 1로 설정된 경우 가져올 때 건너뜁니다.
