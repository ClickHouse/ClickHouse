...
description: 'TabSeparatedRawWithNamesAndTypes 포맷에 대한 참고 문서'
input_format: true
...
[`TabSeparatedWithNamesAndTypes`](./TabSeparatedWithNamesAndTypes.md) 포맷과의 차이점은
행이 escaping 없이 기록된다는 점입니다.

:::note
이 포맷으로 parsing할 때는 각 필드에 탭이나 줄바꿈이 허용되지 않습니다.
:::
