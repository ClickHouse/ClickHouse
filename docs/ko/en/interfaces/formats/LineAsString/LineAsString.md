...
나머지 컬럼은 [`DEFAULT`](/ko/sql-reference/statements/create/table.md/#default), [`MATERIALIZED`](/ko/sql-reference/statements/create/view#materialized-view)로 설정하거나 생략해야 합니다.
