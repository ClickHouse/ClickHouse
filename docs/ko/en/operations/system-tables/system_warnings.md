---
description: '이 테이블에는 ClickHouse 서버 관련 경고 메시지가 포함되어 있습니다.'
...
* [max&#95;pending&#95;mutations&#95;execution&#95;time&#95;to&#95;warn](/ko/operations/server-configuration-parameters/settings#max_pending_mutations_execution_time_to_warn)
* [max&#95;named&#95;collection&#95;num&#95;to&#95;warn](../server-configuration-parameters/settings.md#max_named_collection_num_to_warn)
* [resource&#95;overload&#95;warnings](/ko/operations/settings/server-overload#resource-overload-warnings)
...
* `message_format_string` ([LowCardinality(String)](../../sql-reference/data-types/string.md)) — 메시지 포맷에 사용되는 포맷 문자열.
