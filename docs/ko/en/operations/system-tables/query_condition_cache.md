---
description: '쿼리 조건 캐시의 내용을 보여주는 시스템 테이블입니다.'
...
[쿼리 조건 캐시](../query-condition-cache.md)의 내용을 보여줍니다.
...
* `key_hash` ([UInt128](/ko/sql-reference/data-types/int-uint)) — (table&#95;uuid, part&#95;name, condition&#95;hash)의 해시값입니다.
* `entry_size` ([UInt64](/ko/sql-reference/data-types/int-uint)) — 항목의 크기(바이트 단위)입니다.
* `matching_marks` ([String](/ko/sql-reference/data-types/string)) — 일치하는 마크입니다.
