---
description: 'nth_value 윈도 함수 문서'
...
정렬된 프레임에서 n번째 행(오프셋)을 기준으로 평가한 첫 번째 non-NULL 값을 반환합니다.
...
윈도 함수 구문에 대한 자세한 내용은 [Window Functions - Syntax](./index.md/#syntax)를 참조하십시오.
...
* 정렬된 프레임에서 n번째 행(`offset`)을 기준으로 평가한 첫 번째 NULL이 아닌 값입니다.

**예시**

이 예시에서는 `nth-value` 함수를 사용하여 가상의 프리미어리그 축구 선수 급여 데이터셋에서 세 번째로 높은 급여를 찾습니다.
