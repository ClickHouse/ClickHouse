...
현재 행에 속한 파티션 내에서 1부터 시작하는 번호를 매깁니다.
...
* 현재 행이 속한 파티션 내에서의 번호입니다. [UInt64](../data-types/int-uint.md).

**예시**

다음 예시는 동영상 가이드 [Ranking window functions in ClickHouse](https://youtu.be/Yku9mmBYm_4?si=XIMu1jpYucCQEoXA)에서 제공된 예시를 바탕으로 합니다.
