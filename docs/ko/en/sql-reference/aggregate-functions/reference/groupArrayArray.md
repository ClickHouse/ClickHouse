---
description: '배열들을 하나의 더 큰 배열로 집계합니다.'
...
[`groupArray`](/ko/sql-reference/aggregate-functions/reference/grouparray) 함수와 [배열](/ko/sql-reference/aggregate-functions/combinators#-array) combinator를 결합합니다.

별칭: `array_concat_agg`

**예시**

사용자 브라우징 세션을 기록한 데이터가 있습니다. 각 세션에는 특정 사용자가 방문한 페이지의 시퀀스가 기록됩니다.
`groupArrayArray` 함수를 사용하면 각 사용자의 페이지 방문 패턴을 분석할 수 있습니다.
