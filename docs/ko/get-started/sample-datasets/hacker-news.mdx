...
<Steps>
  <Step title="데이터를 삽입합니다" id="insert-the-data">
  ...
  <Step title="쿼리 속도를 높이기 위한 스키핑 인덱스 추가" id="add-skipping-index">
    ...
    [`EXPLAIN`](/ko/reference/statements/explain) 절을 사용하면 이 인덱스를 추가했을 때 쿨리 성능이 약 3.4배 향상된 이유를 이해할 수 있습니다.
