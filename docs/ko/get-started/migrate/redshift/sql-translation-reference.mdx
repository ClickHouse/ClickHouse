...
<sub><span>*</span> ClickHouse는 추가로 더 넓은 범위의 부호 없는 정수도 지원합니다. 즉, <a href="/ko/sql-reference/data-types/int-uint">`UInt8`, `UInt32`, `UInt32` and `UInt64`</a>입니다.</sub><br />
<sub><span>**</span>ClickHouse의 String 타입은 기본적으로 길이 제한이 없지만, <a href="/ko/sql-reference/statements/create/table#constraints">제약 조건</a>을 사용해 특정 길이로 제한할 수 있습니다.</sub>
