...
slug: /ko/get-started/migrate/bigquery/overview
...
<div id="bigquery-projects-vs-clickhouse-cloud-services">
  ### BigQuery 프로젝트와 ClickHouse Cloud 서비스 비교 {#bigquery-projects-vs-clickhouse-cloud-services}
</div>
...
<div id="bigquery-datasets-vs-clickhouse-cloud-databases">
  ### BigQuery 데이터셋 vs ClickHouse Cloud 데이터베이스 {#bigquery-datasets-vs-clickhouse-cloud-databases}
</div>
...
<div id="bigquery-slot-reservations-and-quotas">
  ### BigQuery 슬롯 예약 및 쿼터 {#bigquery-slot-reservations-and-quotas}
</div>
...
<div id="query-acceleration-techniques">
  ## 쿼리 가속 기법 {#query-acceleration-techniques}
</div>

<div id="primary-and-foreign-keys-and-primary-index">
  ### 프라이머리 키, 외래 키 및 프라이머리 인덱스 {#primary-and-foreign-keys-and-primary-index}
</div>
...
<div id="querying-materialized-views">
  ## materialized view 쿼리 {#querying-materialized-views}
</div>
...
<div id="data-sources-and-file-formats">
  ## 데이터 소스와 파일 포맷 {#data-sources-and-file-formats}
</div>
