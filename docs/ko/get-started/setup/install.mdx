...
<div className="ch-install-cloud-card">
  ...
  <div className="ch-install-cloud-actions">
    ...
    <a
      ...
      href="https://clickhouse.com/docs/ko/get-started/setup/cloud"
      onClick={(event) => { event.preventDefault(); window.location.href = withDocsBase('/ko/get-started/setup/cloud'); }}
    >
      빠른 시작 튜토리얼 읽기
    </a>
  </div>
