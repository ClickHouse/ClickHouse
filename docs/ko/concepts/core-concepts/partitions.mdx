...
이는 ClickHouse가 쿼리 결과를 계산하기 위해 6밀리초 동안 1개의 granule([8192](/ko/reference/settings/merge-tree-settings/index-granularity#index_granularity)행으로 이루어진 블록)을 스캔하고 처리했다는 의미입니다.
