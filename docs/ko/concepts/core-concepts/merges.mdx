...
**④ 압축 및 저장**: 새 컬럼 파일과 인덱스를 [압축](/ko/reference/statements/create/table/codec)한 뒤, 머지된 데이터 파트를 나타내는 새 [디렉터리](/ko/concepts/core-concepts/parts#what-are-table-parts-in-clickhouse)에 저장합니다.
