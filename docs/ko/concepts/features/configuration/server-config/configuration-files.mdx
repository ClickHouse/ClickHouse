...
sidebarTitle: '설정 파일'
slug: /ko/concepts/features/configuration/server-config/configuration-files
title: '설정 파일'
doc_type: 'guide'
---
...
<div id="from_env_zk">
  ### 환경 변수 및 ZooKeeper 노드를 사용한 치환 {#from_env_zk}
</div>
...
<div id="substitution-with-file-content">
  ## 파일 내용으로 치환 {#substitution-with-file-content}
</div>
