...
sidebarTitle: 'JWT'
slug: /ko/concepts/features/security/external-authenticators/jwt
title: 'JWT 인증'
doc_type: 'reference'
---
...
<div id="example-token-header-and-payload">
  ### 토큰 헤더와 페이로드 예시 {#example-token-header-and-payload}
</div>
...
<div id="persistent-access-assignments">
  ### 영구적인 액세스 할당 {#persistent-access-assignments}
</div>
...
<div id="passing-token-directly">
  ### 토큰 직접 전달하기 {#passing-token-directly}
</div>
...
<div id="clickhouse-cloud-built-in">
  ## ClickHouse Cloud 내장 JWT 인증자 {#clickhouse-cloud-built-in}
</div>
...
<div id="enabling-jwt-authentication-for-your-service">
  ## 서비스에 JWT 인증 활성화하기 {#enabling-jwt-authentication-for-your-service}
</div>
