---
slug: /ko/concepts/features/security/tls/configuring-tls
sidebarTitle: 'TLS 구성'
title: 'TLS 구성'
...
<div id="configure-openssl-for-standalone-clickhouse-keeper">
  ## 독립 실행형 ClickHouse Keeper용 OpenSSL 구성 {#configure-openssl-for-standalone-clickhouse-keeper}
</div>
...
<div id="openssl-verification-modes">
  ## OpenSSL 검증 모드 및 인증서 핸들러 {#openssl-verification-modes}
</div>
