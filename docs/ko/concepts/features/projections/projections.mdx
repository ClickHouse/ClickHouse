---
slug: /ko/concepts/features/projections/projections
title: '프로젝션'
...
<div id="when-to-use-projections">
  ## 프로젝션은 언제 사용해야 하나요? {#when-to-use-projections}
</div>
...
<div id="filtering-without-using-primary-keys">
  ### 프라이머리 키에 없는 컬럼으로 필터링하기 {#filtering-without-using-primary-keys}
</div>
...
<div id="combining-projections">
  ### 하나의 쿼리에서 프로젝션 결합하기 {#combining-projections}
</div>
