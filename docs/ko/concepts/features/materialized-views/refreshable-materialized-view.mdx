---
slug: /ko/concepts/features/materialized-views/refreshable-materialized-view
title: '갱신 가능 구체화 뷰'
...
<div id="when-should-refreshable-materialized-views-be-used">
  ## 갱신 가능 구체화 뷰는 언제 사용해야 하나요? {#when-should-refreshable-materialized-views-be-used}
</div>
...
<div id="when-was-a-refreshable-materialized-view-last-refreshed">
  ## 갱신 가능 구체화 뷰가 마지막으로 갱신된 시점은 언제입니까? {#when-was-a-refreshable-materialized-view-last-refreshed}
</div>
...
<div id="how-can-i-change-the-refresh-rate">
  ## 갱신 주기는 어떻게 변경하나요? {#how-can-i-change-the-refresh-rate}
</div>
...
<div id="using-append-to-add-new-rows">
  ## 새 행을 추가할 때 `APPEND` 사용하기 {#using-append-to-add-new-rows}
</div>
