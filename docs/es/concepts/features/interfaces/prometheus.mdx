...
## Exponer métricas del servidor ClickHouse {#expose}
...
## API HTTP de Prometheus y PromQL {#prometheus-http-api-and-promql}
...
### Configure la API de Prometheus {#configure-prometheus-api}
