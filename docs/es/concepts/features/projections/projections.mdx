---
slug: /es/concepts/features/projections/projections
title: 'Proyecciones'
...
<div id="smarter_storage_with_part_offset">
  ### Almacenamiento más inteligente con `_part_offset` {#smarter_storage_with_part_offset}
</div>
...
<div id="when-to-use-projections">
  ## ¿Cuándo usar proyecciones? {#when-to-use-projections}
</div>
...
<div id="filtering-without-using-primary-keys">
  ### Filtrado por columnas que no están en la clave primaria {#filtering-without-using-primary-keys}
</div>
...
<div id="average-price-projections">
  #### Consulta 1. Precio medio por año {#average-price-projections}
</div>
...
<div id="average-price-london-projections">
  #### Consulta 2. Precio promedio por año en Londres {#average-price-london-projections}
</div>
...
<div id="most-expensive-neighborhoods-projections">
  #### Consulta 3. Los barrios más caros {#most-expensive-neighborhoods-projections}
</div>
...
<div id="combining-projections">
  ### Combinar proyecciones en una sola consulta {#combining-projections}
</div>
