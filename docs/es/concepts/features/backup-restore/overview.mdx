...
para evitar algunos tipos de errores; por ejemplo, de forma [predeterminada](/es/reference/settings/session-settings/max#max_table_size_to_drop)
...
* ser [síncronas o asíncronas](#synchronous-vs-asynchronous)
* ser [síncronas o asíncronas](#synchronous-vs-asynchronous)
...
* hacerse de [tablas del sistema, tablas de registro o tablas de gestión de acceso](#system-backups)
