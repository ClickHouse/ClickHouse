...
Un puerto de introspección es un endpoint de [protocolo componible](/es/operations/settings/composable-protocols) marcado con `<introspection>true</introspection>`. De forma predeterminada, no hay ningún puerto de introspección configurado:
