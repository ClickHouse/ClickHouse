...
slug: /es/concepts/features/configuration/server-config/configuration-files
...
<div id="merging">
  ## Combinación de archivos de configuración {#merging}
</div>
...
<div id="from_env_zk">
  ### Sustitución por variables de entorno y nodos de ZooKeeper {#from_env_zk}
</div>
...
<div id="substitution-with-file-content">
  ## Sustitución con contenido de archivos {#substitution-with-file-content}
</div>
...
<div id="encryption">
  ## Cifrado y ocultación de la configuración {#encryption}
</div>
...
<div id="user-settings">
  ## Configuración de usuarios {#user-settings}
</div>
