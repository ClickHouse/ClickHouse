...
slug: /es/concepts/features/performance/caches/query-cache
...
<div id="background-design-and-limitations">
  ## Antecedentes, diseño y limitaciones {#background-design-and-limitations}
</div>
...
<div id="configuration-settings-and-usage">
  ## Ajustes de configuración y uso {#configuration-settings-and-usage}
</div>
...
<div id="subquery-caching">
  ## Almacenamiento en caché de subconsultas {#subquery-caching}
</div>
