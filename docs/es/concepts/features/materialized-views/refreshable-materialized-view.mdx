---
slug: /es/concepts/features/materialized-views/refreshable-materialized-view
...
<div id="when-should-refreshable-materialized-views-be-used">
  ## ¿Cuándo se deben usar las vistas materializadas actualizables? {#when-should-refreshable-materialized-views-be-used}
</div>
...
<div id="when-was-a-refreshable-materialized-view-last-refreshed">
  ## ¿Cuándo se actualizó por última vez una vista materializada actualizable? {#when-was-a-refreshable-materialized-view-last-refreshed}
</div>
...
<div id="how-can-i-change-the-refresh-rate">
  ## ¿Cómo puedo cambiar la frecuencia de actualización? {#how-can-i-change-the-refresh-rate}
</div>
...
<div id="using-append-to-add-new-rows">
  ## Uso de `APPEND` para añadir nuevas filas {#using-append-to-add-new-rows}
</div>
