---
slug: /es/concepts/features/security/tls/configuring-tls
...
<div id="configure-openssl-for-standalone-clickhouse-keeper">
  ## Configurar OpenSSL para ClickHouse Keeper en modo independiente {#configure-openssl-for-standalone-clickhouse-keeper}
</div>
...
<div id="openssl-verification-modes">
  ## Modos de verificación de OpenSSL y manejadores de certificados {#openssl-verification-modes}
</div>
...
<div id="verification-modes">
  ### Modos de verificación {#verification-modes}
</div>
...
<div id="invalid-certificate-handlers">
  ### Manejadores de certificados no válidos {#invalid-certificate-handlers}
</div>
...
<div id="disabling-certificate-verification">
  ### Ejemplo: desactivar la verificación de certificados {#disabling-certificate-verification}
</div>
