...
sidebarTitle: 'JWT'
slug: /es/concepts/features/security/external-authenticators/jwt
...
<div id="required-claims">
  ### Claims obligatorios {#required-claims}
</div>
...
<div id="other-recognized-claims">
  ### Otros claims reconocidos {#other-recognized-claims}
</div>
...
<div id="optional-claims">
  ### Claims opcionales {#optional-claims}
</div>
...
<div id="example-token-header-and-payload">
  ### Ejemplo de encabezado y carga útil de un token {#example-token-header-and-payload}
</div>
...
<div id="ephemeral-user-behavior">
  ## Comportamiento de los usuarios efímeros {#ephemeral-user-behavior}
</div>
...
<div id="identity-and-naming">
  ### Identidad y nombres {#identity-and-naming}
</div>
...
<div id="access-rights">
  ### Permisos de acceso {#access-rights}
</div>
...
<div id="token-freshness">
  ### Vigencia del token {#token-freshness}
</div>
...
<div id="lifetime-and-garbage-collection">
  ### Tiempo de vida y recolección de basura {#lifetime-and-garbage-collection}
</div>
...
<div id="persistent-access-assignments">
  ### Asignaciones persistentes de acceso {#persistent-access-assignments}
</div>
...
<div id="differences-from-regular-users">
  ## Diferencias con los usuarios normales {#differences-from-regular-users}
</div>
...
<div id="sql-security-definer-views">
  ## Vistas con SQL SECURITY DEFINER {#sql-security-definer-views}
</div>
...
<div id="client-usage">
  ## Uso del cliente {#client-usage}
</div>

<div id="passing-token-directly">
  ### Pasar un token directamente {#passing-token-directly}
</div>
...
<div id="oauth2-device-code-login">
  ### Inicio de sesión con código de dispositivo de OAuth2 {#oauth2-device-code-login}
</div>
...
<div id="clickhouse-cloud-built-in">
  ## Autenticador JWT integrado de ClickHouse Cloud {#clickhouse-cloud-built-in}
</div>
...
<div id="enabling-jwt-authentication-for-your-service">
  ## Habilitar la autenticación con JWT para su servicio {#enabling-jwt-authentication-for-your-service}
</div>
...
<div id="interserver-communication">
  ## Comunicación entre servidores {#interserver-communication}
</div>
