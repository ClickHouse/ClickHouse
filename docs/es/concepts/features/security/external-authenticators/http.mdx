...
slug: /es/concepts/features/security/external-authenticators/http
title: 'HTTP'
doc_type: 'referencia'
---
...
<div id="http-auth-server-definition">
  ## Definición del servidor de autenticación HTTP {#http-auth-server-definition}
</div>
...
<div id="enabling-http-auth-using-sql">
  ### Habilitación de la autenticación HTTP mediante SQL {#enabling-http-auth-using-sql}
</div>
...
<div id="passing-session-settings">
  ### Pasar ajustes de sesión {#passing-session-settings}
</div>
