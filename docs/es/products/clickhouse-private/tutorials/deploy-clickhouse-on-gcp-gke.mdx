...
<Steps>
  <Step stepNumber={0}>
    ## Paso 0: Configuración de la cuenta de servicio
  ...
  <Step stepNumber={1}>
    ## Paso 1: Configurar variables de entorno (`00-env.sh`)
  ...
  <Step stepNumber={2}>
    ## Paso 2: Crear Artifact Registry (`01-artifact-registry.sh`)
  ...
  <Step stepNumber={3}>
    ## Paso 3: Copiar imágenes de contenedor (`02-copy-images.sh`)
  ...
  <Step stepNumber={4}>
    ## Paso 4: Configurar la VPC y la subred (`03-vpc-subnet.sh`)
  ...
  <Step stepNumber={5}>
    ## Paso 5: Crear Cloud NAT (`04-cloud-nat.sh`)
  ...
  <Step stepNumber={6}>
    ## Paso 6: Crear una cuenta de servicio de GCP (`05-service-account.sh`)
  ...
  <Step stepNumber={7}>
    ## Paso 7: Crear un bucket de GCS (`06-gcs-bucket.sh`)
  ...
  <Step stepNumber={8}>
    ## Paso 8: Crear clúster de GKE (`07-gke-cluster.sh`)
  ...
  <Step stepNumber={9}>
    ## Paso 9: Crear grupos de nodos (`08-node-pools.sh`)
  ...
  <Step stepNumber={10}>
    ## Paso 10: Desplegar el conjunto de daemon de Local SSD (`09-local-ssd-daemonset.sh`)
  ...
  <Step stepNumber={11}>
    ## Paso 11: Agregar etiquetas de topología (`10-topology-labels.sh`)
  ...
  <Step stepNumber={12}>
    ## Paso 12: Instalar los requisitos previos de Kubernetes
  ...
  <Step stepNumber={13}>
    ## Paso 13: Pasos de FIPS (condicional)
  ...
  <Step stepNumber={14}>
    ## Paso 14: Instalar el operador (`16-install-operator.sh`)
  ...
  <Step stepNumber={15}>
    ## Paso 15: Desplegar el clúster de ClickHouse (`17-install-cluster.sh`)
  ...
  <Step stepNumber={16}>
    ## Paso 16: Vincular Workload Identity (`18-bind-helm-workload-identity.sh`)
  ...
  <Step stepNumber={17}>
    ## Paso 17: Verificar la instalación
