...
* **PrivateLink** (AWS) / **Private Service Connect** (GCP) — el hostname del endpoint privado del proveedor de Cloud. Solo aparece cuando [PrivateLink or Private Service Connect](#privatelink-or-private-service-connect) está habilitado.
