...
description: 'Configure ClickHouse Connector: instancias de ClickHouse, listas de permitidos de operadores, políticas de red, redacción, réplica privada y almacenamiento'
