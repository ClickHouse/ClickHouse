...
En modo gestionado, ClickHouse Cloud solo modifica los servicios que le pediste gestionar. Cualquier persona con acceso al host o al pod del executor también puede controlarlos con los comandos locales `clicklink clctl instances`; consulta el [ciclo de vida del servicio](/es/products/bring-your-own-cloud/connector/managed-services#service-lifecycle). ClickHouse Cloud envía los comandos de ciclo de vida por el canal saliente del executor:
