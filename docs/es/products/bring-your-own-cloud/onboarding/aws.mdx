...
1. Vaya al VPC Dashboard de la cuenta BYOC de ClickHouse.
2. Seleccione Peering Connections.
3. Haga clic en Create Peering Connection
4. Establezca VPC Requester como el ID de ClickHouse VPC.
...
1. Seleccione Route Tables en VPC Dashboard.
