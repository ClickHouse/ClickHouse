...
<Steps>
  <Step title="Habilitar el balanceador de carga privado para ClickHouse BYOC" id="step-1-enable-private-load-balancer-for-clickhouse-byoc">
    Ponte en contacto con soporte de ClickHouse para habilitar el balanceador de carga privado.
  </Step>

  <Step title="Crear una conexión de peering" id="step-2-create-a-peering-connection">
    1. Ve al VPC Dashboard de la cuenta de ClickHouse BYOC.
    2. Selecciona Peering Connections.
    3. Haz clic en Create Peering Connection.
    4. Establece VPC Requester con el VPC ID de ClickHouse.
    5. Establece VPC Accepter con el VPC ID de destino. (Selecciona otra cuenta si corresponde)
    6. Haz clic en Create Peering Connection.

    <br />

    <img src="/images/cloud/reference/byoc-vpcpeering-1.webp" alt="BYOC Crear conexión de peering" />

    <br />
  </Step>

  <Step title="Aceptar la solicitud de conexión de peering" id="step-3-accept-the-peering-connection-request">
    Ve a la cuenta de peering; en la página (VPC -&gt; Peering connections -&gt; Actions -&gt; Accept request), el cliente puede aprobar esta solicitud de peering de VPC.
  ...
  <Step title="Agregar el destino a las tablas de rutas de la VPC de ClickHouse" id="step-4-add-destination-to-clickhouse-vpc-route-tables">
    En la cuenta de ClickHouse BYOC,

    1. Selecciona Route Tables en el VPC Dashboard.
    2. Busca el VPC ID de ClickHouse. Edita cada tabla de rutas asociada a las subredes privadas.
    3. Haz clic en el botón Edit en la pestaña Routes.
    4. Haz clic en Add another route.
    5. Introduce el rango CIDR de la VPC de destino en Destination.
    6. Selecciona “Peering Connection” y el ID de la conexión de peering en Target.

    <br />

    <img src="/images/cloud/reference/byoc-vpcpeering-3.webp" alt="BYOC Agregar tabla de rutas" />

    <br />
  </Step>

  <Step title="Agregar el destino a las tablas de rutas de la VPC de destino" id="step-5-add-destination-to-the-target-vpc-route-tables">
    En la cuenta de AWS de peering,

    1. Selecciona Route Tables en el VPC Dashboard.
    2. Busca el VPC ID de destino.
    3. Haz clic en el botón Edit en la pestaña Routes.
    4. Haz clic en Add another route.
    5. Introduce el rango CIDR de la VPC de ClickHouse en Destination.
    6. Selecciona “Peering Connection” y el ID de la conexión de peering en Target.

    <br />

    <img src="/images/cloud/reference/byoc-vpcpeering-4.webp" alt="BYOC Agregar tabla de rutas" />

    <br />
  </Step>

  <Step title="Edita el Security Group para permitir el acceso desde la VPC emparejada" id="step-6-edit-security-group-to-allow-peered-vpc-access">
