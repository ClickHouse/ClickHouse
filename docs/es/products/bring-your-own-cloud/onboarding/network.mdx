...
| Página                                                                                               | Descripción                                |
| ---------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| [Configuración de red privada de BYOC en AWS](/es/products/bring-your-own-cloud/onboarding/network-aws) | Configure la red privada para BYOC en AWS. |
| [Configuración de red privada de BYOC en GCP](/es/products/bring-your-own-cloud/onboarding/network-gcp) | Configure la red privada para BYOC en GCP. |