...
<Steps>
  <Step>
    ### Configurar el rol de administración sin permisos de escritura de IAM
  ...
  <Step>
    ### Crear los roles de IAM por infraestructura
  ...
  <Step>
    ### Mantener actualizados los roles por infraestructura
