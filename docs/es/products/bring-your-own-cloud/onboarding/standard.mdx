...
<Steps>
  ...
  <Step>
    ...
    Se te pedirá que configures la infraestructura, incluidos los buckets de almacenamiento de objetos, la VPC/VNet y el clúster de Kubernetes, desde la consola web de ClickHouse Cloud. Hay ciertas configuraciones que deben definirse en esta etapa, ya que no podrán cambiarse más adelante. En concreto:
