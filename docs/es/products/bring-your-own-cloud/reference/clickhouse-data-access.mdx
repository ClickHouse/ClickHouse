...
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Exportador de estado   | Estado del servicio y de las copias de seguridad (salud, estado — eventos operativos, no el contenido de las copias de seguridad) a una cola `SQS` propiedad de ClickHouse Cloud. |
| Scraper de facturación | Métricas de CPU y memoria a un bucket de almacenamiento de objetos propiedad de ClickHouse Cloud.                                                                                 |
