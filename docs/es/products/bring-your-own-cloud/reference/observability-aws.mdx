...
<div id="prometheus-monitoring">
  ## Enfoques de monitorización con Prometheus {#prometheus-monitoring}
</div>
...
<div id="monitoring-approaches-comparison">
  ### Comparación de métodos de monitoreo {#monitoring-approaches-comparison}
</div>
...
<div id="builtin-prometheus-stack">
  ## La stack integrada de Prometheus de BYOC {#builtin-prometheus-stack}
</div>
...
<div id="prometheus-stack-integration">
  ### Integración con sus herramientas de monitorización {#prometheus-stack-integration}
</div>
...
<div id="direct-prometheus-integration">
  ## Integración de Prometheus para el servicio de ClickHouse {#direct-prometheus-integration}
</div>
