...
omites (rutas de los certificados, configuración de la CA) se conservan. Consulta la
[configuración del servidor `openSSL`](/es/reference/settings/server-settings/settings/other#openssl)
...
* [Configuración del servidor `openSSL`](/es/reference/settings/server-settings/settings/other#openssl) — opciones de TLS que se pueden sobrescribir mediante `extraConfig`