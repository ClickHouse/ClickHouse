---
position: 2
slug: /es/products/kubernetes-operator/guides/configuration
...
<div id="clickhousecluster-configuration">
  ## Configuración de ClickHouseCluster {#clickhousecluster-configuration}
</div>
...
<div id="replicas-and-shards">
  ### Réplicas y segmentos {#replicas-and-shards}
</div>
...
<div id="keeper-integration">
  ### Integración de Keeper {#keeper-integration}
</div>
...
<div id="keepercluster-configuration">
  ## Configuración de KeeperCluster {#keepercluster-configuration}
</div>
...
<div id="cluster-domain">
  ## Dominio del clúster {#cluster-domain}
</div>
...
<div id="pod-configuration">
  ## Configuración del pod de Kubernetes {#pod-configuration}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencepodtemplatespec-for-all-supported-pod-template-options">
  ### Consulta la [Referencia de la API](/es/products/kubernetes-operator/reference/api-reference#podtemplatespec) para ver todas las opciones compatibles de la plantilla de pod de Kubernetes. {#see-api-reference-for-all-supported-pod-template-options}
</div>

<div id="pod-disruption-budgets">
  ## Presupuestos de interrupción de pods {#pod-disruption-budgets}
</div>
...
<div id="pdb-defaults">
  ### Valores predeterminados {#pdb-defaults}
</div>
...
<div id="pdb-overrides">
  ### Sobrescribir los valores predeterminados {#pdb-overrides}
</div>
...
<div id="pdb-cluster-wide-disable">
  ### Desactivación a nivel de clúster {#pdb-cluster-wide-disable}
</div>
...
<div id="container-configuration">
  ## Configuración del contenedor {#container-configuration}
</div>
...
<div id="container-resources">
  ### Recursos de los contenedores {#container-resources}
</div>
...
<div id="volume-mounts">
  ### Montajes de volúmenes {#volume-mounts}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencecontainertemplatespec-for-all-supported-container-template-options">
  ### Consulta la [referencia de la API](/es/products/kubernetes-operator/reference/api-reference#containertemplatespec) para ver todas las opciones compatibles de la plantilla de contenedor. {#see-api-reference-for-all-supported-container-template-options}
</div>

<div id="tls-ssl-configuration">
  ## Configuración de TLS/SSL {#tls-ssl-configuration}
</div>

<div id="configure-secure-endpoints">
  ### Configurar endpoints seguros {#configure-secure-endpoints}
</div>
...
<div id="ssl-certificate-secret-format">
  ### Formato del Secret del certificado SSL {#ssl-certificate-secret-format}
</div>
...
<div id="clickhouse-keeper-communication-over-tls">
  ### Comunicación de ClickHouse-Keeper mediante TLS {#clickhouse-keeper-communication-over-tls}
</div>
...
<div id="external-secret">
  ## Secret externo {#external-secret}
</div>
...
<div id="external-secret-required-keys">
  ### Claves requeridas {#external-secret-required-keys}
</div>
...
<div id="external-secret-policy">
  ### Política: Observe vs Manage {#external-secret-policy}
</div>
...
<div id="external-secret-status">
  ### Condición de estado y solución de problemas {#external-secret-status}
</div>
...
<div id="additional-ports-mysql-example">
  ### Ejemplo completo: MySQL wire protocol {#additional-ports-mysql-example}
</div>
...
<div id="additional-ports-constraints">
  ### Restricciones de los campos {#additional-ports-constraints}
</div>
...
<div id="additional-ports-reserved">
  ### Puertos y nombres reservados {#additional-ports-reserved}
</div>
...
<div id="version-probe-and-upgrade-channel">
  ## Sonda de versión y canal de actualización {#version-probe-and-upgrade-channel}
</div>
...
<div id="upgrade-channel-choosing">
  ### Elegir un canal de lanzamientos {#upgrade-channel-choosing}
</div>
...
<div id="version-status-conditions">
  ### Condiciones de estado {#version-status-conditions}
</div>
...
<div id="version-probe-template">
  ### Sobrescritura del Job de la sonda de versión {#version-probe-template}
</div>
...
<div id="version-operator-flags">
  ### Controles globales del operador {#version-operator-flags}
</div>
...
<div id="clickhouse-settings">
  ## Configuración de ClickHouse {#clickhouse-settings}
</div>

<div id="default-user-password">
  ### Contraseña del usuario `default` {#default-user-password}
</div>
...
<div id="password-types">
  #### Tipos de contraseña {#password-types}
</div>
...
<div id="default-password-secret-example">
  #### Ejemplo completo con un Secret {#default-password-secret-example}
</div>
...
<div id="using-configmap-for-user-passwords">
  #### Uso de un ConfigMap {#using-configmap-for-user-passwords}
</div>
...
<div id="database-sync">
  ### Sincronización de la base de datos {#database-sync}
</div>
...
<div id="embedded-extra-configuration">
  ### Configuración adicional integrada {#embedded-extra-configuration}
</div>
...
<div id="embedded-extra-users-configuration">
  ### Configuración integrada de usuarios adicionales {#embedded-extra-users-configuration}
</div>
...
<div id="see-documentationconceptsfeaturesconfigurationsettingssettings-users-for-all-supported-clickhouse-users-configuration-options">
  #### Consulta la [documentación](/es/concepts/features/configuration/settings/settings-users) para ver todas las opciones de configuración de usuarios de ClickHouse admitidas. {#see-documentation-for-all-supported-clickhouse-users-configuration-options}
</div>
