...
<div id="billing-compliance">
  ## Cumplimiento de facturación {#billing-compliance}
</div>
...
<div id="direct-payg">
  ### Facturación de pago por uso con tarjeta de crédito {#direct-payg}
</div>
...
<div id="cloud-marketplace-payg">
  ### Facturación de pago por uso a través del marketplace en la nube {#cloud-marketplace-payg}
</div>
...
<div id="committed-spend-contract">
  ### Facturación por contrato comprometido {#committed-spend-contract}
</div>
...
<div id="marketplace-payg">
  ## Cómo pagar a través de marketplaces {#marketplace-payg}
</div>
