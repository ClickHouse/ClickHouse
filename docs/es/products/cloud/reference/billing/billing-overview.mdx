...
### Scale (siempre activo, escalado automático): desde $499.38 al mes {#scale-always-on-auto-scaling-from-49938-per-month}
...
### Enterprise: Los precios iniciales varían {#enterprise-starting-prices-vary}
...
### ¿Qué es un ClickHouse Credit (CHC)? {#what-is-chc}
...
### ¿Dónde puedo encontrar los precios anteriores? {#find-legacy-pricing}

Puedes encontrar la información sobre los precios anteriores [aquí](https://clickhouse.com/pricing?legacy=true).

### ¿Cómo se factura el cómputo? {#how-is-compute-metered}
...
### ¿Cómo se calcula el almacenamiento en disco? {#how-is-storage-on-disk-calculated}
...
### ¿Las copias de seguridad cuentan para el almacenamiento total? {#do-backups-count-toward-total-storage}
...
### ¿Cómo estimo la compresión? {#how-do-i-estimate-compression}
...
### ¿Qué herramientas ofrece ClickHouse para estimar el costo de operar un servicio en la nube si tengo una implementación autogestionada? {#what-tools-does-clickhouse-offer-to-estimate-the-cost-of-running-a-service-in-the-cloud-if-i-have-a-self-managed-deployment}
...
### ¿Qué opciones de facturación están disponibles para ClickHouse Cloud? {#what-billing-options-are-available-for-clickhouse-cloud}
...
### ¿Puedo eliminar mi tarjeta de crédito? {#can-i-delete-my-credit-card}
...
### ¿Dónde puedo ver mis reembolsos? {#where-can-i-see-my-refunds}
...
### ¿Cuánto tarda en aparecer un reembolso? {#how-long-does-it-take-for-a-refund-to-appear}
...
### ¿Cuánto dura el ciclo de facturación? {#how-long-is-the-billing-cycle}
...
### Si tengo una suscripción PAYG del marketplace activa y luego firmo un contrato por compromiso, ¿se consumirán primero mis créditos contratados? {#committed-credits-consumed-first-with-active-payg-subscription}
...
### ¿Qué controles ofrece ClickHouse Cloud para gestionar los costos de los servicios Scale y Enterprise? {#what-controls-does-clickhouse-cloud-offer-to-manage-costs-for-scale-and-enterprise-services}
...
### ¿Qué controles ofrece ClickHouse Cloud para gestionar los costos de los servicios Basic? {#what-controls-does-clickhouse-cloud-offer-to-manage-costs-for-basic-services}
...
### Si tengo varios servicios, ¿recibo una factura por servicio o una factura consolidada? {#if-i-have-multiple-services-do-i-get-an-invoice-per-service-or-a-consolidated-invoice}

Se genera una factura consolidada para todos los servicios de una organización determinada en un período de facturación.

### Si añado mi tarjeta de crédito y actualizo antes de que expire mi período de prueba y se agoten los créditos, ¿se me cobrará? {#if-i-add-my-credit-card-and-upgrade-before-my-trial-period-and-credits-expire-will-i-be-charged}
...
### ¿Cómo puedo llevar un control de mis gastos? {#how-can-i-keep-track-of-my-spending}
...
### ¿Cómo accedo a las facturas de mi suscripción al servicio de ClickHouse Cloud? {#how-do-i-access-my-invoice-for-my-subscription-to-the-clickhouse-cloud-service}
...
### ¿Por qué las fechas de los extractos de uso no coinciden con las de mi factura de AWS Marketplace? {#why-do-the-dates-on-the-usage-statements-not-match-my-marketplace-invoice}
...
### ¿Hay alguna restricción sobre el uso de créditos prepagados? {#are-there-any-restrictions-around-the-usage-of-prepaid-credits}
...
### ¿Hay alguna diferencia en el precio de ClickHouse Cloud si se paga a través del marketplace del proveedor de nube o directamente a ClickHouse? {#is-there-a-difference-in-clickhouse-cloud-pricing-whether-paying-through-the-cloud-provider-marketplace-or-directly-to-clickhouse}
...
### ¿Cómo se factura la separación compute-compute? {#how-is-compute-compute-separation-billed}
...
## Precios de ClickPipes {#clickpipes-pricing}
