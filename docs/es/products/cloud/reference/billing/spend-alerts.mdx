...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/cloud/reference/billing/spend-alerts-config.webp" alt="Cuadro de diálogo de alertas de gasto de la organización con límite de gasto, alertas automáticas por umbral y canales de notificación" size="md" />
  </Step>
</Steps>
