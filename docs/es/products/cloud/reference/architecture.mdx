...
<div id="storage-backed-by-object-store">
  ## Almacenamiento basado en almacenamiento de objetos {#storage-backed-by-object-store}
</div>
...
<div id="service-isolation">
  ## Aislamiento del servicio {#service-isolation}
</div>
...
<div id="compute-isolation">
  ### Aislamiento del cómputo {#compute-isolation}
</div>
...
<div id="storage-isolation">
  ### Aislamiento del almacenamiento {#storage-isolation}
</div>
...
<div id="compute-compute-separation">
  ## Cómputo-cómputo separation {#compute-compute-separation}
</div>
