...
<div id="restoring-from-a-backup">
  ## Restauración desde una copia de seguridad {#restoring-from-a-backup}
</div>
...
<div id="primary-service-data-corruption">
  ### Corrupción de datos del servicio principal {#primary-service-data-corruption}
</div>
...
<div id="primary-region-downtime">
  ### Caída de la región primaria {#primary-region-downtime}
</div>
