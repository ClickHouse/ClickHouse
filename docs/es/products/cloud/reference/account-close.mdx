...
Antes de solicitar el cierre de la cuenta, sigue estos pasos para preparar tu cuenta.

<Steps>
  <Step>
    ### 1. Exporta todos los datos que necesites conservar.
  ...
  <Step>
    ### 2. Detén y elimina tus servicios.

    > Esto evitará que se acumulen cargos adicionales en tu cuenta
  </Step>

  <Step>
    ### 3. Elimina todos los usuarios, excepto el admin que solicitará el cierre.

    > Esto evita que se produzca actividad inesperada en la cuenta que pueda impedir el cierre
  </Step>

  <Step>
    ### 4. Revisa las pestañas &#39;Usage&#39; y &#39;Billing&#39; para verificar que se hayan pagado todos los cargos.

    > No podemos cerrar cuentas con saldos pendientes de pago.
  </Step>
</Steps>
