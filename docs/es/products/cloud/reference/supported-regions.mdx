...
Las siguientes tablas enumeran las regiones compatibles por proveedor de nube. Las insignias indican la disponibilidad de regiones privadas, HIPAA y PCI. Las regiones sin insignias no ofrecen actualmente ninguna de estas opciones.
...
<Tabs>
  <Tab title="AWS" id="aws-regions" icon="aws">
    ...
    | `il-central-1`   | —                                                                                                        |
    | `mx-central-1`   | <Badge color="purple">Privada</Badge> <Badge color="blue">PCI</Badge>                                    |
