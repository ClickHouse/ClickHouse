...
Los límites del nivel Basic de `100` bases de datos y `500` tablas se aplican únicamente a los servicios con una sola réplica de ese nivel. Los servicios con una sola réplica de los niveles Scale y Enterprise utilizan las protecciones estándar del servicio. Para obtener más información, consulta [Límites de uso](/es/products/cloud/guides/best-practices/usagelimits).