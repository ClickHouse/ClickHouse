...
| [integración de Prometheus de ClickHouse Cloud](#clickhouse-cloud-prometheus-integration)                         | [clickhouse.com/docs](/es/integrations/prometheus)                                                | Cloud       | Métricas                       |
...
Configura el Datadog Agent con la [integración de OpenMetrics](https://docs.datadoghq.com/integrations/openmetrics/) para consultar periódicamente la ClickHouse Cloud API y recopilar métricas. Consulta la [página de integración de Prometheus](/es/integrations/prometheus#integrating-with-datadog) para obtener más información sobre la configuración.
