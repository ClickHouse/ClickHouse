...
| Unity Catalog        | Iceberg y Delta (solo ubicaciones de almacenamiento externo) | Credenciales de cliente OAuth               | Cloud (solo Iceberg) &amp; [Core](/es/guides/use-cases/data-warehousing/unity-catalog) | 25.10+  |
