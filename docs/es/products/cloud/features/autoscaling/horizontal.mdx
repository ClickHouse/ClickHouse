...
<Image img="/images/cloud/manage/scaling-patch-request.webp" size="lg" alt="Solicitud PATCH de escalado" border caption="Solicitud `PATCH` para actualizar `numReplicas`" />

<Image img="/images/cloud/manage/scaling-patch-response.webp" size="md" alt="Respuesta PATCH de escalado" border caption="Respuesta a la solicitud `PATCH`" />
...
<Image img="/images/cloud/manage/scaling-configure.webp" size="md" alt="Configuración del escalado" border caption="Configuración de escalado del servicio desde la consola de ClickHouse Cloud" />
