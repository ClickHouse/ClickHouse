...
<Image img="/images/cloud/reference/compute-compute-1.webp" size="md" alt="Servicio único en ClickHouse Cloud" caption="Fig. 1 - Servicio único en ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-2.webp" size="md" alt="Separación de cómputo en ClickHouse Cloud" caption="Fig. 2 - Separación de cómputo en ClickHouse Cloud" />
...
<Image img="/images/cloud/reference/compute-compute-8.webp" size="lg" alt="Ejemplo de warehouse con servicio principal y servicios secundarios" background="white" caption="Fig. 3 - Ejemplo de warehouse" />
...
<Image img="/images/cloud/reference/compute-compute-3.webp" size="md" alt="Acceso de usuarios entre servicios que comparten los mismos datos" caption="Fig. 4 - La usuaria Alice se creó en servicio 1, pero puede usar las mismas credenciales para acceder a todos los servicios que comparten los mismos datos" />
...
<Image img="/images/cloud/reference/compute-compute-4.webp" size="md" alt="Configuración del control de acceso a la red" caption="Fig. 5 - Alice tiene restringido el acceso al servicio 2 debido a la configuración del control de acceso a la red" />
...
<Image img="/images/cloud/reference/compute-compute-5.webp" size="lg" alt="Servicios de lectura y escritura y de solo lectura en un warehouse" caption="Fig. 6 - Servicios de lectura y escritura y de solo lectura en un warehouse" />
...
<Image img="/images/cloud/reference/compute-compute-7.webp" size="md" alt="Crear un nuevo servicio en un warehouse" caption="Fig. 7 - Haga clic en el signo más para crear un nuevo servicio en un warehouse" />
