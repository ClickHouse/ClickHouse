...
<div id="managing-cache-locality">
  ### Gestión de la localidad de la caché {#managing-cache-locality}
</div>
...
<div id="settings-related-to-parallel-replicas">
  ## Configuración relacionada con las réplicas paralelas {#settings-related-to-parallel-replicas}
</div>
...
## Investigar problemas con las réplicas paralelas {#investigating-issues-with-parallel-replicas}
