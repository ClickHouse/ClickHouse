...
<Image img="/images/cloud/agent-builder/sharing/sharing.webp" alt="Parte inferior del panel de Agent Builder con el icono share resaltado y una insignia que muestra una entidad compartida" size="sm" />
