...
<div id="working-with-your-restored-service">
  ## Trabajar con tu servicio restaurado {#working-with-your-restored-service}
</div>
...
<div id="use-the-new-restored-service">
  ### Use el **nuevo servicio restaurado** {#use-the-new-restored-service}
</div>
...
<div id="migrate-data-from-the-newly-restored-service-back-to-the-original-service">
  ### Migre los datos del **servicio recién restaurado** al **servicio original** {#migrate-data-from-the-newly-restored-service-back-to-the-original-service}
</div>
...
<div id="undeleting-or-undropping-tables">
  ## Recuperar tablas eliminadas {#undeleting-or-undropping-tables}
</div>
