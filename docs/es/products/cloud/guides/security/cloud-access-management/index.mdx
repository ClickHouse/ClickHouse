...
| [Migración de RBAC con roles personalizados](/es/products/cloud/guides/security/cloud-access-management/migrating-rbac-custom-roles)             | Guía para administradores sobre cómo migrar al nuevo sistema de control de acceso basado en roles                     |
