...
<div id="sql-console-passwordless-authentication">
  ### Autenticación sin contraseña en Consola SQL {#sql-console-passwordless-authentication}
</div>
...
<Tip>
  Se recomienda usar [roles de base de datos administrados por Cloud](/es/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles) (beta) para administrar el acceso a la base de datos desde la consola. Los roles `sql-console-role:<email>` no son compatibles con la [autenticación con JWT](/es/products/cloud/guides/security/cloud-access-management/jwt-authentication-setup).
</Tip>
...
<div id="database-authentication">
  ## Autenticación de la base de datos {#database-authentication}
</div>

<div id="database-user-id--password">
  ### ID y contraseña del usuario de base de datos {#database-user-id--password}
</div>
...
<div id="database-ssh">
  ### Usuario de base de datos con autenticación SSH {#database-ssh}
</div>
...
<div id="database-permissions">
  ## Permisos de la base de datos {#database-permissions}
</div>
