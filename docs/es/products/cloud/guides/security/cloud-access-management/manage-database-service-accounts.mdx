...
<Steps>
  ...
  <Step>
    ...
    Algunos drivers (p. ej., ClickHouse Connect para Python) también exponen una configuración de rol que se envía con cada solicitud y que el servidor usa como rol de la sesión.
  </Step>
</Steps>