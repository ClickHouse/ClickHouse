...
<Image img="/images/cloud/security/azure-pe-create-basic.webp" size="md" alt="Crear Private Endpoint básico" border />
...
<Image img="/images/cloud/security/azure-pe-resource.webp" size="md" alt="Selección de recursos de Private Endpoint" border />
