...
Los siguientes motores de tabla también son compatibles y se usan tal cual. El motor de tabla `MySQL` compatible es distinto del motor de base de datos `MySQL`, que no es compatible:
...
## Lista de funciones no compatibles {#list-of-unsupported-features}
