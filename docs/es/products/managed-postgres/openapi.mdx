...
[create API]: /products/cloud/api-reference/postgres/postgres-service-create "Crear un nuevo servicio de Postgres"
...
[slow patterns API]: /products/cloud/api-reference/postgres/slow-query-patterns-get-list "Listar patrones de consultas lentas de Postgres"

[slow pattern API]: /products/cloud/api-reference/postgres/slow-query-pattern-get "Obtener un patrón de consulta lenta de Postgres con ejecuciones recientes"