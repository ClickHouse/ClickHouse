...
endpoint
[list slow query patterns](/es/api-reference/organization/get-list-of-available-organizations#tag/Postgres/operation/slowQueryPatternsGetList),
y el [panel lateral de detalles](#detail) se corresponde con el
endpoint
[get slow query pattern](/es/api-reference/organization/get-list-of-available-organizations#tag/Postgres/operation/slowQueryPatternGet),
