---
slug: /es/products/managed-postgres/read-replicas
...
<div id="why-use-read-replicas">
  ## Por qué usar réplicas de lectura {#why-use-read-replicas}
</div>
...
<div id="wal-shipping-from-object-storage">
  ### WAL shipping desde el almacenamiento de objetos {#wal-shipping-from-object-storage}
</div>
...
<div id="why-we-chose-this-approach">
  ### Por qué elegimos este enfoque {#why-we-chose-this-approach}
</div>
...
<div id="replication-lag-characteristics">
  ### Características del retraso de replicación {#replication-lag-characteristics}
</div>
