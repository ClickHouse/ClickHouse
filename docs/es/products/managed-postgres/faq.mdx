...
<div id="metrics-access">
  ### ¿Cómo puedo acceder a las métricas de mi instancia de ClickHouse Managed Postgres?
</div>
...
ClickHouse Managed Postgres incluye copias de seguridad automáticas diarias con archivado continuo de WAL, lo que permite la recuperación a un momento dado en cualquier instante dentro de una ventana de retención de 7 días. Las copias de seguridad se almacenan en S3.
...
<div id="terraform-support">
  ### ¿Hay soporte para Terraform disponible para ClickHouse Managed Postgres?
</div>

Actualmente, no hay soporte para Terraform para ClickHouse Managed Postgres. Recomendamos usar la consola de ClickHouse Cloud o [OpenAPI](/es/products/managed-postgres/openapi) para crear y gestionar sus instancias.
...
<div id="migration-tools">
  ### ¿Qué herramientas hay disponibles para migrar a ClickHouse Managed Postgres?
</div>
