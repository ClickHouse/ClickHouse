...
## Aspectos destacados de los precios beta {#beta-pricing-highlights}

### Precios de la Public Beta en AWS {#aws-public-beta-pricing}
...
### Precios de la Private Preview en GCP {#gcp-private-preview-pricing}
