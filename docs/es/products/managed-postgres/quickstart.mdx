...
Ahora que ya tenemos tablas y datos en Postgres, vamos a replicar las tablas en ClickHouse para analítica. Para empezar, haz clic en **ClickHouse integration** en la barra lateral. Luego, puedes hacer clic en **Replicate data in ClickHouse**.
