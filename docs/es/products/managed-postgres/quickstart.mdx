...
<Visibility for="humans">
  <View title="UI de Cloud">
    ...
    * Consulta ClickHouse directamente desde Postgres usando `pg_clickhouse`
    ...
    ## Parte 1: Primeros pasos con NVMe Postgres {#part-1}

    ### Crear una base de datos {#create-postgres-database}
    ...
    ### Conectar a tu base de datos {#connect}
    ...
    ### Comprueba el rendimiento de NVMe {#nvme-performance}
    ...
    ### Ejecuta consultas sobre tus datos {#run-queries}
    ...
    ***
    ...
    ## Parte 2: Añade analítica en tiempo real con ClickHouse {#part-2}
    ...
    * **ClickHouse** para analítica en menos de un segundo sobre miles de millones de filas
    ...
    ### Configurar la integración con ClickHouse {#setup-integrate-clickhouse}
    ...
    * Haz clic en **Replicate data to ClickHouse**.
    ...
    ### Consulta ClickHouse desde Postgres {#pg-clickhouse-extension}
    ...
    ### Ve tu analítica en acción {#analytics-after-integration}
    ...
    ### Comparación del rendimiento de Postgres vs ClickHouse {#performance-comparison}
