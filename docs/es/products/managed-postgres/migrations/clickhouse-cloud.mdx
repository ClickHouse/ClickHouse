...
<Steps>
  <Step title="Conéctate a tu base de datos de origen" id="step-1-connect">
    ...
    En la barra lateral izquierda, haz clic en **orígenes de datos**.

    <Image img="/images/managed-postgres/pgpg/overview.webp" alt="Entrada de orígenes de datos en la barra lateral del servicio de Managed Postgres" size="lg" border />

    Haz clic en **Start import**.

    <Image img="/images/managed-postgres/pgpg/startimport.webp" alt="Página de orígenes de datos con el botón Start import" size="lg" border />
  ...
  <Step title="Importa el esquema en tu servicio de Managed Postgres" id="step-3-import-schema">
...
* [Inicio rápido de Managed Postgres](/es/products/managed-postgres/quickstart)
* [Datos de conexión de Managed Postgres](/es/products/managed-postgres/connection)
