...
### Paso 1: Poner la base de datos Postgres de origen en modo de solo lectura
...
### Paso 2: Validar los recuentos de filas
...
### Paso 4: Restablecer las secuencias
