...
<Note>
  Si tienes problemas durante la migración, consulta las [preguntas frecuentes sobre migraciones de Managed Postgres](/es/cloud/managed-postgres/migrations/faq) para ver los errores más comunes y sus soluciones.
</Note>
...
<div id="step-2-export-schema">
  ### Exporta el esquema de tu base de datos
</div>
...
<div id="step-3-import-schema">
  ### Importa el esquema en tu servicio de Managed Postgres
</div>
