...
Para las organizaciones del nivel Enterprise, ClickHouse Managed Postgres admite ventanas de mantenimiento para que las actualizaciones y otras operaciones de mantenimiento puedan programarse en el momento que menos afecte a su carga de trabajo. La compatibilidad en la UI y la API para configurar ventanas de mantenimiento estará disponible próximamente. Mientras tanto, póngase en contacto con [support](https://clickhouse.com/support/program) para configurar una ventana de mantenimiento para su instancia.
