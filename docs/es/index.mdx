  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "Guías de inicio rápido", href: "/get-started/quickstarts/home" },
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Referencia SQL", href: "/reference/statements" },
        { label: "Configuración", href: "/reference/settings/index" },
        ...
        { label: "Operador de Kubernetes", href: "/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="Analítica en tiempo real" description="Obtén insights instantáneos y dashboards a escala. Analiza miles de millones de filas en tiempo real con resultados en milisegundos." href="/es/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="Observabilidad" description="Almacena y consulta logs, métricas y trazas a escala con ClickStack, la pila de observabilidad de código abierto impulsada por ClickHouse." href="/es/clickstack/overview" showArrow />

        <HeroCard title="Data warehousing" description="Analiza y explora datos al instante para obtener insights y crear aplicaciones. Escala más rápido descargando las cargas de trabajo pesadas." href="/es/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="Analítica agéntica" description="Permite que los agentes de IA consulten directamente tus datos en tiempo real para ofrecer insights conversacionales y visualizaciones al instante" href="/es/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              { label: "2. buenas prácticas para organizar datos para analítica y crecimiento", href: "/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. Formas de consultar grandes conjuntos de datos en tiempo real", href: "/get-started/use-cases/real-time-analytics" },
              { label: "4. Cómo crear dashboards, alertas y funciones basadas en eventos sobre la misma plataforma", href: "/get-started/use-cases/data-warehousing" },
              { label: "5. Consejos para mantener los costos bajos sin sacrificar el rendimiento", href: "/concepts/best-practices/index" },
          ]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" description="La pila de observabilidad todo en uno basada en ClickHouse, que te ofrece consultas ultrarrápidas y potentes agregaciones sobre logs, métricas, trazas, reproducciones de sesiones y errores." href="/es/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard filename="thumbnail-postgres-light.webp" title="Managed Postgres" description="Servicio de Postgres rápido, escalable y de nivel empresarial, integrado de forma nativa con ClickHouse. Combina fácilmente Postgres para transacciones y ClickHouse para analítica." href="/es/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="Plataforma de ingeniería de LLM de código abierto para observabilidad, métricas, evaluaciones y gestión de prompts." href="https://langfuse.com/docs" showArrow external />
          ...
          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="Una base de datos rápida, fiable y escalable en el mismo proceso. Descubre la potencia de ClickHouse en el mismo proceso." href="/es/products/chdb/index" showArrow />
        </div>
      </div>
