...
export const IntegrationsBanner = () => {
    const assetBase = typeof window !== 'undefined' && window.location.pathname.startsWith('/docs') ? '/docs' : '';
    const href = '/es/integrations/home';
    return (
        <a
        ...
        >
            <div>
                <h3 className="text-[#111827] dark:text-white text-lg font-semibold leading-[1.3] mt-0">Integración</h3>
                <span className="block text-[#6b7280] dark:text-[#a1a1aa] mt-1 text-sm font-normal leading-normal">100+ integraciones to connect the tools and services that you love with ClickHouse.</span>
            </div>
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "Guías de inicio rápido", href: "/es/get-started/quickstarts/home" },
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Referencia SQL", href: "/es/reference/statements" },
        { label: "Configuración", href: "/es/reference/settings/index" },
        { label: "Funciones", href: "/es/reference/functions/regular-functions/overview" },
        { label: "Motores", href: "/es/reference/engines/engines" },
        { label: "Tablas del sistema", href: "/es/reference/system-tables/overview" },
        ...
        { label: "ClickHouse Managed Postgres", href: "/es/products/managed-postgres/overview" },
        { label: "Langfuse", href: "https://langfuse.com/docs", external: true },
        { label: "chDB", href: "/es/chdb" },
        { label: "Operador de Kubernetes", href: "/es/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="Analítica en tiempo real" galaxyEvent="docs.home.real-time-analytics" description="Obtén insights instantáneos y dashboards a escala. Analiza miles de millones de filas en tiempo real con resultados en milisegundos." href="/es/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="Observabilidad" galaxyEvent="docs.home.observability" description="Almacena y consulta logs, métricas y trazas a escala con ClickStack, la pila de observabilidad de código abierto impulsada por ClickHouse." href="/es/clickstack/overview" showArrow />

        <HeroCard title="Data warehousing" galaxyEvent="docs.home.data-warehousing" description="Analiza y explora datos al instante para obtener insights y crear aplicaciones. Escala más rápido descargando las cargas de trabajo pesadas." href="/es/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="Analítica agéntica" galaxyEvent="docs.home.agentic-analytics" description="Permite que los agentes de IA consulten directamente tus datos en tiempo real para ofrecer insights conversacionales y visualizaciones al instante" href="/es/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        {/* Fila 1: ClickHouse Cloud (col-span-2) + 2 tarjetas en columna (col-span-1) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. Cómo ingestar datos desde fuentes comunes con un esfuerzo mínimo", href: "/es/integrations/home" },
              { label: "2. buenas prácticas para organizar datos para analítica y crecimiento", href: "/es/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. Formas de consultar grandes conjuntos de datos en tiempo real", href: "/es/get-started/use-cases/real-time-analytics" },
              { label: "4. Cómo crear dashboards, alertas y funciones basadas en eventos sobre la misma plataforma", href: "/es/get-started/use-cases/data-warehousing" },
              { label: "5. Consejos para mantener los costos bajos sin sacrificar el rendimiento", href: "/es/concepts/best-practices/index" },
          ]}
            />
          </div>

          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" galaxyEvent="docs.home.clickstack" description="La pila de observabilidad todo en uno basada en ClickHouse, que te ofrece consultas ultrarrápidas y potentes agregaciones sobre logs, métricas, trazas, reproducciones de sesiones y errores." href="/es/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />
        ...
        {/* Banner de ancho completo de Integrations */}
      ...
      <div id="mcp-setup" className="mt-16 scroll-mt-20">
        ...
        <div className="mt-6 p-4 rounded-lg bg-[#f9f9f9] dark:bg-white/[0.03] border border-[#e5e7eb] dark:border-white/10">
          ...
          <p className="text-sm text-gray-500 dark:text-zinc-500 mb-3">Instala las skills de ClickHouse para que tu agente tenga conocimientos expertos de ClickHouse y siga las buenas prácticas.</p>
