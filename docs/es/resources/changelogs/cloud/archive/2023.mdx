...
* Se mejoró el rendimiento de lectura de las consultas que recuperan una gran cantidad de archivos pequeños del almacenamiento de objetos
* Para los servicios recién lanzados, la configuración [compatibility](/es/reference/settings/session-settings/compatibility#compatibility) se establece en la versión con la que se lanzó inicialmente el servicio
