...
<Image img="/images/cloud/reference/oct-4-latency-insights.webp" size="lg" alt="Interfaz de ClickPipes que muestra un gráfico de métricas de latencia para el rendimiento de la ingestión de datos" border caption="Controles de escalado para Kafka y Kinesis (Beta privada)" />
