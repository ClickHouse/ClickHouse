...
Siga los pasos para crear un endpoint privado inverso en la [documentación de ClickPipes](/es/integrations/clickpipes/networking/aws-privatelink#creating-clickpipe).