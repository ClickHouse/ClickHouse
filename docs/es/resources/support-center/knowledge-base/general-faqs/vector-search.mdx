...
<Steps>
  <Step title="Crear embeddings">
    ...
    Puedes pensar en un embedding como un gran array de números de coma flotante que representa tus datos. [Consulta esta guía de OpenAI para obtener más información sobre los embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings).
  </Step>
