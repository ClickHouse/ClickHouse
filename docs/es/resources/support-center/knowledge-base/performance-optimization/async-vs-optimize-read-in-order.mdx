...
<Image img="/images/knowledgebase/sync_read.webp" size="md" alt="Diagrama de lectura síncrona de datos" />
...
<Image img="/images/knowledgebase/async_read.webp" size="md" alt="Diagrama de lectura asíncrona de datos" />
