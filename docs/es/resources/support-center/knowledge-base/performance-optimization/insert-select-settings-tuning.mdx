...
[max&#95;insert&#95;block&#95;size](/es/reference/settings/session-settings#settings-max_insert_block_size) = `100_000_000` (valor predeterminado `1_048_576`)
...
[min&#95;insert&#95;block&#95;size&#95;rows](/es/reference/settings/session-settings#min-insert-block-size-rows) = `100_000_000` (valor predeterminado `1_048_576`)

Aumentarlo de ~1M a 100M permitiría formar bloques más grandes.

[min&#95;insert&#95;block&#95;size&#95;bytes](/es/reference/settings/session-settings#min-insert-block-size-bytes) = `500_000_000` (valor predeterminado `268_435_456`)

Aumentarlo de 268.44 MB a 500 MB permitiría formar bloques más grandes.

[parts&#95;to&#95;delay&#95;insert](/es/reference/settings/merge-tree-settings#parts-to-delay-insert) = `500` (valor predeterminado `150`)
...
[parts&#95;to&#95;throw&#95;insert](/es/reference/settings/merge-tree-settings#parts-to-throw-insert) = `1500` (valor predeterminado `3000`)
