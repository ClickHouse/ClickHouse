...
Como alternativa, apunte su client directamente al paquete de certifi. [ClickHouse Connect](/es/integrations/language-clients/python) no usa certifi automáticamente como alternativa, así que pase el paquete mediante el parámetro `ca_cert`:
