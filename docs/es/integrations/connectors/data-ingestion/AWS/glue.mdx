...
<Tabs>
  ...
  <Tab title="Instalación manual">
    ...
    1. Cargue el JAR más reciente del Spark connector (`clickhouse-spark-runtime-3.X_2.X-0.10.X.jar`) en un bucket de S3.
...
Para obtener más información, visite nuestra [documentación de Spark](/es/integrations/apache-spark).