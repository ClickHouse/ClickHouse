---
slug: /es/integrations/connectors/data-ingestion/AWS/integrating-s3-with-clickhouse
...
<div id="splitting-large-files">
  ### Dividir archivos grandes {#splitting-large-files}
</div>
...
<div id="inserting-data">
  ### Inserción de datos {#inserting-data}
</div>
...
<div id="managing-credentials">
  ## Gestión de credenciales {#managing-credentials}
</div>
...
<div id="s3-optimizing-performance">
  ## Optimización del rendimiento {#s3-optimizing-performance}
</div>
...
<div id="s3-storage-tuning">
  ### Ajuste del almacenamiento en S3 {#s3-storage-tuning}
</div>
...
<div id="s3-backed-mergetree">
  ## MergeTree respaldado por S3 {#s3-backed-mergetree}
</div>
...
<div id="creating-a-disk">
  ### Creación de un disco {#creating-a-disk}
</div>
...
<div id="creating-a-storage-policy">
  ### Creación de una política de almacenamiento {#creating-a-storage-policy}
</div>
...
<div id="modifying-a-table">
  ### Modificar una tabla {#modifying-a-table}
</div>
...
<div id="handling-replication">
  ### Gestión de la replicación {#handling-replication}
</div>
...
<div id="configuring-s3-for-clickhouse-use">
  ## Usar el almacenamiento de objetos de S3 como disco de ClickHouse {#configuring-s3-for-clickhouse-use}
</div>
...
<div id="configure-clickhouse-to-use-the-s3-bucket-as-a-disk">
  ### Configure ClickHouse para usar el bucket de S3 como disco {#configure-clickhouse-to-use-the-s3-bucket-as-a-disk}
</div>
...
<div id="s3-multi-region">
  ## Replicar un único segmento entre dos regiones de AWS mediante almacenamiento de objetos en S3 {#s3-multi-region}
</div>
...
<div id="plan-the-deployment">
  ### Planifique la implementación {#plan-the-deployment}
</div>
...
<div id="install-software">
  ### Instalar el software {#install-software}
</div>

<div id="clickhouse-server-nodes">
  #### Nodos del servidor ClickHouse {#clickhouse-server-nodes}
</div>
...
<div id="deploy-clickhouse">
  #### Desplegar ClickHouse {#deploy-clickhouse}
</div>
...
<div id="deploy-clickhouse-keeper">
  #### Desplegar ClickHouse Keeper {#deploy-clickhouse-keeper}
</div>
...
<div id="create-s3-buckets">
  ### Crear buckets de S3 {#create-s3-buckets}
</div>
...
<div id="configure-clickhouse-keeper">
  ### Configurar ClickHouse Keeper {#configure-clickhouse-keeper}
</div>
...
<div id="configure-clickhouse-server">
  ### Configurar el servidor de ClickHouse {#configure-clickhouse-server}
</div>

<div id="define-a-cluster">
  #### Definir un clúster {#define-a-cluster}
</div>
...
<div id="disable-zero-copy-replication">
  #### Deshabilitar la replicación zero-copy {#disable-zero-copy-replication}
</div>
...
<div id="configure-networking">
  ### Configurar la red {#configure-networking}
</div>
...
<div id="start-the-servers">
  ### Iniciar los servidores {#start-the-servers}
</div>

<div id="run-clickhouse-keeper">
  #### Ejecutar ClickHouse Keeper {#run-clickhouse-keeper}
</div>
...
<div id="check-clickhouse-keeper-status">
  #### Comprobar el estado de ClickHouse Keeper {#check-clickhouse-keeper-status}
</div>
...
<div id="run-clickhouse-server">
  #### Ejecute el servidor de ClickHouse {#run-clickhouse-server}
</div>
