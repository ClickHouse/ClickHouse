...
1. Inicie sesión en Azure Portal de Microsoft y abra su instancia de Data Factory.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-with-data-factory.webp" size="lg" alt="Página principal de Azure Portal con Data Factory" border />
...
3. En el menú de la izquierda, seleccione **Manage**, luego vaya a **Linked services**
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-create-linked-service-button.webp" size="lg" alt="Botón New Linked Service de Azure Data Factory" border />
...
4. En la **barra de búsqueda de New linked service**, escriba **REST**, seleccione **REST** y haga clic en **Continue**
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-search.webp" size="lg" alt="Búsqueda de New Linked Service de Azure Data Factory" border />
...
5. En el panel de configuración del servicio vinculado, introduzca un nombre para el nuevo servicio,
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-lined-service-pane.webp" size="lg" alt="Panel New Lined Service" border />
...
6. En el panel de contenido dinámico puede crear una URL parametrizada, lo que
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-base-url-empty.webp" size="lg" alt="URL base vacía de New Linked Service" border />
...
7. Haga clic en el **&quot;+&quot;** junto al campo de filtro y agregue un nuevo parámetro; asígnele el nombre
   ...
   Haga clic en **Save**.
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-params.webp" size="lg" alt="Parámetros de New Linked Service" border />
