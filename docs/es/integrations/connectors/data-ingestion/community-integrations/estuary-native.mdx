...
Estuary ofrece un conector de materialización directo con ClickHouse que utiliza el [protocolo nativo](/es/interfaces/tcp) y el [formato nativo](/es/interfaces/formats/Native) de ClickHouse.
