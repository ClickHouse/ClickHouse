...
Desde la versión 26.1 de CH, se admite este esquema cuando `allow_experimental_nullable_tuple_type=1` (consulta [esta página de la documentación](/es/reference/settings/session-settings/allow-experimental#allow_experimental_nullable_tuple_type)).
