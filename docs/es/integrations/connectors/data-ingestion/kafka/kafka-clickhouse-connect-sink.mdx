...
Desde la versión 26.9 de ClickHouse, este esquema se admite de forma predeterminada. En las versiones 26.1 a 26.8 requiere el SETTING `allow_experimental_nullable_tuple_type = 1` (consulta [esta página de la documentación](/es/reference/settings/session-settings/allow-experimental#allow_experimental_nullable_tuple_type)).
