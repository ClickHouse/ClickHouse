...
### Cargar los datos de taxis de NYC
...
<Frame>
  ![La tabla yellow\_tripdata y sus columnas en un Lakehouse de Fabric](/images/integrations/tools/data-integration/microsoft-fabric/fabric-08-tutorial-lakehouse-table.webp)
</Frame>
...
<Frame>
  ![Las tres consultas del tutorial en la consola SQL de ClickHouse integrada](/images/integrations/tools/data-integration/microsoft-fabric/fabric-09-tutorial-sample-queries.webp)
</Frame>
...
### La verificación de correo electrónico falla al abrir un elemento de ClickHouse
...
### No se puede iniciar sesión en la consola de ClickHouse Cloud
...
### Acceso denegado al abrir un elemento
