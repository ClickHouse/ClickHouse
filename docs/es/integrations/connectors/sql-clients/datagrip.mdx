...
<Tip>
  A medida que establezca conexiones, el orden cambia; es posible que ClickHouse todavía no aparezca al principio de la lista.
</Tip>

<Image img="/images/integrations/sql-clients/datagrip-6.webp" size="sm" border alt="DataGrip seleccionando ClickHouse de la lista de Data Sources" />
