...
[Yandex DataLens](https://yandex.cloud/en/services/datalens) es un servicio de visualización y análisis de datos.
...
* [Tutorial](https://yandex.cloud/en/docs/solutions/datalens/data-from-ch-visualization) sobre la visualización de datos de una base de datos de ClickHouse.
