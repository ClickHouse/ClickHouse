...
slug: /es/integrations/connectors/data-visualization/grafana/query-builder
...
<div id="how-to-make-a-data-link">
  ### Cómo crear un enlace de datos {#how-to-make-a-data-link}
</div>
