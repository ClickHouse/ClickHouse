...
2. Busca **ClickHouse** y haz clic en el plugin firmado por Grafana Labs:
   ...
   <Image size="md" img="/images/integrations/data-visualization/grafana/search.webp" alt="Selecciona el plugin de ClickHouse en la página de conexiones" border />

3. En la siguiente pantalla, haz clic en el botón **Install**:

   <Image size="md" img="/images/integrations/data-visualization/grafana/install.webp" alt="Instala el plugin de ClickHouse" border />
