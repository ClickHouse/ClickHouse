...
slug: /es/integrations/connectors/data-visualization/grafana/config
...
<div id="column-aliases">
  ### Alias de columnas {#column-aliases}
</div>
...
<div id="table-defined-alias-columns">
  #### Columnas ALIAS definidas en la tabla {#table-defined-alias-columns}
</div>
