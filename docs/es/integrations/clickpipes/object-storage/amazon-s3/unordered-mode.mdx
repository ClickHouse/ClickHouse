...
<Steps>
  ...
  <Step title="Crear un ClickPipe con modo no ordenado" id="create-clickpipe">
    ...
    **2.** En **Incoming data**, active **Continuous ingestion**. Seleccione **Any order** como modo de ingestión y proporcione la **SQS queue URL** de la cola conectada a su bucket. La cola debe utilizarse exclusivamente para este ClickPipe; consulte [Crear una cola de Amazon SQS](#create-sqs-queue).
