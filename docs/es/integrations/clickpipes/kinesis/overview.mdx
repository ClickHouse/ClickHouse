...
5. Seleccione Kinesis Stream y el offset inicial. La UI mostrará un documento de ejemplo de la fuente seleccionada (topic de Kafka, etc.). También puede habilitar Enhanced Fan-out para Kinesis streams para mejorar el rendimiento y la estabilidad de su ClickPipe (puede encontrar más información sobre Enhanced Fan-out [aquí](https://aws.amazon.com/blogs/aws/kds-enhanced-fanout))
