...
slug: /es/integrations/clickpipes/kinesis/overview
...
<div id="supported-data-formats">
  ## Formatos de datos admitidos {#supported-data-formats}
</div>
...
<div id="standard-types-support">
  ### Compatibilidad con tipos estándar {#standard-types-support}
</div>
...
<div id="variant-type-support">
  ### Compatibilidad con el tipo Variant {#variant-type-support}
</div>
...
<div id="json-type-support">
  ### Compatibilidad con el tipo JSON {#json-type-support}
</div>
...
<div id="kinesis-virtual-columns">
  ## Columnas virtuales de Kinesis {#kinesis-virtual-columns}
</div>
...
<div id="active-shards">
  ### Segmentos activos {#active-shards}
</div>
