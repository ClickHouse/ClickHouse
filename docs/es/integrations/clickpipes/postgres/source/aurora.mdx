...
Consulta [la autenticación de base de datos con AWS IAM (RDS/Aurora)](/es/integrations/clickpipes/postgres/auth) para ver todos los pasos necesarios para configurar el rol y la política de IAM que ClickPipes necesita para autenticarse de esta manera.
