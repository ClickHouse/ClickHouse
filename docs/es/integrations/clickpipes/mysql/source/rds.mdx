...
<Image img="/images/integrations/data-ingestion/clickpipes/mysql/source/rds/rds-backups.webp" alt="Habilitar copias de seguridad automatizadas en RDS" size="lg" border />
