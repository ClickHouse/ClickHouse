...
* ClickHouse inserta lotes de forma atómica solo si todas las filas caben en la misma partición y su número es inferior a [`max_insert_block_size`](/es/reference/settings/session-settings/max-insert#max_insert_block_size).
