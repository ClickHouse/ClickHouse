...
description: 'Representa el contenido de una proyección en tablas MergeTree.
  Puede utilizarse para la introspección.'
...
Representa el contenido de una proyección en tablas MergeTree. Puede utilizarse para la introspección.
...
Un objeto de tabla con las columnas definidas por la proyección especificada.
