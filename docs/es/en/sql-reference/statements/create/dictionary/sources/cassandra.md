...
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `host`                 | El host de Cassandra o una lista de hosts separados por comas.                                                                                                                                                                                                                                                                                                                                   |
| `port`                 | El puerto de los servidores de Cassandra. Si no se especifica, se usa el puerto predeterminado `9042`.                                                                                                                                                                                                                                                                                           |
...
| `allow_filtering`      | Indicador para permitir o no condiciones potencialmente costosas en las columnas de la clave de clustering. El valor predeterminado es `1`.                                                                                                                                                                                                                                                      |
...
| `max_threads`          | El número máximo de hilos que se usarán para cargar datos desde varias particiones en diccionarios de clave compuesta.                                                                                                                                                                                                                                                                           |
| `query`                | La consulta personalizada. Opcional.                                                                                                                                                                                                                                                                                                                                                             |

:::note
Los campos `column_family` o `where` no pueden usarse junto con el campo `query`. Además, se debe declarar uno de los campos `column_family` o `query`.
:::