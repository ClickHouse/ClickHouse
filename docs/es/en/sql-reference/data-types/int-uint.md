---
description: 'Documentación sobre los tipos de datos enteros con y sin signo en ClickHouse,
  que abarcan de 8 bits a 256 bits'
...
Al crear tablas, se pueden definir parámetros numéricos para números enteros (p. ej., `TINYINT(8)`, `SMALLINT(16)`, `INT(32)`, `BIGINT(64)`), pero ClickHouse los ignora.
...
Los tipos enteros sin signo tienen los siguientes rangos:
