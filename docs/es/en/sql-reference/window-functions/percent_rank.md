...
Alias: `percentRank` (sensible a mayúsculas y minúsculas)
...
Para obtener más detalles sobre la sintaxis de las funciones de ventana, consulte: [Funciones de ventana - Sintaxis](./index.md/#syntax).
