...
También imprime dos filas de encabezado con los nombres de las columnas y los tipos, de forma similar a [TabSeparatedWithNamesAndTypes](../TabSeparated/TabSeparatedWithNamesAndTypes.md).
...
Lea los datos con el formato `CustomSeparatedWithNamesAndTypes`:
...
La salida tendrá el formato personalizado configurado:
