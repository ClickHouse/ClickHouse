...
También imprime la fila de encabezado con los nombres de las columnas, al igual que [TabSeparatedWithNames](../TabSeparated/TabSeparatedWithNames.md).
...
Usando el siguiente archivo de texto, llamado `football.txt`:
...
:::note
Si la configuración [`input_format_with_names_use_header`](../../../operations/settings/settings-formats.md/#input_format_with_names_use_header) se establece en `1`,
las columnas de los datos de entrada se asignarán a las columnas de la tabla según sus nombres,
las columnas con nombres desconocidos se omitirán si la configuración [`input_format_skip_unknown_fields`](../../../operations/settings/settings-formats.md/#input_format_skip_unknown_fields) se establece en `1`.
