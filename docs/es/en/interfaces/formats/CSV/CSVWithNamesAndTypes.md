...
También imprime dos filas de encabezado con los nombres y tipos de las columnas, de forma similar a [TabSeparatedWithNamesAndTypes](../formats/TabSeparatedWithNamesAndTypes).
...
Inserte datos con el formato `CSVWithNamesAndTypes`:
