...
Se diferencia del formato [`TabSeparatedWithNames`](./TabSeparatedWithNames.md)
en que las filas se escriben sin aplicar escaping.
...
Lea los datos en formato `TabSeparatedRawWithNames`:
...
La salida estará en formato separado por tabuladores, con un encabezado de una sola línea:
