...
| `input_format_arrow_use_native_reader`                                       | Usa el lector nativo de ClickHouse para los formatos `Arrow` y `ArrowStream` en lugar de la biblioteca Apache Arrow. Establece `0` para usar el lector de la biblioteca Apache Arrow.                                                                              | `1`            |
...
| `output_format_arrow_unsupported_types_as_binary`                            | Genera como datos binarios sin procesar un tipo que no tiene equivalente en Arrow (por ejemplo, `BFloat16`, `AggregateFunction`). Si es `false`, ese tipo genera una excepción. Se aplica tanto al escritor nativo como al escritor de la biblioteca Apache Arrow. | `1`            |
...
| `output_format_arrow_use_native_writer`                                      | Usa el escritor nativo de ClickHouse para los formatos `Arrow` y `ArrowStream` en lugar de la biblioteca Apache Arrow. Establece `0` para usar el escritor de la biblioteca Apache Arrow.                                                                          | `1`            |
