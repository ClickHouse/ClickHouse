---
alias: []
description: 'Documentación sobre el formato Buffers'
input_format: true
keywords: ['Buffers']
output_format: true
...
A diferencia de [Native](./Native.md), **no** almacena nombres ni tipos de columna, ni metadatos adicionales.

En este formato, los datos se escriben y se leen en [bloques](/es/development/architecture#block) en formato binario. Buffers usa la misma representación binaria por columna que el formato [Native](./Native.md) y respeta la misma configuración de Native.
...
* Bytes de los datos de columna serializados, exactamente igual que en el formato [Native](./Native.md).
...
Léalo de nuevo con tipos de columna explícitos:
...
Si tiene una tabla con los mismos tipos de columnas, puede poblarla directamente:
