...
description: 'Documentación del formato PrettyJSONLines'
input_format: false
...
Se diferencia de [JSONEachRow](./JSONEachRow.md) solo en que el JSON está formateado de forma legible, con delimitadores de salto de línea y sangrías de 4 espacios.
...
Lea los datos con el formato `PrettyJSONEachRow`:
