---
alias: []
description: 'Documentación del formato JSONCompactStringsEachRowWithNames'
input_format: true
...
Se diferencia del formato [`JSONCompactEachRow`](./JSONCompactEachRow.md) en que también muestra la fila de encabezado con los nombres de las columnas, de forma similar al formato [TabSeparatedWithNames](../TabSeparated/TabSeparatedWithNames.md).
...
las columnas de los datos de entrada se asignarán a las columnas de la tabla según sus nombres; las columnas con nombres desconocidos se omitirán si la configuración [`input_format_skip_unknown_fields`](/es/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) está establecida en `1`.
