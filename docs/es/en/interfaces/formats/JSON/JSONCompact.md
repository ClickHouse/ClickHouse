---
alias: []
description: 'Documentación sobre el formato JSONCompact'
input_format: true
...
Se diferencia de [JSON](./JSON.md) únicamente en que las filas de datos se devuelven como arrays, no como objetos.
