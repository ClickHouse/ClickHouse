...
Se diferencia de [`JSONEachRow`](./JSONEachRow.md) únicamente en que los campos de datos se generan como cadenas, no como valores JSON con tipo.
...
Lea los datos en formato `JSONStringsEachRow`:
