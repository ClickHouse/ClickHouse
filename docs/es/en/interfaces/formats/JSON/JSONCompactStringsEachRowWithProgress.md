---
alias: []
description: 'Documentación del formato JSONCompactStringsEachRowWithProgress'
input_format: false
...
Similar a [`JSONCompactEachRowWithProgress`](/es/interfaces/formats/JSONCompactEachRowWithProgress), pero todos los valores se convierten en cadenas.
Esto resulta útil cuando se necesita una representación en cadena uniforme de todos los tipos de datos.

Características principales:

* La misma estructura que `JSONCompactEachRowWithProgress`
* Todos los valores se representan como cadenas (los números, arrays, etc. aparecen entre comillas como cadenas)
* Incluye actualizaciones de progreso, totales y manejo de excepciones
* Útil para clientes que prefieren o requieren datos basados en cadenas
