---
alias: []
description: 'Documentación sobre el formato JSONCompactEachRowWithProgress'
input_format: false
...
Este formato combina la salida compacta fila por fila de JSONCompactEachRow con información de progreso
en streaming.
Produce los datos como objetos JSON independientes para los metadatos, las filas individuales, las actualizaciones de progreso,
