...
En este formato, ClickHouse muestra cada fila como un objeto JSON independiente, separado por saltos de línea.

Este formato también se conoce como `JSONEachRow`, `JSONLines`, `NDJSON` (Newline Delimited JSON) o `JSONL`. Estos nombres son alias del mismo formato y pueden usarse indistintamente tanto para la entrada como para la salida.
...
Se omitirán las columnas de datos con nombres desconocidos al importarlas si la configuración [input&#95;format&#95;skip&#95;unknown&#95;fields](/es/operations/settings/settings-formats.md/#input_format_skip_unknown_fields) está establecida en 1.
