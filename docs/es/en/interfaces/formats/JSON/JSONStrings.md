...
Se diferencia del formato [JSON](./JSON.md) únicamente en que los campos de datos se muestran como cadenas, no como valores JSON con tipo. Es un formato solo de salida.
