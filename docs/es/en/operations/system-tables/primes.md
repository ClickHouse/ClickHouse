...
Puede usar esta tabla para realizar pruebas o si necesita hacer una búsqueda por fuerza bruta de números primos.

Las lecturas de esta tabla no se paralelizan.

Es similar a la table function [`primes`](/es/sql-reference/table-functions/primes).
...
* `prime` ([UInt64](/es/sql-reference/data-types/int-uint))
