---
description: 'Muestra el historial de conexiones a ZooKeeper (incluidos los ZooKeepers auxiliares).'
...
La tabla &#39;system.zookeeper&#95;connection&#95;log&#39; muestra el historial de las conexiones a ZooKeeper (incluidos los ZooKeepers auxiliares). Cada fila muestra información sobre un evento relacionado con esas conexiones.

:::note
La tabla no incluye eventos de desconexión causados por el apagado del servidor.
:::
...
* `hostname` ([LowCardinality(String)](/es/sql-reference/data-types/lowcardinality)) — Nombre de host del servidor que se conectó a ZooKeeper o se desconectó de él.
* `type` ([Enum8(&#39;Connected&#39; = 0, &#39;Disconnected&#39; = 1)](/es/sql-reference/data-types/enum)) — El tipo de evento. Valores posibles: Connected, Disconnected.
...
* `name` ([String](/es/sql-reference/data-types/string)) — Nombre del clúster de ZooKeeper.
* `host` ([String](/es/sql-reference/data-types/string)) — El nombre de host o la IP del nodo de ZooKeeper al que ClickHouse se conectó o del que se desconectó.
* `port` ([UInt16](/es/sql-reference/data-types/int-uint)) — El puerto del nodo de ZooKeeper al que ClickHouse se conectó o del que se desconectó.
* `index` ([UInt8](/es/sql-reference/data-types/int-uint)) — El índice del nodo de ZooKeeper al que ClickHouse se conectó o del que se desconectó. El índice proviene de la configuración de ZooKeeper.
* `client_id` ([Int64](/es/sql-reference/data-types/int-uint)) — ID de la sesión de la conexión.
* `keeper_api_version` ([UInt8](/es/sql-reference/data-types/int-uint)) — Versión de la API de Keeper.
* `enabled_feature_flags` ([Array(Enum16(&#39;FILTERED&#95;LIST&#39; = 0, &#39;MULTI&#95;READ&#39; = 1, &#39;CHECK&#95;NOT&#95;EXISTS&#39; = 2, &#39;CREATE&#95;IF&#95;NOT&#95;EXISTS&#39; = 3, &#39;REMOVE&#95;RECURSIVE&#39; = 4, &#39;MULTI&#95;WATCHES&#39; = 5, &#39;CHECK&#95;STAT&#39; = 6, &#39;PERSISTENT&#95;WATCHES&#39; = 7, &#39;CREATE&#95;WITH&#95;STATS&#39; = 8, &#39;TRY&#95;REMOVE&#39; = 9, &#39;LIST&#95;WITH&#95;STAT&#95;AND&#95;DATA&#39; = 10, &#39;GET&#95;CHILDREN&#95;RECURSIVE&#39; = 11))](/es/sql-reference/data-types/array)) — Feature flags habilitados. Solo aplicable a ClickHouse Keeper.
* `availability_zone` ([String](/es/sql-reference/data-types/string)) — Zona de disponibilidad
* `reason` ([LowCardinality(String)](/es/sql-reference/data-types/lowcardinality)) — Motivo de la conexión o desconexión.
