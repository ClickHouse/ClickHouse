...
sidebar_label: 'Datos externos para el procesamiento de consultas'
...
Por ejemplo, si tiene un archivo de texto con identificadores de usuario importantes, puede cargarlo en el servidor junto con una consulta que filtre según esta lista.

Si necesita ejecutar más de una consulta con un gran volumen de datos externos, no use esta función. Es mejor cargar los datos en la base de datos con antelación.
...
**–file** – Ruta al archivo con el dump de la tabla, o -, que hace referencia a stdin.
Solo se puede obtener una única tabla desde stdin.
...
Los archivos especificados en &#39;file&#39; se procesarán con el formato especificado en &#39;format&#39;, usando los tipos de datos especificados en &#39;types&#39; o &#39;structure&#39;. La tabla se cargará en el servidor y estará accesible allí como una tabla temporal con el nombre indicado en &#39;name&#39;.
