...
-   input\_string — Any set of bytes represented as the [Cadena](../../sql_reference/data_types/string.md) objeto de tipo de datos.
...
-   `s` — The string to repeat. [Cadena](../../sql_reference/data_types/string.md).
...
-   `trim_character` — specified characters for trim. [Cadena](../../sql_reference/data_types/string.md).
-   `input_string` — string for trim. [Cadena](../../sql_reference/data_types/string.md).
...
-   `input_string` — string to trim. [Cadena](../../sql_reference/data_types/string.md).
