...
-   `expr` — Expression resulting in a [Cadena](../../sql_reference/data_types/string.md) valor de tipo. Todas las barras diagonales inversas deben escaparse en el valor resultante.
...
-   `x` — Value to be checked for infinity. Type: [Flotante\*](../../sql_reference/data_types/float.md).
-   `y` — Fallback value. Type: [Flotante\*](../../sql_reference/data_types/float.md).
...
Devuelve el número de campos en [Enum](../../sql_reference/data_types/enum.md).
...
-   `ᴺᵁᴸᴸ` para [NULL](../../sql_reference/data_types/nullable.md).
...
Devuelve la capacidad del sistema de archivos en bytes. Para la evaluación, el [camino](../../operations/server_configuration_parameters/settings.md#server_configuration_parameters-path) al directorio de datos debe estar configurado.
...
La función le permite extraer datos de la tabla de la misma manera que [diccionario](../../sql_reference/dictionaries/index.md).

Obtiene datos de [Unir](../../engines/table_engines/special/join.md#creating-a-table) usando la clave de unión especificada.
...
Más información sobre `join_use_nulls` en [Únase a la operación](../../engines/table_engines/special/join.md).
...
Tipo: [Cadena](../../sql_reference/data_types/string.md)
