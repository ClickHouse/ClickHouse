...
-   `separator` — The separator which should contain exactly one character. [Cadena](../../sql_reference/data_types/string.md).
-   `s` — The string to split. [Cadena](../../sql_reference/data_types/string.md).
...
Tipo: [Matriz](../../sql_reference/data_types/array.md) de [Cadena](../../sql_reference/data_types/string.md).
...
-   `separator` — The separator. [Cadena](../../sql_reference/data_types/string.md).
-   `s` — The string to split. [Cadena](../../sql_reference/data_types/string.md).
