...
Comprueba si el argumento es [NULL](../syntax.md#null).
...
Resultados en un valor de tipo [NULL](../../sql_reference/data_types/nullable.md) para un no- `Nullable` si el valor no es `NULL`.
