...
-   `arrays` – Arbitrary number of arguments of [Matriz](../../sql_reference/data_types/array.md) tipo.
    **Ejemplo**
...
-   `agg_func` — The name of an aggregate function which should be a constant [cadena](../../sql_reference/data_types/string.md).
-   `arr` — Any number of [matriz](../../sql_reference/data_types/array.md) escriba columnas como los parámetros de la función de agregación.
...
-   `agg_func` — The name of an aggregate function which should be a constant [cadena](../../sql_reference/data_types/string.md).
-   `ranges` — The ranges to aggretate which should be an [matriz](../../sql_reference/data_types/array.md) de [tuplas](../../sql_reference/data_types/tuple.md) que contiene el índice y la longitud de cada rango.
-   `arr` — Any number of [matriz](../../sql_reference/data_types/array.md) escriba columnas como los parámetros de la función de agregación.
...
-   `array_of_arrays` — [Matriz](../../sql_reference/data_types/array.md) de matrices. Por ejemplo, `[[1,2,3], [4,5]]`.
...
`arr` — The [matriz](../../sql_reference/data_types/array.md) inspeccionar.
...
`arr` — Any number of [matriz](../../sql_reference/data_types/array.md) escriba columnas para combinar.
