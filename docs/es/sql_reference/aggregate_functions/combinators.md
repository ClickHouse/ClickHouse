...
-   [AgregaciónMergeTree](../../engines/table_engines/mergetree_family/aggregatingmergetree.md) motor de mesa.
-   [finalizeAggregation](../../sql_reference/functions/other_functions.md#function-finalizeaggregation) función.
-   [runningAccumulate](../../sql_reference/functions/other_functions.md#function-runningaccumulate) función.
