...
| Estado transaccional de la aplicación junto con consultas analíticas que requieren un sistema de servicio independiente                                     | [Services de Postgres y ClickHouse en ClickHouse Cloud](/es/products/managed-postgres/clickhouse-integration) | Qué tablas necesitan replicación, el retraso de replicación aceptable, los cambios de esquema y el coste y la operación de dos services                    |
