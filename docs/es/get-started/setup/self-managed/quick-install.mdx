...
<Steps>
  <Step title="Instala ClickHouse usando curl" id="install-clickhouse-using-curl">
    ...
    En Linux y macOS, esto también instala [`clickhousectl`](/es/install/clickhousectl),
    ...
    segundo plano y administrar ClickHouse Cloud. Consulta la [página de instalación de clickhousectl](/es/install/clickhousectl)
