...
<Steps>
  ...
  <Step title="Agregar datos" id="3-add-data">
    ...
    * las claves primarias en ClickHouse ***no son únicas*** para cada fila de una tabla
    ...
    Para profundizar en los conceptos fundamentales de ClickHouse, consulte [&quot;Core Concepts&quot;](/es/concepts/core-concepts/index).
...
* El [Tutorial](/get-started/quickstarts/tutorial) te guía para insertar 2 millones de filas en una tabla y escribir algunas consultas analíticas
