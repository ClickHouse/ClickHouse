...
<sub><span>*</span> ClickHouse también admite enteros sin signo con rangos más amplios; es decir, <a href="/es/sql-reference/data-types/int-uint">`UInt8`, `UInt32`, `UInt32` y `UInt64`</a>.</sub><br />
<sub><span>**</span>El tipo String de ClickHouse es ilimitado de forma predeterminada, pero puede limitarse a longitudes específicas mediante <a href="/es/sql-reference/statements/create/table#constraints">restricciones</a>.</sub>
