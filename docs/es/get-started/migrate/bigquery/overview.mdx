...
slug: /es/get-started/migrate/bigquery/overview
...
<div id="bigquery-projects-vs-clickhouse-cloud-services">
  ### Proyectos de BigQuery vs. servicios de ClickHouse Cloud {#bigquery-projects-vs-clickhouse-cloud-services}
</div>
...
<div id="bigquery-datasets-vs-clickhouse-cloud-databases">
  ### Datasets de BigQuery vs bases de datos de ClickHouse Cloud {#bigquery-datasets-vs-clickhouse-cloud-databases}
</div>
...
<div id="bigquery-folders">
  ### Carpetas de BigQuery {#bigquery-folders}
</div>
...
<div id="bigquery-slot-reservations-and-quotas">
  ### Reservas de slots y cuotas de BigQuery {#bigquery-slot-reservations-and-quotas}
</div>
...
<div id="query-acceleration-techniques">
  ## Técnicas de aceleración de consultas {#query-acceleration-techniques}
</div>

<div id="primary-and-foreign-keys-and-primary-index">
  ### Claves primarias y externas e índice primario {#primary-and-foreign-keys-and-primary-index}
</div>
...
<div id="secondary-indexes-only-available-in-clickhouse">
  ## Índices secundarios (Solo disponibles en ClickHouse) {#secondary-indexes-only-available-in-clickhouse}
</div>
...
<div id="querying-materialized-views">
  ## Consulta de las vistas materializadas {#querying-materialized-views}
</div>
...
<div id="data-sources-and-file-formats">
  ## Fuentes de datos y formatos de archivo {#data-sources-and-file-formats}
</div>
...
<div id="sql-language-features">
  ## Características del lenguaje SQL {#sql-language-features}
</div>
