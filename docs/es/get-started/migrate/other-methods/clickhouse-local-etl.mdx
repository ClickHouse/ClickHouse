...
Usaremos el [motor de tabla de integración](/es/reference/engines/table-engines/integrations/mysql) (creado sobre la marcha por la [función de tabla mysql](/es/reference/functions/table-functions/mysql)) para leer datos de la base de datos MySQL de origen, y la [función de tabla remoteSecure](/es/reference/functions/table-functions/remote)
