...
| OSS a Cloud                                                              | Transfiere datos desde una implementación autogestionada de ClickHouse mediante [`remoteSecure`](/es/get-started/migrate/oss-to-cloud/clickhouse-to-cloud) o [`BACKUP` y `RESTORE`](/es/get-started/migrate/oss-to-cloud/oss-to-cloud-backup-restore). |
