...
-   Uso de sesiones para conexiones con el protocolo de compatibilidad MySQL. Acerca de nosotros [\#5646](https://github.com/ClickHouse/ClickHouse/pull/5646) ([Yuriy Baranov](https://github.com/yurriy))
...
-   Bloqueo con sin comprimir\_cache + JOIN durante la fusión (\# 5197)
    ...
    Kutenin](https://github.com/danlark1))
-   Error de segmentación en una consulta de clickhouse-cliente a tablas del sistema. Acerca de nosotros
