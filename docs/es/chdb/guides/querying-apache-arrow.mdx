---
title: 'Cómo consultar Apache Arrow con chDB'
sidebarTitle: 'Consultar Apache Arrow'
slug: /chdb/guides/apache-arrow
description: 'En esta guía, aprenderemos a consultar tablas de Apache Arrow con chDB'
keywords: ['chdb', 'Apache Arrow']
doc_type: 'guide'
---

[Apache Arrow](https://arrow.apache.org/) es un formato de memoria estandarizado orientado a columna que ha ganado popularidad en la comunidad de datos.
...
Primero, descarguemos uno de los archivos Parquet del [conjunto de datos de Ookla](https://github.com/teamookla/ookla-open-data) con la [herramienta AWS CLI](https://aws.amazon.com/cli/):
