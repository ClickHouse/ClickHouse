---
title: 'SQL para usuarios de pandas'
sidebarTitle: 'Correspondencia con SQL'
slug: /chdb/guides/pandas-to-sql
description: 'Cómo se traducen las operaciones de pandas a SQL en DataStore'
keywords: ['chdb', 'datastore', 'pandas', 'sql', 'correspondencia', 'consulta']
doc_type: 'guide'
---
