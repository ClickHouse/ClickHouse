...
[JupySQL](https://jupysql.readthedocs.io/en/latest/quick-start.html) es una biblioteca de Python que permite ejecutar SQL en notebooks de Jupyter y en el shell de IPython.
...
Vamos a crear un histograma, pero primero escribamos (y guardemos) una consulta que calcule las clasificaciones dentro del top 100 que ha alcanzado cada jugador.
Podremos usar esto para crear un histograma que muestre cuántos jugadores alcanzaron cada clasificación:
...
<Image img="/images/chdb/guides/players_per_rank.webp" size="md" alt="Histograma de la clasificación de los jugadores en el conjunto de datos de la ATP" />