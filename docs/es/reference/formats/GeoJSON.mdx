---
alias: []
description: 'Formato de entrada y salida para documentos FeatureCollection de GeoJSON: en la entrada, una fila por cada feature con las columnas id, geometry y properties; en la salida, una feature por fila.'
input_format: true
output_format: true
keywords: ['GeoJSON']
