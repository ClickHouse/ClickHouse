...
| ------------------------------------- | ----------------------------------------------------------------------------------- | --------------------------- |
| `Boolean`                             | [Bool](/es/reference/data-types/boolean)                                               | `Boolean`                   |
...
| `Bigint`                              | [Int64/UInt64](/es/reference/data-types/int-uint)                                      | `Bigint`                    |
...
| `String`, `Varchar`, `Binary`          | [String](/es/reference/data-types/string)                                              | `String`                     |
| `Char`                                 | [FixedString](/es/reference/data-types/fixedstring)                                    | `String`                     |
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | -------------- |
| [`output_format_orc_string_as_string`](/es/reference/settings/formats#output_format_orc_string_as_string)                                                                                  | Usar el tipo String de ORC en lugar de Binary para las columnas String.                                  | `true`          |
| [`output_format_orc_compression_method`](/es/reference/settings/formats#output_format_orc_compression_method)                                                                             | Método de compresión usado para el formato ORC de salida. Valor predeterminado                           | `zstd`         |
| [`input_format_orc_case_insensitive_column_matching`](/es/reference/settings/formats#input_format_orc_case_insensitive_column_matching)                                                    | Ignorar mayúsculas y minúsculas al hacer coincidir las columnas de ORC con las columnas de ClickHouse.   | `false`         |
| [`input_format_orc_allow_missing_columns`](/es/reference/settings/formats#input_format_orc_allow_missing_columns)                                                                          | Permitir columnas ausentes al leer datos ORC.                                                            | `true`          |
| [`input_format_orc_skip_columns_with_unsupported_types_in_schema_inference`](/es/reference/settings/formats#input_format_orc_skip_columns_with_unsupported_types_in_schema_inference)      | Permitir omitir columnas con tipos no compatibles durante la inferencia de esquema del formato ORC.      | `false`         |
