...
ClickHouse admite la mayoría de los formatos de datos de texto y binarios conocidos. Esto permite una integración sencilla en casi cualquier
...
## Resumen de formatos {#formats-overview}
...
| [CustomSeparatedIgnoreSpaces](/es/reference/formats/CustomSeparated/CustomSeparatedIgnoreSpaces)                                   | ✔       | ✗      |
| [CustomSeparatedIgnoreSpacesWithNames](/es/reference/formats/CustomSeparated/CustomSeparatedIgnoreSpacesWithNames)                 | ✔       | ✗      |
| [CustomSeparatedIgnoreSpacesWithNamesAndTypes](/es/reference/formats/CustomSeparated/CustomSeparatedIgnoreSpacesWithNamesAndTypes) | ✔       | ✗      |
...
| [HiveText](/es/reference/formats/HiveText)                                                                                         | ✔       | ✔      |
...
| [JSONLines](/es/reference/formats/JSON/JSONLines)                                                                                  | ✔       | ✔      |
...
| [MySQLWire](/es/reference/formats/MySQLWire)                                                                                       | ✗       | ✔      |
| [PostgreSQLWire](/es/reference/formats/PostgreSQLWire)                                                                             | ✗       | ✔      |
| [ODBCDriver2](/es/reference/formats/ODBCDriver2)                                                                                   | ✗       | ✔      |
...
| [PNG](/es/reference/formats/PNG)                                                                                                   | ✗       | ✔      |
| [Puffin](/es/reference/formats/Puffin/Puffin)                                                                                      | ✔       | ✗      |
| [PuffinMetadata](/es/reference/formats/Puffin/PuffinMetadata)                                                                      | ✔       | ✗      |
...
Los ajustes adicionales específicos de JSON se documentan en la página [ajustes del formato JSON](/es/reference/formats/JSON/format-settings).
...
debe estar ubicado en el directorio especificado en [format&#95;schema&#95;path](/es/reference/settings/server-settings/settings/format#format_schema_path)
de la configuración del servidor.

## Ignorar errores {#skippingerrors}

Algunos formatos, como `CSV`, `TabSeparated`, `TSKV`, `JSONEachRow`, `Template`, `CustomSeparated` y `Protobuf`, pueden omitir una fila incorrecta si se produce un error de análisis y continuar analizando desde el comienzo de la siguiente fila. Consulte los ajustes [input&#95;format&#95;allow&#95;errors&#95;num](/es/reference/settings/formats/input-format#input_format_allow_errors_num) e
[input&#95;format&#95;allow&#95;errors&#95;ratio](/es/reference/settings/formats/input-format#input_format_allow_errors_ratio).
Limitaciones:
