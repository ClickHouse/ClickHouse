---
alias: []
description: 'Documentación del formato JSONCompact'
input_format: true
...
Se diferencia de [JSON](/es/reference/formats/JSON/JSON) solo en que las filas de datos se muestran como arrays, no como objetos.
