...
Se diferencia del formato [JSON](/es/reference/formats/JSON/JSON) únicamente en que los campos de datos se devuelven como cadenas, no como valores JSON tipados. Este es un formato solo de salida.
