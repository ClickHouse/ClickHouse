---
description: 'El motor `Atomic` admite consultas [`DROP TABLE`](#drop-detach-table) y [`RENAME TABLE`](#rename-table) sin bloqueo, y consultas [`EXCHANGE TABLES`](#exchange-tables) Atomic. El motor de base de datos `Atomic` se usa de forma predeterminada.'
sidebarTitle: 'Atomic'
...
<Note>
  Puedes usar la configuración [show&#95;table&#95;uuid&#95;in&#95;table&#95;create&#95;query&#95;if&#95;not&#95;nil](/es/reference/settings/session-settings#show_table_uuid_in_table_create_query_if_not_nil) para mostrar el UUID en la consulta `SHOW CREATE`.
</Note>
