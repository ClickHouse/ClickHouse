...
La tabla [tags](#tags-table) mantiene las columnas de etiquetas (y los Maps `tags`/`all_tags`) fuera de su clave de ordenación,
...
para una tabla de tags de agregación [externa](#external-target-tables) creada manualmente, debe configurarlo usted mismo.
