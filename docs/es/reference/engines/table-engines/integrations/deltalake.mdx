...
<Note>
  ...
  Las escrituras de Delta Lake son una funcionalidad Beta y deben habilitarse con `SET allow_delta_lake_writes = 1` (disponible a partir de la versión 26.7; en versiones anteriores use `SET allow_experimental_delta_lake_writes = 1`).
</Note>
