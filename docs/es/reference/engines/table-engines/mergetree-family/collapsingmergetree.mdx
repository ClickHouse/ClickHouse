...
```text
┌──────────────UserID─┬─PageViews─┬─Duration─┬─Sign─┐
│ 4324182021466249494 │         5 │      146 │    1 │ -- la fila de "estado" antigua puede eliminarse
│ 4324182021466249494 │         5 │      146 │   -1 │ -- la fila de "cancelación" puede eliminarse
│ 4324182021466249494 │         6 │      185 │    1 │ -- la nueva fila de "estado" permanece
└─────────────────────┴───────────┴──────────┴──────┘
```
...
1. El programa que escribe los datos debe recordar el estado de un objeto para poder cancelarlo. La fila de &quot;cancel&quot; debe contener copias de los campos de la clave de ordenación del &quot;state&quot; y el `Sign` opuesto. Esto aumenta el tamaño inicial del almacenamiento, pero permite escribir los datos rápidamente.
