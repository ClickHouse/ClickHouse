...
<Accordion title="Activar el analizador completo">
  ...
  mediante la configuración [`input_format_values_interpret_expressions`](/es/reference/settings/formats/input-format#input_format_values_interpret_expressions).
...
Cuando se recibe una consulta, el servidor calcula no más de [max&#95;query&#95;size](/es/reference/settings/session-settings/max#max_query_size) bytes de la solicitud en RAM
...
<Note>
  Puede cambiar este comportamiento predeterminado estableciendo [prefer&#95;column&#95;name&#95;to&#95;alias](/es/reference/settings/session-settings/prefer#prefer_column_name_to_alias) en `1`.
</Note>
