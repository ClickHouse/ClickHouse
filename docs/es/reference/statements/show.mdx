...
<Note>
  ...
  * [`display_secrets_in_show_and_select`](/es/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select) (SETTING del servidor)
  * [`format_display_secrets_in_show_and_select` ](/es/reference/settings/formats/format#format_display_secrets_in_show_and_select) (SETTING de formato)
