...
* Configuración [insert&#95;null&#95;as&#95;default](/es/reference/settings/session-settings/insert#insert_null_as_default).
* Configuración [union&#95;default&#95;mode](/es/reference/settings/session-settings/other#union_default_mode).