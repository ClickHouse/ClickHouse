...
**Ejemplo 6:** Reutilizar una expresión escalar común definida como lambda en una subconsulta

Defina la expresión escalar común como una lambda para vincular explícitamente su argumento:
