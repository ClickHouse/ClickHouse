...
Si desea usar números de columna en lugar de nombres de columna en la cláusula `LIMIT BY`, habilite la configuración [enable&#95;positional&#95;arguments](/es/reference/settings/session-settings/enable-positional-arguments#enable_positional_arguments).
