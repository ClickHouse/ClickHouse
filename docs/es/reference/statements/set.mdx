...
Para obtener más información sobre la SETTING `session_timezone`, consulta [session&#95;timezone](/es/reference/settings/session-settings/other#session_timezone).
