...
La función [dictGetHierarchy](/es/reference/functions/regular-functions/ext-dict-functions#dictGetHierarchy) permite obtener la cadena de padres de un elemento.
