...
<Info>
  ...
  mediante el ajuste [`allow_experimental_ytsaurus_dictionary_source`](/es/reference/settings/session-settings/allow-experimental#allow_experimental_ytsaurus_dictionary_source).
</Info>
