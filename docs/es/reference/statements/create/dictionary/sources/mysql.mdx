...
| `ssl_ca`, `ssl_cert`, `ssl_key` | Las mismas credenciales como rutas a archivos en el servidor. Solo se permiten para un diccionario definido en un archivo de configuración del servidor; consulta más abajo. Opcional.                                                                                                                                                                                                  |
