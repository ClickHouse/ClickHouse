...
Para que ClickHouse pueda acceder a un recurso HTTPS, debe [configurar OpenSSL](/es/reference/settings/server-settings/settings/other#openssl) en la configuración del servidor.
