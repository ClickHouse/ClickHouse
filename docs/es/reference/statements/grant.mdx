...
* `SYSTEM`. Nivel: `GROUP`
  ...
  * `SYSTEM RELOAD`. Nivel: `GROUP`
    ...
    * `SYSTEM RELOAD DICTIONARY`. Nivel: `GLOBAL`. Alias: `SYSTEM RELOAD DICTIONARIES`, `RELOAD DICTIONARY`, `RELOAD DICTIONARIES`, `SYSTEM UNLOAD DICTIONARY`, `SYSTEM UNLOAD DICTIONARIES`, `UNLOAD DICTIONARY`, `UNLOAD DICTIONARIES`
  ...
  * `SYSTEM BACKGROUND`. Nivel: `GROUP`
    * `SYSTEM STREAMING ENGINES`. Nivel: `TABLE`
    * `SYSTEM VIEWS`. Nivel: `VIEW`. Alias: `SYSTEM REFRESH VIEW`, `SYSTEM START VIEWS`, `SYSTEM STOP VIEWS`, `SYSTEM START VIEW`, `SYSTEM STOP VIEW`, `SYSTEM PAUSE VIEWS`, `SYSTEM PAUSE VIEW`, `SYSTEM CANCEL VIEW`, `REFRESH VIEW`, `START VIEWS`, `STOP VIEWS`, `START VIEW`, `STOP VIEW`, `PAUSE VIEWS`, `PAUSE VIEW`, `CANCEL VIEW`
...
[`display_secrets_in_show_and_select` configuración del servidor](/es/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select)
como la
[`format_display_secrets_in_show_and_select` configuración de formato](/es/reference/settings/formats/format#format_display_secrets_in_show_and_select)
están activadas.
