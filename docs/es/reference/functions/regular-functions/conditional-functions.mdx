...
:::note Use la configuración `least_greatest_legacy_null_behavior` para cambiar el comportamiento de `NULL`
...
Devuelve el mayor valor entre los argumentos, convertido al tipo compatible de mayor tamaño. [`Any`](/es/reference/data-types/index)
