...
### Valores NULL en las expresiones condicionales {#null-values-in-conditionals}
...
<Note title="Use la configuración `least_greatest_legacy_null_behavior` para cambiar el comportamiento de `NULL`">
