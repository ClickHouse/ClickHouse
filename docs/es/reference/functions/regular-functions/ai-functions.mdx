...
### Parámetros de la colección nombrada {#named-collection-parameters}
...
### Selección de credenciales {#selecting-credentials}
...
### Mapa de parámetros {#parameter-map}
...
### Configuración a nivel de consulta {#query-level-settings}
...
### Restricción de hosts de endpoint {#restricting-endpoint-hosts}
...
### Seguridad del transporte (HTTP vs HTTPS) {#transport-security}
