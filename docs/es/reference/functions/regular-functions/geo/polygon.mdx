---
description: 'Documentación sobre Polygon'
sidebarTitle: 'Polígono'
slug: /sql-reference/functions/geo/polygons
title: 'Funciones para trabajar con Polygon'
doc_type: 'reference'
---
...
Devuelve un objeto geométrico WKT (Well Known Text) a partir de varios [tipos de datos Geo](/es/reference/data-types/geo). Los objetos WKT compatibles son:
...
`geo_data` puede ser uno de los siguientes [tipos de datos Geo](/es/reference/data-types/geo) o uno de sus tipos primitivos subyacentes:

* [Point](/es/reference/data-types/geo#point)
* [MultiPoint](/es/reference/data-types/geo#multipoint)
...
* [LineString](/es/reference/data-types/geo#linestring)
* [MultiLineString](/es/reference/data-types/geo#multilinestring)

**Valor devuelto**

* Se devuelve el objeto geométrico WKT `POINT` para un Point.
* Se devuelve el objeto geométrico WKT `MULTIPOINT` para un MultiPoint.
...
```response
MULTIPOLYGON(((0 0,10 0,10 0,10 10,0 10,0 0),(4 4,5 4,5 5,4 5,4 4)),((-10 -10,-10 -9,-9 10,-10 -10)))
```
...
Analiza una representación de Well-Known Text (WKT) de una geometría MultiPoint y la devuelve en el formato interno de ClickHouse.
...
* `wkt_string`: La cadena WKT de entrada que representa una geometría de tipo MultiPoint.

<div id="returned-value">
  ### Valor devuelto
</div>

La función devuelve una representación interna de ClickHouse de la geometría de multipuntos.
...
Analiza una representación Well-Known Binary (WKB) de una geometría MultiPoint y la devuelve en el formato interno de ClickHouse.
...
* `wkb_string`: La cadena WKB de entrada que representa una geometría MultiPoint.

<div id="returned-value">
  ### Valor devuelto
</div>

La función devuelve una representación interna de ClickHouse de la geometría multipunto.
...
A diferencia de [`polygonsIntersectCartesian`](#polygonsintersectcartesian), acepta cualquier tipo de dato geométrico
(`Point`, `MultiPoint`, `LineString`, `MultiLineString`, `Ring`, `Polygon`, `MultiPolygon`), incluido el tipo común
[`Geometry`](/es/reference/data-types/geo#geometry), y los dos argumentos pueden ser de tipos distintos.
...
A diferencia de [`polygonsIntersectSpherical`](#polygonsintersectspherical), acepta cualquier tipo de dato geométrico
(`Point`, `MultiPoint`, `LineString`, `MultiLineString`, `Ring`, `Polygon`, `MultiPolygon`), incluido el tipo común
[`Geometry`](/es/reference/data-types/geo#geometry), y los dos argumentos pueden ser de tipos diferentes.
...
Calcula la envolvente convexa. [Referencia](https://www.boost.org/doc/libs/1_61_0/libs/geometry/doc/html/geometry/reference/algorithms/convex_hull.html)
