...
Devuelve un objeto geométrico WKT (Well Known Text) a partir de varios [tipos de datos geográficos](/es/reference/data-types/geo). Los objetos WKT compatibles son:
...
(`Point`, `LineString`, `MultiLineString`, `Ring`, `Polygon`, `MultiPolygon`), incluido el tipo común
