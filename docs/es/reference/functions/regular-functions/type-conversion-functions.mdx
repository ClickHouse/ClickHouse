...
Admite conversiones desde `String`, `FixedString`, `Date`, `Date32`, `Time`, `DateTime`, `DateTime64` o tipos numéricos (`(U)Int8`, `(U)Int16`, `(U)Int32`, `(U)Int64`, `(U)Int128`, `(U)Int256`, `BFloat16`, `Float32`, `Float64`). Los valores `Decimal` y `Time64` no son compatibles y generan una excepción; un valor del tipo `Time` se desborda en lugar de saturarse.
