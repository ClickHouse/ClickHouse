...
Admite conversiones desde `String`, `FixedString`, `Date`, `Date32`, `Time`, `DateTime`, `DateTime64` o tipos numéricos (`(U)Int8`, `(U)Int16`, `(U)Int32`, `(U)Int64`, `BFloat16`, `Float32`, `Float64`). Los valores `Decimal` y `Time64` no son compatibles y generan una excepción; el tipo `Time` y los tipos de enteros de gran tamaño, como `(U)Int128`/`(U)Int256`, se desbordan en lugar de saturarse.
...
Las conversiones desde otros tipos de fecha y hora, como `Date32` o `DateTime64`, siguen la configuración `date_time_overflow_behavior`: el modo predeterminado `ignore` puede producir valores con desbordamiento, `saturate` los limita a los límites del intervalo y `throw` genera una excepción.
...
* `x` — Valor de entrada que se convertirá. [`String`](/es/reference/data-types/string), [`FixedString`](/es/reference/data-types/fixedstring), [`(U)Int*`](/es/reference/data-types/int-uint), [`Float*`](/es/reference/data-types/float), [`BFloat16`](/es/reference/data-types/float), [`Date`](/es/reference/data-types/date), [`Date32`](/es/reference/data-types/date32), [`Time`](/es/reference/data-types/time), [`DateTime`](/es/reference/data-types/datetime) o [`DateTime64`](/es/reference/data-types/datetime64)
...
Admite la conversión desde String, FixedString, DateTime, DateTime64 o tipos numéricos que representan segundos transcurridos desde la medianoche.
...
* `x` — Valor de entrada que se debe convertir. [`String`](/es/reference/data-types/string) o [`FixedString`](/es/reference/data-types/fixedstring) o [`DateTime`](/es/reference/data-types/datetime) o [`DateTime64`](/es/reference/data-types/datetime64) o [`(U)Int*`](/es/reference/data-types/int-uint) o [`BFloat16`](/es/reference/data-types/float) o [`Float*`](/es/reference/data-types/float)
