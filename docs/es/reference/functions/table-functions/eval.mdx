...
También requiere el analizador ([`enable_analyzer`](/es/reference/settings/session-settings/allow-experimental#allow_experimental_analyzer), activado de forma predeterminada).
