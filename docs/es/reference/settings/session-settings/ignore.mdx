...
Solo tiene efecto en ClickHouse Cloud. Excluye las partes de datos nuevas de las consultas SELECT hasta que se hayan precalentado (véase [cache&#95;populated&#95;by&#95;fetch](/es/reference/settings/merge-tree-settings/cache-populated-by-fetch#cache_populated_by_fetch)) o hasta que alcancen esta antigüedad en segundos. Solo para Replicated-/SharedMergeTree.
