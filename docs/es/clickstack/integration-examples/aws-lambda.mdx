...
<Info>
  ...
  * Configurar la extensión para exportar logs y trazas a ClickStack
...
<Steps>
  <Step title="Elige la capa adecuada de Rotel Lambda Extension" id="choose-layer">
  ...
  <Step title="Añade la capa Rotel a tu función Lambda" id="add-layer">
  ...
  <Step title="Configura la extensión para exportar a ClickStack" id="configure-extension">
  ...
  <Step title="Probar la integración" id="test-integration">
  ...
  <Step title="Verifica los logs en HyperDX" id="verify-logs">
...
<Steps>
  <Step title="Quitar los permisos de CloudWatch del rol de ejecución" id="remove-permissions">
  ...
  <Step title="Verifica que el logging de CloudWatch esté deshabilitado" id="verify-disabled">
...
<Steps>
  <Step title="Elige la capa de instrumentación para tu lenguaje" id="choose-instrumentation">
  ...
  <Step title="Agrega ambas capas a tu función" id="add-both-layers">
  ...
  <Step title="Configura la autoinstrumentación" id="configure-instrumentation">
