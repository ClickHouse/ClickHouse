...
<Steps>
  <Step title="Verifique que se pueda acceder a los metadatos de EC2" id="verify-metadata">
  ...
  <Step title="Instalar OpenTelemetry Collector" id="install-collector">
  ...
  <Step title="Crear la configuración del collector" id="create-config">
  ...
  <Step title="Configura la API key de ClickStack" id="set-api-key">
  ...
  <Step title="Ejecuta el collector" id="run-collector">
...
<Steps>
  ...
  <Step title="Crear una configuración de prueba para el collector" id="test-config">
...
<Steps>
  <Step title="Descargar la configuración del dashboard" id="download">
    <TrackedLink href={'https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/host-logs-dashboard.json'} download="host-logs-dashboard.json" eventName="docs.ec2_host_logs_monitoring.dashboard_download">Descargar el archivo de configuración del dashboard</TrackedLink>.
  </Step>

  <Step title="Importa el dashboard preconfigurado" id="import-dashboard">
    1. Abre HyperDX y ve a la sección dashboard
