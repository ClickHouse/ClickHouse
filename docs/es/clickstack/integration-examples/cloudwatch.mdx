...
<Steps>
  ...
  <Step title="Configura las credenciales de AWS" id="configure-aws">
  ...
  <Step title="Configura el receptor de CloudWatch" id="configure-receiver">
  ...
  <Step title="Inicie el collector" id="start-collector">
  ...
  <Step title="Verificar los logs en HyperDX" id="verify-logs">
...
<Steps>
  ...
  <Step title="Importar el dataset de demostración" id="import-demo-data">
    ```bash
  ...
  <Step title="Verificar los datos de demostración" id="verify-demo-logs">
    Una vez importados:
...
<Steps>
  <Step title="Descargar la configuración del dashboard" id="download">
    <TrackedLink href={'https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Descargar el archivo de configuración del dashboard</TrackedLink>.
  </Step>

  <Step title="Importar el dashboard" id="import-dashboard">
  ...
  <Step title="Ver el dashboard" id="created-dashboard">
    ...
    <Image img="/images/clickstack/cloudwatch/logs-dashboard.webp" alt="Dashboard de logs de CloudWatch" />
