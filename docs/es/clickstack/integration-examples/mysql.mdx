...
<Steps>
  <Step title="Configurar el registro de MySQL" id="configure-mysql">
  ...
  <Step title="Crear una configuración personalizada de OTel collector" id="custom-otel">
...
<Steps>
  ...
  <Step title="Verifica los logs en HyperDX" id="verify-demo-logs">
...
<Steps>
  <Step title="Descargar la configuración del dashboard" id="download">
    <TrackedLink href={'https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/mysql-logs-dashboard.json'} download="mysql-logs-dashboard.json" eventName="docs.mysql_logs_monitoring.dashboard_download">Descargar el archivo de configuración del dashboard</TrackedLink>.
  </Step>
