...
<Steps>
  <Step title="Verifique la configuración de logging de MongoDB" id="verify-mongodb">
  ...
  <Step title="Cree una configuración personalizada para el OTel collector de MongoDB" id="custom-otel">
...
<Steps>
  <Step title="Descarga el dataset de ejemplo" id="download-sample">
  ...
  <Step title="Crea la configuración de prueba del collector" id="test-config">
...
<Steps>
  <Step title="Descargar la configuración del dashboard" id="download">
    <TrackedLink href={'https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/mongodb-logs-dashboard.json'} download="mongodb-logs-dashboard.json" eventName="docs.mongodb_logs_monitoring.dashboard_download">Descargar el archivo de configuración del dashboard</TrackedLink>.
  </Step>
