...
<Steps>
  <Step title="Configurar el registro de PostgreSQL" id="configure-postgres">
...
<Steps>
  ...
  <Step title="Crea una configuración de collector de prueba" id="test-config">
...
<Steps>
  <Step title="Descargar la configuración del dashboard" id="download">
    <TrackedLink href={'https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/postgres-logs-dashboard.json'} download="postgresql-logs-dashboard.json" eventName="docs.postgres_logs_monitoring.dashboard_download">Descargar el archivo de configuración del dashboard</TrackedLink>.
  </Step>
