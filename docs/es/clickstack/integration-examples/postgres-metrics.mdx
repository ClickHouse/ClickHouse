...
<Steps>
  <Step title="Asegúrese de que el usuario de monitorización tenga los permisos necesarios" id="monitoring-permissions">
  ...
  <Step title="Cree una configuración personalizada del OpenTelemetry Collector" id="create-custom-config">
  ...
  <Step title="Despliegue ClickStack con una configuración personalizada" id="deploy-clickstack">
  ...
  <Step title="Verifique la recopilación de métricas" id="verify-metrics">
...
<Steps>
  ...
  <Step title="Verificar métricas en HyperDX" id="verify-metrics-demo">
...
<Steps>
  <Step title="Descargar la configuración del dashboard" id="download">
    <TrackedLink href={'https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/postgres-metrics-dashboard.json'} download="postgres-metrics-dashboard.json" eventName="docs.postgres_metrics_monitoring.dashboard_download">Descargar el archivo de configuración del dashboard</TrackedLink>.
  </Step>
