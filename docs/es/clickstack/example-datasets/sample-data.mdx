...
<Tabs>
  ...
  <Tab title="ClickStack Open Source">
    El siguiente ejemplo asume que ha iniciado ClickStack Open Source usando la [imagen todo en uno](/es/clickstack/getting-started/oss) y ha copiado la [API key de ingesta](/es/clickstack/getting-started/oss#copy-ingestion-api-key).
