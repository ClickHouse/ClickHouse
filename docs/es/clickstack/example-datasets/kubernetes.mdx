...
<Steps>
  <Step title="Instalar cert-manager (opcional)" id="install-cert-manager">
  ...
  <Step title="Despliega OpenTelemetry Demo (opcional)" id="deploy-otel-demo">
  ...
  <Step title="Añade el repositorio del gráfico de Helm de ClickStack" id="add-helm-clickstack">
  ...
  <Step title="Implementar ClickStack" id="deploy-clickstack">
  ...
  <Step title="Acceder a la UI de HyperDX" id="access-the-hyperdx-ui">
    <Note>
  ...
  <Step title="Obtener la API key de ingesta" id="retrieve-ingestion-api-key">
  ...
  <Step title="Crear un Secret de Kubernetes para la API key" id="create-api-key-kubernetes-secret">
  ...
  <Step title="Desplegar los componentes del collector de Kubernetes" id="deploy-kubernetes-collector-components">
  ...
  <Step title="Explora los datos de Kubernetes en HyperDX" id="explore-kubernetes-data-hyperdx">
