...
<Steps>
  ...
  <Step title="Añadir el repositorio de Helm de ClickStack" id="add-the-clickstack-helm-repository">
  ...
  <Step title="Instalación de ClickStack" id="installing-clickstack">
  ...
  <Step title="Verificar la instalación" id="verify-the-installation">
  ...
  <Step title="Reenvío de puertos" id="forward-ports">
  ...
  <Step title="Accede a la UI" id="navigate-to-the-ui">
  ...
  <Step title="Personalizar valores (opcional)" id="customizing-values">
  ...
  <Step title="Uso de secretos (opcional)" id="using-secrets">
