...
<Steps>
  <Step title="Clona el repositorio" id="clone-the-repo">
  ...
  <Step title="Accede a la UI de HyperDX" id="navigate-to-hyperdx-ui">
    ...
    <Info>
      **Sobrescribir la conexión predeterminada**
      ...
      Puedes sobrescribir la conexión predeterminada de la instancia integrada de ClickHouse. Para obtener más información, consulta [&quot;Uso de ClickHouse Cloud&quot;](#using-clickhouse-cloud).
    </Info>
