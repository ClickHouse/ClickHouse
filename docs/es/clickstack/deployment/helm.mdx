...
<Steps>
  ...
  <Step title="Agrega el repositorio de Helm de ClickStack" id="add-the-clickstack-helm-repository">
  ...
  <Step title="Instala los operadores" id="install-the-operators">
  ...
  <Step title="Instalar ClickStack" id="installing-clickstack">
  ...
  <Step title="Verifique la instalación" id="verify-the-installation">
  ...
  <Step title="Personalización de valores (opcional)" id="customizing-values">
