---
slug: /es/clickstack/architecture
...
### ClickHouse Cloud: el motor {#clickhouse-cloud}
    ...
    * Capacidad para [aislar de forma independiente las cargas de trabajo de lectura y escritura](/es/clickstack/managing/isolating-read-write) con Warehouses
    * Autenticación integrada
    * Backups automatizados
    * Funciones de seguridad y compliance
    * Actualizaciones sin interrupciones

### OpenTelemetry collector: ingestión de datos {#open-telemetry-collector-managed}
...
### UI de ClickStack (HyperDX): la interfaz {#hyperdx}
...
### ClickHouse: el motor de base de datos {#clickhouse}
...
### OpenTelemetry collector: ingestión de datos {#open-telemetry-collector}
...
### ClickStack UI (HyperDX): la interfaz {#hyperdx-ui}
...
### MongoDB: estado de la aplicación {#mongo}
