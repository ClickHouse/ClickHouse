...
<Tabs>
  <Tab title="ClickStack gestionado">
    ...
    * La posibilidad de [aislar de forma independiente las cargas de trabajo de lectura y escritura](/es/clickstack/managing/isolating-read-write) con Warehouses.
...
### Proteger la ingestión {#secure-ingestion-managed}
...
#### Crear un usuario de ingestión {#create-a-database-ingestion-user-managed}
...
### Configurar Time To Live (TTL) {#configure-ttl-managed}
...
### Estimación de recursos {#estimating-resources}
...
#### Aislar cargas de trabajo de observabilidad {#isolating-workloads}
...
#### Aislar cargas de trabajo de lectura y escritura {#isolating-read-write}

    Los Warehouses también permiten separar en capacidad de cómputo dedicada las propias cargas de trabajo de ingestión y de consulta de ClickStack, de modo que la ingestión se dirija a un servicio de lectura y escritura y la UI de ClickStack se ejecute en un servicio de solo lectura. Esta es la topología de producción recomendada para despliegues más grandes. Consulta [&quot;Aislar cargas de trabajo de lectura y escritura&quot;](/es/clickstack/managing/isolating-read-write).
...
### Seguridad de red y puertos {#network-security}
...
### Configuración del secret de sesión {#session-secret}
...
### Ingestión segura {#secure-ingestion}
...
#### Crear un usuario de ingestión {#create-a-database-ingestion-user-oss}
...
#### Buenas prácticas de seguridad {#self-managed-security}
...
#### Permisos de usuario para la UI de ClickStack {#user-permissions}
...
### Configurar Time To Live (TTL) {#configure-ttl}
...
### Directrices de MongoDB {#mongodb-guidelines}
