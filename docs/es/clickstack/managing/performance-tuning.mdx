...
emite la forma reescrita cuando el servidor alcanza el umbral correspondiente
que se indica a continuación. Las versiones más antiguas vuelven a la forma original de subíndice de Map
automáticamente.

<Tabs>
  <Tab title="ClickHouse Cloud">
    Las compilaciones de ClickHouse Cloud y las versiones de código abierto usan líneas de versión independientes.
    Use las versiones mínimas de Cloud indicadas a continuación.

    | Rama de ClickHouse | Versión mínima de Cloud |
    | ------------------ | ----------------------- |
    | 26.2               | `26.2.1.307`            |
    | 26.3               | `26.3.0.0`              |
    | 26.4               | `26.4.1.1740`           |
    ...
    El mínimo `26.3.0.0` es la base de la rama, por lo que todas las compilaciones `26.3` son
    compatibles.
  </Tab>

  <Tab title="Código abierto">
    | Rama de ClickHouse | Versión mínima de código abierto |
    | ------------------ | -------------------------------- |
    | 26.2               | `26.2.19.43`                     |
    | 26.3               | `26.3.12.3`                      |
    | 26.4               | `26.4.3.37`                      |
