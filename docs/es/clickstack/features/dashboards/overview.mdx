...
<Note>
  Los filtros personalizados en listas desplegables están disponibles en los dashboard guardados. Para ver un ejemplo de este patrón en uso, consulte el [panel de Kubernetes](#kubernetes-dashboard), que proporciona filtros desplegables integrados para pod de Kubernetes, Implementación, nombre del nodo, Espacio de nombres y clúster.
</Note>
