...
<Steps>
  ...
  <Step title="Configurar el clic en la fila" id="wire-dashboard">
  ...
  <Step title="Hacer clic en una fila" id="click-dashboard">
...
<Steps>
  <Step title="Haz que el clic en la fila apunte a Búsqueda" id="wire-search">
  ...
  <Step title="Haz clic en una fila" id="click-search">
...
* **Búsqueda**: envía el clic a la página de Búsqueda de una fuente que elijas.
* **Dashboard**: envía el clic a otro dashboard de tu equipo.

Para **Búsqueda** y **Dashboard**, eliges a dónde lleva el clic y defines con plantillas los filtros que se trasladan:
