...
<Steps>
  ...
  <Step>
    ...
    En un dashboard de resumen, añade un tile de **Table** en tu fuente de traza agrupado por `ServiceName`. Asígnale las columnas RED que puntúan cada servicio, cada una como una serie con alias:
