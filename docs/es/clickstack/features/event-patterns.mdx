...
Para ver un ejemplo práctico, consulte cómo se usan los patrones de eventos en el [Remote Demo Dataset](/es/clickstack/example-datasets/remote-demo-data#identify-error-patterns).