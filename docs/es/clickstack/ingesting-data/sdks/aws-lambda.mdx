...
## Instalación de las capas de Lambda de OpenTelemetry {#installing-the-otel-lambda-layers}
...
### Agregar la capa de autoinstrumentación específica del lenguaje {#adding-language-specific-auto-instrumentation}
...
### Instalación de la capa Lambda del collector de OpenTelemetry {#installing-the-otel-collector-layer}
...
## Comprobación de la instalación {#checking-the-installation}
...
## Solución de problemas {#troubleshoting}

### La instrumentación personalizada no envía datos {#custom-instrumentation-not-sending}
...
### Habilitar logs de depuración del SDK {#enabling-sdk-debug-logs}
...
### Habilitar los logs de depuración del collector {#enabling-collector-debug-logs}
