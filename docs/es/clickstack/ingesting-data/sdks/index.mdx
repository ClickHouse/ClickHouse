...
doc_type: 'guide'
keywords: ['SDKs de ClickStack', 'SDKs de lenguaje de ClickStack', 'SDKs de OpenTelemetry para ClickStack', 'SDKs de instrumentación de aplicaciones', 'SDKs de recopilación de telemetría']
---
...
## Protección mediante API key {#securing-api-key}
...
## Integración con Kubernetes {#kubernetes-integration}
