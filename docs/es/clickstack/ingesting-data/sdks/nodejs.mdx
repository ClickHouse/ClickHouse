...
### Instalar el paquete de instrumentación de OpenTelemetry de HyperDX {#install-hyperdx-opentelemetry-instrumentation-package}
...
### Inicialización del SDK {#initializin-the-sdk}
...
### Configurar la recopilación de logs {#setup-log-collection}
...
### Configurar la recopilación de errores {#setup-error-collection}
...
## Configuración avanzada de la instrumentación {#advanced-instrumentation-configuration}

### Capturar logs de la consola {#capture-console-logs}
...
### Añadir información de usuario o metadatos {#attach-user-information-or-metadata}
...
### Bibliotecas instrumentadas automáticamente {#auto-instrumented-libraries}
...
## Instalación alternativa {#alternative-installation}

### Ejecutar la aplicación con la CLI de OpenTelemetry de ClickStack {#run-the-application-with-cli}
...
### Activar la captura de excepciones {#enabling-exception-capturing}
...
### Bibliotecas instrumentadas automáticamente {#auto-instrumented-libraries-2}
