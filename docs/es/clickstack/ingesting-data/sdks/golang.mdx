...
### Instala los paquetes de instrumentación de OpenTelemetry {#install-opentelemetry}
...
### Ejemplo de servidor HTTP nativo (net/http) {#native-http-server-example}
...
### Ejemplo de aplicación con Gin {#gin-application-example}
