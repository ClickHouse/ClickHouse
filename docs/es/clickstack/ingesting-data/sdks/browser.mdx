...
### Asociar información del usuario o metadatos {#attach-user-information-or-metadata}
...
### Captura automáticamente errores en los límites de error de React {#auto-capture-react-error-boundary-errors}
...
### Enviar acciones personalizadas {#send-custom-actions}
...
### Habilita la captura de red de forma dinámica {#enable-network-capture-dynamically}
...
### Habilitar la temporización de recursos para solicitudes CORS {#enable-resource-timing-for-cors-requests}
