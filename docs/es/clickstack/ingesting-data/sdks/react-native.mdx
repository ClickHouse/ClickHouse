...
### Instalar con NPM {#install-via-npm}
...
### Inicializar ClickStack {#initialize-clickstack}
...
### Adjuntar información del usuario o metadatos (opcional) {#attach-user-information-metadata}
...
### Instrumentar versiones anteriores {#instrument-lower-versions}
...
## Navegación entre vistas {#view-navigation}
