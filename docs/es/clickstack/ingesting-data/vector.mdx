...
<Tabs>
  <Tab title="ClickStack gestionado">
    ...
    <Steps>
      <Step title="Crear una base de datos y una tabla" id="create-a-database-table">
      ...
      <Step title="Añade el sink de ClickHouse a la configuración de Vector" id="add-clickhouse-sink-to-config">
      ...
      <Step title="Accede a la UI de ClickStack" id="navigate-to-clickstack-ui">
      ...
      <Step title="Crear un origen de datos" id="create-a-datasource-managed">
      ...
      <Step title="Explora los datos" id="explore-the-data-managed">
  ...
  <Tab title="ClickStack de código abierto">
    <Steps>
      <Step title="Crear una base de datos y una tabla" id="create-a-database-table-oss">
      ...
      <Step title="Añade el sink de ClickHouse a la configuración de Vector" id="add-clickhouse-config-to-sink-oss">
      ...
      <Step title="Accede a la UI de ClickStack" id="navigate-to-clickstack-ui-oss">
      ...
      <Step title="Crear un origen de datos" id="create-a-datasource-oss">
      ...
      <Step title="Explora los datos" id="explore-the-data-oss">
        Ve a la vista de logs para explorar los datos y empezar a usar ClickStack.
...
<Tabs>
  <Tab title="ClickStack gestionado">
    ...
    <Steps>
      <Step title="Instalación de Vector" id="installing-vector">
        <InstallingVector />
      </Step>

      <Step title="Descargar los datos de ejemplo" id="download-the-sample-data">
        <VectorSampleData />
      </Step>

      <Step title="Crear una base de datos y una tabla" id="create-database-table-nginx-managed">
      ...
      <Step title="Copiar la configuración de Vector" id="copy-vector-configuration">
      ...
      <Step title="Iniciar Vector" id="start-vector">
      ...
      <Step title="Accede a la UI de ClickStack" id="navigate-to-clickstack-ui-nginx-managed">
        Ve a tu servicio de Managed ClickStack y selecciona &quot;ClickStack&quot; en el menú de la izquierda. Si ya has completado el onboarding, se abrirá la UI de ClickStack en una pestaña nueva y se te autenticará automáticamente. Si no, puedes completar el onboarding y seleccionar “Launch ClickStack” una vez que hayas elegido Vector como fuente de entrada.

        <Image img="/images/clickstack/launch-clickstack-vector.webp" alt="Iniciar ClickStack para Vector" size="lg" />
      </Step>

      <Step title="Crear un origen de datos" id="create-a-datasource-nginx-managed">
      ...
      <Step title="Explora los datos" id="explore-the-data-nginx-managed">
  ...
  <Tab title="ClickStack Open Source">
    ...
    <Steps>
      <Step title="Instalación de Vector" id="installing-vector-oss">
        <InstallingVector />
      </Step>

      <Step title="Descargar los datos de ejemplo" id="download-the-sample-data-oss">
        <VectorSampleData />
      </Step>

      <Step title="Crear una base de datos y una tabla" id="create-a-database-table-nginx-oss">
        Vector requiere que se definan una tabla y un esquema antes de la ingestión de datos.
      ...
      <Step title="Copiar la configuración de Vector" id="copy-vector-configuration-nginx-oss">
      ...
      <Step title="Iniciar Vector" id="start-vector-oss-nginx">
      ...
      <Step title="Crear un origen de datos" id="create-a-datasource-nginx-oss">
      ...
      <Step title="Ve a la UI de ClickStack" id="navigate-to-clickstack-ui-nginx-oss">
        Accede a la UI de ClickStack en [http://localhost:8080](http://localhost:8080). Crea un usuario si aún no has completado el onboarding.

        <Image img="/images/use-cases/observability/hyperdx-login.webp" alt="Inicio de sesión de ClickStack" size="lg" />
      </Step>

      <Step title="Explora los datos" id="explore-the-data-nginx-oss">
        Ve a la vista de búsqueda de `20 de octubre de 2025` para explorar los datos y empezar a usar ClickStack.
