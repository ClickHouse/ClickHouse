---
slug: /es/guides/oss/deployment-and-scaling/examples/2-shards-2-replicas
...
#### Configuración del clúster {#cluster-config}
...
### Configuración de usuario {#cluster-configuration}
...
### Configuración de Keeper {#configuration-explanation}
