...
Esperamos que esta guía te haya ayudado a comprender mejor cómo investigar las consultas lentas con ClickHouse y cómo hacerlas más rápidas. Para profundizar en este tema, puedes leer más sobre el [analizador de consultas](/es/guides/clickhouse/performance-and-monitoring/analyzer) y el [perfilado](/es/concepts/features/performance/troubleshoot/sampling-query-profiler) para entender mejor cómo ejecuta ClickHouse tu consulta.

A medida que te familiarices más con las particularidades de ClickHouse, te recomiendo leer sobre [claves de particionamiento](/es/concepts/best-practices/partitioning-keys) e [índices de omisión de datos](/es/concepts/features/performance/skip-indexes/skipping-indexes) para conocer técnicas más avanzadas que puedes usar para acelerar tus consultas.