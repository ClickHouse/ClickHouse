...
<Accordion title="Inspección del contenido del índice primario">
  ...
  Para ello, primero tenemos que copiar el archivo del índice primario en el [user&#95;files&#95;path](/es/reference/settings/server-settings/settings#user_files_path) de un nodo del clúster en ejecución:
