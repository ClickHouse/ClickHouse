...
slug: /es/guides/clickhouse/data-modelling/sparse-primary-indexes
...
<div id="test-machine">
  ### Máquina de prueba {#test-machine}
</div>
...
<div id="a-full-table-scan">
  ### Un escaneo completo de la tabla {#a-full-table-scan}
</div>
...
<div id="clickhouse-index-design">
  ## Diseño de índices en ClickHouse {#clickhouse-index-design}
</div>

<div id="an-index-design-for-massive-data-scales">
  ### Un diseño de índices para datos a gran escala {#an-index-design-for-massive-data-scales}
</div>
...
<div id="a-table-with-a-primary-key">
  ### Una tabla con clave primaria {#a-table-with-a-primary-key}
</div>
...
### Los datos se almacenan en disco ordenados por las columnas de la clave primaria {#data-is-stored-on-disk-ordered-by-primary-key-columns}
...
### Los datos se organizan en gránulos para el procesamiento de datos en paralelo {#data-is-organized-into-granules-for-parallel-data-processing}
...
### El índice primario tiene una entrada por gránulo {#the-primary-index-has-one-entry-per-granule}
...
### El índice primario se usa para seleccionar gránulos {#the-primary-index-is-used-for-selecting-granules}
...
### Los archivos de marcas se usan para localizar gránulos {#mark-files-are-used-for-locating-granules}
...
<div id="using-multiple-primary-indexes">
  ## Uso de múltiples índices primarios {#using-multiple-primary-indexes}
</div>

<a name="filtering-on-key-columns-after-the-first" />

### Las columnas secundarias de la clave pueden (o no) ser ineficientes {#secondary-key-columns-can-not-be-inefficient}
...
### Algoritmo de búsqueda por exclusión genérica {#generic-exclusion-search-algorithm}
...
### Nota sobre el índice de omisión de datos {#note-about-data-skipping-index}
...
<div id="a-need-to-use-multiple-primary-indexes">
  ### La necesidad de usar varios índices primarios {#a-need-to-use-multiple-primary-indexes}
</div>
...
### Opciones para crear índices primarios adicionales {#options-for-creating-additional-primary-indexes}
...
### Opción 1: Tablas secundarias {#option-1-secondary-tables}
...
### Opción 2: Vistas materializadas {#option-2-materialized-views}
...
### Opción 3: Proyecciones {#option-3-projections}
...
<div id="ordering-key-columns-efficiently">
  ## Ordenar eficientemente las columnas de la clave {#ordering-key-columns-efficiently}
</div>
...
<div id="efficient-filtering-on-secondary-key-columns">
  ### Filtrado eficiente en columnas secundarias de la clave {#efficient-filtering-on-secondary-key-columns}
</div>
...
### Relación de compresión óptima de los archivos de datos {#optimal-compression-ratio-of-data-files}
...
<div id="identifying-single-rows-efficiently">
  ## Identificar filas individuales de forma eficiente {#identifying-single-rows-efficiently}
</div>
