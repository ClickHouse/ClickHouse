...
<Steps>
  ...
  <Step>
    ## Configuración del servidor MCP de ClickHouse
  ...
  <Step>
    ...
    ```text
      ┃                                                                                     ┃
      ┃  Modelo cargado: ollama (qwen3)                                                     ┃
      ┃   MCPHost System (09:52)                                                            ┃
      ┃                                                                                     ┃

      ┃                                                                                     ┃
      ┃  Modelo cargado correctamente en la GPU                                             ┃
      ┃   MCPHost System (09:52)                                                            ┃
      ┃                                                                                     ┃

      ┃                                                                                     ┃
      ┃  Se cargaron 3 herramientas desde los servidores MCP                                ┃
      ┃   MCPHost System (09:52)                                                            ┃
      ┃                                                                                     ┃

      Introduzca su prompt (escriba /help para ver los comandos, Ctrl+C para salir, ESC para cancelar la generación)
    ```
