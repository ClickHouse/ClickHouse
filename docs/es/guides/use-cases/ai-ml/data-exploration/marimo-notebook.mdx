...
En esta guía, aprenderá a explorar en un notebook de Marimo un conjunto de datos alojado en ClickHouse Cloud con la ayuda de [chDB](/chdb/index), un rápido motor SQL OLAP en proceso basado en ClickHouse.
