...
<div id="choose-access-method">
  ## Elija un método de acceso {#choose-access-method}
</div>
...
<div id="table-engines">
  ### Motores de tabla {#table-engines}
</div>
...
<div id="datalakecatalog">
  ### Motor de base de datos `DataLakeCatalog` {#datalakecatalog}
</div>
...
<div id="required-settings">
  ## Configuración requerida {#required-settings}
</div>
...
<div id="query-performance">
  ## Mejorar el rendimiento de las consultas {#query-performance}
</div>
...
<div id="query-habits">
  ### Hábitos de consulta {#query-habits}
</div>
...
<div id="parallel-cluster-reads">
  ### Lecturas en paralelo en clústeres multinodo {#parallel-cluster-reads}
</div>
...
<div id="snapshot-bounds">
  ### Limite las lecturas por lotes a instantáneas {#snapshot-bounds}
</div>
...
<div id="filesystem-cache">
  ### Almacenar archivos Parquet en caché localmente {#filesystem-cache}
</div>
...
<div id="iceberg-read-settings">
  #### Configuración de lectura {#iceberg-read-settings}
</div>
...
<div id="iceberg-catalog-latency">
  #### Reduce la latencia del catálogo {#iceberg-catalog-latency}
</div>
...
<div id="iceberg-time-travel">
  #### Viaje temporal {#iceberg-time-travel}
</div>
...
<div id="iceberg-write-settings">
  #### Escrituras en Iceberg {#iceberg-write-settings}
</div>
...
<div id="delta-read-settings">
  #### Ajustes de lectura {#delta-read-settings}
</div>
...
<div id="delta-incremental-sync">
  #### Flujo de cambios de datos de Delta {#delta-incremental-sync}
</div>
...
<div id="debug-system-tables">
  ## Depurar consultas del data lake {#debug-system-tables}
</div>
...
<div id="debug-catalog">
  ### Verificar la conectividad del catálogo {#debug-catalog}
</div>
...
<div id="debug-files">
  ### Ver qué archivos se leen {#debug-files}
</div>
...
<div id="debug-metadata-logs">
  ### Registros de metadatos {#debug-metadata-logs}
</div>
