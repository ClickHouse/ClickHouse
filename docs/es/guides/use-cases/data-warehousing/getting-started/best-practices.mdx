...
Para las operaciones de escritura, Iceberg requiere [allow&#95;insert&#95;into&#95;iceberg](/es/reference/settings/session-settings/allow#allow_insert_into_iceberg) (25.7+, Beta desde 26.2). Consulta [Escritura en lagos de datos](/es/guides/use-cases/data-warehousing/getting-started/writing-data). Delta Lake requiere [allow&#95;delta&#95;lake&#95;writes](/es/reference/settings/session-settings/allow-experimental#allow_experimental_delta_lake_writes) (25.9+). La [matriz de compatibilidad](/es/guides/use-cases/data-warehousing/support-matrix) indica qué flags se aplican a cada formato y operación.
...
* [Escritura en lagos de datos](/es/guides/use-cases/data-warehousing/getting-started/writing-data) — Escriba datos en Iceberg y Delta Lake
* [Matriz de compatibilidad](/es/guides/use-cases/data-warehousing/getting-started/support-matrix) — Comparación de funcionalidades entre formatos, catálogos y backends de almacenamiento