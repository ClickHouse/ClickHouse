...
- `pagination-titles.js` — restores the previous page title that Mintlify exposes through the pagination link's accessible label but omits from its visible markup.
