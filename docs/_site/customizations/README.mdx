...
- `cloud-sidebar-ad.js` — adds a permanently dismissible ClickHouse Cloud advert below the documentation MCP server control in the right sidebar on `/get-started/` pages.
