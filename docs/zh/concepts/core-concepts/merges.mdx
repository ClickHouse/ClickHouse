...
**④ 压缩与存储**：新的列文件和索引会被[压缩](/zh/reference/statements/create/table/codec)，并保存在一个新的[目录](/zh/concepts/core-concepts/parts#what-are-table-parts-in-clickhouse)中，该目录表示合并后的数据分区片段。
