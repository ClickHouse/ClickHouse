---
slug: /zh/concepts/features/materialized-views/refreshable-materialized-view
...
<div id="when-should-refreshable-materialized-views-be-used">
  ## 何时应使用可刷新materialized view？ {#when-should-refreshable-materialized-views-be-used}
</div>
...
<div id="when-was-a-refreshable-materialized-view-last-refreshed">
  ## 可刷新materialized view 最近一次刷新是在什么时候？ {#when-was-a-refreshable-materialized-view-last-refreshed}
</div>
