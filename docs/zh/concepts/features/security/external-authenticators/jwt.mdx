...
sidebarTitle: 'JWT'
slug: /zh/concepts/features/security/external-authenticators/jwt
title: 'JWT 身份验证'
doc_type: 'reference'
---
...
<div id="other-recognized-claims">
  ### 其他已识别的声明 {#other-recognized-claims}
</div>
...
<div id="example-token-header-and-payload">
  ### 令牌标头和载荷示例 {#example-token-header-and-payload}
</div>
...
<div id="differences-from-regular-users">
  ## 与普通用户的区别 {#differences-from-regular-users}
</div>
...
<div id="enabling-jwt-authentication-for-your-service">
  ## 为服务启用 JWT 身份验证 {#enabling-jwt-authentication-for-your-service}
</div>
