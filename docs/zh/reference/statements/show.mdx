...
<Note>
  ...
  * [`display_secrets_in_show_and_select`](/zh/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select) (服务器设置)
  * [`format_display_secrets_in_show_and_select` ](/zh/reference/settings/formats/format#format_display_secrets_in_show_and_select) (格式设置)
