...
<Info>
  ...
  可通过设置 [`allow_experimental_ytsaurus_dictionary_source`](/zh/reference/settings/session-settings/allow-experimental#allow_experimental_ytsaurus_dictionary_source)
  启用 YTsaurus 字典源。
</Info>
