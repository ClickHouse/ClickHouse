...
[dictGetHierarchy](/zh/reference/functions/regular-functions/ext-dict-functions#dictGetHierarchy) 函数可用于获取某个元素的父级链。[dictGetRoot](/zh/reference/functions/regular-functions/ext-dict-functions#dictGetRoot) 函数则仅返回某个元素的最顶层祖先 (根) 。
