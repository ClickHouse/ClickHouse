...
<Warning>
  **已弃用**
  ...
  窗口视图已弃用，未来的发行版中可能会被移除。它们仍受 [allow&#95;experimental&#95;window&#95;view](/zh/reference/settings/session-settings/allow-experimental#allow_experimental_window_view) 设置限制 (`SET allow_experimental_window_view = 1`) ，不建议在新的使用场景中采用。
</Warning>
