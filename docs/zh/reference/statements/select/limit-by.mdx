...
如果你想在 `LIMIT BY` 子句中使用列编号而不是列名，请启用设置 [enable&#95;positional&#95;arguments](/zh/reference/settings/session-settings/enable-positional-arguments#enable_positional_arguments)。
