...
要禁用按列号排序，请将设置 [enable&#95;positional&#95;arguments](/zh/reference/settings/session-settings/enable-positional-arguments#enable_positional_arguments) 设为 0。
要禁用按 `ALL` 排序，请将设置 [enable&#95;order&#95;by&#95;all](/zh/reference/settings/session-settings/enable#enable_order_by_all) 设为 0。
...
如果 `ORDER BY` 表达式的前缀与表的 sorting key 一致，可以通过使用 [optimize&#95;read&#95;in&#95;order](/zh/reference/settings/session-settings/optimize#optimize_read_in_order) 设置来优化查询。
