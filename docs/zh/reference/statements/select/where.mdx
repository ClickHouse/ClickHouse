...
`WHERE` 子句后的表达式通常会结合[比较运算符](/zh/reference/operators/index#comparison-operators)和[逻辑运算符](/zh/reference/operators/index#operators-for-working-with-data-sets)使用，或者使用众多[常规函数](/zh/reference/functions/regular-functions/overview)中的一种。
