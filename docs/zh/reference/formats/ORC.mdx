...
| 设置                                                                                                                                                                                     | 描述                                            | 默认值     |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | ------- |
| [`output_format_orc_string_as_string`](/zh/reference/settings/formats#output_format_orc_string_as_string)                                                                                  | 对 String 列使用 ORC String 类型，而非 Binary。         | `true`   |
| [`output_format_orc_compression_method`](/zh/reference/settings/formats#output_format_orc_compression_method)                                                                             | 输出 ORC 格式使用的压缩方法。默认值                          | `zstd`  |
| [`input_format_orc_case_insensitive_column_matching`](/zh/reference/settings/formats#input_format_orc_case_insensitive_column_matching)                                                    | 匹配 ORC 列与 ClickHouse 列时忽略大小写。                 | `false`  |
| [`input_format_orc_allow_missing_columns`](/zh/reference/settings/formats#input_format_orc_allow_missing_columns)                                                                          | 读取 ORC 数据时允许列缺失。                              | `true`   |
| [`input_format_orc_skip_columns_with_unsupported_types_in_schema_inference`](/zh/reference/settings/formats#input_format_orc_skip_columns_with_unsupported_types_in_schema_inference)      | 对 ORC 格式执行 schema inference 时，允许跳过类型不受支持的列。   | `false`  |
