...
* 针对将 domain IP 类型 (IPv4、IPv6) 替换为原生类型的后续修复，参见 https://github.com/ClickHouse/ClickHouse/pull/43221。 [#45043](https://github.com/ClickHouse/ClickHouse/pull/45043) ([Yakov Olkhovskiy](https://github.com/yakov-olkhovskiy)).
...
* 修复某些情况下 SEMI JOIN 和 join&#95;use&#95;nulls 的逻辑错误，关闭 [#45163](https://github.com/ClickHouse/ClickHouse/issues/45163) 和 [#45209](https://github.com/ClickHouse/ClickHouse/issues/45209)。[#45230](https://github.com/ClickHouse/ClickHouse/pull/45230) ([Vladimir C](https://github.com/vdimir)).
...
* 修复了分布式表创建与向其 INSERT 之间的竞态条件 (可能会在向该表执行 INSERT 时导致 CANNOT&#95;LINK) 。[#45502](https://github.com/ClickHouse/ClickHouse/pull/45502) ([Azat Khuzhin](https://github.com/azat)).
