...
* 修复了可能存在不稳定性的测试 `00731_long_merge_tree_select_opened_files.sh`。该测试并不经常失败，但我们在使用 ThreadFuzzer 进行实验时，发现其中存在潜在的竞态条件：[#9814](https://github.com/ClickHouse/ClickHouse/issues/9814)。[#11270](https://github.com/ClickHouse/ClickHouse/pull/11270) ([alexey-milovidov](https://github.com/alexey-milovidov)).
...
* 新增了一个 Docker image，可用于为我们的代码库生成交互式代码浏览器 HTML 报告。[#8781](https://github.com/ClickHouse/ClickHouse/pull/8781) ([alesapin](https://github.com/alesapin))
