...
- `arg1` — Description of the argument. [DataType](/zh/reference/data-types/float)
- `arg2` — Description of the argument. [DataType](/zh/reference/data-types/float)
- `arg3` — Description of optional argument (optional). [DataType](/zh/reference/data-types/float)
...
- Returns {insert what the function returns here}. [DataType](/zh/reference/data-types/float)
