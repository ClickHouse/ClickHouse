...
<Steps>
  <Step title="创建嵌入向量">
    你的数据 (文档、图像或结构化数据) 必须转换为&#95;嵌入向量&#95;。我们建议使用 [OpenAI Embeddings API](https://platform.openai.com/docs/api-reference/embeddings) 创建嵌入向量，或使用开源 Python 库 [SentenceTransformers](https://www.sbert.net/)。

    你可以将嵌入向量视为由大量浮点数组成的数组，用来表示你的数据。[查看 OpenAI 的这份指南，进一步了解嵌入向量](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings)。
  </Step>
