...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- | -------------- | -------------------------------------------------- |
| `名称`                     | Source 名称。                                                                                                                                                                                                                                        | 是   | 否              | –                                                  |
| `分组`                     | 用于在源选择器中对源进行分组的可选标签。属于同一分组的源会显示在一起；除源名称外，搜索还会匹配分组名称。                                                                                                                                                                                              | 否   | 否              | –                                                  |
| `Server Connection`      | 服务器连接名称。                                                                                                                                                                                                                                          | 是   | No             | `Default`                                          |
| `数据库`                    | ClickHouse 数据库名称。                                                                                                                                                                                                                                 | Yes | Yes            | `default`                                          |
| `表`                      | 目标表名称。使用默认 schema 时设为 `otel_logs`。                                                                                                                                                                                                                | Yes | No             |                                                    |
| `查询设置`                   | 查询级[会话设置](/zh/reference/settings/session-settings)，每项均由设置名称和值组成，并会应用于针对此 source 发出的每个查询。                                                                                                                                                             | No  | 否              | –                                                  |
...
| `使用文本索引`                 | 使用 Lucene 的搜索在查询隐式列时是否调用 `hasAllTokens`。                                                                                                                                                                                                          | 否   | No             | `自动（根据 schema 检测）`                                 |
| `突出显示的属性`                | 打开日志详情时显示的表达式或列。返回 URL 的表达式将显示为链接。                                                                                                                                                                                                                | No  | No             | –                                                  |
| `突出显示的 Trace 属性`         | 从 trace 中每条日志提取的表达式或列，显示在 trace 瀑布图上方。返回 URL 的表达式将显示为链接。                                                                                                                                                                                          | 否   | 否              | –                                                  |
