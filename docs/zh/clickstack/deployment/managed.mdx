---
slug: /zh/clickstack/deployment/managed
title: '托管'
...
### 启动 collector {#start-a-collector-existing}
...
### 配置现有 collector {#configure-existing-collectors-existing}
...
### 开始摄取 (可选) {#start-ingestion-existing}
