...
* `name` ([String](/zh/sql-reference/data-types/string)) — 数据库名称。
* `engine` ([String](/zh/sql-reference/data-types/string)) — 数据库引擎。
* `data_path` ([String](/zh/sql-reference/data-types/string)) — 数据路径。
* `metadata_path` ([String](/zh/sql-reference/data-types/string)) — 元数据路径。
* `uuid` ([UUID](/zh/sql-reference/data-types/uuid)) — 数据库 UUID。
* `engine_full` ([String](/zh/sql-reference/data-types/string)) — 数据库引擎的参数。
* `comment` ([String](/zh/sql-reference/data-types/string)) — 数据库注释。
* `is_external` ([UInt8](/zh/sql-reference/data-types/int-uint)) — 数据库为外部数据库 (即 PostgreSQL/DataLakeCatalog) 。
...
`SHOW DATABASES` 查询会使用此系统表中的 `name` 列。
