...
计算某个值在一组值中的累计分布，即值小于或等于当前行值的行所占的百分比。可用于确定某个值在分区中的相对位置。
...
有关窗口函数语法的更多信息，请参见：[Window Functions - Syntax](./index.md/#syntax)。
