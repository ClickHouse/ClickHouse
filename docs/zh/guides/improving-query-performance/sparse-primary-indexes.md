...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-01.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-02.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-03a.png').default} class="image"/>

在我们的表中，索引总共有1083个条目，887万行数据和1083个颗粒:

<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-03b.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-04.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-05.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-06.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-07.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-08.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-13a.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-09a.png').default} class="image"/>


在物化视图中，额外的表被隐藏，数据自动在两个表之间保持同步：
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-09b.png').default} class="image"/>


projection方式是最透明的选项，因为除了自动保持隐藏的附加表与数据变化同步外，ClickHouse还会自动选择最有效的表版本进行查询：
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-09c.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-10.png').default} class="image"/>

主键索引如下：
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-11.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-12a.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-12b-1.png').default} class="image"/>


ClickHouse将隐藏表的列数据文件(.bin)、标记文件(.mrk2)和主索引(primary.idx)存储在ClickHouse服务器的数据目录的一个特殊文件夹中：


<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-12b-2.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-12c-1.png').default} class="image"/>

ClickHouse将隐藏表的列数据文件(.bin)、标记文件(.mrk2)和主索引(primary.idx)存储在一个特殊的文件夹中(在下面的截图中用橙色标记)，紧挨着源表的数据文件、标记文件和主索引文件：

<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-12c-2.png').default} class="image"/>
:::
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-14a.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-14b.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-15a.png').default} class="image"/>
...
<img src={require('../../../guides/best-practices/images/sparse-primary-indexes-15b.png').default} class="image"/>
