...
从 ClickHouse 25.7 开始，[ClickHouse Client](/zh/concepts/features/interfaces/cli) 和 [clickhouse-local](/zh/concepts/features/tools-and-utilities/clickhouse-local) 提供了可将自然语言描述转换为 SQL 查询的 [AI 驱动功能](/zh/concepts/features/interfaces/client#ai-sql-generation)。借助此功能，你可以用自然语言描述数据需求，系统随后会将其转换为相应的 SQL 语句。
