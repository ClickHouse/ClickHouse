...
[Paimon](/zh/reference/functions/table-functions/paimon)仅提供表函数。
...
对于目录连接，不同目录类型都有各自的标志。概览请参阅[Connecting to catalogs](/zh/guides/use-cases/data-warehousing/getting-started/connecting-catalogs)，设置详情请参阅 [DataLakeCatalog reference](/zh/reference/engines/database-engines/datalake)。各目录的具体设置请见[目录指南](/zh/guides/use-cases/data-warehousing/reference)。

对于写入操作，Iceberg 需要 [allow&#95;insert&#95;into&#95;iceberg](/zh/reference/settings/session-settings/allow#allow_insert_into_iceberg) (25.7+，自 26.2 起为 Beta) 。请参阅[写入数据湖](/zh/guides/use-cases/data-warehousing/getting-started/writing-data)。Delta Lake 需要 [allow&#95;delta&#95;lake&#95;writes](/zh/reference/settings/session-settings/allow-experimental#allow_experimental_delta_lake_writes) (25.9+) 。[支持矩阵](/zh/guides/use-cases/data-warehousing/support-matrix)列出了每种格式和操作适用的标志。
