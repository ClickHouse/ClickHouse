...
ClickHouse 可将 Prometheus 指标存储在 [`TimeSeries`](/zh/reference/engines/table-engines/integrations/time-series) 表中，并执行 PromQL 查询。有关摄取、查询和可视化的配置，请参阅 [Prometheus 协议和 PromQL](/zh/interfaces/prometheus)。