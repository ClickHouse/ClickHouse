...
<Note>
  ...
  * 对于启用了自适应索引粒度的表 (默认情况下 index granularity 是自适应的，参见 [default](/zh/reference/settings/merge-tree-settings#index_granularity_bytes))，某些粒度的大小可能会因行数据大小不同而少于 8192 行。
