    ...
    return (
        ...
        >
            <div>
                ...
                <span className="block text-[#6b7280] dark:text-[#a1a1aa] mt-1 text-sm font-normal leading-normal">100+ 集成 to connect the tools and services that you love with ClickHouse.</span>
            </div>
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="实时分析" description="大规模交付即时洞察和仪表盘。实时分析数十亿行数据，结果可在毫秒内返回。" href="/zh/get-started/use-cases/real-time-analytics" showArrow />

        <HeroCard title="可观测性" description="借助 ClickStack（由 ClickHouse 提供支持的开源可观测性技术栈），大规模存储和查询日志、指标和链路追踪。" href="/zh/clickstack/overview" showArrow />

        <HeroCard title="数据仓储" description="即时分析和探索数据，获取洞察并构建应用。通过卸载繁重工作负载，实现更快扩展。" href="/zh/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="智能体分析" description="让 AI 智能体直接查询实时数据，提供即时的对话式洞察和可视化" href="/zh/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          ...
          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" description="由 ClickHouse 驱动的一体化可观测性技术栈，提供针对日志、指标、链路追踪、会话回放和错误的闪电般快速查询与强大聚合能力。" href="/zh/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard filename="thumbnail-postgres-light.webp" title="Managed Postgres" description="快速、可扩展、企业级的 Postgres 服务，与 ClickHouse 原生集成。轻松结合使用 Postgres 处理事务，用 ClickHouse 进行分析。" href="/zh/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="面向可观测性、指标、评测和提示词管理的开源 LLM 工程平台。" href="https://langfuse.com/docs" showArrow external />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Kubernetes Operator" description="在 Kubernetes 上自动部署、配置和管理 ClickHouse 与 ClickHouse Keeper 集群。" href="/zh/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="快速、可靠且可扩展的进程内数据库。体验以进程内方式运行的 ClickHouse 的强大能力。" href="/zh/products/chdb/index" showArrow />
        </div>
      </div>
