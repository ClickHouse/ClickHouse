...
export const IntegrationsBanner = () => {
    const assetBase = typeof window !== 'undefined' && window.location.pathname.startsWith('/docs') ? '/docs' : '';
    const href = '/zh/integrations/home';
    return (
        <a
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <h1 className="block text-[34px] font-semibold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
        开始使用 <HighlightedClickHouse /> 进行构建
      </h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "样本数据集", href: "/zh/get-started/sample-datasets/index" },
        ...
        { label: "系统表", href: "/zh/reference/system-tables/overview" },
        ...
        { label: "ClickHouse Managed Postgres", href: "/zh/products/managed-postgres/overview" },
        { label: "Langfuse", href: "https://langfuse.com/docs", external: true },
        { label: "chDB", href: "/zh/chdb" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. 如何以最低成本从常见来源摄取数据", href: "/zh/integrations/home" },
              { label: "2. 面向分析和增长场景组织数据的最佳实践", href: "/zh/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. 实时查询大型数据集的方法", href: "/zh/get-started/use-cases/real-time-analytics" },
              { label: "4. 如何在此基础上构建仪表盘、告警和事件驱动功能", href: "/zh/get-started/use-cases/data-warehousing" },
              { label: "5. 在保持高性能的同时降低成本的技巧", href: "/zh/concepts/best-practices/index" },
          ]}
            />
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <HeroCard filename="thumbnail-postgres-light.webp" title="ClickHouse Managed Postgres" galaxyEvent="docs.home.managed-postgres" description="快速、可扩展、企业级的 Postgres 服务，与 ClickHouse 原生集成。轻松结合使用 Postgres 处理事务，用 ClickHouse 进行分析。" href="/zh/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
