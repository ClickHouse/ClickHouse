...
还有一些杂项函数，比如 [blockSize](../sql_reference/functions/other_functions.md#function-blocksize)、[rowNumberInBlock](../sql_reference/functions/other_functions.md#function-rownumberinblock)，以及 [runningAccumulate](../sql_reference/functions/other_functions.md#function-runningaccumulate)，它们对块进行处理，并且不遵从行的独立性。
...
[来源文章](https://clickhouse.tech/docs/en/development/architecture/) <!--hide-->
