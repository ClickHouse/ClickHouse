...
| **http&#95;agent**?: http.Agent | https.Agent <br /><Badge color="green" icon="flask">Experimental</Badge>   | 为客户端指定自定义 HTTP Agent。              | -      | [HTTP agent 文档](/zh/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only)        |
| **set&#95;basic&#95;auth&#95;header**?: boolean <br /><Badge color="green" icon="flask">Experimental</Badge> | 将基本身份验证凭据设置到 `Authorization` 请求头中。 | `true` | [HTTP agent 文档中此设置的用法](/zh/integrations/language-clients/js#custom-httphttps-agent-experimental-nodejs-only) |
