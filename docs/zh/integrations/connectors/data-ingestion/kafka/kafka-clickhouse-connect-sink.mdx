...
从 ClickHouse 26.9 版本起，默认支持此 schema。在 26.1 至 26.8 版本中，则需要设置 `allow_experimental_nullable_tuple_type = 1` (参见[此文档页面](/zh/reference/settings/session-settings/allow-experimental#allow_experimental_nullable_tuple_type)) 。
