...
从 CH 26.1 版本起，在 `allow_experimental_nullable_tuple_type=1` 时支持此 schema (参见[此文档页面](/zh/reference/settings/session-settings/allow-experimental#allow_experimental_nullable_tuple_type)) 。
