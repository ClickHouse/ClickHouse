...
1. 登录 Microsoft Azure 门户并打开你的 Data Factory 实例。
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-home-with-data-factory.webp" size="lg" alt="包含 Data Factory 的 Azure 门户主页" border />

2. 在 Data Factory 概述页面中，点击 **Launch Studio**。
   <Image img="/images/integrations/data-ingestion/azure-data-factory/azure-data-factory-page.webp" size="lg" alt="Azure 门户中的 Data Factory 页面" border />

3. 在左侧菜单中，选择 **Manage**，然后进入 **Linked services**，
   再点击 **+ New** 创建新的链接服务。
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-create-linked-service-button.webp" size="lg" alt="Azure Data Factory 的新建链接服务按钮" border />
...
4. 在 **New linked service search bar** 中，输入 **REST**，选择 **REST**，然后点击 **Continue**，
   ...
   实例。
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-search.webp" size="lg" alt="Azure Data Factory 的新建链接服务搜索" border />
...
6. 在动态内容面板中，你可以创建参数化 URL，
   ...
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-base-url-empty.webp" size="lg" alt="新建链接服务的 Base URL 为空" border />
...
8. 在表达式字段中，输入以下内容并点击 **OK**。将
   ...
   ```
   <Image img="/images/integrations/data-ingestion/azure-data-factory/adf-new-linked-service-expression-field-filled.webp" size="lg" alt="已填写表达式字段的新建链接服务" border />
