---
slug: /zh/integrations/connectors/data-ingestion/AWS/integrating-s3-with-clickhouse
...
<div id="s3-backed-mergetree">
  ## S3 后端的 MergeTree {#s3-backed-mergetree}
</div>
...
<div id="configure-clickhouse-to-use-the-s3-bucket-as-a-disk">
  ### 配置 ClickHouse 使用 S3 存储桶 作为磁盘 {#configure-clickhouse-to-use-the-s3-bucket-as-a-disk}
</div>
...
<div id="clickhouse-server-nodes">
  #### ClickHouse 服务器 节点 {#clickhouse-server-nodes}
</div>
...
<div id="disable-zero-copy-replication">
  #### 禁用 zero-copy 复制 {#disable-zero-copy-replication}
</div>
...
<div id="run-clickhouse-server">
  #### 启动 ClickHouse 服务器 {#run-clickhouse-server}
</div>
