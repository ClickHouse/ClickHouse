...
<Image size="lg" img="/images/_snippets/s3/2025/s3-1.webp" alt="AWS IAM Management Console - 添加新用户" />

3. 输入用户名

<Image size="lg" img="/images/_snippets/s3/2025/s3-2.webp" alt="AWS IAM Management Console - 添加新用户" />

4. 选择 `Next`

<Image size="lg" img="/images/_snippets/s3/2025/s3-3.webp" alt="AWS IAM Management Console - 添加新用户" />

5. 选择 `Next`

<Image size="lg" img="/images/_snippets/s3/2025/s3-4.webp" alt="AWS IAM Management Console - 添加新用户" />
...
<Image size="lg" img="/images/_snippets/s3/2025/s3-5.webp" alt="AWS IAM Management Console - 添加新用户" />

7. 选择 `Create access key`

<Image size="lg" img="/images/_snippets/s3/2025/s3-6.webp" alt="AWS IAM Management Console - 添加新用户" />

8. 选择 `Application running outside AWS`

<Image size="lg" img="/images/_snippets/s3/2025/s3-7.webp" alt="AWS IAM Management Console - 添加新用户" />

9. 选择 `Create access key`

<Image size="lg" img="/images/_snippets/s3/2025/s3-8.webp" alt="AWS IAM Management Console - 添加新用户" />

10. 将访问密钥和 secret 下载为 .csv 文件，供稍后使用

<Image size="lg" img="/images/_snippets/s3/2025/s3-9.webp" alt="AWS IAM Management Console - 添加新用户" />
