...
<Image img="/images/integrations/tools/data-integration/splunk/splunk_001.webp" size="lg" alt="显示 ClickHouse Cloud Audit Add-on for Splunk 下载页面的 Splunkbase 网站" border />
...
<Image img="/images/integrations/tools/data-integration/splunk/splunk_003.webp" size="lg" alt="用于上传 ClickHouse 插件的 Splunk 应用安装对话框" border />
