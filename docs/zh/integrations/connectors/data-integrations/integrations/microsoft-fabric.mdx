...
<Frame>
  ![Fabric 湖仓中的 yellow\_tripdata 表及其列](/images/integrations/tools/data-integration/microsoft-fabric/fabric-08-tutorial-lakehouse-table.webp)
</Frame>
...
<Frame>
  ![内嵌 ClickHouse SQL 控制台中的三个教程查询](/images/integrations/tools/data-integration/microsoft-fabric/fabric-09-tutorial-sample-queries.webp)
</Frame>
