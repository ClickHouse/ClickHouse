...
<Image img="/images/integrations/sql-clients/datagrip-6.webp" size="sm" border alt="在数据源列表中选择 ClickHouse 的 DataGrip" />
...
<Image img="/images/integrations/sql-clients/datagrip-1.webp" size="lg" border alt="DataGrip 的 Drivers 选项卡，显示 ClickHouse 驱动程序安装" />
