...
<Image size="md" img="/images/integrations/data-visualization/quicksight_02.webp" alt="QuickSight 数据源选择界面，搜索结果中高亮显示了 MySQL" border />
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_03.webp" alt="QuickSight MySQL 连接配置表单，包含 hostname、端口、database 和凭证字段" border />
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_05.webp" alt="用于从 ClickHouse 获取数据的 QuickSight 自定义 SQL 查询编辑器" border />
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_07.webp" alt="QuickSight 界面，底角高亮显示了 Direct Query 模式选项" border />
