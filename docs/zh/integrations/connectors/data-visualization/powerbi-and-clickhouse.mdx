...
<Image size="md" img="/images/integrations/data-visualization/powerbi_odbc_search.webp" alt="Windows 搜索中显示“ODBC 数据源（64 位）”选项" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_get_data.webp" alt="显示“Get Data”按钮的 Power BI Desktop 主屏幕" border />

<br />

选择“Other”-&gt;“ODBC”。

<Image size="md" img="/images/integrations/data-visualization/powerbi_select_odbc.webp" alt="Power BI“Get Data”对话框，其中“Other”类别下的“ODBC”选项已选中" border />
...
<Image size="md" img="/images/integrations/data-visualization/powerbi_dsn_credentials.webp" alt="ODBC DSN connection 的凭据对话框" border />
