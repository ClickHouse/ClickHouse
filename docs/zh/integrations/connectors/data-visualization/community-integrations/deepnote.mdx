...
<Image size="md" img="/images/integrations/data-visualization/deepnote_02.webp" alt="ClickHouse 详情对话框" border />
...
1. 首先，连接到 笔记本 右侧的 ClickHouse 集成。
   ...
   <Image size="lg" img="/images/integrations/data-visualization/deepnote_03.webp" alt="ClickHouse 详细信息对话框" border />
