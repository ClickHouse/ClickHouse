...
1. 要在 Superset 中使用 ClickHouse 数据，您需要先定义一个 ***数据集***。在 Superset 顶部菜单中，选择 **Data**，然后在下拉菜单中选择 **Datasets**。
...
3. 点击对话框底部的 **ADD** 按钮后，您的表就会出现在数据集列表中。现在，您可以开始构建仪表盘并分析 ClickHouse 数据了！
