...
<div id="prometheus-monitoring">
  ## Prometheus 监控方法 {#prometheus-monitoring}
</div>
...
<div id="monitoring-approaches-comparison">
  ### 监控方式对比 {#monitoring-approaches-comparison}
</div>
...
<div id="builtin-prometheus-stack">
  ## 内置 BYOC Prometheus 栈 {#builtin-prometheus-stack}
</div>
...
<div id="prometheus-stack-integration">
  ### 与您的监控工具集成 {#prometheus-stack-integration}
</div>
