...
<Image img="/images/cloud/security/azure-pe-create-review.webp" size="md" alt="专用终结点审核" border />
...
<Image img="/images/cloud/security/azure-privatelink-pe-dns.webp" size="lg" alt="专用终结点 DNS 名称" border />
