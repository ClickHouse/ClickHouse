...
<Image img="/images/cloud/reference/compute-compute-1.webp" size="md" alt="ClickHouse Cloud 中的单个服务" caption="图 1 - ClickHouse Cloud 中的单个服务" />
...
<Image img="/images/cloud/reference/compute-compute-2.webp" size="md" alt="ClickHouse Cloud 中的计算分离" caption="图 2 - ClickHouse Cloud 中的计算分离" />
...
<Image img="/images/cloud/reference/compute-compute-8.webp" size="lg" alt="包含主节点和次级服务的仓库示例" background="white" caption="图 3 - 仓库示例" />
...
<Image img="/images/cloud/reference/compute-compute-3.webp" size="md" alt="共享相同数据的服务之间的用户访问" caption="图 4 - 用户 Alice 是在服务 1 中创建的，但她可以使用相同的凭据访问所有共享相同数据的服务" />
...
<Image img="/images/cloud/reference/compute-compute-4.webp" size="md" alt="网络访问控制设置" caption="图 5 - 由于网络访问控制设置，Alice 无法访问服务 2" />
...
<Image img="/images/cloud/reference/compute-compute-5.webp" size="lg" alt="仓库中的读写与只读服务" caption="图 6 - 仓库中的读写与只读服务" />
...
<Image img="/images/cloud/reference/compute-compute-7.webp" size="md" alt="在仓库中创建新服务" caption="图 7 - 点击加号，在仓库中创建新服务" />
