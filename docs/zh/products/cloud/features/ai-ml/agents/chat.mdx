...
title: '聊天'
description: 'ClickHouse 智能体中的对话、书签、分支、多对话和聊天共享'
...
ClickHouse 智能体中的聊天界面支持对话、分支、并排比较和共享。
...
<Image img="/images/cloud/agent-builder/chat/multi-conversation.webp" alt="聊天标题栏中高亮显示“添加多对话”按钮，输入框上方有一个 + ClickHouse 智能体 指示器" size="lg" />

随后，这两个对话会并排显示，并接收相同的提示：

<Image img="/images/cloud/agent-builder/chat/multi-conversation-2.webp" alt="多对话视图中，两个 ClickHouse 智能体 对话并排运行，二者都在执行相同的 run_select_query 工具调用" size="lg" />
