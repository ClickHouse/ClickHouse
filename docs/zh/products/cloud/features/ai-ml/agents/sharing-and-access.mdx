...
<Image img="/images/cloud/agent-builder/sharing/share-agent-modal.webp" alt="共享对话框，包含“用户和组权限”部分、一个搜索输入框、一个具有所有者角色的现有用户、一个“Share with everyone in ClickHouse”切换开关，以及“取消”和“保存更改”按钮" size="md" />
