...
<Image img="/images/cloud/manage/scaling-patch-request.webp" size="lg" alt="扩缩容 PATCH 请求" border caption="用于更新 `numReplicas` 的 `PATCH` 请求" />

<Image img="/images/cloud/manage/scaling-patch-response.webp" size="md" alt="扩缩容 PATCH 响应" border caption="`PATCH` 请求的响应" />
...
<Image img="/images/cloud/manage/scaling-configure.webp" size="md" alt="扩缩容配置" border caption="ClickHouse Cloud 控制台中的服务扩缩容设置" />
