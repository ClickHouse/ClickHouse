...
<div id="i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-how-can-i-unsubscribe">
  ### 我是通过市场订阅 ClickHouse Cloud 的用户。如何取消订阅？​ {#i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-how-can-i-unsubscribe}
</div>
...
<div id="i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-and-then-unsubscribed-now-i-want-to-subscribe-back-what-is-the-process">
  ### 我通过市场订阅了 ClickHouse Cloud，之后又取消了订阅。现在想重新订阅，该怎么操作？​ {#i-subscribed-to-clickhouse-cloud-as-a-marketplace-user-and-then-unsubscribed-now-i-want-to-subscribe-back-what-is-the-process}
</div>
...
<div id="how-do-i-access-my-invoice-for-my-marketplace-subscription-to-the-clickhouse-cloud-service">
  ### 如何查看我的 ClickHouse Cloud 服务 市场 订阅发票？​ {#how-do-i-access-my-invoice-for-my-marketplace-subscription-to-the-clickhouse-cloud-service}
</div>
...
<div id="where-can-i-find-general-billing-information">
  ### 在哪里可以找到一般计费信息​? {#where-can-i-find-general-billing-information}
</div>
...
<div id="is-there-a-difference-in-clickhouse-cloud-pricing-whether-paying-through-the-cloud-provider-marketplace-or-directly-to-clickhouse">
  ### 通过云提供商市场付费与直接向 ClickHouse 付费时，ClickHouse Cloud 的定价是否有差异？ {#is-there-a-difference-in-clickhouse-cloud-pricing-whether-paying-through-the-cloud-provider-marketplace-or-directly-to-clickhouse}
</div>
...
<div id="multiple-organizations-to-bill-to-single-cloud-marketplace-account">
  ### 我可以将多个 ClickHouse 组织设置为向同一个云市场计费账户 (AWS、GCP 或 Azure) 计费吗？ {#multiple-organizations-to-bill-to-single-cloud-marketplace-account}
</div>
