...
此时务必跳转到 ClickHouse Cloud 并完成注册或登录。否则，我们将无法将您的 GCP Marketplace 订阅关联到 ClickHouse Cloud。
...
如果您是 ClickHouse Cloud 新用户，请点击页面底部的 **Register**。系统会提示您创建新用户并验证电子邮件。完成电子邮件验证后，您可以离开 ClickHouse Cloud 登录页面，并使用新用户名在 [https://console.clickhouse.cloud](https://console.clickhouse.cloud) 登录。
...
如果您是现有 ClickHouse Cloud 用户，直接使用您的凭证登录即可。

7. 成功登录后，系统将创建一个新的 ClickHouse Cloud 组织。该组织将连接到您的 GCP 计费账户，所有使用量都将通过您的 GCP 账户计费。
