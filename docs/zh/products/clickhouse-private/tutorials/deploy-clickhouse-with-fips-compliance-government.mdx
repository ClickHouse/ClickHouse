...
<Steps>
  <Step title="阶段 1：创建 FIPS 证书" id="phase-1-create-fips-certificates">
  ...
  <Step title="第 2 阶段：安装 Kubernetes 前置条件" id="phase-2-install-kubernetes-prerequisites">
  ...
  <Step title="第 3 阶段：安装 Operator" id="phase-3-install-operator">
  ...
  <Step title="阶段 4：创建证书 Secret" id="phase-4-create-certificate-secrets">
  ...
  <Step title="阶段 5：部署 ClickHouse 集群" id="phase-5-deploy-clickhouse-cluster">
  ...
  <Step title="阶段 6：验证安装" id="phase-6-verify-installation">
    ### 在 TLS 端口上执行端口转发
