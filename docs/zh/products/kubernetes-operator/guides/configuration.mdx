---
position: 2
slug: /zh/products/kubernetes-operator/guides/configuration
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencepodtemplatespec-for-all-supported-pod-template-options">
  ### 所有受支持的 pod (容器组)  模板选项，请参见 [API 参考文档](/zh/products/kubernetes-operator/reference/api-reference#podtemplatespec)。 {#see-api-reference-for-all-supported-pod-template-options}
</div>

<div id="pod-disruption-budgets">
  ## pod (容器组) 中断预算 {#pod-disruption-budgets}
</div>
...
<div id="pdb-cluster-wide-disable">
  ### 集群范围内停用 {#pdb-cluster-wide-disable}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencecontainertemplatespec-for-all-supported-container-template-options">
  ### 有关所有受支持的容器模板选项，请参见 [API 参考文档](/zh/products/kubernetes-operator/reference/api-reference#containertemplatespec)。 {#see-api-reference-for-all-supported-container-template-options}
</div>
...
<div id="external-secret-required-keys">
  ### 必需的键 {#external-secret-required-keys}
</div>
...
<div id="external-secret-policy">
  ### 策略：Observe 与 Manage {#external-secret-policy}
</div>
...
<div id="external-secret-status">
  ### 状态条件和故障排查 {#external-secret-status}
</div>
...
<div id="additional-ports-mysql-example">
  ### 端到端示例：MySQL wire 协议 {#additional-ports-mysql-example}
</div>
...
<div id="additional-ports-constraints">
  ### 字段约束 {#additional-ports-constraints}
</div>
...
<div id="additional-ports-reserved">
  ### 保留端口和名称 {#additional-ports-reserved}
</div>
...
<div id="version-probe-and-upgrade-channel">
  ## 版本探测与升级通道 {#version-probe-and-upgrade-channel}
</div>
...
<div id="upgrade-channel-choosing">
  ### 选择发布渠道 {#upgrade-channel-choosing}
</div>
...
<div id="version-status-conditions">
  ### 状态条件 {#version-status-conditions}
</div>
...
<div id="version-probe-template">
  ### 覆盖版本探测 Job {#version-probe-template}
</div>
...
<div id="version-operator-flags">
  ### Operator 级别的控制 {#version-operator-flags}
</div>
...
<div id="default-password-secret-example">
  #### 使用 Secret 的完整示例 {#default-password-secret-example}
</div>
...
<div id="using-configmap-for-user-passwords">
  #### 使用 ConfigMap {#using-configmap-for-user-passwords}
</div>
...
<div id="embedded-extra-users-configuration">
  ### 嵌入式附加用户配置 {#embedded-extra-users-configuration}
</div>
...
<div id="see-documentationconceptsfeaturesconfigurationsettingssettings-users-for-all-supported-clickhouse-users-configuration-options">
  #### 有关所有受支持的 ClickHouse 用户配置选项，请参阅[文档](/zh/concepts/features/configuration/settings/settings-users)。 {#see-documentation-for-all-supported-clickhouse-users-configuration-options}
</div>
