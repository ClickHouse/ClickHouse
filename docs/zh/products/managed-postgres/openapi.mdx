...
[ClickHouse OpenAPI]: /zh/products/cloud/features/admin-features/api/api-overview "Cloud API"
...
[Prometheus endpoint]: /zh/products/managed-postgres/monitoring/prometheus "ClickHouse Managed Postgres Prometheus 端点"

[metrics reference]: /zh/products/managed-postgres/monitoring/metrics "ClickHouse Managed Postgres 指标参考"

[Query Insights]: /zh/products/managed-postgres/monitoring/query-insights "Postgres Query Insights"

[detail flyout]: /zh/products/managed-postgres/monitoring/query-insights#detail "Query Insights 详情弹出面板"

[per-execution counters]: /zh/products/managed-postgres/monitoring/query-insights#counters "Query Insights 的单次执行计数器"
