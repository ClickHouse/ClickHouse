...
ClickHouse Managed Postgres 可处理 PostgreSQL 版本升级，帮助您的实例保持安全并及时更新。支持次版本升级和主版本升级，且对业务影响降至最低。
...
对于 Enterprise 层级的组织，ClickHouse Managed Postgres 支持维护窗口，可将升级和其他维护操作安排在对工作负载影响最小的时间进行。用于配置维护窗口的 UI 和 API 支持即将推出。在此之前，请联系 [support](https://clickhouse.com/support/program) 为您的实例设置维护窗口。
