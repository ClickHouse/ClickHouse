...
为数据库实例输入名称，然后点击 **Create service**。随后您将进入概览页面。
...
复制过程将会开始，随后你会进入集成概览页面。由于这是第一个集成，完成初始基础设施设置可能需要 2 到 3 分钟。在此期间，我们来看看新的 **pg&#95;clickhouse** 扩展。
