...
`MgBench` 是一种新的机器生成日志数据分析基准, [Andrew Crotty](http://cs.brown.edu/people/acrotty/).
...
运行基准查询:
```
-- Q1.1: 自午夜以来, 每个 Web 服务器的 CPU/网络利用率是多少?
...
-- Q1.4: 超过 1 个月, 每台服务器在磁盘 I/O 上被阻塞的频率如何?
