...
:::note
ClickHouse还支持 [SQL驱动的工作流](/operations/access-rights#access-control) 用于管理用户。 我们建议使用它。
:::
...
此设置可为用户启用或禁用 SQL-driven [访问控制和帐户管理](/operations/access-rights#access-control) 。
