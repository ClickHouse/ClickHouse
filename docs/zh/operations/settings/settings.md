...
的最大间隔 [分布](../../engines/table-engines/special/distributed.md) 表引擎发送数据。 限制在设置的区间的指数增长 [distributed_async_insert_sleep_time_ms](#distributed_async_insert_sleep_time_ms) 设置。
