---
slug: /zh/sql-reference/aggregate-functions/reference/quantile
...
结果是不确定的。要获得精确的分位数，使用 [quantileExact](/sql-reference/aggregate-functions/reference/quantileexact#quantileexact) 函数。
