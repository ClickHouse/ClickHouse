...
<div className="ch-install-cloud-card">
  ...
  <div className="ch-install-cloud-actions">
    ...
    <a
      ...
      href="https://clickhouse.com/docs/zh/get-started/setup/cloud"
      onClick={(event) => { event.preventDefault(); window.location.href = withDocsBase('/zh/get-started/setup/cloud'); }}
    >
      阅读快速入门教程
    </a>
  </div>
