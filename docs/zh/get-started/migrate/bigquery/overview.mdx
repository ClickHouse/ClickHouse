...
slug: /zh/get-started/migrate/bigquery/overview
...
<div id="bigquery-projects-vs-clickhouse-cloud-services">
  ### BigQuery Projects 与 ClickHouse Cloud 服务 {#bigquery-projects-vs-clickhouse-cloud-services}
</div>
...
<div id="bigquery-slot-reservations-and-quotas">
  ### BigQuery Slot 预留和配额 {#bigquery-slot-reservations-and-quotas}
</div>
...
<div id="secondary-indexes-only-available-in-clickhouse">
  ## 二级索引 (仅 ClickHouse 可用) {#secondary-indexes-only-available-in-clickhouse}
</div>
...
<div id="querying-materialized-views">
  ## 查询 materialized view {#querying-materialized-views}
</div>
