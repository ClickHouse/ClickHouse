...
| OSS to Cloud                                                    | 使用 [`remoteSecure`](/zh/get-started/migrate/oss-to-cloud/clickhouse-to-cloud) 或 [`BACKUP` 和 `RESTORE`](/zh/get-started/migrate/oss-to-cloud/oss-to-cloud-backup-restore) 从自管理 ClickHouse 部署迁移数据。 |
