    ...
    return (
        ...
        >
            <div>
                ...
                <span className="block text-[#6b7280] dark:text-[#a1a1aa] mt-1 text-sm font-normal leading-normal">100+ インテグレーション to connect the tools and services that you love with ClickHouse.</span>
            </div>
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4 mt-6">
        <HeroCard title="リアルタイムアナリティクス" description="即座にインサイトとダッシュボードを大規模に提供。数十億行のデータをリアルタイムで分析し、ミリ秒単位で結果を得られます。" href="/ja/get-started/use-cases/real-time-analytics" showArrow />
        ...
        <HeroCard title="データウェアハウジング" description="データを即座に分析・探索し、インサイトの獲得やアプリケーション活用に役立てられます。負荷の高いワークロードをオフロードすることで、より迅速にスケールできます。" href="/ja/get-started/use-cases/data-warehousing" showArrow />

        <HeroCard title="エージェント型アナリティクス" description="AIエージェントがリアルタイムデータを直接クエリし、会話形式で即座にインサイトや可視化を提供できます" href="/ja/get-started/use-cases/agentic-analytics" showArrow />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          ...
          <div className="flex flex-col gap-4">
            <HeroCard filename="thumbnail-clickstack-light.webp" title="ClickStack" description="ClickHouse を基盤とするオールインワンのオブザーバビリティスタックで、ログ、メトリクス、トレース、セッションリプレイ、エラーに対して超高速のクエリと強力な集計を提供します。" href="/ja/clickstack/overview" extraClassName="flex-1" showArrow arrowBottom />

            <HeroCard filename="thumbnail-postgres-light.webp" title="Managed Postgres" description="高速でスケーラブルな、エンタープライズ向けの Postgres サービスです。ClickHouse とネイティブに統合されています。トランザクションには Postgres、分析には ClickHouse を簡単に組み合わせられます。" href="/ja/products/managed-postgres/overview" extraClassName="flex-1" showArrow arrowBottom />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="オープンソースの LLM エンジニアリングプラットフォーム。オブザーバビリティ、メトリクス、評価、プロンプト管理をサポートします。" href="https://langfuse.com/docs" showArrow external />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Kubernetes Operator" description="Kubernetes 上での ClickHouse および ClickHouse Keeper クラスターのデプロイ、設定、管理を自動化します。" href="/ja/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="高速で信頼性が高く、スケーラブルなインプロセスデータベース。インプロセスで ClickHouse のパワーを体験できます。" href="/ja/products/chdb/index" showArrow />
        </div>
      </div>
