    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        <HeroCard
          ...
          description="初めての方はこちらから。始め方を学び、さらに詳しく知る"
        ...
        { label: "システムテーブル", href: "/ja/reference/system-tables/overview" },
        ...
        { label: "ClickHouse Managed Postgres", href: "/ja/products/managed-postgres/overview" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. 一般的なデータソースから最小限の作業でデータを取り込む方法", href: "/ja/integrations/home" },
