    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "ClickHouseとは？", href: "/get-started/about/intro" },
        { label: "インストール", href: "/get-started/setup/cloud" },
        { label: "クイックスタート", href: "/get-started/quickstarts/home" },
        { label: "ClickHouseの基本概念", href: "/concepts/core-concepts/index" },
        ...
        { label: "システムテーブル", href: "/reference/system-tables/overview" },
        ...
        { label: "ClickHouse Managed Postgres", href: "/products/managed-postgres/overview" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "1. 一般的なデータソースから最小限の作業でデータを取り込む方法", href: "/integrations/home" },
              { label: "2. 分析と成長のためにデータを整理するベストプラクティス", href: "/guides/clickhouse/data-modelling/schema-design" },
              { label: "3. 大規模なデータセットにリアルタイムでクエリする方法", href: "/get-started/use-cases/real-time-analytics" },
              { label: "4. その上にダッシュボード、アラート、イベント駆動型の機能を構築する方法", href: "/get-started/use-cases/data-warehousing" },
              { label: "5. パフォーマンスを高く保ちながらコストを低く抑えるためのヒント", href: "/concepts/best-practices/index" },
          ]}
            />
          </div>
