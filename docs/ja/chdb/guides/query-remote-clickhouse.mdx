---
title: 'リモートのClickHouseサーバーにクエリする方法'
sidebarTitle: 'リモートのClickHouseへのクエリ'
slug: /chdb/guides/query-remote-clickhouse
description: 'このガイドでは、chDBからリモートのClickHouseサーバーにクエリする方法を学びます。'
...
Pandas DataFrames へのクエリについて詳しくは、[Pandas DataFrames 開発者ガイド](/ja/chdb/guides/querying-pandas)を参照してください。