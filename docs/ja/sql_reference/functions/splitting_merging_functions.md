...
-   `separator` — The separator which should contain exactly one character. [文字列](../../sql_reference/data_types/string.md).
-   `s` — The string to split. [文字列](../../sql_reference/data_types/string.md).
...
タイプ: [配列](../../sql_reference/data_types/array.md) の [文字列](../../sql_reference/data_types/string.md).
...
-   `separator` — The separator. [文字列](../../sql_reference/data_types/string.md).
-   `s` — The string to split. [文字列](../../sql_reference/data_types/string.md).
