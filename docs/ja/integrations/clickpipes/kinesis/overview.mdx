...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step2_kinesis.webp" alt="接続の詳細を入力" size="lg" border />
...
<Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_kinesis.webp" alt="データフォーマットとトピックを設定" size="lg" border />
