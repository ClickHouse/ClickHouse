...
| Confluent Cloud  | <img src="/images/integrations/logos/confluent.svg" alt="Confluent Cloud ロゴ" width="32" />         | ストリーミング | 安定版   | 直接インテグレーションにより、Confluent と ClickHouse Cloud の連携を最大限に活用できます。                   |
