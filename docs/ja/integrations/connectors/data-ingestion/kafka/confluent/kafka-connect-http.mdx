...
<Image img="/images/integrations/data-ingestion/kafka/confluent/create_message_in_topic.webp" size="md" alt="Kafka トピックにテストメッセージを作成する方法を示す Confluent Cloud インターフェイス" border />
