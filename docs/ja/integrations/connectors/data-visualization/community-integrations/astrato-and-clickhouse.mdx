...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5a_clickhouse_build_chart.webp" alt="Astrato を ClickHouse の User Access に接続" border />
...
<Image size="lg" img="/images/integrations/data-visualization/astrato_5b_clickhouse_view_sql.webp" alt="ClickHouse の User Access に接続する Astrato" border />
