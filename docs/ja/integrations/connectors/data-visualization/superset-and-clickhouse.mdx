  ...
  <Step title="ドライバーをインストールする" id="2-install-the-driver">
    ...
    <Info>
      **Docker Compose Setup**
      ...
      Docker ベースのインストールについては、コンテナーに `clickhouse-connect` を追加する手順を [Superset のデータベース設定ガイド](https://superset.apache.org/docs/configuration/databases/#clickhouse) で確認してください。
    </Info>
