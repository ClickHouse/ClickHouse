...
<Image size="md" img="/images/integrations/data-visualization/quicksight_02.webp" alt="検索結果で MySQL がハイライト表示されている QuickSight のデータソース選択画面" border />
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_03.webp" alt="hostname、ポート、データベース、認証情報のフィールドを含む QuickSight の MySQL 接続設定フォーム" border />
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_05.webp" alt="ClickHouse からデータを取得するための QuickSight のカスタム SQL クエリエディター" border />
...
<Image size="md" img="/images/integrations/data-visualization/quicksight_07.webp" alt="左下隅で Direct Query モードのオプションがハイライト表示されている QuickSight インターフェイス" border />
