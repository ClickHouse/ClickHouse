---
slug: /ja/concepts/features/projections/projections
title: 'プロジェクション'
...
<div id="smarter_storage_with_part_offset">
  ### `_part_offset` によるより効率的なストレージ {#smarter_storage_with_part_offset}
</div>
...
<div id="when-to-use-projections">
  ## Projections を使用すべきケース {#when-to-use-projections}
</div>
...
<div id="average-price-london-projections">
  #### クエリ 2. ロンドンの年別平均価格 {#average-price-london-projections}
</div>
...
<div id="most-expensive-neighborhoods-projections">
  #### クエリ 3. 最も高額な地域 {#most-expensive-neighborhoods-projections}
</div>
