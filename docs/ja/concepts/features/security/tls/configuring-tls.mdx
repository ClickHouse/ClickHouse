---
slug: /ja/concepts/features/security/tls/configuring-tls
...
<div id="openssl-verification-modes">
  ## OpenSSL の検証モードと証明書ハンドラ {#openssl-verification-modes}
</div>
...
<div id="invalid-certificate-handlers">
  ### 無効な証明書ハンドラ {#invalid-certificate-handlers}
</div>
...
<div id="disabling-certificate-verification">
  ### 例: 証明書の検証を無効にする {#disabling-certificate-verification}
</div>
