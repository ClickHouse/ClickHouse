...
sidebarTitle: 'JWT'
slug: /ja/concepts/features/security/external-authenticators/jwt
title: 'JWT 認証'
doc_type: 'reference'
---
...
<div id="example-token-header-and-payload">
  ### トークン、ヘッダー、ペイロードの例 {#example-token-header-and-payload}
</div>
...
<div id="persistent-access-assignments">
  ### 永続的なアクセス割り当て {#persistent-access-assignments}
</div>
...
<div id="sql-security-definer-views">
  ## SQL SECURITY DEFINER を使用するビュー {#sql-security-definer-views}
</div>
...
<div id="enabling-jwt-authentication-for-your-service">
  ## サービスで JWT 認証を有効にする {#enabling-jwt-authentication-for-your-service}
</div>
