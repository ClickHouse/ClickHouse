...
<Image img="/images/bestpractices/building_skipping_indices.webp" size="lg" alt="スキッピング索引の構築" />
...
<Image img="/images/bestpractices/using_skipping_indices.webp" size="lg" alt="スキッピング索引の使用" />
