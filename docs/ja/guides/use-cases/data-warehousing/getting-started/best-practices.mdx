...
書き込みでは、Iceberg で [allow&#95;insert&#95;into&#95;iceberg](/ja/reference/settings/session-settings/allow#allow_insert_into_iceberg) が必要です (25.7+、26.2 以降はベータ) 。詳しくは [データレイクへの書き込み](/ja/guides/use-cases/data-warehousing/getting-started/writing-data) を参照してください。Delta Lake で [allow&#95;delta&#95;lake&#95;writes](/ja/reference/settings/session-settings/allow-experimental#allow_experimental_delta_lake_writes) が必要です (25.9+) 。[サポートマトリクス](/ja/guides/use-cases/data-warehousing/support-matrix) には、各フォーマットと操作にどのフラグが適用されるかが示されています。
