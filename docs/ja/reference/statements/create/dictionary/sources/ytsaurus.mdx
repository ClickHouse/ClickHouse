...
<Info>
  ...
  設定 [`allow_experimental_ytsaurus_dictionary_source`](/ja/reference/settings/session-settings/allow-experimental#allow_experimental_ytsaurus_dictionary_source) を使用して、
