...
<Note>
  ...
  * [`display_secrets_in_show_and_select`](/ja/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select) (サーバー設定)
  * [`format_display_secrets_in_show_and_select` ](/ja/reference/settings/formats/format#format_display_secrets_in_show_and_select) (フォーマット設定)
