...
<Note>
  このクエリ設定は、対応するサーバー設定を上書きします。詳しくは [max&#95;partition&#95;size&#95;to&#95;drop](/ja/reference/settings/server-settings/settings/max#max_partition_size_to_drop) を参照してください
</Note>
...
<Note>
  このクエリ設定は、対応するサーバー設定を上書きします。詳細は [max&#95;table&#95;size&#95;to&#95;drop](/ja/reference/settings/server-settings/settings/max-table#max_table_size_to_drop) を参照してください。
</Note>
