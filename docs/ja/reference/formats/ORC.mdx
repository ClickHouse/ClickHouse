...
| ------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------ |
| `Boolean`                             | [Bool](/ja/reference/data-types/boolean)                                               | `Boolean`                |
...
| `Bigint`                              | [Int64/UInt64](/ja/reference/data-types/int-uint)                                      | `Bigint`                 |
...
| `String`, `Varchar`, `Binary`          | [String](/ja/reference/data-types/string)                                              | `String`                  |
| `Char`                                 | [FixedString](/ja/reference/data-types/fixedstring)                                    | `String`                  |
...
| 設定                                                                                                                                                                                     | 説明                                                 | デフォルト   |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ------- |
| [`output_format_orc_string_as_string`](/ja/reference/settings/formats#output_format_orc_string_as_string)                                                                                  | String カラムには、Binary ではなく ORC の String 型を使用します。     | `true`   |
| [`output_format_orc_compression_method`](/ja/reference/settings/formats#output_format_orc_compression_method)                                                                             | 出力 ORC フォーマットで使用する圧縮方式。デフォルト値                      | `zstd`  |
| [`input_format_orc_case_insensitive_column_matching`](/ja/reference/settings/formats#input_format_orc_case_insensitive_column_matching)                                                    | ORC のカラムと ClickHouse のカラムを照合する際に、大文字・小文字を区別しません。   | `false`  |
| [`input_format_orc_allow_missing_columns`](/ja/reference/settings/formats#input_format_orc_allow_missing_columns)                                                                          | ORC データの読み取り時に、欠落しているカラムを許可します。                    | `true`   |
| [`input_format_orc_skip_columns_with_unsupported_types_in_schema_inference`](/ja/reference/settings/formats#input_format_orc_skip_columns_with_unsupported_types_in_schema_inference)      | ORC フォーマットのスキーマ推論時に、未対応の型を持つカラムをスキップできるようにします。     | `false`  |
