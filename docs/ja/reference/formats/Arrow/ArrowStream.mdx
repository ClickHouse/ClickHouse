...
| `output_format_arrow_unsupported_types_as_binary`                            | Arrow に対応する型がない型 (例: `BFloat16`、`AggregateFunction`) を生のバイナリデータとして出力します。false の場合、そのような型では exception が発生します。 | `1`         |
