...
* `bytes` is default, controlled by setting [`output_format_avro_string_column_pattern`](/ja/reference/settings/formats/output-format#output_format_avro_string_column_pattern)
