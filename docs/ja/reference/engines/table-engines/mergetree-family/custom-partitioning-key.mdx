...
デフォルトでは、浮動小数点のパーティションキーはサポートされていません。これを使用するには、設定 [allow&#95;floating&#95;point&#95;partition&#95;key](/ja/reference/settings/merge-tree-settings/allow#allow_floating_point_partition_key) を有効にします。
