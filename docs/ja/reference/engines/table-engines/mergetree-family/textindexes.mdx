...
そのため、`support_phrase_search = 1` を指定して索引を作成するには、MergeTree setting [`allow_experimental_text_index_phrase_search`](/ja/reference/settings/merge-tree-settings#allow_experimental_text_index_phrase_search) を有効にする必要があります。
...
<Warning>
  ...
  位置情報の保存を有効にするには、MergeTree setting [`allow_experimental_text_index_phrase_search`](/ja/reference/settings/merge-tree-settings#allow_experimental_text_index_phrase_search) を設定してください。
</Warning>
