...
ウィンドウパーティション内の行の相対順位 (つまりパーセンタイル) を返します。

**構文**

別名: `percentRank` (大文字と小文字を区別) 
...
デフォルトであり、必須でもあるウィンドウフレームの定義は `RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING` です。
