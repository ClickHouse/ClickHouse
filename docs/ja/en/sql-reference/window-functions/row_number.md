...
各パーティション内で、現在の行に 1 から始まる番号を付けます。
...
* 現在の行が属するパーティション内での行番号。[UInt64](../data-types/int-uint.md)。

**例**

次の例は、動画による解説 [ClickHouse のランキング用ウィンドウ関数](https://youtu.be/Yku9mmBYm_4?si=XIMu1jpYucCQEoXA) で示されている例に基づいています。
