---
description: 'さまざまなプログラミング言語向けに利用可能なサードパーティ製クライアントライブラリの概要'
sidebar_label: 'クライアントライブラリ'
sidebar_position: 26
slug: /interfaces/third-party/client-libraries
title: 'サードパーティの開発者によるクライアントライブラリ'
doc_type: 'reference'
---

:::note
ClickHouse Inc は、以下に挙げるライブラリを**保守しておらず**、品質を確認するための広範なテストも実施していません。
:::
...
* [kolya7k ClickHouse PHP 拡張機能](https://github.com//kolya7k/clickhouse-php)
...
* [userverフレームワーク向けClickHouseドライバー](https://userver.tech/dd/ddb/clickhouse_driver.html)
