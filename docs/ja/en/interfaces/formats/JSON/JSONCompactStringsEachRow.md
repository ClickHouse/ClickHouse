---
alias: []
description: 'JSONCompactStringsEachRow フォーマットのリファレンス'
input_format: true
...
[`JSONCompactEachRow`](./JSONCompactEachRow.md) との違いは、データフィールドが型付きの JSON 値ではなく、文字列として出力される点だけです。
...
データを読み込むには、`JSONCompactStringsEachRow` フォーマットを使用します。
