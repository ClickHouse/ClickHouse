...
description: 'PrettyJSONLinesフォーマットに関するドキュメント'
input_format: false
...
[JSONEachRow](./JSONEachRow.md) との違いは、JSON が改行区切りで、4 スペースのインデントによって見やすく整形されている点だけです。
...
データを `PrettyJSONEachRow` フォーマットで読み取ります。
