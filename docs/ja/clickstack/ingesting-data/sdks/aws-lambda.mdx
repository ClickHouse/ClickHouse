...
## OpenTelemetry Lambda レイヤーをインストールする {#installing-the-otel-lambda-layers}
...
### 言語別の自動インストルメンテーションレイヤーを追加する {#adding-language-specific-auto-instrumentation}
...
### カスタムインストルメンテーションでデータが送信されない {#custom-instrumentation-not-sending}
...
### SDK のデバッグログを有効にする {#enabling-sdk-debug-logs}
...
### collector のデバッグログを有効にする {#enabling-collector-debug-logs}
