...
### ユーザー情報またはメタデータを関連付ける {#attach-user-information-or-metadata}
...
### React error boundary のエラーを自動的にキャプチャする {#auto-capture-react-error-boundary-errors}
...
### CORS リクエストのリソースタイミングを有効にする {#enable-resource-timing-for-cors-requests}
