...
<Steps>
  ...
  <Step title="ClickStack の Helm リポジトリを追加する" id="add-the-clickstack-helm-repository">
  ...
  <Step title="ClickStack のインストール" id="installing-clickstack">
  ...
  <Step title="インストールを確認する" id="verify-the-installation">
    インストールを確認します。
  ...
  <Step title="ポートフォワーディング" id="forward-ports">
  ...
  <Step title="UI にアクセスする" id="navigate-to-the-ui">
  ...
  <Step title="values のカスタマイズ (任意)" id="customizing-values">
  ...
  <Step title="シークレットの使用 (任意)" id="using-secrets">
