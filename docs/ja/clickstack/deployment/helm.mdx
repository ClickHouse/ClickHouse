...
<Steps>
  ...
  <Step title="Operator をインストールする" id="install-the-operators">
  ...
  <Step title="ClickStack をインストールする" id="installing-clickstack">
  ...
  <Step title="インストールの確認" id="verify-the-installation">
    インストールを確認します。
  ...
  <Step title="ポートフォワード" id="forward-ports">
  ...
  <Step title="UI に移動する" id="navigate-to-the-ui">
  ...
  <Step title="Secret の使用 (任意)" id="using-secrets">
