...
<Tabs>
  <Tab title="マネージド ClickStack">
    ...
    <Steps>
      <Step title="OpenTelemetry のカスタム設定を作成する" id="create-otel-configuration">
      ...
      <Step title="OpenTelemetry Collector を起動する" id="start-the-otel-collector">
      ...
      <Step title="サービスを選択する" id="select-your-service">
      ...
      <Step title="システムログを確認する" id="navigate-to-the-hyperdx-ui">
      ...
      <Step title="システムメトリクスを調べる" id="explore-system-metrics">
