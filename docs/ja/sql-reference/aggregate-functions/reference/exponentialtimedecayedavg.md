---
slug: /ja/sql-reference/aggregate-functions/reference/exponentialTimeDecayedAvg
...
- 時点 `t` における指数平滑加重移動平均を返します。 [Float64](../../data-types/float.md)。
