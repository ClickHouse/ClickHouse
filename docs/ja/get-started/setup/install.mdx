...
<div className="ch-install-cloud-card">
  ...
  <div className="ch-install-cloud-actions">
    ...
    <a
      className="ch-install-cloud-cta ch-install-cloud-cta-secondary"
      href="https://clickhouse.com/docs/ja/get-started/setup/cloud"
      onClick={(event) => { event.preventDefault(); window.location.href = withDocsBase('/ja/get-started/setup/cloud'); }}
    >
      クイックスタートチュートリアルを読む
    </a>
  </div>
