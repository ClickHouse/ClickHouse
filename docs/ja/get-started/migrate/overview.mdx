...
| OSS to Cloud                                                             | [`remoteSecure`](/ja/get-started/migrate/oss-to-cloud/clickhouse-to-cloud) または [`BACKUP` および `RESTORE`](/ja/get-started/migrate/oss-to-cloud/oss-to-cloud-backup-restore) を使用して、セルフマネージドの ClickHouse デプロイメントからデータを転送します。 |
