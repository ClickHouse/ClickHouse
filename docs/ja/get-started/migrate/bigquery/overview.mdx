...
slug: /ja/get-started/migrate/bigquery/overview
...
<div id="bigquery-projects-vs-clickhouse-cloud-services">
  ### BigQuery Projects と ClickHouse Cloud Services {#bigquery-projects-vs-clickhouse-cloud-services}
</div>
...
<div id="bigquery-datasets-vs-clickhouse-cloud-databases">
  ### BigQuery のデータセットと ClickHouse Cloud のデータベース {#bigquery-datasets-vs-clickhouse-cloud-databases}
</div>
...
<div id="bigquery-slot-reservations-and-quotas">
  ### BigQuery Slot 予約とクォータ {#bigquery-slot-reservations-and-quotas}
</div>
...
<div id="query-acceleration-techniques">
  ## クエリ高速化の手法 {#query-acceleration-techniques}
</div>

<div id="primary-and-foreign-keys-and-primary-index">
  ### 主キーと外部キー、およびプライマリインデックス {#primary-and-foreign-keys-and-primary-index}
</div>
...
<div id="secondary-indexes-only-available-in-clickhouse">
  ## セカンダリ索引 (ClickHouse でのみ利用可能) {#secondary-indexes-only-available-in-clickhouse}
</div>
...
<div id="querying-materialized-views">
  ## materialized view へのクエリ {#querying-materialized-views}
</div>
...
<div id="sql-language-features">
  ## SQL 言語の機能 {#sql-language-features}
</div>
