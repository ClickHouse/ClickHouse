...
* **Kubernetes cluster:** クラウドプロバイダーに応じて Amazon EKS、Google GKE、または Azure AKS となります。アーキテクチャ図に示されている ClickHouse サーバーと補助サービスをホストします。
...
<div id="why-requirements-matter">
  ### これらの要件が重要な理由 {#why-requirements-matter}
</div>
