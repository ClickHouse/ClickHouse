...
<div id="prometheus-monitoring">
  ## Prometheus の監視アプローチ {#prometheus-monitoring}
</div>
...
<div id="builtin-prometheus-stack">
  ## 組み込み BYOC Prometheus スタック {#builtin-prometheus-stack}
</div>
...
<div id="prometheus-stack-integration">
  ### お使いの監視ツールとの統合 {#prometheus-stack-integration}
</div>
...
<div id="direct-prometheus-integration">
  ## ClickHouse service の Prometheus インテグレーション {#direct-prometheus-integration}
</div>
