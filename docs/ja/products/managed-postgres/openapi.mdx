...
[Prometheus endpoint]: /products/managed-postgres/monitoring/prometheus "ClickHouse Managed Postgres Prometheus エンドポイント"

[metrics reference]: /products/managed-postgres/monitoring/metrics "ClickHouse Managed Postgres メトリクス リファレンス"
