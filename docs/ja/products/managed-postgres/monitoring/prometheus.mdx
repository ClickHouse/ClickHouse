...
[cloud-api]: /ja/products/cloud/features/admin-features/api/api-overview "Cloud API"

[API keys]: /ja/products/cloud/features/admin-features/api/openapi "API キーの管理"