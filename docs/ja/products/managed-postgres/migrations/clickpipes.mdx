...
<Image img="/images/managed-postgres/pgpg/nextexport.webp" alt="ステップ2: スキーマのエクスポート用 `pg_dump` コマンド" size="lg" border />
...
<Image img="/images/managed-postgres/pgpg/nextimport.webp" alt="ステップ3: スキーマインポート用の psql コマンド" size="lg" border />
