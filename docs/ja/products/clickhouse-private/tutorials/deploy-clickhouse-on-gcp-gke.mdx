...
<Steps>
  ...
  <Step stepNumber={2}>
    ## ステップ 2: Artifact Registry を作成する (`01-artifact-registry.sh`)
  ...
  <Step stepNumber={3}>
    ## ステップ 3: コンテナーイメージをコピー (`02-copy-images.sh`)
  ...
  <Step stepNumber={4}>
    ## ステップ 4: VPC とサブネットを設定する (`03-vpc-subnet.sh`)
  ...
  <Step stepNumber={5}>
    ## ステップ 5: Cloud NAT を作成する (`04-cloud-nat.sh`)
  ...
  <Step stepNumber={6}>
    ## ステップ6: GCPサービスアカウントを作成する (`05-service-account.sh`)
  ...
  <Step stepNumber={7}>
    ## ステップ 7: GCS バケットの作成 (`06-gcs-bucket.sh`)
  ...
  <Step stepNumber={8}>
    ## ステップ 8: GKE クラスターを作成 (`07-gke-cluster.sh`)
  ...
  <Step stepNumber={9}>
    ## ステップ 9: Node Pool を作成 (`08-node-pools.sh`)
  ...
  <Step stepNumber={10}>
    ## ステップ10: ローカルSSDデーモンセットをデプロイ (`09-local-ssd-daemonset.sh`)
  ...
  <Step stepNumber={11}>
    ## ステップ11: トポロジーラベルを追加する (`10-topology-labels.sh`)
  ...
  <Step stepNumber={12}>
    ## ステップ12: Kubernetesの前提条件をインストールする
  ...
  <Step stepNumber={14}>
    ## ステップ14: Operator をインストールする (`16-install-operator.sh`)
  ...
  <Step stepNumber={15}>
    ## ステップ15: ClickHouseクラスターのデプロイ (`17-install-cluster.sh`)
  ...
  <Step stepNumber={16}>
    ## ステップ 16: Workload Identity をバインドする (`18-bind-helm-workload-identity.sh`)
