---
position: 2
slug: /ja/products/kubernetes-operator/guides/configuration
...
<div id="keeper-integration">
  ### Keeper インテグレーション {#keeper-integration}
</div>
...
<div id="keepercluster-configuration">
  ## KeeperCluster の設定 {#keepercluster-configuration}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencepodtemplatespec-for-all-supported-pod-template-options">
  ### サポートされているすべてのポッドテンプレートオプションについては、[API リファレンス](/ja/products/kubernetes-operator/reference/api-reference#podtemplatespec)を参照してください。 {#see-api-reference-for-all-supported-pod-template-options}
</div>

<div id="pod-disruption-budgets">
  ## ポッドの停止予算 {#pod-disruption-budgets}
</div>
...
<div id="pdb-cluster-wide-disable">
  ### クラスター全体での無効化 {#pdb-cluster-wide-disable}
</div>
...
<div id="container-configuration">
  ## コンテナーの設定 {#container-configuration}
</div>
...
<div id="container-resources">
  ### コンテナーのリソース {#container-resources}
</div>
...
<div id="see-api-referenceproductskubernetes-operatorreferenceapi-referencecontainertemplatespec-for-all-supported-container-template-options">
  ### サポートされているすべての コンテナー テンプレートオプションについては、[API リファレンス](/ja/products/kubernetes-operator/reference/api-reference#containertemplatespec)を参照してください。 {#see-api-reference-for-all-supported-container-template-options}
</div>

<div id="tls-ssl-configuration">
  ## TLS/SSL の設定 {#tls-ssl-configuration}
</div>

<div id="configure-secure-endpoints">
  ### セキュアなエンドポイントを設定する {#configure-secure-endpoints}
</div>
...
<div id="ssl-certificate-secret-format">
  ### SSL 証明書 Secret の形式 {#ssl-certificate-secret-format}
</div>
...
<div id="clickhouse-keeper-communication-over-tls">
  ### TLS を介した ClickHouse-Keeper 通信 {#clickhouse-keeper-communication-over-tls}
</div>
...
<div id="external-secret-required-keys">
  ### 必須のキー {#external-secret-required-keys}
</div>
...
<div id="external-secret-policy">
  ### ポリシー: Observe と Manage {#external-secret-policy}
</div>
...
<div id="external-secret-status">
  ### ステータス条件とトラブルシューティング {#external-secret-status}
</div>
...
<div id="additional-ports-mysql-example">
  ### エンドツーエンドの例: MySQLワイヤプロトコル {#additional-ports-mysql-example}
</div>
...
<div id="additional-ports-constraints">
  ### フィールドの制約 {#additional-ports-constraints}
</div>
...
<div id="additional-ports-reserved">
  ### 予約済みのポートと名前 {#additional-ports-reserved}
</div>
...
<div id="version-probe-and-upgrade-channel">
  ## バージョンプローブとアップグレードチャネル {#version-probe-and-upgrade-channel}
</div>
...
<div id="upgrade-channel-choosing">
  ### リリースチャネルの選択 {#upgrade-channel-choosing}
</div>
...
<div id="version-status-conditions">
  ### ステータス条件 {#version-status-conditions}
</div>
...
<div id="version-probe-template">
  ### バージョンプローブ Job のオーバーライド {#version-probe-template}
</div>
...
<div id="version-operator-flags">
  ### オペレーター全体に適用される制御 {#version-operator-flags}
</div>
...
<div id="default-user-password">
  ### `default` ユーザーのパスワード {#default-user-password}
</div>
...
<div id="default-password-secret-example">
  #### Secretを使った完全な例 {#default-password-secret-example}
</div>
...
<div id="using-configmap-for-user-passwords">
  #### ConfigMap を使用する {#using-configmap-for-user-passwords}
</div>
...
<div id="embedded-extra-users-configuration">
  ### 埋め込み追加ユーザー設定 {#embedded-extra-users-configuration}
</div>
...
<div id="see-documentationconceptsfeaturesconfigurationsettingssettings-users-for-all-supported-clickhouse-users-configuration-options">
  #### サポートされているすべての ClickHouse ユーザー設定オプションについては、[ドキュメント](/ja/concepts/features/configuration/settings/settings-users)を参照してください。 {#see-documentation-for-all-supported-clickhouse-users-configuration-options}
</div>
