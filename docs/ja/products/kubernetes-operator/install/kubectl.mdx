...
<Steps>
  <Step title="リポジトリをクローンする" id="clone-the-repository">
    ```bash
  ...
  <Step title="インストールオプションを設定する" id="configure-installation-options">
  ...
  <Step title="ビルドしてデプロイする" id="build-and-deploy">
