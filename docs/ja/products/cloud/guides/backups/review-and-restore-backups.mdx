...
<div id="working-with-your-restored-service">
  ## 復元済みサービスの扱い {#working-with-your-restored-service}
</div>
...
<div id="migrate-data-from-the-newly-restored-service-back-to-the-original-service">
  ### **新たに復元したサービス**から**元のサービス**へデータを移行する {#migrate-data-from-the-newly-restored-service-back-to-the-original-service}
</div>
...
<div id="undeleting-or-undropping-tables">
  ## テーブルの削除取り消し {#undeleting-or-undropping-tables}
</div>
