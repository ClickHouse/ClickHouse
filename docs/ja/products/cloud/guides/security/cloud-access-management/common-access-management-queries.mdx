...
<Tip>
  コンソールからデータベースアクセスを管理するには、[Cloud管理のデータベースロール](/ja/products/cloud/guides/security/cloud-access-management/manage-custom-roles#manage-database-roles) (ベータ) の使用を推奨します。`sql-console-role:<email>`ロールは、[JWT認証](/ja/products/cloud/guides/security/cloud-access-management/jwt-authentication-setup)と互換性がありません。
</Tip>
