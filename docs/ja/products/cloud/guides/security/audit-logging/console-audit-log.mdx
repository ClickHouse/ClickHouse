...
ClickHouse Cloud API の `activity` エンドポイントを使用すると、監査イベントをエクスポートできます。詳細については、[API リファレンス](/ja/products/cloud/api-reference/organization/get-list-of-available-organizations)を参照してください。
