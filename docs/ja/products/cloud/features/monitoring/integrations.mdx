...
| [ClickHouse Cloud Prometheusインテグレーション](#clickhouse-cloud-prometheus-integration)          | [clickhouse.com/docs](/ja/integrations/prometheus)                                                | Cloud       | メトリクス             |
...
Datadog Agent を [OpenMetrics インテグレーション](https://docs.datadoghq.com/integrations/openmetrics/)で設定し、ClickHouse Cloud API を定期的にポーリングしてメトリクスを収集します。設定の詳細については、[Prometheus インテグレーションのページ](/ja/integrations/prometheus#integrating-with-datadog)を参照してください。
