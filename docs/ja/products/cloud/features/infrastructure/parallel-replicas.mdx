...
<div id="non-sharded-architecture">
  ## 非分片アーキテクチャ {#non-sharded-architecture}
</div>
...
<div id="managing-cache-locality">
  ### cache の局所性の管理 {#managing-cache-locality}
</div>
...
## 並列レプリカの問題の調査 {#investigating-issues-with-parallel-replicas}
