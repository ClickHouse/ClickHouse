...
<Image img="/images/cloud/manage/scaling-patch-request.webp" size="lg" alt="スケーリング PATCH リクエスト" border caption="`numReplicas` を更新する `PATCH` リクエスト" />

<Image img="/images/cloud/manage/scaling-patch-response.webp" size="md" alt="スケーリング PATCH レスポンス" border caption="`PATCH` リクエストのレスポンス" />
...
<Image img="/images/cloud/manage/scaling-configure.webp" size="md" alt="スケーリング設定" border caption="ClickHouse Cloud console のサービスのスケーリング設定" />
