...
<img className="w-full h-auto" src="/images/interfaces/native-format/block-structure.svg" alt="Structure of a columnar wire block and its data layout families" width="1219" height="758" loading="lazy" decoding="async" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/decoder-dispatch.svg" alt="Decoder routing from a type description to its encoding family" width="1195" height="651" loading="lazy" decoding="async" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/array-offsets.svg" alt="Offsets mapping rows into a shared values stream" width="1125" height="278" loading="lazy" decoding="async" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/nested-layout.svg" alt="Composite column layout with and without flattening" width="586" height="534" loading="lazy" decoding="async" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/state-prefix-per-block.svg" alt="State prefix repeated for every non-empty block" width="613" height="581" loading="lazy" decoding="async" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/variant-discriminators.svg" alt="Discriminators selecting values from dense type-specific runs" width="978" height="388" loading="lazy" decoding="async" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/compression-frame.svg" alt="Compression frame fields and compressed-size boundary" width="1255" height="164" loading="lazy" decoding="async" />
