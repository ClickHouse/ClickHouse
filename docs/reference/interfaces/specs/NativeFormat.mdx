...
<img className="w-full h-auto" src="/images/interfaces/native-format/block-structure.png" alt="Structure of a columnar wire block and its data layout families" width="1568" height="976" loading="lazy" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/decoder-dispatch.png" alt="Decoder routing from a type description to its encoding family" width="1568" height="854" loading="lazy" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/array-offsets.png" alt="Offsets mapping rows into a shared values stream" width="1568" height="388" loading="lazy" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/nested-layout.png" alt="Composite column layout with and without flattening" width="1172" height="1068" loading="lazy" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/state-prefix-per-block.png" alt="State prefix repeated for every non-empty block" width="1226" height="1162" loading="lazy" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/variant-discriminators.png" alt="Discriminators selecting values from dense type-specific runs" width="1568" height="624" loading="lazy" />
...
<img className="w-full h-auto" src="/images/interfaces/native-format/compression-frame.png" alt="Compression frame fields and compressed-size boundary" width="1568" height="206" loading="lazy" />
