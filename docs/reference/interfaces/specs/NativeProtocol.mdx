...
| 3 | `trace_type` | `String` | One of `CPU`, `Real`, `Memory`, `MemorySample`, or `MemoryPeak`. Other trace types are excluded. |
...
| 8 | `size` | `Int64` | Allocation or deallocation size for memory samples; zero for time samples. |
