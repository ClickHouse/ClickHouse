---
alias: []
description: 'Documentation for the JSONEachRowWithNamesAndTypes format'
input_format: true
keywords: ['JSONEachRowWithNamesAndTypes']
output_format: true
slug: /interfaces/formats/JSONEachRowWithNamesAndTypes
title: 'JSONEachRowWithNamesAndTypes'
doc_type: 'reference'
---
