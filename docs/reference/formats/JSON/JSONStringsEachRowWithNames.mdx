---
alias: []
description: 'Documentation for the JSONStringsEachRowWithNames format'
input_format: true
keywords: ['JSONStringsEachRowWithNames']
output_format: true
slug: /interfaces/formats/JSONStringsEachRowWithNames
title: 'JSONStringsEachRowWithNames'
doc_type: 'reference'
---
