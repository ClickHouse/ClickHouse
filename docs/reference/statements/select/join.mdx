...
- [max_bytes_before_external_join](/reference/settings/session-settings/join#max_bytes_before_external_join) — Absolute spill threshold.
- [max_bytes_ratio_before_external_join](/reference/settings/session-settings/join#max_bytes_ratio_before_external_join) — Spill threshold as a ratio of available memory.
