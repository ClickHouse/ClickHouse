...
<Note>
Specialized codecs are currently chosen for integers, enums, dates and times, `Decimal32`/`Decimal64`, and `IPv4`. Other columns select between the default codec and `NONE`.
</Note>
