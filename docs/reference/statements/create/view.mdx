...
Note that materialized view is influenced by [optimize_on_insert](/reference/settings/session-settings/optimize#optimize_on_insert) setting. The data is merged before the insertion into a view.
