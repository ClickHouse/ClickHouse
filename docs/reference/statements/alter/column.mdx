...
Separately, `ADD INDEX` only updates metadata: a newly added index stays unmaterialized on historical parts until you run `MATERIALIZE INDEX` or a later merge builds it.
</Note>
