...
:::note
The partial aggregate cache is experimental. See the [`use_partial_aggregate_cache`](/operations/settings/settings#use_partial_aggregate_cache) setting and related options.
:::
