...
Clears ClickHouse's internal DNS cache. You might need to use this command after an infrastructure change, such as changing the IP address of another ClickHouse server or a server used by dictionaries.
