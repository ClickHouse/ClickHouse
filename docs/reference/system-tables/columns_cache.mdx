...
- `database` ([String](/reference/data-types/string)) — Database name of the table the part belongs to. Empty if the table has been dropped but some of its entries are still in the cache.
- `table` ([String](/reference/data-types/string)) — Table name. Empty if the table has been dropped.
