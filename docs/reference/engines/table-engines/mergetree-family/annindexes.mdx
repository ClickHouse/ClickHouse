...
<Tip>
To enforce index usage, you can run the SELECT query with setting [force_data_skipping_indexes](/reference/settings/session-settings/force#force_data_skipping_indices) (provide the index name as setting value).
</Tip>
