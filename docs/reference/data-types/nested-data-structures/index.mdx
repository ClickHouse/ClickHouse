...
When the [`flatten_nested`](/reference/settings/session-settings/other#flatten_nested) setting is set to `0` (`flatten_nested=1` by default) arbitrary levels of nesting are supported.
