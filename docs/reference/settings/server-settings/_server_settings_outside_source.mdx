...
| `operation_timeout` | Maximum time, in seconds, to wait for the result of a single LDAP operation (a bind, a StartTLS negotiation, or a search) on an established connection. Must be greater than `0`. Default is `40`.                                                                                                                                                                                                                                                                                                                                                             |
| `port` | LDAP server port, default is 636 if `enable_tls` is set to true, `389` otherwise.                                                                                                                                                                                                                                                                                                                                                        |
| `search_timeout` | Time limit, in seconds, for LDAP search requests (user DN detection and role mapping). It is sent to the server as the requested time limit and enforced on the client as well. Must be greater than `0`. Default is `20`.                                                                                                                                                                                                                                                                                                                                                        |
