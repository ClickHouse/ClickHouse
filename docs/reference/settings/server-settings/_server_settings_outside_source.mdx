...
| `settings_constraints_replace_previous` | Enables the `changeable_in_readonly` constraint type. It does not affect how the constraints of several settings profiles are combined, see [Constraints on settings](/concepts/features/configuration/settings/constraints-on-settings).                                                                                                                                                                                                                            | `true`  |
