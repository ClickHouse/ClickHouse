...
Snowflake Horizon Catalog exposes the Iceberg REST API for Snowflake-managed Iceberg tables.
Use `DataLakeCatalog` with `catalog_type = 'horizon'`. See the [Horizon catalog guide](/guides/use-cases/data-warehousing/horizon-catalog).
