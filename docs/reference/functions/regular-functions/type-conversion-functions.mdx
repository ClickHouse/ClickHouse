...
import TypeConversionFunctionsIndex from "/snippets/components/TypeConversionFunctionsIndex/TypeConversionFunctionsIndex.jsx";

Type conversion functions convert values between ClickHouse data types. The individual function reference pages are autogenerated from `system.functions` and are available in the navigation.

<TypeConversionFunctionsIndex />
{/*AUTOGENERATED_END*/}
