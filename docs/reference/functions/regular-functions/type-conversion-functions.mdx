...
- `x` — Input value to convert. [`String`](/reference/data-types/string) or [`FixedString`](/reference/data-types/fixedstring) or [`DateTime`](/reference/data-types/datetime) or [`DateTime64`](/reference/data-types/datetime64) or [`(U)Int*`](/reference/data-types/int-uint) or [`BFloat16`](/reference/data-types/float) or [`Float*`](/reference/data-types/float)
...
Returns a UUID2 from the string representation of the UUID. [`UUID2`](/reference/data-types/uuid2)
...
## toUUID2OrNull {#toUUID2OrNull}

Introduced in: v26.8.0

Like [`toUUID2`](#toUUID2) but returns NULL if the string cannot be parsed.

**Syntax**

```sql
toUUID2OrNull(string)
```
...
Returns a UUID2, or NULL on parse failure. [`Nullable(UUID2)`](/reference/data-types/nullable)

**Examples**

## toUUID2OrZero {#toUUID2OrZero}

Introduced in: v26.8.0

Like [`toUUID2`](#toUUID2) but returns a zero UUID2 if the string cannot be parsed.

**Syntax**

```sql
toUUID2OrZero(string)
```
...
Returns a UUID2, or a zero UUID2 on parse failure. [`UUID2`](/reference/data-types/uuid2)
