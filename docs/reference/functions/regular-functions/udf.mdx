...
The transport exposes the following `ProfileEvents` for observability: `ExecutableUDFSharedMemoryCalls`, `ExecutableUDFSharedMemoryInputBytes`, `ExecutableUDFSharedMemoryOutputBytes`, `ExecutableUDFSharedMemoryRegionGrowths` and `ExecutableUDFSharedMemoryAllocatedBytes`.
