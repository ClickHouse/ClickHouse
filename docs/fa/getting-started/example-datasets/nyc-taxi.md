...
toc_priority: 16
toc_title: "\u062F\u0627\u062F\u0647 \u0647\u0627\u06CC \u062A\u0627\u06A9\u0633\u06CC\
  \ \u0646\u06CC\u0648\u06CC\u0648\u0631\u06A9"
---

# داده های تاکسی نیویورک {#new-york-taxi-data}
...
## نحوه وارد کردن داده های خام {#how-to-import-the-raw-data}
...
!!! info "اطلاعات"
    اگر شما نمایش داده شد شرح داده شده در زیر اجرا خواهد شد, شما مجبور به استفاده از نام جدول کامل, `datasets.trips_mergetree`.

## نتایج بر روی سرور تک {#results-on-single-server}
...
[مقاله اصلی](https://clickhouse.tech/docs/en/getting_started/example_datasets/nyc_taxi/) <!--hide-->
