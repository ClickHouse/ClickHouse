...
این موتور از [Nullable](../../../sql_reference/data_types/nullable.md) نوع داده.
...
-   انواع ستون ممکن است از کسانی که در جدول منبع متفاوت. فاحشه خانه تلاش می کند تا [بازیگران](../../../sql_reference/functions/type_conversion_functions.md#type_conversion_function-cast) ارزش ها را به انواع داده های کلیک.
...
-   [تابع جدول ان بی سی](../../../sql_reference/table_functions/odbc.md)
