...
-   [ریزدانه](../../engines/table_engines/mergetree_family/aggregatingmergetree.md) موتور جدول.
-   [پلاکتی](../../sql_reference/functions/other_functions.md#function-finalizeaggregation) تابع.
-   [خرابی اجرا](../../sql_reference/functions/other_functions.md#function-runningaccumulate) تابع.
