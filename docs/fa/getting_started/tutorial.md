# اموزش کلیک {#mwzsh-khlykh}

## چه انتظار از این مقاله? {#chh-ntzr-z-yn-mqlh}
...
## راه اندازی تک گره {#rh-ndzy-tkh-grh}
...
### دانلود و استخراج داده های جدول {#dnlwd-w-stkhrj-ddh-hy-jdwl}
...
!!! اخطار «Notice» این روش مناسب برای جلوگیری از جداول بزرگ نیست. یک ابزار جداگانه وجود دارد [تاتر-کپی](../operations/utils/clickhouse-copier.md) که می تواند جداول دلخواه بزرگ دوباره سفال. "سفال."
