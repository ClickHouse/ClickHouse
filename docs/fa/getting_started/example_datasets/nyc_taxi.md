...
# داده های تاکسی New York {#ddh-hy-tkhsy-new-york}

## چطور داده های raw را import کنیم {#chtwr-ddh-hy-raw-r-import-khnym}
...
متاسفانه، تمام فیلد های مرتبط با آب و هوا (precipitation…average\_wind\_speed) با Null پر شدند. به خاطر همین، ما از دیتاست نهایی اینها رو حذف کردیم.
...
## نتایج بر روی یک سرور {#ntyj-br-rwy-ykh-srwr}
...
[مقاله اصلی](https://clickhouse.tech/docs/fa/getting_started/example_datasets/nyc_taxi/) <!--hide-->
