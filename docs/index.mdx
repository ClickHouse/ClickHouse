        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
            ...
            <HeroCard
                ...
                links={[
                    ...
                    { label: "System tables", href: "/reference/system-tables/overview" },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
                <div className="col-span-2">
                    <HeroCard
                        ...
                        links={[
                            { label: "1. How to ingest data from common sources with minimal work", href: "/integrations/home" },
            ...
            <div className="mt-6">
                <Tabs>
                    ...
                    <Tab title="Codex" icon="/images/logo-codex.svg">
                        <p className="mb-2 text-[#9ca3af] text-[13px]">Run in your terminal:</p>
                        <CodeBlock language="bash">{`codex mcp add clickhouse-docs --url https://clickhouse.com/docs/mcp`}</CodeBlock>
                    </Tab>
