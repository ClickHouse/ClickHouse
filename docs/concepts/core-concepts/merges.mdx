...
**④ Compression & Storage**: The new column files and index are [compressed](/reference/statements/create/table/codec) and saved in a new [directory](/concepts/core-concepts/parts#what-are-table-parts-in-clickhouse) representing the merged data part.
