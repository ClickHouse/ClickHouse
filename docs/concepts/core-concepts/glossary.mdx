...
export const glossaryMetadata = {
  ...
  mutation: { aliases: ['ALTER UPDATE', 'ALTER DELETE', 'row update'], learnMore: '/concepts/best-practices/avoid-mutations' },
  ...
  'refreshable-materialized-view': { aliases: ['scheduled materialized view', 'refresh materialized view'], learnMore: '/materialized-view/refreshable-materialized-view' },
  replacingmergetree: { aliases: ['upsert', 'deduplication', 'still have duplicates'], code: true, learnMore: '/guides/replacing-merge-tree' },
  'secondary-index': { learnMore: '/optimize/skipping-indexes' },
  'skipping-index': { learnMore: '/optimize/skipping-indexes' },
  'sorting-key': { aliases: ['ORDER BY', 'primary key', 'on-disk order'], learnMore: '/concepts/best-practices/choosing-a-primary-key' },
  ...
  ttl: { aliases: ['expiration', 'retention'], code: true, learnMore: '/concepts/features/operations/delete/ttl' },
  update: { learnMore: '/updating-data/overview' },
  upsert: { aliases: ['ON CONFLICT', 'insert or update'], learnMore: '/guides/replacing-merge-tree' },
  warehouse: { aliases: ['compute-compute separation', 'shared storage', 'workload isolation'], learnMore: '/cloud/reference/warehouses' },
}
