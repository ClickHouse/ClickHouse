...
Like the [color coding modes](/concepts/features/interfaces/web-ui-color-coding) and the [pinned columns](/concepts/features/interfaces/web-ui-pinned-columns), the shape belongs to the result it shapes: to the query tab, and within a tab that is a [notebook](/concepts/features/interfaces/web-ui-notebook) to the individual cell. Sorting or filtering one result therefore neither changes nor re-runs another tab's or another cell's result — shaping a cell's result re-runs that cell.
