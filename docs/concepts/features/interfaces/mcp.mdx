...
The [ClickHouse MCP server](https://github.com/ClickHouse/mcp-clickhouse) exposes tools that let an AI assistant interact with ClickHouse:

- `run_query` executes SQL queries against a ClickHouse cluster.
- `list_databases` lists the available databases.
