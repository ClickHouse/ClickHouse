...
| `--ignore-error`                | Do not stop at a query that failed: report the error on `stderr` and continue with the next query. Because the errors are ignored, the process exits with a success code even when some of the queries failed. Only applicable in batch mode.                                                                                                                                                                                                                                                      |
