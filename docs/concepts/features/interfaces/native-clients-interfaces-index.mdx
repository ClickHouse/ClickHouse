...
<CardGroup cols={2}>
  ...
  <Card title="Model Context Protocol (MCP)" icon="/images/mcp.svg" href="/concepts/features/interfaces/mcp">
    Connect AI assistants to ClickHouse through a standardized interface.
  </Card>
  ...
  <Card title="C++ Client Library" icon="code" href="/integrations/language-clients/cpp">
