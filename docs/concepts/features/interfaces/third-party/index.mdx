...
<Note>
Generic tools that support common API like [ODBC](/concepts/features/interfaces/odbc) or [JDBC](/integrations/language-clients/java/jdbc) usually can work with ClickHouse as well, but are not listed here because there are way too many of them.
</Note>
