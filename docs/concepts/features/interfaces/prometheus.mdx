...
The ClickHouse formatter removes comments and normalizes the expression using the native PromQL query tree. For example, durations are represented in seconds: `[5m]` becomes `[300]`.
