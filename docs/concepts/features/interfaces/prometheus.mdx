...
Enable the [`enable_time_series_table`](/reference/settings/session-settings#enable_time_series_table) setting for the user that creates and accesses the table:
