...
The bundled ClickStack UI is useful for local debugging and quick investigation, but isn't meant for production environments. For the production-ready, full-featured offering, see [Open Source ClickStack](/clickstack/getting-started/oss).
</Info>
