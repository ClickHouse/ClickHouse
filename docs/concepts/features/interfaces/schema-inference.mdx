...
There is a special setting [use_structure_from_insertion_table_in_table_functions](/reference/settings/session-settings/use#use_structure_from_insertion_table_in_table_functions)
...
Note: Parsing datetimes during schema inference respect setting [date_time_input_format](/reference/settings/formats/date-time#date_time_input_format)
...
| `Struct`                             | [Tuple](/reference/data-types/tuple)           |
| `Map`                                | [Map](/reference/data-types/map)               |
| `Union`                              | [Variant](/reference/data-types/variant)       |
