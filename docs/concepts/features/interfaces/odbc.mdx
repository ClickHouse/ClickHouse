...
**[cast_keep_nullable](/reference/settings/session-settings/cast#cast_keep_nullable)**
...
**[prefer_column_name_to_alias](/reference/settings/session-settings/prefer#prefer_column_name_to_alias)**
