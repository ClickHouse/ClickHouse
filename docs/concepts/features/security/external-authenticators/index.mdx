...
- HTTP [Authenticator](/concepts/features/security/external-authenticators/http) and [Directory](/concepts/features/security/external-authenticators/http#http-external-user-directory)
