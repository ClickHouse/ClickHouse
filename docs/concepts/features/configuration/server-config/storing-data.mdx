...
- Native GCS disks do not support static `access_token`, `google_adc_*` refresh-token credentials, or `access_header`; use Application Default Credentials or a service-account key instead.
