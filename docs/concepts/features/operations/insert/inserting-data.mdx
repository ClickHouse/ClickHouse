...
<Steps>
<Step title="Download the CSV" id="download-csv">
...
<Step title="Create the table" id="create-table">
...
<Step title="Insert the data from the command line" id="insert-data-via-cmd">
...
<Step title="inserting data via command line with curl" id="insert-using-curl">
