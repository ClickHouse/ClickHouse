...
- [enable_writes_to_query_cache_disk](/reference/settings/session-settings/enable#enable_writes_to_query_cache_disk) controls whether query results are
  written to the disk cache (in addition to the in-memory cache).
- [enable_reads_from_query_cache_disk](/reference/settings/session-settings/enable#enable_reads_from_query_cache_disk) controls whether the server may
