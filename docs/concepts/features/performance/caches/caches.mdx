...
- Partial aggregate cache (experimental). Enable with `use_partial_aggregate_cache`. Clear with [`SYSTEM CLEAR AGGREGATE CACHE`](/sql-reference/statements/system#drop-aggregate-cache).
- Format schema cache.
