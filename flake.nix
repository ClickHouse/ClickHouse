{
  inputs = {
    ...
    contrib-c-ares = { url = "github:c-ares/c-ares/6360e96b5cf8e5980c887ce58ef727e53d77243a"; flake = false; };
    ...
    contrib-curl = { url = "github:curl/curl/57495c64871d18905a0941db9196ef90bafe9a29"; flake = false; };
    ...
    contrib-libarchive = { url = "github:libarchive/libarchive/313aa1fa10b657de791e3202c168a6c833bc3543"; flake = false; };
    ...
    contrib-rust_vendor = { url = "github:ClickHouse/rust_vendor/8ebeb41f6a94c8d220e3a82b067a47841dbb2470"; flake = false; };
