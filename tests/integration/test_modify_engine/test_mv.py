...
def convert_tables():
    q(ch1, "ALTER TABLE hourly_data MODIFY ENGINE TO REPLICATED")
    q(ch1, "ALTER TABLE monthly_aggregated_data MODIFY ENGINE TO REPLICATED")
