...
node1 = cluster.add_instance(
    "node1", main_configs=["configs/background_pool_config.xml"], with_foundationdb=True
)
node2 = cluster.add_instance(
    "node2", main_configs=["configs/background_pool_config.xml"], with_foundationdb=True
)
