...
def test_cmd_mntr_leader_failover_metrics(started_cluster):
    old_leader = None
    try:
        wait_nodes()
        ...
        # Kill the leader to force a real no-leader window and re-election.
        ...
        for _ in range(60):
            try:
                ...
                time.sleep(1)
        assert new_leader is not None, "No new leader was elected after the old leader was killed"
