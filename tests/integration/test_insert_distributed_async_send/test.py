...
# n1 -- distributed_async_insert_batch=1
n1 = cluster.add_instance(
    "n1",
    main_configs=["configs/remote_servers.xml"],
    user_configs=["configs/users.d/batch.xml"],
)
# n2 -- distributed_async_insert_batch=0
...
# n3 -- distributed_async_insert_batch=1/distributed_async_insert_split_batch_on_failure=1
...
# n4 -- distributed_async_insert_batch=0/distributed_async_insert_split_batch_on_failure=1
