...
node1 = cluster.add_instance(
    "node1", main_configs=["configs/s3.xml"], with_minio=True, with_foundationdb=True
)
node2 = cluster.add_instance(
    "node2", main_configs=["configs/s3.xml"], with_minio=True, with_foundationdb=True
)
node3 = cluster.add_instance(
    "node3", main_configs=["configs/s3.xml"], with_minio=True, with_foundationdb=True
)
