...
def test_function_over_time():
    ...
    # max_over_time: the largest sample in each window (windows per grid point: (75,120] -> {1,1},
    # (90,135] -> {1,1,3}, (105,150] -> {1,1,3,4}, (120,165] -> {3,4}, (135,180] -> {4},
    # (150,195] -> {5}, (165,210] -> {5,5,8}). The metric name is dropped, unlike last_over_time.
    do_query_test(
    ...
    # avg_over_time over the same windows.
    do_query_test(
    ...
    # count_over_time and sum_over_time over the same windows.
    do_query_test(
