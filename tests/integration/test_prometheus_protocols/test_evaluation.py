...
def test_function_over_time():
    ...
    do_query_test(
        ...
        # | E   AssertionError: query: idelta(test[45s])[120s:15s]
    ...
    do_query_test(
        ...
        # FIXME: Results are different!
        # | E   AssertionError: query: irate(test[45s])[120s:15s]
    ...
    do_query_test(
        ...
        # FIXME: Results are different!
        # | E   AssertionError: query: delta(test[45s])[120s:15s]
    ...
    do_query_test(
        ...
        # FIXME: Results are different!
        # | E   AssertionError: query: rate(test[45s])[120s:15s]
    ...
    do_query_test(
        ...
        # FIXME: Results are different!
        # | E   AssertionError: query: idelta(test[35s])[120s:15s]
        # | E   assert '{"resultType...210, "3"]]}]}' == '{"resultType...210, "3"]]}]}'
        # | E
