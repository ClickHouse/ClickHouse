...
def test_function_over_time():
    ...
    # *_over_time family (same subquery grid as above): exercises timeSeries*OverTimeToGrid via PromQL / prometheusQuery().
    do_query_test(
        "avg_over_time(test[45s])[120s:15s]",
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "1"], [135, "1.6666666666666667"], [150, "2.25"], [165, "2.6666666666666665"], [180, "4"], [195, "5"], [210, "6"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',1),('1970-01-01 00:02:15.000',1.6666666666666667),('1970-01-01 00:02:30.000',2.25),('1970-01-01 00:02:45.000',2.6666666666666665),('1970-01-01 00:03:00.000',4),('1970-01-01 00:03:15.000',5),('1970-01-01 00:03:30.000',6)]",
            ]
        ],
        eps=1e-11,
    )
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "1"], [135, "1"], [150, "1"], [165, "1"], [180, "4"], [195, "5"], [210, "5"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',1),('1970-01-01 00:02:15.000',1),('1970-01-01 00:02:30.000',1),('1970-01-01 00:02:45.000',1),('1970-01-01 00:03:00.000',4),('1970-01-01 00:03:15.000',5),('1970-01-01 00:03:30.000',5)]",
            ]
        ],
    )
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "2"], [135, "5"], [150, "9"], [165, "8"], [180, "4"], [195, "5"], [210, "18"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',2),('1970-01-01 00:02:15.000',5),('1970-01-01 00:02:30.000',9),('1970-01-01 00:02:45.000',8),('1970-01-01 00:03:00.000',4),('1970-01-01 00:03:15.000',5),('1970-01-01 00:03:30.000',18)]",
            ]
        ],
    )
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "2"], [135, "3"], [150, "4"], [165, "3"], [180, "1"], [195, "1"], [210, "3"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',2),('1970-01-01 00:02:15.000',3),('1970-01-01 00:02:30.000',4),('1970-01-01 00:02:45.000',3),('1970-01-01 00:03:00.000',1),('1970-01-01 00:03:15.000',1),('1970-01-01 00:03:30.000',3)]",
            ]
        ],
    )
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "0"], [135, "0.9428090415820631"], [150, "1.299038105676658"], [165, "1.247219128924647"], [180, "0"], [195, "0"], [210, "1.4142135623730951"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',0),('1970-01-01 00:02:15.000',0.9428090415820631),('1970-01-01 00:02:30.000',1.299038105676658),('1970-01-01 00:02:45.000',1.247219128924647),('1970-01-01 00:03:00.000',0),('1970-01-01 00:03:15.000',0),('1970-01-01 00:03:30.000',1.4142135623730951)]",
            ]
        ],
        eps=1e-11,
    )
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "0"], [135, "0.8888888888888884"], [150, "1.6875"], [165, "1.5555555555555554"], [180, "0"], [195, "0"], [210, "2"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',0),('1970-01-01 00:02:15.000',0.8888888888888884),('1970-01-01 00:02:30.000',1.6875),('1970-01-01 00:02:45.000',1.5555555555555554),('1970-01-01 00:03:00.000',0),('1970-01-01 00:03:15.000',0),('1970-01-01 00:03:30.000',2)]",
            ]
        ],
        eps=1e-11,
    )
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "1"], [135, "1"], [150, "1"], [165, "1"], [180, "1"], [195, "1"], [210, "1"]]}]}',
        [
            [
                "[('__name__','test')]",
    ...
    # `absent_over_time` is not asserted here: PromQL returns an empty vector whenever the inner
    # range has any samples (unlike `present_over_time` which is per-series 0/1 on the grid).
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "110"], [135, "110"], [150, "110"], [165, "120"], [180, "140"], [195, "190"], [210, "190"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',110),('1970-01-01 00:02:15.000',110),('1970-01-01 00:02:30.000',110),('1970-01-01 00:02:45.000',120),('1970-01-01 00:03:00.000',140),('1970-01-01 00:03:15.000',190),('1970-01-01 00:03:30.000',190)]",
            ]
        ],
    )
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "120"], [135, "130"], [150, "140"], [165, "140"], [180, "140"], [195, "190"], [210, "210"]]}]}',
        [
            [
                "[('__name__','test')]",
    ...
    do_query_test(
        "ts_of_max_over_time(test[45s])[120s:15s]",
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "110"], [135, "130"], [150, "140"], [165, "140"], [180, "140"], [195, "190"], [210, "210"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',110),('1970-01-01 00:02:15.000',130),('1970-01-01 00:02:30.000',140),('1970-01-01 00:02:45.000',140),('1970-01-01 00:03:00.000',140),('1970-01-01 00:03:15.000',190),('1970-01-01 00:03:30.000',210)]",
            ]
        ],
    )
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "1"], [135, "1"], [150, "2"], [165, "3"], [180, "4"], [195, "5"], [210, "5"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',1),('1970-01-01 00:02:15.000',1),('1970-01-01 00:02:30.000',2),('1970-01-01 00:02:45.000',3),('1970-01-01 00:03:00.000',4),('1970-01-01 00:03:15.000',5),('1970-01-01 00:03:30.000',5)]",
            ]
        ],
        eps=1e-11,
    )
    ...
    do_query_test(
        "quantile_over_time(0.9, test[45s])[120s:15s]",
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "1"], [135, "2.6000000000000005"], [150, "3.7"], [165, "3.8"], [180, "4"], [195, "5"], [210, "7.4"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',1),('1970-01-01 00:02:15.000',2.6000000000000005),('1970-01-01 00:02:30.000',3.7),('1970-01-01 00:02:45.000',3.8),('1970-01-01 00:03:00.000',4),('1970-01-01 00:03:15.000',5),('1970-01-01 00:03:30.000',7.4)]",
            ]
        ],
        eps=1e-11,
    )
    ...
    do_query_test(
        "mad_over_time(test[45s])[120s:15s]",
        210,
        '{"resultType": "matrix", "result": [{"metric": {"__name__": "test"}, "values": [[120, "0"], [135, "0"], [150, "1"], [165, "1"], [180, "0"], [195, "0"], [210, "0"]]}]}',
        [
            [
                "[('__name__','test')]",
                "[('1970-01-01 00:02:00.000',0),('1970-01-01 00:02:15.000',0),('1970-01-01 00:02:30.000',1),('1970-01-01 00:02:45.000',1),('1970-01-01 00:03:00.000',0),('1970-01-01 00:03:15.000',0),('1970-01-01 00:03:30.000',0)]",
            ]
        ],
    )
