...
def test_function_over_time():
    ...
    do_query_test(
        ...
        210,
        '{"resultType": "matrix", "result": [{"metric": {}, "values": [[120, "1"], [135, "9.166666666666666"], [150, "11.6"], [165, "12.5"], [210, "16.5"]]}]}',
        [
            [
                "[]",
                "[('1970-01-01 00:02:00.000',1),('1970-01-01 00:02:15.000',9.166666666666666),('1970-01-01 00:02:30.000',11.6),('1970-01-01 00:02:45.000',12.5),('1970-01-01 00:03:30.000',16.5)]",
            ]
        ],
        eps=1e-9,
    )
