...
# This script must be called manually after updating contrib/prometheus-protobufs proto files
...
WRITE_V2_PROTO = "prompb/io/prometheus/write/v2/types.proto"
...
PB2_FILENAMES = [
    "prompb/remote_pb2.py",
    "prompb/types_pb2.py",
    "prompb/io/prometheus/write/v2/types_pb2.py",
    "gogoproto/gogo_pb2.py",
]
...
def generate_pb2():
    ...
    cmd = [
        ...
        os.path.join(PROTO_DIR, WRITE_V2_PROTO),
