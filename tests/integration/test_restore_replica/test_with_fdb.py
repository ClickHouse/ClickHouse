...
node_1 = cluster.add_instance("replica1", with_foundationdb=True, main_configs=configs)
node_2 = cluster.add_instance("replica2", with_foundationdb=True, main_configs=configs)
node_3 = cluster.add_instance("replica3", with_foundationdb=True, main_configs=configs)
