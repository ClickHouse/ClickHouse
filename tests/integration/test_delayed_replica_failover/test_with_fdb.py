...
node_1_2 = cluster.add_instance("node_1_2", with_foundationdb=True)
node_2_1 = cluster.add_instance("node_2_1", with_foundationdb=True)
node_2_2 = cluster.add_instance("node_2_2", with_foundationdb=True)
...
"""
        ...
        pm.drop_instance_zk_connections(node_1_2, port=4501)
        pm.drop_instance_zk_connections(node_2_2, port=4501)
