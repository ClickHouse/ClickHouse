...
def test_max_bytes_ratio_before_external_group_by(node):
    ...
    settings = {
        ...
        # which would cause OOM in this test. Disable sharded aggregation for now. Once
        # after testing, sharded aggregation is turned off by default, remove this setting.
