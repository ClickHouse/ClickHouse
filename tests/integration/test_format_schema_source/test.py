...
def test_protobuf_format_input_with_old_setting(started_cluster):
    ...
    with pytest.raises(Exception) as exc:
        instance.http_query(
            "INSERT INTO test.simple SETTINGS format_schema='simple:KeyValuePair' required_message_name='KeyValuePair' FORMAT Protobuf",
            "\x07\x08\x01\x12\x03abc\x07\x08\x02\x12\x03def",
        )

    with pytest.raises(Exception) as exc:
        instance.http_query(
            "INSERT INTO test.simple SETTINGS format_schema='simple:KeyValuePair' required_message_name='Tmp' FORMAT Protobuf",
            "\x07\x08\x01\x12\x03abc\x07\x08\x02\x12\x03def",
        )
    with pytest.raises(Exception) as exc:
        instance.http_query(
            "INSERT INTO test.simple SETTINGS format_schema='simple:' required_message_name='Tmp' FORMAT Protobuf",
            "\x07\x08\x01\x12\x03abc\x07\x08\x02\x12\x03def",
        )
...
"""
    ...
    instance.http_query(
        f"INSERT INTO test.simple SETTINGS format_schema_source='{format_schema_source}', format_schema='{format_schema}', required_message_name='KeyValuePair' FORMAT Protobuf",
        "\x07\x08\x01\x12\x03abc\x07\x08\x02\x12\x03def",
    )
    assert instance.query("SELECT * from test.simple") == "1\tabc\n2\tdef\n"
...
"""
    ...
    assert (
        instance.http_query(
            f"SELECT * FROM test.simple SETTINGS format_schema_source='{format_schema_source}', format_schema='{format_schema}', required_message_name='KeyValuePair' FORMAT Protobuf"
        )
        == "\x07\x08\x01\x12\x03abc\x07\x08\x02\x12\x03def"
    )
...
"""
    ...
    assert (
        instance.http_query(
            f"SELECT * FROM test.simple SETTINGS format_schema_source='query', format_schema='{format_schema}', required_message_name='KeyValuePair' FORMAT Protobuf"
        )
        == "\x07\x08\x01\x12\x03abc\x07\x08\x02\x12\x03def"
    )
...
"""
    ...
    with pytest.raises(Exception) as exc:
        instance.http_query(
            f"SELECT * FROM test.simple SETTINGS format_schema_source='query', format_schema='{format_schema}', required_message_name='MessageTmp' FORMAT Protobuf"
        )
...
"""
    ...
    assert (
        instance.http_query(
            f"SELECT * FROM test.simple SETTINGS format_schema_source='{format_schema_source}', format_schema='{format_schema}', required_message_name='MessageTmp' FORMAT Protobuf"
        )
        == "\x07\x08\x01\x12\x03abc\x07\x08\x02\x12\x03def"
    )
...
"""
    ...
    assert (
        instance.http_query(
            f"SELECT * FROM test.new_simple SETTINGS format_schema_source='{format_schema_source}', format_schema='{new_format_schema}', required_message_name='MessageTmp' FORMAT Protobuf"
        )
        == "\x07\x08\x01\x12\x03abc\x07\x08\x02\x12\x03def"
    )
    ...
    with pytest.raises(Exception) as exc:
        instance.http_query(
            "SELECT * FROM test.simple SETTINGS format_schema_source='{format_schema_source}', format_schema='{new_format_schema}', required_message_name='MessageTmp' FORMAT Protobuf"
    )
...
"""
    ...
    assert instance.http_query(
        f"SELECT * FROM test.simple FORMAT CapnProto SETTINGS format_schema_source='{format_schema_source}', format_schema='{format_schema}', required_message_name='MessageTmp'"
    ) == instance.query(
...
"""
    ...
    # Tets works with new scheme
    assert instance.http_query(
        f"SELECT * FROM test.new_simple FORMAT CapnProto SETTINGS format_schema_source='{format_schema_source}', format_schema='{new_format_schema}', required_message_name='MessageTmp'"
    ) == instance.query(
    ...
    with pytest.raises(Exception) as exc:
        instance.http_query(
            f"SELECT * FROM test.simple FORMAT CapnProto SETTINGS format_schema_source='{format_schema_source}', format_schema='{new_format_schema}', required_message_name='MessageTmp'"
        )
    assert (
