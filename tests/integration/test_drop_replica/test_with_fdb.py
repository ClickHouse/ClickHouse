...
node_1_1 = cluster.add_instance(
    "node_1_1", with_foundationdb=True, main_configs=["configs/remote_servers.xml"]
)
node_1_2 = cluster.add_instance(
    "node_1_2", with_foundationdb=True, main_configs=["configs/remote_servers.xml"]
)
node_1_3 = cluster.add_instance(
    "node_1_3", with_foundationdb=True, main_configs=["configs/remote_servers.xml"]
)
