...
def check_query(clickhouse_node, query, result_set, retry_count=3, interval_seconds=1):
    lastest_result = ''
...
def drop_table_with_materialize_mysql_database(clickhouse_node, mysql_node):
    ...
    # create mapping
    clickhouse_node.query("CREATE DATABASE test_database ENGINE = MaterializeMySQL('mysql5_7:3306', 'test_database', 'root', 'clickhouse')")
