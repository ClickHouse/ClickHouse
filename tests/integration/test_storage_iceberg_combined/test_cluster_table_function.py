...
def test_cluster_table_function(spark_only, format_version, storage_type):
...
def test_writes_cluster_table_function(spark_only, format_version, storage_type):
...
def test_cluster_table_function_split_by_row_groups(spark_only, format_version, storage_type, cluster_table_function_buckets_batch_size):
    started_cluster_iceberg_with_spark = spark_only.cluster
    instance = started_cluster_iceberg_with_spark.instances["node1"]
    spark = started_cluster_iceberg_with_spark.spark_session
...
def test_empty_parquet_file(spark_only, storage_type):
    started_cluster_iceberg_with_spark = spark_only.cluster
    instance = started_cluster_iceberg_with_spark.instances["node1"]
    spark = started_cluster_iceberg_with_spark.spark_session
    format_version = '2'
