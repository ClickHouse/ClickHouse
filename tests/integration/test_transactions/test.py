...
def replace_txn_text(output: str, replace_map):
    for k, v in replace_map.items():
        ...
        # output = output.replace(tid0, "tid0")
        # output = output.replace(tid1, "tid1").replace("csn" + csn1 + "_", "csn_1")
        # output = output.replace(tid2, "tid2").replace("csn" + csn2 + "_", "csn_2")
        # output = output.replace(tid3, "tid3")
        # output = output.replace(tid5, "tid5")
        # output = output.replace(tid6, "tid6").replace("csn" + csn6 + "_", "csn_6")
    return output
