...
node1 = cluster.add_instance(
    "node1", main_configs=["configs/remote_servers.xml"], with_foundationdb=True
)
node2 = cluster.add_instance(
    "node2", main_configs=["configs/remote_servers.xml"], with_foundationdb=True
)
...
node3 = cluster.add_instance(
    "node3", main_configs=["configs/remote_servers.xml"], with_foundationdb=True
)
node4 = cluster.add_instance(
    "node4", main_configs=["configs/remote_servers.xml"], with_foundationdb=True
)
...
def test_drop_failover(drop_failover):
    ...
    with PartitionManager() as pm:
        ...
        pm.partition_instances(node3, node4, port=4501)
...
node5 = cluster.add_instance(
    "node5", main_configs=["configs/remote_servers.xml"], with_foundationdb=True
)
node6 = cluster.add_instance(
    "node6", main_configs=["configs/remote_servers.xml"], with_foundationdb=True
)
...
def test_replace_after_replace_failover(replace_after_replace_failover):
    ...
    with PartitionManager() as pm:
        # Hinder replication between replicas
        pm.partition_instances(node5, node6, port=4501)
