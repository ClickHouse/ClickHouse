...
ch1 = cluster.add_instance(
    "ch1", main_configs=["configs/config.d/clusters.xml"], with_foundationdb=True
)
ch2 = cluster.add_instance(
    "ch2", main_configs=["configs/config.d/clusters.xml"], with_foundationdb=True
)
ch3 = cluster.add_instance(
    "ch3", main_configs=["configs/config.d/clusters.xml"], with_foundationdb=True
)
