...
class ClickHouseCluster:
    ...
    def __init__(
        ...
        self.arrowflight_host = "arrowflight"
    ...
    def start(self):
        ...
        try:
            ...
            if self.with_arrowflight and not self.base_arrowflight_cmd:
                logging.error('NO ARROR FLIGHT CMD!!!!jf0esijofjodsifijosdfiohapbihfuadsphiofphioadsfhipoadshpiofasdiphofihaodsfihasdhiofadshiofihos')
            if self.with_arrowflight and self.base_arrowflight_cmd:
                logging.error(f'RUNNING!!!!!!!23232: {self.base_arrowflight_cmd}')
                run_and_check(self.base_arrowflight_cmd + common_opts)
                
                logging.error(f'RUNNED!!!!')
                self.wait_arrowflight_to_start()
                logging.error(f'RUNNED_TOTAL!!!!')
