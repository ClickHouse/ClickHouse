...
class ClickHouseCluster:
    ...
    def start(self):
        ...
        try:
            ...
            common_opts = ["--verbose", "up", "-d", "--remove-orphans"]
            ...
            if self.with_cassandra and self.base_cassandra_cmd:
                subprocess_check_call(self.base_cassandra_cmd + ["up", "-d", "--remove-orphans"])
                self.up_called = True
            ...
            if self.with_jdbc_bridge and self.base_jdbc_bridge_cmd:
                ...
                subprocess_check_call(self.base_jdbc_bridge_cmd + ["up", "-d", "--remove-orphans"])
                self.up_called = True
