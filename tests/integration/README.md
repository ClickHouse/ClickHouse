...
* `CLICKHOUSE_TESTS_CONFIG_DIR` to choose the directory with test configs
...
It is recommended to use default server configuration and explicitly add parts that differ from default one — do not change base config directory in your test.