...
n1 = cluster.add_instance("n1", main_configs=["configs/remote_servers.xml"], user_configs=["configs/users.xml"])
n2 = cluster.add_instance("n2", main_configs=["configs/remote_servers.xml"], user_configs=["configs/users.xml"])
n3 = cluster.add_instance("n3", main_configs=["configs/remote_servers.xml"], user_configs=["configs/users.xml"])
