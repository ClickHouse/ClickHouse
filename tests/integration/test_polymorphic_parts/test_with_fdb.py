...
node5 = cluster.add_instance(
    "node5", main_configs=["configs/compact_parts.xml"], with_foundationdb=True
)
node6 = cluster.add_instance(
    "node6", main_configs=["configs/compact_parts.xml"], with_foundationdb=True
)

node9 = cluster.add_instance("node9", with_foundationdb=True, stay_alive=True)
node10 = cluster.add_instance("node10", with_foundationdb=True)
