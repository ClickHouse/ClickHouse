...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("'minio','ClickHouse_Minio_P@ssw0rd',", True, "auto", id="auth_positive"),
...
def test_get_file_with_special(started_cluster, special):
    ...
    auth = "'minio','ClickHouse_Minio_P@ssw0rd',"
...
@pytest.mark.parametrize("auth", [pytest.param("'minio','ClickHouse_Minio_P@ssw0rd',", id="minio")])
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("'minio','ClickHouse_Minio_P@ssw0rd',", True, id="auth_positive"),
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("", True, id="positive"),
        pytest.param("'wrongid','wrongkey'", False, id="negative"),
        # ("'minio','ClickHouse_Minio_P@ssw0rd',",True), Redirect with credentials not working with nginx.
    ],
)
...
def test_insert_with_path_with_globs(started_cluster):
    ...
    table_function_3 = f"s3('http://minio1:9001/root/test_parquet*', 'minio', 'ClickHouse_Minio_P@ssw0rd', 'Parquet', 'a Int32, b String')"
...
def test_signatures(started_cluster):
    ...
    result = instance.query(
        f"select * from s3('http://{started_cluster.minio_host}:{started_cluster.minio_port}/{bucket}/test.arrow', 'minio', 'ClickHouse_Minio_P@ssw0rd')"
    )
    assert int(result) == 1

    error = instance.query_and_get_error(
        f"select * from s3('http://{started_cluster.minio_host}:{started_cluster.minio_port}/{bucket}/test.arrow', 'minio', 'ClickHouse_Minio_P@ssw0rd', '{session_token}')"
    )
    ...
    result = instance.query(
        f"select * from s3('http://{started_cluster.minio_host}:{started_cluster.minio_port}/{bucket}/test.arrow', 'minio', 'ClickHouse_Minio_P@ssw0rd', 'Arrow')"
    )
    assert int(result) == 1

    error = instance.query_and_get_error(
        f"select * from s3('http://{started_cluster.minio_host}:{started_cluster.minio_port}/{bucket}/test.arrow', 'minio', 'ClickHouse_Minio_P@ssw0rd', '{session_token}', 'Arrow')"
    )
    assert "S3_ERROR" in error

    error = instance.query_and_get_error(
        f"select * from s3('http://{started_cluster.minio_host}:{started_cluster.minio_port}/{bucket}/test.arrow', 'minio', 'ClickHouse_Minio_P@ssw0rd', '{session_token}', 'Arrow', 'x UInt64')"
    )
    assert "S3_ERROR" in error

    error = instance.query_and_get_error(
        f"select * from s3('http://{started_cluster.minio_host}:{started_cluster.minio_port}/{bucket}/test.arrow', 'minio', 'ClickHouse_Minio_P@ssw0rd', '{session_token}', 'Arrow', 'x UInt64', 'auto')"
    )
    assert "S3_ERROR" in error
