...
def test_error_message_includes_credential_sources(started_cluster):
    """Test that authentication errors include hints about possible credential sources."""
    instance = started_cluster.instances["s3_with_invalid_environment_credentials"]
    ...
    # Since the test instance has AWS_ACCESS_KEY_ID set, it should be mentioned
    assert "environment variables (AWS_ACCESS_KEY_ID)" in error_message
