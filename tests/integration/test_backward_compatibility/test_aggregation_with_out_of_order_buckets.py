...
node1 = cluster.add_instance("node1", main_configs=["configs/clusters.xml", "configs/no_serialize_string_with_size_stream.xml"], with_zookeeper=True, use_old_analyzer=False, macros={"replica": "node1", "shard": "shard"})
node2 = cluster.add_instance("node2", main_configs=["configs/clusters.xml", "configs/no_serialize_string_with_size_stream.xml"], with_zookeeper=True, use_old_analyzer=False,  macros={"replica": "node2", "shard": "shard"})
