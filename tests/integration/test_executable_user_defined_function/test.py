...
def test_executable_function_parameter_python(started_cluster):
    ...
    assert node.query_and_get_error("SELECT test_function_parameter_python(2,2)(toUInt64(1))")
    ...
    assert node.query_and_get_error("SELECT test_function_parameter_python('test')(toUInt64(1))")
