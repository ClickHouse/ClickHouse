...
def test_attach_broken_parts(drop_detached_parts_table):
    ...
    instance.query("INSERT INTO t_attach_broken VALUES (4)")
    instance.query("INSERT INTO t_attach_broken VALUES (5)")
    ...
    instance.exec_in_container(
        [
            ...
            "{}/detached/broken-on-start_all_3_3_0".format(path),
        ]
    )
    instance.exec_in_container(
        [
            "mv",
            "{}/all_4_4_0/".format(path),
            "{}/detached/invalid-partition_12_4_4_0".format(path),
        ]
    )
    instance.exec_in_container(
        [
            "mv",
            "{}/all_5_5_0/".format(path),
            "{}/detached/invalid-part-name_all_1".format(path),
        ]
    )
    ...
    with pytest.raises(Exception) as e:
        instance.query(
            "ALTER TABLE t_attach_broken ATTACH PART 'broken-on-start_all_2_2_0' SETTINGS allow_attach_broken_part = 0"
        )
    ...
    with pytest.raises(Exception) as e:
        instance.query(
            "ALTER TABLE t_attach_broken ATTACH PART 'invalid-partition_12_4_4_0' SETTINGS allow_attach_broken_part = 1"
        )
    ...
    with pytest.raises(Exception) as e:
        instance.query(
            "ALTER TABLE t_attach_broken ATTACH PART 'invalid-part-name_all_1' SETTINGS allow_attach_broken_part = 1"
        )

    assert "BAD_DATA_PART_NAME" in str(e.value)

    instance.query(
        "ALTER TABLE t_attach_broken ATTACH PART 'broken-on-start_all_2_2_0' SETTINGS allow_attach_broken_part = 1"
    )

    instance.query(
        "ALTER TABLE t_attach_broken DROP DETACHED PART 'broken-on-start_all_3_3_0' SETTINGS allow_drop_detached = 1"
    )
    instance.query(
        "ALTER TABLE t_attach_broken DROP DETACHED PART 'invalid-partition_12_4_4_0' SETTINGS allow_drop_detached = 1"
    )
    instance.query(
        "ALTER TABLE t_attach_broken DROP DETACHED PART 'invalid-part-name_all_1' SETTINGS allow_drop_detached = 1"
    )

    assert instance.query("SELECT count(), sum(id) FROM t_attach_broken") == "2\t3\n"
