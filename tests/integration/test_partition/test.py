...
def partition_complex_assert_checksums(after_detach=False):
    ...
    if after_detach:
        checksums = (
            ...
            "2b9687de1fb828f3d02762bfb5f8fc73\tshadow/1/data/test/partition_complex/19700102_2_2_0/column_compression_codecs.txt\n"
            "2b9687de1fb828f3d02762bfb5f8fc73\tshadow/1/data/test/partition_complex/19700201_1_1_0/column_compression_codecs.txt\n"
