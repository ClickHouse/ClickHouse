...
def test_embedded_database_and_tables(started_cluster):
    ...
    node1.query("create database unity_test engine DataLakeCatalog('http://localhost:8080/api/2.1/unity-catalog') settings warehouse = 'unity', catalog_type='unity'", settings={"allow_experimental_database_unity_catalog": "1"})
...
def test_multiple_schemes_tables(started_cluster):
    ...
    node1.query("create database multi_schema_test engine DataLakeCatalog('http://localhost:8080/api/2.1/unity-catalog') settings warehouse = 'unity', catalog_type='unity'", settings={"allow_experimental_database_unity_catalog": "1"})
...
def test_complex_table_schema(started_cluster):
    ...
    node1.query("create database complex_schema engine DataLakeCatalog('http://localhost:8080/api/2.1/unity-catalog') settings warehouse = 'unity', catalog_type='unity'", settings={"allow_experimental_database_unity_catalog": "1"})
