...
def test_create_table():
    ...
    check_logs(
        must_contain=[
            ...
            generate_create_table_numbered("(`x` int) ENGINE = URL('https://[HIDDEN]@domain.com/path', 'CSV')"),
...
def test_create_database():
    ...
    check_logs(
        must_contain=[
            ...
            "CREATE DATABASE database5 ENGINE = URL('https://[HIDDEN]@localhost:11111/x/')",
        ],
        must_not_contain=[password],
    )
...
def test_table_functions():
    ...
    check_logs(
        must_contain=[
            ...
            "CREATE TABLE tablefunc48 (`x` int) AS url('https://[HIDDEN]@domain.com/path', 'CSV')",
