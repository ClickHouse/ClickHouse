...
# Common artifactrs required for jobs from particular CI run.
# It contains checked out compressed repo.
S3_ATRIFACTS_BUCKET = os.getenv("S3_ATRIFACTS_BUCKET", "clickhouse-artifacts")
