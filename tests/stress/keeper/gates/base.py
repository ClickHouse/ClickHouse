...
def _gate_sync_read_barrier(g, nodes, leader, ctx, summary):
    ...
    """
    print("[keeper][gate] sync_read_barrier: not yet implemented, skipping")
    return True
...
def _gate_linearizable_reads_ok(g, nodes, leader, ctx, summary):
    ...
    """
    print("[keeper][gate] linearizable_reads_ok: not yet implemented, skipping")
    return True
...
def _gate_acl_matrix_ok(g, nodes, leader, ctx, summary):
    ...
    """
    print("[keeper][gate] acl_matrix_ok: not yet implemented, skipping")
    return True
...
def _gate_acl_digest_rotate_ok(g, nodes, leader, ctx, summary):
    ...
    """
    print("[keeper][gate] acl_digest_rotate_ok: not yet implemented, skipping")
    return True
...
def _gate_lin_register_ok(g, nodes, leader, ctx, summary):
    ...
    """
    print("[keeper][gate] lin_register_ok: not yet implemented, skipping")
    return True
