...
class KeeperBench:
    ...
    def run(self):
        ...
        if clients_env:
            if self._is_zookeeper or self.replay_path:
                raise ValueError("KEEPER_BENCH_CLIENTS is not supported with the ZooKeeper backend or replay mode: both rewrite sessions/workers")
