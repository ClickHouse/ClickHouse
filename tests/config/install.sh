...
if [[ "$EXPORT_S3_STORAGE_POLICIES" == "1" ]]; then
    ...
    # allow_dynamic_cache_resize was added in 25.5; use_real_disk_size, keep_free_space_eviction_threads
    # and reserve_granularity in 26.7.
    ...
    check_clickhouse_version 26.7 || sed -i "s|<use_real_disk_size>1</use_real_disk_size>||" $DEST_SERVER_PATH/config.d/storage_conf.xml
