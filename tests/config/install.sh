...
ln -sf $SRC_PATH/config.d/jemalloc_global_profiler.yaml $DEST_SERVER_PATH/config.d/
...
ln -sf $SRC_PATH/users.d/jemalloc_query_profiler.yaml $DEST_SERVER_PATH/users.d/
