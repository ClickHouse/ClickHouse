...
ln -s /repo/ci/release/download_release_packages.py /usr/bin/download_release_packages
ln -s /repo/ci/release/get_previous_release_tag.py /usr/bin/get_previous_release_tag
