...
SETTINGS disk = disk(
    ...
    metadata_type = cas,
    cas_server_root_id = '${CLICKHOUSE_DATABASE}_04289',
    name = '${CLICKHOUSE_DATABASE}_04289_cas_multi_detach',
    path = '${CLICKHOUSE_DATABASE}_04289_cas_multi_detach_pool/');
...
SYSTEM CAS FORGET '${CLICKHOUSE_DATABASE}_04289_cas_multi_detach';
EOF
