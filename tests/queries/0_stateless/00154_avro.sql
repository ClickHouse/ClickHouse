...
-- test.hits lives on a cache-over-web disk; with the cache off every column read becomes a
-- remote round trip, which turns this test from under a second into minutes.
