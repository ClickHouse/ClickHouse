...
ALTER TABLE destination ATTACH PARTITION ID 'all' FROM source;
...
-- Attach without experimental setting, should not be allowed
DROP TABLE IF EXISTS source;
DROP TABLE IF EXISTS destination;
...
ALTER TABLE destination ATTACH PARTITION ID '20100302' FROM source; -- { serverError 36 }
