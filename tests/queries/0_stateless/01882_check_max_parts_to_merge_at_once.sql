...
FROM system.part_log WHERE event_date >= yesterday() AND event_time >= now() - 600 AND table = 'limited_merge_table' and database = currentDatabase() and event_type = 'MergeParts';
