...
FROM values('id UInt8, arr Array(Int32)', (1, []), (2, [1, 2]), (3, []), (4, [3]), (5, []))
ORDER BY id;
...
FROM values('id UInt8, arr Array(Float64)', (1, []), (2, [1, 2]), (3, []), (4, [3]), (5, []))
ORDER BY id;
...
FROM values('id UInt8, arr Array(Decimal32(2))', (1, []), (2, [1, 2]), (3, []), (4, [3]), (5, []))
ORDER BY id;
