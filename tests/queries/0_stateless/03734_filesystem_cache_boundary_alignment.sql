...
CREATE TABLE t0 (c0 Int, c1 String) ENGINE = IcebergS3(s3_conn, filename = currentDatabase() || '_test_03734_t0/', format = 'CSV');
CREATE TABLE t1 (c0 Int, c1 Array(String)) ENGINE = Distributed('test_shard_localhost', default, t0);

REPLACE TABLE t1 (c0 String, c1 Int) ENGINE = S3(s3_conn, filename = currentDatabase() || '_test_03734_t1/', format = 'CSV');
