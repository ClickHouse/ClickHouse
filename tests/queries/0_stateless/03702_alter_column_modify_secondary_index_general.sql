...
SELECT 'COMPACT', * from test_compact;
ALTER TABLE test_wide UPDATE b = 2 WHERE b = 1;
SELECT 'WIDE', * from test_wide;
...
-- Also, ALTER TABLE UPDATE must be possible without an exception
ALTER TABLE test_compact UPDATE b = 3 WHERE b = 2;
SELECT 'COMPACT', * from test_compact;
ALTER TABLE test_wide UPDATE b = 3 WHERE b = 2;
SELECT 'WIDE', * from test_wide;
...
ALTER TABLE test_compact UPDATE b = '4' WHERE b = '3';
SELECT 'COMPACT', * from test_compact;
ALTER TABLE test_wide UPDATE b = '4' WHERE b = '3';
SELECT 'WIDE', * from test_wide;
...
-- Check that ALTER TABLE UPDATE still works
ALTER TABLE test_compact UPDATE b = 5 WHERE b = 4;
SELECT 'COMPACT', * from test_compact;
ALTER TABLE test_wide UPDATE b = 5 WHERE b = 4;
SELECT 'WIDE', * from test_wide;
