...
-- With virtual rows the buffering is owned by VirtualRowReadAheadTransform regardless of
-- this setting; pin the test to the plain path where BufferChunks presence follows it.
