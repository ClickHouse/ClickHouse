...
insert into in_02231 select * from numbers(5e6) settings max_memory_usage='30Mi', max_threads=1, min_insert_block_size_rows = 10000, min_insert_block_size_bytes = '10Mi';
