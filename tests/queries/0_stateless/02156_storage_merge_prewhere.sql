...
SET allow_reorder_prewhere_conditions = 1; -- CI may inject False; prewhere conditions not reordered by statistics → equals(k,3) stays before notEmpty(v) instead of being reordered
