...
FROM numbers(128)
SETTINGS max_threads = 1, max_insert_threads = 1, max_block_size = 128,
...
SET use_query_cache = 0, log_queries = 1, log_profile_events = 1, log_queries_probability = 1,
...
-- Keep execution settings query-local so they do not affect the shared query-log scan.
SELECT k, count(), sum(value), uniqExact(value)
FROM dictionary_top_k_input
GROUP BY k ORDER BY k ASC LIMIT 1
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    max_streams_for_merge_tree_reading = 1, max_block_size = 1,
    ...
    log_comment = '05090_dictionary_top_k/ascending';
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    group_by_top_k_optimization_observation_rows = 0, exact_rows_before_limit = 0,
    use_skip_indexes_for_top_k = 0, use_top_k_dynamic_filtering = 0,
    log_comment = '05090_dictionary_top_k/descending';
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    group_by_top_k_optimization_observation_rows = 0, exact_rows_before_limit = 0,
    use_skip_indexes_for_top_k = 0, use_top_k_dynamic_filtering = 0,
    log_comment = '05090_dictionary_top_k/control';
