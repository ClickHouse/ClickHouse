...
SELECT toDecimalString('88'::UInt8, 78);
SELECT toDecimalString('646464'::Int256, 78);
SELECT toDecimalString('-128.789323123321329854641231237893231233213298546'::Decimal256(45), 78);
SELECT toDecimalString('88'::UInt8, 155); -- {serverError CANNOT_PRINT_FLOAT_OR_DOUBLE_NUMBER}
SELECT toDecimalString('646464'::Int256, 155); -- {serverError CANNOT_PRINT_FLOAT_OR_DOUBLE_NUMBER}
SELECT toDecimalString('-128.789323123321329854641231237893231233213298546'::Decimal256(45), 155); -- {serverError CANNOT_PRINT_FLOAT_OR_DOUBLE_NUMBER}
SELECT toDecimalString('1.0'::Decimal512(1), 155); -- {serverError CANNOT_PRINT_FLOAT_OR_DOUBLE_NUMBER}
SELECT toDecimalString('1.0'::Decimal512(1), 155); -- {serverError CANNOT_PRINT_FLOAT_OR_DOUBLE_NUMBER}
