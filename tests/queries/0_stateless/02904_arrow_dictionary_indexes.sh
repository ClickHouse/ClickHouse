...
# Arrow allows duplicate dictionary values; they dedup into LowCardinality on read.
$CLICKHOUSE_LOCAL -q "select * from file('$CUR_DIR/data_arrow/non_unique_dict.arrowstream')"
