...
for engine in "${ENGINES[@]}"; do
    ...
    $CLICKHOUSE_CLIENT --query "SELECT n, a1, a2, a3, t, mapSort(m) FROM subcolumns"
    $CLICKHOUSE_CLIENT --query "SELECT n, n.null, a1, a1.size0, a2, a2.size0, a2.size1, a2.size2, a3, a3.size0, a3.null, t, t.s, t.v, mapSort(m), arrayMap(x -> x.1, arraySort(arrayZip(m.keys, m.values))), arrayMap(x -> x.2, arraySort(arrayZip(m.keys, m.values))) FROM subcolumns"
done
