...
${CLICKHOUSE_CURL} -sS "${CLICKHOUSE_URL}&dialect=clickhouse_json&allow_experimental_json_ast_dialect=1" --data-binary "$CRAFTED_JOIN_JSON" 2>&1 | grep -o "BAD_ARGUMENTS" | head -n 1
...
${CLICKHOUSE_CURL} -sS "${CLICKHOUSE_URL}&dialect=clickhouse_json&allow_experimental_json_ast_dialect=1" --data-binary "$CRAFTED_EXPLAIN_JSON" 2>&1 | grep -o "BAD_ARGUMENTS" | head -n 1
...
${CLICKHOUSE_CURL} -sS "${CLICKHOUSE_URL}&dialect=clickhouse_json&allow_experimental_json_ast_dialect=1" --data-binary "$CRAFTED_DICT_JSON" 2>&1 | grep -o "BAD_ARGUMENTS" | head -n 1
...
${CLICKHOUSE_CURL} -sS "${CLICKHOUSE_URL}&dialect=clickhouse_json&allow_experimental_json_ast_dialect=1" --data-binary "$CRAFTED_WASM_JSON" 2>&1 | grep -o "BAD_ARGUMENTS" | head -n 1
...
${CLICKHOUSE_CURL} -sS "${CLICKHOUSE_URL}&dialect=clickhouse_json&allow_experimental_json_ast_dialect=1" --data-binary "$CRAFTED_WASM_TRUE_JSON" 2>&1 | grep -o "BAD_ARGUMENTS" | head -n 1
...
${CLICKHOUSE_CURL} -sS "${CLICKHOUSE_URL}&dialect=clickhouse_json&allow_experimental_json_ast_dialect=1" --data-binary "$CRAFTED_DICT_TRUE_JSON" 2>&1 | grep -o "BAD_ARGUMENTS" | head -n 1
...
${CLICKHOUSE_CURL} -sS "${CLICKHOUSE_URL}&dialect=clickhouse_json&allow_experimental_json_ast_dialect=1" --data-binary "$CRAFTED_EXPLAIN_TRUE_JSON" 2>&1 | grep -o "BAD_ARGUMENTS" | head -n 1
