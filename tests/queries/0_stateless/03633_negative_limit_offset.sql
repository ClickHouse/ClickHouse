...
SELECT number FROM numbers(100000) LIMIT -5 OFFSET -1000;
...
SELECT 'Misc';
SELECT DISTINCT number % 8 FROM numbers(120) ORDER BY number LIMIT -3 OFFSET -2;
SELECT DISTINCT number % 80 FROM numbers(120) ORDER BY number LIMIT -3 OFFSET 50;
...
SELECT DISTINCT number FROM numbers(20) LIMIT 18446744073709551615 OFFSET 18446744073709551615;
