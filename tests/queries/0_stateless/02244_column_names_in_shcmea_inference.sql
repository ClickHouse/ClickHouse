...
desc file(currentDatabase() || '_test_02244', 'TSV') settings column_names_for_schema_inference='x,y';
...
desc file(currentDatabase() || '_test_02244', 'CSV') settings column_names_for_schema_inference='x,y';
...
desc file(currentDatabase() || '_test_02244', 'JSONCompactEachRow') settings column_names_for_schema_inference='x,y';
...
desc file(currentDatabase() || '_test_02244', 'Values') settings column_names_for_schema_inference='x,y';
