...
SELECT * FROM using1 t1 ALL LEFT JOIN (SELECT *, c, d as b FROM using2) t2 USING (a, b) ORDER BY d;
SELECT * FROM using1 t1 ALL INNER JOIN (SELECT *, c, d as b FROM using2) t2 USING (a, b) ORDER BY d;
