...
select parseDateTime('42', '%f', 'UTC') = toDateTime('1970-01-01 00:00:00', 'UTC'); -- { serverError CANNOT_PARSE_DATETIME }
...
select parseDateTime64('2021-01-04 23:12:34.118'); -- { serverError CANNOT_PARSE_DATETIME }
...
select parseDateTime64('2021-01-04 23:12:34.118', '%Y-%m-%d %H:%i:%s.%f'); -- { serverError CANNOT_PARSE_DATETIME }
...
-- Test parseDataTime64 supports range between 0000 - 9999
select parseDateTime64('1899-12-31 23:59:59', '%Y-%m-%d %H:%i:%s') = toDateTime64('1899-12-31 23:59:59', 0);
...
select parseDateTime64('2300-01-01 00:00:00', '%Y-%m-%d %H:%i:%s') = toDateTime64('2300-01-01 00:00:00', 0);
select parseDateTime64('9999-12-31 23:59:59', '%Y-%m-%d %H:%i:%s') = toDateTime64('9999-12-31 23:59:59', 0);
