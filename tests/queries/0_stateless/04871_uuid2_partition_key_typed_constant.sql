...
ALTER TABLE t_uuid2_partition DROP PARTITION toUUID('61f0c404-5cb3-11e7-907b-a6006ad3dba0');
SELECT count() FROM t_uuid2_partition;

-- A typed UUID2 constant: already in the needed layout.
ALTER TABLE t_uuid2_partition DROP PARTITION toUUID2('992f6910-42b2-43cd-98bc-c812fbf9b683');
SELECT count() FROM t_uuid2_partition;
...
INSERT INTO t_uuid2_partition_str VALUES ('61f0c404-5cb3-11e7-907b-a6006ad3dba0');
