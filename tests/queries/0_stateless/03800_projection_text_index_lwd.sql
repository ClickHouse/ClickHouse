...
CREATE TABLE t_text_index_lwd (c0 FixedString(37), PROJECTION i0 INDEX c0 TYPE text(tokenizer = array())) ENGINE = MergeTree() ORDER BY tuple() SETTINGS lightweight_mutation_projection_mode = 'rebuild';
