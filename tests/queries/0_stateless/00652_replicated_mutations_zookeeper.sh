...
# Insert some data
${CLICKHOUSE_CLIENT} --keeper_fault_injection_probability=0 --query="INSERT INTO mutations_r1(d, x, s) VALUES \
    ('2000-01-01', 1, 'a')"
${CLICKHOUSE_CLIENT} --keeper_fault_injection_probability=0 --query="INSERT INTO mutations_r1(d, x, s) VALUES \
...
# Insert some data
${CLICKHOUSE_CLIENT} --keeper_fault_injection_probability=0 --query="INSERT INTO mutations_cleaner_r1(x) VALUES (1), (2), (3), (4), (5)"
