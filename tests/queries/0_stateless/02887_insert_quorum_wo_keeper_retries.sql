...
INSERT INTO quorum1 SETTINGS keeper_fault_injection_probability=0, keeper_max_retries=0 VALUES (1), (2), (3), (4), (5); -- {serverError UNKNOWN_STATUS_OF_INSERT}

-- If we allow retries, quorum should be rechecked when the replica recovers
system enable failpoint replicated_merge_tree_insert_quorum_fail_0;
INSERT INTO quorum1 SETTINGS keeper_fault_injection_probability=0, keeper_max_retries=1 VALUES (6), (7), (8), (9), (10);
