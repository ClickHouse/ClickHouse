...
DROP TABLE IF EXISTS big_04652;
...
CREATE TABLE big_04652 (k UInt64, v Int64) ENGINE = MergeTree ORDER BY k;
INSERT INTO big_04652 SELECT number, number FROM numbers(1000);
SELECT count(), count(r.jv), sum(r.jv) FROM big_04652 AS l ANY LEFT JOIN jt AS r USING (k);
