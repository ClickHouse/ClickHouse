...
SELECT id, count(),
    ...
    floor(avgMerge(decimal325Avg), 5),
    ...
    minMerge(int64Min),
    maxMerge(int64Max),
    floor(avgMerge(int64Avg), 5),
    sumMerge(int64Sum),
    minMerge(int32Min),
    maxMerge(int32Max),
    floor(avgMerge(int32Avg), 5),
    sumMerge(int32Sum),
    minMerge(int16Min),
    maxMerge(int16Max),
    floor(avgMerge(int16Avg), 5),
    sumMerge(int16Sum),
    minMerge(int8Min),
    maxMerge(int8Max),
    floor(avgMerge(int8Avg), 5),
    sumMerge(int8Sum)
