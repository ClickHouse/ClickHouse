...
-- why: column-ID corner cases -- metadata-only RENAME/DROP mechanics, rejected ALTERs, TTL.
-- Some sections assert on local part layout, hence no-object-storage / no-parallel-replicas.
-- Continues in 04048_column_ids_corner_cases_2; split to stay under the 180s per-test cap.
