...
cp $CUR_DIR/data_json/btc_transactions.json ${user_files_path}/
...
${CLICKHOUSE_CLIENT} -q "INSERT INTO btc SELECT * FROM file('btc_transactions.json', 'JSONAsObject')"
...
rm ${user_files_path}/btc_transactions.json
