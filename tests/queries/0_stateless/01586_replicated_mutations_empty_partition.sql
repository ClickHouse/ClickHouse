...
ENGINE = ReplicatedMergeTree('/01586_replicated_mutations_empty_partitions/{shard}', '{replica}')
ORDER BY key
PARTITION by key;
...
SELECT count() FROM system.zookeeper WHERE path = '/01586_replicated_mutations_empty_partitions/s1/block_numbers';
