...
{"id":1,"j":{"n":-9223372036854775808,"u":18446744073709551615,"f":-0.0,"flag":true,"dec":1.2300,"big_dec":10000000000000000.01,"day":"1970-01-02","dt":"1970-01-01 00:00:01.500000000","ip":"192.0.2.1","ip6":"2001:db8::1","uuid":"00000000-0000-0000-0000-000000000001","nf":-0.0,"lc":"low-one","items":[11,12],"arr":[1,2,3],"dyn_arr":[1,"one",true],"map_s":{"first":7,"second":7},"map_lc":{"first":70,"second":71},"tup":{"a":9,"b":"tuple-one"},"nullable":"present"}}
{"id":2,"j":{"n":42,"u":42,"f":1.5,"flag":false,"dec":2.3400,"big_dec":10000000000000000.02,"day":"1970-01-03","dt":"1970-01-01 00:00:02.500000000","ip":"192.0.2.2","ip6":"2001:db8::2","uuid":"00000000-0000-0000-0000-000000000002","nf":1.5,"lc":"low-two","items":[21],"arr":[3,4,5],"dyn_arr":[-2,"two",false],"map_s":{"first":8},"map_lc":{"first":80},"tup":{"a":10,"b":"tuple-two"},"nullable":null}}
...
SELECT count() FROM json_bf_edges WHERE j.flag = 'no'
SETTINGS bool_true_representation = 'no', bool_false_representation = 'maybe', force_data_skipping_indices = 'idx';
