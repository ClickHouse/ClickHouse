...
db.aggr.aggregate([{\$group: {_id: "\$city", sum_money: {\$sum: "\$money"}, avg_age: {\$avg: "\$age" }, c: {\$sum: 1}}}, {\$sort: { c: -1}}, { \$limit: 10}]);
...
db.aggr.aggregate([{ \$group: { _id: "\$city" } }, { \$count: "c" }])
db.aggr.aggregate([{ \$match: { name: { \$ne: "Alex" } } },{ \$group: { _id: "\$city", c: { \$sum: 1 } } },{ \$sort: { c: -1 } },])
db.aggr.aggregate([{ \$group: { _id: { city: "\$city", name: "\$name" } } },{ \$group: { _id: "\$_id.city", u: { \$sum: 1 } } },{ \$sort: { u: -1 } },{ \$limit: 10 },])
db.aggr.aggregate([{ \$group: { _id: "\$city", c: { \$sum: 1} } },{ \$sort: { c: -1 } },{ \$limit: 10 },])
db.aggr.aggregate([{ \$match: { city: { \$ne: "" } } },{ \$group: { _id: { city: "\$city", name: "\$name" } } },{ \$group: { _id: "\$_id.city", u: { \$sum: 1 } } },{ \$sort: { u: -1 } },])
EOF