...
DISABLE_OPTIMIZATION="SET enable_analyzer=$ENABLE_ANALYZER;SET query_plan_remove_redundant_sorting=0;SET optimize_duplicate_order_by_and_distinct=0;SET query_plan_merge_expressions=1;SET query_plan_merge_filters=1;SET query_plan_lift_up_union=1;SET query_plan_remove_unused_columns=1;SET query_plan_filter_push_down=1;SET query_plan_optimize_lazy_materialization=0;SET enable_optimize_predicate_expression=1"
