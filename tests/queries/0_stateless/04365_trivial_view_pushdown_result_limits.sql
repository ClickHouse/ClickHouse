...
DROP TABLE IF EXISTS 04365_local;
DROP TABLE IF EXISTS 04365_dist;
DROP VIEW IF EXISTS 04365_view;

CREATE TABLE 04365_local (id UInt32) ENGINE = MergeTree ORDER BY id;
CREATE TABLE 04365_dist AS 04365_local
ENGINE = Distributed(test_shard_localhost, currentDatabase(), 04365_local);
CREATE VIEW 04365_view AS SELECT id FROM 04365_dist;

INSERT INTO 04365_dist VALUES (1), (2), (3), (4), (5);
SYSTEM FLUSH DISTRIBUTED 04365_dist;
...
SELECT id FROM 04365_view ORDER BY id LIMIT 1
...
SELECT id FROM 04365_view ORDER BY id
...
DROP VIEW 04365_view;
DROP TABLE 04365_dist;
DROP TABLE 04365_local;
