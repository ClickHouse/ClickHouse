...
-- A subquery in a CHECK constraint is rejected on the DDL path, so the table keeps working.
ALTER TABLE check_constraint ADD CONSTRAINT c0 CHECK (SELECT 1); -- { serverError BAD_ARGUMENTS }
INSERT INTO TABLE check_constraint (c0) VALUES (1);
