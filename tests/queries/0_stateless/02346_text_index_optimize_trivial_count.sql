...
SELECT trimLeft(explain) FROM (EXPLAIN SELECT count() FROM tab WHERE hasToken(text, 'alpha')) WHERE explain LIKE '%ReadFromPreparedSource%';
SELECT trimLeft(explain) FROM (EXPLAIN SELECT count() FROM tab WHERE hasAnyTokens(text, ['alpha'])) WHERE explain LIKE '%ReadFromPreparedSource%';
SELECT trimLeft(explain) FROM (EXPLAIN SELECT count() FROM tab WHERE hasAllTokens(text, ['alpha'])) WHERE explain LIKE '%ReadFromPreparedSource%';
