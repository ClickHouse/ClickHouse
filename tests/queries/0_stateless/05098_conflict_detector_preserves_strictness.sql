...
-- (`query_plan_optimize_join_order_conflict_detector` set to `a` or `c`) must not change the strictness of a
...
SELECT 'ANY  greedy cd_a', count() FROM l ANY LEFT JOIN r ON l.k = r.k
    SETTINGS query_plan_optimize_join_order_algorithm = 'greedy', query_plan_optimize_join_order_conflict_detector = 'a';
SELECT 'ANY  greedy cd_c', count() FROM l ANY LEFT JOIN r ON l.k = r.k
    SETTINGS query_plan_optimize_join_order_algorithm = 'greedy', query_plan_optimize_join_order_conflict_detector = 'c';
