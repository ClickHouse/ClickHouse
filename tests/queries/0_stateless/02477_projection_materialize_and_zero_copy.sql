...
SETTINGS allow_remote_fs_zero_copy_replication=1, index_granularity=8192, index_granularity_bytes='10Mi', enable_block_number_column=0, enable_block_offset_column=0;
