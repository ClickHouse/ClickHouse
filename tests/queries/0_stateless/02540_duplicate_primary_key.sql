...
(
    ...
    `m_registered` LowCardinality(UInt8),
    `m_mcc` LowCardinality(Nullable(Int16)),
    `m_mnc` LowCardinality(Nullable(Int16)),
    `m_ci` Nullable(Int32),
    `m_tac` LowCardinality(Nullable(Int32)),
    `enb_id` Nullable(Int32),
    `ci` Nullable(Int32),
    `m_earfcn` LowCardinality(Int32),
    `rsrp` LowCardinality(Nullable(Int16)),
    `rsrq` LowCardinality(Nullable(Int16)),
    `cqi` LowCardinality(Nullable(Int16)),
    ...
    `manipulation` LowCardinality(UInt8),
    `ss_rsrp` LowCardinality(Nullable(Int16)),
    `ss_rsrq` LowCardinality(Nullable(Int16)),
    `ss_sinr` LowCardinality(Nullable(Int16)),
    `csi_rsrp` LowCardinality(Nullable(Int16)),
    `csi_rsrq` LowCardinality(Nullable(Int16)),
    `csi_sinr` LowCardinality(Nullable(Int16)),
    `altitude` Nullable(Float32),
    `access_technology` LowCardinality(Nullable(String)),
    `buildingtype` LowCardinality(String),
    `LocationType` LowCardinality(String),
    `carrier_name` LowCardinality(Nullable(String)),
    `CustomPolygonName` LowCardinality(String),
    `h3_10_pixel` UInt64,
    `stc_cluster` LowCardinality(Nullable(String)),
