...
-- 04402_group_by_limit_pushdown_aliased_key, which is restricted to the analyzer;
-- the old analyzer resolves that construct inconsistently across query contexts.
