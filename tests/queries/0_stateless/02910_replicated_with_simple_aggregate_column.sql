...
ENGINE = ReplicatedMergeTree('/tables/{database}/t_all_types', 'r1')
ORDER BY i8;

CREATE TABLE t_all_types_r2
(
    i8            Int8,
    i16           Int16,
    i32           Int32,
...
ENGINE = ReplicatedMergeTree('/tables/{database}/t_all_types', 'r2')
ORDER BY i8;