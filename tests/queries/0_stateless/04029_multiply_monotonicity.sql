...
CREATE TABLE t_multiply_mono (key UInt64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_mono_int (key Int64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_overflow (key UInt64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_overflow_signed (key Int64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_widened (key UInt32) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_neg (key Int64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_u128 (key UInt128) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_i128_overflow (key Int128) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_u256 (key UInt256) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_i256_overflow (key Int256) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_left_const (key UInt64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_one (key Int64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_neg1_min (key Int64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_neg1_ok (key Int64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_var_var (key UInt64, val UInt64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
...
CREATE TABLE t_multiply_boundary (key UInt64) ENGINE = MergeTree ORDER BY key SETTINGS index_granularity = 1, add_minmax_index_for_numeric_columns = 0;
