...
SELECT * FROM events WHERE (ts, e) IN ('2023-06-10 00:00:13', 'z') SETTINGS force_primary_key = 1, max_rows_to_read = 2;
SELECT * FROM events WHERE (e, ts) IN ('y', '2023-06-10 00:00:07') SETTINGS force_primary_key = 1, max_rows_to_read = 2;
