...
-- resolve the duplicates that flowed through. A parallel final `DISTINCT` merges once per hash-scattered
-- stream, so the number of merges is a property of the plan, not of the spilling.
