...
(
    ...
    region String,
    user_id UInt32,
    PROJECTION region_proj INDEX region TYPE basic WITH SETTINGS (add_minmax_index_for_numeric_columns = 0),
    PROJECTION user_id_proj INDEX user_id TYPE basic WITH SETTINGS (add_minmax_index_for_numeric_columns = 0)
)
ENGINE = MergeTree
ORDER BY id
SETTINGS
