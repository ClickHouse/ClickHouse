...
SELECT count() FROM tab WHERE a != ['x'] SETTINGS use_skip_indexes = 1;
SELECT count() FROM tab WHERE a != ['x'] SETTINGS use_skip_indexes = 0;
SELECT count() FROM tab WHERE hasAny(a, ['x']) SETTINGS use_skip_indexes = 1;
SELECT count() FROM tab WHERE hasAny(a, ['x']) SETTINGS use_skip_indexes = 0;
...
SELECT count() FROM tab WHERE a != ['x'] SETTINGS use_skip_indexes = 1;
SELECT count() FROM tab WHERE a != ['x'] SETTINGS use_skip_indexes = 0;
SELECT count() FROM tab WHERE a IN (['x'], ['q']) SETTINGS use_skip_indexes = 1;
SELECT count() FROM tab WHERE has(a, 'x') SETTINGS use_skip_indexes = 1;
SELECT count() FROM tab WHERE hasAny(a, ['x']) SETTINGS use_skip_indexes = 1;
SELECT count() FROM tab WHERE hasAny(a, ['x']) SETTINGS use_skip_indexes = 0;
SELECT count() FROM tab WHERE hasAll(a, ['x']) SETTINGS use_skip_indexes = 1;
DROP TABLE tab;
