...
-- Partial aggregate cache: first query misses, second hits; new parts add work.
...
SETTINGS
    ...
    log_comment = 'test_partial_agg_cache_query_1';
...
WHERE
    ...
    AND log_comment = 'test_partial_agg_cache_query_1'
...
SETTINGS
    ...
    max_rows_to_group_by = 0,
    group_by_overflow_mode = 'throw',
    log_comment = 'test_partial_agg_cache_query_2';
...
WHERE
    type = 'QueryFinish'
    AND current_database = currentDatabase()
    AND log_comment = 'test_partial_agg_cache_query_2'
    AND is_initial_query = 1
ORDER BY event_time_microseconds DESC
LIMIT 1;
...
SETTINGS
    ...
    max_rows_to_group_by = 0,
    group_by_overflow_mode = 'throw',
    log_comment = 'test_partial_agg_cache_query_3';
...
WHERE
    type = 'QueryFinish'
    AND current_database = currentDatabase()
    AND log_comment = 'test_partial_agg_cache_query_3'
    AND is_initial_query = 1
ORDER BY event_time_microseconds DESC
LIMIT 1;
