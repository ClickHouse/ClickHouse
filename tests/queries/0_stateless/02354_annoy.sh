...
DROP TABLE IF EXISTS _02354_annoy_l2;

CREATE TABLE _02354_annoy_l2
(
    id Int32,
...
INSERT INTO _02354_annoy_l2 VALUES (1, [0.0, 0.0, 10.0]), (2, [0.0, 0.0, 10.5]), (3, [0.0, 0.0, 9.5]), (4, [0.0, 0.0, 9.7]), (5, [0.0, 0.0, 10.2]), (6, [10.0, 0.0, 0.0]), (7, [9.5, 0.0, 0.0]), (8, [9.7, 0.0, 0.0]), (9, [10.2, 0.0, 0.0]), (10, [10.5, 0.0, 0.0]), (11, [0.0, 10.0, 0.0]), (12, [0.0, 9.5, 0.0]), (13, [0.0, 9.7, 0.0]), (14, [0.0, 10.2, 0.0]), (15, [0.0, 10.5, 0.0]);

SELECT *
FROM _02354_annoy_l2
...
SET param__02354_target_vector='[0.0, 0.0, 10.0]';

SELECT *
FROM _02354_annoy_l2
WHERE L2Distance(embedding, {_02354_target_vector: Array(Float32)}) < 1.0
LIMIT 5;

SELECT *
FROM _02354_annoy_l2
ORDER BY L2Distance(embedding, {_02354_target_vector: Array(Float32)})
LIMIT 3;
...
$CLICKHOUSE_CLIENT -nm --allow_experimental_annoy_index=1 -q "
DROP TABLE IF EXISTS _02354_annoy_cosine;

CREATE TABLE _02354_annoy_cosine
(
    id Int32,
    embedding Array(Float32),
...
INSERT INTO _02354_annoy_cosine VALUES (1, [0.0, 0.0, 10.0]), (2, [0.2, 0.0, 10.0]), (3, [-0.3, 0.0, 10.0]), (4, [0.5, 0.0, 10.1]), (5, [0.8, 0.0, 10.0]), (6, [10.0, 0.0, 0.0]), (7, [9.5, 0.0, 0.0]), (8, [9.7, 0.0, 0.0]), (9, [10.2, 0.0, 0.0]), (10, [10.5, 0.0, 0.0]), (11, [0.0, 10.0, 0.0]), (12, [0.0, 9.5, 0.0]), (13, [0.0, 9.7, 0.0]), (14, [0.0, 10.2, 0.0]), (15, [0.0, 10.5, 0.0]);

SELECT *
FROM _02354_annoy_cosine
...
$CLICKHOUSE_CLIENT -nm --allow_experimental_annoy_index=1 -q "
DROP TABLE IF EXISTS _02354_annoy;

-- Index spans >1 column

CREATE TABLE _02354_annoy
(
    id Int32,
    embedding Array(Float32),
