...
EXPLAIN SELECT _table, count() FROM test_03217_all_replicas WHERE  _table = 'test_03217_merge_replica_1' AND x >= 0 GROUP BY _table SETTINGS enable_analyzer=1, query_plan_filter_push_down=1, query_plan_merge_expressions=1;
