...
(
  ...
  value2 UInt64 CODEC(Delta, DefaultCompression),
...
ALTER TABLE compress_table MODIFY COLUMN value3 CODEC(DefaultCompression);
...
ALTER TABLE compress_table MODIFY COLUMN value2 CODEC(DefaultCompression(5)); --{serverError 36}
