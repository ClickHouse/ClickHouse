...
${CLICKHOUSE_CLIENT} --merge_tree_min_rows_for_concurrent_read 1 --merge_tree_min_bytes_for_concurrent_read 1 --max_insert_threads 1 --max_insert_block_size 100 --min_insert_block_size_rows 100 --min_insert_block_size_bytes 100Mi -q "INSERT INTO ghdata_2_from_string SELECT data FROM ghdata_2_string"
