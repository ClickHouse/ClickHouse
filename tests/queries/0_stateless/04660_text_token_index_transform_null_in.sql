...
--
-- The extraction uses `toUInt64OrZero` because `WHERE` conjuncts are evaluated over the whole
-- column rather than short-circuited, so the cast also sees the plan rows the `LIKE` guard
-- rejects, where `extract` yields an empty string. Zero is safe for the comparison: a row without
-- a `Granules: read/total` pair reads 0 < 0, which is false, so only real granule rows can
-- satisfy it.
...
SELECT 'text String', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text String control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text LowCardinality(String)', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_lc WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text LowCardinality(String) control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_lc WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text Nullable(String) null-free set', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_null WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text Nullable(String) control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_null WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text LowCardinality(Nullable(String)) null-free set', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_lcnull WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text LowCardinality(Nullable(String)) control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_lcnull WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text FixedString(12)', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_fixed WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text FixedString(12) control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_fixed WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text tuple set', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_tuple WHERE (a, b) IN (('a5', 'word5'), ('a500', 'word500')) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text tuple set control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_tuple WHERE (a, b) IN (('a5', 'word5'), ('a500', 'word500')) SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text tuple set Nullable indexed component null-free', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_tuple_null WHERE (a, b) IN (('a5', 'word5'), ('a500', 'word500')) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text tuple set Nullable indexed component control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_tuple_null WHERE (a, b) IN (('a5', 'word5'), ('a500', 'word500')) SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text tuple set indexed at position 1', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_pos1 WHERE (id, str) IN (SELECT number, 'Hello10' FROM numbers(100)) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text map element value', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_map WHERE m['k'] IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text map element value control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_map WHERE m['k'] IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text JSON subcolumn', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_json WHERE j.a::String IN ('word5', 'word500') SETTINGS transform_null_in = 1, enable_json_type = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text JSON subcolumn control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_json WHERE j.a::String IN ('word5', 'word500') SETTINGS transform_null_in = 0, enable_json_type = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'tokenbf_v1 String', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'tokenbf_v1 String control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'tokenbf_v1 LowCardinality(String)', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok_lc WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'tokenbf_v1 LowCardinality(String) control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok_lc WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'tokenbf_v1 tuple set', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok_tuple WHERE (a, b) IN (('a5', 'word5'), ('a500', 'word500')) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'tokenbf_v1 tuple set control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok_tuple WHERE (a, b) IN (('a5', 'word5'), ('a500', 'word500')) SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'ngrambf_v1 String', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_ngram WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'ngrambf_v1 String control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_ngram WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'ngrambf_v1 LowCardinality(String)', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_ngram_lc WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'ngrambf_v1 LowCardinality(String) control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_ngram_lc WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'sparse_grams String', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_sparse WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'sparse_grams String control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_sparse WHERE x IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text globalNullIn', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt WHERE x GLOBAL IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'tokenbf_v1 globalNullIn', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok WHERE x GLOBAL IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'ngrambf_v1 globalNullIn', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_ngram WHERE x GLOBAL IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'sparse_grams globalNullIn', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_sparse WHERE x GLOBAL IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'tokenbf_v1 globalIn tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok WHERE x GLOBAL IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'ngrambf_v1 globalIn tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_ngram WHERE x GLOBAL IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'sparse_grams globalIn tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_sparse WHERE x GLOBAL IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text globalIn tnin=0 unchanged', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt WHERE x GLOBAL IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));

SELECT '--- 4. a set containing NULL must NOT be pruned, and must return the NULL rows ---';

SELECT 'text Nullable NULL-in-set not pruned', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_null WHERE x IN ('word5', NULL) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text LowCardinality(Nullable) NULL-in-set not pruned', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_lcnull WHERE x IN ('word5', NULL) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text tuple NULL at indexed position not pruned', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_tuple_null WHERE (a, b) IN (('a7', 'word7'), ('a107', NULL)) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text empty-string element not pruned', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt WHERE x IN ('word5', '') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text tokenizes-to-nothing element not pruned', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt WHERE x IN ('word5', '...') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'text NOT IN not pruned tnin=1', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt WHERE x NOT IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'text NOT IN not pruned tnin=0', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt WHERE x NOT IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'tokenbf_v1 NOT IN not pruned tnin=1', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok WHERE x NOT IN ('word5', 'word500') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'tokenbf_v1 NOT IN not pruned tnin=0', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok WHERE x NOT IN ('word5', 'word500') SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'Array(String) IN not pruned tnin=0', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_arr WHERE x IN (['word5'], ['word500']) SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'Array(String) IN not pruned tnin=1', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_arr WHERE x IN (['word5'], ['word500']) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'Array(String) has() prunes tnin=1', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_arr WHERE has(x, 'word5') SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'tokenbf_v1 Nullable unindexed component null-free', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok_tuple_null WHERE (a, b) IN (('a5', 'word5'), ('a500', 'word500')) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'tokenbf_v1 Nullable unindexed component control tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok_tuple_null WHERE (a, b) IN (('a5', 'word5'), ('a500', 'word500')) SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'tokenbf_v1 NULL in unindexed component prunes', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok_tuple_null WHERE (a, b) IN ((NULL, 'word7'), ('a5', 'word5')) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
...
SELECT 'mixed tuple text prunes tnin=0', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_mixed WHERE (id, str) IN ((5, 'word5'), (500, 'word500')) SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'mixed tuple text prunes tnin=1', count() > 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_txt_mixed WHERE (id, str) IN ((5, 'word5'), (500, 'word500')) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'mixed tuple tokenbf_v1 not pruned tnin=0', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok_mixed WHERE (id, str) IN ((5, 'word5'), (500, 'word500')) SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'mixed tuple tokenbf_v1 not pruned tnin=1', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_tok_mixed WHERE (id, str) IN ((5, 'word5'), (500, 'word500')) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'mixed tuple ngrambf_v1 not pruned tnin=0', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_ngram_mixed WHERE (id, str) IN ((5, 'word5'), (500, 'word500')) SETTINGS transform_null_in = 0) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
SELECT 'mixed tuple ngrambf_v1 not pruned tnin=1', count() = 0 FROM (EXPLAIN indexes = 1 SELECT count() FROM t_ngram_mixed WHERE (id, str) IN ((5, 'word5'), (500, 'word500')) SETTINGS transform_null_in = 1) WHERE explain LIKE '%Granules: %/%' AND toUInt64OrZero(extract(explain, 'Granules: (\d+)/')) < toUInt64OrZero(extract(explain, 'Granules: \d+/(\d+)'));
