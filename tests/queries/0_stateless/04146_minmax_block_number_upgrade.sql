...
SETTINGS enable_block_number_column = 1, enable_block_offset_column = 1, extend_minmax_index_with_persisted_virtual_columns = 0;
...
alter table t modify setting extend_minmax_index_with_persisted_virtual_columns=1 settings alter_sync=2;
...
alter table t modify setting extend_minmax_index_with_persisted_virtual_columns=0 settings alter_sync=2;
