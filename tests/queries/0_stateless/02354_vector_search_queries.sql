...
-- Test with metric = 'cosineDistance' (Annoy/Usearch), NumTrees = 200 (Annoy), ScalarKind = 'f64' (Usearch)

CREATE TABLE tab_annoy(id Int32, vec Array(Float32), INDEX idx vec TYPE annoy('cosineDistance', 200) GRANULARITY 2) ENGINE = MergeTree ORDER BY id SETTINGS index_granularity = 3;
