...
-- The preliminary DISTINCT of the inputs is planned only for several threads, and a swap of the join sides reorders
-- the inputs of the nested set operation.
SET max_threads = 2;
