...
-- The stateful projection over the mixed parts returns the same values with the setting
-- enabled and disabled.
SELECT (
    SELECT groupArray(n) FROM (SELECT neighbor(v, 1) AS n FROM t_04823 FINAL WHERE v < 1000000
