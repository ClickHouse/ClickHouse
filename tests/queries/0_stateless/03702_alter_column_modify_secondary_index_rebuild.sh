...
client() {
    ...
    $CLICKHOUSE_CLIENT --echo --enable-analyzer=1 --use_query_condition_cache=0 --mutations_sync=2 --alter_sync=2 --use_statistics_for_part_pruning=0 --query_plan_merge_expressions=1 -q "$1"
}
