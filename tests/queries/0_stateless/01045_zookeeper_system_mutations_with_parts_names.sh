...
${CLICKHOUSE_CLIENT} -n --query="SET insert_keeper_fault_injection_probability=0;INSERT INTO replicated_table_for_mutations select number, number from numbers(100000)"
