...
CREATE TABLE t0 (s Nullable(String), t Tuple(a Nullable(String))) ENGINE = MergeTree ORDER BY tuple() SETTINGS ratio_of_defaults_for_sparse_serialization = 0.9, nullable_serialization_version='allow_sparse';
