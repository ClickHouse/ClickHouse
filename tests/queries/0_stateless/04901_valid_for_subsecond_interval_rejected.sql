...
CREATE USER user_04901_subsecond VALID FOR INTERVAL 1 MILLISECOND; -- { serverError BAD_ARGUMENTS }
CREATE USER user_04901_subsecond VALID FOR INTERVAL 1 MICROSECOND; -- { serverError BAD_ARGUMENTS }
CREATE USER user_04901_subsecond VALID FOR INTERVAL 1 NANOSECOND; -- { serverError BAD_ARGUMENTS }

-- A sub-second term hiding inside a sum of intervals is rejected too.
CREATE USER user_04901_subsecond VALID FOR INTERVAL 1 DAY + INTERVAL 1 MILLISECOND; -- { serverError BAD_ARGUMENTS }

-- Sub-second intervals are also rejected at the credential level.
CREATE USER user_04901_subsecond IDENTIFIED WITH plaintext_password BY 'x' VALID FOR INTERVAL 500 MILLISECOND; -- { serverError BAD_ARGUMENTS }
...
CREATE USER user_04901_subsecond VALID FOR INTERVAL 1000 MILLISECOND; -- { serverError BAD_ARGUMENTS }
