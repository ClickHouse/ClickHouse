...
CREATE TABLE test (id UInt32, a UInt32) ENGINE = MergeTree
ORDER BY id
SETTINGS enable_block_number_column = 1, enable_block_offset_column = 1;

INSERT INTO test(id,a) VALUES (1,1),(3,3),(4,4);
INSERT INTO test(id,a) VALUES (2,2),(5,5),(6,6);

SELECT '*** BEFORE MUTATION BEFORE MERGE ***';
SELECT id,a,_block_number,_block_offset,_part from test ORDER BY id;
...
SELECT *,_block_number,_block_offset,_part from test ORDER BY id;
