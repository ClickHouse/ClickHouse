...
$CLICKHOUSE_CLIENT -nm -q "
  ...
  insert into test_10m select number, number*100 from numbers(1e6) settings max_insert_threads=1, max_partitions_per_insert_block=100, max_block_size=10000, min_insert_block_size_rows=10000;
