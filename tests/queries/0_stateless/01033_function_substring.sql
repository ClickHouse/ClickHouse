...
SELECT '-- oversized negative offset in substringUTF8';

SELECT substringUTF8(materialize('café au lait'), -15, 5);
SELECT substringUTF8(materialize('café au lait'), -15, 3);
SELECT substringUTF8(materialize('Éclair is fresh'), -16, 5);
