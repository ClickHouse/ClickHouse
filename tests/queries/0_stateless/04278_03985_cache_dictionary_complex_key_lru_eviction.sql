...
SELECT dictGet('cache_dict', 'value', (toUInt64(0), 'tag_0')) FORMAT Null;
SELECT dictGet('cache_dict', 'value', (toUInt64(1), 'tag_1')) FORMAT Null;
SELECT dictGet('cache_dict', 'value', (toUInt64(2), 'tag_2')) FORMAT Null;
SELECT dictGet('cache_dict', 'value', (toUInt64(3), 'tag_3')) FORMAT Null;
...
SELECT dictGet('cache_dict', 'value', (toUInt64(4), 'tag_4')) FORMAT Null;
...
SELECT dictGet('cache_dict', 'value', (toUInt64(5), 'tag_5')) FORMAT Null;

-- Key 4 was fetched right before key 5, so it must still be cached (old value).
SELECT 'recent_insert_survived', dictGet('cache_dict', 'value', (toUInt64(4), 'tag_4')) = 'old_4';
-- Key 0 was the least recently used and must have been evicted (re-fetched -> new value).
SELECT 'lru_key_evicted', dictGet('cache_dict', 'value', (toUInt64(0), 'tag_0')) = 'new_0';
