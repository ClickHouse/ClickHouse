...
create table test_1164_memory.r1 (n int) engine=ReplicatedMergeTree('/test/01164/t', '1') order by n;
create table test_1164_memory.r2 (n int) engine=ReplicatedMergeTree('/test/01164/t', '2') order by n;
