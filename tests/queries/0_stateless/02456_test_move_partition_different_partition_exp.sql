...
CREATE TABLE source (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY toYYYYMM(timestamp);
CREATE TABLE destination (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY toYYYYMMDD(timestamp);
...
CREATE TABLE source (timestamp DateTime, A Int64) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY timestamp PARTITION BY intDiv(A, 6);

CREATE TABLE destination (timestamp DateTime, A Int64) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY timestamp PARTITION BY A;
...
CREATE TABLE source (productName String, category String) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY cityHash64(category);
CREATE TABLE destination (productName String, category String) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY toString(category);
...
CREATE TABLE source (timestamp Int64) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY (timestamp) PARTITION BY intDiv(timestamp, 86400000);
CREATE TABLE destination (timestamp Int64) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY (timestamp) PARTITION BY toYear(toDateTime(intDiv(timestamp, 1000)));
...
CREATE TABLE source (timestamp DateTime('UTC'), key Int64, f Float64) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY (key, timestamp) PARTITION BY toYear(timestamp);
CREATE TABLE destination (timestamp DateTime('UTC'), key Int64, f Float64) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY (key, timestamp) PARTITION BY (intDiv(toUInt32(timestamp),86400));
...
DROP TABLE IF EXISTS destination SYNC;
CREATE TABLE source (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY toYYYYMM(timestamp);
CREATE TABLE destination (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple();
...
DROP TABLE IF EXISTS destination SYNC;
CREATE TABLE source (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY toYYYYMM(timestamp);
CREATE TABLE destination (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY tuple();
...
DROP TABLE IF EXISTS source SYNC;
DROP TABLE IF EXISTS destination SYNC;
CREATE TABLE source (a Int, b Int, c Int) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY (a, b, c);
CREATE TABLE destination (a Int, b Int, c Int) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY (a, b);
...
DROP TABLE IF EXISTS destination SYNC;
CREATE TABLE source (a Int, b Int, c Int) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY (a, b, c);
CREATE TABLE destination (a Int, b Int, c Int) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY a;
...
CREATE TABLE source (`timestamp` DateTime, `A` Int64) ENGINE = ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') PARTITION BY tuple(toYYYYMM(timestamp), intDiv(A, 6)) ORDER BY timestamp;
CREATE TABLE destination (`timestamp` DateTime, `A` Int64) ENGINE = ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') PARTITION BY A ORDER BY timestamp;
...
CREATE TABLE source (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY tuple();
CREATE TABLE destination (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple();
...
CREATE TABLE source (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple();
CREATE TABLE destination (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY tuple();
...
CREATE TABLE source (A Int, B Int) ENGINE = ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') PARTITION BY tuple(A, B) ORDER BY tuple();
CREATE TABLE destination (A Int, B Int) ENGINE = ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') PARTITION BY tuple(intDiv(A, 2), intDiv(B, 2)) ORDER BY tuple();
...
CREATE TABLE source (A Int, B Int) ENGINE = ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') PARTITION BY tuple(intDiv(A, 2), intDiv(B, 2)) ORDER BY tuple();
CREATE TABLE destination (A Int, B Int) ENGINE = ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') PARTITION BY tuple(A, B) ORDER BY tuple();
...
CREATE TABLE source (productName String, category String) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY toString(category);
CREATE TABLE destination (productName String, category String) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY substring(category, 1, 2);
...
CREATE TABLE source (productName String, category String) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY toString(category);
CREATE TABLE destination (productName String, category String) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY toString(productName);
...
CREATE TABLE source (productName String) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY left(productName, 2);
CREATE TABLE destination (productName String) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY cityHash64(productName);
...
CREATE TABLE source (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY toYYYYMM(timestamp);
CREATE TABLE destination (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY toYYYYMM(timestamp);
...
CREATE TABLE source (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/source', '1') ORDER BY tuple() PARTITION BY toYYYYMMDD(timestamp);
CREATE TABLE destination (timestamp DateTime) engine=ReplicatedMergeTree('/clickhouse/tables/{database}/test/destination', '1') ORDER BY tuple() PARTITION BY toYYYYMM(timestamp);
