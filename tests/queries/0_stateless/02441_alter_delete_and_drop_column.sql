...
select partition,name,uuid,part_type,part_storage_type,active,marks,rows,refcount,partition_id,metadata_version from system.parts where database=currentDatabase() and table='mut';
