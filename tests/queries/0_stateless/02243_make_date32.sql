...
select makeDate32(1980, -10, 17);
select makeDate32(1980, 10, -17);
select makeDate32(1980.0, '10', 30.0/2);
select makeDate32(-1980.0, '10', 30.0/2);
select makeDate32(cast(1980.1 as Decimal(20,5)), '10', 30.0/2);
select makeDate32(cast('-1980.1' as Decimal(20,5)), '10', 30.0/2);
select makeDate32(cast(1980.1 as Float32), '10', 30.0/2);
select makeDate32(cast(-1980.1 as Float32), '10', 30.0/2);
--select makeDate32(cast(1980 as Date), '10', 30.0/2);
--select makeDate32(cast(-1980 as Date), '10', 30.0/2);
--select makeDate32(cast(1980 as Date32), '10', 30.0/2);
--select makeDate32(cast(-1980 as Date32), '10', 30.0/2);
--select makeDate32(cast(1980 as DateTime), '10', 30.0/2);
--select makeDate32(cast(-1980 as DateTime), '10', 30.0/2);
--select makeDate32(cast(1980 as DateTime64), '10', 30.0/2);
--select makeDate32(cast(-1980 as DateTime64), '10', 30.0/2);
