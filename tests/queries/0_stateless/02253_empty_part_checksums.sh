#!/usr/bin/env bash
# Tags: zookeeper, no-replicated-database, no-shared-merge-tree, no-darwin
...
cleanup_thread_preferred_points_per_iteration=0, min_bytes_for_wide_part=0, min_bytes_for_full_part_storage=0, remove_empty_parts=0, replace_long_file_name_to_hash=0, add_minmax_index_for_numeric_columns=0"
