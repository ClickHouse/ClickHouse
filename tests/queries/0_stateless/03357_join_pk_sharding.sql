...
insert into tab_l select number, number, number, number from numbers(10);
insert into tab_m select number, number, number, number from numbers(10);
insert into tab_r select number, number, number, number from numbers(10);
