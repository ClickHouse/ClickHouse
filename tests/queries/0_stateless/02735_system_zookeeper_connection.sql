...
select name, host, port, index, connected_time, session_uptime_elapsed_seconds, is_expired, keeper_api_version from system.zookeeper_connection order by name;
