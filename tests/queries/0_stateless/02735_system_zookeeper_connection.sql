...
select name, host, port, index, (connected_time between yesterday() and today()), (abs(session_uptime_elapsed_seconds  - zookeeperSessionUptime()) < 10), is_expired, keeper_api_version from system.zookeeper_connection order by name;
