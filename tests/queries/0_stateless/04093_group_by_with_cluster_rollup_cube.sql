...
-- `GROUPING SETS`: the latter finalize aggregate states before the cluster
-- step would merge them, which would otherwise produce a `LOGICAL_ERROR`
-- in `mergeAggregateStates` ("Expected ColumnAggregateFunction").
