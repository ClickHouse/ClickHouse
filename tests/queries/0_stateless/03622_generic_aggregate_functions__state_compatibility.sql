...
select hex(groupUniqArrayState(tuple('str', 'str'::Variant(String))));
select hex(groupUniqArrayState(tuple('str', 'str'::Dynamic)));
select hex(groupUniqArrayState(tuple('str', 'str'::Dynamic(max_types=0))));
