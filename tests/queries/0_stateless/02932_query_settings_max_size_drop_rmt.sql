...
ALTER TABLE test_max_size_drop DROP PART 'all_0_0_0' SETTINGS max_partition_size_to_drop = 1; -- { serverError TABLE_SIZE_EXCEEDS_MAX_DROP_SIZE_LIMIT }
ALTER TABLE test_max_size_drop DROP PART 'all_0_0_0';
DROP TABLE test_max_size_drop SYNC;
