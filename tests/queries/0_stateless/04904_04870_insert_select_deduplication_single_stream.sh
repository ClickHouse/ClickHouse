...
$CLICKHOUSE_CLIENT --max_insert_threads 4 --max_threads 4 --use_strict_insert_block_limits 1 -q \
...
$CLICKHOUSE_CLIENT --max_insert_threads 4 --max_threads 4 --use_strict_insert_block_limits 0 -q \
    "EXPLAIN PIPELINE INSERT INTO insert_select_deduplication_single_stream SELECT number FROM numbers(4)" | grep -c "MergeTreeSink"
