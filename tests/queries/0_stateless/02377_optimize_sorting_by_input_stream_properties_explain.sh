...
DISABLE_OPTIMIZATION="set optimize_sorting_by_input_stream_properties=0;set optimize_read_in_order=0;set max_threads=3"
ENABLE_OPTIMIZATION="set optimize_sorting_by_input_stream_properties=1;set optimize_read_in_order=1;set max_threads=3"
