...
select 'no bf: metadata', rg.num_rows, col.name, col.bloom_filter_bytes from file(bf_03263.parquet, ParquetMetadata) array join row_groups as rg array join rg.columns as col settings max_threads=1;
...
select 'bf: metadata', rg.num_rows, col.name, col.bloom_filter_bytes from file(bf_03263.parquet, ParquetMetadata) array join row_groups as rg array join rg.columns as col settings max_threads=1;
...
select 'more bits per value: metadata', rg.num_rows, col.name, col.bloom_filter_bytes from file(bf_03263.parquet, ParquetMetadata) array join row_groups as rg array join rg.columns as col settings max_threads=1;
