...
$CLICKHOUSE_LOCAL "SELECT 34 AS x FORMAT TSV" | $CLICKHOUSE_CLIENT "INSERT INTO test FORMAT TSV"
$CLICKHOUSE_LOCAL "SELECT 56 AS x FORMAT Native" | $CLICKHOUSE_CLIENT "INSERT INTO test (x) FORMAT Native"
$CLICKHOUSE_LOCAL "SELECT 78 AS x FORMAT Native" | $CLICKHOUSE_CLIENT "INSERT INTO test FORMAT Native"
...
$CLICKHOUSE_LOCAL "SELECT 20 AS x FORMAT TSV" | $CLICKHOUSE_CLIENT "INSERT INTO test FORMAT TSV"
$CLICKHOUSE_LOCAL "SELECT 30 AS x FORMAT Native" | $CLICKHOUSE_CLIENT "INSERT INTO test (x) FORMAT Native"
$CLICKHOUSE_LOCAL "SELECT 40 AS x FORMAT Native" | $CLICKHOUSE_CLIENT "INSERT INTO test FORMAT Native"
...
$CLICKHOUSE_LOCAL "SELECT 34 AS x FORMAT TSV" | $CLICKHOUSE_CURL "${CLICKHOUSE_URL}&query=INSERT+INTO+test+FORMAT+TSV" --data-binary @-
...
$CLICKHOUSE_LOCAL "SELECT 78 AS x FORMAT Native" | $CLICKHOUSE_CURL "${CLICKHOUSE_URL}&query=INSERT+INTO+test+FORMAT+Native" --data-binary @-
...
$CLICKHOUSE_LOCAL "SELECT 20 AS x FORMAT TSV" | $CLICKHOUSE_CURL "${CLICKHOUSE_URL}&query=INSERT+INTO+test+FORMAT+TSV" --data-binary @-
...
$CLICKHOUSE_LOCAL "SELECT 40 AS x FORMAT Native" | $CLICKHOUSE_CURL "${CLICKHOUSE_URL}&query=INSERT+INTO+test+FORMAT+Native" --data-binary @-
