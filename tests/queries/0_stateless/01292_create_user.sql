...
SET param_userName101292="u1_01292";
SET param_userName201292="u2_01292";
CREATE USER {userName101292:Identifier};
CREATE USER {userName101292:Identifier}@'192.168.%.%', {userName201292:Identifier}@'192.168.%.%';
SHOW CREATE USER u1_01292;
