...
CREATE USER u1_01292 IDENTIFIED WITH sha256_password BY 'qwe123' HOST LOCAL SETTINGS readonly=1;
SHOW CREATE USER u1_01292;
ALTER USER u1_01292 IDENTIFIED WITH double_sha1_password BY '123root' HOST LOCAL SETTINGS readonly=1;
SHOW CREATE USER u1_01292;
DROP USER u1_01292;
