...
-- MDX autogeneration sentinels are source-maintenance details and must not be
-- exposed to consumers of the rendered Markdown.
SELECT count()
FROM system.documentation
WHERE type = 'System Table'
    AND description LIKE '%{/*AUTOGENERATED_%*/}%';
