...
SET max_bytes_before_external_join = 0; -- ensure only the join algorithm blocks the rewrite here
SET max_bytes_ratio_before_external_join = 0; -- ensure only the join algorithm blocks the rewrite here
