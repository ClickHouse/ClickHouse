...
explain actions=1 select * from test where n.null settings optimize_move_to_prewhere=1, allow_reorder_prewhere_conditions=0, query_plan_remove_unused_columns=1;
...
explain actions=1 select * from test where t.a < 4 settings optimize_move_to_prewhere=1, allow_reorder_prewhere_conditions=0, query_plan_remove_unused_columns=1;
...
explain actions=1 select * from test where json.a::Int64 < 4 settings optimize_move_to_prewhere=1, allow_reorder_prewhere_conditions=0, query_plan_remove_unused_columns=1;
