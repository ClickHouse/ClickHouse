...
do
    ...
    $CLICKHOUSE_CLIENT -q "insert into test_02841 ${CH_SETTINGS} values (1, 'str1', 1)"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 ${CH_SETTINGS} values (2, 'str2', 1)"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 ${CH_SETTINGS} select number, 'str_numbers_1', 1 from numbers(10000)"
    ...
    $CLICKHOUSE_CLIENT -q "insert into test_02841 ${CH_SETTINGS} select number, 'str_numbers_2', 1 from numbers(10000)"
    ...
    $CLICKHOUSE_CLIENT -q "insert into test_02841 ${CH_SETTINGS} values (1, 'str1', 1)"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 ${CH_SETTINGS} values (2, 'str2', 1)"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 ${CH_SETTINGS} select number, 'str_numbers_1', number > 9000 ? 99 : 1 from numbers(10000)"
