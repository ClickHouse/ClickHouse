...
do
    ...
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (1, 'str1', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (2, 'str2', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (3, 'str3', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (5, 'str5', 99) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (6, 'str6', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (7, 'str7', 1) ${CH_SETTINGS}"
    ...
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (1, 'str1', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (2, 'str2', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 select number, 'str_numbers_1', 1 from numbers(10000) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (3, 'str4', 99) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (4, 'str5', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 select number, 'str_numbers_2', 1 from numbers(10000) ${CH_SETTINGS}"
    ...
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (1, 'str1', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (2, 'str2', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 select number, 'str_numbers_1', number > 9000 ? 99 : 1 from numbers(10000) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (3, 'str4', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 values (4, 'str5', 1) ${CH_SETTINGS}"
    $CLICKHOUSE_CLIENT -q "insert into test_02841 select number, 'str_numbers_2', 1 from numbers(10000) ${CH_SETTINGS}"
