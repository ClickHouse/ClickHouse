...
SELECT id, mapSort(map) FROM map_containsValueLike_test WHERE mapContainsValueLike(map, '1-%') = 1;
SELECT id, mapSort(map) FROM map_containsValueLike_test WHERE mapContainsValueLike(map, '3-%') = 0 order by id;
