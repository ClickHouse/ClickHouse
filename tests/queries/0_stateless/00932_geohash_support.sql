...
select geohashEncode(-181.0, -91.0);
select count(geohashDecode('0123456789bcdefghjkmnpqrstuvwxyz'));

select 'invalid geohash characters:';
select geohashDecode('a'); -- { serverError BAD_ARGUMENTS }
select geohashDecode('i'); -- { serverError BAD_ARGUMENTS }
select geohashDecode('l'); -- { serverError BAD_ARGUMENTS }
select geohashDecode('o'); -- { serverError BAD_ARGUMENTS }
select geohashDecode('!'); -- { serverError BAD_ARGUMENTS }
