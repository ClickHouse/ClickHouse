...
SET query_cache_tag = '02494_query_cache_eligible_queries';

SYSTEM CLEAR QUERY CACHE TAG '02494_query_cache_eligible_queries';
...
SELECT COUNT(*) FROM (SELECT * FROM system.query_cache WHERE tag = '02494_query_cache_eligible_queries') AS test_query_cache;
