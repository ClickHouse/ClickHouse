...
CREATE TABLE tab(k UInt64, s String, INDEX af(s) TYPE gin(2))
            ...
            SETTINGS index_granularity = 2, index_granularity_bytes = '10Mi', min_bytes_for_full_part_storage = 0;
...
-- search GIN index with hasToken
...
-- search GIN index with IN operator
...
-- search GIN index with multiSearch
...
-- search GIN index with mapContains
