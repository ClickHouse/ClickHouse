...
DROP TABLE IF EXISTS shard_0.t_sus_04319;
DROP TABLE IF EXISTS shard_1.t_sus_04319;

CREATE TABLE shard_0.t_sus_04319 (x UInt32) ENGINE = MergeTree ORDER BY x;
INSERT INTO shard_0.t_sus_04319 VALUES (10), (20);

CREATE TABLE dist_sus (x UInt32) ENGINE = Distributed('test_cluster_two_shards_different_databases', '', t_sus_04319, x);
...
SELECT x FROM shard_0.t_sus_04319 ORDER BY x;
...
DROP TABLE dist_sus;
DROP TABLE shard_0.t_sus_04319;
