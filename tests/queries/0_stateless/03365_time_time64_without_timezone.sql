...
SELECT toTime('12:34:56', 'UTC'); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
SELECT toTime(toDateTime('2023-01-01 12:34:56'), 'UTC'); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
SELECT toTime(toDateTime64('2023-01-01 12:34:56.789', 3), 'UTC'); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
SELECT toTime(45296, 'UTC'); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
...
SELECT toTime(['12:34:56', '01:23:45'], 'UTC'); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
...
SELECT toTime('12:34:56', 'Europe/Moscow'); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
SELECT toTime64('12:34:56.789', 3, 'Europe/Moscow'); -- { serverError NUMBER_OF_ARGUMENTS_DOESNT_MATCH }
SELECT toTime('12:34:56', '+03:00'); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
