...
INSERT INTO src SELECT number % 10 as a, number as b FROM numbers(50);
...
SELECT count() FROM remote('127.0.0.{1..6}', currentDatabase(), src);

CREATE TABLE dst_null(a UInt64, b UInt64) ENGINE = Null;
