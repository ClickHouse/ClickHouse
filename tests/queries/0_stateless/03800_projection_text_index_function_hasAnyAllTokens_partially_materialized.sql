...
ALTER TABLE tab ADD PROJECTION idx INDEX message TYPE text(tokenizer = 'splitByString');
...
ALTER TABLE tab ADD PROJECTION idx INDEX message TYPE text(tokenizer = 'splitByNonAlpha');
