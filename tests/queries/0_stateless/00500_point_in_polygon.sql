...
SELECT 'multipolygon with one polygon with holes';
SELECT pointInPolygon((0.5, 1.5), [[[(0., 0.), (7., 0.), (7., 3.), (0., 3.)], [(1., 1.), (2., 1.), (2., 2.), (1., 2.)], [(3., 1.), (4., 1.), (4., 2.), (3., 2.)], [(5., 1.), (6., 1.), (6., 2.), (5., 2.)]]]);
SELECT pointInPolygon((1.5, 1.5), [[[(0., 0.), (7., 0.), (7., 3.), (0., 3.)], [(1., 1.), (2., 1.), (2., 2.), (1., 2.)], [(3., 1.), (4., 1.), (4., 2.), (3., 2.)], [(5., 1.), (6., 1.), (6., 2.), (5., 2.)]]]);
SELECT pointInPolygon((2.5, 1.5), [[[(0., 0.), (7., 0.), (7., 3.), (0., 3.)], [(1., 1.), (2., 1.), (2., 2.), (1., 2.)], [(3., 1.), (4., 1.), (4., 2.), (3., 2.)], [(5., 1.), (6., 1.), (6., 2.), (5., 2.)]]]);
SELECT pointInPolygon((3.5, 1.5), [[[(0., 0.), (7., 0.), (7., 3.), (0., 3.)], [(1., 1.), (2., 1.), (2., 2.), (1., 2.)], [(3., 1.), (4., 1.), (4., 2.), (3., 2.)], [(5., 1.), (6., 1.), (6., 2.), (5., 2.)]]]);
...
SELECT 'multipolygon with two polygons with holes';
SELECT pointInPolygon((1.5, 8.), [[[(0.,0.),(4.,0.),(4.,4.),(0.,4.),(0.,0.)],[(1.,1.),(2.,1.),(2.,2.),(1.,2.),(1.,1.)]], [[(6.,0.),(10.,0.),(10.,4.),(6.,4.),(6.,0.)],[(7.,1.),(9.,1.),(9.,3.),(7.,3.),(7.,1.)]], [[(0.,6.),(4.,6.),(4.,10.),(0.,10.),(0.,6.)],[(1.,7.5),(3.,7.5),(3.,8.5),(1.,8.5),(1.,7.5)]], [[(6.,6.),(10.,6.),(10.,10.),(6.,10.),(6.,6.)],[(7.,7.),(8.,7.),(8.,8.),(7.,8.),(7.,7.)]]]);
SELECT pointInPolygon((0.5, 1.5), [[[(0.,0.),(6.,0.),(6.,4.),(0.,4.),(0.,0.)],[(1.,1.),(2.,1.),(2.,2.),(1.,2.),(1.,1.)],[(4.,1.),(5.,1.),(5.,2.),(4.,2.),(4.,1.)]],[[(8.,0.),(14.,0.),(14.,5.),(8.,5.),(8.,0.)],[(9.,1.),(11.,1.),(11.,3.),(9.,3.),(9.,1.)],[(10.,3.5),(12.,3.5),(12.,4.5),(10.,4.5),(10.,3.5)]]]);


SELECT 'multipolygon with two polygons with holes (variadic)';
SELECT pointInPolygon((1.5, 8.), [[(0.,0.),(4.,0.),(4.,4.),(0.,4.),(0.,0.)],[(1.,1.),(2.,1.),(2.,2.),(1.,2.),(1.,1.)]], [[(6.,0.),(10.,0.),(10.,4.),(6.,4.),(6.,0.)],[(7.,1.),(9.,1.),(9.,3.),(7.,3.),(7.,1.)]], [[(0.,6.),(4.,6.),(4.,10.),(0.,10.),(0.,6.)],[(1.,7.5),(3.,7.5),(3.,8.5),(1.,8.5),(1.,7.5)]], [[(6.,6.),(10.,6.),(10.,10.),(6.,10.),(6.,6.)],[(7.,7.),(8.,7.),(8.,8.),(7.,8.),(7.,7.)]]);
SELECT pointInPolygon((0.5, 1.5), [[(0.,0.),(6.,0.),(6.,4.),(0.,4.),(0.,0.)],[(1.,1.),(2.,1.),(2.,2.),(1.,2.),(1.,1.)],[(4.,1.),(5.,1.),(5.,2.),(4.,2.),(4.,1.)]],[[(8.,0.),(14.,0.),(14.,5.),(8.,5.),(8.,0.)],[(9.,1.),(11.,1.),(11.,3.),(9.,3.),(9.,1.)],[(10.,3.5),(12.,3.5),(12.,4.5),(10.,4.5),(10.,3.5)]]);
