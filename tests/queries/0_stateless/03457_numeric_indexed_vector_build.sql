...
-- Normalize value_type: UInt64 demangles to 'unsigned long long' on macOS libc++ (vs 'unsigned long' on Linux).
select replaceRegexpAll(numericIndexedVectorShortDebugString(groupNumericIndexedVectorState(uin, value)), '"value_type":"unsigned long long"', '"value_type":"unsigned long"') from uin_value_details;
...
select replaceRegexpAll(numericIndexedVectorShortDebugString(groupNumericIndexedVectorStateIf(uin, value, ds = '2023-12-26')), '"value_type":"unsigned long long"', '"value_type":"unsigned long"') from uin_value_details;
select replaceRegexpAll(numericIndexedVectorShortDebugString(groupNumericIndexedVectorStateIf(uin, value, ds = '2023-12-27')), '"value_type":"unsigned long long"', '"value_type":"unsigned long"') from uin_value_details;
