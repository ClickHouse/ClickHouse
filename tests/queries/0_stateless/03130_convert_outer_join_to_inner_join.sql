...
SETTINGS query_plan_join_swap_table = 'false', enable_join_runtime_filters = 0, query_plan_merge_expressions = 1, query_plan_merge_filter_into_join_condition = 0, query_plan_split_filter = 0, query_plan_filter_push_down = 1, query_plan_optimize_lazy_materialization = 0, query_plan_convert_outer_join_to_inner_join = 1
;
