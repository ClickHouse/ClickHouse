...
SELECT 'one ge hash' AS cell, min(ok) AS all_ok, groupArrayIf((id, expected, got), NOT ok) AS mismatches FROM (SELECT g.id AS id, o.v AS expected, g.got AS got, o.v = g.got AS ok FROM (SELECT l.id AS id, groupArray(r.v) AS got FROM l_one AS l ASOF LEFT JOIN r_nan AS r ON l.e = r.e AND l.t >= r.t GROUP BY l.id) AS g JOIN (SELECT id, v FROM asof_oracle WHERE src = 'one' AND op = 'ge') AS o ON o.id = g.id) SETTINGS join_algorithm = 'hash';
SELECT 'one gt hash' AS cell, min(ok) AS all_ok, groupArrayIf((id, expected, got), NOT ok) AS mismatches FROM (SELECT g.id AS id, o.v AS expected, g.got AS got, o.v = g.got AS ok FROM (SELECT l.id AS id, groupArray(r.v) AS got FROM l_one AS l ASOF LEFT JOIN r_nan AS r ON l.e = r.e AND l.t >  r.t GROUP BY l.id) AS g JOIN (SELECT id, v FROM asof_oracle WHERE src = 'one' AND op = 'gt') AS o ON o.id = g.id) SETTINGS join_algorithm = 'hash';
SELECT 'one le hash' AS cell, min(ok) AS all_ok, groupArrayIf((id, expected, got), NOT ok) AS mismatches FROM (SELECT g.id AS id, o.v AS expected, g.got AS got, o.v = g.got AS ok FROM (SELECT l.id AS id, groupArray(r.v) AS got FROM l_one AS l ASOF LEFT JOIN r_nan AS r ON l.e = r.e AND l.t <= r.t GROUP BY l.id) AS g JOIN (SELECT id, v FROM asof_oracle WHERE src = 'one' AND op = 'le') AS o ON o.id = g.id) SETTINGS join_algorithm = 'hash';
SELECT 'one lt hash' AS cell, min(ok) AS all_ok, groupArrayIf((id, expected, got), NOT ok) AS mismatches FROM (SELECT g.id AS id, o.v AS expected, g.got AS got, o.v = g.got AS ok FROM (SELECT l.id AS id, groupArray(r.v) AS got FROM l_one AS l ASOF LEFT JOIN r_nan AS r ON l.e = r.e AND l.t <  r.t GROUP BY l.id) AS g JOIN (SELECT id, v FROM asof_oracle WHERE src = 'one' AND op = 'lt') AS o ON o.id = g.id) SETTINGS join_algorithm = 'hash';
...
SELECT 'multi ge hash' AS cell, min(ok) AS all_ok, groupArrayIf((id, expected, got), NOT ok) AS mismatches FROM (SELECT g.id AS id, o.v AS expected, g.got AS got, o.v = g.got AS ok FROM (SELECT l.id AS id, groupArray(r.v) AS got FROM l_multi AS l ASOF LEFT JOIN r_clean AS r ON l.e = r.e AND l.t >= r.t GROUP BY l.id) AS g JOIN (SELECT id, v FROM asof_oracle WHERE src = 'multi' AND op = 'ge') AS o ON o.id = g.id) SETTINGS join_algorithm = 'hash';
SELECT 'multi gt hash' AS cell, min(ok) AS all_ok, groupArrayIf((id, expected, got), NOT ok) AS mismatches FROM (SELECT g.id AS id, o.v AS expected, g.got AS got, o.v = g.got AS ok FROM (SELECT l.id AS id, groupArray(r.v) AS got FROM l_multi AS l ASOF LEFT JOIN r_clean AS r ON l.e = r.e AND l.t >  r.t GROUP BY l.id) AS g JOIN (SELECT id, v FROM asof_oracle WHERE src = 'multi' AND op = 'gt') AS o ON o.id = g.id) SETTINGS join_algorithm = 'hash';
SELECT 'multi le hash' AS cell, min(ok) AS all_ok, groupArrayIf((id, expected, got), NOT ok) AS mismatches FROM (SELECT g.id AS id, o.v AS expected, g.got AS got, o.v = g.got AS ok FROM (SELECT l.id AS id, groupArray(r.v) AS got FROM l_multi AS l ASOF LEFT JOIN r_clean AS r ON l.e = r.e AND l.t <= r.t GROUP BY l.id) AS g JOIN (SELECT id, v FROM asof_oracle WHERE src = 'multi' AND op = 'le') AS o ON o.id = g.id) SETTINGS join_algorithm = 'hash';
SELECT 'multi lt hash' AS cell, min(ok) AS all_ok, groupArrayIf((id, expected, got), NOT ok) AS mismatches FROM (SELECT g.id AS id, o.v AS expected, g.got AS got, o.v = g.got AS ok FROM (SELECT l.id AS id, groupArray(r.v) AS got FROM l_multi AS l ASOF LEFT JOIN r_clean AS r ON l.e = r.e AND l.t <  r.t GROUP BY l.id) AS g JOIN (SELECT id, v FROM asof_oracle WHERE src = 'multi' AND op = 'lt') AS o ON o.id = g.id) SETTINGS join_algorithm = 'hash';
