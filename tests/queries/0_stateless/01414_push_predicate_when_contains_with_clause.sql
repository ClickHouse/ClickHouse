...
EXPLAIN SYNTAX SELECT number, square_number FROM ( WITH number * 2 AS square_number SELECT number, square_number FROM default.numbers_indexed) AS squares WHERE number = 999;
