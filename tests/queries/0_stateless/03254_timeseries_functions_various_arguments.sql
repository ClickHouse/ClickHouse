...
SELECT timeSeriesLastToGrid(10, 120, 10, 10)(timestamps, values) FROM ts_data; -- {serverError BAD_ARGUMENTS}
...
SELECT 'staleness = 10:';
SELECT timeSeriesLastToGrid(10, 120, 10, 10)(timestamps, values) FROM (SELECT * FROM ts_data WHERE length(timestamps) = length(values));
SELECT timeSeriesLastToGrid(10, 120, 10, 10)(timestamps, values) FROM ts_data WHERE length(timestamps) = length(values);
SELECT timeSeriesLastToGridIf(10, 120, 10, 10)(timestamps, values, length(timestamps) = length(values)) FROM ts_data;
SELECT timeSeriesLastToGridIf(10, 120, 10, 10)(timestamps, values, toNullable(length(timestamps) = length(values))) FROM ts_data;

SELECT 'staleness = 11:';
SELECT timeSeriesLastToGrid(10, 120, 10, 11)(timestamps, values) FROM (SELECT * FROM ts_data WHERE length(timestamps) = length(values));
SELECT timeSeriesLastToGrid(10, 120, 10, 11)(timestamps, values) FROM ts_data WHERE length(timestamps) = length(values);
SELECT timeSeriesLastToGridIf(10, 120, 10, 11)(timestamps, values, length(timestamps) = length(values)) FROM ts_data;
SELECT timeSeriesLastToGridIf(10, 120, 10, 11)(timestamps, values, toNullable(length(timestamps) = length(values))) FROM ts_data;
...
SELECT timeSeriesLastToGrid(100, 110, 15, 10)([89, 101, 109]::Array(UInt32), [89, 101, 109]::Array(Float32));
SELECT timeSeriesLastToGrid(100, 120, 15, 10)([89, 101, 109]::Array(UInt32), [89, 101, 109]::Array(Float32));
SELECT timeSeriesLastToGrid(100, 100, 1, 11)([89]::Array(UInt32), [89]::Array(Float32));
SELECT timeSeriesLastToGrid(100, 100, 1, 12)([89]::Array(UInt32), [89]::Array(Float32));
SELECT timeSeriesLastToGrid(100, 120, 10, 10)([95, 110]::Array(UInt32), [95, 110]::Array(Float32));
SELECT timeSeriesLastToGrid(100, 120, 15, 10)([101]::Array(UInt32), [101]::Array(Float32));
...
SELECT timeSeriesLastToGrid(105, 210, 15, 30)([110, 120, 130, 140, 190, 200, 210, 220, 230]::Array(UInt32), [1, 1, 3, 4, 5, 5, 8, 12, 13]::Array(Float32));
SELECT timeSeriesLastToGrid(105, 210, 15, 300)([110, 120, 130, 140, 190, 200, 210, 220, 230]::Array(UInt32), [1, 1, 3, 4, 5, 5, 8, 12, 13]::Array(Float32));
SELECT timeSeriesLastToGrid(90, 210, 15, 300)([110, 120, 130, 140, 190, 200, 210, 220, 230]::Array(UInt32), [1, 1, 3, 4, 5, 5, 8, 12, 13]::Array(Float32));

SELECT timeSeriesLastToGrid(100, 150, 10, 30)(toDateTime(105), [1., 2., 3.]); -- {serverError ILLEGAL_TYPE_OF_ARGUMENT}
...
SELECT timeSeriesLastToGrid(100, 150, 10, 30)(toDateTime(105), arrayJoin([1., 2., 3.]));
...
SELECT timeSeriesLastToGridMerge(toNullable(60), 100, 200, 20)(
    initializeAggregation('timeSeriesLastToGridState(100, 200, 20, 60)', (100 + number*10)::DateTime32, number::Float64)
...
SELECT timeSeriesLastToGridMerge(60, 100, 200, 20)(
    initializeAggregation('timeSeriesLastToGridState(100, 200, 20, 60)', (100 + number*10)::DateTime32, number::Float64)
) FROM numbers(5); -- {serverError ILLEGAL_TYPE_OF_ARGUMENT}

-- With matching parameters everything should work
SELECT timeSeriesLastToGridMerge(100, 200, 20, 60)(
    initializeAggregation('timeSeriesLastToGridState(100, 200, 20, 60)', (100 + number*10)::DateTime32, number::Float64)
) FROM numbers(5);
