...
SET query_cache_tag = '03381_query_result_cache_scalar_subqueries';

SET enable_analyzer = 1;

SYSTEM CLEAR QUERY CACHE TAG '03381_query_result_cache_scalar_subqueries';
...
SELECT count(*) FROM (SELECT * FROM system.query_cache WHERE tag = '03381_query_result_cache_scalar_subqueries') AS test_query_cache WHERE is_subquery = 1;
