...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_pk_prefix_1col LIMIT 5 BY a SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_pk_prefix_2col LIMIT 5 BY a, b SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_pk_prefix_full LIMIT 5 BY a, b, c SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_where_fixed WHERE a = 1 LIMIT 5 BY b SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_where_irrelevant WHERE z > 5 LIMIT 5 BY a SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, z FROM test_monotonic_function LIMIT 5 BY toStartOfHour(a) SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, z FROM test_negative_monotonic LIMIT 5 BY negate(a) SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_with_offset LIMIT 5 OFFSET 2 BY a SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_middle_column LIMIT 5 BY b SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_last_column LIMIT 5 BY c SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_skip_prefix LIMIT 5 BY a, c SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_non_pk_column LIMIT 5 BY z SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_order_by_non_pk ORDER BY z LIMIT 5 BY a SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_multi_where_fixed WHERE a = 1 AND b = 2 LIMIT 5 BY c SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_where_fixed_by_tail WHERE a = 1 LIMIT 5 BY b, c SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_interleaved_fixed_by WHERE b = 2 LIMIT 5 BY a, c SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, z FROM test_injective_wrapped WHERE toString(a) = '1' LIMIT 5 BY b SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_transitively_fixed WHERE a = 1 AND b = 2 LIMIT 5 BY c SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, z FROM test_monotonic_chain LIMIT 5 BY a, intDiv(b, 100) SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, z FROM test_creating_sets WHERE a IN (SELECT x FROM test_creating_sets_in) LIMIT 5 BY a SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, x FROM test_array_join ARRAY JOIN arr AS x LIMIT 5 BY a SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
-- Each child's ReadFromMergeTree reads in PK order, and the single LimitByTransform above
-- ReadFromMerge runs in (InOrder) mode.
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, z FROM test_merge_wrap LIMIT 5 BY a SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, z FROM test_merge_nonpk_wrap LIMIT 5 BY z SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
...
SELECT replaceRegexpOne(explain, '^[ ]*(.*)', '\1') FROM (EXPLAIN PIPELINE SELECT a, b, c, z FROM test_multi_and WHERE a = 1 AND z > 0 AND b = 2 LIMIT 5 BY c SETTINGS optimize_limit_by_in_order = 1) WHERE explain LIKE '%LimitByTransform%';
