...
INSERT INTO test_outer_limit SELECT number % 100000, number % 97, number % 7, number FROM numbers_mt(1e6) SETTINGS max_insert_block_size = 1000000;
...
INSERT INTO test_outer_limit_stateful SELECT number % 100000, number % 97, number % 7, number FROM numbers_mt(1e6) SETTINGS max_insert_block_size = 1000000;
