...
SETTINGS ratio_of_defaults_for_sparse_serialization = 0.9, serialization_info_version = 'default'
...
SETTINGS ratio_of_defaults_for_sparse_serialization = 1.0, serialization_info_version = 'default'
