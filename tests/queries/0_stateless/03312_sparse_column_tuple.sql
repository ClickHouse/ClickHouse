...
SETTINGS ratio_of_defaults_for_sparse_serialization = 0.9, serialize_string_with_size_stream = 0
...
SETTINGS ratio_of_defaults_for_sparse_serialization = 1.0, serialize_string_with_size_stream = 0
