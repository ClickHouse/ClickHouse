...
CREATE TABLE tab(k UInt64, s String, INDEX af(s) TYPE text(tokenizer = 'ngrams', ngram_size = 2) GRANULARITY 1)
...
ALTER TABLE tab ADD INDEX af(s) TYPE text(tokenizer = 'ngrams', ngram_size = 2) GRANULARITY 1 SETTINGS mutations_sync = 2;
