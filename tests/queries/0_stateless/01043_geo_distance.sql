...
SELECT round(greatCircleDistance(0., 0., 90., 0.), 8);
SELECT round(greatCircleDistance(0., 0., 0., 90.), 8);

SELECT round(geoDistance(0., 0., 90., 0.), 8);
SELECT round(geoDistance(0., 0., 0., 90.), 8);
