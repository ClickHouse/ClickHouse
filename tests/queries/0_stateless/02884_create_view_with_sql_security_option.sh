...
${CLICKHOUSE_CLIENT} --query "CREATE TABLE $db.test_table (s String) ENGINE = MergeTree ORDER BY s;"

${CLICKHOUSE_CLIENT} --query "DROP USER IF EXISTS $user1, $user2, $user3";
${CLICKHOUSE_CLIENT} --query "CREATE USER $user1, $user2, $user3";

${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.* TO $user1"
...
${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.test_view_1 TO $user2"
${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.test_view_2 TO $user2"
${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.test_view_3 TO $user2"
${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.test_view_4 TO $user2"
${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.test_view_5 TO $user2"
${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.test_view_6 TO $user2"
${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.test_view_7 TO $user2"
${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.test_view_8 TO $user2"
${CLICKHOUSE_CLIENT} --query "GRANT SELECT ON $db.test_view_9 TO $user2"
