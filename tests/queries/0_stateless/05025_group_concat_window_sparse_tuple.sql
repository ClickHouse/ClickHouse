...
-- The sparse element can also be hidden one wrapper deeper, under a Nullable.
...
INSERT INTO t_group_concat_sparse_nullable_tuple SELECT tuple(if(number % 200 = 0, 'y', '')) FROM numbers(4000);
