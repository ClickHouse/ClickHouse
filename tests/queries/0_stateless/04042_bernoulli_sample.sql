...
-- SAMPLE + STREAM rejection is covered by 04758_bernoulli_sample_streaming_queries_rejected
-- (kept separate because the style check requires `_streaming_queries_` in the name of any test
-- that sets `enable_streaming_queries`).
