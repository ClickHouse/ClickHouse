...
select dumpColumnStructure(*) from sparse limit 1 SETTINGS max_block_size = 1, query_plan_optimize_lazy_materialization = 0, query_plan_execute_functions_after_sorting = 0;
