...
-- Numeric inputs now honour date_time_overflow_behavior: throw mode rejects the value instead of
-- saturating it. The saturation above is what the other two modes do.
