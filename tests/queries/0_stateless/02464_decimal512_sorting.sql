...
SELECT * FROM test_decimal512_sort ORDER BY value, id;

-- Test descending sort
SELECT '=== Descending sort ===';
SELECT * FROM test_decimal512_sort ORDER BY value DESC, id;
...
SELECT * FROM test_decimal512_sort_negative ORDER BY value, id;
SELECT * FROM test_decimal512_sort_negative ORDER BY value DESC, id;
...
SELECT * FROM test_decimal512_sort_zero ORDER BY value, id;
SELECT * FROM test_decimal512_sort_zero ORDER BY value DESC, id;
...
SELECT * FROM test_decimal512_sort_identical ORDER BY value, id;
SELECT * FROM test_decimal512_sort_identical ORDER BY value DESC, id;
...
SELECT * FROM test_decimal512_sort_large ORDER BY value, id;
SELECT * FROM test_decimal512_sort_large ORDER BY value DESC, id;

-- Test LIMIT with ORDER BY
SELECT '=== LIMIT with ORDER BY ===';
SELECT * FROM test_decimal512_sort ORDER BY value, id LIMIT 3;
SELECT * FROM test_decimal512_sort ORDER BY value DESC, id LIMIT 3;
