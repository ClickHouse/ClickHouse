...
ALTER TABLE t_text_index ADD PROJECTION idx_text INDEX lower(s1) TYPE text(tokenizer = splitByNonAlpha);
...
ALTER TABLE t_text_index ADD PROJECTION idx_text INDEX concat(s1, ' ', s2) TYPE text(tokenizer = splitByNonAlpha);
