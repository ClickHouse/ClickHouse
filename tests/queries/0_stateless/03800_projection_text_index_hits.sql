...
ALTER TABLE hits_text ADD PROJECTION idx_search_phrase INDEX SearchPhrase TYPE text(tokenizer = 'splitByNonAlpha');
ALTER TABLE hits_text ADD PROJECTION idx_url INDEX URL TYPE text(tokenizer = 'splitByNonAlpha');
