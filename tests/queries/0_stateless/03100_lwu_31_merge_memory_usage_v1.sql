...
-- Clone of 03100_lwu_31_merge_memory_usage with the legacy patch part format (`patch_parts_version = 'v1'`).
...
OPTIMIZE TABLE t_lwu_memory PARTITION ID 'patch-a257a8c31cf3c615f349784eb5553ff7-all' FINAL;
