...
SELECT '-- Test NULL FixedString uses the nested default';
SELECT arrayMap(hex, tokens(CAST(NULL AS Nullable(FixedString(4))), 'array'));
SELECT arrayMap(hex, tokens(CAST(NULL AS Nullable(FixedString(4))), 'ngrams', 4));
SELECT arrayMap(hex, tokens(nullIf(materialize(toFixedString('hide', 4)), materialize(toFixedString('hide', 4))), 'array'));
...
SELECT arrayMap(a -> arrayMap(hex, a), extractAllGroups(CAST(NULL AS Nullable(FixedString(4))), '(.)'));
SELECT arrayMap(a -> arrayMap(hex, a), extractAllGroups(nullIf(materialize(toFixedString('hide', 4)), materialize(toFixedString('hide', 4))), '(.)'));
...
SELECT arrayMap(a -> arrayMap(hex, a), extractAllGroupsHorizontal(CAST(NULL AS Nullable(FixedString(4))), '(.)'));
...
SELECT arrayMap(a -> arrayMap(hex, a), extractAllGroupsVertical(CAST(NULL AS Nullable(FixedString(4))), '(.)'));

SELECT '-- Test ngrams with nullable';
SELECT ngrams(toNullable('ClickHouse'), 3);
SELECT ngrams(CAST(NULL AS Nullable(String)), 3);
SELECT arrayMap(hex, ngrams(CAST(NULL AS Nullable(FixedString(4))), 4));
SELECT arrayMap(hex, ngrams(nullIf(materialize(toFixedString('hide', 4)), materialize(toFixedString('hide', 4))), 4));
