...
select round(h3CellAreaM2(585763170430222335 + d * 549755813888), 0) as res, toTypeName(res) from test;
select round(h3CellAreaRads2(585763170430222335 + d * 549755813888), 10) as res, toTypeName(res) from test;
