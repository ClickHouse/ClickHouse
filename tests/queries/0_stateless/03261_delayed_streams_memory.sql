...
SETTINGS min_bytes_for_wide_part = 0, ratio_of_defaults_for_sparse_serialization = 1.0, serialize_string_with_size_stream = 0, max_compress_block_size = '1M', storage_policy = 's3_cache';
