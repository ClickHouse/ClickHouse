...
SETTINGS min_bytes_for_wide_part = 0, ratio_of_defaults_for_sparse_serialization = 1.0, serialization_info_version = 'default', max_compress_block_size = '1M', storage_policy = 's3_cache', auto_statistics_types = '';
