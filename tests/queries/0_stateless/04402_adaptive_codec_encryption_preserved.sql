...
SETTINGS min_bytes_for_wide_part = 0, enable_adaptive_codec_selection = 1, default_compression_codec = 'LZ4, AES_128_GCM_SIV', optimize_row_order_if_no_order_by = 0;
...
ENGINE = MergeTree ORDER BY tuple()
SETTINGS min_bytes_for_wide_part = 0, enable_adaptive_codec_selection = 1, default_compression_codec = 'LZ4', optimize_row_order_if_no_order_by = 0;
