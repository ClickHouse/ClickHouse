...
duckdb ${DB_PATH} "CREATE TABLE t3 (a REAL, b DOUBLE, c BOOL)"
...
duckdb ${DB_PATH} "INSERT INTO t3 VALUES (0.123456789, 0.123456789, 1)"
duckdb ${DB_PATH} "INSERT INTO t3 VALUES (-0.123456789, -0.123456789, 0)"
...
${CLICKHOUSE_CLIENT} -q "INSERT INTO ${DB_NAME}.t6 SELECT number, rand32(), rand64() FROM numbers(1000000)"
