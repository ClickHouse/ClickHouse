...
-- SELECT quantile(0.5)(b), quantile(0.9)(b) from (SELECT x as b, quantile(0.5)(b) as x, quantile(0.9)(b) FROM (SELECT quantile(0.5)(b) as x, quantile(0.9)(b)  FROM fuse_tbl) );
