...
INSERT INTO tdm2 VALUES (toUnixTimestamp('2000-01-01 13:12:12', 'Europe/Moscow')), (toUnixTimestamp('2000-01-01 14:12:12', 'Europe/Moscow')), (toUnixTimestamp('2000-01-01 15:12:12', 'Europe/Moscow'));
SET max_rows_to_read = 1;
SELECT toDateTime(timestamp, 'Europe/Moscow') FROM tdm2 WHERE toHour(toDateTime(timestamp, 'Europe/Moscow')) = 13;
