...
INSERT INTO dictionary_group_array_insert_at SETTINGS max_threads = 1, max_insert_threads = 1
VALUES (0, 0, 'a', 10);
INSERT INTO dictionary_group_array_insert_at SETTINGS max_threads = 1, max_insert_threads = 1
VALUES (1, 1, 'a', 20), (1, 2, 'b', 30);
...
-- Keep fixture execution settings query-local so they do not affect the shared query-log scan.
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    group_by_two_level_threshold = 0, group_by_two_level_threshold_bytes = 0,
    max_bytes_before_external_group_by = 0, max_bytes_ratio_before_external_group_by = 0,
    log_comment = '05091_dictionary_group_array_insert_at/single-level';
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    max_bytes_before_external_group_by = 0, max_bytes_ratio_before_external_group_by = 0,
    log_comment = '05091_dictionary_group_array_insert_at/two-level';
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    group_by_two_level_threshold = 0, group_by_two_level_threshold_bytes = 0,
    max_bytes_before_external_group_by = 0, max_bytes_ratio_before_external_group_by = 0,
    log_comment = '05091_dictionary_group_array_insert_at/control';
