...
SET query_cache_tag = '03381_query_result_cache_subquery_settings_propagation';

SET enable_analyzer = 1;

SYSTEM CLEAR QUERY CACHE TAG '03381_query_result_cache_subquery_settings_propagation';
...
SELECT count(*) FROM (SELECT * FROM system.query_cache WHERE tag = '03381_query_result_cache_subquery_settings_propagation') AS test_query_cache WHERE is_subquery = 1;
-- Expected: 0
...
SELECT count(*) FROM (SELECT * FROM system.query_cache WHERE tag = '03381_query_result_cache_subquery_settings_propagation') AS test_query_cache;
-- Expected: 0
...
SELECT number FROM (SELECT number FROM numbers(5) SETTINGS use_query_cache = true);
SELECT count(*) FROM (SELECT * FROM system.query_cache WHERE tag = '03381_query_result_cache_subquery_settings_propagation') AS test_query_cache WHERE is_subquery = 0;
