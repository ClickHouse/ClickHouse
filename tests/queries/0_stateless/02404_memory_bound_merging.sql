...
-- Test asserts in-order aggregation is used; the small table here selects all granules,
-- which would otherwise trigger the PK-selectivity fallback to parallel reading.
