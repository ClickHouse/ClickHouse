...
create table dist_pr_t as t engine = Distributed(test_cluster_one_shard_three_replicas_localhost, currentDatabase(), t);

-- { echoOn } --
explain pipeline select * from dist_pr_t group by a order by a limit 5 offset 100500;

select * from dist_pr_t group by a order by a limit 5 offset 100500;
