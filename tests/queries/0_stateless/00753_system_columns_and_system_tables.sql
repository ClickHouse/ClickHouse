...
FROM system.tables
WHERE database = currentDatabase() and name = 'check_system_tables'
FORMAT PrettyCompactNoEscapes;

SELECT name, is_in_partition_key, is_in_sorting_key, is_in_primary_key, is_in_sampling_key
FROM system.columns
WHERE database = currentDatabase() and table = 'check_system_tables'
FORMAT PrettyCompactNoEscapes;
...
SELECT lifetime_bytes, lifetime_rows FROM system.tables WHERE database = currentDatabase() and name = 'check_system_tables';
