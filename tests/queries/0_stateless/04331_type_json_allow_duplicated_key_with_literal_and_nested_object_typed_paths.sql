...
select '{"a" : 42, "a" : {"b" : 42}}'::JSON(a Int32) as json, json.a, json.a.b, json.^a;

-- Basic: typed path with object first, literal second
select '{"a" : {"b" : 42}, "a" : 42}'::JSON(a Int32) as json, json.a, json.a.b, json.^a;

-- Typed path for nested key
select '{"a" : {"b" : 42, "b" : {"c" : 42}}}'::JSON(a.b Int32) as json, json.a.b, json.a.b.c;

-- Multiple typed paths
select '{"a" : 42, "a" : {"b" : 42}, "c" : "hello", "c" : {"d" : 1}}'::JSON(a Int32, c String) as json, json.a, json.c, json.a.b, json.c.d;

-- Typed path with Nullable type
select '{"a" : 42, "a" : {"b" : 42}}'::JSON(a Nullable(Int32)) as json, json.a, json.a.b;
