...
INSERT INTO samples_table (locality_hash, id, timestamp, value) VALUES
    (xxHash64('foo'), 1583154, toDateTime64(100, 3), 10.),
    (xxHash64('bar'), 2836623, toDateTime64(100, 3), 10.),
    (xxHash64('baz'), 3691271, toDateTime64(100, 3), 20.);
...
--     FROM samples_table
--     WHERE (locality_hash, id) IN (
--         SELECT locality_hash, timeSeriesStoreTags(id, tags, '__name__', metric_name)
--         FROM tags_table
