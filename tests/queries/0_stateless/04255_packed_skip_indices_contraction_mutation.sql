-- Regression: shrinking packed_skip_index_types to an empty (or non-overlapping) value, then
...
ALTER TABLE t_shrink_mutate MODIFY SETTING packed_skip_index_types = '';
