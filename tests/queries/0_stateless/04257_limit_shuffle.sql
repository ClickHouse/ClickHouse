...
DROP DATABASE IF EXISTS limit_shuffle_query_cache_db;
CREATE DATABASE limit_shuffle_query_cache_db;
CREATE TABLE limit_shuffle_query_cache_db.limit_shuffle_plain_local (number UInt64) ENGINE = Memory;
...
SELECT * FROM cluster('test_shard_localhost', 'limit_shuffle_query_cache_db', 'limit_shuffle_plain_local') SETTINGS enable_analyzer = 1, use_query_cache = 1 FORMAT Null;
...
DROP TABLE limit_shuffle_query_cache_db.limit_shuffle_plain_local;
DROP DATABASE limit_shuffle_query_cache_db;
