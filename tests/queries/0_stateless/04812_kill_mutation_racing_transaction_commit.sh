...
# Tag rationale: transactions are unsupported in Ordinary databases; enables server-wide failpoints.
#
...
$CLICKHOUSE_CLIENT -q "DROP TABLE t_kill_race; DROP TABLE t_kill_race_2"
