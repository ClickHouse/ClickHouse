...
cat $CURDIR/data_csv/csv_empty_for_string_field.csv | ${CLICKHOUSE_CLIENT} -q "INSERT INTO test_tbl SETTINGS input_format_csv_empty_as_default=true, input_format_csv_empty_not_as_null_for_nullable_string_field=true FORMAT CSV"
