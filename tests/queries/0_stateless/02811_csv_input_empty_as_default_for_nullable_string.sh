...
# By default (input_format_csv_empty_string_is_not_null = 0) an empty unquoted value of a nullable string column
...
# With input_format_csv_empty_string_is_not_null = 1, the empty value of a nullable string column
