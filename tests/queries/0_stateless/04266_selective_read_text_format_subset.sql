...
INSERT INTO FUNCTION file(currentDatabase() || '_04266_selective_read_with_names.csv', 'CSVWithNames', 'c1 String, c2 UInt32')
SELECT 'not_uint', 42
SETTINGS engine_file_truncate_on_insert = 1;

SELECT c2
FROM file(currentDatabase() || '_04266_selective_read_with_names.csv', 'CSV', 'c1 UInt32, c2 UInt32');

INSERT INTO FUNCTION file(currentDatabase() || '_04266_selective_read_hive/p=7/data.csv', 'CSV', 'c2 UInt32')
SELECT 42
SETTINGS engine_file_truncate_on_insert = 1;

SELECT c2
FROM file(currentDatabase() || '_04266_selective_read_hive/p=7/data.csv', 'CSV', 'p UInt32, c2 UInt32')
SETTINGS use_hive_partitioning = 1, input_format_csv_detect_header = 0;
