...
SELECT DISTINCT id FROM dist_01213 ORDER BY id SETTINGS optimize_skip_unused_shards=1, optimize_distributed_group_by_sharding_key=0;
...
SELECT DISTINCT id FROM dist_01213 ORDER BY id SETTINGS optimize_skip_unused_shards=1, optimize_distributed_group_by_sharding_key=1;
