...
cat $CURDIR/data_csv/csv_with_input_row_diff_number_fields.csv | ${CLICKHOUSE_CLIENT} -q "INSERT INTO test_tbl SETTINGS input_format_csv_ignore_if_input_too_many_fields=true FORMAT CSV"
