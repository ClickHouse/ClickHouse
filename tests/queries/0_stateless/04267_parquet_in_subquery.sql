-- Tags: no-fasttest
-- Regression for #100743: IN (subquery) on Parquet must push down to page index / row-group stats / bloom filter, same as a literal IN.
...
WHERE event_date >= yesterday()
  ...
  AND log_comment IN ('100743_literal', '100743_subquery', '100743_cte')
