...
EXPLAIN PLAN SELECT 1 + number from system.numbers LIMIT 1 SETTINGS query_plan_merge_expressions = 1, query_plan_execute_functions_after_sorting = 0;
...
EXPLAIN PIPELINE SELECT 1 + number from system.numbers LIMIT 1 SETTINGS query_plan_merge_expressions = 1, query_plan_execute_functions_after_sorting = 0;
