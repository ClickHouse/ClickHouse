...
select count() > 0 from system.text_log where event_date >= yesterday() AND event_time >= now() - 600 and level = 'Error' and message_format_string = 'Unknown {}{} identifier {} in scope {}{}' and value1 = 'expression' and value3 = '\`count\`' and value4 = 'SELECT count' and query_id = '${query_id}_1';
