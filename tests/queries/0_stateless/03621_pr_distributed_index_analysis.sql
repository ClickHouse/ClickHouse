...
select
  ...
  if(
    ...
    anyIf(Settings['allow_experimental_parallel_reading_from_replicas'], is_initial_query) = '1',
    if(anyIf(Settings['cluster_for_parallel_replicas'], is_initial_query) = 'parallel_replicas',
