...
CREATE TABLE _01902_db.t4 (n Date) ENGINE=MergeTree ORDER BY n;
INSERT INTO _01902_db.t4   SELECT * FROM numbers(10);
SELECT NULL FROM _01902_db.t_merge WHERE n ORDER BY _table DESC; -- {serverError ILLEGAL_TYPE_OF_COLUMN_FOR_FILTER}
