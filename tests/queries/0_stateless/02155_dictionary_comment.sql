...
SELECT name, comment FROM system.dictionaries WHERE name == '02155_test_dictionary';
...
SELECT name, comment FROM system.dictionaries WHERE name == '02155_test_dictionary';
SELECT name, comment FROM system.tables WHERE name == '02155_test_dictionary';
...
(
    id UInt64,
    value String
) ENGINE=Dictionary('02155_test_dictionary');
...
SELECT name, comment FROM system.tables WHERE name == '02155_test_dictionary_view';
SELECT name, comment FROM system.tables WHERE name == '02155_test_dictionary_view';
