...
-- The behaviour agrees with the 64-bit source in every overflow mode. The numeric conversion to `DateTime`
-- does not consult `throw` (a separate, pre-existing gap); the `DateTime64` and `Time64` ones reject the value.
