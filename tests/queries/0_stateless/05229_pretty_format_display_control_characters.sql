...
SELECT 'tab\there' AS value FORMAT Pretty;
SELECT 'tab\there' AS value FORMAT PrettySpace;
...
SELECT 'tab\there' AS value FORMAT PrettyCompact SETTINGS output_format_pretty_display_control_characters = 0;
