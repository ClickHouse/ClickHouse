...
-- resolve it as a real function. serialize_query_plan=1 must disable expression
-- compilation so the shipped plan only ever contains resolvable function names.
