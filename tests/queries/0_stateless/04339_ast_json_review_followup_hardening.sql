...
-- well-formed lambda whose name is not `lambda`, three arguments, and the `APPLY` transformer child
-- (whose own boundary check accepts a two-child lambda whose first argument is not a tuple).
-- ---------------------------------------------------------------------------
