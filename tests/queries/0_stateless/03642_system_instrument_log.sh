...
$CLICKHOUSE_CLIENT -q """
    ...
    SYSTEM INSTRUMENT ADD \`QueryMetricLog::startQuery\` LOG 'this is an instrumentation log';
"""
...
$CLICKHOUSE_CLIENT -q """
    ...
    SELECT count() FROM system.text_log WHERE event_date >= yesterday() AND query_id = '$query_id' AND message ILIKE '%this is an instrumentation log';
    SYSTEM INSTRUMENT REMOVE ALL;
"""
