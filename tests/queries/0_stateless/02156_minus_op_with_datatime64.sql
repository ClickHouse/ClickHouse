...
toDateTime64('2023-10-01 12:00:00', 3) - toDateTime64('2023-10-01 11:00:00', 6) AS result_no_materialize_4,

-- DateTime64 (scale 6) - DateTime64 (scale 3)
toDateTime64('2023-10-01 12:00:00', 6) - toDateTime64('2023-10-01 11:00:00', 3) AS result_no_materialize_5,
...
materialize(toDateTime64('2023-10-01 12:00:00', 3)) - toDateTime64('2023-10-01 11:00:00', 6) AS result_left_materialize_4,

materialize(toDateTime64('2023-10-01 12:00:00', 6)) - toDateTime64('2023-10-01 11:00:00', 3) AS result_left_materialize_5,

materialize(toDateTime('2023-10-01 12:00:00')) - toDateTime64('2023-10-01 11:00:00', 3) AS result_left_materialize_6,

materialize(toDateTime('2023-10-01 12:00:00')) - toDateTime64('2023-10-01 11:00:00', 6) AS result_no_materialize_7;
