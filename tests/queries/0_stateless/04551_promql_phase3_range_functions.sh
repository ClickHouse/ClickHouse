...
promql_client()
{
    $CLICKHOUSE_CLIENT --enable_time_series_table 1 --dialect promql --promql_table ts --promql_evaluation_time 1700000000 "$@"
}
...
$CLICKHOUSE_CLIENT --enable_time_series_table 1 -q "DROP TABLE ts"
$CLICKHOUSE_CLIENT --enable_time_series_table 1 -q "DROP TABLE ts_data"
$CLICKHOUSE_CLIENT --enable_time_series_table 1 -q "DROP TABLE ts_tags"
$CLICKHOUSE_CLIENT --enable_time_series_table 1 -q "DROP TABLE ts_metrics"
