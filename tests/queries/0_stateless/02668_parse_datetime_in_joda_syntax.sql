...
-- Test parseDataTime64InJodaSyntax supports range between 0000 - 9999
select parseDateTime64InJodaSyntax('1899-12-31 23:59:59', 'yyyy-MM-dd HH:mm:ss') = toDateTime64('1899-12-31 23:59:59', 0);
...
select parseDateTime64InJodaSyntax('2300-01-01 00:00:00', 'yyyy-MM-dd HH:mm:ss') = toDateTime64('2300-01-01 00:00:00', 0);
select parseDateTime64InJodaSyntax('9999-12-31 23:59:59', 'yyyy-MM-dd HH:mm:ss') = toDateTime64('9999-12-31 23:59:59', 0);
