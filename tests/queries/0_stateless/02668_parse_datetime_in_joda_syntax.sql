...
-- Test with inputs between 1900 - 2299 using function parseDateTime64InJodaSyntaxOrZero
...
-- Test with inputs between 1900 - 2299 using function parseDateTime64InJodaSyntax
select parseDateTime64InJodaSyntax('1923-05-15 14:45:30.123', 'yyyy-MM-dd HH:mm:ss.SSS') = toDateTime64('1923-05-15 14:45:30.123', 3);
select parseDateTime64InJodaSyntax('2150-11-23 08:22:10.456', 'yyyy-MM-dd HH:mm:ss.SSS') = toDateTime64('2150-11-23 08:22:10.456', 3);
select parseDateTime64InJodaSyntax('2107-07-19 19:30:45.789123', 'yyyy-MM-dd HH:mm:ss.SSSSSS') = toDateTime64('2107-07-19 19:30:45.789123', 6);
select parseDateTime64InJodaSyntax('1909-12-31 23:59:59.999', 'yyyy-MM-dd HH:mm:ss.SSS') = toDateTime64('1909-12-31 23:59:59.999', 3);
select parseDateTime64InJodaSyntax('2200-01-01 00:00:00.000', 'yyyy-MM-dd HH:mm:ss.SSS') = toDateTime64('2200-01-01 00:00:00.000', 3);
select parseDateTime64InJodaSyntax('1924-10-09 10:30:10.123456America/Los_Angeles', 'yyyy-MM-dd HH:mm:ss.SSSSSSz') = toDateTime64('1924-10-09 10:30:10.123456', 6, 'America/Los_Angeles');
select parseDateTime64InJodaSyntax('2299-10-09 10:30:10.123456America/Los_Angeles', 'yyyy-MM-dd HH:mm:ss.SSSSSSz') = toDateTime64('2299-10-09 10:30:10.123456', 6, 'America/Los_Angeles');

-- Test with inputs between 1900 - 2299 using function parseDateTime64InJodaSyntaxOrNull
select parseDateTime64InJodaSyntaxOrNull('1923-05-15 14:45:30.123', 'yyyy-MM-dd HH:mm:ss.SSS') = toDateTime64('1923-05-15 14:45:30.123', 3);
select parseDateTime64InJodaSyntaxOrNull('2150-11-23 08:22:10.456', 'yyyy-MM-dd HH:mm:ss.SSS') = toDateTime64('2150-11-23 08:22:10.456', 3);
select parseDateTime64InJodaSyntaxOrNull('2107-07-19 19:30:45.789123', 'yyyy-MM-dd HH:mm:ss.SSSSSS') = toDateTime64('2107-07-19 19:30:45.789123', 6);
select parseDateTime64InJodaSyntaxOrNull('1909-12-31 23:59:59.999', 'yyyy-MM-dd HH:mm:ss.SSS') = toDateTime64('1909-12-31 23:59:59.999', 3);
select parseDateTime64InJodaSyntaxOrNull('2200-01-01 00:00:00.000', 'yyyy-MM-dd HH:mm:ss.SSS') = toDateTime64('2200-01-01 00:00:00.000', 3);
select parseDateTime64InJodaSyntaxOrNull('1924-10-09 10:30:10.123456America/Los_Angeles', 'yyyy-MM-dd HH:mm:ss.SSSSSSz') = toDateTime64('1924-10-09 10:30:10.123456', 6, 'America/Los_Angeles');
select parseDateTime64InJodaSyntaxOrNull('2299-10-09 10:30:10.123456America/Los_Angeles', 'yyyy-MM-dd HH:mm:ss.SSSSSSz') = toDateTime64('2299-10-09 10:30:10.123456', 6, 'America/Los_Angeles');
