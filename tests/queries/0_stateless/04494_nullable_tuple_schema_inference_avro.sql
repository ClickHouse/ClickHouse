...
-- Avro union [null, record], because otherwise DESCRIBE would return a type that CREATE TABLE rejects.
-- A null record value is read as the default tuple value (input_format_null_as_default).
