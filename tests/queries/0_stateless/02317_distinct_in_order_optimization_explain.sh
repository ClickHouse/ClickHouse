...
# This test checks which DISTINCT variant the in-order optimization picks; disable external DISTINCT
# so that the final DISTINCT stays a plain DistinctTransform instead of ExternalDistinctTransform.
