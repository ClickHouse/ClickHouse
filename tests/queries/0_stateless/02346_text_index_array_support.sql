...
(
    ...
    INDEX array_idx(arr) TYPE text(tokenizer = 'splitByNonAlpha', posting_list_block_size = 1),
    INDEX array_fixed_idx(arr_fixed) TYPE text(tokenizer = 'splitByNonAlpha', posting_list_block_size = 1)
)
ENGINE = MergeTree()
ORDER BY (id)
