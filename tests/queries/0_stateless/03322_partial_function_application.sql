...
SELECT arrayMap(linear_equation(_, 3, 5), [4, 6, 7]);
SELECT arrayMap(linear_equation(10, _2, _1), [4, 6, 7], [10, 3, -1]);
SELECT arrayMap(linear_equation(_3, _1, _2), [4, 6, 7], [10, 3, -1], [1, 4, 0]);
SELECT arrayMap(linear_equation(_4, _1, _2), [4, 6, 7], [10, 3, -1], [1, 4, 0]); -- { clientError UNKNOWN_IDENTIFIER }
