...
ENGINE = MergeTree() ORDER BY a SETTINGS disk = disk(type = cache, disk = 'local_disk', name = 'cache_with_sql_collection', cache_name='cache_collection_sql');
...
ENGINE = MergeTree() ORDER BY a SETTINGS disk = disk(type = cache, disk = 'local_disk', name = 'cache_with_collection', cache_name='cache_collection');
