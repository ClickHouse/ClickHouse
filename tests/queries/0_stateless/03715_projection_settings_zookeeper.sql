...
-- If a subsequent statement (`SYSTEM SYNC REPLICA`, `DETACH`, `ATTACH`) aborts the
-- script with a fast error (e.g. `Code: 999. Coordination::Exception: Session expired`),
-- the x1 results are still captured instead of producing zero output.
