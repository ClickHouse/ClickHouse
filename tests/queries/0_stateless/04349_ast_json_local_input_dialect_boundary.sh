...
# fails `ParserQuery`), and `SETTINGS enable_json_ast_dialect = 0` would trip the disabled-gate
...
printf '1\n2\n3\n' | ${CLICKHOUSE_LOCAL} --enable_json_ast_dialect 1 --dialect clickhouse_json -q "$JSON_DIALECT" 2>&1 && echo 'json_dialect_ok'
