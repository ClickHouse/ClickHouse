...
SELECT emptyArrayToSingle(emptyArrayString()), emptyArrayToSingle(emptyArrayDate()), emptyArrayToSingle(arrayMap(x -> toTimeZone(x, 'Europe/Moscow'), emptyArrayDateTime()));
