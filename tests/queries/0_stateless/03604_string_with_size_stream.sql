...
create table test (s String) engine MergeTree order by () settings serialization_info_version = 'single_stream', string_serialization_version = 'single_stream';
...
create table test (s String) engine MergeTree order by () settings serialization_info_version = 'single_stream', string_serialization_version = 'with_size_stream';
...
create table test_old (x UInt64, y UInt64, s String) engine MergeTree order by x settings serialization_info_version = 'single_stream';
...
create table test_old_compact (s String, t Tuple(a String, b String)) engine MergeTree order by () settings serialization_info_version = 'single_stream', min_rows_for_wide_part = 10000000, min_bytes_for_wide_part = 10000000;
create table test_old_wide (s String, t Tuple(a String, b String)) engine MergeTree order by () settings serialization_info_version = 'single_stream', min_rows_for_wide_part = 1, min_bytes_for_wide_part = 1;
