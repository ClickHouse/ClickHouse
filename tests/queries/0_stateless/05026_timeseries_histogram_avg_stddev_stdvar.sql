...
SELECT timeSeriesHistogramAvg(h), timeSeriesHistogramStddev(h), timeSeriesHistogramStdvar(h)
FROM (SELECT CAST([NULL, (0, -53, 0., 4., 8., 0., [(1, 2)], [3., 1.], [], [], [1., 3., 5.], 4, 0, [3, 1], [])], 'Array(Nullable(Tuple(flags UInt8, schema Int8, zero_threshold Float64, count Float64, sum Float64, zero_count Float64, positive_spans Array(Tuple(offset Int32, length UInt32)), positive_values Array(Float64), negative_spans Array(Tuple(offset Int32, length UInt32)), negative_values Array(Float64), custom_values Array(Float64), count_int UInt64, zero_count_int UInt64, positive_values_int Array(UInt64), negative_values_int Array(UInt64))))') AS arr)
ARRAY JOIN arr AS h;
...
SELECT timeSeriesHistogramAvg(h), timeSeriesHistogramStddev(h), timeSeriesHistogramStdvar(h)
FROM (SELECT (0, -53, 0., 8., 21., 0., [(0, 3)], [0., 2., 6.], [], [], [1., 2., 4.], 8, 0, [0, 2, 6], [])::Tuple(flags UInt8, schema Int8, zero_threshold Float64, count Float64, sum Float64, zero_count Float64, positive_spans Array(Tuple(offset Int32, length UInt32)), positive_values Array(Float64), negative_spans Array(Tuple(offset Int32, length UInt32)), negative_values Array(Float64), custom_values Array(Float64), count_int UInt64, zero_count_int UInt64, positive_values_int Array(UInt64), negative_values_int Array(UInt64)) AS h);
...
SELECT timeSeriesHistogramAvg(h), timeSeriesHistogramStddev(h), timeSeriesHistogramStdvar(h)
FROM (SELECT (0, 0, 0.6, 3., 0., 1., [(0, 1)], [1.], [(0, 1)], [1.], [], 3, 1, [1], [1])::Tuple(flags UInt8, schema Int8, zero_threshold Float64, count Float64, sum Float64, zero_count Float64, positive_spans Array(Tuple(offset Int32, length UInt32)), positive_values Array(Float64), negative_spans Array(Tuple(offset Int32, length UInt32)), negative_values Array(Float64), custom_values Array(Float64), count_int UInt64, zero_count_int UInt64, positive_values_int Array(UInt64), negative_values_int Array(UInt64)) AS h);

SELECT '-- an invalid exponential schema (9 > 8) is rejected';
SELECT timeSeriesHistogramStdvar((0, 9, 0., 4., 5.656854249492381, 0., [(1, 2)], [3., 1.], [], [], [], 4, 0, [3, 1], [])::Tuple(flags UInt8, schema Int8, zero_threshold Float64, count Float64, sum Float64, zero_count Float64, positive_spans Array(Tuple(offset Int32, length UInt32)), positive_values Array(Float64), negative_spans Array(Tuple(offset Int32, length UInt32)), negative_values Array(Float64), custom_values Array(Float64), count_int UInt64, zero_count_int UInt64, positive_values_int Array(UInt64), negative_values_int Array(UInt64))); -- { serverError INCORRECT_DATA }
