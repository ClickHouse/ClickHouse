...
$CLICKHOUSE_CLIENT -n --query "SET insert_keeper_fault_injection_probability=0;INSERT INTO concurrent_mutate_kill SELECT number, toString(number) FROM numbers(1000000)"
