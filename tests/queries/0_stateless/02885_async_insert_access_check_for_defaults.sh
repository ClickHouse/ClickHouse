...
INSERT INTO table_for_dict VALUES (1, 'value_1'), (2, 'value_2'), (3, 'value_3'), (4, 'value_4');
...
$CLICKHOUSE_CLIENT --query "SELECT * FROM table_with_default WHERE key=1"

$CLICKHOUSE_CLIENT --async_insert=1 --query "INSERT INTO table_with_default (key) VALUES (2)"
$CLICKHOUSE_CLIENT --query "SELECT * FROM table_with_default WHERE key=2"
...
$CLICKHOUSE_CLIENT --query "SELECT * FROM table_with_default WHERE key=3 OR key=4"
