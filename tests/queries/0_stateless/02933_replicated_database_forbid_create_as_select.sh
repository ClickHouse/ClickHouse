...
${CLICKHOUSE_CLIENT} --query "CREATE TABLE ${CLICKHOUSE_DATABASE}_db.test (id UInt64) ENGINE = ReplicatedMergeTree() ORDER BY id AS SELECT 1" |& grep -cm1 "SUPPORT_IS_DISABLED"
