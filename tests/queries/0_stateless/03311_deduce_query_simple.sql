...
CREATE TABLE test4(id UInt32, val1 String, val2 String, val3 String) ENGINE = MergeTree ORDER BY id;
...
INSERT INTO test4(id, val1, val2, val3) VALUES
(1, 'a', '1', 'a1'),
(2, 'b', '2', 'b2'),
(3, 'c', '3', 'c');

DEDUCE TABLE test4 BY val3;
