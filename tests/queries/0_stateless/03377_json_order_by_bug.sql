SET enable_variant_type = 1, allow_suspicious_variant_types = 1, enable_json_type = 1, allow_suspicious_types_in_order_by = 1, allow_not_comparable_types_in_order_by = 1, type_json_skip_duplicated_paths=1;
