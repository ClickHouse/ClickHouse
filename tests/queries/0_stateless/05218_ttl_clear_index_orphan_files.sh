...
#
# Reproduce full-storage parts with standalone skip-index files on disk but absent from
# checksums.txt. TTL cleanup must still select the part and remove those orphan files.
