...
cleanup()
{
    ...
    $CLICKHOUSE_CLIENT -q "DROP TABLE IF EXISTS t_empty_index_guard; DROP TABLE IF EXISTS t_empty_materialized_guard; DROP TABLE IF EXISTS t_race_materialized; DROP TABLE IF EXISTS t_race_index" 2>/dev/null ||:
}
trap cleanup EXIT
