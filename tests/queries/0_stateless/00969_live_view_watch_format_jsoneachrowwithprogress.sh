...
$CLICKHOUSE_CLIENT --allow_experimental_live_view 1 --query="WATCH lv LIMIT 0 FORMAT JSONEachRowWithProgress" | sed -r -e 's/"cumulative_processing_time":"[0-9]+"/"cumulative_processing_time":"<CUMULATIVE-PROCESSING-TIME>"/'
