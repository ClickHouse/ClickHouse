...
SELECT toString(d) FROM t_in_decimal WHERE d IN (1.123456789012345679) ORDER BY d;
SELECT toString(d) FROM t_in_decimal WHERE d NOT IN (1.123456789012345679) ORDER BY d;
SELECT toString(d) FROM t_in_decimal WHERE d IN (1.123456789012345678, 3.5) ORDER BY d;
SELECT toString(d) FROM t_in_decimal WHERE d NOT IN (1.123456789012345678, 3.5) ORDER BY d;
SELECT toString(d) FROM t_in_decimal WHERE d IN (1.123456789012345678, 1.123456789012345679) ORDER BY d;
SELECT toString(d) FROM t_in_decimal WHERE d GLOBAL IN (1.123456789012345679) ORDER BY d;

SELECT 'constant left-hand side';
SELECT CAST('1.123456789012345678', 'Decimal128(18)') IN (1.123456789012345679);
SELECT CAST('1.123456789012345679', 'Decimal128(18)') IN (1.123456789012345679);

SELECT 'exponent notation';
SELECT toString(d) FROM t_in_decimal WHERE d IN (1123456789012345679e-18) ORDER BY d;
...
SELECT f FROM t_in_float WHERE f IN (1.5) ORDER BY f;
SELECT f FROM t_in_float WHERE f IN (25e-1, 999) ORDER BY f;
