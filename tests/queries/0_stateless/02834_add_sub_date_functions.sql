...
SELECT addDate('2022-05-07'::Date32, INTERVAL 5 MINUTE); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
...
SELECT subDate('2022-05-07'::Date32, INTERVAL 5 MINUTE); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
