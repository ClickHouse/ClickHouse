...
SET enable_optimize_predicate_expression = 1; -- CI may inject False; old analyzer's PredicateExpressionsOptimizer not run → subquery wrapper for t2 not created in EXPLAIN SYNTAX output
