...
DROP TABLE IF EXISTS t_nested_null_sub_stripe;
CREATE TABLE t_nested_null_sub_stripe (c0 Nested(c1 LowCardinality(IPv4), c2 Nullable(Tuple())), c3 DateTime64(4) NULL) ENGINE = StripeLog;
INSERT INTO t_nested_null_sub_stripe (`c0.c1`, `c0.c2`, c3) VALUES (['127.0.0.1', '10.0.0.1'], [NULL, tuple()], '2024-01-01 00:00:00.0000');
SELECT `c0.c1`, `c0.c2`, `c0.c2.null` FROM t_nested_null_sub_stripe;
SELECT `c0.c2.null` FROM t_nested_null_sub_stripe;
SELECT `c0.c2`, `c0.c2.null` FROM t_nested_null_sub_stripe;
...
DROP TABLE t_nested_null_sub_stripe;
