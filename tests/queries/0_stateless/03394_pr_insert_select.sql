...
SYSTEM FLUSH LOGS;
select count() from system.query_log where (current_database = currentDatabase() or has(databases, currentDatabase())) and type = 'QueryFinish' and query_kind = 'Insert' and log_comment='ac5dcf0f-c5a9-4e8c-9f17-e6c94093586f' and event_date >= yesterday();
