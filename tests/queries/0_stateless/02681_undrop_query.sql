...
select table from system.marked_dropped_tables where table = '02681_undrop_mergetree' limit 1;
...
select table from system.marked_dropped_tables where table = '02681_undrop_uuid_on_cluster' limit 1;
...
select table from system.marked_dropped_tables where table = '02681_undrop_no_uuid_on_cluster' limit 1;
...
select table from system.marked_dropped_tables where table = '02681_undrop_replicatedmergetree' limit 1;
...
select table from system.marked_dropped_tables where table = '02681_undrop_log' limit 1;
...
select table from system.marked_dropped_tables where table = '02681_undrop_distributed' limit 1;
...
drop table 02681_undrop_multiple;
select table from system.marked_dropped_tables where table = '02681_undrop_multiple' limit 1;
