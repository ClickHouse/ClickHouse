...
----------------------------------------------------
SELECT 'Test lazy mode with large dataset (>128 rows, compression block boundary)';
...
----------------------------------------------------
SELECT 'Test lazy mode with large posting list and segment index';
...
-- AND intersection with segment index
SET text_index_posting_list_apply_mode = 'lazy';
...
----------------------------------------------------
SELECT 'Test lazy mode with large posting list segment index after merge';
