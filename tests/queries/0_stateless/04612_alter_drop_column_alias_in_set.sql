...
-- are collected. Before 26.6 MutationsInterpreter cannot expand ALIAS chains in mutations at all
-- (UNKNOWN_IDENTIFIER), so unlike 26.6+ this only covers the DROP COLUMN validator.
...
-- No DELETE/UPDATE/lightweight-DELETE coverage here: before 26.6 any mutation referencing the
