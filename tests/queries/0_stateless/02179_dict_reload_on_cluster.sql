...
INSERT INTO dict_db_01036.dict_data VALUES(1,11);
...
SELECT 'SYSTEM DICTIONARIES ON CLUSTER test_shard_localhost';
SYSTEM RELOAD DICTIONARIES ON CLUSTER test_shard_localhost;
SELECT query_count FROM system.dictionaries WHERE database = 'dict_db_01036' AND name = 'dict';
SELECT dictGetUInt64('dict_db_01036.dict', 'val', toUInt64(1));
SELECT query_count FROM system.dictionaries WHERE database = 'dict_db_01036' AND name = 'dict';
