...
(
    ...
    version UInt64,
    text String,
    PROJECTION idx_text INDEX text TYPE text(tokenizer = array)
)
ENGINE = ReplacingMergeTree(version) ORDER BY id SETTINGS deduplicate_merge_projection_mode = 'rebuild';
