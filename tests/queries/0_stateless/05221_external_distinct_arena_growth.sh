...
# The high spill threshold makes preliminary pass-through and final spilling depend on the
# projected key-storage growth. Each local query has an isolated user memory budget.
