...
ALTER TABLE db_overlay.t_a ADD COLUMN z UInt8 DEFAULT 0; -- { serverError TABLE_IS_PERMANENTLY_READ_ONLY }
...
TRUNCATE ALL TABLES FROM db_overlay; -- { serverError TABLE_IS_PERMANENTLY_READ_ONLY }
