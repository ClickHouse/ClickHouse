...
-- (`users.d/use_reader_executor.xml`, `users.d/reader_executor_long_connections.xml`)
-- enables them to exercise the executor read path in CI, so they show as enabled here.
