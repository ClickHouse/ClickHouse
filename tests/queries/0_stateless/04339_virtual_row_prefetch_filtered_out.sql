...
-- a real chunk; its read-ahead slot must still free up (`VirtualRowReadAheadTransform::prepare`
-- skips a lane whose input is finished before it can occupy the window). Otherwise the window
