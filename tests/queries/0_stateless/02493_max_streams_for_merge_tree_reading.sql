...
select * from (explain pipeline select sum(x) from t settings max_threads=32, max_streams_for_merge_tree_reading=16, allow_asynchronous_read_from_io_pool_for_merge_tree=0, query_plan_merge_expressions=1) where explain like '%Resize%' or explain like '%MergeTreeSelect%';
...
select * from (explain pipeline select sum(x) from t settings max_threads=4, max_streams_for_merge_tree_reading=16, allow_asynchronous_read_from_io_pool_for_merge_tree=0, max_streams_to_max_threads_ratio=8, query_plan_merge_expressions=1) where explain like '%Resize%' or explain like '%MergeTreeSelect%';
...
select * from (explain pipeline select sum(x) from t settings max_threads=4, max_streams_for_merge_tree_reading=16, allow_asynchronous_read_from_io_pool_for_merge_tree=1, query_plan_merge_expressions=1) where explain like '%Resize%' or explain like '%MergeTreeSelect%';
...
select * from (explain pipeline select sum(x) from t settings max_threads=4, max_streams_for_merge_tree_reading=16, allow_asynchronous_read_from_io_pool_for_merge_tree=1, max_streams_to_max_threads_ratio=8, query_plan_merge_expressions=1) where explain like '%Resize%' or explain like '%MergeTreeSelect%';
...
select * from (explain pipeline select sum(x) from (select x from t order by x) settings max_threads=4, max_streams_for_merge_tree_reading=16, allow_asynchronous_read_from_io_pool_for_merge_tree=1, optimize_read_in_order=1, query_plan_read_in_order=1, query_plan_merge_expressions=1) where explain like '%Resize%';
