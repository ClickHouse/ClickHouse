...
$CLICKHOUSE_CLIENT -q "insert into function file(data4.jsonl) select number % 2 ? number::UInt32 : NULL as x from numbers(10) settings engine_file_truncate_on_insert=1"
