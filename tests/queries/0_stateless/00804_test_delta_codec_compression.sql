...
) ENGINE MergeTree() ORDER BY tuple() SETTINGS allow_experimental_block_number_column=false, min_bytes_for_wide_part = 0, compress_marks = false, compress_primary_key = false, ratio_of_defaults_for_sparse_serialization = 1;
