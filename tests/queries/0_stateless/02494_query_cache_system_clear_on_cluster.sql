...
-- Without TAG
SELECT formatQuery('SYSTEM CLEAR QUERY CACHE');

-- With TAG - it should be preserved
SELECT formatQuery('SYSTEM CLEAR QUERY CACHE TAG ''tag''');

-- With TAG and ON CLUSTER - both should be preserved
SELECT formatQuery('SYSTEM CLEAR QUERY CACHE TAG ''tag'' ON CLUSTER ''cluster''');

-- With ON CLUSTER but no TAG
SELECT formatQuery('SYSTEM CLEAR QUERY CACHE ON CLUSTER ''cluster''');
