...
CREATE TABLE t_lazy_narrow (k UInt64, v UInt64)
ENGINE = MergeTree ORDER BY tuple()
...
INSERT INTO t_lazy_narrow SELECT number, number % 10 FROM numbers(1000);
...
WHERE event_date >= yesterday() AND event_time >= now() - 600
  ...
  AND log_comment IN ('04209_part_lazy', '04209_prewhere_lazy', '04209_join_lazy')
