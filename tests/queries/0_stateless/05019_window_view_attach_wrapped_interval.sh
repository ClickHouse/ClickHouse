...
${CLICKHOUSE_CLIENT} --allow_experimental_window_view 1 -q "DROP TABLE IF EXISTS ${TABLE}"
${CLICKHOUSE_CLIENT} --allow_experimental_window_view 1 -q "
...
${CLICKHOUSE_CLIENT} --allow_experimental_window_view 1 -q "DETACH TABLE ${TABLE}"
...
${CLICKHOUSE_CLIENT} --allow_experimental_window_view 1 -q "ATTACH TABLE ${TABLE}"
echo attached

${CLICKHOUSE_CLIENT} --allow_experimental_window_view 1 -q "DROP TABLE ${TABLE}"
