...
SETTINGS index_granularity = 1, min_bytes_for_wide_part = 1000000000, write_marks_for_substreams_in_compact_parts = 1, optimize_row_order_if_no_order_by = 0;
...
ENGINE = MergeTree ORDER BY tuple() SETTINGS index_granularity = 1, min_bytes_for_wide_part = 1000000000, write_marks_for_substreams_in_compact_parts = 1, optimize_row_order_if_no_order_by = 0;
...
SETTINGS index_granularity = 3, min_bytes_for_wide_part = 1000000000, write_marks_for_substreams_in_compact_parts = 1, optimize_row_order_if_no_order_by = 0;
