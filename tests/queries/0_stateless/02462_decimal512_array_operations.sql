...
SELECT
    arraySum(CAST([] AS Array(Decimal512(3)))) AS sum_empty,
    arrayAvg(CAST([] AS Array(Decimal512(3)))) AS avg_empty,
    arrayMin(CAST([] AS Array(Decimal512(3)))) AS min_empty,
    arrayMax(CAST([] AS Array(Decimal512(3)))) AS max_empty,
    arrayProduct(CAST([] AS Array(Decimal512(3)))) AS product_empty;
