...
SELECT c0 FROM t1 ORDER BY c0 DESC WITH FILL STALENESS -2 SETTINGS optimize_const_name_size = 0;
SELECT c0 FROM t1 ORDER BY c0 DESC WITH FILL TO -6 STEP -2 SETTINGS optimize_const_name_size = 0;
