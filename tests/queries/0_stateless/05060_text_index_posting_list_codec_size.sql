...
INSERT INTO tab_pfor SELECT * FROM tab_src;
...
WITH
    ...
    (SELECT data_compressed_bytes FROM system.data_skipping_indices WHERE database = currentDatabase() AND table = 'tab_pfor') AS sz_pfor
SELECT
    sz_bitpacking < sz_none,
    sz_pfor < sz_bitpacking,
    -- At least 5% better than bitpacking.
    sz_pfor < sz_bitpacking * 0.95;
