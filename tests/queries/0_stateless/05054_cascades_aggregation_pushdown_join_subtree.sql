...
-- Pin (randomized in CI): the canaries assert the pushed shapes, and the scenarios below turn
-- the cascades optimizer off outright, so this cannot leak into them.
