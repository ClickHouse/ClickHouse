...
CREATE TABLE t_max_size_patch_parts (x UInt64) ENGINE = MergeTree ORDER BY x SETTINGS max_table_size_rows = 10, enable_block_number_column = 1, enable_block_offset_column = 1;
