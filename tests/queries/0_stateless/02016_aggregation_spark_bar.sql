...
SELECT sparkbar(1)(event_date,cnt) FROM spark_bar_test; -- { serverError BAD_ARGUMENTS }
SELECT sparkbar(1025)(event_date,cnt) FROM spark_bar_test; -- { serverError BAD_ARGUMENTS }
SELECT sparkbar(2, 0)(event_date,cnt) FROM spark_bar_test; -- { serverError NUMBER_OF_ARGUMENTS_DOESNT_MATCH }
SELECT sparkbar(2, 0, 1, 3)(event_date,cnt) FROM spark_bar_test; -- { serverError NUMBER_OF_ARGUMENTS_DOESNT_MATCH }
...
SELECT sparkbar(11,toDate('2020-01-02'),toDate('2020-01-02'))(event_date,cnt) FROM spark_bar_test; -- { serverError BAD_ARGUMENTS }
