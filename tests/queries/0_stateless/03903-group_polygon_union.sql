...
-- Negative tests: wrong argument type, too many arguments, parameters
...
SELECT groupPolygonUnion(polygon, polygon) FROM (SELECT [[(0.,0.),(1.,0.),(1.,1.),(0.,0.)]] AS polygon); -- { serverError NUMBER_OF_ARGUMENTS_DOESNT_MATCH }
