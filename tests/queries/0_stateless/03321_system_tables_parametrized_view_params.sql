...
DROP TABLE IF EXISTS parametrized_view_one_param_temporary;

DROP TABLE IF EXISTS parametrized_view_multiple_params_temporary;
...
CREATE VIEW parametrized_view_one_param_temporary AS SELECT * FROM raw_data WHERE id = {id:UInt32};

SELECT name, engine, parametrized_view_paramters
    FROM system.tables
    WHERE database = currentDatabase() and name = 'parametrized_view_one_param_temporary';

CREATE VIEW parametrized_view_multiple_params_temporary
...
SELECT name, engine, parametrized_view_paramters
    FROM system.tables
    WHERE database = currentDatabase() and name = 'parametrized_view_multiple_params_temporary';

DROP TABLE parametrized_view_one_param;

DROP TABLE parametrized_view_multiple_params;

DROP TABLE parametrized_view_one_param_temporary;

DROP TABLE parametrized_view_multiple_params_temporary;
