...
-- The carrier lives in the query-plan layer and only fires under the analyzer; the old
...
-- read that column and break the byte-count assertions. Pin the analyzer so the carrier is
