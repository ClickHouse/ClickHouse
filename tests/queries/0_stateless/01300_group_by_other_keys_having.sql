...
SET enable_optimize_predicate_expression = 1; -- CI may inject False; HAVING condition on GROUP BY key not pushed to WHERE → stays as HAVING instead of WHERE in EXPLAIN SYNTAX
