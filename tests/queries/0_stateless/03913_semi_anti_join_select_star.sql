...
SET select_star_skip_non_preserved_side_for_anti_join = 1;
...
SET select_star_skip_non_preserved_side_for_semi_join = 1;
...
SELECT * FROM (SELECT 1 AS a) t1 LEFT ANTI JOIN (SELECT 2 AS b) t2 ON false
SETTINGS select_star_skip_non_preserved_side_for_anti_join = 0;
