...
SELECT number FROM numbers(3) SETTINGS discard_query_result = 1;
...
SELECT number FROM numbers(3) FORMAT TSVWithNames SETTINGS discard_query_result = 1;
...
SELECT count() FROM remote('127.0.0.2', currentDatabase(), t_04336_discard_query_result) SETTINGS discard_query_result = 1;

DROP TABLE t_04336_discard_query_result;
