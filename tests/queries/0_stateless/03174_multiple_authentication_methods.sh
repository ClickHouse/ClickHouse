...
function test_config_based_auth
{
  echo "=== Testing Config-Based Multiple Plaintext Passwords ==="
  ...
  echo "=== Testing Config-Based Multiple Double SHA1 Passwords ==="
  ...
  echo "=== Testing Config-Based Mixed Authentication Methods ==="
