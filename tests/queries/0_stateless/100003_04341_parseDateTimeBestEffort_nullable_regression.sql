...
-- toString() writes empty strings at null positions since PR #105587; the parser must skip them.
...
-- two-arg form with timezone (was throwing CANNOT_PARSE_DATETIME before the fix)
...
-- OrNull variant (sanity check, should be unaffected)
