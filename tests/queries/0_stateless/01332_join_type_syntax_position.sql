...
select * from numbers(1) t1 asof join numbers(1) t2 using number; -- { serverError NOT_IMPLEMENTED }
select * from numbers(1) t1 left asof join numbers(1) t2 using number; -- { serverError NOT_IMPLEMENTED }
...
select * from numbers(1) t1 asof join numbers(1) t2 using number; -- { serverError NOT_IMPLEMENTED }
select * from numbers(1) t1 asof left join numbers(1) t2 using number; -- { serverError NOT_IMPLEMENTED }
