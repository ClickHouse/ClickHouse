...
LIMIT 5000
FORMAT Null
SETTINGS max_threads = 1, log_comment = '04321_lazy_materialization_uncompressed_cache_run_1';
...
WHERE event_date >= yesterday()
  ...
  AND log_comment = '04321_lazy_materialization_uncompressed_cache_run_1'
...
LIMIT 5000
FORMAT Null
SETTINGS max_threads = 1, log_comment = '04321_lazy_materialization_uncompressed_cache_run_2';
...
WHERE event_date >= yesterday()
  ...
  AND type = 'QueryFinish'
  AND current_database = currentDatabase()
  AND log_comment = '04321_lazy_materialization_uncompressed_cache_run_2'
ORDER BY event_time_microseconds DESC
LIMIT 1;
