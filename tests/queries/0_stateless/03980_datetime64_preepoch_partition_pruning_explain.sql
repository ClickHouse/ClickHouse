...
SET optimize_use_implicit_projections = 0, session_timezone = 'UTC', optimize_move_to_prewhere = 1, query_plan_optimize_prewhere = 1, query_plan_merge_expressions = 1;
