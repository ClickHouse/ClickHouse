...
SELECT tumbleStart(toUInt32(42)); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
...
select hopStart((toDateTime('2025-02-07 17:23:42'), makeDateTime(null))) SETTINGS session_timezone='UTC'; -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
