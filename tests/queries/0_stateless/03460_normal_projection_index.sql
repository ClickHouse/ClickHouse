...
ALTER TABLE test_partial_projection ADD PROJECTION region_proj (SELECT _part_offset ORDER BY region) WITH SETTINGS (add_minmax_index_for_numeric_columns = 0);
