...
begin transaction; -- { serverError 646 }
rollback;
...
-- cannot commit after exception
commit; -- { serverError 646 }
insert into mt1 values (5); -- { serverError 646 }
insert into mt2 values (50); -- { serverError 646 }
select 1; -- { serverError 646 }
rollback;
