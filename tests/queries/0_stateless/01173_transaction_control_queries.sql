...
begin transaction; -- { serverError 700 }
rollback;
...
-- cannot commit after exception
commit; -- { serverError 700 }
insert into mt1 values (5); -- { serverError 700 }
insert into mt2 values (50); -- { serverError 700 }
select 1; -- { serverError 700 }
rollback;
