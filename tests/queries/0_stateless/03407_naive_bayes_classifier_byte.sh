...
$CLICKHOUSE_CLIENT -q "SELECT naiveBayesClassifierWithProb('lang_byte_2', 'She painted the wall a bright yellow')"
$CLICKHOUSE_CLIENT -q "SELECT naiveBayesClassifierWithProb('lang_byte_2', 'На кухне пахнет свежим хлебом.')"

$CLICKHOUSE_CLIENT -q "SELECT naiveBayesClassifierAllProbs('lang_byte_2', 'She painted the wall a bright yellow')"
$CLICKHOUSE_CLIENT -q "SELECT naiveBayesClassifierAllProbs('lang_byte_2', 'На кухне пахнет свежим хлебом.')"
