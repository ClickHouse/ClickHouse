...
SELECT 'test1_algo', merge_algorithm, merge_reason, length(merged_from) FROM system.part_log
...
SYSTEM FLUSH LOGS part_log;
SELECT 'test2_algo', merge_algorithm, merge_reason, length(merged_from) FROM system.part_log
...
SYSTEM FLUSH LOGS part_log;
SELECT 'test3_algo', merge_algorithm, merge_reason, length(merged_from) FROM system.part_log
...
SYSTEM FLUSH LOGS part_log;
SELECT 'test4_algo', merge_algorithm, merge_reason, length(merged_from) FROM system.part_log
...
SYSTEM FLUSH LOGS part_log;
SELECT 'test5_algo', merge_algorithm, merge_reason, length(merged_from) FROM system.part_log
...
SYSTEM FLUSH LOGS part_log;
SELECT 'test6_algo', merge_algorithm, merge_reason, length(merged_from) FROM system.part_log
    WHERE database = currentDatabase() AND table = 't_ttl_vert_6' AND event_type = 'MergeParts'
    ORDER BY event_time_microseconds;
