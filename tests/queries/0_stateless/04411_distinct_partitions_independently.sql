...
INSERT INTO test_partition_eq_key SELECT number, number FROM numbers_mt(200);
INSERT INTO test_partition_eq_key SELECT number, number FROM numbers_mt(200);
...
INSERT INTO test_partition_func_of_key SELECT toDate('2024-01-01') + (number % 240), number FROM numbers_mt(240);
INSERT INTO test_partition_func_of_key SELECT toDate('2024-01-01') + (number % 240), number + 1 FROM numbers_mt(240);
...
INSERT INTO test_complex_expr_both_sides SELECT number FROM numbers_mt(16);
...
INSERT INTO test_multi_col_partition_covered SELECT number, number FROM numbers_mt(24);
...
INSERT INTO test_key_superset_partition SELECT number, number % 50 FROM numbers_mt(200);
...
INSERT INTO test_partition_sum_of_components SELECT number, number FROM numbers_mt(24);
...
INSERT INTO test_with_where_filter SELECT number, number FROM numbers_mt(200);
INSERT INTO test_with_where_filter SELECT number, number + 1 FROM numbers_mt(200);
...
INSERT INTO test_with_filter_step SELECT number, number FROM numbers_mt(200);
INSERT INTO test_with_filter_step SELECT number, number + 1 FROM numbers_mt(200);
...
INSERT INTO test_with_projection_alias SELECT number, toString(number) FROM numbers_mt(200);
...
INSERT INTO test_injective_wrapper SELECT number, toString(number) FROM numbers_mt(200);
...
INSERT INTO test_summing_merge_tree SELECT number, 1 FROM numbers_mt(200);
...
INSERT INTO test_table_level_order_by SELECT number FROM numbers_mt(200);
INSERT INTO test_table_level_order_by SELECT number FROM numbers_mt(200);
...
INSERT INTO test_array_join SELECT number, range(number % 5) FROM numbers_mt(200);
INSERT INTO test_array_join SELECT number, range(number % 5) FROM numbers_mt(200);
...
INSERT INTO test_key_excludes_partition_col SELECT number, number FROM numbers_mt(200);
...
INSERT INTO test_key_noninjective_of_partition SELECT number % 8 FROM numbers_mt(200);
...
INSERT INTO test_key_coarser_than_partition SELECT number % 16 FROM numbers_mt(200);
...
INSERT INTO test_mismatched_divisors SELECT number FROM numbers_mt(16);
...
INSERT INTO test_noninjective_wrapper_in_key SELECT number, number FROM numbers_mt(24);
...
INSERT INTO test_nondeterministic_key SELECT number FROM numbers_mt(200);
...
INSERT INTO test_stateful_key SELECT number FROM numbers_mt(200);
...
INSERT INTO test_single_partition SELECT 8 * number FROM numbers_mt(200);
INSERT INTO test_single_partition SELECT 8 * number FROM numbers_mt(200);
...
INSERT INTO test_no_partition_by SELECT number FROM numbers_mt(200);
...
INSERT INTO test_with_final SELECT number, 1 FROM numbers_mt(200);
...
INSERT INTO test_projection_partitioned_reading SELECT number % 100, number FROM numbers_mt(200);
INSERT INTO test_projection_partitioned_reading SELECT number % 100, number + 10000 FROM numbers_mt(200);
...
INSERT INTO test_with_order_by_in_query SELECT number, number FROM numbers_mt(200);
