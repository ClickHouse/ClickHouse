...
$CLICKHOUSE_CLIENT --allow_experimental_codecs 1 --send_logs_level fatal -q "ATTACH TABLE t_zxc_attach_column UUID '${UUID}' (x UInt64 CODEC(ZXC)) ENGINE = MergeTree ORDER BY tuple();"
