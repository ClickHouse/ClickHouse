...
--
-- The stale in-order state reached `AggregatingStep`, so a distributed query with
...
-- The reported query was a mutation subquery: `replaceNonDeterministicToScalars` runs
