...
DROP FUNCTION IF EXISTS test_03925_func;
...
CREATE OR REPLACE FUNCTION test_03925_func LANGUAGE WASM ABI BUFFERED_V1 FROM 'abi_buf_out_of_bounds' :: 'test_func' ARGUMENTS (UInt64) RETURNS UInt64 SETTINGS serialization_format = 'CSV';
SELECT test_03925_func(456 :: UInt64), test_03925_func(materialize(521 :: UInt64));
