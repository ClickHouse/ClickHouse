...
INSERT INTO t_ni_rep SELECT number, number, 1 FROM numbers(100000);
INSERT INTO t_ni_rep SELECT number, number, 1 FROM numbers(100000);
OPTIMIZE TABLE t_ni_rep FINAL;
SYSTEM STOP MERGES t_ni_rep;
INSERT INTO t_ni_rep SELECT number, number + 5, 2 FROM numbers(20000);
...
INSERT INTO t_ni_del SELECT number, number, 1, number % 7 = 0 FROM numbers(100000);
INSERT INTO t_ni_del SELECT number, number, 1, number % 7 = 0 FROM numbers(100000);
OPTIMIZE TABLE t_ni_del FINAL;
SYSTEM STOP MERGES t_ni_del;
INSERT INTO t_ni_del SELECT number, number + 5, 2, 0 FROM numbers(20000);
...
INSERT INTO t_ni_col SELECT number, number, 1 FROM numbers(100000);
INSERT INTO t_ni_col SELECT number, number, -1 FROM numbers(50000);
