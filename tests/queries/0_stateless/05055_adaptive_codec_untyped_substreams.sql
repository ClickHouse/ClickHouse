...
SETTINGS min_bytes_for_wide_part = 0, enable_adaptive_codec_selection = 1, serialization_info_version = 'with_types',
         map_serialization_version = 'with_buckets', map_buckets_strategy = 'constant', max_buckets_in_map = 256,
         map_buckets_min_avg_size = 0;

INSERT INTO t_untyped_substreams SELECT map(number * 2, 1, number * 2 + 1, 2) FROM numbers(100000);
