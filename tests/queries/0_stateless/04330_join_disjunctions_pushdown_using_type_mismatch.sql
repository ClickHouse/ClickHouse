...
-- NOTE (26.5 backport): the original test additionally covered the secondary analyzer fix in
...
-- 26.5 does not do this (the special-multiIf constant folding was added to master after 26.5 and
-- is unrelated to this fix), so on 26.5 the unknown identifier simply propagates and the scenario
