...
WHERE event_date >= yesterday() AND event_time >= now() - 600 AND current_database = currentDatabase() AND is_initial_query AND log_comment = 'parallel_replicas_task_size_82982938' AND type = 'QueryFinish'
