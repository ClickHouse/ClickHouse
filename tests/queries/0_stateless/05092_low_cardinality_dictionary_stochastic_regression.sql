...
INSERT INTO dictionary_stochastic_regression
SELECT 0, number, 'shared', 1, 1 FROM numbers(7)
SETTINGS max_threads = 1, max_insert_threads = 1;
INSERT INTO dictionary_stochastic_regression
SELECT 1, number + 7, 'shared', 1, 1 FROM numbers(8)
SETTINGS max_threads = 1, max_insert_threads = 1;
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    group_by_two_level_threshold = 0, group_by_two_level_threshold_bytes = 0,
    max_bytes_before_external_group_by = 0, max_bytes_ratio_before_external_group_by = 0,
    log_comment = '05092_dictionary_stochastic_regression/linear-single';
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    max_bytes_before_external_group_by = 0, max_bytes_ratio_before_external_group_by = 0,
    log_comment = '05092_dictionary_stochastic_regression/linear-two';
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    group_by_two_level_threshold = 0, group_by_two_level_threshold_bytes = 0,
    max_bytes_before_external_group_by = 0, max_bytes_ratio_before_external_group_by = 0,
    log_comment = '05092_dictionary_stochastic_regression/logistic-single';
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    group_by_two_level_threshold = 1, group_by_two_level_threshold_bytes = 0,
    max_bytes_before_external_group_by = 0, max_bytes_ratio_before_external_group_by = 0,
    log_comment = '05092_dictionary_stochastic_regression/logistic-two';
...
SETTINGS max_threads = 1, enable_parallel_replicas = 0, serialize_query_plan = 0,
    ...
    group_by_two_level_threshold = 0, group_by_two_level_threshold_bytes = 0,
    max_bytes_before_external_group_by = 0, max_bytes_ratio_before_external_group_by = 0,
    log_comment = '05092_dictionary_stochastic_regression/control';
