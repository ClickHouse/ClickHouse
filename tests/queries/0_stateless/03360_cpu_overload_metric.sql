...
SELECT count() FROM system.numbers_mt SETTINGS max_threads = 256, use_concurrency_control = 0, max_execution_time = 2, timeout_overflow_mode = 'break', max_rows_to_read = 0, max_bytes_to_read = 0;
SYSTEM FLUSH LOGS;
