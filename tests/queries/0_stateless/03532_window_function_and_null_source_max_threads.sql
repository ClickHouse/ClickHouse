...
SELECT trimLeft(explain) FROM (
    EXPLAIN PIPELINE
        ...
        SELECT lead
        FROM window2
        SETTINGS max_threads = 20, enable_parallel_replicas=0, query_plan_enable_multithreading_after_window_functions=1
...
SELECT trimLeft(explain) FROM (
    EXPLAIN PIPELINE
        ...
        SELECT lead
        FROM window2
        SETTINGS max_threads = 2000, enable_parallel_replicas=0, query_plan_enable_multithreading_after_window_functions=1
...
SELECT trimLeft(explain) FROM (
    EXPLAIN PIPELINE
        ...
        SELECT lead
        FROM window2
        SETTINGS max_threads = 300, enable_parallel_replicas=0, query_plan_enable_multithreading_after_window_functions=1
