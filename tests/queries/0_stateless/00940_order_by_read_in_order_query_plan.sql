SET optimize_read_in_order = 1, query_plan_read_in_order = 1, enable_analyzer = 0, query_plan_optimize_lazy_materialization = 0, optimize_sorting_by_input_stream_properties = 1, query_plan_merge_expressions = 1;
