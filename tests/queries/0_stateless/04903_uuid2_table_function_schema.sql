...
DROP VIEW IF EXISTS uuid2_table_function_schema_gcs;
DROP VIEW IF EXISTS uuid2_table_function_schema_s3_cluster;
...
CREATE VIEW uuid2_table_function_schema_gcs AS
    SELECT * FROM gcs('https://example.com/uuid2_table_function_schema.csv', 'CSV', 'id UUID');
CREATE VIEW uuid2_table_function_schema_s3_cluster AS
    SELECT * FROM s3Cluster('test_shard_localhost', 'https://example.com/uuid2_table_function_schema.csv', 'CSV', 'id UUID');
...
DROP VIEW uuid2_table_function_schema_gcs;
DROP VIEW uuid2_table_function_schema_s3_cluster;
