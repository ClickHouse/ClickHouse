...
SETTINGS disk = disk(
    ...
    metadata_type = cas,
    cas_server_root_id = '${CLICKHOUSE_DATABASE}_04286',
    name = '${CLICKHOUSE_DATABASE}_04286_cas_rdp',
    path = '${CLICKHOUSE_DATABASE}_04286_cas_rdp_pool/');
...
WHERE disk_name = '${CLICKHOUSE_DATABASE}_04286_cas_rdp'
...
SYSTEM CAS FORGET '${CLICKHOUSE_DATABASE}_04286_cas_rdp';
EOF
