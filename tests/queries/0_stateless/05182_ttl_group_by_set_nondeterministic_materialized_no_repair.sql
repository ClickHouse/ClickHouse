...
SYSTEM STOP MERGES ttl_nondet_sort_key;
SYSTEM STOP MERGES ttl_det_sort_key;
SYSTEM STOP MERGES ttl_nondet_group_by_key;
SYSTEM STOP MERGES ttl_det_group_by_key;

INSERT INTO ttl_nondet_sort_key (g, x, ts) SELECT number % 1000, number, now() - toIntervalDay(2) FROM numbers(50000);
INSERT INTO ttl_nondet_sort_key (g, x, ts) SELECT number % 1000, number, now() - toIntervalDay(2) FROM numbers(50000, 50000);
INSERT INTO ttl_det_sort_key (g, x, ts) SELECT number % 1000, number, now() - toIntervalDay(2) FROM numbers(50000);
INSERT INTO ttl_det_sort_key (g, x, ts) SELECT number % 1000, number, now() - toIntervalDay(2) FROM numbers(50000, 50000);
INSERT INTO ttl_nondet_group_by_key (g, x, v, ts) SELECT number % 1000, number, number, now() - toIntervalDay(2) FROM numbers(50000);
INSERT INTO ttl_nondet_group_by_key (g, x, v, ts) SELECT number % 1000, number, number, now() - toIntervalDay(2) FROM numbers(50000, 50000);
INSERT INTO ttl_det_group_by_key (g, x, v, ts) SELECT number % 1000, number, number, now() - toIntervalDay(2) FROM numbers(50000);
INSERT INTO ttl_det_group_by_key (g, x, v, ts) SELECT number % 1000, number, number, now() - toIntervalDay(2) FROM numbers(50000, 50000);

SYSTEM START MERGES ttl_nondet_sort_key;
SYSTEM START MERGES ttl_det_sort_key;
SYSTEM START MERGES ttl_nondet_group_by_key;
SYSTEM START MERGES ttl_det_group_by_key;

OPTIMIZE TABLE ttl_nondet_sort_key FINAL;
OPTIMIZE TABLE ttl_det_sort_key FINAL;
OPTIMIZE TABLE ttl_nondet_group_by_key FINAL;
OPTIMIZE TABLE ttl_det_group_by_key FINAL;
...
SELECT 'rows', count(), countIf(x = 99000 + g) FROM ttl_nondet_sort_key;
SELECT 'rows', count(), countIf(x = 99000 + g) FROM ttl_det_sort_key;
SELECT 'rows', count(), countIf(x = 99000 + g) FROM ttl_nondet_group_by_key;
SELECT 'rows', count(), countIf(x = 99000 + g) FROM ttl_det_group_by_key;
