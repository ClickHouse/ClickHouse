...
-- Since 26.7, an unquoted number for a DateTime64 column is a Unix timestamp in seconds, consistent
...
-- The pre-26.7 behavior (reading the number as the raw scaled value / ticks) is available via the
