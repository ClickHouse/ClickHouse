...
SELECT countIf(explain like '%Algorithm: DirectKeyValueJoin%'), countIf(explain like '%Algorithm: PartitionedHashJoin%') FROM (
...
SELECT countIf(explain like '%Algorithm: GraceHashJoin%'), countIf(explain like '%Algorithm: PartitionedHashJoin%') FROM (
    EXPLAIN PLAN actions = 1
