...
SELECT count(id) FROM t_final_query_tbl FINAL where v = 98889991 SETTINGS use_skip_indexes_if_final=2;
SELECT count(id) FROM t_final_query_tbl FINAL where v = 88889992 SETTINGS use_skip_indexes_if_final=2;
SELECT count(id) FROM t_final_query_tbl FINAL where v = 78889993 SETTINGS use_skip_indexes_if_final=2;
SELECT count(id) FROM t_final_query_tbl FINAL where v = 68889994 SETTINGS use_skip_indexes_if_final=2;
SELECT count(id) FROM t_final_query_tbl FINAL where v = 58889995 SETTINGS use_skip_indexes_if_final=2;
...
SELECT 'Next 4 queries should return 0 rows and the 5th query should return 1 row';
SELECT count(id1) FROM t_final_query_tbl2 FINAL where v = 98889991 SETTINGS use_skip_indexes_if_final=2;
SELECT count(id1) FROM t_final_query_tbl2 FINAL where v = 88889992 SETTINGS use_skip_indexes_if_final=2;
SELECT count(id1) FROM t_final_query_tbl2 FINAL where v = 78889993 SETTINGS use_skip_indexes_if_final=2;
SELECT count(id1) FROM t_final_query_tbl2 FINAL where v = 68889994 SETTINGS use_skip_indexes_if_final=2;
SELECT count(id1) FROM t_final_query_tbl2 FINAL where v = 58889995 SETTINGS use_skip_indexes_if_final=2;
