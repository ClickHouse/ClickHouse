...
SELECT
    CAST((1., 0., 10.), 'ExponentialTimeDecayingFloat64(10)')
...
SELECT
    tuple(CAST((1., 0., 10.), 'ExponentialTimeDecayingFloat64(10)'))
...
WITH
    ...
    CAST((1., 10 * log(2.), 10.), 'ExponentialTimeDecayingFloat64(10)') AS b
