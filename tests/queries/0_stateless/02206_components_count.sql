SELECT GraphComponentsCount(from, to) FROM (SELECT * FROM VALUES('from UInt64, to UInt64', (1, 1)) WHERE 0);
SELECT GraphComponentsCount(from, to) FROM VALUES('from UInt64, to UInt64', (1, 1), (2, 2));
SELECT GraphComponentsCount(from, to) FROM VALUES('from UInt64, to UInt64', (1, 1), (2, 3), (3, 4), (2, 4));
SELECT GraphComponentsCount(from, to) FROM VALUES('from UInt64, to UInt64', (1, 2), (2, 1), (3, 4), (4, 3), (4, 4));
