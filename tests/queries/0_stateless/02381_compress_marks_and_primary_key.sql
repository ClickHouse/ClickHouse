...
create table test_02381(a UInt64, b UInt64) ENGINE = MergeTree order by (a, b) SETTINGS compress_marks = false, compress_primary_key = false, ratio_of_defaults_for_sparse_serialization = 1, serialization_info_version = 'basic', auto_statistics_types = '', add_minmax_index_for_numeric_columns=0, allow_experimental_adaptive_codec_selection = 0;
...
create table test_02381_compact (a UInt64, b String) ENGINE = MergeTree order by (a, b) SETTINGS auto_statistics_types = '', allow_experimental_adaptive_codec_selection = 0;
