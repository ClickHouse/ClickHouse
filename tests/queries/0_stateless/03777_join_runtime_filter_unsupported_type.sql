...
WHERE t1.a = t2.b
SETTINGS enable_join_runtime_filters=1, join_runtime_filter_min_probe_rows = 0, join_runtime_filter_exact_values_limit=100, log_comment='Q1';
...
FROM
    ...
    (SELECT (number, number+1) aS b FROM numbers(1000)) AS t2
WHERE t1.a = t2.b
SETTINGS enable_join_runtime_filters=1, join_runtime_filter_min_probe_rows = 0, join_runtime_filter_exact_values_limit=10000, log_comment='Q2';
