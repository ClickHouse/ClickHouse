...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = 3 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = 5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = 5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE 3 = i AND i = 5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE 3 = i AND i = 5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = toUInt8(3) SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = toUInt8(3) SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = toUInt8(5) SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = toUInt8(5) SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = 3.0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = 3.0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = 3.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = 3.5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i < 2 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i < 2 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i > 1 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i > 1 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i >= 4 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i >= 4 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i < 2.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i < 2.5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i < 5 AND i < 3 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i < 5 AND i < 3 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i > 3 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i > 3 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i < 5 AND i > 1 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i < 5 AND i > 1 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i < 1 AND i > 5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i < 1 AND i > 5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i < 5.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i < 5.5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE 5 > i AND i > 1 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE 5 > i AND i > 1 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE 3 = i AND 10 > i SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE 3 = i AND 10 > i SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE 5 > i AND 1 < i SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE 5 > i AND 1 < i SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i < 5 AND f > 2.0 AND f < 6.0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i < 5 AND f > 2.0 AND f < 6.0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = 5 AND f > 1.0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = 5 AND f > 1.0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i > 1 AND i < 5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i > 1 AND i < 5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i < 5 AND i > 3 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i < 5 AND i > 3 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i < 5 AND i > 5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i < 5 AND i > 5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE lc = 'y' AND lc = 'y' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE lc = 'y' AND lc = 'y' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE lc = 'y' AND lc = 'z' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE lc = 'y' AND lc = 'z' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE s = 'c' AND s = 'c' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE s = 'c' AND s = 'c' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE s = 'c' AND s = 'a' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE s = 'c' AND s = 'a' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = u AND u = 5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i = u AND u = 5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i < 3 AND u > 3 AND u < 10 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i < 3 AND u > 3 AND u < 10 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > u AND u > 2 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > u AND u > 2 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = u AND u = 3 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = u AND u = 3 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i < 5 AND s != '' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1 AND i < 5 AND s != '' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i != 1 AND i != 3 AND i != 7 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i != 1 AND i != 3 AND i != 7 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i != 1 AND i != 3 AND i != 1 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i != 1 AND i != 3 AND i != 1 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > u AND i < u SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > u AND i < u SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i > NULL SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i > NULL SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = 3 AND f = 3.0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = 3 AND f = 3.0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = 3 AND f = 4 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = 3 AND f = 4 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f > 1 AND f < 5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f > 1 AND f < 5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = 3 AND f < 3.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = 3 AND f < 3.5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = '1.5' AND f = 1.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = '1.5' AND f = 1.5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = '3.0' AND f < 5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = '3.0' AND f < 5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = '3.0' AND f = '5.0' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = '3.0' AND f = '5.0' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = '2024-06-15 12:00:00' AND dt = '2024-06-15 12:00:00' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = '2024-06-15 12:00:00' AND dt = '2024-06-15 12:00:00' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = '2024-06-15 12:00:00' AND dt = '2025-01-01 00:00:00' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = '2024-06-15 12:00:00' AND dt = '2025-01-01 00:00:00' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt > '2024-01-01 00:00:00' AND dt < '2025-01-01 00:00:00' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt > '2024-01-01 00:00:00' AND dt < '2025-01-01 00:00:00' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = 1718452800 AND dt > 1704067200 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = 1718452800 AND dt > 1704067200 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = 1718452800 AND dt = 1735689600 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = 1718452800 AND dt = 1735689600 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt > 1704067200 AND dt < 1735689600 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt > 1704067200 AND dt < 1735689600 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i > 1.5 AND i < '5' SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i = 3 AND i > 1.5 AND i < '5' SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = '3.0' AND f > 1 AND f < 5.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE f = '3.0' AND f > 1 AND f < 5.5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = '2024-06-15 12:00:00' AND dt > 1704067200 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE dt = '2024-06-15 12:00:00' AND dt > 1704067200 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u = 256 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u = 256 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u = -1 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u = -1 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u > 255 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u > 255 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u < 0 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u < 0 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u > 255 AND u < 100 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u > 255 AND u < 100 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u >= 255 AND u != 0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u >= 255 AND u != 0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 3.5 AND u > 0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 3.5 AND u > 0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 3.0 AND u > 0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 3.0 AND u > 0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u > 254.5 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE u > 254.5 AND i > 0 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1.5 AND i < 4.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1.5 AND i < 4.5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 3.5 AND i < 2.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 3.5 AND i < 2.5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1.5 AND i > 3.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 1.5 AND i > 3.5 SETTINGS optimize_and_compare_chain_pruning = 1;
...
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 2.5 AND i < 3.5 SETTINGS optimize_and_compare_chain_pruning = 0;
EXPLAIN QUERY TREE SELECT * FROM 04032_t WHERE i > 2.5 AND i < 3.5 SETTINGS optimize_and_compare_chain_pruning = 1;
