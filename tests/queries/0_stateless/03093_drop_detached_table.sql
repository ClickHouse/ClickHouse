...
CREATE TABLE test_table_03093_dist (key UInt64) Engine=Distributed('test_cluster_two_shards', currentDatabase(), 'test_table_03093_for_dist');
...
CREATE TABLE test_table_03093_for_dist (key Nullable(UInt64)) Engine=TinyLog();
CREATE TABLE test_table_03093_dist_perm (key UInt64) Engine=Distributed('test_cluster_two_shards', currentDatabase(), 'test_table_03093_for_dist');
