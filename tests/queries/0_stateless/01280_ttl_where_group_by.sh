...
$CLICKHOUSE_CLIENT --query "drop table ttl_01280_1"
$CLICKHOUSE_CLIENT --query "drop table ttl_01280_2"
$CLICKHOUSE_CLIENT --query "drop table ttl_01280_3"
$CLICKHOUSE_CLIENT --query "drop table ttl_01280_4"
$CLICKHOUSE_CLIENT --query "drop table ttl_01280_5"
$CLICKHOUSE_CLIENT --query "drop table ttl_01280_6"
