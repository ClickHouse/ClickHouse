...
$CLICKHOUSE_LOCAL --query "
    ...
    (
        SELECT * FROM file('${CUR_DIR}/02995_settings_26_6_1.tsv', 'TSV', 'name String, default String')
    ),
    old_merge_tree_settings AS
    (
        SELECT * FROM file('${CUR_DIR}/02995_merge_tree_settings_settings_26_6_1.tsv', 'TSV', 'name String, default String')
    ),
    new_settings AS
    (
