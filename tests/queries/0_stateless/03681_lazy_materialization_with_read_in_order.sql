...
SELECT a, e FROM test_lazy_read_in_order ORDER BY a LIMIT 5;
...
SELECT a, e FROM test_lazy_read_in_order WHERE e > 100 ORDER BY a LIMIT 5;
...
SELECT a, e FROM test_lazy_read_in_order PREWHERE e > 100 ORDER BY a LIMIT 5;
...
SELECT a, e FROM test_lazy_read_in_order ORDER BY a, e LIMIT 5;
...
SELECT a, e FROM test_lazy_read_in_order ORDER BY a, a + 1 LIMIT 5;
...
INSERT INTO test_correctness VALUES
    (5, 'five', 50, 'data5'),
    (2, 'two', 20, 'data2'),
    (8, 'eight', 80, 'data8'),
    (1, 'one', 10, 'data1'),
...
ORDER BY id ASC
LIMIT 5
SETTINGS optimize_read_in_order=0, query_plan_optimize_lazy_materialization=0;
