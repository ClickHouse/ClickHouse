...
-- value far below the scale-9 range: the number of ticks overflows Int64
SELECT toDateTime64(-999999999999.0, 9, 'UTC'); -- { serverError DECIMAL_OVERFLOW }
SELECT toDateTime64(-999999999999, 9, 'UTC'); -- { serverError DECIMAL_OVERFLOW }
