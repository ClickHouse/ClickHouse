-- Regression guard: read a Wide part whose JSON(max_dynamic_paths=0) column has a
-- multi-mark Object structure stream (exercises MergeTreeReaderStream getRightOffset
