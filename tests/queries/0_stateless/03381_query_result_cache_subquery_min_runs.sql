...
SET query_cache_tag = '03381_query_result_cache_subquery_min_runs';

SET enable_analyzer = 1;

SYSTEM CLEAR QUERY CACHE TAG '03381_query_result_cache_subquery_min_runs';
...
SELECT count(*) FROM (SELECT * FROM system.query_cache WHERE tag = '03381_query_result_cache_subquery_min_runs') AS test_query_cache WHERE is_subquery = 1;
-- Expected: 0
