...
insert into function file(currentDatabase() || '_05231_u32.parquet', Parquet, 'x UInt32')
    select toUInt32(70000) as x;
insert into function file(currentDatabase() || '_05231_i64.parquet', Parquet, 'x Int64')
    select toInt64(4294967301) as x;
insert into function file(currentDatabase() || '_05231_u8.parquet', Parquet, 'x UInt8')
    select toUInt8(200) as x;
insert into function file(currentDatabase() || '_05231_i8.parquet', Parquet, 'x Int8')
    select toInt8(-1) as x;
insert into function file(currentDatabase() || '_05231_u32big.parquet', Parquet, 'x UInt32')
    select toUInt32(3000000000) as x;
insert into function file(currentDatabase() || '_05231_i32neg.parquet', Parquet, 'x Int32')
    select toInt32(number - 4000) as x from numbers(4000)
    settings output_format_parquet_row_group_size = 1000;
insert into function file(currentDatabase() || '_05231_i32ts.parquet', Parquet, 'x Int32')
    select toInt32(2000000000) as x;
insert into function file(currentDatabase() || '_05231_str.parquet', Parquet, 'x String')
    select '3500' as x;
insert into function file(currentDatabase() || '_05231_fs4.parquet', Parquet, 'x FixedString(4)')
...
select count() from file(currentDatabase() || '_05231_i8.parquet', Parquet, 'x UInt8') where x = 255;
select count() from file(currentDatabase() || '_05231_i8.parquet', Parquet, 'x UInt8') where x = 255
...
select count() from file(currentDatabase() || '_05231_i8.parquet', Parquet, 'x UInt16') where x = 65535;

-- A signed source read as DateTime, which saturates every negative value to the epoch.
select count() from file(currentDatabase() || '_05231_i32neg.parquet', Parquet, 'x DateTime')
...
select count() from file(currentDatabase() || '_05231_str.parquet', Parquet, 'x FixedString(8)')
    where x = '3500';
...
select count() from file(currentDatabase() || '_05231_u32.parquet', Parquet, 'x UInt16') where x = 4464
    settings input_format_parquet_filter_push_down = 0, input_format_parquet_page_filter_push_down = 0;
select count() from file(currentDatabase() || '_05231_i64.parquet', Parquet, 'x Int32') where x = 5
    settings input_format_parquet_filter_push_down = 0, input_format_parquet_page_filter_push_down = 0;

-- The mirror of the 8-bit signedness flip above, unsigned stored and signed requested.
select count() from file(currentDatabase() || '_05231_u8.parquet', Parquet, 'x Int8') where x = -56
    settings input_format_parquet_filter_push_down = 0, input_format_parquet_page_filter_push_down = 0;

-- Enum hints: narrowing into the enum's Int16, and a signedness flip through an Enum8.
select count() from file(currentDatabase() || '_05231_u32big.parquet', Parquet, 'x Enum16(\'a\' = 24064)')
    where x = 'a'
    settings input_format_parquet_filter_push_down = 0, input_format_parquet_page_filter_push_down = 0;
select count() from file(currentDatabase() || '_05231_u8.parquet', Parquet, 'x Enum8(\'a\' = -56)')
    where x = 'a'
    settings input_format_parquet_filter_push_down = 0, input_format_parquet_page_filter_push_down = 0;
...
-- date literal.
select count() from file(currentDatabase() || '_05231_u32big.parquet', Parquet, 'x Date32')
...
select count() from file(currentDatabase() || '_05231_i32ts.parquet', Parquet, 'x Date32')
    where x = toDate32(toDateTime(2000000000))
    settings input_format_parquet_filter_push_down = 0, input_format_parquet_page_filter_push_down = 0;

-- The Nullable wrapper must not hide the narrowing underneath it.
select count() from file(currentDatabase() || '_05231_u32.parquet', Parquet, 'x Nullable(UInt16)')
    where x = 4464
    settings input_format_parquet_filter_push_down = 0, input_format_parquet_page_filter_push_down = 0;
...
select count() from file(currentDatabase() || '_05231_fs4.parquet', Parquet, 'x String') where x = 'ab'
    settings input_format_parquet_filter_push_down = 0, input_format_parquet_page_filter_push_down = 0;
...
insert into function file(currentDatabase() || '_05231_c_u8.parquet', Parquet, 'x UInt8')
...
insert into function file(currentDatabase() || '_05231_c_i8.parquet', Parquet, 'x Int8')
    select toInt8(number - 128) as x from numbers(256)
    settings output_format_parquet_row_group_size = 64, output_format_parquet_write_bloom_filter = 1;
insert into function file(currentDatabase() || '_05231_c_u32.parquet', Parquet, 'x UInt32')
...
insert into function file(currentDatabase() || '_05231_c_i32.parquet', Parquet, 'x Int32')
    select toInt32(number) as x from numbers(4000)
    settings output_format_parquet_row_group_size = 1000, output_format_parquet_write_bloom_filter = 1;
insert into function file(currentDatabase() || '_05231_c_u64.parquet', Parquet, 'x UInt64')
    select toUInt64(18446744073709547616 + number) as x from numbers(4000)
    settings output_format_parquet_row_group_size = 1000, output_format_parquet_write_bloom_filter = 1;
insert into function file(currentDatabase() || '_05231_c_u32ts.parquet', Parquet, 'x UInt32')
    select toUInt32(3000000000 + number) as x from numbers(4000)
    settings output_format_parquet_row_group_size = 1000, output_format_parquet_write_bloom_filter = 1;
insert into function file(currentDatabase() || '_05231_c_str.parquet', Parquet, 'x String')
    select leftPad(toString(number), 4, '0') as x from numbers(4000)
    settings output_format_parquet_row_group_size = 1000, output_format_parquet_write_bloom_filter = 1;
insert into function file(currentDatabase() || '_05231_c_ipv6.parquet', Parquet, 'x IPv6')
...
-- physical width.
select count() from file(currentDatabase() || '_05231_c_u8.parquet', Parquet, 'x UInt8') where x = 200
...
select count() from file(currentDatabase() || '_05231_c_u32.parquet', Parquet, 'x UInt32') where x = 3500
...
select count() from file(currentDatabase() || '_05231_c_u8.parquet', Parquet, 'x Int16') where x = 200
...
select count() from file(currentDatabase() || '_05231_c_u8.parquet', Parquet, 'x Int16') where x = 200
    settings log_comment = 'hfilter_b_03_u8_i16', input_format_parquet_filter_push_down = 0,
             input_format_parquet_page_filter_push_down = 0, input_format_parquet_bloom_filter_push_down = 1,
             input_format_parquet_dictionary_filter_push_down = 0;
select count() from file(currentDatabase() || '_05231_c_i8.parquet', Parquet, 'x Int16') where x = 100
...
select count() from file(currentDatabase() || '_05231_c_i32.parquet', Parquet, 'x UInt32') where x = 3500
...
select count() from file(currentDatabase() || '_05231_c_i32.parquet', Parquet, 'x UInt32') where x = 3500
    settings log_comment = 'hfilter_b_05_i32_u32', input_format_parquet_filter_push_down = 0,
             input_format_parquet_page_filter_push_down = 0, input_format_parquet_bloom_filter_push_down = 1,
             input_format_parquet_dictionary_filter_push_down = 0;
select count() from file(currentDatabase() || '_05231_c_u64.parquet', Parquet, 'x Int64') where x = -500
...
select count() from file(currentDatabase() || '_05231_c_u64.parquet', Parquet, 'x Int64') where x = -500
    settings log_comment = 'hfilter_b_06_u64_i64', input_format_parquet_filter_push_down = 0,
             input_format_parquet_page_filter_push_down = 0, input_format_parquet_bloom_filter_push_down = 1,
             input_format_parquet_dictionary_filter_push_down = 0;
select count() from file(currentDatabase() || '_05231_c_i8.parquet', Parquet, 'x UInt32') where x = 100
...
select count() from file(currentDatabase() || '_05231_c_u32ts.parquet', Parquet, 'x DateTime')
...
select count() from file(currentDatabase() || '_05231_c_u32ts.parquet', Parquet, 'x DateTime')
    ...
    settings log_comment = 'hfilter_b_08_u32_dt', input_format_parquet_filter_push_down = 0,
             input_format_parquet_page_filter_push_down = 0, input_format_parquet_bloom_filter_push_down = 1,
             input_format_parquet_dictionary_filter_push_down = 0;
select count() from file(currentDatabase() || '_05231_c_u32.parquet', Parquet, 'x IPv4')
    where x = toIPv4(3500)
...
select count() from file(currentDatabase() || '_05231_c_u8.parquet', Parquet, 'x Date')
    where x = toDate(200)
...
select count() from file(currentDatabase() || '_05231_c_u8.parquet', Parquet, 'x Date')
    ...
    settings log_comment = 'hfilter_b_10_u8_date', input_format_parquet_filter_push_down = 0,
             input_format_parquet_page_filter_push_down = 0, input_format_parquet_bloom_filter_push_down = 1,
             input_format_parquet_dictionary_filter_push_down = 0;
select count() from file(currentDatabase() || '_05231_c_i8.parquet', Parquet, 'x Date32')
...
select count() from file(currentDatabase() || '_05231_c_u32.parquet', Parquet, 'x Nullable(UInt32)')
    where x = 3500
...
select count() from file(currentDatabase() || '_05231_c_u32.parquet', Parquet, 'x Nullable(UInt32)')
    ...
    settings log_comment = 'hfilter_b_12_u32_nu32', input_format_parquet_filter_push_down = 0,
             input_format_parquet_page_filter_push_down = 0, input_format_parquet_bloom_filter_push_down = 1,
             input_format_parquet_dictionary_filter_push_down = 0;
select count() from file(currentDatabase() || '_05231_c_str.parquet', Parquet, 'x LowCardinality(String)')
    where x = '3500'
...
select count() from file(currentDatabase() || '_05231_c_str.parquet', Parquet, 'x String')
    where x = '3500'
...
select count() from file(currentDatabase() || '_05231_c_str.parquet', Parquet, 'x String')
    ...
    settings log_comment = 'hfilter_b_14_str_str', input_format_parquet_filter_push_down = 0,
             input_format_parquet_page_filter_push_down = 0, input_format_parquet_bloom_filter_push_down = 1,
             input_format_parquet_dictionary_filter_push_down = 0;
select count() from file(currentDatabase() || '_05231_c_ipv6.parquet', Parquet, 'x IPv6')
