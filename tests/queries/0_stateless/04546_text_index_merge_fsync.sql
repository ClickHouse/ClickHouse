...
-- single blob, so it has no per-stream index files to fsync and the delta would read 0 for a
...
SETTINGS min_rows_to_fsync_after_merge = 1, min_compressed_bytes_to_fsync_after_merge = 1,
         fsync_part_directory = 1, fsync_after_insert = 1, min_bytes_for_wide_part = 0, min_rows_for_wide_part = 0,
         min_bytes_for_full_part_storage = 0, max_bytes_to_merge_at_max_space_in_pool = 1, index_granularity = 1024;
