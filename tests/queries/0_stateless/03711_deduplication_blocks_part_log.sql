...
SELECT id, value FROM 03710_database.03711_table as l JOIN 03710_database.03711_join_with as r ON l.id == r.id and l.id = 1;
...
SELECT id, value FROM 03710_database.03711_table as l JOIN 03710_database.03711_join_with as r ON l.id == r.id and l.id = 2;
