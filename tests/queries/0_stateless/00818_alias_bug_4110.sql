...
select 10 as a, a + 1 as a; -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }
with 10 as a select a as a; -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }
with 10 as a select a + 1 as a; -- { serverError MULTIPLE_EXPRESSIONS_FOR_ALIAS }
