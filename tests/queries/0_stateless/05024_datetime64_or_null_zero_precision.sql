...
SELECT toTypeName(toDateTime64OrNull('0001-01-01', 0));
SELECT toDateTime64OrNull('0001-01-01', 0);

SELECT toTypeName(toDateTime64OrNull('0001-01-01', 0, 'UTC'));
...
SELECT toTypeName(toDateTime64OrZero('0001-01-01', 0, 'UTC'));
