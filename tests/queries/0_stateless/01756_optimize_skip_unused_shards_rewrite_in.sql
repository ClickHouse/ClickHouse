...
-- the identifier-free right-hand side is folded to a constant during predicate analysis, so shards can be skipped
select * from dist_01756 where dummy in (toUInt8(0)) settings enable_analyzer=0;
