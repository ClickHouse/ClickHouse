...
SELECT dateDiff('second', toDate32('1900-01-01'), toDateTime64('1900-01-02 00:00:00', 3, 'UTC'));
SELECT dateDiff('minute', toDate32('1900-01-01'), toDateTime64('1900-01-02 00:00:00', 3, 'UTC'));
SELECT dateDiff('hour', toDate32('1900-01-01'), toDateTime64('1900-01-02 00:00:00', 3, 'UTC'));
SELECT dateDiff('day', toDate32('1900-01-01'), toDateTime64('1900-01-02 00:00:00', 3, 'UTC'));
SELECT dateDiff('week', toDate32('1900-01-01'), toDateTime64('1900-01-08 00:00:00', 3, 'UTC'));
SELECT dateDiff('month', toDate32('1900-01-01'), toDateTime64('1900-02-01 00:00:00', 3, 'UTC'));
SELECT dateDiff('quarter', toDate32('1900-01-01'), toDateTime64('1900-04-01 00:00:00', 3, 'UTC'));
SELECT dateDiff('year', toDate32('1900-01-01'), toDateTime64('1901-01-01 00:00:00', 3, 'UTC'));

-- DateTime64 vs Date32
SELECT dateDiff('second', toDateTime64('1900-01-01 00:00:00', 3, 'UTC'), toDate32('1900-01-02'));
SELECT dateDiff('minute', toDateTime64('1900-01-01 00:00:00', 3, 'UTC'), toDate32('1900-01-02'));
SELECT dateDiff('hour', toDateTime64('1900-01-01 00:00:00', 3, 'UTC'), toDate32('1900-01-02'));
SELECT dateDiff('day', toDateTime64('1900-01-01 00:00:00', 3, 'UTC'), toDate32('1900-01-02'));
SELECT dateDiff('week', toDateTime64('1900-01-01 00:00:00', 3, 'UTC'), toDate32('1900-01-08'));
SELECT dateDiff('month', toDateTime64('1900-01-01 00:00:00', 3, 'UTC'), toDate32('1900-02-01'));
SELECT dateDiff('quarter', toDateTime64('1900-01-01 00:00:00', 3, 'UTC'), toDate32('1900-04-01'));
SELECT dateDiff('year', toDateTime64('1900-01-01 00:00:00', 3, 'UTC'), toDate32('1901-01-01'));
...
SELECT dateDiff('day', toDate32('1900-01-01'), materialize(toDateTime64('1900-01-02 00:00:00', 3, 'UTC')));
SELECT dateDiff('day', toDateTime64('1900-01-01 00:00:00', 3, 'UTC'), materialize(toDate32('1900-01-02')));
...
SELECT dateDiff('day', materialize(toDate32('1900-01-01')), toDateTime64('1900-01-02 00:00:00', 3, 'UTC'));
SELECT dateDiff('day', materialize(toDateTime64('1900-01-01 00:00:00', 3, 'UTC')), toDate32('1900-01-02'));
...
SELECT dateDiff('day', materialize(toDate32('1900-01-01')), materialize(toDateTime64('1900-01-02 00:00:00', 3, 'UTC')));
SELECT dateDiff('day', materialize(toDateTime64('1900-01-01 00:00:00', 3, 'UTC')), materialize(toDate32('1900-01-02')));
