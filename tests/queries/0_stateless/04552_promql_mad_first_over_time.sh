...
echo "-- host1 -> 10, host2 -> 5, host3 -> 100; host4's only sample is older than the window, so it is dropped."
...
echo "-- host1 = 10 (median 20, deviations 10/0/10), host2 = 10 (median 15, deviations 10/0/10), host3 = 0."
