...
clang++-19 -c -Os -fno-exceptions -fno-rtti -nostdlib -D LEXER_STANDALONE_BUILD "${CUR_DIR}/../../../src/Parsers/Lexer.cpp" -o "${CLICKHOUSE_TMP}/Lexer.o"
...
clang-19 main.c "${CLICKHOUSE_TMP}/Lexer.o" -o "${CLICKHOUSE_TMP}/lexer"
