...
USING number
SETTINGS max_threads=16, query_plan_execute_functions_after_sorting=0, query_plan_merge_expressions=1, query_plan_push_down_limit=1;
...
USING number
SETTINGS max_threads=16, query_plan_use_new_logical_join_step = 0, query_plan_execute_functions_after_sorting=0, query_plan_merge_expressions=1, query_plan_push_down_limit=1;
