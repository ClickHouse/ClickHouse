...
SELECT 'subquery shall use main query session_timezone';
...
SELECT 'test proper serialization';
...
SELECT 'Create a table and test that DateTimes are processed correctly on insert';
...
SELECT 'Test parsing in WHERE filter, shall have the same logic as insert';
