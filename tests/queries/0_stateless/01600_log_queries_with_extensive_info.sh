...
${CLICKHOUSE_CLIENT} -q "alter table test_log_queries.logtable rename column j to x, rename column k to y" "--query_id=01600_log_queries_with_extensive_info_09"
${CLICKHOUSE_CLIENT} -q "alter table test_log_queries.logtable2 add column x int, add column y int" "--query_id=01600_log_queries_with_extensive_info_010"
${CLICKHOUSE_CLIENT} -q "optimize table test_log_queries.logtable" "--query_id=01600_log_queries_with_extensive_info_011"
${CLICKHOUSE_CLIENT} -q "drop table if exists test_log_queries.logtable" "--query_id=01600_log_queries_with_extensive_info_012"
${CLICKHOUSE_CLIENT} -q "drop table if exists test_log_queries.logtable2" "--query_id=01600_log_queries_with_extensive_info_013"
${CLICKHOUSE_CLIENT} -q "drop database if exists test_log_queries" "--query_id=01600_log_queries_with_extensive_info_014"
