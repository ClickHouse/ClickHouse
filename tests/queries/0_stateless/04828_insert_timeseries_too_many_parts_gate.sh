...
$CLICKHOUSE_CLIENT -q "
DROP TABLE IF EXISTS ts_gate_mv_a;
DROP TABLE IF EXISTS ts_gate_mv_b;
DROP TABLE IF EXISTS ts_gate;
DROP TABLE IF EXISTS ts_gate_source;
DROP TABLE IF EXISTS ts_gate_data;
DROP TABLE IF EXISTS ts_gate_tags;
DROP TABLE IF EXISTS ts_gate_metrics;
"
...
$CLICKHOUSE_CLIENT -q "
DROP TABLE ts_gate_mv_a;
DROP TABLE ts_gate_mv_b;
DROP TABLE ts_gate;
DROP TABLE ts_gate_source;
DROP TABLE ts_gate_data;
DROP TABLE ts_gate_tags;
DROP TABLE ts_gate_metrics;
"
...
$CLICKHOUSE_CLIENT -q "
DROP TABLE IF EXISTS ts_quorum_mv_a;
DROP TABLE IF EXISTS ts_quorum_mv_b;
DROP TABLE IF EXISTS ts_quorum;
DROP TABLE IF EXISTS ts_quorum_source;
DROP TABLE IF EXISTS ts_quorum_data_1;
DROP TABLE IF EXISTS ts_quorum_data_2;
DROP TABLE IF EXISTS ts_quorum_tags;
DROP TABLE IF EXISTS ts_quorum_metrics;
"
...
$CLICKHOUSE_CLIENT --select_sequential_consistency=1 -q "
SELECT count() FROM ts_quorum_data_1;
SELECT count() FROM ts_quorum_data_2;
"

$CLICKHOUSE_CLIENT -q "
DROP TABLE ts_quorum_mv_a;
DROP TABLE ts_quorum_mv_b;
DROP TABLE ts_quorum;
DROP TABLE ts_quorum_source;
DROP TABLE ts_quorum_data_1;
DROP TABLE ts_quorum_data_2;
DROP TABLE ts_quorum_tags;
DROP TABLE ts_quorum_metrics;
"
