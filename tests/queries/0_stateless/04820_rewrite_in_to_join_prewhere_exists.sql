...
SELECT count() FROM t_114026_null PREWHERE x IN (SELECT CAST(NULL, 'Nullable(UInt8)')) SETTINGS rewrite_in_to_join = 1, allow_experimental_correlated_subqueries = 1, transform_null_in = 1;
