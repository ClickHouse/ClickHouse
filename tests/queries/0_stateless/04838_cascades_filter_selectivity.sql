...
-- estimate would fall back to 10% of the 600000000-row left input. The join rewrite is turned
-- off: a semi join on a key without statistics keeps the left estimate.
