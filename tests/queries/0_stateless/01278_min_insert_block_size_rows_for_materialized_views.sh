...
{
    ${CLICKHOUSE_CLIENT} --max_memory_usage=$TEST_01278_MEMORY --parallel_view_processing --optimize_trivial_insert_select='false' "$@" -q "
explain pipeline graph = 1, compact = 0 insert into data_01278 select
    number,
