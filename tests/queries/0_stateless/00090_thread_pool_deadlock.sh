...
# Tag no-parallel: deliberately saturates the global thread pool; running it concurrently
#   starves other tests' queries into `CANNOT_SCHEDULE_TASK` (no free thread) failures
