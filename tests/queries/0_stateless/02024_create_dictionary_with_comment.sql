...
DROP DICTIONARY IF EXISTS _2024_dictionary_with_comment;

CREATE DICTIONARY _2024_dictionary_with_comment
(
    id UInt64,
    value String
)
...
SHOW CREATE DICTIONARY _2024_dictionary_with_comment;
SELECT comment FROM system.dictionaries WHERE name == '_2024_dictionary_with_comment' AND database == currentDatabase();
