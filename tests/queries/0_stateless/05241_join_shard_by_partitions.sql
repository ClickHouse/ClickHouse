...
SELECT count() FROM t_left AS l JOIN t_right AS r ON l.d = r.d SETTINGS log_comment = '05241_inner';
SYSTEM FLUSH LOGS query_log;
-- 3 * 184 rows of 2026-03 .. 2026-08 on the left, 2 * 184 on the right.
SELECT read_rows FROM system.query_log
WHERE current_database = currentDatabase() AND log_comment = '05241_inner' AND type = 'QueryFinish';
