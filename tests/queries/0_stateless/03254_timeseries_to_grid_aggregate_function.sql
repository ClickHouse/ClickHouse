...
SET enable_parallel_replicas = 0; -- Prevent randomized parallel replicas from interfering with aggregate function type comparison (same fix as the sparse variant).
