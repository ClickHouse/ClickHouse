...
-- The `subcolumns=1` cases also enable `optimize_map_element_to_subcolumn`, which gates the
-- m['key'] -> m.key_<key> rewrite and is disabled by default, so they read the key subcolumn.
...
SELECT 'wide, filter id=2, subcolumns=1', m[''] FROM t_map_dup WHERE id = 2 SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
SELECT 'wide, no filter, subcolumns=0', id, m[''] FROM t_map_dup ORDER BY id SETTINGS optimize_functions_to_subcolumns = 0;
SELECT 'wide, no filter, subcolumns=1', id, m[''] FROM t_map_dup ORDER BY id SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
...
SELECT 'wide, count first value, subcolumns=1', count() FROM t_map_dup WHERE id = 2 AND m[''] = 'FIRST' SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
...
SELECT 'compact, filter id=2, subcolumns=1', m[''] FROM t_map_dup WHERE id = 2 SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
SELECT 'compact, no filter, subcolumns=0', id, m[''] FROM t_map_dup ORDER BY id SETTINGS optimize_functions_to_subcolumns = 0;
SELECT 'compact, no filter, subcolumns=1', id, m[''] FROM t_map_dup ORDER BY id SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
...
SELECT 'Nullable(String) subcolumns=1', m['d'] FROM t_map_types WHERE id = 2 SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
...
SELECT 'LowCardinality(String) subcolumns=1', m['d'] FROM t_map_types WHERE id = 2 SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
DROP TABLE t_map_types;
...
SELECT 'LowCardinality(Nullable(String)) subcolumns=1', m['d'] FROM t_map_types WHERE id = 2 SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
DROP TABLE t_map_types;
...
SELECT 'UInt64 subcolumns=1', m['d'] FROM t_map_types WHERE id = 2 SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
DROP TABLE t_map_types;
...
SELECT 'Array(String) subcolumns=1', m['d'] FROM t_map_types WHERE id = 2 SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
DROP TABLE t_map_types;
...
SELECT 'LowCardinality(String) key subcolumns=1', m['d'] FROM t_map_types WHERE id = 2 SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
DROP TABLE t_map_types;
...
SELECT 'UInt64 key subcolumns=1', m[7] FROM t_map_types WHERE id = 2 SETTINGS optimize_functions_to_subcolumns = 1, optimize_map_element_to_subcolumn = 1;
DROP TABLE t_map_types;
