...
create table t0 (key Int) engine=MergeTree order by () settings auto_statistics_types='', add_minmax_index_for_numeric_columns=0;
create table t1 (key Int) engine=MergeTree order by () settings auto_statistics_types='', add_minmax_index_for_numeric_columns=0;
