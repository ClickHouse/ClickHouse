...
ATTACH TABLE parsed_cache_reader UUID '$READER_UUID' (id UInt64) ENGINE=IcebergLocal('$TABLE_PATH');
...
ATTACH TABLE parsed_cache_disabled UUID '$DISABLED_UUID' (id UInt64) ENGINE=IcebergLocal('$TABLE_PATH');
