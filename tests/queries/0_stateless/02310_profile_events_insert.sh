...
echo local
$CLICKHOUSE_LOCAL --async_insert=0 --print-profile-events --profile-events-delay-ms=-1 -q "insert into function null('foo Int') values (1)" |& grep -o 'InsertedRows: .*' >/dev/null || true
