...
SELECT toDateTime('2024 April 4', 'UTC') SETTINGS cast_string_to_date_time_mode = 'basic'; -- { serverError CANNOT_PARSE_DATETIME, CANNOT_PARSE_TEXT }
SELECT CAST('2024 April 4' AS DateTime('UTC')) SETTINGS cast_string_to_date_time_mode = 'basic'; -- { serverError CANNOT_PARSE_DATETIME, CANNOT_PARSE_TEXT }

-- Verify basic mode rejects these formats for DateTime64
SELECT toDateTime64('2024 April 4', 3, 'UTC') SETTINGS cast_string_to_date_time_mode = 'basic'; -- { serverError CANNOT_PARSE_DATETIME, CANNOT_PARSE_TEXT }
SELECT CAST('2024 April 4' AS DateTime64(3, 'UTC')) SETTINGS cast_string_to_date_time_mode = 'basic'; -- { serverError CANNOT_PARSE_DATETIME, CANNOT_PARSE_TEXT }
