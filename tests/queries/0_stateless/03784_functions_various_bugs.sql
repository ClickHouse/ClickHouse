...
-- A `LowCardinality(Nullable(...))` denominator selects the NULL-masking variant, so a NULL row
-- returns NULL instead of dividing by the dictionary's default `0` (#117216).
