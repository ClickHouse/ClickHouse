SELECT '-1E9-1E9-1E9-1E9' AS x, toDecimal32(x, 0); -- { serverError ARGUMENT_OUT_OF_BOUND }
...
SELECT '1E-9' AS x, toDecimal32(x, 10); -- { serverError ARGUMENT_OUT_OF_BOUND }
SELECT '1E-10' AS x, toDecimal32(x, 10); -- { serverError ARGUMENT_OUT_OF_BOUND }
