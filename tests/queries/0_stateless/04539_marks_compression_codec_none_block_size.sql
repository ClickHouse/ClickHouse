...
INSERT INTO marks_none_wide_big SELECT number FROM numbers(20000);
INSERT INTO marks_none_wide_small SELECT number FROM numbers(20000);
INSERT INTO marks_none_compact_big SELECT number FROM numbers(20000);
INSERT INTO marks_none_compact_small SELECT number FROM numbers(20000);
...
SELECT count(), sum(n) FROM marks_none_wide_big WHERE n >= 19990;
SELECT count(), sum(n) FROM marks_none_compact_big;
SELECT count(), sum(n) FROM marks_none_compact_big WHERE n >= 19990;
