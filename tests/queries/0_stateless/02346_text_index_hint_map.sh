...
MY_CLICKHOUSE_CLIENT="${CLICKHOUSE_CLIENT} --enable_text_index 1 --use_skip_indexes_on_data_read 1 --query_plan_text_index_add_hint 1 --use_query_condition_cache 0 --enable_analyzer 1"
