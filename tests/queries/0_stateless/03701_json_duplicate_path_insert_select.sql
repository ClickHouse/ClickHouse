...
INSERT INTO test_json_duplicates SELECT '{"a": 1, "a": 2}'::JSON; -- {serverError INCORRECT_DATA}

-- Should succeed with setting
INSERT INTO test_json_duplicates SELECT '{"a": 1, "a": 2}'::JSON SETTINGS type_json_skip_duplicated_paths=1;
