...
explain pipeline select * from x1 order by i desc limit 5;

select * from x1 order by i desc limit 5;

explain pipeline select * from x1 order by i limit 5;
...
explain pipeline select * from x2 order by i, j desc limit 5;

select * from x2 order by i, j desc limit 5;

explain pipeline select * from x2 order by i, j limit 5;
