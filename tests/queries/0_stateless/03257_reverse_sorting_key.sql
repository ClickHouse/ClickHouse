...
explain pipeline select * from x1 order by i desc nulls first limit 5 settings max_threads=1, read_in_order_use_virtual_row=0;
...
explain pipeline select * from x1 order by i limit 5 settings max_threads=1, read_in_order_use_virtual_row=0;
...
explain pipeline select * from x2 order by i, j desc nulls first limit 5 settings max_threads=1, read_in_order_use_virtual_row=0;
...
explain pipeline select * from x2 order by i, j limit 5 settings max_threads=1, read_in_order_use_virtual_row=0;
