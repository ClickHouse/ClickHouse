...
-- =============================================================================
-- Three AI function defaults were flipped in 26.8: `ai_function_allow_insecure_endpoint`
-- from 1 to 0, `ai_function_max_api_calls_per_query` from 0 (unlimited) to 1000, and
-- `ai_function_max_retries` from 0 to 1. `compatibility` with an earlier version restores
-- all three, which pins the previous_value/new_value pairs in `SettingsChangesHistory`.
--
