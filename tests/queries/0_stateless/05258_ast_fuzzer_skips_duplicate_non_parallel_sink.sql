...
SETTINGS ast_fuzzer_runs = 30, ast_fuzzer_any_query = 1, log_comment = '05258_hazard';
...
SETTINGS ast_fuzzer_runs = 30, ast_fuzzer_any_query = 1, log_comment = '05258_safe';
...
SETTINGS ast_fuzzer_runs = 30, ast_fuzzer_any_query = 1, log_comment = '05258_undecided';
...
WHERE event_date >= today() - 1
  ...
  AND current_database = currentDatabase()
  AND log_comment = '05258_undecided'
...
CREATE TABLE {CLICKHOUSE_DATABASE_1:Identifier}.q_src (k Int) ENGINE = Kafka
    SETTINGS kafka_broker_list = 'localhost:9092', kafka_topic_list = '05258_q',
             kafka_group_name = '05258_q', kafka_format = 'CSV';
...
SETTINGS ast_fuzzer_runs = 30, ast_fuzzer_any_query = 1, log_comment = '05258_queue';
...
SETTINGS ast_fuzzer_runs = 30, ast_fuzzer_any_query = 1, log_comment = '05258_qsafe';
