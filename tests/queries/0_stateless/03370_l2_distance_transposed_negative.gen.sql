...
WITH [toBFloat16(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 0) AS dist FROM qbit ORDER BY id; -- { serverError BAD_ARGUMENTS }
WITH [toBFloat16(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 17) AS dist FROM qbit ORDER BY id; -- { serverError BAD_ARGUMENTS }
WITH [toFloat32(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 1) AS dist FROM qbit ORDER BY id;
WITH [toFloat64(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 1) AS dist FROM qbit ORDER BY id;
DROP TABLE qbit;
...
WITH [toFloat32(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 0) AS dist FROM qbit ORDER BY id; -- { serverError BAD_ARGUMENTS }
WITH [toFloat32(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 33) AS dist FROM qbit ORDER BY id; -- { serverError BAD_ARGUMENTS }
WITH [toBFloat16(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 1) AS dist FROM qbit ORDER BY id;
WITH [toFloat64(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 1) AS dist FROM qbit ORDER BY id;
DROP TABLE qbit;
...
WITH [toFloat64(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 0) AS dist FROM qbit ORDER BY id; -- { serverError BAD_ARGUMENTS }
WITH [toFloat64(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 65) AS dist FROM qbit ORDER BY id; -- { serverError BAD_ARGUMENTS }
WITH [toBFloat16(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 1) AS dist FROM qbit ORDER BY id;
WITH [toFloat32(0), 1, 2] AS reference_vec SELECT id, vec, L2DistanceTransposed(vec, reference_vec, 1) AS dist FROM qbit ORDER BY id;
DROP TABLE qbit;
