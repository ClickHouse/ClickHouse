...
SETTINGS disk = disk(name = 'test_prefetch_buffer_size_$CLICKHOUSE_DATABASE', type = cache, max_size = '10Gi', path = 'test_prefetch_buffer_size_$CLICKHOUSE_DATABASE', disk = 's3_disk'), min_bytes_for_wide_part=0, serialize_string_with_size_stream=0
