...
SELECT t1.dt FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT '20210101' AS dt UNION ALL SELECT '20210102' AS dt) AS t UNION ALL SELECT '20210103' AS dt) AS t UNION ALL SELECT '20210104' AS dt) AS t UNION ALL SELECT '20210105' AS dt) AS t UNION ALL SELECT '20210106' AS dt) AS t UNION ALL SELECT '20210107' AS dt) AS t UNION ALL SELECT '20210108' AS dt) AS t UNION ALL SELECT '20210109' AS dt) AS t UNION ALL SELECT '20210110' AS dt) AS t UNION ALL SELECT '20210111' AS dt) AS t UNION ALL SELECT '20210112' AS dt) AS t UNION ALL SELECT '20210113' AS dt) AS t UNION ALL SELECT '20210114' AS dt) AS t UNION ALL SELECT '20210115' AS dt) AS t UNION ALL SELECT '20210116' AS dt) AS t UNION ALL SELECT '20210117' AS dt) AS t UNION ALL SELECT '20210118' AS dt) AS t UNION ALL SELECT '20210119' AS dt) AS t UNION ALL SELECT '20210120' AS dt) AS t UNION ALL SELECT '20210121' AS dt) AS t UNION ALL SELECT '20210122' AS dt) AS t UNION ALL SELECT '20210123' AS dt) AS t UNION ALL SELECT '20210124' AS dt) AS t UNION ALL SELECT '20210125' AS dt) AS t UNION ALL SELECT '20210126' AS dt) AS t UNION ALL SELECT '20210127' AS dt) AS t UNION ALL SELECT '20210128' AS dt) AS t UNION ALL SELECT '20210129' AS dt) AS t UNION ALL SELECT '20210130' AS dt) AS t1 CROSS JOIN (SELECT 1000+1000) ASt2 GROUP BY t1.dt ORDER BY t1.dt;
