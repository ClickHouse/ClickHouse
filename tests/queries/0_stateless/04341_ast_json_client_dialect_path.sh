...
${CLICKHOUSE_CLIENT} --enable_json_ast_dialect 1 --dialect clickhouse_json --multiquery -q "$JSON ; $JSON"
...
OUT=$(${CLICKHOUSE_CLIENT} --enable_json_ast_dialect 1 --dialect clickhouse_json --multiquery -q "$JSON garbage" 2>&1)
