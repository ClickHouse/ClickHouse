...
SELECT CAST((NULL, number), 'Nullable(Tuple(Nullable(UInt64), UInt64))') IN [CAST((NULL, number), 'Nullable(Tuple(Nullable(UInt64), UInt64))')], CAST((NULL, number), 'Nullable(Tuple(Nullable(UInt64), UInt64))') NOT IN [CAST((NULL, number), 'Nullable(Tuple(Nullable(UInt64), UInt64))')] FROM numbers(1) SETTINGS transform_null_in = 0, enable_nullable_tuple_type = 1;
SELECT CAST((NULL, number), 'Nullable(Tuple(Nullable(UInt64), UInt64))') IN [CAST((NULL, number), 'Nullable(Tuple(Nullable(UInt64), UInt64))')], CAST((NULL, number), 'Nullable(Tuple(Nullable(UInt64), UInt64))') NOT IN [CAST((NULL, number), 'Nullable(Tuple(Nullable(UInt64), UInt64))')] FROM numbers(1) SETTINGS transform_null_in = 1, enable_nullable_tuple_type = 1;
