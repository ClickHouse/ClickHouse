...
-- The setting only substitutes a default for an invalid cell. Both endpoints below are valid cells,
-- just at different resolutions, so a line that cannot be drawn between them is still an error.
SELECT h3Line(toUInt64(585609238802333695), h3ToParent(toUInt64(585624631965122559), 1))
