...
ALTER TABLE t_text_index ADD PROJECTION idx_c1 INDEX c1 TYPE text (tokenizer = ngrams(3));
ALTER TABLE t_text_index ADD PROJECTION idx_c2 INDEX c2 TYPE text (tokenizer = ngrams(3));
