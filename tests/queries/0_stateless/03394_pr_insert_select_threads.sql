...
INSERT INTO t_mt_source SELECT number as k, toString(number) as v FROM system.numbers_mt LIMIT 1e5 SETTINGS max_block_size=1000, min_insert_block_size_rows=1000;
