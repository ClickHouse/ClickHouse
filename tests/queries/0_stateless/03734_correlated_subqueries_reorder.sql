...
SET materialize_statistics_on_insert = 1; -- CI may inject either value; statistics must be deterministically available, otherwise NDV-based ResultRows estimates differ
