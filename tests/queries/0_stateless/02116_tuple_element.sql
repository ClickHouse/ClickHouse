...
SELECT tupleElement(t1, 0) FROM t_tuple_element SETTINGS allow_experimental_analyzer = 0; -- { serverError ILLEGAL_INDEX }
SELECT tupleElement(t1, 0) FROM t_tuple_element SETTINGS allow_experimental_analyzer = 1; -- { serverError NOT_FOUND_COLUMN_IN_BLOCK }
SELECT tupleElement(t1, 3) FROM t_tuple_element SETTINGS allow_experimental_analyzer = 0; -- { serverError ILLEGAL_INDEX }
SELECT tupleElement(t1, 3) FROM t_tuple_element SETTINGS allow_experimental_analyzer = 1; -- { serverError NOT_FOUND_COLUMN_IN_BLOCK }
...
SELECT tupleElement(t2, 0) FROM t_tuple_element SETTINGS allow_experimental_analyzer = 0; -- { serverError ILLEGAL_INDEX }
SELECT tupleElement(t2, 0) FROM t_tuple_element SETTINGS allow_experimental_analyzer = 1; -- { serverError NOT_FOUND_COLUMN_IN_BLOCK }
SELECT tupleElement(t2, 3) FROM t_tuple_element SETTINGS allow_experimental_analyzer = 0; -- { serverError ILLEGAL_INDEX }
SELECT tupleElement(t2, 3) FROM t_tuple_element SETTINGS allow_experimental_analyzer = 1; -- { serverError NOT_FOUND_COLUMN_IN_BLOCK }
