...
$CLICKHOUSE_CLIENT --allow_experimental_live_view 1 --query="SELECT * FROM lv FORMAT JSONEachRowWithProgress" | sed -r -e 's/"elapsed_time":"[0-9]+"/"elapsed_time":"<ELAPSED-TIME>"/'
