...
(
    ...
    SETTINGS prefer_localhost_replica = 0, max_parallel_replicas = 3, distributed_group_by_no_merge = 0, use_parallel_replicas = 1,
...
(
    ...
    SETTINGS prefer_localhost_replica = 0, max_parallel_replicas = 12, distributed_group_by_no_merge = 0, use_parallel_replicas = 1,
        parallel_replicas_custom_key = 'k', parallel_replicas_custom_key_filter_type = 'range',
