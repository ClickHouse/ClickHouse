...
select arrayPRAUC([0.1, 0.4, 0.35, 0.8], [0, 0, 1, 1], [0, 0, 0], [1, 1, 0, 1]); -- { serverError NUMBER_OF_ARGUMENTS_DOESNT_MATCH }
select arrayPRAUC(['a', 'b', 'c', 'd'], [1, 0, 1, 1]); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
select arrayPRAUC([0.1, 0.4, NULL, 0.8], [0, 0, 1, 1]); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
select arrayPRAUC([0.1, 0.4, 0.35, 0.8], [0, NULL, 1, 1]); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }

-- negative tests for optional argument
select arrayPRAUC([0.1, 0.4, 0.35, 0.8], [0, 0, 1, 1], [0, 0, NULL]); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
select arrayPRAUC([0.1, 0.4, 0.35, 0.8], [0, 0, 1, 1], ['a', 'b', 'c']); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
select arrayPRAUC([0.1, 0.4, 0.35, 0.8], [0, 0, 1, 1], [0, 1, 0, 0]); -- { serverError BAD_ARGUMENTS }
