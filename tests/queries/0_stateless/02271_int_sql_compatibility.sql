...
-- The SIGNED / UNSIGNED suffix (with or without a display width) must resolve to the
-- right signed/unsigned width for every integer alias in the whitelist, not just INT.
CREATE TEMPORARY TABLE t11_02271 (a TINYINT SIGNED, b TINYINT UNSIGNED, c TINYINT(8) UNSIGNED);
SHOW CREATE TEMPORARY TABLE t11_02271;

CREATE TEMPORARY TABLE t12_02271 (a SMALLINT SIGNED, b SMALLINT UNSIGNED, c SMALLINT(16) UNSIGNED);
SHOW CREATE TEMPORARY TABLE t12_02271;

CREATE TEMPORARY TABLE t13_02271 (a MEDIUMINT SIGNED, b MEDIUMINT UNSIGNED, c MEDIUMINT(24) UNSIGNED);
SHOW CREATE TEMPORARY TABLE t13_02271;

CREATE TEMPORARY TABLE t14_02271 (a INTEGER SIGNED, b INTEGER UNSIGNED, c INTEGER(11) UNSIGNED);
SHOW CREATE TEMPORARY TABLE t14_02271;

CREATE TEMPORARY TABLE t15_02271 (a BIGINT SIGNED, b BIGINT UNSIGNED, c BIGINT(64) UNSIGNED);
SHOW CREATE TEMPORARY TABLE t15_02271;
