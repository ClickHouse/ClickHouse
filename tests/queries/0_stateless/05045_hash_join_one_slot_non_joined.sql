...
FROM (
    ...
    ON t1.key = t2.key
    SETTINGS join_algorithm = 'hash', parallel_hash_join_threshold = 1, max_threads = 1, parallel_non_joined_rows_processing = 1, query_plan_join_swap_table = 0
...
ON t1.key = t2.key
SETTINGS join_algorithm = 'hash', parallel_hash_join_threshold = 1, max_threads = 1, parallel_non_joined_rows_processing = 1, query_plan_join_swap_table = 0, join_use_nulls = 1;
