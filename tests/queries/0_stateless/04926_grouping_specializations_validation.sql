...
SELECT __groupingForCube(CAST(-8.9757207546686 AS Decimal(38, 13)), CAST(['1970-01-14'] AS Array(Date)), CAST('1970-01-05' AS Date), CAST(-11448 AS Int32)); -- { serverError ILLEGAL_TYPE_OF_ARGUMENT }
