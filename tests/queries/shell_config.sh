...
export CLICKHOUSE_TEST_ZOOKEEPER_PREFIX=${CLICKHOUSE_TEST_ZOOKEEPER_PREFIX:="${CLICKHOUSE_TEST_NAME}_${CLICKHOUSE_DATABASE}"}
export CLICKHOUSE_TEST_UNIQUE_NAME=${CLICKHOUSE_TEST_UNIQUE_NAME:="${CLICKHOUSE_TEST_NAME}_${CLICKHOUSE_DATABASE}"}
