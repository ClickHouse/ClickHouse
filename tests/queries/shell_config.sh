...
# simple-snappy
[ -x "${CLICKHOUSE_BINARY}-simple-snappy" ] && CLICKHOUSE_SIMPLE_SNAPPY=${CLICKHOUSE_SIMPLE_SNAPPY:="${CLICKHOUSE_BINARY}-simple-snappy"}
[ -x "${CLICKHOUSE_BINARY}" ] && CLICKHOUSE_SIMPLE_SNAPPY=${CLICKHOUSE_SIMPLE_SNAPPY:="${CLICKHOUSE_BINARY} simple-snappy"}
export CLICKHOUSE_SIMPLE_SNAPPY=${CLICKHOUSE_SIMPLE_SNAPPY:="${CLICKHOUSE_BINARY}-simple-snappy"}
