...
def parameter_values(self):
    ...
    for encrypt, decrypt in [
        ...
        with Example(
            ...
            description=f"Check using dictionary for parameters of {encrypt} and {decrypt} functions.",
        ):
            with parameters_dictionary(
                "parameters_data", node, mysql_node
            ) as dict_name:
...
@TestFeature
@Name("dictionary")
@Requirements(RQ_SRS008_AES_Functions_Compatibility_Dictionaries("1.0"))
