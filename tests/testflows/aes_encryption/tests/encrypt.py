...
def invalid_parameters(self):
    ...
    with Example(
        ...
        requirements=[
            RQ_SRS008_AES_Encrypt_Function_InitializationVector_NotValidForMode("1.0")
        ],
    ):
        encrypt(
            plaintext="'hello there'",
    ...
    with Example(
        "invalid mode value",
        requirements=[
            RQ_SRS008_AES_Encrypt_Function_Parameters_Mode_Value_Invalid("1.0")
        ],
    ):
...
def aad_parameter_types_and_length(self):
    ...
    with When("aad is specified using String type"):
        encrypt(
            ...
            iv=iv,
            aad="'aad'",
            message="19A1183335B374C626B24208AAEC97F148732CE05621AC87B21526",
        )
    ...
    with When("aad is specified using String with UTF8 characters"):
        encrypt(
            ...
            message="19A1183335B374C626B242C68D9618A8C2664D7B6A3FE978104B39",
        )
    ...
    with When("aad is 0 bytes"):
        encrypt(
            ...
            iv=iv,
            aad="''",
            message="19A1183335B374C626B242DF92BB3F57F5D82BEDF41FD5D49F8BC9",
        )
    ...
    with When("aad is 1 byte"):
        encrypt(
            ...
            iv=iv,
            aad="'1'",
            message="19A1183335B374C626B242D1BCFC63B09CFE9EAD20285044A01035",
        )
    ...
    with When("aad is 256 bytes"):
        encrypt(
            ...
            iv=iv,
            aad=f"'{'1' * 256}'",
            message="19A1183335B374C626B242355AD3DD2C5D7E36AEECBB847BF9E8A7",
        )


@TestScenario
@Requirements(RQ_SRS008_AES_Encrypt_Function_Parameters_InitializationVector("1.0"))
...
@TestScenario
@Requirements(RQ_SRS008_AES_Encrypt_Function_Parameters_Key("1.0"))
...
@TestScenario
@Requirements(RQ_SRS008_AES_Encrypt_Function_Parameters_ReturnValue("1.0"))
