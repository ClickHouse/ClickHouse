...
def feature(self, node="clickhouse1"):
    ...
    try:
        ...
        with Scenario(
            ...
            requirements=[RQ_SRS_006_RBAC_Quota_Alter_Interval_Randomized("1.0")],
        ):
        ...
        with Scenario(
            ...
            with Then(f"I alter a quota, assign to role {role}, which does not exist"):
                ...
                node.query(
                    f"ALTER QUOTA quota0 TO {role}", exitcode=exitcode, message=message
                )
            del role
        ...
        with Scenario(
            ...
            requirements=[RQ_SRS_006_RBAC_Quota_Alter_Assignment_None("1.0")],
        ):
        ...
        with Scenario(
            ...
            requirements=[RQ_SRS_006_RBAC_Quota_Alter_Assignment_All("1.0")],
        ):
        ...
        with Scenario(
            ...
            requirements=[RQ_SRS_006_RBAC_Quota_Alter_Assignment_Except("1.0")],
        ):
