...
def feature(self, node="clickhouse1"):
    ...
    try:
        ...
        with Scenario(
            "I create row policy with no options",
            requirements=[
        ...
        with Scenario(
            "I create row policy using short syntax with no options",
            requirements=[
                RQ_SRS_006_RBAC_RowPolicy_Create("1.0"),
                RQ_SRS_006_RBAC_RowPolicy_Create_On("1.0"),
            ],
        ...
        with Scenario(
            ...
            with cleanup(policy):
                ...
                with When(f"I create row policy {policy}"):
                    ...
                    node.query(
                        f"CREATE ROW POLICY {policy} ON default.foo",
                        exitcode=exitcode,
                        message=message,
                    )
            del policy
        ...
        with Scenario(
            "I create row policy if not exists, policy does exist",
            requirements=[
                RQ_SRS_006_RBAC_RowPolicy_Create_IfNotExists("1.0"),
                RQ_SRS_006_RBAC_RowPolicy_Create_On("1.0"),
            ],
        ...
        with Scenario(
            "I create row policy or replace, policy does not exist",
            requirements=[
        ...
        with Scenario(
            "I create row policy or replace, policy does exist",
            requirements=[
                RQ_SRS_006_RBAC_RowPolicy_Create_Replace("1.0"),
                RQ_SRS_006_RBAC_RowPolicy_Create_On("1.0"),
            ],
        ...
        with Scenario(
            "I create row policy for select",
            requirements=[
        ...
        with Scenario(
            "I create row policy using condition",
            requirements=[
                RQ_SRS_006_RBAC_RowPolicy_Create_Condition("1.0"),
                RQ_SRS_006_RBAC_RowPolicy_Create_On("1.0"),
            ],
        ...
        with Scenario(
            "I create row policy assigned to one role",
            requirements=[
        ...
        with Scenario(
            ...
            requirements=[RQ_SRS_006_RBAC_RowPolicy_Create_Assignment("1.0")],
        ):
            role = "role2"
        ...
        with Scenario(
            "I create row policy assigned to multiple roles",
            requirements=[
                RQ_SRS_006_RBAC_RowPolicy_Create_Assignment("1.0"),
                RQ_SRS_006_RBAC_RowPolicy_Create_On("1.0"),
            ],
        ...
        with Scenario(
            "I create row policy on cluster",
            requirements=[
        ...
        with Scenario(
            "I create row policy on fake cluster, throws exception",
            requirements=[
                RQ_SRS_006_RBAC_RowPolicy_Create_OnCluster("1.0"),
                RQ_SRS_006_RBAC_RowPolicy_Create_On("1.0"),
            ],
        ...
        with Scenario(
            "I create row policy on cluster after table",
            requirements=[
                RQ_SRS_006_RBAC_RowPolicy_Create_OnCluster("1.0"),
                RQ_SRS_006_RBAC_RowPolicy_Create_On("1.0"),
            ],
