...
def select(self, node=None):
    ...
    Scenario(run=select_with_join_subquery_privilege_granted_directly_or_via_role)
...
def refresh(self, node=None):
    ...
    """
    Scenario(run=refresh_with_privilege_granted_directly_or_via_role)
    Scenario(run=refresh_with_privilege_revoked_directly_or_from_role)
