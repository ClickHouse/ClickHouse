...
possible_properties = {
    ...
    "mmap_cache_size": threshold_generator(0.2, 0.2, 0, 8192),
    "page_cache_free_memory_ratio": threshold_generator(0.2, 0.2, 0.0, 1.0),
    "page_cache_max_size": threshold_generator(0.2, 0.2, 0, 8192),
    "page_cache_min_size": threshold_generator(0.2, 0.2, 0, 8192),
    ...
    "uncompressed_cache_size": threshold_generator(0.2, 0.2, 0, 8192),
