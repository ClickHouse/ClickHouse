...
def parse_args():
    parser = argparse.ArgumentParser(description="Benchmark ClickHouse Redis-compatible GET/MGET.")
    parser.add_argument("--host", default="127.0.0.1", help="ClickHouse Redis-compatible endpoint host.")
    parser.add_argument("--port", type=int, default=9006, help="ClickHouse Redis-compatible endpoint port.")
...
def main():
    ...
    print(f"system=clickhouse interface=redis_endpoint requests={len(latencies)} elapsed={elapsed:.3f}s")
