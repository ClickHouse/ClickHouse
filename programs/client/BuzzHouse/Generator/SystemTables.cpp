...
const std::map<std::string, SQLType *> settingsTable
...
std::map<std::string, std::map<std::string, SQLType *>> systemTables = {
    ...
    {"events", {{"event", new StringType(std::nullopt)}, {"value", new IntType(64, true)}, {"description", new StringType(std::nullopt)}}},
    ...
    {"server_settings",
     {{"name", new StringType(std::nullopt)},
      ...
      {"changeable_without_restart",
       new EnumType(
           8, std::vector<EnumValue>{EnumValue("No", 0), EnumValue("IncreaseOnly", 1), EnumValue("DecreaseOnly", 2), EnumValue("Yes", 3)})},
      {"is_obsolete", new IntType(8, true)}}},
    {"settings_changes",
      ...
      {"changes",
       new ArrayType(new TupleType(std::vector<SubType>(
           {SubType(std::nullopt, new StringType(std::nullopt)),
            ...
            SubType(std::nullopt, new StringType(std::nullopt)),
            SubType(std::nullopt, new StringType(std::nullopt))})))}}},
    {"merge_tree_settings", settingsTable},
    {"replicated_merge_tree_settings", settingsTable},
    {"shared_merge_tree_settings", settingsTable},
    ...
    {"table_functions",
     {{"name", new StringType(std::nullopt)}, {"description", new StringType(std::nullopt)}, {"allow_readonly", new IntType(8, true)}}},
    ...
    {"settings_profile_elements",
     {{"profile_name", new Nullable(new StringType(std::nullopt))},
      ...
      {"max", new Nullable(new StringType(std::nullopt))},
      {"writability",
       new EnumType(8, std::vector<EnumValue>{EnumValue("WRITABLE", 0), EnumValue("CONST", 1), EnumValue("CHANGEABLE_IN_READONLY", 2)})},
     ...
     {{"name", new StringType(std::nullopt)},
      ...
      {"keys",
       new ArrayType(new EnumType(
           8,
           std::vector<EnumValue>{
               EnumValue("user_name", 1), EnumValue("ip_address", 2), EnumValue("forwarded_ip_address", 3), EnumValue("client_key", 4)}))},
    ...
    {"storage_policies",
     {{"policy_name", new StringType(std::nullopt)},
      ...
      {"volume_type", new EnumType(8, std::vector<EnumValue>{EnumValue("JBOD", 0), EnumValue("SINGLE_DISK", 1), EnumValue("UNKNOWN", 2)})},
    ...
    {"named_collections",
     {{"name", new StringType(std::nullopt)}, {"collection", new MapType(new StringType(std::nullopt), new StringType(std::nullopt))}}},
    {"asynchronous_loader",
    ...
    {"view_refreshes",
     {{"database", new StringType(std::nullopt)},
      ...
      {"written_bytes", new IntType(64, true)}}},
    {"workloads",
     {{"name", new StringType(std::nullopt)}, {"parent", new StringType(std::nullopt)}, {"create_query", new StringType(std::nullopt)}}},
    {"resources",
     {{"name", new StringType(std::nullopt)},
