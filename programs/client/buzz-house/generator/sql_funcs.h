...
const std::vector<const CHFunction> CHFuncs = {
    ...
    //Geo
    CHFunction(sql_query_grammar::SQLFunc::FUNCgreatCircleDistance, 0, 0, 4, 4),
    CHFunction(sql_query_grammar::SQLFunc::FUNCgeoDistance, 0, 0, 4, 4),
    CHFunction(sql_query_grammar::SQLFunc::FUNCgreatCircleAngle, 0, 0, 4, 4),
    CHFunction(sql_query_grammar::SQLFunc::FUNCpointInEllipses, 0, 0, 2, ulimited_params),
    CHFunction(sql_query_grammar::SQLFunc::FUNCpointInPolygon, 0, 0, 2, ulimited_params),
    CHFunction(sql_query_grammar::SQLFunc::FUNCgeohashEncode, 0, 0, 2, 3),
    CHFunction(sql_query_grammar::SQLFunc::FUNCgeohashDecode, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCgeohashesInBox, 0, 0, 5, 5),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3IsValid, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetResolution, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3EdgeAngle, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3EdgeLengthM, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3EdgeLengthKm, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCgeoToH3, 0, 0, 3, 3),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3ToGeo, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3ToGeoBoundary, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3kRing, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetBaseCell, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3HexAreaM2, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3HexAreaKm2, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3IndexesAreNeighbors, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3ToChildren, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3ToParent, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3ToString, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCstringToH3, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetResolution, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3IsResClassIII, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3IsPentagon, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetFaces, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3CellAreaM2, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3CellAreaRads2, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3ToCenterChild, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3ExactEdgeLengthM, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3ExactEdgeLengthKm, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3ExactEdgeLengthRads, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3NumHexagons, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3PointDistM, 0, 0, 4, 4),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3PointDistKm, 0, 0, 4, 4),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3PointDistRads, 0, 0, 4, 4),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetRes0Indexes, 0, 0, 0, 0),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetPentagonIndexes, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3Line, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3Distance, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3HexRing, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetUnidirectionalEdge, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3UnidirectionalEdgeIsValid, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetOriginIndexFromUnidirectionalEdge, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetDestinationIndexFromUnidirectionalEdge, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetIndexesFromUnidirectionalEdge, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetUnidirectionalEdgesFromHexagon, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCh3GetUnidirectionalEdgeBoundary, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCgeoToS2, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCs2ToGeo, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCs2GetNeighbors, 0, 0, 1, 1),
    CHFunction(sql_query_grammar::SQLFunc::FUNCs2CellsIntersect, 0, 0, 2, 2),
    CHFunction(sql_query_grammar::SQLFunc::FUNCs2CapContains, 0, 0, 3, 3),
    CHFunction(sql_query_grammar::SQLFunc::FUNCs2CapUnion, 0, 0, 4, 4),
    CHFunction(sql_query_grammar::SQLFunc::FUNCs2RectAdd, 0, 0, 3, 3),
    CHFunction(sql_query_grammar::SQLFunc::FUNCs2RectContains, 0, 0, 3, 3),
    CHFunction(sql_query_grammar::SQLFunc::FUNCs2RectUnion, 0, 0, 4, 4),
    CHFunction(sql_query_grammar::SQLFunc::FUNCs2RectIntersection, 0, 0, 4, 4),
    CHFunction(sql_query_grammar::SQLFunc::FUNCsvg, 0, 0, 1, 2),
    //Other
