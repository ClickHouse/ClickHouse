...
public:
    ...
    ServerCredentials mysql_server, postgresql_server, sqlite_server, redis_server, minio_server;
    ...
    FuzzConfig() : mysql_server(), postgresql_server(), sqlite_server(), redis_server(), minio_server() { }
