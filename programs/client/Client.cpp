...
void Client::connect()
{
    ...
    if (is_interactive)
    {
        ...
        auto client_version_tuple = std::tuple(VERSION_MAJOR, VERSION_MINOR, VERSION_PATCH);
        auto server_version_tuple = std::tuple(server_version_major, server_version_minor, server_version_patch);
