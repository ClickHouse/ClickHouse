...
private:
    ...
    static void highlight(const String & query, std::vector<replxx::Replxx::Color> & colors)
    {
        ...
        static const std::unordered_map<TokenType, Replxx::Color> token_to_color =
        {
            ...
            { TokenType::Comma, Replxx::Color::WHITE },
            { TokenType::Semicolon, Replxx::Color::WHITE },
            { TokenType::Dot, Replxx::Color::WHITE },
            { TokenType::Asterisk, Replxx::Color::WHITE },
            { TokenType::Plus, Replxx::Color::WHITE },
            { TokenType::Minus, Replxx::Color::WHITE },
            { TokenType::Slash, Replxx::Color::WHITE },
            { TokenType::Percent, Replxx::Color::WHITE },
            { TokenType::Arrow, Replxx::Color::WHITE },
            { TokenType::QuestionMark, Replxx::Color::WHITE },
            { TokenType::Colon, Replxx::Color::WHITE },
            { TokenType::Equals, Replxx::Color::WHITE },
            { TokenType::NotEquals, Replxx::Color::WHITE },
            { TokenType::Less, Replxx::Color::WHITE },
            { TokenType::Greater, Replxx::Color::WHITE },
            { TokenType::LessOrEquals, Replxx::Color::WHITE },
            { TokenType::GreaterOrEquals, Replxx::Color::WHITE },
            { TokenType::Concatenation, Replxx::Color::WHITE },
            { TokenType::At, Replxx::Color::WHITE },
