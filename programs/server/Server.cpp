...
try
{
    ...
    auto main_config_reloader = std::make_unique<ConfigReloader>(
        ...
        [&](ConfigurationPtr config, bool initial_loading)
        {
            ...
            global_context->setMaxTablesSizeToWarn(server_settings_.max_table_size_to_warn);
            global_context->setMaxDatabaseSizeToWarn(server_settings_.max_database_size_to_warn);
            global_context->setMaxPartsNumToWarn(server_settings_.max_part_num_to_warn);
