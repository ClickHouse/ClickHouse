...
namespace ServerSetting
{
    ...
    extern const ServerSettingsString text_index_posting_list_cache_policy;
    extern const ServerSettingsUInt64 text_index_posting_list_cache_size;
    extern const ServerSettingsUInt64 text_index_posting_list_cache_max_entries;
    extern const ServerSettingsDouble text_index_posting_list_cache_size_ratio;
...
#undef COLLECT_FLAG
    ...
    String text_index_posting_list_cache_policy = server_settings[ServerSetting::text_index_posting_list_cache_policy];
    size_t text_index_posting_list_cache_size = server_settings[ServerSetting::text_index_posting_list_cache_size];
    size_t text_index_posting_list_cache_max_count = server_settings[ServerSetting::text_index_posting_list_cache_max_entries];
    double text_index_posting_list_cache_size_ratio = server_settings[ServerSetting::text_index_posting_list_cache_size_ratio];
    if (text_index_posting_list_cache_size > max_cache_size)
    {
        text_index_posting_list_cache_size = max_cache_size;
        LOG_INFO(log, "Lowered text index posting list cache size to {} because the system has limited RAM", formatReadableSizeWithBinarySuffix(text_index_posting_list_cache_size));
    }
    global_context->setTextIndexPostingListCache(text_index_posting_list_cache_policy, text_index_posting_list_cache_size, text_index_posting_list_cache_max_count, text_index_posting_list_cache_size_ratio);
