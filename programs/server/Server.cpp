...
#undef COLLECT_FLAG
    ...
    try
    {
        ...
        attachInformationSchema(global_context, *database_catalog.getDatabaseOrThrow(DatabaseCatalog::INFORMATION_SCHEMA, global_context));
        attachInformationSchema(global_context, *database_catalog.getDatabaseOrThrow(DatabaseCatalog::INFORMATION_SCHEMA_UPPERCASE, global_context));
