...
namespace ServerSetting
{
    ...
    extern const ServerSettingsUInt64 memory_worker_dirty_pages_decay_change_period_ms;
...
#undef COLLECT_FLAG
    ...
    MemoryWorkerConfig memory_worker_config{
        ...
        .dirty_pages_decay_change_period_ms = server_settings[ServerSetting::memory_worker_dirty_pages_decay_change_period_ms],
