...
public:
    ...
    virtual R visit(ReadFromMergeTree & /*step*/) { return visitStep(); }

    virtual R visit(AggregatingStep & /*step*/) { return visitStep(); }

    virtual R visit(MergingAggregatedStep & /*step*/) { return visitStep(); }

    virtual R visit(ExpressionStep & /*step*/) { return visitStep(); }

    virtual R visit(SortingStep & /*step*/) { return visitStep(); }

    virtual R visit(LimitStep & /*step*/) { return visitStep(); }

    virtual R visit(JoinStep & /*step*/) { return visitStep(); }

    virtual R visit(UnionStep & /*step*/) { return visitStep(); }

    virtual R visit(ExchangeDataStep & /*step*/) { return visitStep(); }
