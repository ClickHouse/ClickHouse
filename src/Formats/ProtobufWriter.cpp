...
public:
    ...
    virtual void writeBFloat16(const BFloat16 &) override { cannotConvertType("BFloat16"); }
    virtual void writeFloat16(const Float16 &) override { cannotConvertType("Float16"); }
...
public:
    ...
    void writeBFloat16(const BFloat16 & value) override { castNumericAndWriteField(static_cast<float>(value)); }
    void writeFloat16(const Float16 & value) override { castNumericAndWriteField(static_cast<float>(value)); }
