...
struct JSONExtractInsertSettings
{
    ...
    bool convert_bool_to_float = true;
...
bool tryGetNumericValueFromJSONElement(NumberType & value, const typename JSONParser::Element & element, bool convert_bool_to_integer, bool convert_bool_to_float, bool allow_type_conversion, String & error);
