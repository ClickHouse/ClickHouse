...
private:
    ...
    {
        throw Exception( ErrorCodes::CANNOT_PARSE_PROTOBUF_SCHEMA, "Cannot parse '{}' file, found an error at line {}, column {}, {}", filename, std::to_string(line), std::to_string(column), message);
    }
