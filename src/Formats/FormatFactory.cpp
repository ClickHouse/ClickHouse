...
FormatSettings getFormatSettings(const ContextPtr & context, const Settings & settings)
{
    ...
    format_settings.diagram.diagram_type = settings[Setting::diagram_output_format_diagram_type];
    format_settings.diagram.is_ascii_symbols = settings[Setting::diagram_output_format_is_ascii_set];
    format_settings.diagram.title = settings[Setting::diagram_output_format_title];
    format_settings.diagram.limit_height = settings[Setting::diagram_output_format_limit_height];
    format_settings.diagram.limit_width = settings[Setting::diagram_output_format_limit_width];
