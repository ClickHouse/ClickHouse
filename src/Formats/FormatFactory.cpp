...
FormatSettings getFormatSettings(const ContextPtr & context, const Settings & settings)
{
    ...
    format_settings.protobuf.schema_registry_url = settings[Setting::format_protobuf_schema_registry_url].toString();
    ...
    if (format_settings.schema.is_server)
    {
        ...
        const Poco::URI & protobuf_schema_registry_url = settings[Setting::format_protobuf_schema_registry_url];
        if (!protobuf_schema_registry_url.empty())
             context->getRemoteHostFilter().checkURL(protobuf_schema_registry_url);
    }
