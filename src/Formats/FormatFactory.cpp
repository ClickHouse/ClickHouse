...
FormatSettings getFormatSettings(const ContextPtr & context, const Settings & settings)
{
    ...
    format_settings.protobuf.input_datetime64_scale = settings[Setting::input_format_protobuf_datetime64_scale];
    format_settings.protobuf.output_datetime64_scale = settings[Setting::output_format_protobuf_datetime64_scale];
