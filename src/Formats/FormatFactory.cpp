...
FormatSettings getFormatSettings(const ContextPtr & context, const Settings & settings)
{
    ...
    format_settings.native.write_string_with_size_stream = settings[Setting::output_format_native_write_string_with_size_stream];
    format_settings.native.read_string_with_size_stream = settings[Setting::input_format_native_read_string_with_size_stream];
