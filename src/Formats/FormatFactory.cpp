...
#undef DECLARE_FORMAT_EXTERN
    ...
    extern const SettingsBool allow_nullable_tuple_type;
...
FormatSettings getFormatSettings(const ContextPtr & context, const Settings & settings)
{
    ...
    format_settings.schema_inference_allow_nullable_tuple_type = settings[Setting::allow_nullable_tuple_type];
