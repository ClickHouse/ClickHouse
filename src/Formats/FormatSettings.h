...
struct FormatSettings
{
    ...
    struct
    {
        ...
        /// -1: integer DateTime64 fields are Unix seconds. >= 0: scaled ticks at this precision, must match the column.
        Int64 input_datetime64_scale = -1;
        Int64 output_datetime64_scale = -1;
    } protobuf{};
