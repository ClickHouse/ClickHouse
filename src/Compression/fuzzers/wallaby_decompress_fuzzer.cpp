...
try
{
    ...
    const UInt8 float_width = p->float_width_index % 2 == 0 ? sizeof(Float32) : sizeof(Float64);
    auto codec = DB::getCompressionCodecWallaby(float_width);
