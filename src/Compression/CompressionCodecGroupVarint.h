...
namespace DB
{
    ...
    protected:
        void compressData(const UInt32 * source, UInt32 source_size,  UInt8 * dest) const override;

        void decompressData(const UInt8 * source, UInt32 source_size, Uint32 * dest) const override;
