...
{
    using T = TypeParam;
    std::mt19937_64 rng(0xC0FFEE); // NOLINT(bugprone-random-generator-seed,cert-msc32-c,cert-msc51-cpp)
...
{
    using T = TypeParam;
    std::mt19937_64 rng(0x1234); // NOLINT(bugprone-random-generator-seed,cert-msc32-c,cert-msc51-cpp)
    std::vector<T> v(600);
...
{
    using T = TypeParam;
    std::mt19937_64 rng(0x5678); // NOLINT(bugprone-random-generator-seed,cert-msc32-c,cert-msc51-cpp)
    std::vector<T> v(2000);
...
{
    using T = TypeParam;
    std::mt19937_64 rng(0xD0C1D); // NOLINT(bugprone-random-generator-seed,cert-msc32-c,cert-msc51-cpp)
...
{
    using T = TypeParam;
    std::mt19937_64 rng(0x1AC1D); // NOLINT(bugprone-random-generator-seed,cert-msc32-c,cert-msc51-cpp)
    std::vector<T> v(5000);
...
{
    using T = TypeParam;
    std::mt19937_64 rng(0xFADE); // NOLINT(bugprone-random-generator-seed,cert-msc32-c,cert-msc51-cpp)
...
TYPED_TEST(PForRoundTrip, U64CrossBoundaryAndFullWidth)
{
    ...
    {
        std::mt19937_64 rng(0xB16B00); // NOLINT(bugprone-random-generator-seed,cert-msc32-c,cert-msc51-cpp)
        std::vector<T> v(900);
