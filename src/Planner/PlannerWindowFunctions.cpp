...
WindowDescription extractWindowDescriptionFromWindowNode(const QueryTreeNodePtr & func_node_, const PlannerContext & planner_context)
{
    ...
    bool compile_sort_description_v = query_context_settings[compile_sort_description];
    size_t min_count_to_compile_sort_description_v = query_context_settings[min_count_to_compile_sort_description];

    window_description.partition_by.compile_sort_description = compile_sort_description_v;
    window_description.partition_by.min_count_to_compile_sort_description = min_count_to_compile_sort_description_v;

    window_description.order_by.compile_sort_description = compile_sort_description_v;
    window_description.order_by.min_count_to_compile_sort_description = min_count_to_compile_sort_description_v;

    window_description.full_sort_description.compile_sort_description = compile_sort_description_v;
    window_description.full_sort_description.min_count_to_compile_sort_description = min_count_to_compile_sort_description_v;
