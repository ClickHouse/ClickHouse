...
{
    const String & additional_result_filter_v = settings[additional_result_filter];
    if (additional_result_filter_v.empty())
        return {};

    ParserExpression parser;
    auto additional_result_filter_ast = parseQuery(
        parser,
        additional_result_filter_v.data(),
        additional_result_filter_v.data() + additional_result_filter_v.size(),
