...
{
    winsize winsize{};
    winsize.ws_col = static_cast<unsigned short>(width);
    winsize.ws_row = static_cast<unsigned short>(height);
    winsize.ws_xpixel = static_cast<unsigned short>(width_pixels);
    winsize.ws_ypixel = static_cast<unsigned short>(height_pixels);
