...
bool checkExpression(std::string_view match_str, const FilterExpression & expression, bool is_url)
{
    if (is_url)
    {
...
FilterExpression getExpression(const std::string & expression)
{
