...
void MySQLHandler::run()
{
    ...
    try
    {
        ...
        try
        {
            ...
            {
                /// Mirror the access check of `USE database` (InterpreterUseQuery).
...
void MySQLHandler::comFieldList(ReadBuffer & payload)
{
    ...
    /// Mirror the access check of DESCRIBE/SHOW COLUMNS (InterpreterDescribeQuery).
    /// Checked before getTable() so it does not become a table-existence oracle.
