...
namespace DB
{
    ...
    class Net_API WebSocket : public Poco::Net::StreamSocket
    ...
    protected:
        static Poco::Net::WebSocketImpl * accept(HTTPServerRequest & request, HTTPServerResponse & response);
        static Poco::Net::WebSocketImpl *
        connect(Poco::Net::HTTPClientSession & cs, HTTPRequest & request, HTTPResponse & response, Poco::Net::HTTPCredentials & credentials);
        static Poco::Net::WebSocketImpl * completeHandshake(Poco::Net::HTTPClientSession & cs, HTTPResponse & response, const std::string & key);
    ...
    private:
        ...
        static Poco::Net::HTTPCredentials _defaultCreds;
    };
