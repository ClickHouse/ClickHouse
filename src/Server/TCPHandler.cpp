...
bool TCPHandler::receiveProxyHeader()
{
    ...
    /// No `expect_eof`: the nested buffer is the connection, and the parser below calls `eof` once the
    /// limit is reached, which would probe the socket for the client's next bytes.
