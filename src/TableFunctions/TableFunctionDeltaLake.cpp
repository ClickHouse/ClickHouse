...
ObjectStoragePtr TableFunctionDeltaLakeImpl<Definition, Configuration>::getObjectStorage(const ContextPtr & context, bool create_readonly) const
{
    if (!object_storage)
...
template <typename Definition, typename Configuration>
StorageObjectStorageConfigurationPtr TableFunctionDeltaLakeImpl<Definition, Configuration>::getConfiguration(ContextPtr context) const
{
    if (!configuration)
    {
...
template <typename Definition, typename Configuration>
std::vector<size_t> TableFunctionDeltaLakeImpl<Definition, Configuration>::skipAnalysisForArguments(
...
template <typename Definition, typename Configuration>
std::shared_ptr<typename TableFunctionDeltaLakeImpl<Definition, Configuration>::Settings>
TableFunctionDeltaLakeImpl<Definition, Configuration>::createEmptySettings()
{
    return std::make_shared<DataLakeStorageSettings>();
}

template <typename Definition, typename Configuration>
void TableFunctionDeltaLakeImpl<Definition, Configuration>::parseArguments(const ASTPtr & ast_function, ContextPtr context)
{
...
template <typename Definition, typename Configuration>
ColumnsDescription TableFunctionDeltaLakeImpl<
...
template <typename Definition, typename Configuration>
StoragePtr TableFunctionDeltaLakeImpl<Definition, Configuration>::executeImpl(
