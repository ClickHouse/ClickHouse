...
class Context;
/**
 * totaly define the table schema in this function
 *    - hiveCluster(cluster_name, hive_url, hive_database, hive_table, columns, partition_keys)
 */
...
private:
    Poco::Logger * logger = &Poco::Logger::get("TableFunctionHiveCluster");
