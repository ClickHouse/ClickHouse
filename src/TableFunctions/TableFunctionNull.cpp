...
void TableFunctionNull::parseArguments(const ASTPtr & ast_function, ContextConstPtr context)
{
...
ColumnsDescription TableFunctionNull::getActualTableStructure(ContextConstPtr context) const
{
