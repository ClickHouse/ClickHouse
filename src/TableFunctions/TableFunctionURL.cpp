...
```sql
-- Reads the first address only, even though the pattern describes 100020001 of them.
SELECT * FROM url('https://example.com/data-{0..10000}-{0..10000}.tsv', TSV, 'x UInt64') LIMIT 1;
