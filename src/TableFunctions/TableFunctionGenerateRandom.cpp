...
void TableFunctionGenerateRandom::parseArguments(const ASTFunction & ast_function, const Context & /*context*/)
{
...
StoragePtr TableFunctionGenerateRandom::executeImpl(
