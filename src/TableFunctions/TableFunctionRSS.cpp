#include <TableFunctions/TableFunctionRSS.h>
...
std::vector<size_t> TableFunctionRSS::skipAnalysisForArguments(const QueryTreeNodePtr & query_node_table_function, ContextPtr) const
{
...
void TableFunctionRSS::parseArguments(const ASTPtr & ast, ContextPtr context)
{
...
void TableFunctionRSS::parseArgumentsImpl(ASTs & args, const ContextPtr & context)
{
...
void TableFunctionRSS::updateStructureAndFormatArgumentsIfNeeded(ASTs & args, const String & structure_, const String & format_, const ContextPtr & context)
{
...
StoragePtr TableFunctionRSS::getStorage(
...
ColumnsDescription TableFunctionRSS::getActualTableStructure(ContextPtr context, bool /*is_insert_query*/) const
{
    if (structure == "auto")
    {
...
std::optional<String> TableFunctionRSS::tryGetFormatFromFirstArgument()
{
...
{
    factory.registerFunction<TableFunctionRSS>();
}
}
