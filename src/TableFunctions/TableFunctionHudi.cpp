...
ObjectStoragePtr TableFunctionHudiImpl<Definition, Configuration>::getObjectStorage(const ContextPtr & context, bool create_readonly) const
{
    if (!object_storage)
...
template <typename Definition, typename Configuration>
StorageObjectStorageConfigurationPtr TableFunctionHudiImpl<Definition, Configuration>::getConfiguration(ContextPtr context) const
{
    if (!configuration)
    {
...
template <typename Definition, typename Configuration>
std::vector<size_t> TableFunctionHudiImpl<Definition, Configuration>::skipAnalysisForArguments(
...
template <typename Definition, typename Configuration>
std::shared_ptr<typename TableFunctionHudiImpl<Definition, Configuration>::Settings>
TableFunctionHudiImpl<Definition, Configuration>::createEmptySettings()
{
    return std::make_shared<DataLakeStorageSettings>();
}

template <typename Definition, typename Configuration>
void TableFunctionHudiImpl<Definition, Configuration>::parseArguments(const ASTPtr & ast_function, ContextPtr context)
{
...
template <typename Definition, typename Configuration>
ColumnsDescription TableFunctionHudiImpl<
...
template <typename Definition, typename Configuration>
StoragePtr TableFunctionHudiImpl<Definition, Configuration>::executeImpl(
    ...
    bool is_insert_query) const
{
    ...
    storage = std::make_shared<StorageHudi>(
        configuration,
