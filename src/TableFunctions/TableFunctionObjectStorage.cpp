...
Delta Lake writes are a Beta feature disabled by default. Enable them with the following (`allow_delta_lake_writes` is available from version 26.7; before version 26.7, use `allow_experimental_delta_lake_writes`):
