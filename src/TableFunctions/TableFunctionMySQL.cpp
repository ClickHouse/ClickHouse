...
<Note>
Some data types of MySQL can be mapped to different ClickHouse types - this is addressed by query-level setting [mysql_datatypes_support_level](/reference/settings/session-settings/mysql#mysql_datatypes_support_level)
</Note>
...
- [mysql_datatypes_support_level](/reference/settings/session-settings/mysql#mysql_datatypes_support_level)
