...
public:
    ...
    TableFunctionPtr get(const ASTPtr & ast_function, ContextConstPtr context) const;

    /// Returns nullptr if not found.
    TableFunctionPtr tryGet(const std::string & name, ContextConstPtr context) const;
