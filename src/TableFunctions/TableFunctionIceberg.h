...
/* iceberg(source, [access_key_id, secret_access_key,] format, structure[, compression]) - creates a temporary Iceberg table on S3.
 */
class TableFunctionIceberg : public ITableFunction
{
public:
