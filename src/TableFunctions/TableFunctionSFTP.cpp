...
void TableFunctionSFTP::parseFirstArguments(const ASTPtr & arg, const ContextPtr & context)
{
    ...
    if (type == Field::Types::String)
    {
        ...
        throw Exception(ErrorCodes::BAD_ARGUMENTS, "The first argument of table function '{}' mush be sftp url", getName());
}

String TableFunctionSFTP::getFormatFromFirstArgument()
{
    if (fd >= 0)
