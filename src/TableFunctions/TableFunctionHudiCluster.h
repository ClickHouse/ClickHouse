...
class TableFunctionHudiClusterImpl : public ITableFunctionCluster<TableFunctionHudiImpl<Definition, Configuration>>
{
public:
...
protected:
    using Base = TableFunctionHudiImpl<Definition, Configuration>;
