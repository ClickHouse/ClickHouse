...
| Category | Functions |
|----------|-----------|
| Range    | `rate`, `irate`, `delta`, `idelta`, `increase`, `last_over_time`, `deriv`, `changes`, `resets`, `max_over_time`, `min_over_time`, `avg_over_time`, `sum_over_time`, `count_over_time`, `stddev_over_time`, `stdvar_over_time`, `present_over_time`, `quantile_over_time`, `predict_linear` |
