...
protected:
    ...
    bool hasStaticStructure() const override { return Base::table_options.structure != "auto"; }
    bool needStructureHint() const override { return Base::table_options.structure == "auto"; }
