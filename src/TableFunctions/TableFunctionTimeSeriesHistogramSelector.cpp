...
void TableFunctionTimeSeriesHistogramSelector::parseArguments(const ASTPtr & ast_function, ContextPtr context)
{
    ...
    config = StorageTimeSeriesSelector::getConfiguration(args, context, ViewTarget::Histograms);
}
...
StoragePtr TableFunctionTimeSeriesHistogramSelector::executeImpl(
