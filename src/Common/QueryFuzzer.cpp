...
static const Strings insert_formats = {
    ...
    "JSONEachRow",
    "JSONEachRowWithNames",
    "JSONEachRowWithNamesAndTypes",
    "JSONStringsEachRow",
    "JSONLines",
    "JSONCompactEachRow",
...
void QueryFuzzer::fuzzIndexDeclaration(ASTIndexDeclaration & index)
{
    ...
    static const Strings simple_tokenizers = {"splitByNonAlpha", "splitByString", "array", "keyword", "asciiCJK", "unicodeWord"};
