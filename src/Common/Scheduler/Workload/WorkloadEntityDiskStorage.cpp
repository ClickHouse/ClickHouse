...
namespace
{
    ...
    /// entity survives a power loss. Reports failures via `ec` (checked by the caller).
    ...
    bool throw_if_not_exists)
{
    ...
    /// power loss (otherwise an acknowledged DROP could revert and resurrect the entity).
