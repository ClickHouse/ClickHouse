...
/// `LL`, not `L`: the value is about 6.2e10 and so needs 64 bits, which `long` only has on
/// LP64 platforms - on LLP64 (Windows) it is 32 bits and the constant silently wraps.
