...
#define APPLY_FOR_METRICS(M) \
    ...
    M(BackgroundMergesPoolTask, "Number of active merges in background pool") \
    M(BackgroundMutationsPoolTask, "Number of active mutations in background pool") \
    M(BackgroundFetchesPoolTask, "Number of active tasks in BackgroundFetchesPool") \
    M(BackgroundCommonPoolTask, "Number of active tasks in BackgroundFetchesPool") \
