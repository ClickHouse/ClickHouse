...
#define APPLY_FOR_BUILTIN_METRICS(M) \
    ...
    M(KeeperSnapshotDeserThreads, "Number of threads in the threadpool for parallel V8 keeper snapshot decompression and parse.") \
    M(KeeperSnapshotDeserThreadsActive, "Number of active threads in the threadpool for parallel V8 keeper snapshot decompression and parse.") \
    M(KeeperSnapshotDeserThreadsScheduled, "Number of queued or active jobs in the threadpool for parallel V8 keeper snapshot decompression and parse.") \
