...
#define APPLY_FOR_BUILTIN_METRICS(M) \
    ...
    M(TimeSeriesInsertCacheBytes, "Total size of TimeSeries insert caches in bytes") \
    M(TimeSeriesInsertCacheEntries, "Total number of entries in TimeSeries insert caches") \
