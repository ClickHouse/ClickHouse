...
#define APPLY_FOR_BUILTIN_METRICS(M) \
    ...
    M(VectorQueryPlanCacheBytes, "Total size of the vector query plan cache in bytes") \
    M(VectorQueryPlanCacheEntries, "Total number of entries in the vector query plan cache") \
