...
#define APPLY_FOR_BUILTIN_METRICS(M) \
    ...
    M(WaitingQuery, "Number of non-internal queries blocked waiting for asynchronously loading tables, which is what the 'max_waiting_queries' server setting limits") \
