...
/** memcpy function could work suboptimal if all the following conditions are met:
  ...
  * One of that assumptions - ability to read and write some number of bytes after the end of passed memory regions.
  * Under that assumption, it is possible not to implement difficult code to process tails of data and copy always by big chunks.
  *
