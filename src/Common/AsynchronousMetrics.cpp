...

    {
        auto threads_get_metric_name_doc = [](const String & name) -> std::pair<const char *, const char *>
        {
            static std::map<String, std::pair<const char *, const char *>> metric_map =
            {
                ...
                {"mongo_port", {"MongoThreads", "Number of threads in the server of the MongoDB compatibility protocol."}},
            ...
            static std::map<String, std::pair<const char *, const char *>> metric_map =
                {
                    ...
                    {"mongo_port", {"MongoRejectedConnections", "Number of rejected connections for the MongoDB compatibility protocol."}},
