...
static constinit FiberLocal<uint64_t, FiberLocalSlot::MemoryTrackerUntrackedAllocationsBlockerCounter> MemoryTrackerUntrackedAllocationsBlockerInThreadCounter;
