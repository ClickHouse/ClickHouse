...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(RowsAfterWhere, "Number of rows remaining after WHERE filtering in MergeTree tables. Accounts for both PREWHERE-pushed and non-pushed WHERE conditions.", ValueType::Number) \
