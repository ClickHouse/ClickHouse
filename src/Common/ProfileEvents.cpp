...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(QueryPlanCacheHits, "Number of times a query plan has been found in the query plan cache (and query planning was skipped). Only updated for SELECT queries with SETTINGS allow_experimental_query_plan_cache = 1 and enable_query_plan_cache = 1.", ValueType::Number) \
