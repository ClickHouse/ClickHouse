...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(MergingSortedMaterializationMilliseconds, "Total busy time spent materializing output columns after merging sorted streams, summed across parallel workers", ValueType::Milliseconds) \
