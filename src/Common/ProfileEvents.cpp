...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(IcebergStorageMetadataCacheHits, "Number of Iceberg derived storage metadata cache hits.", ValueType::Number) \
    M(IcebergStorageMetadataCacheMisses, "Number of Iceberg derived storage metadata cache misses.", ValueType::Number) \
