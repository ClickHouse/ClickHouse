...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(TextIndexDiscardPatternScanByTokenBudget, "Number of times pattern-based dictionary scan in a text index was discarded because the number of dictionary tokens to match in a data part exceeded 'text_index_like_max_dictionary_tokens_to_scan'.", ValueType::Number) \
