...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(IcebergMetadataMinMaxAcceptedDataFilePositionDeleteFilePairs, "Total number of accepted data files-position delete file pairs by minmax analysis from pairs suitable by partitioning and sequence number.", ValueType::Number) \
    M(IcebergMetadataMinMaxRejectedDataFilePositionDeleteFilePairs, "Total number of accepted data files-position delete file pairs by minmax analysis from pairs suitable by partitioning and sequence number.", ValueType::Number) \
