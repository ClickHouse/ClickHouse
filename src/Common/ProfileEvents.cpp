...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(IndexMonotonicFunctionChainApplications, "Number of times a chain of monotonic functions was applied to a key range during index analysis.", ValueType::Number) \
