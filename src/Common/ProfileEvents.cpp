...
The server successfully detected this situation and will download merged part from the replica to force the byte-identical result.
    ...
    M(ObjectStorageQueueMoveSourceRewritten, "Number of objects whose after_processing = move was refused because the object was no longer the generation that was ingested", ValueType::Number) \
