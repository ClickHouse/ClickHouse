...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(MutationUntouchedPartsByIndexAnalysis, "Number of data parts proven untouched by a mutation with analysis of the partition value and the primary key index, without executing the query that checks the predicate", ValueType::Number) \
