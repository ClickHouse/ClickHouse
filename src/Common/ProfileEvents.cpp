...
The server successfully detected this situation and will download merged part from the replica to force the byte-identical result.
    ...
    M(LoadedStatisticsParts, "Number of data parts whose statistics were loaded to build a selectivity estimator. Reuse of a cached estimator loads none.", ValueType::Number) \
