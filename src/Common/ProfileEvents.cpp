...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(AsyncInsertQueueFlushesOnLimit, "Number of times AsynchronousInsertQueue was flushed because the limit on number of pending inserts or bytes was exceeded.") \
