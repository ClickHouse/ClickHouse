...
template class IntervalTree<Interval<UInt512>, IntervalTreeVoidValue>;
...
template class IntervalTree<Interval<Int512>, IntervalTreeVoidValue>;
...
template class IntervalTree<Interval<Decimal512>, IntervalTreeVoidValue>;
...
template class IntervalTree<Interval<UInt512>, size_t>;
...
template class IntervalTree<Interval<Int512>, size_t>;
...
template class IntervalTree<Interval<Decimal512>, size_t>;
