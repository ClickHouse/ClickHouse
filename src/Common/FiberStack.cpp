...
public:
    explicit FixedSizeFiberStackCache(FiberStack * base_allocator_, size_t max_cached_stacks_ = 100) : max_cached_stacks(max_cached_stacks_), allocator(base_allocator_) {}
...
public:
    ...
    {
        /// Using round-robin to distribute load is better than thread-local cache
...
boost::context::stack_context FixedSizeFiberStackWithCache::allocate()
{
    ...
    /// Fallback with standard allocator
