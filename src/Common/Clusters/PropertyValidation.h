...
/// `ClusterMetadataManager::updateShardPropertiesFromSQL` / `replaceShardReplicasFromSQL`).
...
/// only (merge semantics in `ClusterMetadataManager::replaceClusterMembersFromSQL`).
