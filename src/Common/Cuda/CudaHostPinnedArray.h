...
class CudaHostPinnedArray : private TAllocator
{
public:
    typedef T   ValueType;

    CudaHostPinnedArray(size_t sz_);
    CudaHostPinnedArray(const CudaHostPinnedArray &) = delete;
    CudaHostPinnedArray & operator = (const CudaHostPinnedArray &) = delete;
