...
protected:
    ...
    static constexpr size_t pad_left = integerRoundUp(integerRoundUp(pad_left_, ELEMENT_SIZE), 32);
...
extern template class PODArray<UInt8, 4096, Allocator<false>, 31, 32>;
extern template class PODArray<UInt16, 4096, Allocator<false>, 31, 32>;
extern template class PODArray<UInt32, 4096, Allocator<false>, 31, 32>;
extern template class PODArray<UInt64, 4096, Allocator<false>, 31, 32>;

extern template class PODArray<Int8, 4096, Allocator<false>, 31, 32>;
extern template class PODArray<Int16, 4096, Allocator<false>, 31, 32>;
extern template class PODArray<Int32, 4096, Allocator<false>, 31, 32>;
extern template class PODArray<Int64, 4096, Allocator<false>, 31, 32>;
}
