...
/** Previously, these constants were located in one enum.
  ...
  * - system.errors table
  *
  * These constants shouldn't be divisible by 256, otherwise clickhouse-client
  * will exit with code 0 in case of such errors.
  */
...
#define APPLY_FOR_BUILTIN_ERROR_CODES(M) \
    ...
    M(256, PARTITION_ALREADY_EXISTS_OBSOLETE) \
    ...
    M(511, UNKNOWN_ROLE) \
    M(512, SET_NON_GRANTED_ROLE_OBSOLETE) \
    ...
    M(768, CANNOT_EXECUTE_PROMQL_QUERY_OBSOLETE) \
    M(769, PARTITION_ALREADY_EXISTS) \
    M(770, SET_NON_GRANTED_ROLE) \
    M(771, CANNOT_EXECUTE_PROMQL_QUERY) \
\
