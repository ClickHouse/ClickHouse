...
TEST(SLRUCache, set)
{
    ...
    auto slru_cache = SimpleCacheBase("SLRU", /*max_size=*/10, /*max_elements_size=*/0, /*size_ratio*/0.5);
...
{
    using SimpleCacheBase = DB::CacheBase<int, int>;
    auto slru_cache = SimpleCacheBase("SLRU", /*max_size=*/2, /*max_elements_size=*/0, /*size_ratio*/0.5);
    slru_cache.set(1, std::make_shared<int>(2));
    slru_cache.set(1, std::make_shared<int>(3));
...
TEST(SLRUCache, evictOnElements)
{
    ...
    auto slru_cache = SimpleCacheBase(/*max_size=*/10, /*max_elements_size=*/1, /*size_ratio*/0.5);
...
{
    using SimpleCacheBase = DB::CacheBase<int, size_t, std::hash<int>, ValueWeight>;
    auto slru_cache = SimpleCacheBase(/*max_size=*/10, /*max_elements_size=*/0, /*size_ratio*/0.5);
    slru_cache.set(1, std::make_shared<size_t>(2));
    slru_cache.set(2, std::make_shared<size_t>(3));
