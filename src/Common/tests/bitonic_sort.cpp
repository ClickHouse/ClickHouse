...
#include "Common/BitonicSort.cpp"
...
static void NO_INLINE sort2()
{
    BitonicSort<Key>& sorter = BitonicSort<Key>::getInstance();
    sorter.configure();
//    sorter.prepareBuffers();
...
//    srand(time(nullptr));
...

    {
        ...
        if (method == 2)    sort2(); // sort2(data.data(), n);
