...
TEST_F(ProxyConfigurationResolverProviderTests, EnvironmentResolverShouldBeUsedIfNoSettings)
{
    ...
    auto resolver = DB::ProxyConfigurationResolverProvider::get();

    auto http_configuration = resolver->resolve(DB::ProxyConfiguration::Protocol::HTTP);
    auto https_configuration = resolver->resolve(DB::ProxyConfiguration::Protocol::HTTPS);
...
TEST_F(ProxyConfigurationResolverProviderTests, LIST_HTTP_ONLY)
{
    ...
    auto http_proxy_configuration = resolver->resolve(DB::ProxyConfiguration::Protocol::HTTP);
    ...
    auto https_proxy_configuration = resolver->resolve(DB::ProxyConfiguration::Protocol::HTTPS);
