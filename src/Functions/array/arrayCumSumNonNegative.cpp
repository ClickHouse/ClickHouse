...
REGISTER_FUNCTION(ArrayCumSumNonNegative)
{
    ...
    FunctionDocumentation::ReturnedValue returned_value = "Returns an array of the partial sums of the elements in the source array, with any negative running sum replaced by zero. The result type matches the input array's numeric type.";
