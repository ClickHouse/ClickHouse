    ...
    size_t input_rows_count) const
{
    ...
    if (!((res = executeNumber<IndexType, UInt8>(arguments, result_type, index_data, builder))
          ...
          || (res = executeNumber<IndexType, Decimal512>(arguments, result_type, index_data, builder))
          ...
          || (res = executeArrayNumber<IndexType, Decimal512>(arguments, result_type, index_data, builder))
