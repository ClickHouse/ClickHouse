...
REGISTER_FUNCTION(ArraySlice)
{
    ...
    FunctionDocumentation::ReturnedValue returned_value = "Returns a slice of the array with `length` elements from the specified `offset`. [`Array(T)`](/sql-reference/data-types/array).";
