...
{
    FunctionDocumentation::Description description = "Returns a slice of the array. Array elements set to `NULL` are handled as normal values.";
    FunctionDocumentation::Syntax syntax = "arraySlice(arr, offset[, length])";
    FunctionDocumentation::Arguments arguments = {
        {"arr", "Array to slice. [Array](/sql-reference/data-types/array)."},
