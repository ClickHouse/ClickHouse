...
//
    ...
    //                         "Function {} does not support NULLs in Array(Float32)).", getName());
//
    //     const auto * src_data_concrete = checkAndGetColumn<ColumnVector<Float32>>(&src_data);
//
    //     if (!src_data_concrete)
    //         throw Exception(ErrorCodes::ILLEGAL_COLUMN, "Illegal column {}. Function {} expects Array(Float32).",
    //             src_data.getName(), getName());
//
