...
1 row in set. Elapsed: 2.012 sec.
    ...
    FunctionDocumentation documentation_sleep = {description_sleep, syntax_sleep, argument_sleep, {}, returned_value_sleep, examples_sleep, introduced_in_sleep, category_sleep};
...
└────────┴───────────────────┘
    ...
    FunctionDocumentation documentation_sleepEachRow = {description_sleepEachRow, syntax_sleepEachRow, argument_sleepEachRow, {}, returned_value_sleepEachRow, examples_sleepEachRow, introduced_in_sleepEachRow, category_sleepEachRow};
