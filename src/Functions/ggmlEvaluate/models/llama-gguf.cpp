...
// std::string LlamaGgufModel::evalImpl(GgmlModelParams params, const std::string & input)
// {
...
//                     llama_kv_cache_seq_shift(lctx, 0, ga_i,                n_past,              ib*bd);
//                     llama_kv_cache_seq_div  (lctx, 0, ga_i + ib*bd,        ga_i + ib*bd + ga_w, ga_n);
//                     llama_kv_cache_seq_shift(lctx, 0, ga_i + ib*bd + ga_w, n_past + ib*bd,      dd);
