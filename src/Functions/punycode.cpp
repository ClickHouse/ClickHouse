...
Computes a Punycode representation of a string.)",
        ...
        .returned_value="The punycode representation [String](/docs/sql-reference/data-types/string.md).",
        .examples={
            {"simple",
...
Computes a Punycode representation of a string. Throws an exception if the input is not valid Punycode.)",
        ...
        .returned_value="The plaintext representation [String](/docs/sql-reference/data-types/string.md).",
        .examples={
            {"simple",
