...
-- haystack NOT SIMILAR TO pattern
    ...
    FunctionDocumentation::Arguments arguments = {
        ...
        {"pattern", "`SIMILAR TO` pattern to match against. Can contain `%` (matches any number of characters), `_` (matches single character), and `\\` for escaping, and regular expression metacharacters (excluding `^`, `$`, and `.`)", {"String"}}
    };
