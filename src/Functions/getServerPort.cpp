...
└───────────────────────────┘
    ...
    FunctionDocumentation documentation_getServerPort = {description_getServerPort, syntax_getServerPort, argument_getServerPort, {}, returned_value_getServerPort, examples_getServerPort, introduced_in_getServerPort, category_getServerPort};
