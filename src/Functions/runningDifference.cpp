...
└────────┴──────┘
    ...
    FunctionDocumentation documentation_runningDifference = {description_runningDifference, syntax_runningDifference, argument_runningDifference, {}, returned_value_runningDifference, examples_runningDifference, introduced_in_runningDifference, category_runningDifference};
