...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_or_null = {description_or_null, syntax_or_null, argument_or_null, {}, returned_value_or_null, examples_or_null, introduced_in_or_null, category_or_null};
