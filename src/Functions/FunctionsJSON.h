...
//
//#include <Functions/JSONExtractTree.h>
//
...
//
//
//static const JSONExtractInsertSettings & getJSONExtractInsertSettings()
//{
//    static const JSONExtractInsertSettings instance = []
//    {
//        JSONExtractInsertSettings settings;
//        settings.insert_null_as_default = false;
//        settings.insert_default_on_invalid_elements_in_complex_types = true;
//        return settings;
//    }();
//    return instance;
//}
...
//    {
//        String error;
//        return extract_tree->insertResultToColumn(dest, element, getJSONExtractInsertSettings(), error);
//    }
//
//protected:
...
//        {
//            if (extract_tree->insertResultToColumn(col_value, value, getJSONExtractInsertSettings(), error))
