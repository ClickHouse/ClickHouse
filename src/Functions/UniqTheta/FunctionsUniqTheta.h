    ...
    public:
        ...
        DataTypePtr getReturnTypeImpl(const DataTypes & arguments) const override
        {
            ...
            if (!(sketch_type0 && sketch_type0->getFunctionName() == "uniqTheta"))
                throw Exception( ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "First argument for function {} must be a uniqTheta but it has type {}", getName(), arguments[0]->getName());
            ...
            if (!(sketch_type1 && sketch_type1->getFunctionName() == "uniqTheta"))
                throw Exception( ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT, "Second argument for function {} must be a uniqTheta but it has type {}", getName(), arguments[1]->getName());
