...
public:
    ...
    {
        return std::make_shared<FunctionHasColumnInTable>(context_, context_->isDistributed());
    }
    ...
    explicit FunctionHasColumnInTable(ContextPtr context_, bool is_distributed_)
        : WithContext(context_), is_distributed(is_distributed_)
    {
    }
