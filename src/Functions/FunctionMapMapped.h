...
// TODO 只要map没有实现去重，那么这个函数就不能用了。先等着吧
/** Higher-order functions for maps.
  * These functions optionally apply a map (transform) to map(or multiple map of identical size) by lambda function,
