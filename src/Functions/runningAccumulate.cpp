...
public:
    ...
    /// Finalizing an arbitrary aggregate state can throw. The declaration above answers a different
    /// question, so it must not decide whether unused rows of a replicated argument are finalized.
