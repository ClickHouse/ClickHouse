...
└────────┴─────────────┴────────────────┘
    ...
    FunctionDocumentation documentation_runningAccumulate = {description_runningAccumulate, syntax_runningAccumulate, argument_runningAccumulate, {}, returned_value_runningAccumulate, examples_runningAccumulate, introduced_in_runningAccumulate, category_runningAccumulate};
