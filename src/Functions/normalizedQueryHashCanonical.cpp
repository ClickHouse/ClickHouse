...
/** Like `normalizedQueryHash`, but works on the parsed query and ignores the order of elements in
  * lists where the order does not change what the query does. See `canonicalQueryHash`.
  */
