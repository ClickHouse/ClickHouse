...
└────────────┘
    ...
    FunctionDocumentation documentation_makeDate = {description_makeDate, syntax_makeDate, argument_makeDate, {}, returned_value_makeDate, examples_makeDate, introduced_in_makeDate, category_makeDate};
...
└────────────┘
    ...
    FunctionDocumentation documentation_makeDate32 = {description_makeDate32, syntax_makeDate32, argument_makeDate32, {}, returned_value_makeDate32, examples_makeDate32, introduced_in_makeDate32, category_makeDate32};
...
└─────────────────────┘
    ...
    FunctionDocumentation documentation_makeDateTime = {description_makeDateTime, syntax_makeDateTime, argument_makeDateTime, {}, returned_value_makeDateTime, examples_makeDateTime, introduced_in_makeDateTime, category_makeDateTime};
...
└─────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_makeDateTime64 = {description_makeDateTime64, syntax_makeDateTime64, argument_makeDateTime64, {}, returned_value_makeDateTime64, examples_makeDateTime64, introduced_in_makeDateTime64, category_makeDateTime64};
...
└──────────────────────┘
    ...
    FunctionDocumentation documentation_yyyymmddtodate = {description_yyyymmddtodate, syntax_yyyymmddtodate, argument_yyyymmddtodate, {}, returned_value_yyyymmddtodate, examples_yyyymmddtodate, introduced_in_yyyymmddtodate, category_yyyymmddtodate};
...
└────────────────────────────┘
    ...
    FunctionDocumentation documentation_yyyymmddtodate32 = {description_yyyymmddtodate32, syntax_yyyymmddtodate32, argument_yyyymmddtodate32, {}, returned_value_yyyymmddtodate32, examples_yyyymmddtodate32, introduced_in_yyyymmddtodate32, category_yyyymmddtodate32};
...
└───────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_yyyymmddhhmmsstodatetime = {description_yyyymmddhhmmsstodatetime, syntax_yyyymmddhhmmsstodatetime, argument_yyyymmddhhmmsstodatetime, {}, returned_value_yyyymmddhhmmsstodatetime, examples_yyyymmddhhmmsstodatetime, introduced_in_yyyymmddhhmmsstodatetime, category_yyyymmddhhmmsstodatetime};
