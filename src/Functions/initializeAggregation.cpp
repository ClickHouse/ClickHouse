...
└────────────────────────────┴───────────────────────────────┘
    ...
    FunctionDocumentation documentation_initializeAggregation = {description_initializeAggregation, syntax_initializeAggregation, arguments_initializeAggregation, {}, returned_value_initializeAggregationcategory_initializeAggregation};
