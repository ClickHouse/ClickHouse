...
template <typename Quantize4BitImpl>
class FunctionQuantize4BitImpl : public IFunction
{
public:
    static constexpr auto name = "quantize4Bit";
...
class FunctionQuantize4Bit : public FunctionQuantize4BitImpl<TargetSpecific::Default::Quantize4BitImpl>
{
public:
    explicit FunctionQuantize4Bit(ContextPtr context) : selector(context)
    {
        selector.registerImplementation<TargetArch::Default, FunctionQuantize4BitImpl<TargetSpecific::Default::Quantize4BitImpl>>();
    }
    ...
    static FunctionPtr create(ContextPtr context) { return std::make_shared<FunctionQuantize4Bit>(context); }
