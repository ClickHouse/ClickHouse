...
└─────────────────────────────────┘
    ...
    FunctionDocumentation documentation_replicate = {description_replicate, syntax_replicate, argument_replicate, {}, returned_value_replicate, examples_replicate, introduced_in_replicate, category_replicate};
