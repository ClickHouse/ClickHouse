...
A tumbling time window assigns records to non-overlapping, continuous windows with a fixed duration (`interval`).
    ...
    FunctionDocumentation::Examples examples_tumble = {{"Tumbling window", "SELECT tumble(now(), toIntervalDay('1'))", "('2026-08-02 00:00:00','2026-08-03 00:00:00')"}};
...
Returns the inclusive lower bound of the corresponding tumbling window.
    ...
    FunctionDocumentation::Examples examples_tumble_start = {{"Tumbling window start", "SELECT tumbleStart(now(), toIntervalDay('1'))", "2026-08-02 00:00:00"}};
...
Returns the exclusive upper bound of the corresponding tumbling window.
    ...
    FunctionDocumentation::Examples examples_tumble_end = {{"Tumbling window end", "SELECT tumbleEnd(now(), toIntervalDay('1'))", "2026-08-03 00:00:00"}};
...
Since one record can be assigned to multiple hop windows, the function only returns the bound of the first window when hop function is used without WINDOW VIEW.
    ...
    FunctionDocumentation::Examples examples_hop = {{"Hopping window", "SELECT hop(now(), INTERVAL '1' DAY, INTERVAL '2' DAY)", "('2026-08-01 00:00:00','2026-08-03 00:00:00')"}};
...
Since one record can be assigned to multiple hop windows, the function only returns the bound of the first window when hop function is used without `WINDOW VIEW`.
    ...
    FunctionDocumentation::Examples examples_hop_start = {{"Hopping window start", "SELECT hopStart(now(), INTERVAL '1' DAY, INTERVAL '2' DAY)", "2026-08-01 00:00:00"}};
...
Since one record can be assigned to multiple hop windows, the function only returns the bound of the first window when hop function is used without `WINDOW VIEW`.
    ...
    FunctionDocumentation::Examples examples_hop_end = {{"Hopping window end", "SELECT hopEnd(now(), INTERVAL '1' DAY, INTERVAL '2' DAY)", "2026-08-03 00:00:00"}};
