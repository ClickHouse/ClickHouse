...
A tumbling time window assigns records to non-overlapping, continuous windows with a fixed duration (`interval`).
    ...
    FunctionDocumentation documentation_tumble = {description_tumble, syntax_tumble, argument_tumble, {}, returned_value_tumble, examples_tumble, introduced_in_tumble, category_tumble};
...
Returns the inclusive lower bound of the corresponding tumbling window.
    ...
    FunctionDocumentation documentation_tumble_start = {description_tumble_start, syntax_tumble_start, argument_tumble_start, {}, returned_value_tumble_start, examples_tumble_start, introduced_in_tumble_start, category_tumble_start};
...
Returns the exclusive upper bound of the corresponding tumbling window.
    ...
    FunctionDocumentation documentation_tumble_end = {description_tumble_end, syntax_tumble_end, argument_tumble_end, {}, returned_value_tumble_end, examples_tumble_end, introduced_in_tumble_end, category_tumble_end};
...
Since one record can be assigned to multiple hop windows, the function only returns the bound of the first window when hop function is used without WINDOW VIEW.
    ...
    FunctionDocumentation documentation_hop = {description_hop, syntax_hop, argument_hop, {}, returned_value_hop, examples_hop, introduced_in_hop, category_hop};
...
Since one record can be assigned to multiple hop windows, the function only returns the bound of the first window when hop function is used without `WINDOW VIEW`.
    ...
    FunctionDocumentation documentation_hop_start = {description_hop_start, syntax_hop_start, argument_hop_start, {}, returned_value_hop_start, examples_hop_start, introduced_in_hop_start, category_hop_start};
...
Since one record can be assigned to multiple hop windows, the function only returns the bound of the first window when hop function is used without `WINDOW VIEW`.
    ...
    FunctionDocumentation documentation_hop_end = {description_hop_end, syntax_hop_end, argument_hop_end, {}, returned_value_hop_end, examples_hop_end, introduced_in_hop_end, category_hop_end};
