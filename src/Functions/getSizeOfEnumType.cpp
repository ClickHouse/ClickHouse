...
└───┘
    ...
    FunctionDocumentation documentation_getSizeOfEnumType = {description_getSizeOfEnumType, syntax_getSizeOfEnumType, argument_getSizeOfEnumType, {}, returned_value_getSizeOfEnumType, examples_getSizeOfEnumType, introduced_in_getSizeOfEnumType, category_getSizeOfEnumType};
