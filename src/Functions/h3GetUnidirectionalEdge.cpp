...
Returns a unidirectional edge H3 index for two adjacent H3 cell indices (origin and destination).
    ...
    FunctionDocumentation::ReturnedValue returned_value = {"Returns the H3 unidirectional edge index. Throws an exception if either input is not a valid H3 cell (controlled by the `functions_h3_default_if_invalid` setting).", {"UInt64"}};
