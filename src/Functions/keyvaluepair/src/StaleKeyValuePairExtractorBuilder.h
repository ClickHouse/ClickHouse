...
class StaleKeyValuePairExtractorBuilder
{
public:
    StaleKeyValuePairExtractorBuilder & withKeyValuePairDelimiter(char key_value_pair_delimiter_)
    {
        key_value_pair_delimiter = key_value_pair_delimiter_;
        return *this;
    }

    StaleKeyValuePairExtractorBuilder & withEscapeCharacter(char escape_character_)
    {
        escape_character = escape_character_;
        return *this;
    }

    StaleKeyValuePairExtractorBuilder & withItemDelimiter(char item_delimiter_)
    {
        item_delimiter = item_delimiter_;
        return *this;
    }

    StaleKeyValuePairExtractorBuilder & withEnclosingCharacter(std::optional<char> enclosing_character_)
    {
        enclosing_character = enclosing_character_;
        return *this;
    }

    StaleKeyValuePairExtractorBuilder & withValueSpecialCharacterAllowList(std::unordered_set<char> value_special_character_allowlist_)
    {
    ...
    StaleKeyValuePairExtractorBuilder & withEscapingProcessor()
    {
