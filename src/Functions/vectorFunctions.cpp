...
addTupleOfIntervals(datetime, intervals)
    ...
    FunctionDocumentation::ReturnedValue returned_value_addTupleOfIntervals = {"Returns `date` with added `intervals`", {"Date"}};
...
subtractTupleOfIntervals(datetime, intervals)
    ...
    FunctionDocumentation::ReturnedValue returned_value_subtractTupleOfIntervals = {"Returns `date` with subtracted `intervals`", {"Date"}};
...
addInterval(interval_1, interval_2)
    ...
    FunctionDocumentation::ReturnedValue returned_value_addInterval = {"Returns a tuple of intervals", {"Tuple(T)"}};
