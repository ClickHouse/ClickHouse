...
Calculates the distance between two points (the elements of the vectors are the coordinates) in Euclidean space ([Euclidean distance](https://en.wikipedia.org/wiki/Euclidean_distance)).
    ...
    FunctionDocumentation::ReturnedValue returned_value_l2_distance = {"Returns the 2-norm distance. The return type is determined by the least common supertype of the input element types: `Float32` for `Float32` or `BFloat16` inputs, `Float64` for integer or `Float64` inputs.", {"Float32", "Float64"}};
...
Calculates the distance between two points (the elements of the vectors are the coordinates) in `Lp` space ([p-norm distance](https://en.wikipedia.org/wiki/Norm_(mathematics)#p-norm)).
    ...
    FunctionDocumentation::ReturnedValue returned_value_lp_distance = {"Returns the p-norm distance. The return type is determined by the least common supertype of the input element types: `Float32` for `Float32` or `BFloat16` inputs, `Float64` for integer or `Float64` inputs.", {"Float32", "Float64"}};
...
Calculates the [cosine distance](https://en.wikipedia.org/wiki/Cosine_similarity#Cosine_distance) between two vectors (the elements of the tuples are the coordinates). The smaller the returned value is, the more similar are the vectors.
    ...
    FunctionDocumentation::ReturnedValue returned_value_cosine_distance = {"Returns the cosine of the angle between two vectors subtracted from one. The return type is determined by the least common supertype of the input element types: `Float32` for `Float32` or `BFloat16` inputs, `Float64` for integer or `Float64` inputs.", {"Float32", "Float64"}};
...
Calculates the approximate distance between two points (the values of the vectors are the coordinates) in Euclidean space ([Euclidean distance](https://en.wikipedia.org/wiki/Euclidean_distance)).
    ...
    FunctionDocumentation::ReturnedValue returned_value_l2_distance_transposed = {"Returns the approximate 2-norm distance. The return type is determined by the least common supertype of the input element types: `Float32` for `Float32` or `BFloat16` inputs, `Float64` for integer or `Float64` inputs.", {"Float32", "Float64"}};
...
Calculates the approximate [cosine distance](https://en.wikipedia.org/wiki/Cosine_similarity#Cosine_distance) between two points (the values of the vectors are the coordinates). The smaller the returned value is, the more similar are the vectors.
    ...
    FunctionDocumentation::ReturnedValue returned_value_cosine_distance_transposed
        = {"Returns the approximate cosine of the angle between two vectors subtracted from one. The return type is determined by the least common supertype of the input element types: `Float32` for `Float32` or `BFloat16` inputs, `Float64` for integer or `Float64` inputs.", {"Float32", "Float64"}};
