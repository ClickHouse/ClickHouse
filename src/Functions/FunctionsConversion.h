...
template <>
inline void parseImpl<DataTypeUUID2>(DataTypeUUID2::FieldType & x, ReadBuffer & rb, const DateLUTImpl *, bool, bool)
{
    UUID tmp;
    readUUIDText(tmp, rb);
...
template <>
inline bool tryParseImpl<DataTypeUUID2>(DataTypeUUID2::FieldType & x, ReadBuffer & rb, const DateLUTImpl *, bool, bool)
{
    UUID tmp;
    if (!tryReadUUIDText(tmp, rb))
        return false;
