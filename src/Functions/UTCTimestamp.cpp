...
└─────────────────────┘
    ...
    FunctionDocumentation documentation_UTCTimestamp = {description_UTCTimestamp, syntax_UTCTimestamp, argument_UTCTimestamp, {}, returned_value_UTCTimestamp, examples_UTCTimestamp, introduced_in_UTCTimestamp,category_UTCTimestamp};
