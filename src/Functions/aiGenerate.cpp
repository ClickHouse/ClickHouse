...
Provider credentials and configuration are taken from the named collection named by the `ai_credentials` setting.
        ...
        .examples
        = {{"Simple question", "SELECT aiGenerate('What is 2 + 2? Reply with just the number.') SETTINGS ai_credentials = 'ai_creds'", "4"},
           {"With system prompt", "SELECT aiGenerate('Explain ClickHouse', 'You are a database expert. Be concise.') SETTINGS ai_credentials = 'ai_creds'", ""},
