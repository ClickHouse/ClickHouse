...
└────────────┴───────┴───────┴───────┘
    ...
    FunctionDocumentation documentation_toWeek = {description_toWeek, syntax_toWeek, arguments_toWeek, {}, returned_value_toWeekcategory_toWeek};
...
└────────────┴───────────┴───────────┴───────────┴───────────────┘
    ...
    FunctionDocumentation documentation_toYearWeek = {description_toYearWeek, syntax_toYearWeek, arguments_toYearWeek, {}, returned_value_toYearWeekcategory_toYearWeek};
...
toStartOfWeek(datetime[, mode[, timezone]])
    ...
    FunctionDocumentation documentation_to_start_of_week = {description_to_start_of_week, syntax_to_start_of_week, arguments_to_start_of_week, {}, returned_value_to_start_of_weekcategory_to_start_of_week};
...
toLastDayOfWeek(toDate('2023-04-23'), 1):                2023-04-23
    ...
    FunctionDocumentation documentation_to_last_day_of_week = {description_to_last_day_of_week, syntax_to_last_day_of_week, arguments_to_last_day_of_week, {}, returned_value_to_last_day_of_weekcategory_to_last_day_of_week};
