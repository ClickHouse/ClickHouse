...
public:
    ...
    {
        const auto *const col_hindex_origin = block.getByPosition(arguments[0]).column.get();
        const auto *const col_hindex_dest = block.getByPosition(arguments[1]).column.get();
