...
[[maybe_unused]] static void printType(DB::bUInt128) { std::cout << "UInt128"; }
[[maybe_unused]] static void printType(DB::bUInt256) { std::cout << "UInt256"; }
...
[[maybe_unused]] static void printType(DB::bInt128) { std::cout << "Int128"; }
[[maybe_unused]] static void printType(DB::bInt256) { std::cout << "Int256"; }
