...
static const std::map<std::pair<std::string, std::string>, std::string> answer =
{
    ...
    {{"UInt128", "UInt512"}, "UInt512"},
    {{"UInt128", "Int8"}, "Int256"},
    {{"UInt128", "Int16"}, "Int256"},
    {{"UInt128", "Int32"}, "Int256"},
    {{"UInt128", "Int64"}, "Int256"},
    {{"UInt128", "Int128"}, "Int256"},
    {{"UInt128", "Int256"}, "Int256"},
    {{"UInt128", "Int512"}, "Int512"},
    {{"UInt128", "Float32"}, "Error"},
    {{"UInt128", "Float64"}, "Error"},
    ...
    {{"UInt256", "UInt512"}, "UInt512"},
    {{"UInt256", "Int8"}, "Int512"},
    {{"UInt256", "Int16"}, "Int512"},
    {{"UInt256", "Int32"}, "Int512"},
    {{"UInt256", "Int64"}, "Int512"},
    {{"UInt256", "Int128"}, "Int512"},
    {{"UInt256", "Int256"}, "Int512"},
    {{"UInt256", "Int512"}, "Int512"},
    {{"UInt256", "Float32"}, "Error"},
    {{"UInt256", "Float64"}, "Error"},
    {{"UInt512", "UInt8"}, "UInt512"},
    {{"UInt512", "UInt16"}, "UInt512"},
    {{"UInt512", "UInt32"}, "UInt512"},
    {{"UInt512", "UInt64"}, "UInt512"},
    {{"UInt512", "UInt128"}, "UInt512"},
    {{"UInt512", "UInt256"}, "UInt512"},
    {{"UInt512", "UInt512"}, "UInt512"},
    {{"UInt512", "Int8"}, "Error"},
    {{"UInt512", "Int16"}, "Error"},
    {{"UInt512", "Int32"}, "Error"},
    {{"UInt512", "Int64"}, "Error"},
    {{"UInt512", "Int128"}, "Error"},
    {{"UInt512", "Int256"}, "Error"},
    {{"UInt512", "Int512"}, "Error"},
    {{"UInt512", "Float32"}, "Error"},
    {{"UInt512", "Float64"}, "Error"},
    {{"Int8", "UInt8"}, "Int16"},
    {{"Int8", "UInt16"}, "Int32"},
    {{"Int8", "UInt32"}, "Int64"},
    {{"Int8", "UInt64"}, "Int128"},
    ...
    {{"Int16", "UInt32"}, "Int64"},
    {{"Int16", "UInt64"}, "Int128"},
    {{"Int16", "UInt128"}, "Int256"},
    {{"Int16", "UInt256"}, "Int512"},
    {{"Int16", "UInt512"}, "Error"},
    {{"Int16", "Int8"}, "Int16"},
    {{"Int16", "Int16"}, "Int16"},
    {{"Int16", "Int32"}, "Int32"},
    ...
    {{"Int32", "UInt32"}, "Int64"},
    {{"Int32", "UInt64"}, "Int128"},
    {{"Int32", "UInt128"}, "Int256"},
    {{"Int32", "UInt256"}, "Int512"},
    {{"Int32", "UInt512"}, "Error"},
    {{"Int32", "Int8"}, "Int32"},
    {{"Int32", "Int16"}, "Int32"},
    {{"Int32", "Int32"}, "Int32"},
    ...
    {{"Int128", "UInt256"}, "Int512"},
    {{"Int128", "UInt512"}, "Error"},
    {{"Int128", "Int8"}, "Int128"},
    {{"Int128", "Int16"}, "Int128"},
    {{"Int128", "Int32"}, "Int128"},
    {{"Int128", "Int64"}, "Int128"},
    ...
    {{"Int256", "UInt256"}, "Int512"},
    {{"Int256", "UInt512"}, "Error"},
    {{"Int256", "Int8"}, "Int256"},
    {{"Int256", "Int16"}, "Int256"},
    {{"Int256", "Int32"}, "Int256"},
    {{"Int256", "Int64"}, "Int256"},
    ...
    {{"Int256", "Int512"}, "Int512"},
    {{"Int256", "Float32"}, "Error"},
    {{"Int256", "Float64"}, "Error"},
    {{"Int512", "UInt8"}, "Int512"},
    {{"Int512", "UInt16"}, "Int512"},
    {{"Int512", "UInt32"}, "Int512"},
    {{"Int512", "UInt64"}, "Int512"},
    {{"Int512", "UInt128"}, "Int512"},
    {{"Int512", "UInt256"}, "Int512"},
    {{"Int512", "UInt512"}, "Error"},
    {{"Int512", "Int8"}, "Int512"},
    {{"Int512", "Int16"}, "Int512"},
    {{"Int512", "Int32"}, "Int512"},
    {{"Int512", "Int64"}, "Int512"},
    {{"Int512", "Int128"}, "Int512"},
    {{"Int512", "Int256"}, "Int512"},
    {{"Int512", "Int512"}, "Int512"},
    {{"Int512", "Float32"}, "Error"},
    {{"Int512", "Float64"}, "Error"},
    {{"Float32", "UInt8"}, "Float32"},
    {{"Float32", "UInt16"}, "Float32"},
    {{"Float32", "UInt32"}, "Float64"},
    {{"Float32", "UInt64"}, "Error"},
    {{"Float32", "UInt128"}, "Error"},
    {{"Float32", "UInt256"}, "Error"},
    {{"Float32", "UInt512"}, "Error"},
    ...
    {{"Float64", "UInt128"}, "Error"},
    {{"Float64", "UInt256"}, "Error"},
    {{"Float64", "UInt512"}, "Error"},
...
void ifRightType()
{
    SCOPED_TRACE("When comparing " + getTypeString(T0()) + " and " + getTypeString(T1()));
