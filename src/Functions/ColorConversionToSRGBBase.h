...
public:
    ...
    DataTypePtr getReturnTypeImpl(const DataTypes & arguments) const override
    {
        ...
        /// We require the first argument to be a Tuple rather than an Array because the three color channels are conceptually
...
protected:
    /// Common helper: OKLab -> sRGB conversion (steps 2-3 of the conversion pipeline)
    /// This is shared by both OKLAB and OKLCH conversions
    static ColorConversion::Color oklabToSrgb(const ColorConversion::Color & oklab, Float64 gamma)
    {
