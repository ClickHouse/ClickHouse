...
- `japanese` splits Japanese text into words using the MeCab morphological analyzer. Requires a dictionary configured in the server configuration (see the [text index](/engines/table-engines/mergetree-family/textindexes) documentation) and a build with MeCab support.
