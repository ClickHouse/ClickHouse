...
- `asciiCJK_v2` uses StringZilla's UAX #29 UTF-8 segmentation. It keeps connected Unicode word runs together while emitting individual CJK ideographs.
...
tokens(value, 'array')
    ...
    FunctionDocumentation::Arguments arguments = {
        ...
        {"tokenizer", "The tokenizer to use. Valid arguments are `splitByNonAlpha`, `splitByString`, `asciiCJK`, `asciiCJK_v2`, `icu`, `japanese`, `ngrams`, `sparseGrams`, and `array`. Optional, if not set explicitly, defaults to `splitByNonAlpha`.", {"const String"}},
