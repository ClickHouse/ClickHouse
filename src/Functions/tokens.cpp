...
tokens(value, 'chinese'[, granularity])
    ...
    FunctionDocumentation::Arguments arguments = {
        ...
        {"tokenizer", "The tokenizer to use. Valid arguments are `splitByNonAlpha`, `splitByString`, `asciiCJK`, `ngrams`, `sparseGrams`, `array`, and `chinese`. Optional, if not set explicitly, defaults to `splitByNonAlpha`.", {"const String"}},
