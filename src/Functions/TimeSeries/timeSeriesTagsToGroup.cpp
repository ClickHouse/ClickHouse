...
/// Function timeSeriesTagsToGroup([('tag_name1', 'tag_value1'), (tag_name2, tag_value2), ...]) returns a group (UInt64)
/// corresponding to the specified set of tags.
...
REGISTER_FUNCTION(TimeSeriesTagsToGroup)
{
    ...
    factory.registerFunction<TimeSeriesTagsToGroup>(documentation);
}
