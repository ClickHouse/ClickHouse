...
└────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_currentRoles = {description_currentRoles, syntax_currentRoles, argument_currentRoles, {}, returned_value_currentRoles, examples_currentRoles, introduced_in_currentRoles, category_currentRoles};
...
└────────────────────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_enabledRoles = {description_enabledRoles, syntax_enabledRoles, argument_enabledRoles, {}, returned_value_enabledRoles, examples_enabledRoles, introduced_in_enabledRoles, category_enabledRoles};
...
└────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_defaultRoles = {description_defaultRoles, syntax_defaultRoles, argument_defaultRoles, {}, returned_value_defaultRoles, examples_defaultRoles, introduced_in_defaultRoles, category_defaultRoles};
