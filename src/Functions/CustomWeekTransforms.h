...
namespace CustomWeek
{
    ...
    struct TransformImpl
    {
        ...
        static ColumnPtr execute(const ColumnsWithTypeAndName & arguments, const DataTypePtr &,
                                 size_t /*input_rows_count*/, Transform transform = {})
        {
...
struct ToWeekImpl
{
    ...
    using FactorTransform = CustomWeek::ZeroTransform;
};
