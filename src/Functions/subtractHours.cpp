...
subtractHours(datetime, num)
    ...
    FunctionDocumentation::ReturnedValue returned_value = "Returns `datetime` minus `num` hours. [`DateTime`](../data-types/datetime.md)/[`DateTime64(3)`](../data-types/datetime64.md).";
