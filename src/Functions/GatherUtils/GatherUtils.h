...
/// A source that reads a lazily replicated array without materializing it (see ReplicatedSource in Sources.h).
/// Only the slice* algorithms support such sources.
