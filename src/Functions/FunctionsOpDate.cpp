...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_addDate = {description_addDate, syntax_addDate, argument_addDate, {}, returned_value_addDate, examples_addDate, introduced_in_addDate, category_addDate
    };
...
└──────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_subDate = {description_subDate, syntax_subDate, argument_subDate, {}, returned_value_subDate, examples_subDate, introduced_in_subDate, category_subDate};
