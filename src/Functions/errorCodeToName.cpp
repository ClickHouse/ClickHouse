...
└──────────────────────┘
    ...
    FunctionDocumentation documentation_errorCodeToName = {description_errorCodeToName, syntax_errorCodeToName, argument_errorCodeToName, {}, returned_value_errorCodeToName, examples_errorCodeToName, introduced_in_errorCodeToName, category_errorCodeToName};
