...
DataTypePtr FunctionToFixedString::getReturnTypeImpl(const ColumnsWithTypeAndName & arguments) const
{
...
void FunctionToFixedString::executeForN(Block & block, const ColumnNumbers & arguments, const size_t result, const size_t n)
{
...
void FunctionToFixedString::executeImpl(Block & block, const ColumnNumbers & arguments, size_t result, size_t /*input_rows_count*/)
{
