...
toStartOfTenMinutes(datetime)
    ...
    FunctionDocumentation::ReturnedValue returned_value_to_start_of_ten_minutes = {"Returns the date with time rounded to the start of the nearest ten-minute interval", {"DateTime"}};
