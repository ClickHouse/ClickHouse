...
toStartOfTenMinutes(datetime)
    ...
    FunctionDocumentation::ReturnedValue returned_value = "Returns the date with time rounded to the start of the nearest ten-minute interval. [`DateTime`](../data-types/datetime.md)/[`DateTime64`](../data-types/datetime64.md)..";
