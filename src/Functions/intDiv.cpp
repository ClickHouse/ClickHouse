    ...
    : BinaryOperation<A, B, DivideIntegralImpl<A, B>>
{
    ...
    static void NO_INLINE process(const A * __restrict a, const B * __restrict b, ResultType * __restrict c, size_t size, const NullMap *, const NullMap * right_nullmap, NullMap *)
    {
