...
└───────────────────┘
    ...
    FunctionDocumentation documentation_initialQueryID = {description_initialQueryID, syntax_initialQueryID, argument_initialQueryID, {}, returned_value_initialQueryID, examples_initialQueryID, introduced_in_initialQueryID, category_initialQueryID};
