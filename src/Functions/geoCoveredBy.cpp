...
`ST_CoveredBy` is an alias for this function.
    )",
    ...
    /// ST_CoveredBy is an alias for geoCoveredByCartesian.
    factory.registerAlias("ST_CoveredBy", "geoCoveredByCartesian", FunctionFactory::Case::Insensitive);
