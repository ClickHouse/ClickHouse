...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_queryString = {description_queryString, syntax_queryString, arguments_queryString, {}, returned_value_queryStringcategory_queryString};
