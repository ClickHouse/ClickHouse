...
└─────────────────────────────────────────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_cutQueryStringAndFragment = {description_cutQueryStringAndFragment, syntax_cutQueryStringAndFragment, arguments_cutQueryStringAndFragment, {}, returned_value_cutQueryStringAndFragmentcategory_cutQueryStringAndFragment};
