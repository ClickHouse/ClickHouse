...
└────────────────────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_cutFragment = {description_cutFragment, syntax_cutFragment, arguments_cutFragment, {}, returned_value_cutFragmentcategory_cutFragment};
