...
└────────────────────────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_topLevelDomain = {description_topLevelDomain, syntax_topLevelDomain, arguments_topLevelDomain, {}, returned_value_topLevelDomaincategory_topLevelDomain};
...
└────────────────────────────────────────────────┴───────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_topLevelDomainRFC = {description_topLevelDomainRFC, syntax_topLevelDomainRFC, arguments_topLevelDomainRFC, {}, returned_value_topLevelDomainRFCcategory_topLevelDomainRFC};
