...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_extractURLParameterNames = {description_extractURLParameterNames, syntax_extractURLParameterNames, arguments_extractURLParameterNames, {}, returned_value_extractURLParameterNamescategory_extractURLParameterNames};
