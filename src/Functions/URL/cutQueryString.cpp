...
└──────────────────────────────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_cutQueryString = {description_cutQueryString, syntax_cutQueryString, arguments_cutQueryString, {}, returned_value_cutQueryStringcategory_cutQueryString};
