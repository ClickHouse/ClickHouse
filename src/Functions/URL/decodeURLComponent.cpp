...
└────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_decodeURLComponent = {description_decodeURLComponent, syntax_decodeURLComponent, arguments_decodeURLComponent, {}, returned_value_decodeURLComponentcategory_decodeURLComponent};
...
└──────────────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_encodeURLComponent = {description_encodeURLComponent, syntax_encodeURLComponent, arguments_encodeURLComponent, {}, returned_value_encodeURLComponentcategory_encodeURLComponent};
...
└───────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_decodeURLFormComponent = {description_decodeURLFormComponent, syntax_decodeURLFormComponent, arguments_decodeURLFormComponent, {}, returned_value_decodeURLFormComponentcategory_decodeURLFormComponent};
...
└───────────────────────────────────────────────────────────┘
    ...
    FunctionDocumentation documentation_encodeURLFormComponent = {description_encodeURLFormComponent, syntax_encodeURLFormComponent, arguments_encodeURLFormComponent, {}, returned_value_encodeURLFormComponentcategory_encodeURLFormComponent};
