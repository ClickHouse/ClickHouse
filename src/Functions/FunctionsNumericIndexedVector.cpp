...
REGISTER_FUNCTION(NumericIndexedVector)
{
    factory.registerFunction<FunctionNumericIndexedVectorBuild>(FunctionDocumentation{
        .description
        = R"(Creates a NumericIndexedVector from a map. The map’s keys represent the Index and the map’s value represents the element value.)",
...
└─────┘
    ...
    factory.registerFunction<FunctionNumericIndexedVectorShortDebugString>(FunctionDocumentation{
        .description = R"(Returns internal information of the NumericIndexedVector in a human-readable format. This function is primarily used for debugging purposes.)",
...
Row 1:
──────
res: vector_type: BSI; index_type: char8_t; value_type: char8_t; integer_bit_num: 8; fraction_bit_num: 0; zero_indexes cardinality: 0; data_array total card: 3, all value sum: 60, size: 8, cardinality: 0: 0, 1: 2, 2: 2, 3: 2, 4: 2, 5: 0, 6: 0, 7: 0.
            )"
        }},
        .introduced_in = {25, 5},
        .category = FunctionDocumentation::Category::Arithmetic,
