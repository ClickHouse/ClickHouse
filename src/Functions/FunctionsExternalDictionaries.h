...
private:
    ...
    bool executeDispatchSimple(
            ColumnsWithTypeAndName & block, const ColumnNumbers & arguments, const size_t result, const std::shared_ptr<const IDictionaryBase> & dict_ptr) const
    {
...
private:
    ...
    void executeDispatch(
            ColumnsWithTypeAndName & block, const ColumnNumbers & arguments, const size_t result, const DictionaryType * dict,
...
private:
    ...
    template <typename DictionaryType>
    bool executeDispatch(ColumnsWithTypeAndName & block, const ColumnNumbers & arguments, const size_t result, const std::shared_ptr<const IDictionaryBase> & dict_ptr) const
    {
        const auto dict = typeid_cast<const DictionaryType *>(dict_ptr.get());
        if (!dict)
            return false;
...
private:
    ...
    template <typename DictionaryType>
    bool executeDispatch(ColumnsWithTypeAndName & block, const ColumnNumbers & arguments, const size_t result,
...
private:
    ...
    template <typename DictionaryType>
    bool execute(ColumnsWithTypeAndName & block, const size_t result, const DictionaryType * dict,
