...
struct NameDictGetBFloat16 { static constexpr auto name = "dictGetBFloat16"; };
...
using FunctionDictGetBFloat16 = FunctionDictGet<DataTypeBFloat16, NameDictGetBFloat16>;
...
struct NameDictGetBFloat16OrDefault { static constexpr auto name = "dictGetBFloat16OrDefault"; };
...
using FunctionDictGetBFloat16OrDefault = FunctionDictGetOrDefault<DataTypeBFloat16, NameDictGetBFloat16OrDefault>;
