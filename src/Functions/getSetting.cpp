...
└──────────────────────────┘
    ...
    FunctionDocumentation documentation_getSetting = {description_getSetting, syntax_getSetting, argument_getSetting, {}, returned_value_getSetting, examples_getSetting, introduced_in_getSetting, category_getSetting};
...
NULL
    ...
    FunctionDocumentation documentation_getSettingOrDefault = {description_getSettingOrDefault, syntax_getSettingOrDefault, argument_getSettingOrDefault, {}, returned_value_getSettingOrDefault, examples_getSettingOrDefault, introduced_in_getSettingOrDefault, category_getSettingOrDefault};
