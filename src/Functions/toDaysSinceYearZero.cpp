...
toDaysSinceYearZero(date[, time_zone])
    ...
    FunctionDocumentation::Arguments arguments_toDaysSinceYearZero = {
        {"date", "The date or date with time for which to calculate the number of days since year zero from. [`Date`](../data-types/date.md)/[`Date32`](../data-types/date32.md)/[`DateTime`](../data-types/datetime.md)/[`DateTime64`](../data-types/datetime64.md)."},
