...
{
    FunctionDocumentation::Description description = "Takes any integer and converts it into [binary form](https://en.wikipedia.org/wiki/Binary_number), then returns the value of the bit at a specified position. Counting is done right-to-left, starting at 0.";
    FunctionDocumentation::Syntax syntax = "bitTest(a, i)";
    FunctionDocumentation::Arguments arguments = {
        {"a", "An integer value. [`(U)Int8/16/32/64`](/sql-reference/data-types/int-uint)/[`Float32/64`](/sql-reference/data-types/float)."},
