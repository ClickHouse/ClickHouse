...
Applies to database engines that store table metadata on disk (e.g. `Atomic`, `Ordinary`). Views, materialized views, dictionaries, `Alias` tables, and tables backed by table functions are always loaded eagerly regardless of this setting.
