...
TEST(ParserReference, SimpleReference)
{
    ...
    EXPECT_EQ(ast_reference_01->as<ASTDeclareReference>()->reference_expression->as<ASTIdentifier>()->fullName(), "ref_col_01");
    ...
    EXPECT_EQ(arguments->children[0]->as<ASTIdentifier>()->fullName(), "ref_col_01");
    EXPECT_EQ(arguments->children[1]->as<ASTIdentifier>()->fullName(), "ref_col_02");
}
...
TEST(ParserReference, ReferenceDifferenceKind)
{
    ...
    ASTPtr ast_reference_02 = parseQuery(p_reference, reference_02.data(), reference_02.data() + reference_02.size(), "", 0, 0);
    EXPECT_EQ(ast_reference_02->as<ASTDeclareReference>()->reference_table_name, "table_name");
    EXPECT_EQ(ast_reference_02->as<ASTDeclareReference>()->reference_expression->as<ASTIdentifier>()->fullName(), "ref_col_01");
    ...
    EXPECT_EQ(ast_reference_03->as<ASTDeclareReference>()->reference_expression->as<ASTIdentifier>()->fullName(), "ref_col_01");
...
TEST(ParserReference, ReferenceDifferenceOption)
{
    ...
    EXPECT_EQ(ast_reference_04->as<ASTDeclareReference>()->reference_expression->as<ASTIdentifier>()->fullName(), "ref_col_01");
    ...
    EXPECT_EQ(ast_reference_05->as<ASTDeclareReference>()->reference_expression->as<ASTIdentifier>()->fullName(), "ref_col_01");
