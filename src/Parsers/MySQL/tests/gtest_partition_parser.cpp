...
TEST(ParserPartition, AllPatitionOptions)
{
    ...
    EXPECT_EQ(declare_options->changes["engine"]->as<ASTIdentifier>()->fullName(), "engine_name");
    ...
    EXPECT_EQ(declare_options->changes["tablespace"]->as<ASTIdentifier>()->fullName(), "table_space_name");
}
...
TEST(ParserPartition, PatitionOptionsWithLessThan)
{
    ...
    EXPECT_EQ(declare_options_01->changes["engine"]->as<ASTIdentifier>()->fullName(), "engine_name");
    ...
    EXPECT_EQ(declare_partition_02->less_than->as<ASTIdentifier>()->fullName(), "MAXVALUE");
    ASTDeclareOptions * declare_options_02 = declare_partition_02->options->as<ASTDeclareOptions>();
    EXPECT_EQ(declare_options_02->changes["engine"]->as<ASTIdentifier>()->fullName(), "engine_name");
    ...
    EXPECT_EQ(declare_partition_03_argument->children[1]->as<ASTIdentifier>()->fullName(), "MAXVALUE");
    ASTDeclareOptions * declare_options_03 = declare_partition_03->options->as<ASTDeclareOptions>();
    EXPECT_EQ(declare_options_03->changes["engine"]->as<ASTIdentifier>()->fullName(), "engine_name");
    ...
    EXPECT_EQ(declare_partition_04_argument->children[0]->as<ASTIdentifier>()->fullName(), "MAXVALUE");
    EXPECT_EQ(declare_partition_04_argument->children[1]->as<ASTIdentifier>()->fullName(), "MAXVALUE");
    ASTDeclareOptions * declare_options_04 = declare_partition_04->options->as<ASTDeclareOptions>();
    EXPECT_EQ(declare_options_04->changes["engine"]->as<ASTIdentifier>()->fullName(), "engine_name");
}
...
TEST(ParserPartition, PatitionOptionsWithInExpression)
{
    ...
    EXPECT_EQ(declare_partition_01_argument->children[2]->as<ASTIdentifier>()->fullName(), "MAXVALUE");
    ASTDeclareOptions * declare_options_01 = declare_partition_01->options->as<ASTDeclareOptions>();
    EXPECT_EQ(declare_options_01->changes["engine"]->as<ASTIdentifier>()->fullName(), "engine_name");
    ...
    EXPECT_EQ(argument_03->as<ASTExpressionList>()->children[0]->as<ASTIdentifier>()->fullName(), "MAXVALUE");
    EXPECT_EQ(argument_03->as<ASTExpressionList>()->children[1]->as<ASTIdentifier>()->fullName(), "MAXVALUE");
