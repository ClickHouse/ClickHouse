...
TEST(ParserIndex, AllIndexOptions)
{
    ...
    EXPECT_EQ(declare_index->index_columns->children[0]->as<ASTIdentifier>()->fullName(), "col_01");
    ...
    EXPECT_EQ(declare_index->index_columns->children[2]->as<ASTIdentifier>()->fullName(), "col_03");
    ...
    EXPECT_EQ(declare_options->changes["index_type"]->as<ASTIdentifier>()->fullName(), "HASH");
