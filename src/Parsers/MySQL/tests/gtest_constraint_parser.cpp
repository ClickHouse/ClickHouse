...
TEST(ParserConstraint, CheckConstraint)
{
    ...
    EXPECT_EQ(check_expression_01->arguments->children.front()->as<ASTIdentifier>()->name(), "col_01");
    EXPECT_EQ((*std::next(check_expression_01->arguments->children.begin()))->as<ASTLiteral>()->value.safeGet<UInt64>(), 1);
    ...
    EXPECT_EQ(check_expression_02->arguments->children.front()->as<ASTIdentifier>()->name(), "col_01");
    EXPECT_EQ((*std::next(check_expression_02->arguments->children.begin()))->as<ASTLiteral>()->value.safeGet<UInt64>(), 1);
    ...
    EXPECT_EQ(check_expression_03->arguments->children.front()->as<ASTIdentifier>()->name(), "col_01");
    EXPECT_EQ((*std::next(check_expression_03->arguments->children.begin()))->as<ASTLiteral>()->value.safeGet<UInt64>(), 1);
    ...
    EXPECT_EQ(check_expression_04->arguments->children.front()->as<ASTIdentifier>()->name(), "col_01");
    EXPECT_EQ((*std::next(check_expression_04->arguments->children.begin()))->as<ASTLiteral>()->value.safeGet<UInt64>(), 1);
    ...
    EXPECT_EQ(check_expression_05->arguments->children.front()->as<ASTIdentifier>()->name(), "col_01");
    EXPECT_EQ((*std::next(check_expression_05->arguments->children.begin()))->as<ASTLiteral>()->value.safeGet<UInt64>(), 1);
}
