...
TEST(ParserConstraint, CheckConstraint)
{
    ...
    EXPECT_EQ(check_expression_01->arguments->children[0]->as<ASTIdentifier>()->fullName(), "col_01");
    ...
    EXPECT_EQ(check_expression_02->arguments->children[0]->as<ASTIdentifier>()->fullName(), "col_01");
    ...
    EXPECT_EQ(check_expression_03->arguments->children[0]->as<ASTIdentifier>()->fullName(), "col_01");
    ...
    EXPECT_EQ(check_expression_04->arguments->children[0]->as<ASTIdentifier>()->fullName(), "col_01");
    ...
    EXPECT_EQ(check_expression_05->arguments->children[0]->as<ASTIdentifier>()->fullName(), "col_01");
