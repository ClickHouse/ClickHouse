...
TEST(ParserPartitionOptions, HashPatitionOptions)
{
    ...
    EXPECT_EQ(declare_partition_options_01->partition_expression->as<ASTIdentifier>()->fullName(), "col_01");
    ...
    EXPECT_EQ(declare_partition_options_02->partition_expression->as<ASTIdentifier>()->fullName(), "col_01");
}
...
TEST(ParserPartitionOptions, KeyPatitionOptions)
{
    ...
    EXPECT_EQ(columns_list->children[0]->as<ASTIdentifier>()->fullName(), "col_01");
    EXPECT_EQ(columns_list->children[1]->as<ASTIdentifier>()->fullName(), "col_02");
    ...
    EXPECT_EQ(declare_partition_options_03->partition_expression->as<ASTIdentifier>()->fullName(), "col_01");
}
...
TEST(ParserPartitionOptions, PatitionNumberOptions)
{
    ...
    EXPECT_EQ(declare_partition_options->partition_expression->as<ASTIdentifier>()->fullName(), "col_01");
...
TEST(ParserPartitionOptions, PatitionWithSubpartitionOptions)
{
    ...
    EXPECT_EQ(declare_partition_options->subpartition_expression->as<ASTIdentifier>()->fullName(), "col_02");
