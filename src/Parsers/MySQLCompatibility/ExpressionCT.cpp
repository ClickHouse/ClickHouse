...
static String getCHFunctionName(MySQLTree::TOKEN_TYPE operation)
{
	switch (operation)
	{
		case MySQLTree::TOKEN_TYPE::PLUS_OPERATOR:  return "plus";
		case MySQLTree::TOKEN_TYPE::MINUS_OPERATOR: return "minus";
		case MySQLTree::TOKEN_TYPE::MULT_OPERATOR:  return "multiply";
		case MySQLTree::TOKEN_TYPE::DIV_OPERATOR:   return "divide";
		case MySQLTree::TOKEN_TYPE::DIV_SYMBOL:     return "intDiv";
		case MySQLTree::TOKEN_TYPE::MOD_OPERATOR:   return "modulo"; 
		case MySQLTree::TOKEN_TYPE::MOD_SYMBOL:     return "modulo";

		case MySQLTree::TOKEN_TYPE::GREATER_THAN_OPERATOR: return "greater";
		case MySQLTree::TOKEN_TYPE::GREATER_OR_EQUAL_OPERATOR: return "greaterOrEquals";
		case MySQLTree::TOKEN_TYPE::LESS_THAN_OPERATOR: return "less";
		case MySQLTree::TOKEN_TYPE::LESS_OR_EQUAL_OPERATOR: return "lessOrEquals";
		case MySQLTree::TOKEN_TYPE::EQUAL_OPERATOR: return "equals";
		case MySQLTree::TOKEN_TYPE::NOT_EQUAL_OPERATOR: return "notEquals";
		case MySQLTree::TOKEN_TYPE::NULL_SAFE_EQUAL_OPERATOR: return "nullSafeEquals";

		case MySQLTree::TOKEN_TYPE::AND_SYMBOL: return "and";
		case MySQLTree::TOKEN_TYPE::LOGICAL_AND_OPERATOR: return "and";
		case MySQLTree::TOKEN_TYPE::OR_SYMBOL: return "or";
		case MySQLTree::TOKEN_TYPE::LOGICAL_OR_OPERATOR: return "or";
		case MySQLTree::TOKEN_TYPE::XOR_SYMBOL: return "xor";
...
{
	MySQLPtr literal_node = TreePath({
			"nullLiteral"
		}).evaluate(_source);
...
{
	MySQLPtr numeric_node = TreePath({
			"numLiteral"
		}).evaluate(_source);
...
{
	MySQLPtr text_literal = TreePath({
			"textLiteral"
		}).evaluate(_source);
...
bool ExprSimpleCT::setup()
{
	...
	// ( subexpr )
	{
		MySQLPtr expr_list = TreePath({
				"exprList"
			}).evaluate(simple_expr_node, true);
...
bool ExprBoolStatementCT::setup()
{
	...
	MySQLPtr bool_pri_node = TreePath({
			"boolPri"
		}).evaluate(_source);
	...
	{
		// FIXME
		MySQLPtr predicate_ptr = TreePath({
				"predicate",
				"bitExpr"
			}).evaluate(bool_pri_node, true);
