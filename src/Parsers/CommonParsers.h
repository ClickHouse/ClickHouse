...
#define APPLY_FOR_PARSER_KEYWORDS(MR_MACROS) \
    ...
    MR_MACROS(ALTER_TEMPORARY_VIEW, "ALTER TEMPORARY VIEW") \
    ...
    MR_MACROS(CREATE_TEMPORARY_VIEW, "CREATE TEMPORARY VIEW") \
    ...
    MR_MACROS(DROP_TEMPORARY_VIEW, "DROP TEMPORARY VIEW") \
    MR_MACROS(DROP, "DROP") \
    MR_MACROS(ELSE, "ELSE") \
    ...
    MR_MACROS(TEMPORARY_VIEW, "TEMPORARY VIEW") \
