...
#define APPLY_FOR_PARSER_KEYWORDS(MR_MACROS) \
    ...
    MR_MACROS(EXCEPT_DATA_FROM_TABLE, "EXCEPT DATA FROM TABLE") \
    MR_MACROS(EXCEPT_DATA_FROM_TABLES, "EXCEPT DATA FROM TABLES") \
    MR_MACROS(EXCEPT, "EXCEPT") \
    MR_MACROS(EXCHANGE_DICTIONARIES, "EXCHANGE DICTIONARIES") \
    MR_MACROS(EXCHANGE_TABLES, "EXCHANGE TABLES") \
    MR_MACROS(EXCLUDE_CURRENT_ROW, "EXCLUDE CURRENT ROW") \
    MR_MACROS(EXCLUDE_GROUP, "EXCLUDE GROUP") \
    MR_MACROS(EXCLUDE_NO_OTHERS, "EXCLUDE NO OTHERS") \
    MR_MACROS(EXCLUDE_TIES, "EXCLUDE TIES") \
