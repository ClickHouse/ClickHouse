...
#define APPLY_FOR_PARSER_KEYWORDS(MR_MACROS) \
    ...
    MR_MACROS(MATERIALIZE_COLUMNS, "MATERIALIZE COLUMNS") \
    MR_MACROS(MATERIALIZE_INDEX, "MATERIALIZE INDEX") \
    MR_MACROS(MATERIALIZE_INDEXES, "MATERIALIZE INDEXES") \
    MR_MACROS(MATERIALIZE_PROJECTION, "MATERIALIZE PROJECTION") \
    MR_MACROS(MATERIALIZE_PROJECTIONS, "MATERIALIZE PROJECTIONS") \
