...
#define APPLY_FOR_PARSER_KEYWORDS(MR_MACROS) \
    ...
    MR_MACROS(BETWEEN_ASYMMETRIC, "BETWEEN ASYMMETRIC") \
    MR_MACROS(BETWEEN_SYMMETRIC, "BETWEEN SYMMETRIC") \
    ...
    MR_MACROS(NONE, "NONE") \
    MR_MACROS(NOT_BETWEEN_ASYMMETRIC, "NOT BETWEEN ASYMMETRIC") \
    MR_MACROS(NOT_BETWEEN_SYMMETRIC, "NOT BETWEEN SYMMETRIC") \
