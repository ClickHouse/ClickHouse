...
bool ParserCreateAggregateFunctionQuery::parseImpl(IParser::Pos & pos, ASTPtr & node, Expected & expected)
{
    ...
    auto create_function_query = std::make_shared<ASTCreateAggregateFunctionQuery>();
