...
public:
    ...
    /// still binds its own self-reference: only a marked node becomes a recursive CTE in the query tree.
    /// Never set without `cte_name`, which names the recursive CTE table that binding uses.
