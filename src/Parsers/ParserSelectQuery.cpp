...
| [`RENAME`](/reference/statements/select/rename_modifier)   | Changes the output names of columns selected by a column matcher without changing their values, types, expressions, or order. |
