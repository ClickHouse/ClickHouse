...
INSTANTIATE_TEST_SUITE_P(ParserKQLQuery_Datetime, ParserKQLTest,
    ::testing::Combine(
        ...
        },
        {
            ...
            "SELECT CONCAT('67.', toString(substring(toString(toTime(parseDateTime64BestEffortOrNull('0000-00-00 12:30:59.9799', 9, 'UTC'))), 12))) SETTINGS enable_time_time64_type=0"
        },
        {
