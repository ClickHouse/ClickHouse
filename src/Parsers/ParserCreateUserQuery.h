...
/** Parses queries like
  ...
  *     [NOT IDENTIFIED | IDENTIFIED [WITH {no_password|plaintext_password|sha256_password|sha256_hash|double_sha1_password|double_sha1_hash|ldap_server|kerberos_realm}] BY {'password'|'hash'|'server_name'|'realm'}]
