...
ASTPtr ASTCreateAggregateFunctionQuery::clone() const
{
    auto res = std::make_shared<ASTCreateAggregateFunctionQuery>(*this);
    res->children.clear();
...
void ASTCreateAggregateFunctionQuery::formatImpl(WriteBuffer & ostr, const IAST::FormatSettings & settings, IAST::FormatState & state, IAST::FormatStateStacked frame) const
{
...
String ASTCreateAggregateFunctionQuery::getFunctionName() const
{
    String name;
