...
public:
    ...
    struct FormatSettings
    {
        ...
        bool enable_simple_identifiers;
        ...
        explicit FormatSettings(
            ...
            bool enable_simple_identifiers_ = false)
            : ostr(ostr_)
            , one_line(one_line_)
            , hilite(hilite_)
            ...
            , enable_simple_identifiers(enable_simple_identifiers_)
        {
        }
        ...
        FormatSettings(WriteBuffer & ostr_, const FormatSettings & other)
            ...
            , enable_simple_identifiers(other.enable_simple_identifiers)
        {
        }

        void writeIdentifier(const String & name, bool ambiguous) const;
        void validateIdentifier(const String & name) const;
    };
