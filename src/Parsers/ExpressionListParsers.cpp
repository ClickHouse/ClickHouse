...
const std::vector<std::pair<std::string_view, Operator>> ParserExpressionImpl::operators_table
{
    ...
    {toStringView(Keyword::HAS_ALL_TOKENS), Operator("hasAllTokens",    9,  2)},
    {toStringView(Keyword::HAS_ANY_TOKENS), Operator("hasAnyTokens",    9,  2)},
    {toStringView(Keyword::HAS_TOKEN),      Operator("hasToken",        9,  2)},
