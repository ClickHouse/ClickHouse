    ...
    size_t max_parser_backtracks)
{
    ...
    ASTPtr res = tryParseMongoQuery(parser, pos, end, error_message, false, description, allow_multi_statements, max_query_size, max_parser_depth, max_parser_backtracks);
