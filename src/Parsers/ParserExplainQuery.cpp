...
`full_sorting_merge`, `parallel_full_sorting_merge`, `sorted_merge`, and `parallel_sorted_merge` need it
for **both** sides of the `ANY` kinds. The `ALL` kinds need nothing.
