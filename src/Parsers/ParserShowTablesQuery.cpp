...
- [`display_secrets_in_show_and_select`](/reference/settings/server-settings/settings/other#display_secrets_in_show_and_select) (server setting)
- [`format_display_secrets_in_show_and_select` ](/reference/settings/formats/format#format_display_secrets_in_show_and_select) (format setting)
