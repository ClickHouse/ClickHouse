...
#define LIST_OF_SERVER_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(UInt64, max_access_entities_num_to_throw, 0lu, "If number of access entities is greater than this value, server will throw an exception. 0 means no limitation.", 0) \
