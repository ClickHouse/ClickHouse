...
Configured as `named_collections_storage.type` (`<named_collections_storage><type>` in XML).
    ...
    DECLARE(UInt64, query_plan_cache_max_entries, 1024, R"(The maximum number of query plans stored in the cache. 0 means the query plan cache is disabled.)", 0, "query_plan_cache.max_entries") \
