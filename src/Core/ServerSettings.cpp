...
with the MergeTree setting [merge_build_skip_indexes_in_separate_thread](/reference/settings/merge-tree-settings/merge#merge_build_skip_indexes_in_separate_thread).
