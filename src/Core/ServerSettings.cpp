...
#define LIST_OF_SERVER_SETTINGS(DECLARE, ALIAS) \
    ...
    **See also:**
    ...
    DECLARE(String, allowed_disks_for_table_engines, "", "The size of the protected queue (in case of SLRU policy) in the iceberg metadata cache relative to the cache's total size.", 0) \
