...
#define LIST_OF_SERVER_SETTINGS_WITHOUT_PATH(DECLARE, ALIAS) \
    DECLARE(String, insert_deduplication_version, "new_unified_hash", R"(Obsolete setting, does nothing. ClickHouse always uses the unified insert deduplication hash (`new_unified_hash`) for both synchronous and asynchronous inserts.)", SettingsTierType::OBSOLETE) \
