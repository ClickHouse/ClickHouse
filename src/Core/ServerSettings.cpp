...
Applies to plans in the framed format (serialization version 11 and above), which declare their size
...
A plan from a peer below version 11 declares no size and is read field by field as it arrives, so its total
