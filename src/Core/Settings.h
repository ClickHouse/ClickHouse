...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Bool, allow_alter_database_to_drop_and_recreate_if_needed, false, "Whether to drop and recreate the entire database for certain ALTER DATABASE queries (currently MaterializedMySQL only)", 0) \
