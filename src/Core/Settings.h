...
#define COMMON_SETTINGS(M) \
    ...
    M(LogsLevel, send_logs_level, LogsLevel::warning, "Send server text logs with specified minimum level to client. Valid values: 'trace', 'debug', 'information', 'warning', 'error', 'fatal', 'none'", 0) \
