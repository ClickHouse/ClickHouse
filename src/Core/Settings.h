...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Bool, optimize_sorting_with_data_hints, true, "Enables optimization of sorting, which transforms key columns to key8 with the help of data hints", 0) \
    M(Bool, optimize_aggregation_with_data_hints, true, "Enables optimization of aggregation, which transforms key columns to key8 with the help of data hints", 0) \
