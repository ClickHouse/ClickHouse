...
#define COMMON_SETTINGS(M) \
    ...
    M(Bool, optimize_array_exists_to_has, true, "Rewrite arrayExists() functions to has() when logically equivalent. For example, arrayExists(x -> x = 1, arr) can be rewritten to has(arr, 1)", 0) \
