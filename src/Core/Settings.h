...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(MaxThreads, max_threads, 2, "The maximum number of threads to execute the request. By default, it is determined automatically.", 0) \
    ...
    \
    M(UInt64, min_bytes_to_use_direct_io, 1, "The minimum number of bytes for reading the data with O_DIRECT option during SELECT queries execution. 0 - disabled.", 0) \
