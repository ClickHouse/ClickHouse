...
#define COMMON_SETTINGS(M) \
    ...
    M(Bool, optimize_fuse_sum_count_avg, true, "Fuse functions `sum, avg, count` with identical arguments into one `sumCount` (`optimize_syntax_fuse_functions should be enabled)", 0) \
