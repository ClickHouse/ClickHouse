...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Int32, join_to_sort_perkey_rows_threshold, 2, "The lower limit of number of rows to per key in the right table to determine whether to sort it in join.", 0) \
