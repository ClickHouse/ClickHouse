...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Bool, deduplicate_blocks_in_dependent_materialized_views, true, "Should deduplicate blocks for materialized views. Use true to always deduplicate in dependent tables.", 0) \
    ...
    M(Bool, update_insert_deduplication_token_in_dependent_materialized_views, false, "Deprecated.", 0) \
