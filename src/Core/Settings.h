...
#define FORMAT_FACTORY_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, output_format_pretty_max_column_name_width_histeresis, 10, "Histeresis for column name width. If width is greater than max column name width by this value, it will be truncated in the middle", 0) \
