...
#define FORMAT_FACTORY_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, outer_to_inner_join_rewirte, 1, "Use outer join instead of outer join if the expressions could filter NULL. Values: 0 - no rewrite, 1 - rewrite outer join if possible", 0) \
    \
