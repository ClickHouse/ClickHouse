...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Int32, join_to_sort_perkey_rows_threshold, 2, "The lower limit of per-key average rows in the right table to determine whether to sort it in hash join.", 0) \
