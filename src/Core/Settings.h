...
#define FORMAT_FACTORY_SETTINGS(M) \
    ...
    \
    M(BoolFormat, bool_format, FormatSettings::BoolFormat::true_false_lower_case, "Text to represent bool value. Possible values: 'true_false', 'True_False', 'T_F', 'Yes_No', 'Y_N', 'On_Off'.", 0) \
    \
