...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Bool, enable_adaptive_reorder_short_circuit_arguments, true, "Enable reordering the arguments of short-circuit functions adaptively.", 0) \
    M(UInt64, update_short_circuit_arguments_order_every_rows, 65536, "Try to adjust short circuit arguments execution order on every n rows.", 0) \
    \
