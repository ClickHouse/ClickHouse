...
#define FORMAT_FACTORY_SETTINGS(M, ALIAS) \
    ...
    M(Bool, input_format_json_throw_on_duplicated_fields, true, "Throw an exception if there are duplicated fields in JSON object in JSON input formats. If disabled, the first field will be used", 0) \
