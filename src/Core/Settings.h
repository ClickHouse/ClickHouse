...
#define COMMON_SETTINGS(M)                                            \
    ...
    M(SettingSeconds, window_view_heartbeat_interval, DEFAULT_WINDOW_VIEW_HEARTBEAT_INTERVAL_SEC, "The heartbeat interval in seconds to indicate watch query is alive.", 0) \
