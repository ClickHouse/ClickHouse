...
#define COMMON_SETTINGS(M) \
    ...
    M(Seconds, tcp_keep_alive_timeout, DBMS_DEFAULT_RECEIVE_TIMEOUT_SEC, "The time in seconds the connection needs to remain idle before TCP starts sending keepalive probes", 0) \
