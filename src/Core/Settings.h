...
#define COMMON_SETTINGS(M) \
    ...
    \
    M(PreferredBlockSize, preferred_block_size_bytes, 0, "This setting adjusts the data block size for query processing and represents additional fine tune to the more rough 'max_block_size' setting. If the columns are large and with 'max_block_size' rows the block size is likely to be larger than the specified amount of bytes, its size will be lowered for better CPU cache locality. 0 means the automatically determined value will be used.", 0) \
    \
