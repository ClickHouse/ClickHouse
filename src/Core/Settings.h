...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    \
    M(Bool, stop_reading_on_first_cancel, false, "If setting is enabled, pipeline needs to return a result on a partially read table before the query is completely cancelled.", 0) \
