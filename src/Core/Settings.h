...
#define COMMON_SETTINGS(M) \
    ...
    M(UInt64, max_bytes_to_use_mmap_io, (1 * 1024 * 1024 * 1024), "The maximum number of bytes for reading the data with mmap option during SELECT queries execution. 0 - no limit.", 0) \
