...
#define COMMON_SETTINGS(M) \
    ...
    \
    M(String, additional_filters, "", "Additional filter expression which would be applied after reading from specified table. Syntax : 'table1:expression1;database.table2:expression2'", 0) \
    \
