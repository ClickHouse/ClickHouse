...
<<<<<<< HEAD
    ...
    M(Bool, enable_limit_pushdown, false, "Pushes down the limit clauses to the remote shards to minimize the amount of data transferred across network.", 0) \
    M(Float, limit_pushdown_fetch_multiplier, 2.0, "When limit_pushdown is enabled, each remote shard will rank their top (N * limit_pushdown_fetch_multiplie) results and only return those results to the initiator node.", 0) \
=======
    ...
    M(Bool, enable_pushdown_limit_to_shards, false, "Pushes down the limit clauses to the remote shards to minimize the amount of data transferred across network.", 0) \
...
>>>>>>> Refactor limit_pushdown (for remote shards)
