...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Bool, dictionary_validate_id_type, false, "Validate primary key type for dictionaries. By default id type for simple layouts will be implicitly converted to UInt64.", 0) \
    \
