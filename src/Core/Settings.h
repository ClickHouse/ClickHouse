...
#define FORMAT_FACTORY_SETTINGS(M, ALIAS) \
    ...
    M(ParquetVersion, output_format_parquet_version, "v2_latest", "Parquet format version for output format. Supported versions: v1_0, v2_4, v2_6 and v2_latest (default)", 0) \
