...
#define LIST_OF_SETTINGS(M)                                            \
    ...
    M(SettingFloat, group_by_shared_method_proportion_threshold, 0.9, "The proportion of unique keys in which the shared method for aggregation is used. 0 - do not use shared method.", 0) \
