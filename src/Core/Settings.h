...
#define COMMON_SETTINGS(M) \
    ...
    M(Bool, stream_like_engine_allow_direct_select, false, "Allow direct select for Kafka, RabbitMQ and FileLog engines in case there is no attached materialized view", 0) \
    \
