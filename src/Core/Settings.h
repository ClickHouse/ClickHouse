...
#define COMMON_SETTINGS(M) \
    ...
    M(MaxThreads, max_download_threads, 0, "The maximum number of threads to download data (e.g. from s3).", 0) \
    M(UInt64, max_download_buffer_size, 0, "The maximal size of buffer for parallel downloading per thread (e.g. from s3).", 0) \
