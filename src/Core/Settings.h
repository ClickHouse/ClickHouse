...
#define COMMON_SETTINGS(M)                                            \
    ...
    \
    /** FIXME set default_database_engine to Ordinary before merge */ \
    M(SettingDefaultDatabaseEngine, default_database_engine, DefaultDatabaseEngine::Atomic, "Default database engine.", 0) \
