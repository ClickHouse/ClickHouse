...
#define COMMON_SETTINGS(M)                                            \
    ...
    M(SettingUInt64, max_memory_usage_for_session, 0, "Maximum memory usage for processing all concurrently running queries for a user session. Zero means unlimited.", 0) \
