...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Bool, native_protocol_continue_query_on_connection_close, false, "Allow query to continue in the background after connection close in the native protocol", 0) \
