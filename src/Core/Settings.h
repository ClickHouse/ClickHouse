...
#define COMMON_SETTINGS(M) \
    ...
    M(Float, insert_keeper_fault_injection_probability, 0.05f, "Approximate probability of failure for a keeper request during insert. Valid value is in interval [0.0f, 1.0f]", 0) \
