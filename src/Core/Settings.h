...
#define COMMON_SETTINGS(M) \
    ...
    M(Bool, optimize_distributed_aggregation, false, "Enable optimized pipeline for distributed agggreagtion with sort by sublinear monotonic aggreagate function", 0) \
    \
