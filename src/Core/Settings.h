...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Int32, set_zookeeper_xid_value, 1, "Set the initial value of ZooKeeper's xid. This setting is used for testing purposes and not meant to be changed by users.", 0) \
