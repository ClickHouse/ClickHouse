...
#define COMMON_SETTINGS(M) \
    ...
    M(Bool, allow_experimental_exclude_deleted_rows_from_result, false, "Exclude rows that were previously marked as deleted by DELETE statement from results of SELECT.", 0) \
    \
    \
