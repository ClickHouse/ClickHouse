...
#define COMMON_SETTINGS(M) \
    ...
    M(Bool, allow_implicitly_collapse_materialize_mysql_database_sign, true, "Allow to implicitly collapse the sign column in MaterializeMySQL.", 0) \
    M(Bool, allow_implicitly_collapse_materialize_mysql_database_version, true, "Allow to implicitly collapse the version column in MaterializeMySQL.", 0) \
