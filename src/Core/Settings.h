...
#define FORMAT_FACTORY_SETTINGS(M, ALIAS) \
    ...
    M(Bool, output_format_approximate_numbers_with_decimal_point, false, "Always output a decimal_point when printing Float/Decimal values. E.g. 1. instead of 1..", 0) \
    \
