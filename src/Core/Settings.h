...
#define COMMON_SETTINGS(M) \
    ...
    M(UInt64, max_distributed_connections, 1024, "The maximum number of connections for distributed processing of one query (should be greater than max_threads). This setting is ignored when async_socket_for_remote is on.", 0) \
