...
#define FORMAT_FACTORY_SETTINGS(M, ALIAS) \
    ...
    M(Bool, input_format_csv_with_names, false, "Whether get columns names from CSV input file.", 0) \
    M(Bool, input_format_csv_with_types, false, "Whether get columns types from CSV input file.", 0) \
