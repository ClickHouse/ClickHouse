...
static std::map<ClickHouseVersion, SettingsChangesHistory::SettingsChanges> settings_changes_history =
{
    {"24.4", {{"input_format_json_throw_on_bad_escape_sequence", true, true, "Allow to save JSON strings with bad escape sequences"},
              ...
              {"query_plan_optimize_lazy_materialization", true, true, "Add new setting to use query plan for lazy materialization optimisation"},
              {"query_plan_max_limit_for_lazy_materialization", 10, 10, "Add new setting to control maximum limit value that allows to use query plan for lazy materialization optimisation. If zero, there is no limit"},
