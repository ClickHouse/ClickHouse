...
static std::map<ClickHouseVersion, SettingsChangesHistory::SettingsChanges> settings_changes_history =
{
    ...
    {"24.3", {{"s3_connect_timeout_ms", 1000, 1000, "Introduce new dedicated setting for s3 connection timeout"},
              ...
              {"join_right_table_sort_rows_upper_limit", 100000, 100000, "The upper limit of number of rows in the right table to determine whether to sort it in join."},
              {"join_right_table_sort_per_key_rows_lower_limit", 10, 10, "The lower limit of number of rows to per key in the right table to determine whether to sort it in join." },
              }},
