...
static std::map<ClickHouseVersion, SettingsChangesHistory::SettingsChanges> settings_changes_history =
{
    {"24.1", {{"print_pretty_type_names", false, true, "Better user experience."},
              ...
              {"default_materialized_view_sql_security", SQLSecurityType::INVOKER, SQLSecurityType::DEFINER, "Allows to set a default value for SQL SECURITY option when creating a materialized view"},
              {"default_normal_view_sql_security", SQLSecurityType::INVOKER, SQLSecurityType::INVOKER, "Allows to set default `SQL SECURITY` option while creating a normal view"}}},
