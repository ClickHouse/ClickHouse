...
static std::map<ClickHouseVersion, SettingsChangesHistory::SettingsChanges> settings_changes_history =
{
    {"24.5", {{"allow_deprecated_functions", true, false, "Allow usage of deprecated functions"},
              ...
              {"hash_join_compression", false, false, "A new setting."},
              {"hash_join_cache_byte_limit", 125_MiB, 125_MiB, "A new setting."},
              {"hash_join_cache_count_limit", 1024, 1024, "A new setting."},
              }},
