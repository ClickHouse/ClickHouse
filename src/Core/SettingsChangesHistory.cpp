...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"output_format_flatbuffers_string_as_string", false, false, "New setting for the new `Flatbuffers` output format: serialize `String`/`FixedString` columns as FlexBuffers String instead of the default Blob (ClickHouse strings are arbitrary byte sequences, while FlexBuffers String is UTF-8 text)."},
