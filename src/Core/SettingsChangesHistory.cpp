...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"query_plan_window_functions_hash_partitioning", false, false, "New setting to compute aggregate window functions over whole partitions by hashing the partition keys instead of sorting."},
