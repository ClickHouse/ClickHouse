...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"vector_search_min_surviving_pk_fraction", 1.0, 0.5, "New setting: minimum fraction of the marks of a part surviving primary key analysis for the vector similarity index to be used on a partially pruned part. previous_value=1.0 so `compatibility` with versions before 26.8 restores the legacy rule of using the vector index only when the primary key prunes nothing."},
