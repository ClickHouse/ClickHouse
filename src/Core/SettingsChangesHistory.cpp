...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"time_series_selector_relaxed_filtering", false, false, "New setting: allow the timeSeriesSelector table function to skip row-level filtering for whole-metric selectors and rely on primary-key index analysis alone."},
