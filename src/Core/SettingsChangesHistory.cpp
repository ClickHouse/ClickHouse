...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.7",
        {
            ...
            {"query_plan_rewrite_grouped_count_distinct", false, true, "New setting to rewrite a grouped `uniqExact` into a `count` over a deduplicating aggregation when hash-table statistics of a previous run show few group keys."},
