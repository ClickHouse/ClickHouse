...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.6",
        {
            ...
            {"iceberg_parallel_manifest_decode_threads", 1, 1, "New experimental setting controlling the number of threads used to decode Iceberg manifest files in parallel during query planning."},
        });
