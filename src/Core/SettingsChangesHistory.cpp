...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.1",
        {
            ...
            {"allow_nullable_tuple_in_variant_and_dynamic_subcolumn", false, false, "New server setting that controls whether tuple subcolumns of Variant and Dynamic are extracted as Nullable(Tuple(...))."},
