...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"use_paimon_minmax_index_pruning", false, false, "New (experimental) setting to prune Paimon data files using the per-file min/max value statistics recorded in the manifest entries."},
