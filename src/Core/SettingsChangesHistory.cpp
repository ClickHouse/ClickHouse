...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.2",
        {
            ...
            {"semi_join_select_star_compatibility", false, false, "New setting to skip non-preserved side columns in SELECT * for SEMI JOINs"},
            {"anti_join_select_star_compatibility", false, false, "New setting to skip non-preserved side columns in SELECT * for ANTI JOINs"},
        });
