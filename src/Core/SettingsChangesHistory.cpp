...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.9",
        {
            ...
            {"delta_lake_accurate_write_cast", true, true, "New setting (default enabled): cast written values to the Delta write-schema type with an accurate cast that throws on a value that does not fit the target type. Set the setting to 0 explicitly for the plain, silently-truncating cast."},
