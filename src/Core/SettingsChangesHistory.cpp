...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"run_query_in_background", false, false, "New experimental setting to run a query in the background, detached from the connection that submitted it, discarding the result."},
