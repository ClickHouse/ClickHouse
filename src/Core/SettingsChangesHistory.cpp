...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"join_algorithm", "direct,parallel_hash,hash", "direct,parallel_hash,hash", "`hash` and `parallel_hash` are now aliases of the same join class. Listing one or the other does not control how parallel the join is. The default list is unchanged."},
