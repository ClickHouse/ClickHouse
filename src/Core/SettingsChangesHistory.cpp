...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.6",
        {
            ...
            {"text_index_max_cardinality_per_token_for_analysis", 0, 0, "New setting to allow `text` skip-index mark filtering to read uncached posting lists up to the specified per-token cardinality"},
