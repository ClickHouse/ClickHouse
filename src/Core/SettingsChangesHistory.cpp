...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.7",
        {
            ...
            {"allow_experimental_ie_join", false, false, "New experimental setting to execute a JOIN with exactly two inequality conditions in the ON section with the IEJoin algorithm (ALL INNER/LEFT/RIGHT/FULL and SEMI/ANTI LEFT/RIGHT kinds)."},
        });
