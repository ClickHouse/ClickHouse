...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"statistics_cache_max_entries", 1024, 1024, "New setting to cap how many merged part statistics the statistics cache of one query keeps, so a query whose reads never share statistics holds a bounded number of them."},
