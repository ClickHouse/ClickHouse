...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"query_plan_serialization_version", 0, 0, "New setting to pick the query plan serialization version a query writes, for trying a new version before it becomes the default."},
