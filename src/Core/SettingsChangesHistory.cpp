    ...
    {"25.1",
        {
            ...
            {"output_format_parquet_compression_level", 3, 3, "Compression level for Parquet output format. User must know the levels for the compression algorithm being used."},
        }
    },
    {"24.12",
        {
