...
const VersionToSettingsChangesMap & getMergeTreeSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"max_postpone_time_for_failed_merges_ms", 0, 60000, "New setting to postpone failed merges of a non-replicated table with exponential backoff. The previous value disables the backoff, restoring the pre-26.10 behavior of retrying a failed merge immediately."},
        });
