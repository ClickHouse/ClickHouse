...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.1",
        {
            ...
            {"allow_nullable_tuple_in_extracted_subcolumns", false, false, "New server setting that controls whether extracted tuple subcolumns are returned as Nullable(Tuple(...))."},
