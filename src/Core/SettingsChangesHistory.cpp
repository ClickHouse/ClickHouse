...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"force_materialized_cte", false, true, "New setting: throw an exception when a CTE declared AS MATERIALIZED cannot be materialized instead of silently inlining it."},
