...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.4",
        {
            ...
            {"ai_max_concurrent_requests", 16, 16, "New setting"},
            {"ai_max_rps", 50, 50, "New setting"},
            {"ai_max_retries", 3, 3, "New setting"},
            {"ai_retry_initial_delay_ms", 1000, 1000, "New setting"},
            {"ai_cache_ttl_sec", 86400, 86400, "New setting"},
            ...
            {"generateembedding_max_batch_size", 100, 100, "New setting"},
        });
