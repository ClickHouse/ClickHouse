...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.4",
        {
            ...
            {"enable_join_runtime_filter_shared_fixed_hash_table", false, false, "New setting: when the hash join build side converts to a FixedHashMap, share that map as the runtime filter for the probe side (instead of building a separate Set/BloomFilter)."},
