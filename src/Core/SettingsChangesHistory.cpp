...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"use_column_refs_for_primary_key_index_analysis", false, false, "New setting to reference primary key index columns directly during index analysis instead of materializing their values as `Field`."},
