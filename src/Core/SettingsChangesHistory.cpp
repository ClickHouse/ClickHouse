...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"max_bytes_before_external_limit_by", 0, 0, "New setting to enable spilling of the hash-based `LIMIT BY` to disk when memory usage exceeds the given threshold in bytes. If 0, only `max_bytes_ratio_before_external_limit_by` applies."},
            {"max_bytes_ratio_before_external_limit_by", 0., 0.5, "New setting to enable spilling of the hash-based `LIMIT BY` to disk when memory usage exceeds the given ratio of available memory. If 0, only `max_bytes_before_external_limit_by` applies."},
