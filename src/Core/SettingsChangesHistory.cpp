...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"query_cache_herd_wait_timeout", 0, 300, "New setting: maximum wait for concurrent identical queries coalescing on query cache miss. The compatibility value 0 disables coalescing, preserving the pre-26.8 behavior where every concurrent identical query executes."},
