...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.6",
        {
            ...
            {"background_schedule_pool_initial_size", 16, 16, "New setting: obsolete session-level alias of the server setting of the same name (settable in the default profile), consistent with the sibling `background_*_pool_size` settings."},
        });
