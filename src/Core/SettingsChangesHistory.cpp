...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.6",
        {
            ...
            {"input_format_parquet_prefetch_memory_fraction", 0.6, 0.6, "New setting to tune the Parquet reader v3 split of the column-data memory budget between compressed read-ahead and decode."},
            {"input_format_parquet_decode_thread_fraction", 0.375, 0.375, "New setting to tune the Parquet reader v3 share of the parsing thread pool given to column decoding."},
