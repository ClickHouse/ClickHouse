...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"query_plan_hash_join_subset_keys_auto", false, false, "New setting to enable cardinality-based automatic demotion of JOIN equality keys out of the hash table key set. Disabled by default; enable per-query for opt-in experimentation."},
