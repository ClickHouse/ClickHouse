...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"query_plan_join_shard_by_partitions", false, false, "New setting to execute a hash JOIN of two `MergeTree` tables partition by partition when both are partitioned by the same function of the join keys."},
        });
