...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.9",
        {
            ...
            {"input_format_protobuf_datetime64_legacy_seconds", true, false, "From 26.9, integer Protobuf fields mapped to DateTime64 are read as scaled DateTime64 ticks (preserving subseconds). Set this to true (or SET compatibility = '26.8') to restore the pre-26.9 behavior of reading whole Unix seconds. float/double fields always store fractional Unix seconds and are unaffected."},
            {"output_format_protobuf_datetime64_legacy_seconds", true, false, "From 26.9, integer Protobuf fields mapped from DateTime64 are written as scaled DateTime64 ticks (preserving subseconds). Set this to true (or SET compatibility = '26.8') to restore the pre-26.9 behavior of writing whole Unix seconds. float/double fields always store fractional Unix seconds and are unaffected."},
