...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.5",
        {
            ...
            {"output_format_pretty_use_nbsp_for_leading_padding", false, false, "New setting. When enabled, leading padding in Pretty output (row-number indent and indent before grid borders) is rendered with U+00A0 NO-BREAK SPACE so it survives copy-paste through tools that compress runs of regular spaces."},
