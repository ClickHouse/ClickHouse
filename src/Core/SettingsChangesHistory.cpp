...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"mutations_restrict", 0, 0, "New setting: safety catch that rejects mutation-producing `ALTER TABLE` forms (value 1) and lightweight `DELETE`/`UPDATE` (value 2) before they run. Default 0 preserves prior behavior."},
