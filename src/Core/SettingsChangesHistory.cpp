...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"parallel_replicas_plan_based", false, true, "Enable plan-based parallel replicas by default on this experiment branch. previous_value=false so `compatibility` with versions before 26.8 restores the old behavior."},
