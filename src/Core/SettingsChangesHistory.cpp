...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"enable_fast_modify_ttl", false, false, "New setting to accelerate `ALTER TABLE ... MODIFY TTL` by shifting per-part TTL metadata instead of rewriting parts when the new TTL provably differs from the old one by a constant time shift. Disabled by default because the resulting mutation is recorded in an internal form that servers without this feature cannot parse."},
