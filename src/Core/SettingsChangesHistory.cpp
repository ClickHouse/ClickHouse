...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.1",
        {
            ...
            {"distinct_set_limit_for_enabling_bloom_filter", "", 1000000, "New setting."},
            {"distinct_bloom_filter_bytes", "", 524288, "New setting."},
            {"distinct_pass_ratio_threshold_for_disabling_bloom_filter", "", 0.7, "New setting."},
            {"distinct_bloom_filter_max_ratio_of_set_bits", "", 0.7, "New setting."},
