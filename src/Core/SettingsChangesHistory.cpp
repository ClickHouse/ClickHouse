...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.3",
        {
            ...
            {"query_plan_estimate_filter_selectivity_by_sampling", true, true, "Estimate filter selectivity by sampling granules from MergeTree tables to improve join ordering."},
