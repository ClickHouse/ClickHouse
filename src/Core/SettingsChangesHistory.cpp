...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"optimize_rewrite_array_join_filter_to_array_filter", false, true, "New setting to push WHERE predicates on arrayJoin/ARRAY JOIN columns into arrayFilter before array expansion. previous_value=false so `compatibility` with versions before 26.8 restores the pre-existing behavior (no rewrite)."},
