...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.9",
        {
            ...
            {"query_plan_optimize_join_order_use_conflict_detector_c", false, true, "New setting to use the (correct and complete) conflict detector C for join reordering validity in the DPsub join order algorithm. Enabled by default together with the `dpsub` default of `query_plan_optimize_join_order_algorithm`."},
