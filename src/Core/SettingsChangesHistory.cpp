...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"allow_inequality_join_as_cross_join", false, false, "New setting that executes a keyless outer `JOIN` with the hash join over a constant join key, as it was executed before the block nested loop join existed. Kept for comparison; off by default."},
