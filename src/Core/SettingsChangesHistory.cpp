...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"input_format_vortex_filter_push_down", true, true, "New setting to push the WHERE condition down into the Vortex format scan, pruning segments by statistics and decoding only the matching rows."},
