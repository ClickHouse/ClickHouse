...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"max_external_merge_fan_in", 0, 64, "New setting to limit the number of temporary files merged simultaneously for external sorting, including sorting for `full_sorting_merge` JOINs, and external `DISTINCT`. Any remaining in-memory run joins only the final merge and does not count toward this limit. A value of `0` preserves unlimited fan-in."},
