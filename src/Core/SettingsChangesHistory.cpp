...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"output_format_json_type_use_source", false, false, "New setting to write values of the JSON type declared with `with_source=1` as the JSON text stored in the `__source` subcolumn."},
