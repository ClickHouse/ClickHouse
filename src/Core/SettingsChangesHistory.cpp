...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"enable_producing_buckets_out_of_order_in_aggregation", true, false, "Disabled by default because the initiator may lose track of buckets received out of order and merge them incompletely, which produces incorrect results in memory-efficient distributed aggregation."},
