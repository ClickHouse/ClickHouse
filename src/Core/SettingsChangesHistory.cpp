...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.6",
        {
            ...
            {"cast_float_to_decimal_uses_rounding", false, true, "New setting. Float-to-Decimal casts now round to nearest (ties to even) instead of truncating toward zero. Set to false (e.g. via `compatibility`) to restore the previous truncating behavior."},
