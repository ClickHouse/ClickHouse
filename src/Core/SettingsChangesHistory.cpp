...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"iceberg_prefetch_manifest_files", 1, 1, "New setting controlling how many Iceberg manifest files are prefetched concurrently ahead of the manifest file currently being parsed. The default 1 keeps the previously hardcoded single-slot prefetch, so no behavior changes."},
        });
