...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"arrayjoin_nondeterministic_functions_before_expansion", true, false, "A non-deterministic function next to a lowered `arrayJoin` is evaluated once per output row, like with the `ARRAY JOIN` clause. The old evaluation once per source row is behind the setting."},
