...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"parallel_replicas_insert_select_local_pipeline", true, true, "Obsolete setting: a distributed `INSERT SELECT` with parallel replicas always runs the local pipeline on the initiator. Use `parallel_replicas_local_plan` to leave all the reading to the remote replicas instead."},
