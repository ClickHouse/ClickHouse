...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.7",
        {
            ...
            {"query_plan_short_circuit_constant_false_join", true, true, "New setting to short-circuit a JOIN with a constant-false ON condition (or an already-empty input) so the non-contributing side is not read."},
        });
