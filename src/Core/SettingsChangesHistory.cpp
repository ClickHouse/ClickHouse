...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"use_iceberg_partition_pruning", false, true, "Enable partition pruning support for Iceberg tables with partitions."},
        });
        ...
        addSettingsChanges(settings_changes_history, "25.1",
        {
            ...
            {"use_iceberg_partition_pruning", false, false, "Enable partition pruning support for Iceberg tables with partitions."},
