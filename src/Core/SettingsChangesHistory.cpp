...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.9",
        {
            ...
            {"query_plan_propagate_predicate_across_join", false, true, "New setting that copies filter conjuncts across equi-join keys, so that the other side can prune its primary key or read fewer rows into the join."},
