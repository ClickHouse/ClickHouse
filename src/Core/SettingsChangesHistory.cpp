...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.4",
        {
            ...
            {"use_pipelined_mergetree_reader", false, false, "New setting to use pipelined MergeTree reader that splits prewhere and rest column reading into separate pipeline stages."},
        });
