...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.7",
        {
            ...
            {"default_cluster", "default", "default", "New setting for the cluster name used when a query specifies `ON CLUSTER` without a cluster name, and as a fallback for `cluster_for_parallel_replicas` when it is unset."},
        });
