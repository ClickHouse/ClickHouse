...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"insert_expected_table_engine", "", "", "New setting: when not empty, an INSERT is refused unless the target table has exactly this engine."},
            {"insert_expected_column_types", "", "", "New setting: when not empty, an INSERT is refused unless the target table declares exactly these column types."},
