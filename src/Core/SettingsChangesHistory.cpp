...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.9",
        {
            ...
            {"delta_lake_accurate_write_cast", false, true, "New setting: cast values to the Delta write-schema type with an accurate cast that throws on overflow instead of silently truncating (default enabled); `compatibility` below 26.9 selects the plain, silently-truncating cast."},
