...
const VersionToSettingsChangesMap & getMergeTreeSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(merge_tree_settings_changes_history, "26.7",
        {
            ...
            {"shared_merge_tree_merge_coordinator_distribution_algorithm", "water_filling", "water_filling", "New setting which controls what algorithm is used by the merge coordinator to distribute merges between replicas", CompatibilityMode::StartUsingNew},
        });
