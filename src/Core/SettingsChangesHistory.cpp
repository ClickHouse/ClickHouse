...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.7",
        {
            ...
            {"query_plan_hash_join_subset_keys_auto", false, true, "New setting to enable cardinality-based automatic demotion of JOIN equality keys. Enaple by default for CI; enable per-query for opt-in experimentation."},
