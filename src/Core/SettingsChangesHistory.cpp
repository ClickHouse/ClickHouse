...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"query_plan_convert_distinct_to_aggregation", false, true, "New optimization to execute unordered final `DISTINCT` through aggregation without aggregate functions."},
