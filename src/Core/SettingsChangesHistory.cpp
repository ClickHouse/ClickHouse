...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"text_index_like_max_dictionary_tokens_to_scan", 0, 0, "New setting bounding the dictionary tokens that the text index LIKE/ILIKE dictionary scan may match in one data part; 0 keeps the scan unlimited, as before."},
