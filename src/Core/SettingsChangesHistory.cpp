...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"input_format_protobuf_datetime64_legacy_seconds", true, false, "From 26.8, numeric Protobuf fields mapped to DateTime64 are read as scaled DateTime64 ticks (preserving subseconds). Set this to true (or SET compatibility = '26.7') to restore the pre-26.8 behavior of reading Unix seconds (whole seconds for integer fields, fractional seconds for float/double fields)."},
            {"output_format_protobuf_datetime64_legacy_seconds", true, false, "From 26.8, numeric Protobuf fields mapped from DateTime64 are written as scaled DateTime64 ticks (preserving subseconds). Set this to true (or SET compatibility = '26.7') to restore the pre-26.8 behavior of writing Unix seconds (whole seconds for integer fields, fractional seconds for float/double fields)."},
