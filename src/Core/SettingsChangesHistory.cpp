...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.9",
        {
            ...
            {"max_promql_native_parallel_lanes", 0, 0, "New setting to cap native PromQL primary-key range layers; zero preserves the automatic read-stream cap without changing `max_threads`."},
