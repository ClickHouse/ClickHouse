...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"cast_fixed_string_to_string_strip_trailing_zeros", true, false, "The conversion of `FixedString` to `String` keeps the trailing zero bytes instead of removing them."},
