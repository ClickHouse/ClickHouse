...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "25.2",
        {
            ...
            {"s3_check_objects_after_upload_max_attempts", 1, 1, "Max attempts to check with backoff each uploaded object to s3"},
            {"s3_check_objects_after_upload_initial_backoff_ms", 0, 100, "Initial backoff timeout for checking uploaded object to s3"},
            {"azure_check_objects_after_upload_max_attempts", 1, 1, "Max attempts to check with backoff each uploaded object to azure blob storage"},
