...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"enable_database_materialized_postgresql", false, false, "Added an alias for setting `allow_experimental_database_materialized_postgresql`."},
            {"enable_database_hms_catalog", false, false, "Added an alias for setting `allow_experimental_database_hms_catalog`."},
            {"enable_kusto_dialect", false, false, "Added an alias for setting `allow_experimental_kusto_dialect`."},
            {"enable_prql_dialect", false, false, "Added an alias for setting `allow_experimental_prql_dialect`."},
            {"enable_polyglot_dialect", false, false, "Added an alias for setting `allow_experimental_polyglot_dialect`."},
            {"enable_cleanup_old_data_files_compaction", false, false, "Added an alias for setting `allow_experimental_cleanup_old_data_files_compaction`."},
            {"allow_expire_snapshots", false, false, "Added an alias for setting `allow_experimental_expire_snapshots`."},
            {"enable_ytsaurus_table_engine", false, false, "Added an alias for setting `allow_experimental_ytsaurus_table_engine`."},
            {"enable_ytsaurus_table_function", false, false, "Added an alias for setting `allow_experimental_ytsaurus_table_function`."},
            {"enable_ytsaurus_dictionary_source", false, false, "Added an alias for setting `allow_experimental_ytsaurus_dictionary_source`."},
            {"enable_paimon_storage_engine", false, false, "Added an alias for setting `allow_experimental_paimon_storage_engine`."},
            {"enable_object_storage_queue_hive_partitioning", false, false, "Added an alias for setting `allow_experimental_object_storage_queue_hive_partitioning`."},
            {"enable_database_paimon_rest_catalog", false, false, "Added an alias for setting `allow_experimental_database_paimon_rest_catalog`."},
            {"enable_eval_table_function", false, false, "Added an alias for setting `allow_experimental_eval_table_function`."},
