...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.9",
        {
            ...
            {"max_parallel_ordered_merge_materialization_threads", 0, 0, "New setting to control parallel materialization of output blocks in `MergingSorted` and `FinishSorting` query plan steps, including in-order reads, and in sorted coordinator-side `GatherReceive` steps. Full sorting is unaffected."},
