...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.7",
        {
            ...
            {"use_statistics_for_min_max_aggregation", false, true, "New setting to answer filterless `min`/`max` aggregation queries from per-part column statistics (`minmax` or `basic`) without reading column data, as an extension of the implicit `_minmax_count_projection`."},
