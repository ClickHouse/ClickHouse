...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"use_query_condition_cache_for_top_k", true, false, "New setting to gate the query condition cache for `ORDER BY ... LIMIT n` (TopK) reads; disabled by default. previous_value=true because 26.7 shipped these reads participating in the query condition cache unconditionally, so `compatibility` with 26.7 restores that behavior."},
