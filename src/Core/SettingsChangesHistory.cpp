...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "25.8",
        {
            ...
            {"allow_experimental_database_iceberg", false, true, "Added an alias for setting `allow_experimental_database_iceberg`"},
            {"allow_experimental_database_unity_catalog", false, true, "Added an alias for setting `allow_experimental_database_unity_catalog`"},
            {"allow_experimental_database_glue_catalog", false, true, "Added an alias for setting `allow_experimental_database_glue_catalog`"},
            {"allow_database_iceberg", false, true, "Added an alias for setting `allow_experimental_database_iceberg`"},
            {"allow_database_unity_catalog", false, true, "Added an alias for setting `allow_experimental_database_unity_catalog`"},
            {"allow_database_glue_catalog", false, true, "Added an alias for setting `allow_experimental_database_glue_catalog`"},
