...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"exponential_time_decay_aggregate_function_calculation_budget", 0.0, 0.0, "New opt-in approximate calculation budget for mergeable exponential time-decay aggregate functions; disabled by default."},
