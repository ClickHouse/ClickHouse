...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.6",
        {
            ...
            {"allow_drop_detached_table", false, false, "Enable drop detach table."},
            {"allow_experimental_drop_detached_table", false, false, "Enable drop detach table."},
        ...
        addSettingsChanges(settings_changes_history, "26.5",
        {
            ...
            {"allow_experimental_drop_detached_table", false, false, "Enable drop for detached table."},
