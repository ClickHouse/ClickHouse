...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"merge_tree_bound_json_shared_data_path_reads", true, true, "New setting to bound the read of each JSON shared data path to its end in Wide parts, avoiding over-reading into the following paths."},
