...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.9",
        {
            ...
            {"output_format_pretty_highlight_json", false, true, "New setting to highlight JSON syntax (keys, string values, and punctuation) with color, in the Pretty and Vertical output formats, when output is a terminal."},
        });
