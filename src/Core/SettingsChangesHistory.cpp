...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"allow_projection_column_list_in_replicated_metadata", false, false, "New setting to explicitly permit projection column-list syntax in replicated metadata after every replica has been upgraded."},
