...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.7",
        {
            ...
            {"join_runtime_filter_min_probe_rows", 0, 1000, "New setting to control the minimum probe-side size for installing JOIN runtime filters. Previously there was no such threshold, so the previous value is 0, meaning runtime filters were always installed."},
