...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"optimize_string_size_subcolumn_with_full_read", false, false, "New setting to opt in to String size-subcolumn filters when the query also reads the full String."},
