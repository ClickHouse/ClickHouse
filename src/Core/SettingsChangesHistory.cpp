...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        {
            {"query_plan_filter_push_down_inferred_only_for_pruning", true, true, "New setting: add join-key-equivalence inferred filter conditions to the other join side only when index analysis there can use them for pruning."},
