...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.6",
        {
            ...
            {"http_allow_redirects_on_post", false, false, "New setting to accept HTTP 301/302/303 redirect responses as success on POST/PUT requests in URL engine writes; method-preserving 307/308 redirects continue to raise an error since a streamed body cannot be replayed."},
