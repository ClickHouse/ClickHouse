    ...
    {"24.12",
        {
            ...
            {"optimize_extract_common_expressions", false, false, "Optimize WHERE, PREWHERE, ON, HAVING and QUALIFY expressions by extracting common expressions out from disjunction of conjunctions."},
