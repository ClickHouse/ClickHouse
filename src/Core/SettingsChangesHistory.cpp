...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.10",
        {
            ...
            {"ai_function_rerank_default_credentials", "", "", "New setting"},
            {"allow_experimental_ai_rerank_function", false, false, "New experimental setting to enable the `aiRerank` function."},
        });
