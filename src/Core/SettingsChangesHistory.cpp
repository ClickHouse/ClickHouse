...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"input_format_vortex_filter_push_down", true, true, "New setting to push WHERE conditions on top-level integer, floating-point, and string/binary columns down into the Vortex format scan, so that selective queries decode only the matching rows; whole segments are not yet pruned by statistics."},
