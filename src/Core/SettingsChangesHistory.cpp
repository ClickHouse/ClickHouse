...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.6",
        {
            ...
            {"query_plan_optimize_join_order_use_eel_conflict_detector", false, false, "New experimental setting to use the EEL conflict detector for outer-join reordering validity in the DPsub join order algorithm."},
        });
