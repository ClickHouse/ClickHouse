...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.9",
        {
            ...
            {"max_bytes_ratio_before_external_join", 0., 0., "Retrospectively disable automatic spilling, because it interferes with read-in-order-through-join optimization."},
