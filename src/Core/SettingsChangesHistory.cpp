...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"date_time_64_output_format_cut_trailing_zeros_align_to_groups_of_thousands", false, false, "The trimmed output scale widened from [0, 3, 6] to [0, 3, 6, 9], so a `DateTime64` or `Time64` value with scale 7 to 9 no longer loses the digits past the sixth. The default is unchanged; this row records the semantics change for the compatibility audit path."},
        });
