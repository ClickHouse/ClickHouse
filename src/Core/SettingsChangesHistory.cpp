...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.7",
        {
            ...
            {"lance_enable_fragment_parallelism", false, true, "New setting to split Lance datasets into fragment packs for multi-stream ClickHouse reads."},
            {"lance_fragment_pack_mode", "auto", "auto", "New setting for Lance fragment packing mode (one/pack/auto)."},
            {"lance_max_fragment_packs", 0, 0, "New setting for the maximum number of Lance fragment packs (0 = align with max_threads)."},
            {"lance_min_rows_per_pack", 0, 0, "New setting for the soft minimum rows per Lance fragment pack (0 = ignore)."},
            {"lance_min_bytes_per_pack", 0, 0, "New setting for the soft minimum bytes per Lance fragment pack (0 = ignore)."},
