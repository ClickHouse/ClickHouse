...
IMPLEMENT_SETTING_ENUM(ObjectStorageQueueBucketAssignmentStrategy, ErrorCodes::BAD_ARGUMENTS,
    {{"path", ObjectStorageQueueBucketAssignmentStrategy::PATH},
     {"PATH", ObjectStorageQueueBucketAssignmentStrategy::PATH},
     {"partition", ObjectStorageQueueBucketAssignmentStrategy::PARTITION},
     {"PARTITION", ObjectStorageQueueBucketAssignmentStrategy::PARTITION}})
