...
#define SERVER_SETTINGS(M, ALIAS) \
    ...
    M(Double, background_part_check_time_to_total_time_ratio, 0.01, "Ratio of time spent by background check to total time spent on part checks. 0.01 means background checks can't spent more than 1% of time for part checks", 0)
