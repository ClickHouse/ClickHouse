...
#define SERVER_SETTINGS(M, ALIAS) \
    ...
    M(String, skipping_index_cache_policy, DEFAULT_SKIPPING_INDEX_CACHE_POLICY, "Skipping index granule cache policy name.", 0) \
    M(UInt64, skipping_index_cache_size, DEFAULT_SKIPPING_INDEX_CACHE_MAX_SIZE, "Size of the skipping index cache in bytes.", 0) \
