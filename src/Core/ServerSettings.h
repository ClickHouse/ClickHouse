...
#define SERVER_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, max_active_parts_loading_thread_pool_size, 32, "The maximum number of threads that would be used for loading outdated data parts on startup", 0) \
    M(UInt64, max_outdated_parts_loading_thread_pool_size, 64, "The maximum number of threads that would be used for loading outdated data parts on startup", 0) \
    M(UInt64, max_parts_cleaning_thread_pool_size, 64, "The maximum number of threads that would be used for loading outdated data parts on startup", 0) \
