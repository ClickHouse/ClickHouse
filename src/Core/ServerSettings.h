...
#define SERVER_SETTINGS(M, ALIAS) \
    ...
    M(String, shutdown_wait_unfinished_query_kind, "", "Query kind for which shutdown_wait_unfinished_queries will be applied. Empty string means wait for all query kinds.", 0) \
