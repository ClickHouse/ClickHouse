...
#define SERVER_SETTINGS(M, ALIAS) \
    ...
    M(Bool, page_cache_use_madv_free, true, "If true, the userspace page cache will allow the OS to automatically reclaim memory from the cache on memory pressure (using MADV_FREE).", 0) \
