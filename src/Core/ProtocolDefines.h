...
/// Zero omits the setting and preserves unlimited merging. Nonzero values require a reader that
/// knows the setting; older readers reject the unknown name before reading its value.
