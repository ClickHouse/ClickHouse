...
/// Version 8 serializes the plan-level `max_threads` and `concurrency_control` fields. They are not
...
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_EXECUTION_LIMITS = 8;
