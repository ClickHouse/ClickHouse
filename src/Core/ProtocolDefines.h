...
/// Version 21 registers the `max_streams_per_hierarchical_merge_for_validation` plan setting. The
...
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_HIERARCHICAL_MERGE_VALIDATION = 21;
