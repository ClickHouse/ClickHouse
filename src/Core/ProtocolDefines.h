...
/// Version 3 serializes shard-limit and distributed top-K candidate markers in `LimitStep`.
static constexpr auto DBMS_QUERY_PLAN_SERIALIZATION_VERSION_WITH_SHARD_LIMIT = 3;
static constexpr auto DBMS_QUERY_PLAN_SERIALIZATION_VERSION = DBMS_QUERY_PLAN_SERIALIZATION_VERSION_WITH_SHARD_LIMIT;
...
static constexpr auto DBMS_MIN_PROTOCOL_VERSION_WITH_QUERY_COORDINATION = 54487;
