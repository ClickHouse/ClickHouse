...
/// Version 16 appends the aggregate-tree frame threshold to `WindowStep`. Below this version the field
...
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_WINDOW_AGGREGATE_TREE_THRESHOLD = 16;
