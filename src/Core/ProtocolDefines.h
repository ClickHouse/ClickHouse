...
static constexpr auto DBMS_PARALLEL_REPLICAS_MIN_VERSION_WITH_TOTAL_MARKS_IN_PART = 8;
static constexpr auto DBMS_PARALLEL_REPLICAS_MIN_VERSION_WITH_PART_FINGERPRINT = 9;
static constexpr auto DBMS_PARALLEL_REPLICAS_PROTOCOL_VERSION = 9;
