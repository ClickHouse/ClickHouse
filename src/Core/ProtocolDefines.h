...
static constexpr auto DBMS_CLUSTER_PROCESSING_PROTOCOL_VERSION_WITH_ICEBERG_IDENTITY_PARTITION_PATHS = 11;
static constexpr auto DBMS_CLUSTER_PROCESSING_PROTOCOL_VERSION
    = DBMS_CLUSTER_PROCESSING_PROTOCOL_VERSION_WITH_ICEBERG_IDENTITY_PARTITION_PATHS;
