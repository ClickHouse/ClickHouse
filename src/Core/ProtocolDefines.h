...
/// Version 11 registers the `spill_codec_authorized` plan setting for temporary-file codecs. A peer
...
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_EXPERIMENTAL_SPILL_CODEC = 11;
