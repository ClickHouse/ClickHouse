...
/// Serialize the semantic flags of a `singleValueOrNull` state, so that its result remains
/// unchanged after crossing a serialization boundary.
static constexpr auto DBMS_MIN_REVISION_WITH_SINGLE_VALUE_OR_NULL_STATE_VERSION = 54493;
