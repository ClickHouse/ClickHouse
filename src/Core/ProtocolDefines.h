...
/// Version 14 adds the per-step security-barrier flag that keeps plan optimizations from crossing the
...
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_SECURITY_BARRIER = 14;
