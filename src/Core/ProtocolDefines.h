...
/// Version 16 preserves aggregation state byte limits and the associated limit errors.
...
/// First query-plan serialization version with aggregation state byte limits and limit errors.
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_AGGREGATION_LIMITS = 16;
