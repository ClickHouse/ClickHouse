...
/// Version 19 adds the `array_join_use_nulls` flag (bit 32) on a serialized `ArrayJoinStep`.
...
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_ARRAY_JOIN_USE_NULLS = 19;
