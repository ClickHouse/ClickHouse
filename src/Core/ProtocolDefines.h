...
/// Preserve whether an unlimited `groupConcat` state contains rows when its payload
/// is empty.
static constexpr auto DBMS_MIN_REVISION_WITH_GROUP_CONCAT_STATE_VERSION = 54493;
