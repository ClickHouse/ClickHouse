...
/// Version 12 adds the `only_merge` flag (bit 128) on `AggregatingStep`, set on the merge step
...
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_ONLY_MERGE_AGGREGATION = 12;
