...
/// Version 11 adds the `GROUP BY` top-K parameters payload to the `Aggregating` step, so the
...
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_GROUP_BY_TOP_K = 11;
