...
static constexpr auto DBMS_CLUSTER_PROCESSING_PROTOCOL_VERSION_ICEBERG_SPECIFIC = 3;
static constexpr auto DBMS_CLUSTER_PROCESSING_PROTOCOL_VERSION = DBMS_CLUSTER_PROCESSING_PROTOCOL_VERSION_ICEBERG_SPECIFIC;
