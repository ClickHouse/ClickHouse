...
/// Version 10 adds the `IntervalKind` of INTERVAL offsets in the `WindowStep` frame.
...
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_WINDOW_FRAME_INTERVAL = 10;
