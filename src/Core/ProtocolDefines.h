...
/// First global query-plan version that writes version 1 of `Join`, adding the multiset flag of the join
/// operator (see `JoinOperator::multiset`).
static constexpr auto DBMS_MIN_QUERY_PLAN_SERIALIZATION_VERSION_WITH_MULTISET_JOIN = 19;
