...
const std::optional<ColumnWithTypeAndName> Block::findSubcolumnByName(const std::string & name) const
{
...
const std::optional<ColumnWithTypeAndName> Block::findColumnOrSubcolumnByName(const std::string & name) const
{
