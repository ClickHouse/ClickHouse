...
bool Field::operator< (const Field & rhs) const
{
    ...
    switch (which)
    {
        ...
        case Types::Version: return get<Version>() < rhs.get<Version>();
        case Types::Float64:
...
bool Field::operator<= (const Field & rhs) const
{
    ...
    switch (which)
    {
        ...
        case Types::IPv4:    return get<IPv4>()    <= rhs.get<IPv4>();
        case Types::IPv6:    return get<IPv6>()    <= rhs.get<IPv6>();
        case Types::Version: return get<Version>().toUnderType() <= rhs.get<Version>().toUnderType();
        case Types::Float64:
        {
            static constexpr int nan_direction_hint = 1; /// Put NaN at the end
...
std::string_view fieldTypeToString(Field::Types::Which type)
{
    switch (type)
    {
        ...
        case Field::Types::Which::Version: return "Version"sv;
...
template NearestFieldType<std::decay_t<Version>> & Field::safeGet<Version>() &;
