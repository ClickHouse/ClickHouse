...
Defines the behavior when [Date](/reference/data-types/date), [Date32](/reference/data-types/date32), [DateTime](/reference/data-types/datetime), [DateTime64](/reference/data-types/datetime64) or [Time](/sql-reference/data-types/time) are converted into Date, Date32, DateTime, DateTime64 or Time, or a number is converted into Date, Date32, DateTime or Time, but the value cannot be represented in the result type.
