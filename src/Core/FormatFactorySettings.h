...
Defines the behavior when [Date](/reference/data-types/date), [Date32](/reference/data-types/date32), [DateTime](/reference/data-types/datetime), [DateTime64](/reference/data-types/datetime64), integers or strings are converted into Date, Date32, DateTime or DateTime64 but the value cannot be represented in the result type. This also applies when a text input format parses a column declared as one of these types.
