...
0 means no limit in bytes.
    ...
    DECLARE(String, diagram_output_format_diagram_type, "SCATTER", "The type of diagram", 0) \
    DECLARE(String, diagram_output_format_title, "", "The title of plot", 0) \
    DECLARE(Bool, diagram_output_format_is_ascii_set, false, "Charset for printing plot. Available charsets: ASCII, UTF-8 (default one).", 0) \
    DECLARE(Int64, diagram_output_format_limit_height, -1, "Limit num of rows in plot", 0) \
    DECLARE(Int64, diagram_output_format_limit_width, -1, "Limit num of columns in plot", 0) \
