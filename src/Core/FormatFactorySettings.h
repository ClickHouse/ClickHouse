...
Defines the behavior when a [Date](/reference/data-types/date), [Date32](/reference/data-types/date32), [DateTime](/reference/data-types/datetime), [DateTime64](/reference/data-types/datetime64), [Time](/reference/data-types/time), [Time64](/reference/data-types/time64), integer or floating-point value is converted into `Date`, `Date32`, `DateTime`, `DateTime64`, `Time` or `Time64` but the value cannot be represented in the result type. It also applies when a `Date` or `DateTime` is parsed from text, including by an input format. Conversion of `BFloat16` to `DateTime64` or `Time64` is not supported at all, so the setting does not apply to it.
