...
Enables or disables the initialization of [NULL](/sql-reference/syntax#literals) fields with [default values](/sql-reference/statements/create/table#default-values), if data type of these fields is not [nullable](/sql-reference/data-types/nullable).
