...
static constexpr auto DEFAULT_QUERY_RESULT_CACHE_MAX_ENTRY_CHUNKS = 8192uz;
static constexpr size_t DEFAULT_QUERY_RESULT_CACHE_MAX_QUERY_STRING_SIZE = 256 * 1024; /// 256 KB
static constexpr size_t DEFAULT_QUERY_RESULT_CACHE_MAX_QUERY_ID_SIZE = 1024;           /// 1 KB
static constexpr size_t DEFAULT_QUERY_RESULT_CACHE_MAX_TAG_SIZE = 1024;                /// 1 KB
