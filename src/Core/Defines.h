...
static constexpr auto DEFAULT_ORC_METADATA_CACHE_POLICY = "SLRU";
static constexpr auto DEFAULT_ORC_METADATA_CACHE_MAX_SIZE = 512_MiB;
static constexpr auto DEFAULT_ORC_METADATA_CACHE_SIZE_RATIO = 0.5;
static constexpr auto DEFAULT_ORC_METADATA_CACHE_MAX_ENTRIES = 5000;
