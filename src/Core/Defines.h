...
static constexpr auto DEFAULT_STATISTICS_CACHE_POLICY = "SLRU";
static constexpr auto DEFAULT_STATISTICS_CACHE_MAX_SIZE = 1_GiB;
static constexpr auto DEFAULT_STATISTICS_CACHE_SIZE_RATIO = 0.5l;
