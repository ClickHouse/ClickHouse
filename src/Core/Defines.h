...
static constexpr auto DEFAULT_MULTI_SEARCH_AUTOMATON_CACHE_MAX_SIZE = 256_MiB;
static constexpr auto DEFAULT_MULTI_SEARCH_AUTOMATON_CACHE_MAX_ENTRIES = 1'000;
