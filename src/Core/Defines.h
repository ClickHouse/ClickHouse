...
/** Which blocks by default read the data (by number of rows).
  ...
  */
#define DEFAULT_BLOCK_SIZE 65473 /// 65536 minus 16 + 15 bytes padding that we usually have in arrays
...
/** Which blocks should be formed for insertion into the table, if we control the formation of blocks.
  ...
  */
#define DEFAULT_INSERT_BLOCK_SIZE 1048513 /// 1048576 minus 16 + 15 bytes padding that we usually have in arrays
