...
namespace BinlogEvent
{
    ...
    {
    public:
        IBinlogEvent() = default;

        virtual bool isValid();

        virtual void parse(ReadBuffer & payload);

        virtual ~IBinlogEvent();
    };

    class SampleEvent : public IBinlogEvent
    {
    public:
        SampleEvent() = default;
    };
    ...
    public:
        ...
        virtual BinlogEventPtr readBinlogEvent(ReadBuffer & payload);
    ...
    public:
        ...
        BinlogEventPtr  readBinlogEvent(ReadBuffer & payload) override
        {
            UInt16 header = 0;
            payload.readStrict(reinterpret_cast<char *>(&header), 1);
            switch (header)
