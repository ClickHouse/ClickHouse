...
From v25.4, when using `parallel_distributed_insert_select = 2` to read from a `ReplicatedMergeTree` or `SharedMergeTree` source table, `enable_parallel_replicas = 1` is also required.
)", 0) \
