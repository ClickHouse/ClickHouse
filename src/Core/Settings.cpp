...
Maximum number of HTTP requests that AI functions may dispatch per query. This is a hard cap: the total number of requests across the whole query - including all AI functionsdw it contains. Set to 0 to disable.
)", EXPERIMENTAL) \
