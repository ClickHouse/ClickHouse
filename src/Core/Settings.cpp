...
Such an inferred condition is redundant for correctness. With this setting enabled the inferred
copy is added only when index analysis on the receiving side (primary key, partition key,
