...
It currently cannot stop during merging of aggregation states. During query analysis it stops only
while collecting typo correction hints for an unresolved identifier, so the actual run time will be
higher than the value of this setting.
:::
)", 0) \
