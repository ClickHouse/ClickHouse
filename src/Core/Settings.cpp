...
In particular, when the right table is reranged, `joined_block_split_single_row` has no effect, so `max_joined_block_size_rows` does not bound the number of rows produced for a single left row.
