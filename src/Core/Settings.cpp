...
Use query plan for lazy materialization optimization.
    ...
    DECLARE(Bool, query_plan_use_new_logical_join_step, true, "*Deprecated*, same as `query_plan_use_logical_join_step`.", 0) \
    DECLARE(Bool, query_plan_use_logical_join_step, true, "Use logical join step in query plan.", 0) \
