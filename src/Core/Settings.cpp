...
- [`min_insert_block_size_rows`](#min_insert_block_size_rows)
    ...
    DECLARE(UInt64, function_generate_date_array_max_elements_in_block, 500000000, R"(
Sets the safety threshold for data volume generated by function [generate_date_array](/sql-reference/functions/array-functions#generate_date_array). Defines the maximum number of values generated by function per block of data (sum of array sizes for every row in a block).
