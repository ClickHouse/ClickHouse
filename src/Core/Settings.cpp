...
Allow parsing Iceberg `geometry` and `geography` field types as ClickHouse `Geometry` (Variant) type.
    ...
    DECLARE_WITH_ALIAS(Bool, show_external_databases_in_system_tables, false, R"(
Enables showing external databases (data lake catalogs, MySQL, PostgreSQL) in system tables.
