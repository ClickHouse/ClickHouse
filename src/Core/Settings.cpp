...
Not required to `ATTACH` such a table, to create one with an explicit column list, to read the columns
already stored for an attached table, or to inspect a schema through a data lake catalog.
)", 0) \
