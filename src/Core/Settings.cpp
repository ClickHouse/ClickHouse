...
Disable limit on kafka_num_consumers that depends on the number of available CPU cores.
    ...
    DECLARE(Bool, allow_experimental_sql_handlers, false, R"(
Allow experimental SQL-based HTTP handler management via CREATE HANDLER, ALTER HANDLER, and DROP HANDLER queries
)", EXPERIMENTAL) \
