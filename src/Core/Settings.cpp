...
When enabled with the analyzer, `SEMI` JOIN restricts column access to the preserved side per SQL standard.
...
When enabled with the analyzer, `ANTI` JOIN restricts column access to the preserved side per SQL standard.
