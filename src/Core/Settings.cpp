...
/// TODO: Find a way to introduce CLASS_NAME (to replace 'Settings')
#define DECLARE_SETTINGS_EXTERN(TYPE, NAME, DEFAULT, DESCRIPTION, FLAGS) \
    Settings ## TYPE NAME = & Settings ## Impl :: NAME;

LIST_OF_SETTINGS(DECLARE_SETTINGS_EXTERN, SKIP_ALIAS)
