...
- `0` — Disable thundering herd coalescing. Each concurrent identical query executes independently, as before this feature was introduced. This is the compatibility value for versions before 26.9.
