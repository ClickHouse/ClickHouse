...
This setting is honored only by the `hash`, `parallel_hash`, `ie_join`, and
`band_join` [`join_algorithm`](/reference/settings/session-settings/join#join_algorithm) values. Other
