...
Minimum number of out streams per Resize/StrictResize processor if the original one is split. If the number of streams is less than this value, the merge operation will not split the streams.
)", 0) \
    \
    /* ####################################################### */ \
