...
/** Adapts a query translated from Mongo to the shape of the collection it reads, and answers whether
  * that collection keeps whole documents. A query over a collection of documents addresses every
  * field as a path of the document column; over a table with columns of its own it is left as it is,
  * because a field names the column of the same name there.
  *
