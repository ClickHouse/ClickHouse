...
| JSON(max_dynamic_paths=N, max_dynamic_types=M, path Type, SKIP skip_path, SKIP REGEXP skip_path_regexp) | 0x30<uint8_serialization_version>[<bool_with_source>]<var_int_max_dynamic_paths><uint8_max_dynamic_types><var_uint_number_of_typed_paths><var_uint_path_name_size_1><path_name_data_1><encoded_type_1>...<var_uint_number_of_skip_paths><var_uint_skip_path_size_1><skip_path_data_1>...<var_uint_number_of_skip_path_regexps><var_uint_skip_path_regexp_size_1><skip_path_data_regexp_1>... |
| BFloat16                                                                                                | 0x31                                                                                                                                                                                                                                                                                                                                                                     |
| Time                                                                                                    | 0x32                                                                                                                                                                                                                                                                                                                                                                     |
...
For type JSON `uint8_serialization_version` is 1 for types declared with `with_source=1` and 0 for all other types: a type is always encoded with the oldest version that can represent it, so encodings of types without new arguments stay unchanged. Since version 1 the version is followed by the `bool_with_source` byte; version 0 doesn't have it.
