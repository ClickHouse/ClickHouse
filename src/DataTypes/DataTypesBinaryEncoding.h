...
| JSON(max_dynamic_paths=N, max_dynamic_types=M, path Type, SKIP skip_path, SKIP REGEXP skip_path_regexp, SHARED REGEXP shared_path_regexp) | 0x30<uint8_serialization_version><var_uint_max_dynamic_paths><uint8_max_dynamic_types><var_uint_number_of_typed_paths><var_uint_path_name_size_1><path_name_data_1><encoded_type_1>...<var_uint_number_of_skip_paths><var_uint_skip_path_size_1><skip_path_data_1>...<var_uint_number_of_skip_path_regexps><var_uint_skip_path_regexp_size_1><skip_path_data_regexp_1>...<var_uint_number_of_shared_path_regexps><uint8_shared_path_regexp_match_mode_1><var_uint_shared_path_regexp_size_1><shared_path_regexp_data_1>...<var_uint_shared_path_prefix_size><shared_path_prefix_data> |
| BFloat16                                                                                                | 0x31                                                                                                                                                                                                                                                                                                                                                                     |
| Time                                                                                                    | 0x32                                                                                                                                                                                                                                                                                                                                                                     |
