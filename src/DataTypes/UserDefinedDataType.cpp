...
ASTPtr UserDefinedDataType::getInputFunction() const
{
    return input_function;
}

ASTPtr UserDefinedDataType::getOutputFunction() const
{
...
void UserDefinedDataType::setInputFunction(const ASTPtr & function)
{
    input_function = function;
}

void UserDefinedDataType::setOutputFunction(const ASTPtr & function)
{
