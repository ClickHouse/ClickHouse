...
When [flatten_nested](/reference/settings/session-settings/other#flatten_nested) is set to `0` (which is not by default), arbitrary levels of nesting are supported.
