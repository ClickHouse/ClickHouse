...
public:
        ...
        std::unique_ptr<JSONExtractTreeNode<Parser>> json_extract_tree_)
    {
        ...
        return std::shared_ptr<ISerialization>(new SerializationJSON(typed_paths_types_, typed_paths_serializations_, paths_to_skip_, path_regexps_to_skip_, dynamic_type_, dynamic_serialization_, default_path_type_, std::move(json_extract_tree_)));
    }
