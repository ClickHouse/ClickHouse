...
public:
    ...
    static void serializeVariantForHashCalculation(const IColumn & column, const SerializationPtr & serialization, const String & type_name, size_t row_num, WriteBuffer & ostr);
