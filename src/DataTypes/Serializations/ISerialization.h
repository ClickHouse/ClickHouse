...
public:
    ...
    struct SubstreamData
    {
        ...
        /// Whether this is the sizes of an `Array` (a `Map` shares the substream), which the name of
        /// a subcolumn alone cannot tell. Set by `SerializationArray::enumerateStreams` and kept by
        /// the resolvers that rebuild the data of a nested subcolumn on the way back.
        bool is_array_sizes = false;
    };
