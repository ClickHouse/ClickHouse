...
public:
    ...
    /// When T cannot be inside Variant (Nullable/Dynamic/Variant/Object), the runtime path is
    /// Variant(None): a sparse marker where the actual values live in shared data.
