...
void BackupReaderS3::copyFileToDisk(
    ...
    WriteMode write_mode)
{
        ...
        && (destination_data_source_description.is_encrypted == encrypted_in_backup))
    {
        ...
        auto write_blob_function
            = [&](const Strings & blob_path, WriteMode mode, const std::optional<ObjectAttributes> & object_attributes) -> size_t
        {
...
void BackupWriterS3::copyDataToFile(
    const String & path_in_backup, const CreateReadBufferFunction & create_read_buffer, UInt64 start_pos, UInt64 length)
{
    copyDataToS3File(
        create_read_buffer,
        start_pos,
