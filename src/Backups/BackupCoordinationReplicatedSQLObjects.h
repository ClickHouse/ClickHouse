...
///
/// For example, let's consider three replicas having access to the user-defined function `f1` and `f2`.
...
/// and the following files will be the same too
/// /shards/1/replicas/1/data/system/functions/f2.sql
/// /shards/1/replicas/2/data/system/functions/f2.sql
/// /shards/1/replicas/3/data/system/functions/f2.sql
///
