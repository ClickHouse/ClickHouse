...
{
public:
    explicit BackupReaderFile(const std::filesystem::path & root_path_, const ReadSettings & read_settings_, const WriteSettings & write_settings_);
...
{
public:
    BackupWriterFile(const std::filesystem::path & root_path_, const ReadSettings & read_settings_, const WriteSettings & write_settings_);
