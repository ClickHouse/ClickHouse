...
void registerBackupEnginesFileAndDisk(BackupFactory & factory)
{
    ...
    factory.registerBackupEngine("File", creator_fn, getLocalDestinationIdentity, [](BackupInfo &, ContextPtr) {}, [](const BackupInfo &, BackupInfo &, ContextPtr) { return false; });
    factory.registerBackupEngine("Disk", creator_fn, getLocalDestinationIdentity, [](BackupInfo &, ContextPtr) {}, [](const BackupInfo &, BackupInfo &, ContextPtr) { return false; });
}
