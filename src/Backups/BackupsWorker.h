...
{
public:
    BackupsWorker(ContextPtr global_context, const String & engine, size_t num_backup_threads, size_t num_restore_threads, bool allow_concurrent_backups_, bool allow_concurrent_restores_, bool create_storage, bool is_special_storage);
