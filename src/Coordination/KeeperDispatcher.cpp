...
namespace ProfileEvents
{
    ...
    extern const Event KeeperRequestRejectedForExceedingMemorySoftLimit;
}
    ...
    while (!shutdown_called)
    {
        ...
        try
        {
            if (requests_queue->tryPop(request, max_wait))
            {
                ...
                {
                    ProfileEvents::increment(ProfileEvents::KeeperRequestRejectedForExceedingMemorySoftLimit);
                    LOG_WARNING(
                        log,
