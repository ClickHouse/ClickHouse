...
std::vector<std::pair<std::string, Int32>> KeeperServer::getContainerCandidatesForGarbageCollector(size_t batch_size) const
{
    return state_machine->getContainerCandidatesForGarbageCollector(batch_size);
}
