...
#define LIST_OF_COORDINATION_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, disk_move_verify_destination_digest, false, "Read back and verify the complete destination file after a cross-disk Keeper move. Disabled by default because it adds a full destination read.", 0) \
