...
#define LIST_OF_COORDINATION_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, experimental_use_rocksdb, false, "Deprecated and ignored. RocksDB storage support has been removed from Keeper; this setting has no effect.", 0) \
    DECLARE(UInt64, rocksdb_load_batch_size, 1000, "Deprecated and ignored. RocksDB storage support has been removed from Keeper; this setting has no effect.", 0) \
