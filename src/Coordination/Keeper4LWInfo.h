...
struct Keeper4LWInfo
{
    ...
    /// Whether the leader is slowing down for replicas that cannot keep up,
    /// according to the local Raft parameters. Only the leader's copy has any
    /// effect, but every node reports its own.
