...
/**
  ...
  * suffix), bounded by latest_logs_cache_size_threshold, which is charged in `cachedLogEntryBytes`,
  * that is resident bytes rather than payload bytes; once persisted, its location is recorded
