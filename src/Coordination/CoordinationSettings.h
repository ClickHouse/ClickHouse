...
#define LIST_OF_COORDINATION_SETTINGS(M) \
    ...
    M(Milliseconds, leadership_expiry, 10000, "How often will leader node check if it still has majority. Set it lower or equal to election_timeout_lower_bound_ms to have linearizable reads.", 0) \
