...
#define LIST_OF_COORDINATION_SETTINGS(M) \
    ...
    M(UInt64, max_log_file_size, 50 * 1024 * 1024, "Max size of the Raft log file. If possible, each created log file will preallocate this amount of bytes on disk. Set to 0 to disable the check", 0)
