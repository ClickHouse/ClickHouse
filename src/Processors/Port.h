...
protected:
    ...
    public:
        ...
        public:
            ...
            {
                if ((getUInt(data) & FLAGS_MASK) != 0) [[unlikely]]
...
public:
    ...
    Data ALWAYS_INLINE pullData(bool set_not_needed = false)
    {
        ...
        if (!data->exception && data->chunk.getNumColumns() != header.columns()) [[unlikely]]
        {
...
public:
    ...
    {
        if (!data_.exception && data_.chunk.getNumColumns() != header.columns()) [[unlikely]]
        {
