...
public:
    ...
    const char * getName() const override { return "StatelessAggregatingSortedAlgorithm"; }
    ...
    public:
        StatelessAggregatingMergedData(MutableColumns columns_, UInt64 max_block_size_rows, UInt64 max_block_size_bytes_, ColumnsDefinition & def_);
