...
struct StatelessAggregatingSortedAlgorithm::MapDescription
{
...
static bool mergeMap(const StatelessAggregatingSortedAlgorithm::MapDescription & desc,
    ...
    const Names & partition_key_columns)
{
    ...
    for (const auto & map : discovered_maps)
    {
        ...
        StatelessAggregatingSortedAlgorithm::AggregateDescription desc;
        StatelessAggregatingSortedAlgorithm::MapDescription map_desc;
...
static void preprocessChunk(Chunk & chunk, const StatelessAggregatingSortedAlgorithm::ColumnsDefinition & def)
{
...
static void setRow(Row & row, const ColumnRawPtrs & raw_columns, size_t row_num, const Names & column_names)
{
    ...
    for (size_t i = 0; i < num_columns; ++i)
    {
        ...
        catch (...)
        {
            ...
            throw Exception(ErrorCodes::CORRUPTED_DATA, "StatelessAggregatingSortedAlgorithm failed to read row {} of column {})",
...
StatelessAggregatingSortedAlgorithm::StatelessAggregatingMergedData::StatelessAggregatingMergedData(
...
void StatelessAggregatingSortedAlgorithm::StatelessAggregatingMergedData::startGroup(ColumnRawPtrs & raw_columns, size_t row)
{
...
void StatelessAggregatingSortedAlgorithm::StatelessAggregatingMergedData::finishGroup()
{
...
void StatelessAggregatingSortedAlgorithm::StatelessAggregatingMergedData::addRow(ColumnRawPtrs & raw_columns, size_t row)
{
...
void StatelessAggregatingSortedAlgorithm::StatelessAggregatingMergedData::addRowImpl(ColumnRawPtrs & raw_columns, size_t row)
{
    for (auto & desc : def.columns_to_aggregate)
    {
        if (!desc.created)
...
void StatelessAggregatingSortedAlgorithm::StatelessAggregatingMergedData::initAggregateDescription()
{
...
Chunk StatelessAggregatingSortedAlgorithm::StatelessAggregatingMergedData::pull()
{
...
StatelessAggregatingSortedAlgorithm::StatelessAggregatingSortedAlgorithm(
    const Block & header_,
    size_t num_inputs,
...
void StatelessAggregatingSortedAlgorithm::initialize(Inputs inputs)
{
...
IMergingAlgorithm::Status StatelessAggregatingSortedAlgorithm::merge()
{
