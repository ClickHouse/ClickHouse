...
private:
    ...
    void convertFieldToLiteral(const Field & field, const DataTypePtr & type, substrait::Expression::Literal * literal)
    {
        ...
        switch (type_id)
        {
            ...
            case TypeIndex::Int8:
                literal->set_i8(static_cast<int32_t>(field.safeGet<Int8>()));
                break;
            case TypeIndex::Int16:
                literal->set_i16(static_cast<int32_t>(field.safeGet<Int16>()));
                break;
            case TypeIndex::Int32:
                literal->set_i32(static_cast<int32_t>(field.safeGet<Int32>()));
                break;
            ...
            case TypeIndex::UInt8:
                if (type->getName() == "Bool")
                    ...
                    literal->set_i16(static_cast<int32_t>(field.safeGet<UInt8>()));
                break;
            case TypeIndex::UInt16:
                literal->set_i32(static_cast<int32_t>(field.safeGet<UInt16>()));
                break;
