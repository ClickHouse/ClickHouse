...
For JSON input format, if setting [`input_format_json_validate_types_from_metadata`](/reference/settings/formats/input-format#input_format_json_validate_types_from_metadata) is set to `1`,
