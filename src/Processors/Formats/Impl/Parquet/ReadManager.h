...
private:
    ...
    /// reader's memory high watermark minus what the `Dictionary` stage already holds (the decoded
    /// dictionaries and value sets other row groups are holding right now, plus this batch's
