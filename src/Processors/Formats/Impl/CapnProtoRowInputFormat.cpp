...
- For working with `Enum` in CapnProto format use the [format_capn_proto_enum_comparising_mode](/reference/settings/formats/format-capn#format_capn_proto_enum_comparising_mode) setting.
...
The setting [`format_capn_proto_use_autogenerated_schema`](/reference/settings/formats/format-capn#format_capn_proto_use_autogenerated_schema) is enabled by default and is applicable if [`format_schema`](/reference/formats/index#formatschema) is not set.

You can also save the autogenerated schema to a file during input/output using setting [`output_format_schema`](/reference/settings/formats/output-format#output_format_schema).
