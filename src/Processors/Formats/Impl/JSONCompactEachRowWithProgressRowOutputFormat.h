...
class JSONCompactEachRowWithProgressRowOutputFormat final : public JSONCompactEachRowRowOutputFormat
{
public:
    using JSONCompactEachRowRowOutputFormat::JSONCompactEachRowRowOutputFormat;
