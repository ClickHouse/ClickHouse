...
namespace DB
{
    ...
    {
        ThreadGroupSwitcher switcher(thread_group, ThreadNames::PARALLEL_FORMATER_COLLECTOR);
    ...
    {
        ThreadGroupSwitcher switcher(thread_group, ThreadNames::PARALLEL_FORMATER);
