...
| `output_format_arrow_record_batch_size`                                                                                  | Target record batch size in rows; consecutive blocks individually smaller than the target are combined into one record batch. 0 disables the row criterion. | `0`          |
| `output_format_arrow_record_batch_size_bytes`                                                                            | Target record batch size in bytes of accumulated data. 0 disables the byte criterion.              | `0`          |
