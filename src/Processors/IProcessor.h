...
public:
    ...
    /// Called for all processors before partial cancellation stops any source.
    /// Cache writers must reject publication before a stopped source can produce EOF.
    virtual void onPartialResult() noexcept {}
