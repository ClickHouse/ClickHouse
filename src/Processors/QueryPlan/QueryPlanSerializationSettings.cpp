...
#define PLAN_SERIALIZATION_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(UInt64, max_parallel_ordered_merge_materialization_threads, 0, "Maximum number of threads used to materialize output blocks in `MergingSorted` and `FinishSorting` query plan steps.", 0) \
    \
