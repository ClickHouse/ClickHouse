...
#define PLAN_SERIALIZATION_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(UInt64, radix_join_max_partitions_per_pass, 1024, "For the `radix_join` algorithm, the maximum number of partitions (fanout) produced by a single radix scatter pass.", 0) \
