...
#define PLAN_SERIALIZATION_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, allow_experimental_ie_join, false, "Allow the experimental IEJoin algorithm for INNER JOIN with exactly two inequality conditions in the ON section", 0) \
