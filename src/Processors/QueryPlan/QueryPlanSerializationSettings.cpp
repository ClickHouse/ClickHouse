...
#define PLAN_SERIALIZATION_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, allow_experimental_ie_join, false, "Allow the experimental IEJoin algorithm for JOIN with exactly two inequality conditions in the ON section (ALL INNER/LEFT/RIGHT/FULL and SEMI/ANTI LEFT/RIGHT kinds)", 0) \
