...
size_t SortingStep::Settings::maxBytesInQueryBeforeExternalSort(double max_bytes_ratio_before_external_sort)
{
...
SortingStep::Settings::Settings(const DB::Settings & settings)
{
    ...
    max_bytes_in_query_before_external_sort = maxBytesInQueryBeforeExternalSort(settings[Setting::max_bytes_ratio_before_external_sort]);
...
SortingStep::Settings::Settings(const QueryPlanSerializationSettings & settings)
{
    ...
    max_bytes_in_query_before_external_sort = maxBytesInQueryBeforeExternalSort(settings[QueryPlanSerializationSetting::max_bytes_ratio_before_external_sort]);
