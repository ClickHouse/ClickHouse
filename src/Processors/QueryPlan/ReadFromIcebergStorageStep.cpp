...
ReadFromIcebergStorageStep::ReadFromIcebergStorageStep(
...
QueryPlanStepPtr ReadFromIcebergStorageStep::clone() const
{
    return std::make_unique<ReadFromIcebergStorageStep>(*this);
}

void ReadFromIcebergStorageStep::applyFilters(ActionDAGNodes added_filter_nodes)
{
...
void ReadFromIcebergStorageStep::initializePipeline(QueryPipelineBuilder & pipeline, const BuildQueryPipelineSettings &)
{
    createIterator();
...
void ReadFromIcebergStorageStep::createIterator()
{
    if (iterator_wrapper)
        return;
    ...
    iterator_wrapper = ReadFromIcebergStorageSource::createFileIterator(
...
bool ReadFromIcebergStorageStep::requestReadingInOrder(InputOrderInfoPtr order_info_) const
{
...
InputOrderInfoPtr ReadFromIcebergStorageStep::getDataOrder() const
{
