...
struct QueryPlanOptimizationSettings
{
    ...
    static QueryPlanOptimizationSettings fromSettings(const Settings & from, bool aggregation_with_data_hints = false);
    static QueryPlanOptimizationSettings fromContext(ContextPtr from, bool aggregation_with_data_hints = false);
};
