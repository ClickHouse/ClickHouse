...
void EnumCcpSub<TConsumer, TDPTable, TQueryGraph>::initDPTable(TDPTable & dp_table, const TQueryGraph & query_graph)
{
    for (auto & edge : query_graph.edges)
    {
        ...
        dp_table[left_mask].estimated_rows_upper = query_graph.relation_stats[relations[0]].estimated_rows_upper;
        ...
        dp_table[right_mask].estimated_rows_upper = query_graph.relation_stats[relations[1]].estimated_rows_upper;
    ...
    for (const auto & op : query_graph.conflict_ops)
    {
        ...
        dp_table[left_mask].estimated_rows_upper = query_graph.relation_stats[*rep_left].estimated_rows_upper;
        ...
        dp_table[right_mask].estimated_rows_upper = query_graph.relation_stats[*rep_right].estimated_rows_upper;
