...
void processAndOptimizeIndexFunctions(const Stack & stack, QueryPlan::Nodes & nodes, bool direct_read_from_text_index, bool direct_read_from_bloom_sliced_index);
