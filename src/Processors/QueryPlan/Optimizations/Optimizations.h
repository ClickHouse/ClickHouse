...
struct Optimization
{
    struct ExtraSettings
    {
        ...
        // parallel replicas
        /// Mirrors `QueryPlanOptimizationSettings::parallel_replicas_filter_pushdown_reaches_replicas`:
        /// the setting is on *and* the condition really reaches the replicas.
