...
namespace Setting
{
    ...
    extern const SettingsBool query_plan_use_disjunctions_push_down;
    ...
    bool is_parallel_replicas_initiator_with_projection_support_)
{
    ...
    use_disjunctions_push_down = from[Setting::query_plan_enable_optimizations] && from[Setting::query_plan_use_disjunctions_push_down];
