...
namespace Setting
{
    ...
    extern const SettingsBool query_plan_convert_join_to_subquery;
...
QueryPlanOptimizationSettings::QueryPlanOptimizationSettings(const Settings & from)
{
    ...
    convert_join_to_subquery = from[Setting::query_plan_enable_optimizations] && from[Setting::query_plan_convert_join_to_subquery];
