...
namespace Setting
{
    ...
    extern const SettingsBool query_plan_optimize_join_order_use_eel_conflict_detector;
    ...
    bool is_parallel_replicas_initiator_with_projection_support_)
{
    ...
    query_plan_optimize_join_order_use_eel_conflict_detector = from[Setting::query_plan_optimize_join_order_use_eel_conflict_detector];
