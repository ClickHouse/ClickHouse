...
namespace Setting
{
    ...
    extern const SettingsBool query_plan_join_shard_by_partitions;
    ...
    bool is_parallel_replicas_initiator_with_projection_support_)
{
    ...
    query_plan_join_shard_by_partitions = from[Setting::query_plan_join_shard_by_partitions].value;
