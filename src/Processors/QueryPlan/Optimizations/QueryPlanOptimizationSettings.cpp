...
namespace Setting
{
    ...
    extern const SettingsBool query_plan_optimize_joins;
    ...
    bool is_parallel_replicas_initiator_with_projection_support_)
{
    ...
    optimize_joins = from[Setting::query_plan_optimize_joins] && !from[Setting::allow_experimental_parallel_reading_from_replicas];
