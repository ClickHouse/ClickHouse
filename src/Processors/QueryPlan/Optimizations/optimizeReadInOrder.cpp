...
/// produces `prefix_description + order_by`.  Plan construction (the analyzer's
/// `addWindowSteps`) decides whether a later window needs its own `SortingStep` by
/// checking prefixes of
