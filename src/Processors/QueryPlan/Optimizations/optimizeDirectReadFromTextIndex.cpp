...
///
/// Also this class processes text index functions (hasToken, hasAllTokens, hasAnyTokens, hasPhrase, hasAnyTokenPrefix, hasAnyTokenLike, hasAllTokenLike, hasAnyTokenRegexp):
