        ...
        switch (merging_params.mode)
        {
            ...
            case MergeTreeData::MergingParams::VersionedCoalescing:
            {
                ...
                return std::make_shared<CoalescingSortedTransform>(header, num_outputs,
                            sort_description, merging_params.columns_to_sum, required_columns, max_block_size_rows, /*max_block_size_bytes=*/0, /*max_dynamic_subcolumns*/std::nullopt, merging_params.allow_tuple_element_aggregation, merging_params.version_column);
            }
        }
    };
