...
{
    return convertSortingKeyToInputOrder(getSortingKey());
}

KeyDescription ReadFromObjectStorageStep::getSortingKey() const
{
    return configuration->getSortingKey(storage_snapshot->metadata);
}
}
