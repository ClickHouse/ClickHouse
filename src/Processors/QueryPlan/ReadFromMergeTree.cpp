    ...
    bool skip_partition_pruning_)
{
...

    {
        ...
        {
            ActionsDAGWithInversionPushDown wrapped(predicate, query_context, /* boolean_context */ false);
            return KeyCondition::createForPrimaryKey(
                wrapped, query_context, metadata_snapshot->getPrimaryKey(),
                /*skip_analysis*/ !query_context->getSettingsRef()[Setting::use_primary_key]);
        };
