...
struct ManyAggregatedData
{
    ...
    struct DictionaryAggregationBackpressure : std::enable_shared_from_this<DictionaryAggregationBackpressure>
    {
        ...
        std::shared_ptr<DictionaryRetention> retainDictionaries(std::span<const Columns> blocks, const IColumn * grouping_dictionary);
        static size_t getBlockBytes(const Columns & columns);
