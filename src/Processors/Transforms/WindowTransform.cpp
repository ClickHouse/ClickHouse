    ...
    , public IWindowFunction
{
    ...
    void serialize(ConstAggregateDataPtr __restrict, WriteBuffer &, std::size_t) const override { fail(); }
    void deserialize(AggregateDataPtr __restrict, ReadBuffer &, std::size_t, Arena *) const override { fail(); }
