...
//     : IISource(header), auto_progress(enable_auto_progress)
// {
// }

// void ISource::setProcessListElement(QueryStatus * elem)
// {
...
// bool ISource::checkTimeLimit() const
// {
...
// void ISource::progress(const Progress & value)
// {
