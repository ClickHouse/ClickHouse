    ...
    const String & key, const ReadSettings & read_settings, size_t object_size)
{
    ...
    auto async_reader = object_storage->readObjects(StoredObjects{StoredObject{key, object_size}}, "StorageAzureBlobSource::createAsyncAzureReadBuffer", modified_settings);
