...
#define LIST_OF_REFRESH_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(String, workload, "", "Workload used for refresh query scheduling. A non-empty value makes the refresh acquire query slots and memory reservations from this workload.", 0) \
