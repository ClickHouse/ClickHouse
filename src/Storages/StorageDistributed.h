...
private:
    ...
    bool isShardingKeySuitsQueryTreeNodeExpression(const QueryTreeNodePtr & expr, const StorageSnapshotPtr & storage_snapshot, const SelectQueryInfo & query_info) const;
