...
//    , log(&Poco::Logger::get("ReadBufferFromS3 " + toString(stream_number_)))
//    , storage(storage_)
...
//}
//
//ReadBufferFromS3::Records ReadBufferFromS3::pollBatch(size_t batch_size_)
//{
//    Records new_records;
...
//}
//
//void ReadBufferFromS3::readNewRecords(ReadBufferFromS3::Records & /*new_records*/, size_t /*batch_size_*/)
//{
