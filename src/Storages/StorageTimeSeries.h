...
public:
    ...
    StorageID getTargetTableId(TargetKind target_kind) const;
    StoragePtr getTargetTable(TargetKind target_kind, const ContextPtr & local_context) const;
    StoragePtr tryGetTargetTable(TargetKind target_kind, const ContextPtr & local_context) const;
