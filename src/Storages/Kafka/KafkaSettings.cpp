...
#define KAFKA_RELATED_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(UInt64, kafka_schema_registry_skip_bytes, 0, "Number of bytes to skip from the beginning of each Kafka message (e.g., 19 for AWS Glue Schema Registry envelope header). Maximum: 255 bytes.", 0) \
