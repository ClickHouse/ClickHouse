...
#define KAFKA_RELATED_SETTINGS(M) \
    ...
    M(String, kafka_sasl_username, "", "A sasl user name for kafa engine table.", 0) \
    M(String, kafka_sasl_password, "", "A sasl password for kafka engine table.", 0) \
    M(String, kafka_security_protocol, "", "A security protocol for kafka engine table.", 0) \
    M(String, kafka_sasl_mechanism, "", "A sasl mechanism for kafka engine table.", 0)
