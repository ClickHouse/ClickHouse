...
{
    auto topic_partition_name = topic_partition.topic + "_" + std::to_string(topic_partition.partition_id);
    return fs_keeper_path / "topic_partition_locks" / topic_partition_name / lock_file_name;
}
