...
/// the format version, the next eight zero bytes are `num_parts = 0`, and everything after them
...
TEST(PatchPartIndexRead, ConsumesExactlyTheIndex)
{
...

    {
        ...
        SourcePartsSetForPatch read_index;
        read_index.readBinary(in);
