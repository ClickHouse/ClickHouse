...
bool MergeTreeIndexConditionBloomFilter::mayBeTrueOnGranule(const MergeTreeIndexGranuleBloomFilter * granule, const FunctionPartialEvalResults & function_partial_eval_results) const
{
