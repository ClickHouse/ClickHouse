...
public:
    ...
    bool isSuitableForShortCircuitArgumentsExecution(ColumnsWithTypeAndName & arguments) const override { return func->isSuitableForShortCircuitArgumentsExecution(arguments); }
