...
void MergeTreeDataPartWriterWideSingleDisk::write(const Block & block,
...
void MergeTreeDataPartWriterWideSingleDisk::finishDataSerialization(IMergeTreeDataPart::Checksums & checksums)
{
...
void MergeTreeDataPartWriterWideSingleDisk::addStreams(
    const String & name,
...
IDataType::OutputStreamGetter MergeTreeDataPartWriterWideSingleDisk::createStreamGetter(
...
void MergeTreeDataPartWriterWideSingleDisk::writeSingleMark(
    const String & name,
    const IDataType & type,
    WrittenOffsetColumns & offset_columns,
...
size_t MergeTreeDataPartWriterWideSingleDisk::writeSingleGranule(
    const String & name,
    const IDataType & type,
...
void MergeTreeDataPartWriterWideSingleDisk::writeColumn(
    const String & name,
    const IDataType & type,
    const IColumn & column,
    WrittenOffsetColumns & offset_columns)
...
void MergeTreeDataPartWriterWideSingleDisk::writeFinalMark(
