...
Columns MergeTreeRangeReader::continueReadingChain(ReadResult & result, size_t & num_rows)
{
    ...
    /// Last granule is special because it might be incomplete in the first place,
    /// so we cannot blindly skip to the next mark. Instead, skip a precise number of rows.
