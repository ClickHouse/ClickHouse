...
Tables created without a `SAMPLE BY` key can still use the `SAMPLE` clause via the experimental [Bernoulli sampling](/sql-reference/statements/select/sample#bernoulli-sampling) mode (`allow_experimental_bernoulli_sample`).
