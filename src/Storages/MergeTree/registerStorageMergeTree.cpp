...
| [hasTokenPrefix](/reference/functions/regular-functions/string-search-functions#hasTokenPrefix)                                          | ✗           | ✗      | ✗          | ✗          | ✗            | ✗            | ✔    |
| [hasTokenLike](/reference/functions/regular-functions/string-search-functions#hasTokenLike)                                              | ✗           | ✗      | ✗          | ✗          | ✗            | ✗            | ✔    |
| [hasTokenMatch](/reference/functions/regular-functions/string-search-functions#hasTokenMatch)                                            | ✗           | ✗      | ✗          | ✗          | ✗            | ✗            | ✔    |
