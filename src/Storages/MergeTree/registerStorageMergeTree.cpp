...
| [hasAnyTokenPrefix](/reference/functions/regular-functions/string-search-functions#hasAnyTokenPrefix)                                    | ✗           | ✗      | ✗          | ✗          | ✗            | ✗            | ✔    |
| [hasAnyTokenLike](/reference/functions/regular-functions/string-search-functions#hasAnyTokenLike)                                        | ✗           | ✗      | ✗          | ✗          | ✗            | ✗            | ✔    |
| [hasAllTokenLike](/reference/functions/regular-functions/string-search-functions#hasAllTokenLike)                                        | ✗           | ✗      | ✗          | ✗          | ✗            | ✗            | ✔    |
| [hasAnyTokenRegexp](/reference/functions/regular-functions/string-search-functions#hasAnyTokenRegexp)                                    | ✗           | ✗      | ✗          | ✗          | ✗            | ✗            | ✔    |
