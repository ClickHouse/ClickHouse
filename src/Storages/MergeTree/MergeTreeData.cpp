...
VirtualColumnsDescription MergeTreeData::createVirtuals(const KeyDescription * partition_key)
{
    ...
    desc.addEphemeral(BM25ScoreColumn::name, BM25ScoreColumn::type, "BM25 relevance score computed from a text index created with scoring = 'bm25'", VirtualsMaterializationPlace::Reader);
