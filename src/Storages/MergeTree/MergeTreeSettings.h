...
#define MERGE_TREE_SETTINGS(M, ALIAS) \
    ...
    M(Bool, allow_experimental_optimized_row_order, true, "Allow reshuffling of rows during part inserts and merges to improve the compressibility of the new part", 0) \
    \
