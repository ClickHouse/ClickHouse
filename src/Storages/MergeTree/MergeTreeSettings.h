...
#define LIST_OF_MERGE_TREE_SETTINGS(M) \
    ...
    M(UInt64, min_age_to_force_merge_seconds, 0, "If all parts in a certain range are older than this value, range will be always eligable for merging. Set to 0 to disable.", 0) \
