...
#define LIST_OF_MERGE_TREE_SETTINGS(M) \
    ...
    M(Milliseconds, async_block_ids_cache_min_update_interval_ms, 100, "minimum interval of updating async_block_ids_cache", 0) \
    M(Bool, use_async_block_ids_cache, false, "if use async_block_ids_cache to filter duplicated async inserts in mem", 0) \
