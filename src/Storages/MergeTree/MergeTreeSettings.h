...
#define MERGE_TREE_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, min_free_diskspace_bytes_to_throw_insert, 10ULL * 1024 * 1024 * 1024, "Minimum free disk space bytes to throw an insert.", 0) \
    M(Double, min_free_diskspace_ratio_to_throw_insert, 0.02, "Minimum free disk space ratio to throw an insert.", 0) \
    \
