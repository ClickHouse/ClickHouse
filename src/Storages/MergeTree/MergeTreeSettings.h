...
#define MERGE_TREE_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, background_part_check_delay_seconds, 5*60, "Minimal delay between two background part checks", 0) \
    M(UInt64, delay_between_background_part_checks_for_individual_part_seconds, 24*60, "Minimal delay between checks for the same part", 0) \
