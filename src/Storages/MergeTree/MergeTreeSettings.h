...
#define LIST_OF_MERGE_TREE_SETTINGS(M) \
    ...
    M(UInt64, number_of_free_entries_in_pool_to_execute_mutation, 30, "When there is less than specified number of free entries in pool, do not execute part mutations. This is to leave free threads for regular merges and avoid \"Too many parts\"", 0) \
