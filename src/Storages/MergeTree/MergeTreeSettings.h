...
#define LIST_OF_MERGE_TREE_SETTINGS(M) \
    ...
    M(Bool, fetch_parts_from_lost_replicas, true, "Try to download parts from replicas marked as lost (is_lost flag in zookeeper). Disabling this setting may cause data loss in rare cases", 0) \
    \
