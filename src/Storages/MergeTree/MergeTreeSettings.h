...
#define LIST_OF_MERGE_TREE_SETTINGS(M) \
    ...
    M(UInt64, number_of_free_entries_in_pool_to_lower_max_size_of_merge, 8, "Deprecated.", 0) \
    M(UInt64, number_of_free_entries_in_pool_to_execute_mutation, 10, "Deprecated.", 0) \
