...
public:
    ...
    static void filterPartsByPreWhereAndWhere(const ContextPtr & context, RangesInDataParts & parts_with_ranges, const SelectQueryInfo & query_info_, LoggerPtr log);
