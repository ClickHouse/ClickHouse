...
void MergeTreeSettings::sanityCheck(const Settings & query_settings) const
{
    ...
    if (ratio_of_merges_with_the_maximum_size < 0 || ratio_of_merges_with_the_maximum_size > 1)
    {
        throw Exception(ErrorCodes::BAD_ARGUMENTS, "The value of 'ratio_of_merges_with_the_maximum_size' setting"
