...
#define MERGE_TREE_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, enable_minmax_index_for_all_numeric_columns, false, "Automatically create min-max indices for columns of numeric type", 0) \
    DECLARE(Bool, enable_minmax_index_for_all_string_columns, false, "Automatically create min-max indices for columns of string type", 0) \
    \
