...
#define MERGE_TREE_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, columns_and_secondary_indices_sizes_lazy_calculation, false, "Calculate columns and secondary indices sizes lazily on first request instead of on table initialization.", 0) \
