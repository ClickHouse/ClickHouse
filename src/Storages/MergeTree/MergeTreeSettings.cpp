...
#define MERGE_TREE_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, enable_max_bytes_limit_for_min_age_to_force_merge, false, "When enabled min_age_to_force_merge_seconds and min_age_to_force_merge_on_partition_only, whether they should be limited by max_bytes_to_merge_at_max_space_in_pool.", false) \
