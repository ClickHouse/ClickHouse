...
#define MERGE_TREE_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, enable_minmax_index_for_all_numeric_columns, false, "Enable secondary indices for all numeric columns", 0) \
    DECLARE(Bool, enable_minmax_index_for_all_string_columns, false, "Enable secondary indices for all string columns", 0) \
    \
