...
Allow creating text indexes with the experimental `scoring = 'bm25'` argument
...
- `v3_with_scoring` — Persists term frequencies and document lengths for indexes with `scoring = 'bm25'`.
)", 0) \
