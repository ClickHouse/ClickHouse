...
If it is set to zero, this background refresh is disabled. The statistics caches are populated and used by queries regardless of this setting; the query-level setting `use_statistics_cache` bypasses them.
)", 0) \
