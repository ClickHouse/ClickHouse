...
#define MERGE_TREE_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, write_marks_for_substreams_in_compact_parts, true, "Write marks per each substream instead of per each column in Compact parts. It allows reading individual subcolumns from the data part", 0) \
    \
