...
OPTIMIZE FINAL query.
    ...
    or [during INSERTs](/reference/settings/session-settings/materialize#materialize_statistics_on_insert).
...
the [materialize_statistics_on_insert](/reference/settings/session-settings/materialize#materialize_statistics_on_insert)
session setting and [exclude_materialize_statistics_on_insert](/reference/settings/session-settings/materialize#exclude_materialize_statistics_on_insert).
