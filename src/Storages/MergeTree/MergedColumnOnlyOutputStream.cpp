...
MergedColumnOnlyOutputStream::MergedColumnOnlyOutputStream(
    ...
    : IMergedBlockOutputStream(data_part->storage.getSettings(), data_part->getDataPartStoragePtr(), metadata_snapshot_, part_level_statistics_, columns_list_, /*reset_columns=*/ true)
{
