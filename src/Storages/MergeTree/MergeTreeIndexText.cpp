...
size_t MergeTreeIndexGranuleTextWritable::memoryUsageBytes()
{
    ...
    return sizeof(*this)
        + bloom_filter.getFilterSizeBytes()
        + tokens_and_postings.capacity() * (sizeof(std::pair<StringRef, PostingListBuilder *>) + sizeof(PostingListBuilder))
