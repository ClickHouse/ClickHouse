...
{
    return std::make_shared<MergeTreeIndexConditionText>(predicate, context, metadata_snapshot, index.sample_block, normalized_index_column_name, tokenizer.get(), preprocessor, postprocessor, params.positions);
}
