...
bool MergeTreeIndexConditionVectorSimilarity::mayBeTrueOnGranule(MergeTreeIndexGranulePtr, const FunctionPartialEvalResults & /*function_partial_eval_results*/) const
{
