...
bool MergeTreeIndexConditionVectorSimilarity::mayBeTrueOnGranule(MergeTreeIndexGranulePtr, const PartialEvalResultsFunction & /*partial_eval_results_function*/) const
{
