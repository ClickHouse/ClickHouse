...
public:
    ...
    /** Split the block to blocks, each of them must be written as separate part.
      ...
      */
    static BlocksWithPartition splitBlockIntoParts(Block && block, size_t max_parts, const StorageMetadataPtr & metadata_snapshot, ContextPtr context, DeduplicationInfoPtr deduplication_info);
