    ...
    bool is_final_query)
{
    ...
    /// If parallel_replicas_support_projection is enabled, the selected_marks will be used to select the best projection.
    /// So we cannot just return parts with all marks
