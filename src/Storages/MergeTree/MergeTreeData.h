...
private:
    ...
    /// `ColumnsDescriptionCache` is defined in `MergeTreeDataPartSharedInfo.h` and shared between
    /// all parts of a table that have the same set of columns.
    mutable AggregatedMetrics::GlobalSum columns_descriptions_metric_handle;
    mutable AggregatedMetrics::GlobalSum columns_descriptions_bytes_metric_handle;
    mutable AggregatedMetrics::GlobalSum names_and_types_metric_handle;
    mutable AggregatedMetrics::GlobalSum names_and_types_bytes_metric_handle;
