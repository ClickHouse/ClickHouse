...
public:
    ...
    /// 'fsync_after_insert_each_part'). Whether a part is collected is decided when it is written
    /// (MergeTreeTemporaryPart::needs_fsync_on_finish); this function syncs whatever it is given
