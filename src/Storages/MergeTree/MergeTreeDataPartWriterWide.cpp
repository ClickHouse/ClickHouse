    ...
    const ASTPtr & effective_codec_desc)
{
    ...
    auto data = ISerialization::SubstreamData(serialization).withType(name_and_type.getTypeInStorage()).withColumn(block_sample.getByName(name_and_type.name).column);
