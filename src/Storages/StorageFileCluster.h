...
public:
    ...
    RemoteQueryExecutor::Extension getTaskIteratorExtension(const ActionsDAG::Node * predicate, const ContextPtr & context, const size_t number_of_replicas = 1) const override;
