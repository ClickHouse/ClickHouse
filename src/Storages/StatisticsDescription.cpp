...
StatisticsType stringToStatisticsType(String type)
{
    ...
    if (type == "uniqhll12")
        return StatisticsType::UniqHLL12;
    if (type == "nullcount")
        return StatisticsType::NullCount;

    throw Exception(ErrorCodes::INCORRECT_QUERY, "Unknown statistics type: {}. Supported statistics types are 'countmin', 'minmax', 'nullcount', 'tdigest', 'uniqhll12' and 'uniq'.", type);
}
...
String statisticsTypeToString(StatisticsType type)
{
    switch (type)
    {
        ...
        case StatisticsType::MinMax:
            return "minmax";
        case StatisticsType::UniqHLL12:
            return "UniqHLL12";
        case StatisticsType::NullCount:
            return "nullcount";
        default:
            throw Exception(ErrorCodes::LOGICAL_ERROR, "Unknown statistics type: {}. Supported statistics types are 'countmin', 'minmax', 'nullcount', 'tdigest', 'uniqhll12' and 'uniq'.", type);
    }
}
