...
public:
    ...
    static std::shared_ptr<IObjectIterator> createIcebergIterator(
        StorageObjectStorageConfigurationPtr configuration,
...
class IcebergSource::ReadTaskIterator : public IObjectIterator, private WithContext
{
public:
    ReadTaskIterator(
...
class IcebergSource::GlobIterator : public IObjectIterator, WithContext
{
public:
    GlobIterator(
        ObjectStoragePtr object_storage_,
...
class IcebergSource::KeysIterator : public IObjectIterator
{
public:
    KeysIterator(
        const Strings & keys_,
 ...
 */
class IcebergSource::ArchiveIterator : public IObjectIterator, private WithContext
{
public:
