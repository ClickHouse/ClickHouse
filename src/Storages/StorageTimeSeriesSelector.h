...
public:
    ...
    /// The time bounds have the scale `time_scale`; they are converted to the type of the timestamps in the table,
    /// and the filter is always false if no timestamp of the table is in the time range.
