...
std::optional<UInt64> StorageSet::totalRows(const Context&) const { return set->getTotalRowCount(); }
std::optional<UInt64> StorageSet::totalBytes(const Context&) const { return set->getTotalByteCount(); }
