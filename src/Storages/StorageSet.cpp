...
Chain StorageSetOrJoinBase::writeImpl(const ASTPtr & /*query*/, const StorageMetadataPtr & metadata_snapshot, ContextPtr context, bool /*async_insert*/)
{
    UInt64 id = ++increment;
    return Chain::fromSink<SetOrJoinSink>(
