...
StorageSystemProjectionParts::StorageSystemProjectionParts(const StorageID & table_id_)
    ...
    ColumnsDescription{
        ...
        {"is_broken",                                   std::make_shared<DataTypeUInt8>(), "The flag which indicates whether this projection part is considered as broken."},
        {"exception_code",                              std::make_shared<DataTypeInt32>(), "The code of the error which happened and because of which the part is considered as broken."},
        {"exception",                                   std::make_shared<DataTypeString>(), "The message in the exception which occurred and because of which the part is considered broken."},
    }
    )
{
}
