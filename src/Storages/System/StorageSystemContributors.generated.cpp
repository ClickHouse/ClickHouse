// autogenerated by ci/jobs/scripts/create_release.py
const char * auto_contributors[] {
    ...
    "Hans Krutzer",
    "Hanzi Jiang",
    "Haowen Feng (from Dev Box)",
    "HappenLee",
    "Harikrishnan Prabakaran",
    "Harish Subramanian",
    "Harry Lee",
    "Harry-Lee",
    "HarryLeeIBM",
