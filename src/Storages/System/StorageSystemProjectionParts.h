...
/** Implements system table 'projection_parts' which allows to get information about projection parts for tables of MergeTree family.
  */
class StorageSystemProjectionParts final : public ext::shared_ptr_helper<StorageSystemProjectionParts>, public StorageSystemPartsBase
{
    friend struct ext::shared_ptr_helper<StorageSystemProjectionParts>;
public:
