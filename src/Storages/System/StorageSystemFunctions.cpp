...
void StorageSystemFunctions::fillData(MutableColumns & res_columns, ContextPtr context, const SelectQueryInfo &) const
{
    ...
    {
        fillRow(res_columns, function_name, UInt64(0), "example here", "", FunctionOrigin::SYSTEM, functions_factory);
    }
    ...
    {
        fillRow(res_columns, function_name, UInt64(1), "example here", "", FunctionOrigin::SYSTEM, aggregate_functions_factory);
    }
    ...
    for (const auto & function_name : user_defined_sql_functions_names)
    {
        ...
        fillRow(res_columns, function_name, UInt64(0), "example here", create_query, FunctionOrigin::SQL_USER_DEFINED, user_defined_sql_functions_factory);
    }
