...
#if USE_XRAY
    attach<SystemStorageXRayInstrumentation>(context, system_database, "xray_instrumentation", "Contains a list of all functions instrumented with XRay with their IDs and handlers.");
#endif
