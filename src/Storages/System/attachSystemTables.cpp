...
void attachSystemTablesServer(ContextPtr context, IDatabase & system_database, bool has_zookeeper, [[maybe_unused]] bool has_keeper_server)
{
    ...
    attach<StorageSystemSettingsChanges>(context, system_database, "settings_changes", "Contains information about setting changes across ClickHouse releases. You can use the user-level `compatibility` setting to make ClickHouse behave like a specified release.");
