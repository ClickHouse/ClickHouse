...
void attachSystemTablesServer(ContextPtr context, IDatabase & system_database, bool has_zookeeper)
{
    ...
    attach<StorageSystemClusterPartitions>(context, system_database, "cluster_partitions", "Contains information about clusters partitions for ReplicatedMergeTree");
