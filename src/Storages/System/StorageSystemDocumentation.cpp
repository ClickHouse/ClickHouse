    ...
    ContextPtr context)
{
    ...
    appendSystemTableSection(
        ...
        "Description",
        "description",
        documentation ? normalizeMdxForMarkdown(documentation->description) : comment);
