...
/// database engines, data types, formats, table functions, dictionary sources) keep the entire page in
/// `description`, and such a page contains either a Markdown H1 or its own Markdown section headers, which per
