...
protected:
    ...
    static void writeCluster(MutableColumns & res_columns, ContextPtr context, const std::vector<UInt8> & columns_mask, const NameAndCluster & name_and_cluster, const DatabaseReplicated * replicated);
