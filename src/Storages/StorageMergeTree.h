...
private:
    ...
    /// Returns the maximum level of all outdated parts in a range (left; right) and the maximum mutation
    /// version of those whose creation was not rolled back, or zeros in case if empty range.
