...
private:
    ...
    PartitionCommandsResultInfo addFingerprintPart(const ASTPtr & ast_part_name, const String & fingerprint);
    PartitionCommandsResultInfo removeFingerprintPart(const ASTPtr & ast_part_name, const String & fingerprint);
