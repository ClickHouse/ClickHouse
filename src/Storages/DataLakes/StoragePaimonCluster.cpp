...
String StoragePaimonCluster::getPathSample(ContextPtr context)
{
...
StoragePaimonCluster::StoragePaimonCluster(
...
std::string StoragePaimonCluster::getName() const
{
    return configuration->getEngineName();
}

std::optional<UInt64> StoragePaimonCluster::totalRows(ContextPtr query_context) const
{
...
std::optional<UInt64> StoragePaimonCluster::totalBytes(ContextPtr query_context) const
{
    configuration->lazyInitializeIfNeeded(
        object_storage,
        query_context);
...
void StoragePaimonCluster::updateQueryToSendIfNeeded(
    ASTPtr & query,
...
void StoragePaimonCluster::updateExternalDynamicMetadataIfExists(ContextPtr query_context)
{
...
RemoteQueryExecutor::Extension StoragePaimonCluster::getTaskIteratorExtension(
