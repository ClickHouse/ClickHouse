...
StoragePtr StorageIceberg::create(
    const std::optional<Configuration> & base_configuration,
...
StorageIceberg::StorageIceberg(
    ...
    std::optional<FormatSettings> format_settings_,
    std::optional<String> named_collection_name_)
    : StorageS3(configuration_, context_, table_id_, columns_, constraints_, comment, format_settings_, named_collection_name_)
