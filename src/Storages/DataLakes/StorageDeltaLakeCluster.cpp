...
String StorageDeltaLakeCluster::getPathSample(ContextPtr context)
{
...
StorageDeltaLakeCluster::StorageDeltaLakeCluster(
...
std::string StorageDeltaLakeCluster::getName() const
{
    return configuration->getEngineName();
}

std::optional<UInt64> StorageDeltaLakeCluster::totalRows(ContextPtr query_context) const
{
...
std::optional<UInt64> StorageDeltaLakeCluster::totalBytes(ContextPtr query_context) const
{
    configuration->lazyInitializeIfNeeded(
        object_storage,
        query_context);
...
void StorageDeltaLakeCluster::updateQueryToSendIfNeeded(
    ASTPtr & query,
...
void StorageDeltaLakeCluster::updateExternalDynamicMetadataIfExists(ContextPtr query_context)
{
...
RemoteQueryExecutor::Extension StorageDeltaLakeCluster::getTaskIteratorExtension(
