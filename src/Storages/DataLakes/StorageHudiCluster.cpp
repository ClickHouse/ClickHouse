...
String StorageHudiCluster::getPathSample(ContextPtr context)
{
...
StorageHudiCluster::StorageHudiCluster(
...
std::string StorageHudiCluster::getName() const
{
    return configuration->getEngineName();
}

std::optional<UInt64> StorageHudiCluster::totalRows(ContextPtr query_context) const
{
...
std::optional<UInt64> StorageHudiCluster::totalBytes(ContextPtr query_context) const
{
    configuration->lazyInitializeIfNeeded(
        object_storage,
        query_context);
...
void StorageHudiCluster::updateQueryToSendIfNeeded(
    ASTPtr & query,
...
void StorageHudiCluster::updateExternalDynamicMetadataIfExists(ContextPtr query_context)
{
...
RemoteQueryExecutor::Extension StorageHudiCluster::getTaskIteratorExtension(
