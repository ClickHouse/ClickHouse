...
public:
    ...
    std::optional<NameSet> supportedPrewhereColumns(const StorageSnapshotPtr & query_snapshot) const override { return getNested()->supportedPrewhereColumns(query_snapshot); }
