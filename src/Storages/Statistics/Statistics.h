...
public:
    ...
    /// True iff loaded statistics include a cardinality estimator (`Uniq` or `UniqV2`), so
    /// `estimateCardinality` returns a real estimate instead of the default-ratio guess.
