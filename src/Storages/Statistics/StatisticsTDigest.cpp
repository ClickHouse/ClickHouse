...
StatisticsType StatisticsTDigest::getType() const
{
...
std::optional<Float64> StatisticsTDigest::estimateEqual(Float64 val) const
{
    return t_digest.getCountEqual(val);
}

std::optional<Float64> StatisticsTDigest::estimateLess(Float64 val) const
{
