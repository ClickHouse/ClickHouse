...
struct ProjectionDescription
{
    ...
    getProjectionFromAST(const ASTPtr & definition_ast, const ColumnsDescription & columns, const Context & context);
...
struct ProjectionsDescription
{
    ...
    static ProjectionsDescription parse(const String & str, const ColumnsDescription & columns, const Context & context);

    /// Return common expression for all stored projections
    ExpressionActionsPtr getSingleExpressionForProjections(const ColumnsDescription & columns, const Context & context) const;
