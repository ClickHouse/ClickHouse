...
#define OBJECT_STORAGE_QUEUE_RELATED_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, use_hive_partitioning, true, "Whether path can contains hive partitioning and this engine should process such files with a separate processed files tracking per partition.", 0) \
