...
#define OBJECT_STORAGE_QUEUE_RELATED_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(UInt32, processing_state_cache_ttl_seconds, 5 * 60, "How long the in-memory `Processing` file state is trusted without rechecking keeper. Zero means to always recheck keeper", 0) \
