    ...
    const PrometheusQueryTree::BinaryOperator * operator_node, SQLQueryPiece && argument, ConverterContext & context)
{
    ...
    ASTPtr aggregation_query;
    {
        ...
        builder.select_list.push_back(makeASTFunction(
            ...
            left_transform(make_intrusive<ASTIdentifier>(ColumnNames::Values), context.result_value_type),
            right_transform(make_intrusive<ASTIdentifier>(ColumnNames::Values), context.result_value_type)));
