...
#define LIST_OF_TIME_SERIES_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(UInt64, insert_cache_max_size_bytes, 16777216, "Maximum memory used by the replica-local cache for inserts into the inner metric families table. Set to 0 to disable the cache", 0) \
