...
struct TimeSeriesColumnNames
{
    ...
    /// The function also returns "tags", "value", and "timestamp".
    static constexpr const char * Time = "time";
    static constexpr const char * TimeSeries = "time_series";

    /// Internal columns columns used in the implementation of the table function prometheusQuery().
    /// The function doesn't return any of them.
