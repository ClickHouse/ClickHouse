...
struct TimeSeriesColumnNames
{
    ...
    /// The name of the column with the name of a metric family in the "metrics" target table of tables of versions before 4,
    /// see `getInnerMetricFamily`.
    ...
    /// Returns the name of the column with the name of a metric family in the "metrics" target table
