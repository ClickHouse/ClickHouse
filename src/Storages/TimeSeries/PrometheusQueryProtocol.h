...
class PrometheusQueryProtocol : public WithContext
{
public:
    PrometheusQueryProtocol(ConstStoragePtr time_series_storage_, const ContextPtr & context_);
    ~PrometheusQueryProtocol();
