...
///   5 - The column `metric_family_name` of the "metric families" target table was renamed to `metric_family`, the name of
...
namespace TimeSeriesVersion
{
    ...
    constexpr UInt64 MIN_WITH_METRIC_FAMILY_INNER_COLUMN = 5;
