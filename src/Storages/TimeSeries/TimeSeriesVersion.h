...
///   7 - The columns `min_time` and `max_time` moved from the tags table into a separate "tags min max" target table
...
namespace TimeSeriesVersion
{
    ...
    constexpr UInt64 MIN_WITH_SEPARATE_TAGS_MIN_MAX = 7;
