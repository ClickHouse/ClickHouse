...
void PrometheusRemoteWriteProtocol::writeTimeSeries(const google::protobuf::RepeatedPtrField<prometheus::TimeSeries> & time_series)
{
    ...
    auto tags_table_metadata = time_series_storage->getTargetTable(ViewTarget::Tags, getContext())->getInMemoryMetadataUncached(getContext());
    auto samples_table_metadata = time_series_storage->getTargetTable(ViewTarget::Samples, getContext())->getInMemoryMetadataUncached(getContext());
...
void PrometheusRemoteWriteProtocol::writeMetricsMetadata(const google::protobuf::RepeatedPtrField<prometheus::MetricMetadata> & metrics_metadata)
{
    ...
    auto metrics_table_metadata_ptr = time_series_storage->getTargetTable(ViewTarget::Metrics, getContext())->getInMemoryMetadataUncached(getContext());
