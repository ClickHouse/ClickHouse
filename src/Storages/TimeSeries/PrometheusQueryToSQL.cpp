...
namespace
{
    ...
    DecimalField<DateTime64> alignUp(const DecimalField<DateTime64> & time, const DecimalField<Decimal64> & step)
    {
        ...
        DecimalField<DateTime64> res = time;
        if (auto x = res.getValue() % step.getValue())
            res = DecimalField<DateTime64>{res.getValue() + step.getValue() - x, scale};
        return res;
    }
    ...
    DecimalField<DateTime64> alignDown(const DecimalField<DateTime64> & time, const DecimalField<Decimal64> & step)
    {
        ...
        chassert((step.getValue() > 0) && (scale == time.getScale()));
        auto res = time;
        if (auto y = res.getValue() % step.getValue())
            res = DecimalField<DateTime64>{res.getValue() - y, scale};
        return res;
    }
}
