...
namespace
{
    ...
    void applyASClause(ASTCreateQuery & create_query, const ContextPtr & context)
    {
        ...
        constexpr std::array<ViewTarget::Kind, 5> kinds_with_optional_targets{
            ViewTarget::Samples, ViewTarget::Tags, ViewTarget::Metrics, ViewTarget::RecentSamples, ViewTarget::Histograms};
        for (auto kind : kinds_with_optional_targets)
        {
