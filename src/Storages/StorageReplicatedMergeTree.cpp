    ...
    BackupEntriesCollector & backup_entries_collector, const String & data_path_in_backup, const std::optional<ASTs> & partitions)
{
    ...
    /// Send a list of mutations to the coordination too (we need to find the mutations which are not finished for added part names).
    {
        ...
        if (exists)
        {
            ...
            if (!mutation_infos.empty())
                coordination->addReplicatedMutations(full_zk_path, getStorageID().getFullTableName(), getReplicaName(), mutation_infos);
        }
    }
                                 ...
                                 &backup_entries_collector]()
    {
        ...
        Strings part_names = coordination->getReplicatedPartNames(full_zk_path, my_replica_name);
        ...
        auto mutation_infos = coordination->getReplicatedMutations(full_zk_path, my_replica_name);
