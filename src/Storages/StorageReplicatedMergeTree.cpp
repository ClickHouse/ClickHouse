...
void StorageReplicatedMergeTree::createNewZooKeeperNodes()
{
    ...
    if (settings->allow_remote_fs_zero_copy_replication)
    {
        ...
        futures.push_back(zookeeper->asyncTryCreateNoThrow(zookeeper_path + "/zero_copy_cfs", String(), zkutil::CreateMode::Persistent));
        futures.push_back(zookeeper->asyncTryCreateNoThrow(zookeeper_path + "/zero_copy_cfs/shared", String(), zkutil::CreateMode::Persistent));
    }
