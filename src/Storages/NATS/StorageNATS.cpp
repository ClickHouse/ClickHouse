...
StorageNATS::StorageNATS(
    ...
    , allow_delayed_initialization(allow_delayed_initialization_)
{
...
void registerStorageNATS(StorageFactory & factory)
{
    auto creator_fn = [](const StorageFactory::Arguments & args)
    {
        ...
        return std::make_shared<StorageNATS>(args.table_id, args.getContext(), args.columns, std::move(nats_settings), args.attach || args.replicated_create);
    };
