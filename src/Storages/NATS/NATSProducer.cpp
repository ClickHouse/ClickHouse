...
void NATSJetStreamProducer::publishThreadFunc(void * arg)
{
    NATSJetStreamProducer * producer = static_cast<NATSJetStreamProducer *>(arg);
    String payload;
...
void NATSJetStreamProducer::iterateEventLoop()
{
    connection.getHandler().iterateLoop();
}
