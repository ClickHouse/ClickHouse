    ...
    ClusterPtr cluster) const
{
    auto iterator = StorageObjectStorageSource::createFileIterator(
        ...
        local_context, predicate, filter_actions_dag, virtual_columns, hive_partition_columns_to_read_from_file_path, nullptr, local_context->getFileProgressCallback(), /*ignore_archive_globs=*/true, /*skip_object_metadata=*/true);
