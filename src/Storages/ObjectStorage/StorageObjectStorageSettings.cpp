...
If enabled, the engine would use the metadata file with the most recent last_updated_ms json field. Doesnt make sense to use with iceberg_metadata_file_path.
)", 0)
