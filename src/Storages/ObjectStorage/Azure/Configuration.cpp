...
ObjectStoragePtr StorageAzureConfiguration::doCreateObjectStorage(ContextPtr context, bool is_readonly, CredentialsConfigurationCallback /*refresh_credentials_callback*/) /// NOLINT
{
    assertInitialized();
