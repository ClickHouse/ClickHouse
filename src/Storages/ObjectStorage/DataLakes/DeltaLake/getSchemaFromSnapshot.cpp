...
public:
    static DB::NamesAndTypesList visit(ffi::SharedSnapshot * snapshot, SchemaVisitorData & data)
    {
        ...
        visitor.visit_boolean = &simpleTypeVisitor<DB::TypeIndex::UInt8, true>;
        visitor.visit_string = &simpleTypeVisitor<DB::TypeIndex::String>;
        visitor.visit_long = &simpleTypeVisitor<DB::TypeIndex::UInt64>;
        visitor.visit_integer = &simpleTypeVisitor<DB::TypeIndex::UInt32>;
        visitor.visit_short = &simpleTypeVisitor<DB::TypeIndex::UInt16>;
        visitor.visit_byte = &simpleTypeVisitor<DB::TypeIndex::UInt8>;
        ...
        visitor.visit_date = &simpleTypeVisitor<DB::TypeIndex::Date>;
    ...
    for (const auto & field : *type_lists[list_idx])
    {
        ...
        else
        {
            ...
            else if (which.isArray())
            {
                ...
                // if (field.value_contains_null)
                //     child_types[0] = std::make_shared<DB::DataTypeNullable>(child_types[0]);
