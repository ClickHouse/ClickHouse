...
IMPLEMENT_SETTINGS_TRAITS_WITH_RECORDED_ORIGIN(DataLakeStorageSettingsTraits, LIST_OF_DATA_LAKE_STORAGE_SETTINGS, DataLakeStorageSettings, DataLakeStorageSetting)
