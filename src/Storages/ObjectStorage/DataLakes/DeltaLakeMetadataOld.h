...
class DeltaLakeMetadataOld final : public IDataLakeMetadata
{
public:
    using ConfigurationObserverPtr = StorageObjectStorage::ConfigurationObserverPtr;
    static constexpr auto name = "DeltaLake";

    DeltaLakeMetadataOld(ObjectStoragePtr object_storage_, ConfigurationObserverPtr configuration_, ContextPtr context_);
    ...
    {
        const auto * deltalake_metadata = dynamic_cast<const DeltaLakeMetadataOld *>(&other);
