...
struct IcebergObjectSerializableInfo
{
    ...
    /// Current-schema column name -> its per-file identity-partition value, for columns absent from
    /// the data file. The read source overwrites the NULL-filled output column with it. See #110216.
