...
// Examples:
// partition_transform = Iceberg::PartitionTransformType::Year
// index = 3
...
// partition_transform = Iceberg::PartitionTransformType::Month
// index = 3
...
DB::Range getPartitionRange(
    Iceberg::PartitionTransformType partition_transform, size_t index, DB::ColumnPtr partition_column, DB::DataTypePtr column_data_type);
}
