...
{
    IcebergSnapshot(ManifestListIterator manifest_list_iterator_, Int64 snapshot_id_) : manifest_list_iterator(manifest_list_iterator_), snapshot_id(snapshot_id_) {} 
