...
bool IcebergStorageSink::initializeMetadata()
{
    ...
    try
    {
        ...
        {
            LOG_INFO(getLogger("DDDBG"), "IcebergWrites: invalidate cache for path={} uuid={}",
                     persistent_table_components.table_path,
                     persistent_table_components.table_uuid ? *persistent_table_components.table_uuid : "none");
