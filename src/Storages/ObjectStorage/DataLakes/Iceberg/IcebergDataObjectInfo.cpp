...
IcebergDataObjectInfo::IcebergDataObjectInfo(Iceberg::ManifestFileEntry data_manifest_file_entry_, const std::vector<Iceberg::ManifestFileEntry> & position_deletes_): 
    RelativePathWithMetadata(data_manifest_file_entry_.file_path_key),
    ...
    position_deletes_objects(definePositionDeletesSpan(data_manifest_file_entry_, position_deletes_, data_manifest_file_entry_.file_path_key))
{}
