    ...
    std::shared_ptr<DataLake::ICatalog> catalog)
{
    ...
    while (--max_retries > 0)
    {
        ...
        auto metadata = getMetadataJSONObject(metadata_path, object_storage, persistent_table_components.metadata_cache, context, log, persistent_table_components.table_uuid);
