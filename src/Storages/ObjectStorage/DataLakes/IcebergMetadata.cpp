    ...
    ContextPtr local_context)
{
    ...
    auto [schema, schema_id]
        = parseTableSchema(object, format_version, local_context->getSettingsRef()[iceberg_engine_ignore_schema_evolution]);
...
Strings IcebergMetadata::getDataFiles() const
{
    ...
    for (const auto & manifest_file : manifest_files)
    {
        ...
        if (!context->getSettingsRef()[iceberg_engine_ignore_schema_evolution]
