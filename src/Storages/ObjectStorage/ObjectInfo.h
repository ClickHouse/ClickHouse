...
struct ObjectInfoOneFile : public ObjectInfo
{
    ...
    RelativePathWithMetadata & getUnderlyingObject() override { return relative_path_with_metadata; }
    const RelativePathWithMetadata & getUnderlyingObject() const override { return relative_path_with_metadata; }
    ...
    std::string getPathOrPathToArchiveIfArchive() const override { return getPath(); }
...
struct ObjectInfoInArchive : public ObjectInfo
{
    ...
    const RelativePathWithMetadata & getUnderlyingObject() const override { return underlying_blob_object; }

    bool isArchive() const override { return true; }
    std::string getFileName() const override { return path_in_archive; }

    std::string getPath() const override { return underlying_blob_object.getPath() + "::" + path_in_archive; }

    std::string getPathToArchive() const override { return underlying_blob_object.getPath(); }

    std::string getPathOrPathToArchiveIfArchive() const override { return getPathToArchive(); }
