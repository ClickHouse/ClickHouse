...
public:
    ...
    void initializePipeline(QueryPipelineBuilder & pipeline, const BuildQueryPipelineSettings &) override
    {
        ...
        const size_t max_threads_v = context->getSettingsRef()[max_threads];
        ...
        const size_t max_parsing_threads = num_streams >= max_threads_v ? 1 : (max_threads_v / std::max(num_streams, 1ul));
