...
std::unique_ptr<ReadBuffer> ReadBufferIterator::recreateLastReadBuffer()
{
    ...
    auto impl
        = createReadBuffer(current_object_info->path_with_metadata, object_storage, context, getLogger("ReadBufferIterator"));
    ...
    while (true)
    {
        ...
        else
        {
            ...
            read_buf = createReadBuffer(
                current_object_info->path_with_metadata, object_storage, getContext(), getLogger("ReadBufferIterator"));
        }
