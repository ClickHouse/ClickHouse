...
/// Tests below cover cluster-protocol fail-closed behavior for Iceberg deletion vectors /
/// equality / position deletes and file buckets. Master-only APIs (`read_source_index`,
