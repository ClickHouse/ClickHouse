...
This engine integrates Apache [Iceberg](https://iceberg.apache.org/) tables in Amazon S3, Azure, HDFS and local storage with ClickHouse.
...
- [iceberg table function](/reference/functions/table-functions/iceberg)
    ...
    factory.registerStorage(
        ...
        Documentation{
            .description = "Provides read and write integration with Apache Iceberg tables stored in Amazon S3 or S3-compatible object storage.",
...
#    if USE_AZURE_BLOB_STORAGE
    factory.registerStorage(
        ...
        Documentation{
            .description = "Provides read and write integration with Apache Iceberg tables stored in Microsoft Azure Blob Storage.",
...
#    endif
    factory.registerStorage(
        ...
        Documentation{
            .description = "Provides read and write integration with Apache Iceberg tables stored on the local filesystem.",
