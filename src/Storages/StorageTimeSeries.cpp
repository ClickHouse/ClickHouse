...
| Name | Mandatory? | Default type | Possible types | Description |
|---|---|---|---|---|
| `metric_family` | [x] | `String` | `String` or `LowCardinality(String)` | The name of a metric family. In tables of versions before 4 this column is named `metric_family_name` (see [Version history](#version-history)) |
...
| 4 | The column `metric_family_name` of the [metrics](#metrics-table) table was renamed to `metric_family`, the name of the corresponding outer column. Tables of earlier versions keep the old name of the column, and the [timeSeriesMetrics](/reference/functions/table-functions/timeSeriesMetrics) table function returns the column under the name the table uses. An external metrics table must name the column the way the version of the `TimeSeries` table does |
