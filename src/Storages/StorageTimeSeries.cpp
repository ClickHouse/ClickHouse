...
| Name | Mandatory? | Default type | Possible types | Description |
|---|---|---|---|---|
| `metric_family` | [x] | `String` | `String` or `LowCardinality(String)` | The name of a metric family. In tables of versions before 5 this column is named `metric_family_name` (see [Version history](#version-history)) |
