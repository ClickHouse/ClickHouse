    ...
    bool concat_streams)
{
    ...
    if (processed_stage <= storage_stage)
    {
        ...
        pipes = storage->read(real_column_names, storage->getInMemoryMetadata(), modified_query_info, *modified_context, processed_stage, max_block_size, UInt32(streams_num));
    }
