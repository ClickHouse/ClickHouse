    ...
    for (const auto & table : selected_tables)
    {
        ...
        try
        {
            ...
            if (child.plan.isInitialized())
            {
                ...
                auto optimization_settings = getChildPlanOptimizationSettings(modified_context, query_info);
