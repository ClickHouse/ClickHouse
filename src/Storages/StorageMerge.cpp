    ...
    for (const auto & table : selected_tables)
    {
        ...
        try
        {
            ...
            if (child.plan.isInitialized())
            {
                ...
                convertAndFilterSourceStream(*common_header, query_info, modified_query_info, nested_storage_snapshot, table, aliases, row_policy_data_opt, context, child, is_smallest_column_requested);
