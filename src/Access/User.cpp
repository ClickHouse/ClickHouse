...
void User::setName(const String & name_)
{
    ...
    if (startsWith(name_, EncodedUserInfo::USER_INTERSERVER_MARKER))
        throw Exception(ErrorCodes::BAD_ARGUMENTS, "User name '{}' is reserved", EncodedUserInfo::USER_INTERSERVER_MARKER);
