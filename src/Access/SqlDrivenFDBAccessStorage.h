...
public:
    ...
    SqlDrivenFDBAccessStorage(
        AccessChangesNotifier & changes_notifier_, const String & directory_path_,const std::function<FoundationDBPtr()> & get_fdb_function_, bool readonly_ = false);
...
private:
    ...
    std::optional<String> readNameImpl(const UUID & id, bool throw_if_not_exists) const;
