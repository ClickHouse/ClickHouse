...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_START_SELECTIVE_REBALANCE, "SYSTEM START SELECTIVE REBALANCE, START SELECTIVE REBALANCE", TABLE, SYSTEM) \
    M(SYSTEM_SYNC_SELECTIVE_MIGRATIONS, "SYSTEM SYNC SELECTIVE MIGRATIONS, SYNC SELECTIVE MIGRATIONS", TABLE, SYSTEM) \
    M(SYSTEM_MIGRATE_PARTITION, "SYSTEM MIGRATE PARTITION, MIGRATE PARTITION", TABLE, SYSTEM) \
