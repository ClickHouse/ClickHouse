...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_DROP_TEXT_INDEX_DICTIONARY_CACHE, "SYSTEM CLEAR TEXT INDEX DICTIONARY CACHE, SYSTEM DROP TEXT INDEX DICTIONARY CACHE, DROP TEXT INDEX DICTIONARY CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
