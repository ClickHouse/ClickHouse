...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(ALTER_MATERIALIZE_COLUMNS, "MATERIALIZE COLUMNS", COLUMN, ALTER_COLUMN) \
    ...
    M(ALTER_MATERIALIZE_INDEXES, "MATERIALIZE INDEXES", TABLE, ALTER_INDEX) \
    ...
    M(ALTER_MATERIALIZE_PROJECTIONS, "MATERIALIZE PROJECTIONS", TABLE, ALTER_PROJECTION) \
