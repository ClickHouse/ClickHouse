...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_DROP_BACKGROUND_FILESYSTEM_CACHE_DOWNLOAD, "SYSTEM DROP BACKGROUND FILESYSTEM CACHE DOWNLOAD, DROP BACKGROUND FILESYSTEM CACHE DOWNLOAD", GLOBAL, SYSTEM_DROP_CACHE) \
