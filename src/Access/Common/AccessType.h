...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    \
    M(ALTER_ADD_STATISTIC, "ADD STATISTIC", TABLE, ALTER_STATISTIC) \
    M(ALTER_DROP_STATISTIC, "DROP STATISTIC", TABLE, ALTER_STATISTIC) \
    M(ALTER_MATERIALIZE_STATISTIC, "MATERIALIZE STATISTIC", TABLE, ALTER_STATISTIC) \
    M(ALTER_CLEAR_STATISTIC, "CLEAR STATISTIC", TABLE, ALTER_STATISTIC) \
    M(ALTER_MODIFY_STATISTIC, "MODIFY STATISTIC", TABLE, ALTER_STATISTIC) \
    M(ALTER_STATISTIC, "STATISTIC", GROUP, ALTER_TABLE) /* allows to execute ALTER {ADD|DROP...} STATISTIC */\
    \
    ...
    M(SYSTEM_RELOAD_STATISTICS, "SYSTEM RELOAD STATISTICS", GLOBAL, SYSTEM_RELOAD) \
