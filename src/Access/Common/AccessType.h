...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_DROP_VECTOR_QUERY_PLAN_CACHE, "SYSTEM CLEAR VECTOR QUERY PLAN CACHE, SYSTEM DROP VECTOR QUERY PLAN, DROP VECTOR QUERY PLAN CACHE, DROP VECTOR QUERY PLAN", GLOBAL, SYSTEM_DROP_CACHE) \
