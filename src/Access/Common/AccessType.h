...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_DROP_DATALAKE_CATALOG_CACHE, "SYSTEM CLEAR DATALAKE CATALOG CACHE, SYSTEM DROP DATALAKE CATALOG CACHE, SYSTEM CLEAR DATALAKE_CATALOG_CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
