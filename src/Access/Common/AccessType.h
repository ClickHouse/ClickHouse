...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_RELOAD_DICTIONARY, "SYSTEM RELOAD DICTIONARIES, SYSTEM STOP RELOAD DICTIONARIES, SYSTEM START RELOAD DICTIONARIES, RELOAD DICTIONARIES", GLOBAL, SYSTEM_RELOAD) \
