...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_CAS_GC_RUN, "SYSTEM CAS GC RUN", GLOBAL, SYSTEM) \
    M(SYSTEM_CAS_GC_REBUILD, "SYSTEM CAS GC REBUILD", GLOBAL, SYSTEM) \
    M(SYSTEM_CAS_DROP_POOL_MEMBER, "SYSTEM CAS DROP POOL MEMBER", GLOBAL, SYSTEM) \
    M(SYSTEM_CAS_FSCK, "SYSTEM CAS FSCK", GLOBAL, SYSTEM) \
    M(SYSTEM_CAS_FORGET, "SYSTEM CAS FORGET", GLOBAL, SYSTEM) \
    M(SYSTEM_CAS_GC_STOP, "SYSTEM CAS GC STOP", GLOBAL, SYSTEM) \
    M(SYSTEM_CAS_GC_START, "SYSTEM CAS GC START", GLOBAL, SYSTEM) \
