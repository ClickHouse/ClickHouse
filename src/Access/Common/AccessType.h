...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_DROP_ICEBERG_MANIFEST_PRUNE_CACHE, "SYSTEM CLEAR ICEBERG MANIFEST PRUNE CACHE, SYSTEM DROP ICEBERG MANIFEST PRUNE CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
