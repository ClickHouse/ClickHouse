...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_DROP_PART_AGGREGATION_CACHE, "SYSTEM CLEAR PART AGGREGATION CACHE, SYSTEM DROP PART AGGREGATION, DROP PART AGGREGATION CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
