...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(SYSTEM_DROP_PARTIAL_AGGREGATE_CACHE, "SYSTEM CLEAR PARTIAL AGGREGATE CACHE, SYSTEM DROP PARTIAL AGGREGATE, DROP PARTIAL AGGREGATE CACHE, DROP PARTIAL AGGREGATE", GLOBAL, SYSTEM_DROP_CACHE) \
