...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(ALTER_MODIFY_CONSTRAINT, "MODIFY CONSTRAINT", TABLE, ALTER_CONSTRAINT) \
    M(ALTER_CONSTRAINT, "CONSTRAINT", GROUP, ALTER_TABLE) /* allows to execute ALTER {ADD|DROP|MODIFY} CONSTRAINT */\
    \
    ...
    M(CREATE_MASKING_POLICY, "", GLOBAL, ACCESS_MANAGEMENT) \
    M(ALTER_MASKING_POLICY, "", GLOBAL, ACCESS_MANAGEMENT) \
    M(DROP_MASKING_POLICY, "", GLOBAL, ACCESS_MANAGEMENT) \
    ...
    M(SYSTEM_DROP_CONNECTIONS_CACHE, "SYSTEM CLEAR CONNECTIONS CACHE, SYSTEM DROP CONNECTIONS CACHE, DROP CONNECTIONS CACHE", GLOBAL, SYSTEM_DROP_CACHE)  \
    ...
    M(SYSTEM_DROP_PAIMON_METADATA_CACHE, "SYSTEM CLEAR PAIMON_METADATA_CACHE, SYSTEM DROP PAIMON_METADATA_CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
    ...
    M(SYSTEM_DROP_VECTOR_SIMILARITY_INDEX_CACHE, "SYSTEM CLEAR VECTOR SIMILARITY INDEX CACHE, SYSTEM DROP VECTOR SIMILARITY INDEX CACHE, DROP VECTOR SIMILARITY INDEX CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_TEXT_INDEX_TOKENS_CACHE, "SYSTEM CLEAR TEXT INDEX TOKENS CACHE, SYSTEM DROP TEXT INDEX TOKENS CACHE, DROP TEXT INDEX TOKENS CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_TEXT_INDEX_HEADER_CACHE, "SYSTEM CLEAR TEXT INDEX HEADER CACHE, SYSTEM DROP TEXT INDEX HEADER CACHE, DROP TEXT INDEX HEADER CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_TEXT_INDEX_POSTINGS_CACHE, "SYSTEM CLEAR TEXT INDEX POSTINGS CACHE, SYSTEM DROP TEXT INDEX POSTINGS CACHE, DROP TEXT INDEX POSTINGS CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_TEXT_INDEX_CACHES, "SYSTEM CLEAR TEXT INDEX CACHES, SYSTEM DROP TEXT INDEX CACHES, DROP TEXT INDEX CACHES", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_MMAP_CACHE, "SYSTEM CLEAR MMAP CACHE, SYSTEM DROP MMAP, DROP MMAP CACHE, DROP MMAP", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_QUERY_CONDITION_CACHE, "SYSTEM CLEAR QUERY CONDITION CACHE, SYSTEM DROP QUERY CONDITION, DROP QUERY CONDITION CACHE, DROP QUERY CONDITION", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_ENCRYPTION_HEADERS_CACHE, "SYSTEM CLEAR ENCRYPTION HEADERS CACHE, SYSTEM DROP ENCRYPTION HEADERS, DROP ENCRYPTION HEADERS CACHE, DROP ENCRYPTION HEADERS", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_QUERY_CACHE, "SYSTEM CLEAR QUERY CACHE, SYSTEM DROP QUERY, DROP QUERY CACHE, DROP QUERY", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_AGGREGATE_CACHE, "SYSTEM CLEAR AGGREGATE CACHE, SYSTEM DROP AGGREGATE, DROP AGGREGATE CACHE, DROP AGGREGATE, SYSTEM CLEAR PARTIAL AGGREGATE CACHE, SYSTEM DROP PARTIAL AGGREGATE, SYSTEM DROP PARTIAL AGGREGATE CACHE, DROP PARTIAL AGGREGATE CACHE, DROP PARTIAL AGGREGATE", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_COMPILED_EXPRESSION_CACHE, "SYSTEM CLEAR COMPILED EXPRESSION CACHE, SYSTEM DROP COMPILED EXPRESSION, DROP COMPILED EXPRESSION CACHE, DROP COMPILED EXPRESSIONS", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_FILESYSTEM_CACHE, "SYSTEM CLEAR FILESYSTEM CACHE, SYSTEM DROP FILESYSTEM CACHE, DROP FILESYSTEM CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
    M(SYSTEM_DROP_DISTRIBUTED_CACHE, "SYSTEM CLEAR DISTRIBUTED CACHE, SYSTEM DROP DISTRIBUTED CACHE, DROP DISTRIBUTED CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
    ...
    M(SYSTEM_DROP_PAGE_CACHE, "SYSTEM CLEAR PAGE CACHE, SYSTEM DROP PAGE CACHE, DROP PAGE CACHE", GLOBAL, SYSTEM_DROP_CACHE) \
    ...
    M(SYSTEM_WAIT_BLOBS_CLEANUP, "SYSTEM WAIT BLOBS CLEANUP", GLOBAL, SYSTEM) \
    ...
    M(SYSTEM_WAIT_QUERY_RUNNER, "WAIT QUERY RUNNER", TABLE, SYSTEM) \
    ...
    M(SYSTEM_FLUSH_OBJECT_STORAGE_QUEUE, "FLUSH OBJECT STORAGE QUEUE", TABLE, SYSTEM_FLUSH) \
    ...
    M(SYSTEM_MEMORY, "SYSTEM ALLOCATE MEMORY, SYSTEM FREE MEMORY", GLOBAL, SYSTEM) \
