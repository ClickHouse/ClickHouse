        ...
        bool allow_jwt)
    {
        ...
        if (num_password_fields > 1)
            throw Exception(ErrorCodes::BAD_ARGUMENTS, "More than one field of 'password', 'password_sha256_hex', "
                            ...
                            "'http_authentication', 'has_jwt' are used to specify authentication info for user {}. "
        ...
        if (num_password_fields < 1)
            throw Exception(ErrorCodes::BAD_ARGUMENTS, "Either 'password' or 'password_sha256_hex' "
                            ...
                            "or 'ssl_certificates' or 'ssh_keys' or 'http_authentication' or 'has_jwt' must be specified for user {}.", user_name);
