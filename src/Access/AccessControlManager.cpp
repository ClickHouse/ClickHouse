...
UUID AccessControlManager::login(
    const String & user_name, const String & password, const Poco::Net::IPAddress & address, const String & forwarded_for) const
{
    return MultipleAccessStorage::login(user_name, password, address, forwarded_for, *external_authenticators);
}
