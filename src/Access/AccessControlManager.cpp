...
std::shared_ptr<const SettingsProfilesInfo> AccessControlManager::getSettingsProfileInfo(const UUID & profile_id) const
{
    return settings_profiles_cache->getSettingsProfileInfo(profile_id);
}

std::shared_ptr<const SettingsProfilesInfo> AccessControlManager::getSettingsProfileInfo(const String & profile_name) const
{
    return settings_profiles_cache->getSettingsProfileInfo(profile_name);
}
