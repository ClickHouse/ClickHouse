...
struct RequestSettings
{
    ...
    /// Whether `use_native_copy` was set in the endpoint config. Lets backups tell an
    /// explicit opt-out apart from an unset endpoint (which defaults to native copy).
