                ...
                ObjectMetadata{
                    ...
                    Poco::Timestamp::fromEpochTime(
                        std::chrono::duration_cast<std::chrono::seconds>(
                            blob.Details.LastModified.operator std::chrono::system_clock::time_point().time_since_epoch()).count()),
                    {}});
        }
...
ObjectMetadata AzureObjectStorage::getObjectMetadata(const std::string & path) const
{
    ...
    result.last_modified.emplace(properties.LastModified.operator std::chrono::system_clock::time_point().time_since_epoch().count());
    return result;
}
