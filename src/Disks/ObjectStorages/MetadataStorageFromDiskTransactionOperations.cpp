...
void SetLastModifiedOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
...
void ChmodOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
...
void UnlinkFileOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
...
void CreateDirectoryOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
...
void CreateDirectoryRecursiveOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
    namespace fs = std::filesystem;
    fs::path p(path);
    while (!disk.exists(p))
...
void RemoveDirectoryOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
    disk.removeDirectory(path);
}
...
void RemoveRecursiveOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
    if (disk.isFile(path))
...
void CreateHardlinkOperation::execute(std::unique_lock<CancelableSharedMutex> & lock)
{
...
void MoveFileOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
...
void MoveDirectoryOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
...
void ReplaceFileOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
...
void WriteFileOperation::execute(std::unique_lock<CancelableSharedMutex> &)
{
    if (disk.exists(path))
    {
        existed = true;
...
void AddBlobOperation::execute(std::unique_lock<CancelableSharedMutex> & metadata_lock)
{
...
void UnlinkMetadataFileOperation::execute(std::unique_lock<CancelableSharedMutex> & metadata_lock)
{
...
void SetReadonlyFileOperation::execute(std::unique_lock<CancelableSharedMutex> & metadata_lock)
{
    auto metadata = metadata_storage.readMetadataUnlocked(path, metadata_lock);
