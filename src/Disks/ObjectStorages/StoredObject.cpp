...
StoredObject::StoredObject(
    ...
    , connected_path(connected_path_)
...
const std::string & StoredObject::getConnectedPath() const
{
    ...
    bool object_bypasses_cache)
{
    if (object_bypasses_cache)
        return StoredObject(object_path, connected_path, object_size, {});
    ...
    return StoredObject(object_path, connected_path, object_size, std::move(path_key_for_cache_creator));
}
