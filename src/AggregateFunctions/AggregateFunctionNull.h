...
public:
    ...
    void compileMerge(llvm::IRBuilderBase & builder, llvm::Value * aggregate_data_dst_ptr, llvm::Value * aggregate_data_src_ptr) const override
    {
        ...
        if constexpr (result_is_nullable)
        {
            auto * aggregate_data_is_null_dst_value = b.CreateLoad(aggregate_data_dst_ptr->getType(), aggregate_data_dst_ptr);
            auto * aggregate_data_is_null_src_value = b.CreateLoad(aggregate_data_src_ptr->getType(), aggregate_data_src_ptr);
        ...
        auto * ty_aggregate_data_dst_ptr = aggregate_data_dst_ptr->getType()->getScalarType();
        ...
        auto * ty_aggregate_data_src_ptr = aggregate_data_src_ptr->getType()->getScalarType();
