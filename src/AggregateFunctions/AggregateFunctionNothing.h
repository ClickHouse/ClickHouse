...
public:
    ...
    void serialize(ConstAggregateDataPtr __restrict, WriteBuffer & buf, std::size_t) const override
    {
        writeChar('\0', buf);
    }

    void deserialize(AggregateDataPtr, ReadBuffer & buf, std::size_t, Arena *) const override
    {
