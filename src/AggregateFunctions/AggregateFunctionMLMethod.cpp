...
SELECT length(stochasticLinearRegression(0.01)(target, x1, x2)) FROM train_data
    ...
    factory.registerFunction("stochasticLinearRegression", {createAggregateFunctionMLMethod<FuncLinearRegression>, documentation_linear, {.is_float_promoting = true}});
...
0
    ...
    factory.registerFunction("stochasticLogisticRegression", {createAggregateFunctionMLMethod<FuncLogisticRegression>, documentation_logistic, {.is_float_promoting = true}});
}
