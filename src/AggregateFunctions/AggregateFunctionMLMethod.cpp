...
void Adam::update(
    UInt64 batch_size, SafeVector<Float64> & weights, Float64 & bias, Float64 learning_rate, const SafeVector<Float64> & batch_gradient)
{
    ...
    size_t row_num)
{
    ...
    SafeVector<Float64> shifted_weights(weights.size());
    ...
    ContextPtr /*context*/) const
{
    ...
    SafeVector<Float64> results(limit, bias);
    ...
    size_t row_num)
{
    ...
    SafeVector<Float64> values(weights.size());
