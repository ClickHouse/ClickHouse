...
public:
    ...
    void serialize(ConstAggregateDataPtr __restrict place, WriteBuffer & buf, std::size_t) const override
    {
        this->data(place).serialize(buf);
    }

    void deserialize(AggregateDataPtr __restrict place, ReadBuffer & buf, std::size_t, Arena *) const override
    {
