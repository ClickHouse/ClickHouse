...
public:
    ...
    void add(AggregateDataPtr __restrict place, const IColumn ** columns, size_t row_num, Arena *) const override
    {
        ...
        /// Limit unrolling: x86-64-v3 defaults to unroll-by-4 which hurts when
        /// category_count is small (the unrolled body is skipped, paying extra
        /// setup cost per row). Unroll-by-2 matches master's codegen.
