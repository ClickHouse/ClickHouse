...
└─────────────────────────────┘
    ...
    factory.registerFunction("covarSampMatrix", {createAggregateFunctionVarianceMatrix<AggregateFunctionCovarSampMatrix>, covarSampMatrix_documentation, {.is_float_promoting = true}});
...
└───────────────────────────┘
    ...
    factory.registerFunction("covarPopMatrix", {createAggregateFunctionVarianceMatrix<AggregateFunctionCovarPopMatrix>, covarPopMatrix_documentation, {.is_float_promoting = true}});
...
└────────────────────────┘
    ...
    factory.registerFunction("corrMatrix", {createAggregateFunctionVarianceMatrix<AggregateFunctionCorrMatrix>, corrMatrix_documentation, {.is_float_promoting = true}});
}
