...
└───────────┴───────────────────────┘
    ...
    factory.registerFunction("any", {createAggregateFunctionAny, default_properties}, AggregateFunctionFactory::Case::Sensitive);
...
└───────────────┴───────────────────────────┘
    ...
    factory.registerFunction("anyLast", {createAggregateFunctionAnyLast, default_properties}, AggregateFunctionFactory::Case::Sensitive);
