    ...
    const Settings *)
{
    ...
    throw Exception( ErrorCodes::ILLEGAL_TYPE_OF_ARGUMENT , "Illegal types ({}, {}) of arguments of aggregate function {}, must be Native Ints, Native UInts or Floats", x_arg->getName(), y_arg->getName(), name);
}
