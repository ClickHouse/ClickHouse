...
└───────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("simpleLinearRegression", {createAggregateFunctionSimpleLinearRegression, documentation_simpleLinearRegression, {.is_float_promoting = true}});
}
