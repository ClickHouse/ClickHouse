...
template <typename TimestampType, typename ValueType, bool array_agruments>
class AggregateFunctionTimeSeriesGroupArraySorted final :
    public IAggregateFunctionHelper<AggregateFunctionTimeSeriesGroupArraySorted<TimestampType, ValueType, array_agruments>>
{
public:
    static constexpr bool DateTime64Supported = true;

    using Base = IAggregateFunctionHelper<AggregateFunctionTimeSeriesGroupArraySorted<TimestampType, ValueType, array_agruments>>;
    ...
    {
        return "timeSeriesGroupArraySorted";
    }
    ...
    struct Data
    {
        ...
        {
            auto less_by_timestamp = [](const Element & left, const Element & right) {
            ...
            {
                auto equal_by_timestamp = [](const Element & left, const Element & right) {
                    return left.timestamp == right.timestamp;
                };
    ...
    explicit AggregateFunctionTimeSeriesGroupArraySorted(const DataTypes & argument_types_)
