...
class AggregateFunctionTimeSeriesGroupArraySorted final :
    public IAggregateFunctionHelper<AggregateFunctionTimeSeriesGroupArraySorted<TimestampType, ValueType, array_arguments>>
{
public:
    static constexpr bool DateTime64Supported = true;

    using Base = IAggregateFunctionHelper<AggregateFunctionTimeSeriesGroupArraySorted<TimestampType, ValueType, array_arguments>>;
