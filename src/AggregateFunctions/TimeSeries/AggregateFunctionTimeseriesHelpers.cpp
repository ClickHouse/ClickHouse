...
└─────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("timeSeriesRateToGrid",
        {createAggregateFunctionTimeseries</* is_rate_or_resets = */ true, /* is_predict = */ false, /* is_quantile = */ false, AggregateFunctionTimeseriesExtrapolatedValueTraits, AggregateFunctionTimeseriesExtrapolatedValue>, documentation_timeSeriesRateToGrid});
...
└─────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("timeSeriesDeltaToGrid",
        {createAggregateFunctionTimeseries</* is_rate_or_resets = */ false, /* is_predict = */ false, /* is_quantile = */ false, AggregateFunctionTimeseriesExtrapolatedValueTraits, AggregateFunctionTimeseriesExtrapolatedValue>, documentation_timeSeriesDeltaToGrid});
...
└────────────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("timeSeriesInstantRateToGrid",
        {createAggregateFunctionTimeseries</* is_rate_or_resets = */ true, /* is_predict = */ false, /* is_quantile = */ false, AggregateFunctionTimeseriesInstantValueTraits, AggregateFunctionTimeseriesInstantValue>, documentation_timeSeriesInstantRateToGrid});
...
└─────────────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("timeSeriesInstantDeltaToGrid",
        {createAggregateFunctionTimeseries</* is_rate_or_resets = */ false, /* is_predict = */ false, /* is_quantile = */ false, AggregateFunctionTimeseriesInstantValueTraits, AggregateFunctionTimeseriesInstantValue>, documentation_timeSeriesInstantDeltaToGrid});
...
└───────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("timeSeriesDerivToGrid",
        {createAggregateFunctionTimeseries</* is_rate_or_resets = */ false, /* is_predict = */ false, /* is_quantile = */ false, AggregateFunctionTimeseriesLinearRegressionTraits, AggregateFunctionTimeseriesLinearRegression>, documentation_timeSeriesDerivToGrid});
...
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("timeSeriesPredictLinearToGrid",
        {createAggregateFunctionTimeseries</* is_rate_or_resets = */ false, /* is_predict = */ true, /* is_quantile = */ false, AggregateFunctionTimeseriesLinearRegressionTraits, AggregateFunctionTimeseriesLinearRegression>, documentation_timeSeriesPredictLinearToGrid});
...
└───────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("timeSeriesChangesToGrid",
        {createAggregateFunctionTimeseries</* is_rate_or_resets = */ false, /* is_predict = */ false, /* is_quantile = */ false, AggregateFunctionTimeseriesChangesTraits, AggregateFunctionTimeseriesChanges>, documentation_timeSeriesChangesToGrid});
...
└──────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("timeSeriesResetsToGrid",
        {createAggregateFunctionTimeseries</* is_rate_or_resets = */ true, /* is_predict = */ false, /* is_quantile = */ false, AggregateFunctionTimeseriesChangesTraits, AggregateFunctionTimeseriesChanges>, documentation_timeSeriesResetsToGrid});
...
└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    factory.registerFunction("timeSeriesResampleToGridWithStaleness",
        {createAggregateFunctionTimeseries</* is_rate_or_resets = */ false, /* is_predict = */ false, /* is_quantile = */ false, AggregateFunctionTimeseriesToGridSparseTraits, AggregateFunctionTimeseriesToGridSparse>, documentation_timeSeriesResampleToGridWithStaleness});
    factory.registerAlias("timeSeriesLastToGrid", "timeSeriesResampleToGridWithStaleness");

    registerAggregateFunctionTimeseriesOverTimeGrid(factory);
}
