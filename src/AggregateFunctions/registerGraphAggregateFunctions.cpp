...
(GraphDiameterGeneral) \
(GraphIsTreeGeneral) \
(GraphComponentsCountGeneral) \
(GraphProbabilityConnected) \
(GraphAvgChildrenGeneral) \
(EdgeDistanceGeneral) \
(GraphTreeHeight) \
(GraphCountBridges) \
(GraphCountStronglyConnectedComponents) \
(GraphIsBipartiteGeneral) \
(GraphCountBipartiteMaximumMatching) \
(GraphMaxFlow)
