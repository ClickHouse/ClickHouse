...
└──────────────────────────────────────┘
    ...
    factory.registerFunction(AggregateFunctionLargestTriangleThreeBuckets::name, {createAggregateFunctionLargestTriangleThreeBuckets, documentation, {.is_float_promoting = true}});
