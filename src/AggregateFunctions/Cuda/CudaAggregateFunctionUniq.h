...
struct CudaAggregateFunctionUniqHLL12Data
{
    ...
    __device__ __host__ void initNonzeroData() { set.initNonzeroData(); }
...
public:
    size_t cudaSizeOfData() const override { return sizeof(CudaAggregateFunctionUniqHLL12Data); }
    bool isDataNeeded() const override { return true; }
    ...
    ResultType getResult(CudaAggregateDataPtr place) const override { return ((CudaAggregateFunctionUniqHLL12Data *)place)->set.size(); }
