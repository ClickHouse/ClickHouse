...
public:
    size_t cudaSizeOfData() const override { return sizeof(CudaAggregateFunctionCountData); }
    bool isDataNeeded() const override { return false; }
    ...
    ResultType getResult(CudaAggregateDataPtr place) const override { return ((CudaAggregateFunctionCountData *)place)->count; }
