...
void registerAggregateFunctionsArgMin(AggregateFunctionFactory &);
void registerAggregateFunctionsArgMax(AggregateFunctionFactory &);
...
{
    {
        ...
        registerAggregateFunctionsArgMin(factory);
        registerAggregateFunctionsArgMax(factory);
