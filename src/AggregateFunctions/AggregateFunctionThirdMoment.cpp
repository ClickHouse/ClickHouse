...
└────────────────────┘
    ...
    factory.registerFunction("skewSamp", {createAggregateFunctionStatisticsUnary<AggregateFunctionThirdMoment, StatisticsFunctionKind::skewSamp>, documentation_skewSamp, {.is_float_promoting = true}});
...
└────────────────────┘
    ...
    factory.registerFunction("skewPop", {createAggregateFunctionStatisticsUnary<AggregateFunctionThirdMoment, StatisticsFunctionKind::skewPop>, documentation_skewPop, {.is_float_promoting = true}});
}
