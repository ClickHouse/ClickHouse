...
└──────────┘
    ...
    factory.registerFunction("varSamp", {createAggregateFunctionStatisticsUnary<AggregateFunctionSecondMoment, StatisticsFunctionKind::varSamp>, documentation_varSamp, {.is_float_promoting = true}});
...
└─────────┘
    ...
    factory.registerFunction("varPop", {createAggregateFunctionStatisticsUnary<AggregateFunctionSecondMoment, StatisticsFunctionKind::varPop>, documentation_varPop, {.is_float_promoting = true}});
...
└────────────────────────┘
    ...
    factory.registerFunction("stddevSamp", {createAggregateFunctionStatisticsUnary<AggregateFunctionSecondMoment, StatisticsFunctionKind::stddevSamp>, documentation_stddevSamp, {.is_float_promoting = true}});
...
└───────────────────┘
    ...
    factory.registerFunction("stddevPop", {createAggregateFunctionStatisticsUnary<AggregateFunctionSecondMoment, StatisticsFunctionKind::stddevPop>, documentation_stddevPop, {.is_float_promoting = true}});
