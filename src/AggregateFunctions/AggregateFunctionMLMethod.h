...
public:
    ...
    virtual void compute(
        SafeVector<Float64> & batch_gradient,
        const SafeVector<Float64> & weights,
        Float64 bias,
        Float64 l2_reg_coef,
        Float64 target,
...
public:
    ...
    virtual void
    update(UInt64 batch_size, SafeVector<Float64> & weights, Float64 & bias, Float64 learning_rate, const SafeVector<Float64> & gradient)
        = 0;
...
public:
    void update(
        UInt64 batch_size,
        SafeVector<Float64> & weights,
        Float64 & bias,
        Float64 learning_rate,
        const SafeVector<Float64> & batch_gradient) override;
};
...
private:
    Float64 alpha{0.1};
    SafeVector<Float64> accumulated_gradient;
};
...
private:
    ...
    SafeVector<Float64> average_gradient;
    SafeVector<Float64> average_squared_gradient;
};
...
private:
    ...
    UInt64 iter_num = 0;
    SafeVector<Float64> gradient_batch;
    UInt64 batch_size;
