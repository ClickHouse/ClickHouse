...
#define AUTH_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(SensitiveString, secret_access_key, "", "", 0) \
    DECLARE(SensitiveString, session_token, "", "", 0) \
    DECLARE(String, region, "", "", 0) \
    DECLARE(SensitiveString, server_side_encryption_customer_key_base64, "", "", 0) \
    ...
    DECLARE(SensitiveString, google_adc_client_secret, "", "", 0) \
    DECLARE(SensitiveString, google_adc_refresh_token, "", "", 0) \
