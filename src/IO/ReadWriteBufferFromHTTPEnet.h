...
class UpdatableSessionBaseEnet
{
protected:
    SessionPtr session;
    UInt64 redirects{0};
...
public:
    ...
    explicit UpdatableSessionBaseEnet(const Poco::URI uri, const ConnectionTimeouts & timeouts_, UInt64 max_redirects_)
    ...
    virtual ~UpdatableSessionBaseEnet() = default;
};


namespace detail
{
    template <typename UpdatableSessionEnetPtr>
    class ReadWriteBufferFromHTTPBaseEnet : public SeekableReadBuffer, public WithFileName, public WithFileSize
    {
    public:
    ...
    protected:
        ...
        UpdatableSessionEnetPtr session;
    ...
    public:
        ...
        explicit ReadWriteBufferFromHTTPBaseEnet(
            UpdatableSessionEnetPtr session_,
            Poco::URI uri_,
            ...
            , settings {settings_}
            , log(&Poco::Logger::get("ReadWriteBufferFromHTTPEnet"))
        {
...
class UpdatableSessionEnet : public UpdatableSessionBaseEnet<HTTPSessionPtr>
{
    using Parent = UpdatableSessionBaseEnet<HTTPSessionPtr>;

public:
    UpdatableSessionEnet(const Poco::URI uri, const ConnectionTimeouts & timeouts_, const UInt64 max_redirects_)
...
class ReadWriteBufferFromHTTPEnet : public detail::ReadWriteBufferFromHTTPBaseEnet<std::shared_ptr<UpdatableSessionEnet>>
{
    using Parent = detail::ReadWriteBufferFromHTTPBaseEnet<std::shared_ptr<UpdatableSessionEnet>>;

public:
    ReadWriteBufferFromHTTPEnet(
        Poco::URI uri_,
        const std::string & method_,
        OutStreamCallback out_stream_callback_,
        ...
        : Parent(
            std::make_shared<UpdatableSessionEnet>(uri_, timeouts, max_redirects),
            uri_,
            credentials_,
            method_,
...
class RangedReadWriteBufferFromHTTPFactoryEnet : public ParallelReadBuffer::ReadBufferFactory, public WithFileName
{
    using OutStreamCallback = ReadWriteBufferFromHTTPEnet::OutStreamCallback;

public:
    RangedReadWriteBufferFromHTTPFactoryEnet(
    ...
    SeekableReadBufferPtr getReader() override
    {
        ...
        return std::make_shared<ReadWriteBufferFromHTTPEnet>(
            uri,
            method,
            out_stream_callback,
            timeouts,
            ...
            ReadWriteBufferFromHTTPEnet::Range{next_range->first, next_range->second - 1},
            remote_host_filter,
...
class UpdatablePooledSessionEnet : public UpdatableSessionBaseEnet<PooledHTTPSessionPtr>
{
    using Parent = UpdatableSessionBaseEnet<PooledHTTPSessionPtr>;

private:
    size_t per_endpoint_pool_size;

public:
    explicit UpdatablePooledSessionEnet(
...
class PooledReadWriteBufferFromHTTPEnet : public detail::ReadWriteBufferFromHTTPBaseEnet<std::shared_ptr<UpdatablePooledSessionEnet>>
{
    using Parent = detail::ReadWriteBufferFromHTTPBaseEnet<std::shared_ptr<UpdatablePooledSessionEnet>>;

public:
    explicit PooledReadWriteBufferFromHTTPEnet(
        Poco::URI uri_,
        const std::string & method_ = {},
        OutStreamCallback out_stream_callback_ = {},
        ...
        : Parent(
            std::make_shared<UpdatablePooledSessionEnet>(uri_, timeouts_, max_redirects, max_connections_per_endpoint),
            uri_,
            credentials_,
            method_,
            out_stream_callback_,
