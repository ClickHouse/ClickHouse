...
/// What a guarded copy asks of the DESTINATION. The source generation is named by the `src_etag` and
/// `src_version_id` arguments of the copy functions instead.
...
/// Copies a whole file from S3 to S3. `src_size` is the size of the source object.
