...
TEST_F(ReadBufferFromS3Test, HavingZeroBytes)
{
    ...
    DB::RelativePathWithMetadata path_with_metadata("test_key", object_metadata);
    auto buf = DB::createReadBuffer(path_with_metadata, object_storage, query_context, log);
