...
private:
    ...
    virtual void batchSerializeValueIntoMemoryWithNull(std::vector<char *> & memories, const UInt8 * is_null) const override;

    char * serializeValueIntoMemory(size_t n, char * memory) const override;
    virtual void batchSerializeValueIntoMemory(std::vector<char *> & memories) const override;
