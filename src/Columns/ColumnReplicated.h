...
public:
    ...
    {
        return Base::create(nested_column_->shallowMutate(), indexes_->shallowMutate());
    }

    static Ptr create(const ColumnPtr & nested_column_)
    {
        return Base::create(nested_column_->shallowMutate());
    }
    ...
    {
        return Base::create(nested_column_->shallowMutate(), std::move(indexes_));
    }
