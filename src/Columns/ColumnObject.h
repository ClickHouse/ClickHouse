...
public:
    struct Statistics
    {
        /// In-memory estimates used to select per-path serialization before creating streams.
        ...
        struct PathSerializationStatistics
        {
            size_t num_rows = 0;
            size_t num_defaults = 0;
        };
        UnorderedMapWithMemoryTracking<String, PathSerializationStatistics> path_serialization_statistics;
