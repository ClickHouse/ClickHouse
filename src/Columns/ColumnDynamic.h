...
public:
    ...
    {
        return ColumnDynamic::create(variant_column_->assumeMutableForCreation(), variant_info_, max_dynamic_types_, global_max_dynamic_types_, statistics_);
    }
    ...
    {
        return create(std::move(variant_column_)->assumeMutableForCreation(), variant_type, max_dynamic_types_, global_max_dynamic_types_, statistics_);
    }
