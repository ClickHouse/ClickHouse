...
public:
    ...
    struct Statistics
    {
        ...
        /// part prefix (which only reflects the first granule) are not reliable. Optimizations that
        /// change on-disk layout based on statistics (e.g., Dynamic narrowing) must check this flag.
        bool reliable = true;
