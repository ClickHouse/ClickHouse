...
{
public:
    CudaHostStringsBuffer(size_t max_str_num_, size_t max_sz_, bool has_lens_ = true, bool has_offsets_ = true, bool has_offsets64_ = true);
    ...
    void                        addData(size_t str_num_, size_t str_buf_sz_, const char * str_buf_, const UInt64 * offsets_,
...
protected:
    ...
    CudaHostPinnedArrayPtr<UInt32>      lens;
    CudaHostPinnedArrayPtr<UInt32>      offsets;
