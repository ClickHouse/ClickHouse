...
{
    /// TODO: check if default_field is null.
    auto new_values = nested_column->createWithOffsets(offsets, default_field, total_rows, shift);
    auto new_null_map = null_map->createWithOffsets(offsets, Field(1), total_rows, shift);
