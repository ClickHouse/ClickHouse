...
namespace
{
    ...
    /// The vectors are passed by reference: passing a vector wider than the enabled target features by value
    /// changes the ABI (a warning), and being always-inlined this is free anyway.
