...
template class IColumnHelper<ColumnVector<UInt512>, ColumnFixedSizeHelper>;
...
template class IColumnHelper<ColumnVector<Int512>, ColumnFixedSizeHelper>;
...
template class IColumnHelper<ColumnDecimal<Decimal512>, ColumnFixedSizeHelper>;
