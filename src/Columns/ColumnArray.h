...
public:
    ...
    /// Both write the number of elements and then the elements themselves.
    bool serializedValueMatchesHashStream() const override { return getData().serializedValueMatchesHashStream(); }
