...
{
    auto result_identifier_node = std::make_shared<IdentifierNode>(identifier);
    result_identifier_node->table_expression_modifiers = table_expression_modifiers;
    return result_identifier_node;
}
