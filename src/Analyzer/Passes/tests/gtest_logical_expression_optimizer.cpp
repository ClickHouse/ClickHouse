...
TEST(OptimizeAndCompareChain, compare)
{
    ...
    test_f("a < b AND b < 5", "(a < b) AND (b < 5) AND (a < 5)");
    test_f("a < b AND c < b AND b < 5", "(a < b) AND (c < b) AND (b < 5) AND (a < 5) AND (c < 5)");
    test_f("a < b AND a = c AND b < 5", "(a < b) AND (a = c) AND (b < 5) AND (a < 5) AND (c < 5)");
