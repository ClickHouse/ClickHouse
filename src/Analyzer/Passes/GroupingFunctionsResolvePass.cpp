...
public:
    ...
    void enterImpl(const QueryTreeNodePtr & node)
    {
        ...
        bool force_grouping_standard_compatibility_v = getSettings()[force_grouping_standard_compatibility];
        ...
        switch (group_by_kind)
        {
            case GroupByKind::ORDINARY:
            {
                auto grouping_ordinary_function
                    = std::make_shared<FunctionGroupingOrdinary>(arguments_indexes, force_grouping_standard_compatibility_v);
            ...
            case GroupByKind::ROLLUP:
            {
                auto grouping_rollup_function = std::make_shared<FunctionGroupingForRollup>(
                    arguments_indexes, aggregation_keys_size, force_grouping_standard_compatibility_v);
            ...
            case GroupByKind::GROUPING_SETS:
            {
                auto grouping_grouping_sets_function = std::make_shared<FunctionGroupingForGroupingSets>(
                    arguments_indexes, grouping_sets_keys_indexes, force_grouping_standard_compatibility_v);
