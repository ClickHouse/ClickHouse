...
/// it may contain a decimal-backed leaf (Decimal/Time64, or a Dynamic that can hold one), or a Variant,
/// whose literal does not keep the active member type.
...
/// The active member of a Variant reached through Nullable/Array/Tuple/Map/Variant/Dynamic is named by its
/// own type; under any other wrapper, and below an Object whose JSON text carries none, it is not.
