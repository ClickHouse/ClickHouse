            ...
            (ColumnNameToColumnNodeMap & node_map) mutable
        {
            ...
            for (const auto & column_name_and_type : data.column_names_and_types)
            {
                ...
                if (column_default && column_default->kind == ColumnDefaultKind::Alias)
                {
                    ...
                    expandColumnMatchersInExpression(alias_expression_ast, columns_description);
                    validateNoCyclicAliasesAfterExpansion(column_name_and_type.name, alias_expression_ast, columns_description);
