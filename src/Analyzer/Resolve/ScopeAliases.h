...
struct ScopeAliases
{
    ...
    /// Insert into the alias map. Returns true if a new entry was added.
    bool registerAlias(IdentifierLookupContext lookup_context, const std::string & alias_name, QueryTreeNodePtr node)
    {
