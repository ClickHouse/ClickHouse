...
void addQueryTreePasses(QueryTreePassManager & manager, bool only_analyze, bool no_aliasing)
{
    manager.addPass(std::make_unique<QueryAnalysisPass>(only_analyze, no_aliasing));
