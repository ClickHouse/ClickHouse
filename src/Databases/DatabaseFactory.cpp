...
DatabasePtr DatabaseFactory::get(const ASTCreateQuery & create, const String & metadata_path, ContextPtr context, LoadingStrictnessLevel mode, bool internal, bool is_metadata_replay, bool is_restore_from_backup)
{
    ...
    DatabasePtr impl = getImpl(create, metadata_path, context, mode, internal, is_metadata_replay, is_restore_from_backup);
...
DatabasePtr DatabaseFactory::getImpl(const ASTCreateQuery & create, const String & metadata_path, ContextPtr context, LoadingStrictnessLevel mode, bool internal, bool is_metadata_replay, bool is_restore_from_backup)
{
