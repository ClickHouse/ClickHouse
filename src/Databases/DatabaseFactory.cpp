...
DatabasePtr DatabaseFactory::get(const ASTCreateQuery & create, const String & metadata_path, ContextPtr context, LoadingStrictnessLevel mode, bool internal, bool replays_stored_definition)
{
    ...
    DatabasePtr impl = getImpl(create, metadata_path, context, mode, internal, replays_stored_definition);
...
DatabasePtr DatabaseFactory::getImpl(const ASTCreateQuery & create, const String & metadata_path, ContextPtr context, LoadingStrictnessLevel mode, bool internal, bool replays_stored_definition)
{
    ...
    Arguments arguments{
        ...
        .mode = mode,
        .internal = internal,
        .replays_stored_definition = replays_stored_definition};
