...
DatabasePtr DatabaseFactory::get(const ASTCreateQuery & create, const String & metadata_path, ContextPtr context, LoadingStrictnessLevel mode, bool internal, bool loading_stored_metadata)
{
    ...
    DatabasePtr impl = getImpl(create, metadata_path, context, mode, internal, loading_stored_metadata);
...
DatabasePtr DatabaseFactory::getImpl(const ASTCreateQuery & create, const String & metadata_path, ContextPtr context, LoadingStrictnessLevel mode, bool internal, bool loading_stored_metadata)
{
    ...
    Arguments arguments{
        ...
        .mode = mode,
        .internal = internal,
        .loading_stored_metadata = loading_stored_metadata};
