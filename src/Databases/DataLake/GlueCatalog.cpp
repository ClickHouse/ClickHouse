...
namespace DB::Setting
{
    ...
    extern const SettingsBool s3_slow_down_after_network_error;
    ...
    , region(region_)
{
    ...
    bool slow_down_after_network_error = global_settings[DB::Setting::s3_slow_down_after_network_error];
