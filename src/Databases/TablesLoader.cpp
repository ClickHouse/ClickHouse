...
void TablesLoader::buildDependencyGraph()
{
    ...
    {
        auto new_ref_dependencies = getDependenciesFromCreateQuery(global_context, table_name, table_metadata.ast, global_context->getCurrentDatabase().getFullName(), /*can_throw*/ false, /*validate_current_database*/ false);
