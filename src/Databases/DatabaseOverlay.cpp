...
- `Overlay` delegates `CREATE TABLE` to its first source database. `CREATE VIEW`, `CREATE MATERIALIZED VIEW`, `CREATE DICTIONARY`, `ATTACH`, `ALTER`, `RENAME`, `DROP`, `DETACH`, and `TRUNCATE` are rejected; reads and `INSERT` pass through to the underlying tables.
)DOCS_MD",
