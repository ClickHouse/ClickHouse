        ...
        if (!args.create_query.attach)
            validateMaterializedPostgreSQLCoordinationSettings(
                *postgresql_replica_settings, args.context, args.database_name, args.uuid,
                configuration.database, /* postgres_table */ "");
