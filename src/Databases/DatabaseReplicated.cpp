...
namespace DatabaseReplicatedSetting
{
    ...
    extern const DatabaseReplicatedSettingsUInt32 database_replicated_logs_to_keep;
}
...
bool DatabaseReplicated::createDatabaseNodesInZooKeeper(const zkutil::ZooKeeperPtr & current_zookeeper)
{
    ...
    auto logs_to_keep = db_settings[DatabaseReplicatedSetting::database_replicated_logs_to_keep];
