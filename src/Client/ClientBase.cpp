...
void ClientBase::addCommonOptions(OptionsDescription & options_description)
{
    ...
    options_description.main_description->add_options()
        ...
        ("oauth-url", po::value<std::string>(), "The authentication URL for the device grant flow.")
        ("oauth-client-id", po::value<std::string>(), "Client ID for the authentication application.")
