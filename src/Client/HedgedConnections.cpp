...
HedgedConnections::HedgedConnections(
    ...
    : hedged_connections_factory(
          ...
          /// Value of this setting here has nothing to do with parallel replicas,
          /// so it is safe to use it even if allow_experimental_parallel_reading_from_replicas is disabled.
