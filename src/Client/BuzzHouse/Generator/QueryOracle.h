...
private:
    ...
    void addLimitOrOffset(RandomGenerator & rg, StatementGenerator & gen, uint32_t ncols, SelectStatementCore * ssc);
...
public:
    ...
    void generateImportQuery(
        RandomGenerator & rg, StatementGenerator & gen, bool test_content, const SQLTable & t, const SQLQuery & sq2, SQLQuery & sq4);
