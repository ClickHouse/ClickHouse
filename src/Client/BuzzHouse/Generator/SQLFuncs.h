...
const std::vector<CHAggregate> CHAggrs = {
    ...
    CHAggregate(SQLFunc::FUNCmaxMap, 0, 0, 2, 2, false),
    ...
    CHAggregate(SQLFunc::FUNCuniqCombined, 1, 1, 1, ulimited_params, false),
    CHAggregate(SQLFunc::FUNCuniqCombined64, 1, 1, 1, ulimited_params, false),
    ...
    CHAggregate(SQLFunc::FUNCquantile, 1, 1, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantiles, 1, ulimited_params, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantileExact, 1, 1, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantileExactLow, 1, 1, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantileExactHigh, 1, 1, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantileExactWeighted, 1, 1, 2, 2, false),
    CHAggregate(SQLFunc::FUNCquantileTiming, 1, 1, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantileTimingWeighted, 1, 1, 1, 2, false),
    CHAggregate(SQLFunc::FUNCquantileDeterministic, 1, 1, 1, 2, false),
    CHAggregate(SQLFunc::FUNCquantileTDigest, 1, 1, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantileTDigestWeighted, 1, 1, 2, 2, false),
    CHAggregate(SQLFunc::FUNCquantileBFloat16, 0, 1, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantileBFloat16Weighted, 0, 1, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantileDD, 0, 2, 1, 1, false),
    ...
    CHAggregate(SQLFunc::FUNCquantileGK, 2, 2, 1, 1, false),
    CHAggregate(SQLFunc::FUNCquantileInterpolatedWeighted, 1, 1, 2, 2, false),
