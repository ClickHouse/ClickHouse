...
const std::vector<CHTableFunction> CHTableFuncs = {
    ...
    /// `cosn` and `oss` are aliases of `s3`
    CHTableFunction(SQLTableFunc::TFcosn, 1, 8),
    ...
    CHTableFunction(SQLTableFunc::TFgenerate_series, 2, 3),
    CHTableFunction(SQLTableFunc::TFhdfs, 1, 3),
    CHTableFunction(SQLTableFunc::TFhdfsCluster, 2, 4),
    CHTableFunction(SQLTableFunc::TFhive, 5, 5),
    ...
    CHTableFunction(SQLTableFunc::TFicebergHDFS, 1, 6),
    CHTableFunction(SQLTableFunc::TFicebergHDFSCluster, 2, 7),
    ...
    CHTableFunction(SQLTableFunc::TFnumbers_mt, 1, 3),
    CHTableFunction(SQLTableFunc::TFodbc, 1, 3),
    CHTableFunction(SQLTableFunc::TFoss, 1, 8),
    ...
    CHTableFunction(SQLTableFunc::TFpaimonHDFS, 1, 6),
    CHTableFunction(SQLTableFunc::TFpaimonHDFSCluster, 2, 7),
    ...
    /// Without an argument, `zeros` returns an infinite table
    CHTableFunction(SQLTableFunc::TFzeros, 1, 1),
    CHTableFunction(SQLTableFunc::TFzeros_mt, 1, 1)};
