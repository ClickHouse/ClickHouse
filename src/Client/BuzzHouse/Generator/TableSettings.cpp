...
static std::unordered_map<String, CHSetting> mergeTreeTableSettings = {
    ...
    {"auto_statistics_types",
     CHSetting(
         ...
         false)},
    {"auto_statistics_assume_floats_distinct", trueOrFalseSetting},
    {"auto_statistics_assume_long_strings_distinct", trueOrFalseSetting},
    {"auto_statistics_long_string_distinct_min_length", highRangeNonZeroSetting},
    {"auto_statistics_long_string_distinct_probe_rows", highRangeNonZeroSetting},
