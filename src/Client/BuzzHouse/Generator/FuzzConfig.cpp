    ...
    , log(getLogger("BuzzHouse"))
{
    ...
    static const SettingEntries configEntries = {
        ...
        {"settings_oracle_only", [&](const JSONObjectType & value) { settings_oracle_only = value.getBool(); }},
        ...
        {"settings_oracle_settings", [&](const JSONObjectType & value) { settings_oracle_settings = loadArray(value); }},
