...
namespace Setting
{
    ...
    extern const SettingsIdentifierQuotingRule output_format_identifier_quoting_rule;
...
String format(const SecretHidingFormatSettings & settings)
{
    ...
    return settings.query.formatWithPossiblyHidingSensitiveData(
        ...
        settings.ctx->getSettingsRef()[Setting::output_format_identifier_quoting_rule],
