...
template struct AggregationMethodOneNumber<UInt128, AggregatedDataWithNullableUInt128Key>;
template struct AggregationMethodOneNumber<UInt256, AggregatedDataWithNullableUInt256Key>;
...
template struct AggregationMethodOneNumber<UInt128, AggregatedDataWithNullableUInt128KeyTwoLevel>;
template struct AggregationMethodOneNumber<UInt256, AggregatedDataWithNullableUInt256KeyTwoLevel>;
...
template struct AggregationMethodSingleLowCardinalityColumn<AggregationMethodOneNumber<UInt128, AggregatedDataWithNullableUInt128Key>>;
template struct AggregationMethodSingleLowCardinalityColumn<AggregationMethodOneNumber<UInt256, AggregatedDataWithNullableUInt256Key>>;
...
template struct AggregationMethodSingleLowCardinalityColumn<AggregationMethodOneNumber<UInt128, AggregatedDataWithNullableUInt128KeyTwoLevel>>;
template struct AggregationMethodSingleLowCardinalityColumn<AggregationMethodOneNumber<UInt256, AggregatedDataWithNullableUInt256KeyTwoLevel>>;
