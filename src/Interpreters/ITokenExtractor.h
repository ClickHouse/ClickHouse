...
template <Fn<bool(const char *, size_t)> Callback>
void DefaultTokenExtractor::forEachTokenImpl(const char * __restrict data, size_t length, Callback && callback) const
{
...
void forEachToken(const ITokenExtractor & extractor, const char * __restrict data, size_t length, Callback && callback)
{
    ...
    switch (extractor.getType())
    {
        case ITokenExtractor::Type::Default:
        {
            ...
            default_extractor.forEachTokenImpl(data, length, callback);
            return;
        }
        ...
        case ITokenExtractor::Type::Split:
        {
            ...
            detail::forEachTokenImpl(split_extractor, data, length, callback);
            return;
        }
        ...
        case ITokenExtractor::Type::SparseGram:
        {
            ...
            detail::forEachTokenImpl(sparse_gram_extractor, data, length, callback);
            return;
        }
