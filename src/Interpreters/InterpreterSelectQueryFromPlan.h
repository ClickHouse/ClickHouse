...
/// Executes a pre-built SELECT plan (e.g. a materialized query plan cache entry, or a
/// logical plan resolved against current storages) without constructing the analyzer.
