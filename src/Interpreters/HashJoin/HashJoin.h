...
private:
    ...
    /// One filler owns each lane. Live readers use the lane lock to observe its sketch as
    ...
    /// Guards lane registration and live estimate traversal; live sketch reads use per-lane locks.
