...
ColumnsDescription TraceLogElement::getColumnsDescription()
{
    ...
    return ColumnsDescription
    {
        ...
        {"lines", symbolized_type, "If the symbolization is enabled, contains strings with file names with line numbers, corresponding to the `trace`. Symbolization is supported on ELF platforms (such as Linux) and macOS; on FreeBSD this column is always empty."},
