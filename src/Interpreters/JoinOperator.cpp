...
namespace QueryPlanSerializationSetting
{
    ...
    extern const QueryPlanSerializationSettingsNonZeroUInt64 hash_join_max_fanout_per_pass;
    extern const QueryPlanSerializationSettingsBool hash_join_cap_partitions_by_l1_descriptors;
    ...
    : join_analyze_mode(join_analyze_mode_)
{
    ...
    hash_join_max_fanout_per_pass = query_settings[Setting::hash_join_max_fanout_per_pass];
    hash_join_cap_partitions_by_l1_descriptors = query_settings[Setting::hash_join_cap_partitions_by_l1_descriptors];
...
JoinSettings::JoinSettings(const QueryPlanSerializationSettings & settings, UInt64 version)
{
    ...
    hash_join_max_fanout_per_pass = settings[QueryPlanSerializationSetting::hash_join_max_fanout_per_pass];
    hash_join_cap_partitions_by_l1_descriptors = settings[QueryPlanSerializationSetting::hash_join_cap_partitions_by_l1_descriptors];
...
void JoinSettings::updatePlanSettings(QueryPlanSerializationSettings & settings, UInt64 version, const JoinOperator & join_operator) const
{
    ...
    settings[QueryPlanSerializationSetting::hash_join_max_fanout_per_pass] = hash_join_max_fanout_per_pass;
    settings[QueryPlanSerializationSetting::hash_join_cap_partitions_by_l1_descriptors] = hash_join_cap_partitions_by_l1_descriptors;
