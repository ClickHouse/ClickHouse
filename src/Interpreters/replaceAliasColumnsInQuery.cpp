...
bool replaceAliasColumnsInQuery(
        ...
        ColumnAliasReplacementMode replacement_mode)
{
    ColumnAliasesVisitor::Data aliases_column_data(
        columns, array_join_result_to_source, context, excluded_nodes, replacement_mode);
