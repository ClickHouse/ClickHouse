...
public:
    ...
    struct Entry
    {
        ...
        /// While using `use_real_disk_size` the aligned (real) size could differ from filled size.
        /// This means that `downloaded_size` in `FileSegment` could differ from `entry.getSize`
