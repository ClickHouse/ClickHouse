...
ColumnsDescription PartLogElement::getColumnsDescription()
{
    ...
    return ColumnsDescription
    {
        ...
        {"projections_duration_ms", std::make_shared<DataTypeMap>(std::make_shared<DataTypeString>(), std::make_shared<DataTypeUInt64>()), "Per-projection merge duration in milliseconds."},
    };
}
