...
#define LIST_OF_ALL_SYSTEM_LOGS(M) \
    ...
    M(TransposedMetricLog,   transposed_metric_log,"Contains history of metrics values from tables system.metrics and system.events, periodically flushed to disk.") \
