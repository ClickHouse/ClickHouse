...
private:
    ...
    Strings appendPrewhere(ExpressionActionsChain & chain, bool only_types);
    String appendPrewhereStep(const ASTPtr & ast, ExpressionActionsChain & chain, bool only_types);
