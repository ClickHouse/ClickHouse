...
public:
    ...
    ExpressionActionsPtr getActions(bool add_aliases, bool project_result);
    ExpressionActionsPtr getActions(bool project_result) { return getActions(project_result, true); }
