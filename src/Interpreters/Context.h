...
public:
    ...
    void setPageCache(size_t default_block_size, std::chrono::milliseconds history_window, const String & cache_policy, double size_ratio, size_t min_size_in_bytes, size_t max_size_in_bytes, double free_memory_ratio);
