...
class TextIndexPostingListCache;
class ProcessList;
class QueryStatus;
...
public:
    ...
    void setTextIndexPostingListCache(const String & cache_policy, size_t max_size_in_bytes, size_t max_entries, double size_ratio);
    void updateTextIndexPostingListCacheConfiguration(const Poco::Util::AbstractConfiguration & config);
    std::shared_ptr<TextIndexPostingListCache> getTextIndexPostingListCache() const;
    void clearTextIndexPostingListCache() const;
