...
void MutationsInterpreter::prepare(bool dry_run)
{
    ...
    /// The dependency graph is readable; EPHEMERAL inputs are excluded.
    ...
    if (!ephemeral_reading_materialized.empty())
    {
        ...
        changed_base_columns.insert(materialize_column_targets.begin(), materialize_column_targets.end());
