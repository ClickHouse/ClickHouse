...
TEST_F(FileCacheTest, QueryLimitContextRevivedDuringRelease)
{
    ...
    auto context1 = query_limit.getOrSetQueryContext(query_id, read_settings, cache_guard.lock());
    ...
    auto context2 = query_limit.getOrSetQueryContext(query_id, read_settings, cache_guard.lock());
    ...
    ASSERT_NO_THROW(doomed1 = query_limit.removeQueryContext(query_id, context1, cache_guard.lock()));
    ...
    ASSERT_NO_THROW(doomed2 = query_limit.removeQueryContext(query_id, context2, cache_guard.lock()));
