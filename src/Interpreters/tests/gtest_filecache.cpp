...
static String getFileSegmentPath(const String & base_path, const DB::FileCache::Key & key, size_t offset)
{
...
static void increasePriority(const HolderPtr & holder, size_t pos)
{
