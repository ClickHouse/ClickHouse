...
namespace Setting
{
    ...
    extern const SettingsBool reader_executor_unified_foreground;
...
ReadSettings Context::getReadSettings() const
{
    ...
    res.reader_executor_unified_foreground = settings_ref[Setting::reader_executor_unified_foreground];
