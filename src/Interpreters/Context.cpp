...
void Context::setPageCache(size_t default_block_size, std::chrono::milliseconds history_window, const String & cache_policy, double size_ratio, size_t min_size_in_bytes, size_t max_size_in_bytes, double free_memory_ratio)
{
    std::lock_guard lock(shared->mutex);
    ...
    shared->page_cache = std::make_shared<PageCache>(default_block_size, history_window, cache_policy, size_ratio, min_size_in_bytes, max_size_in_bytes, free_memory_ratio);
}
