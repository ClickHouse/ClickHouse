...
namespace FailPoints
{
    ...
    extern const char async_insert_disable_pause_before_schedule_on_shutdown[];
}
...
void AsynchronousInsertQueue::flushAndShutdown()
{
    try
    {
        ...
        fiu_do_on(FailPoints::async_insert_disable_pause_before_schedule_on_shutdown,
            { FailPointInjection::disableFailPoint(FailPoints::async_insert_pause_before_schedule); });
