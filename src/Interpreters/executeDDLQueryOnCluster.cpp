                                ...
                                const std::optional<String> & cluster)
{
    ...
    auto source = std::make_shared<DDLQueryStatusSource>(node_path, entry, context, hosts_to_wait, cluster);
...
DDLQueryStatusSource::DDLQueryStatusSource(
    const String & zk_node_path, const DDLLogEntry & entry, ContextPtr context_, const std::optional<Strings> & hosts_to_wait, const std::optional<String> & cluster)
