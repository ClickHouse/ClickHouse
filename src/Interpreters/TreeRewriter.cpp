    ...
    std::shared_ptr<TableJoin> table_join) const
{
    ...
    TreeOptimizer::apply(query, result.aliases, source_columns_set, tables_with_columns, getContext(), result.metadata_snapshot, result.storage, result.rewrite_subqueries);
