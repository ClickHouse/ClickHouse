...
template <bool prefer_use_maps_all> struct MapGetter<JoinKind::Inner, JoinStrictness::Any, prefer_use_maps_all> { using Map = HashJoin::MapsOne; static constexpr bool flagged = true; };
