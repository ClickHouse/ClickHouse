...
private:
    ...
    void executeMergeAggregated(QueryPlan & query_plan, bool overflow_row, bool final, bool has_grouping_sets, bool optimize_distributed_aggregation);
    ...
    void executeOrder(QueryPlan & query_plan, InputOrderInfoPtr sorting_info, bool optimize_distributed_aggregation);
