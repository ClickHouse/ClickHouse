    ...
    try
    {
        ...
        /// Everything related to query log.
        {
            ...
            auto exception_callback =
                [start_watch, elem, context, out_ast, internal, log_as_internal, my_quota(quota), normalized_query_hash, implicit_tcl_executor, query_span, query_result_cache, async_insert_token_to_finish](bool log_error) mutable
            {
                if (async_insert_token_to_finish)
                {
                    query_result_cache->finishAsyncInsert(async_insert_token_to_finish);
