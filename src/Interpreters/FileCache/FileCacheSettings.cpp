...
#define LIST_OF_FILE_CACHE_SETTINGS(DECLARE, ALIAS) \
    ...
    DECLARE(Bool, filesystem_cache_expose_prometheus_eviction_metrics, true, "Expose Prometheus metrics describing filesystem cache eviction activity for this cache (filesystem_cache_evictions_total, _evicted_bytes_total, _evicted_segment_hits, _evicted_segment_size_bytes).", 0) \
