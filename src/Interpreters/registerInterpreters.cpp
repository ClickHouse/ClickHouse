...
void registerInterpreters()
{
    ...
    registerInterpreterCreateEndpointQuery(factory);
    registerInterpreterAlterEndpointQuery(factory);
    registerInterpreterDropEndpointQuery(factory);
    registerInterpreterCreateClusterCatalogQuery(factory);
    registerInterpreterAlterShardQuery(factory);
    registerInterpreterAlterClusterQuery(factory);
