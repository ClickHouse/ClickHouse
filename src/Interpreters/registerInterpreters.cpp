...
void registerInterpreters()
{
    ...
    registerInterpreterCreateClusterQuery(factory);
    registerInterpreterAlterClusterQuery(factory);
    registerInterpreterDropClusterQuery(factory);
    registerInterpreterShowCreateShardQuery(factory);
    registerInterpreterShowCreateClusterQuery(factory);
