...
void serializeAggregateDescriptions(const AggregateDescriptions & aggregates, WriteBuffer & out, bool for_cache_key = false);
...
void serializeAggregateDescriptionsWithoutArguments(const AggregateDescriptions & aggregates, WriteBuffer & out, bool for_cache_key = false);
