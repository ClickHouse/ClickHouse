    ...
    bool all_keys_are_const) const
{
    ...
    /// When the state precomputes per-row hashes, `emplaceKey` prefetches using the
    /// precomputed hash. Avoid computing the key and hash again solely for generic prefetching.
