...
private:
    ...
    std::optional<QueryPipeline> distributedWriteIntoReplicatedMergeTreeOrDataLakeFromClusterStorage(const ASTInsertQuery & query, ContextPtr local_context, StorageMetadataPtr storage_metadata);
};
