...
QueryPipeline InterpreterShowCreateQuery::executeImpl()
{
        ...
        (show_query = query_ptr->as<ASTShowCreateDictionaryQuery>()))
    {
        ...
        create_query = DatabaseCatalog::instance().getDatabaseOrThrow(table_id.database_name, getContext())->getCreateTableQuery(table_id.table_name, getContext());
    ...
    else if ((show_query = query_ptr->as<ASTShowCreateDatabaseQuery>()))
    {
        ...
        create_query = DatabaseCatalog::instance().getDatabaseOrThrow(show_query->getDatabase(), getContext())->getCreateDatabaseQuery();
    }
