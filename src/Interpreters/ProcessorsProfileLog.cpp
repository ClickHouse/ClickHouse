...
ColumnsDescription ProcessorProfileLogElement::getColumnsDescription()
{
    return ColumnsDescription
    {
        ...
        {"memory_allocated_bytes", std::make_shared<DataTypeUInt64>(), "The number of bytes allocated while executing processor work. It excludes processor prepare, scheduling and destruction."},
        {"memory_freed_bytes", std::make_shared<DataTypeUInt64>(), "The number of bytes freed while executing processor work. It excludes processor prepare, scheduling and destruction."},
    };
}
