...
ColumnsDescription ProcessorProfileLogElement::getColumnsDescription()
{
    return ColumnsDescription
    {
        ...
        {"memory_usage_delta", std::make_shared<DataTypeInt64>(), "Signed net change in query-thread memory while executing processor work. It excludes processor prepare, scheduling and destruction, and can be negative."},
    };
}
