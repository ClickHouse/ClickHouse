...
void QueryLogElement::appendClientInfo(const ClientInfo & client_info, MutableColumns & columns, size_t & i)
{
    ...
    const String & client_hostname = client_info.getClientHostName();
    typeid_cast<ColumnLowCardinality &>(*columns[i++]).insertData(client_hostname.data(), client_hostname.size());
