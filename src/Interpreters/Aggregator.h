...
using AggregatedDataWithKeys128 = HashMap<UInt128, AggregateDataPtr, UInt128HashNew>;
...
using AggregatedDataWithKeys128TwoLevel = TwoLevelHashMap<UInt128, AggregateDataPtr, UInt128HashNew>;
