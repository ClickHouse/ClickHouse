...
InterpreterCreateQuery::TableProperties InterpreterCreateQuery::setProperties(ASTCreateQuery & create) const
{
    ...
    else if (create.as_table_function)
    {
        ...
        auto table_function = TableFunctionFactory::instance().get(create.as_table_function->as<ASTFunction &>(), context);
                                           ...
                                           const InterpreterCreateQuery::TableProperties & properties)
{
    ...
    if (create.as_table_function)
    {
        ...
        res = factory.get(create.as_table_function->as<ASTFunction &>(), context)
                  ->execute(create.as_table_function->as<ASTFunction &>(), context, create.table, properties.columns);
