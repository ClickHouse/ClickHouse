...
BlockIO InterpreterCreateQuery::createDatabase(ASTCreateQuery & create)
{
    ...
    if (!create.storage && create.attach)
    {
        ...
        if (create.getTableAst() || !create.storage)
    ...
    if (database->getUUID() != UUIDHelpers::Nil)
    {
        if (create.attach && !from_path && create.uuid == UUIDHelpers::Nil)
        {
            throw Exception(ErrorCodes::INCORRECT_QUERY,
                            ...
                            kind_upper,
                            kind_upper, create.getTableAst()->formatForErrorMessage(),
                            kind_upper, create.getTableAst()->formatForErrorMessage(),
                            kind_upper, create.getTableAst()->formatForErrorMessage(),
                            kind_upper, create.getTableAst()->formatForErrorMessage());
        }
...
BlockIO InterpreterCreateQuery::createTable(ASTCreateQuery & create)
{
    ...
    if (create.isTemporary() && create.getDatabaseAst())
    ...
    auto database_name = create.getDatabaseAst() ? create.getDatabase() : current_database;
...
BlockIO InterpreterCreateQuery::fillTableIfNeeded(const ASTCreateQuery & create)
{
        ...
        && (!(create.is_materialized_view || create.is_window_view) || create.is_populate))
    {
        ...
        if (auto db_ast = create.getDatabaseAst())
            query->setDatabaseAst(db_ast->clone());
        if (auto tbl_ast = create.getTableAst())
            query->setTableAst(tbl_ast->clone());
...
BlockIO InterpreterCreateQuery::execute()
{
    ...
    bool is_create_database = create.getDatabaseAst() && !create.getTableAst();
