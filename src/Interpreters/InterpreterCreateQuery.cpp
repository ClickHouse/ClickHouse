                                           ...
                                           DDLGuardPtr & ddl_guard, LoadingStrictnessLevel mode)
{
    ...
    bool is_predefined_database = DatabaseCatalog::isPredefinedDatabase(create.getDatabase()) || DatabaseCatalog::instance().ignoreLimitsForDatabase(create.getDatabase());
