...
parser.add_argument('--runs', type=int, default=int(os.environ.get('CHPC_RUNS', 15)), help='Number of query runs per server. Defaults to CHPC_RUNS environment variable.')
