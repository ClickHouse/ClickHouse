...
class FlightServer(fl.FlightServerBase):
    ...
    def do_get(self, context, ticket):
        print(f"Запрос на данные с тикетом {ticket}")
...
if __name__ == "__main__":
    ...
    print(f"ArrowFlight сервер запущен на {location}")
    flight_server.serve()