...
cp /var/log/clickhouse-server/clickhouse-server.log /test_output/
cp /var/log/clickhouse-server/stderr.log /test_output/
cp /var/log/clickhouse-server/stdout.log /test_output/