...
# lldb over every server process blocks for the whole budget, and the SQL dump needs a
# live server, so neither collection is what these tests assert: both are replaced by
# markers they can observe.
