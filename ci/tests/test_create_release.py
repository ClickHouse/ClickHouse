...
def test_version_file_roundtrips(tmp_path, monkeypatch):
    ...
    version = chv.ClickHouseVersion(26, 6, 1, 54511, 42).with_description("stable")
...
def test_version_bump():
    ...
    patch = chv.ClickHouseVersion(26, 6, 5, 54511, 7)
    patch.bump_patch()
    assert patch.patch == 6 and patch.tweak == 1

    rollover = chv.ClickHouseVersion(26, 12, 1, 100)
    rollover.bump()
