...
class Workflow:
    ...
    class Config:
        ...
        # Override the generated `concurrency.group` (dispatch workflows only).
        # Empty keeps the default `${{ github.workflow }}`. Set two dispatch
        # workflows to the same value to serialize them against each other.
