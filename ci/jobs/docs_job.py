...
if __name__ == "__main__":
    ...
    # The legacy Docusaurus tree (docs/en) is still built pre-cutover, and its
    # system-table pages have AUTOGENERATED regions owned by this generator.
    # Keep it wired until the old tree is retired; the Mintlify tree is
    # regenerated separately by ci/jobs/scripts/docs/autogenerate/.
