...
def check_settings_changes_history():
    ...
    if not changed:
        # The file changed but no setting record was added, value-edited or removed (e.g. only
        # reason-text edits, or entries moved between blocks) - nothing to validate against the
