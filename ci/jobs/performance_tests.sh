...
# TODO TEST:
export CHPC_TEST_GREP=alter_select
...
cp -r --dereference ./programs/server/config.d /tmp/praktika/right/config
cp -r ./tests/config/top_level_domains  /tmp/praktika/right/
cp -r ./tests/performance /tmp/praktika/right/
cp -r ./tests/performance /tmp/praktika/left/
cd /tmp/praktika/right
chmod +x ../input/clickhouse
ln -sf ../input/clickhouse clickhouse-server
ln -sf ../input/clickhouse clickhouse-local
ln -sf ../input/clickhouse clickhouse-client
ln -sf ../input/clickhouse clickhouse-keeper
export PATH="/tmp/praktika/right:$PATH"
