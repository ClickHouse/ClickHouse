...
LOCALE_NAVIGATION_PATHS = " ".join(
    f"docs/{locale}/products/cloud/api-reference/navigation.json" for locale in LOCALE_DIRS
)
...
DOCS_PATHS = (
    ...
    f"docs/products/cloud/navigation.json {LOCALE_NAVIGATION_PATHS}"
)
...
descriptions), and the English and localized "API reference" navigation \
fragments. Most nights nothing changes and no PR is opened; when the upstream \
API changes, this PR carries the diff and self-updates until merged.
