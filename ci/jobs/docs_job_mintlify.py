...
def _protected_docs_guard():
    ...
    client_docs_sync = autogenerated and info.git_branch.startswith(
        CLIENT_DOCS_SYNC_BRANCH_PREFIX
    )
    if client_docs_sync:
        print("OK: skipping the protected-docs guard for a client docs sync.")
        return True
