...
TRUSTED_DOCS_SYNC_PR_AUTHOR = "workflow-authentication-public[bot]"
TRUSTED_DOCS_SYNCS = {
...
def _trusted_docs_sync(info):
    ...
    if not (
        ...
        and info.user_name == TRUSTED_DOCS_SYNC_PR_AUTHOR
    ):
        return None
    return TRUSTED_DOCS_SYNCS.get(info.git_branch)
