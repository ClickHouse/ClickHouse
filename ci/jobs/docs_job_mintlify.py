...
def _protected_docs_guard():
    ...
    # Trusted sync workflows attach this label to the PRs that refresh
    # generated regions and one-way copies owned by another repository.
    if "pr-autogenerated-docs" in info.pr_labels:
        print("OK: skipping the protected-docs guard for autogenerated docs.")
        return True
