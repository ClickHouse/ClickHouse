...
engines, data types, formats, table functions, window functions, dictionary
sources and layouts, system tables, and asynchronous metrics from the structured
documentation embedded in the ClickHouse source and exposed through the corresponding
`system.*` tables.
