...
def main():
    ...
    if res and JobStages.BUILD in stages:
        run_shell("clang-tidy without cache for Aggregator.cpp", "env CTCACHE_DISABLE=1 clang-tidy-cache clang-tidy-19 -p {build_dir} src/Interpreters/Aggregator.cpp")
