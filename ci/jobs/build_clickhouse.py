...
def main():
    ...
    if res and JobStages.BUILD in stages:
        ...
        if build_type in (BuildTypes.AMD_RELEASE, BuildTypes.ARM_RELEASE):
            targets += " compact-symbols"
