    ...
    if (
        ...
        results.append(
            Result.from_commands_run(
                name="Build Packages",
                command=[
                    f"ln -sfn {build_dir_normalized} {Utils.cwd()}/packages/build-dir",
