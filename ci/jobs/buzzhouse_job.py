...
def main():
    ...
    if res:
        ...
        buzz_config = {
            ...
            "disallowed_error_codes": "9,13,15,99,100,101,102,108,127,128,162,165,166,173,209,230,231,233,234,235,246,255,256,257,261,270,271,272,273,274,275,305,307,635,637,638,639,640,641,642,645,647,718,1003",
