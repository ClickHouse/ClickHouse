...
def main():
    ...
    if res:
        ...
        buzz_config = {
            ...
            "disallowed_error_codes": "9,11,13,15,99,100,101,102,104,108,127,162,165,166,167,168,172,209,230,231,233,234,235,246,256,257,261,271,272,273,274,275,305,307,521,635,637,638,639,640,641,642,645,647,718,1003",
