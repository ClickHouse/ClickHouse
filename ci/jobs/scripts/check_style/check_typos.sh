...
codespell \
    --skip "*generated*,*gperf*,*.bin,*.mrk*,*.idx,checksums.txt,*.dat,*.pyc,*.kate-swp,*obfuscateQueries.cpp,d3-*.js,*.min.js,viz-standalone.js,*.sum,${ROOT_PATH}/utils/check-style/aspell-ignore" \
