...
def run_func_test(
    ...
    # Start chaos threads (including the random query killer) after smoke check
    # completes, before actual stress test
...
def main():
    ...
    server_start_timeout = 600.0 if is_slow_build else 300.0
