...
# NOTE: event is temporarily set to PULL_REQUEST to validate the new stateless,
# AST fuzzer and BuzzHouse jobs on this PR before merge. Revert to
# Workflow.Event.SCHEDULE with `branches=[BASE_BRANCH]` and re-enable
# `cron_schedules` before merging (same validation approach as in #100419).
