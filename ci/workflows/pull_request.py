...
FUNCTIONAL_TESTS_PARALLEL_JOB_NAMES = [
    job.name
    for job in JobConfigs.functional_tests_jobs
    if "_debug, parallel" in job.name
]
...
workflow = Workflow.Config(
    ...
    jobs=[
        ...
        *[
            j.set_dependency(
                FUNCTIONAL_TESTS_PARALLEL_JOB_NAMES if "sequential" in j.name else []
            )
        ...
        *[
            job.set_dependency(FUNCTIONAL_TESTS_PARALLEL_JOB_NAMES)
        ...
        *[
        ...
        JobConfigs.docker_sever.set_dependency(FUNCTIONAL_TESTS_PARALLEL_JOB_NAMES),
        JobConfigs.docker_keeper.set_dependency(FUNCTIONAL_TESTS_PARALLEL_JOB_NAMES),
        *[
            job.set_dependency(FUNCTIONAL_TESTS_PARALLEL_JOB_NAMES)
