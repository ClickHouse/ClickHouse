...
class RunnerLabels:
    ...
    AMD_LARGE = ["self-hosted", "func-tester"]
    ARM_LARGE = ["self-hosted", "func-tester-aarch64"]
    AMD_MEDIUM = ["self-hosted", "func-tester"]
    ARM_MEDIUM = ["self-hosted", "func-tester-aarch64"]
    AMD_MEDIUM_CPU = ["self-hosted", "func-tester"]
    ARM_MEDIUM_CPU = ["self-hosted", "func-tester-aarch64"]
    AMD_MEDIUM_MEM = ["self-hosted", "func-tester"]
    ARM_MEDIUM_MEM = ["self-hosted", "func-tester-aarch64"]
    AMD_SMALL = ["self-hosted", "func-tester"]
    ARM_SMALL = ["self-hosted", "func-tester-aarch64"]
    AMD_SMALL_MEM = ["self-hosted", "func-tester"]
    ARM_SMALL_MEM = ["self-hosted", "func-tester-aarch64"]
