...
class BuildTypes(metaclass=MetaClasses.WithIter):
    ...
    # WebAssembly (wasm64, through Emscripten). Experimental: the tree builds up to the
    # `dbms` library, there is no full binary yet, and the CI job pins exactly what
    # builds (see build_clickhouse.py).
    WASM64 = "wasm64"
