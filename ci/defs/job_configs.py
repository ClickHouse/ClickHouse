...
class JobConfigs:
    ...
    docs_job_mintlify_autogenerated = Job.Config(
        name=JobNames.DOCS_MINTLIFY_AUTOGENERATED,
        runs_on=RunnerLabels.FUNC_TESTER_ARM,
        command="python3 ./ci/jobs/docs_job_mintlify.py --regenerate-source-docs",
        digest_config=Job.CacheDigestConfig(
            include_paths=[
                "./ci/jobs/docs_autogen_nightly.py",
                "./ci/jobs/docs_job_mintlify.py",
                "./ci/jobs/scripts/docs",
                "./docs/_migration",
                "./utils/generate-async-metrics-docs",
