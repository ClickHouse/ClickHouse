...
class JobConfigs:
    ...
    build_jobs = Job.Config(
        ...
        provides=[
            ...
            [ArtifactNames.CH_ARM_BINARY, ArtifactNames.LEXER_ARM_BINARY],
        ],
        runs_on=[
            RunnerLabels.BUILDER_AMD,
            RunnerLabels.BUILDER_AMD,
    ...
    functional_tests_jobs = common_ft_job_config.parametrize(
        parameter=[
            ...
            "arm_binary, old analyzer, s3 storage, DatabaseReplicated, parallel",
            "arm_binary, old analyzer, s3 storage, DatabaseReplicated, sequential",
        ...
        runs_on=[
            ...
            RunnerLabels.FUNC_TESTER_ARM,  # arm_binary, old analyzer, s3 storage, DatabaseReplicated, parallel
            RunnerLabels.FUNC_TESTER_ARM,  # arm_binary, old analyzer, s3 storage, DatabaseReplicated, sequential
            ...
            RunnerLabels.FUNC_TESTER_AMD,  # amd_tsan, parallel
