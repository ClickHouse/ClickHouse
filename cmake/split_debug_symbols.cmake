macro(clickhouse_split_debug_symbols)
   ...
   add_custom_command(TARGET ${STRIP_TARGET} POST_BUILD
       ...
       COMMAND "${STRIP_PATH}" --remove-section=.comment --remove-section=.note --keep-section=.clickhouse.hash --keep-section=.symtab --keep-section=.strtab --keep-section=.shstrtab "${STRIP_DESTINATION_DIR}/bin/${STRIP_TARGET}"
