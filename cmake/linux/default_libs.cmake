...
elseif (USE_MUSL)
    set (DEFAULT_LIBS "${CMAKE_SOURCE_DIR}/contrib/sysroot/linux-x86_64/lib/libllvmlibc.a ${DEFAULT_LIBS} ${BUILTINS_LIBRARY} ${EXTRA_BUILTINS_LIBRARY} ${COVERAGE_OPTION} -static -lc")
else ()
