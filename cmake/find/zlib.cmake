...
if (NOT MSVC)
    ...
    if (NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/${INTERNAL_ZLIB_NAME}")
        message (WARNING "Will use standard zlib, please clone manually:\n git clone https://github.com/madler/zlib.git ${ClickHouse_SOURCE_DIR}/src/contrib/${INTERNAL_ZLIB_NAME}")
    endif ()
endif ()

if(NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/${INTERNAL_ZLIB_NAME}/zlib.h")
...
if (NOT ZLIB_FOUND AND NOT MISSING_INTERNAL_ZLIB_LIBRARY)
    ...
    set (ZLIB_INCLUDE_DIR "${ClickHouse_SOURCE_DIR}/src/contrib/${INTERNAL_ZLIB_NAME}" "${ClickHouse_BINARY_DIR}/src/contrib/${INTERNAL_ZLIB_NAME}" CACHE INTERNAL "") # generated zconf.h
