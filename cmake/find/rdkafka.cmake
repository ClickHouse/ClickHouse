...
if (NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/cppkafka/CMakeLists.txt")
...
if (USE_INTERNAL_RDKAFKA_LIBRARY AND NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/librdkafka/CMakeLists.txt")
...
elseif (NOT MISSING_INTERNAL_RDKAFKA_LIBRARY AND NOT ARCH_ARM)
    ...
    set (RDKAFKA_INCLUDE_DIR "${ClickHouse_SOURCE_DIR}/src/contrib/librdkafka/src")
