...
if(NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/avro/lang/c++/CMakeLists.txt")
...
elseif(NOT MISSING_INTERNAL_AVRO_LIBRARY)
    ...
    set(AVROCPP_INCLUDE_DIR "${ClickHouse_SOURCE_DIR}/src/contrib/avro/lang/c++/include")
