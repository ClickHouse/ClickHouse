...
if(ENABLE_ODBC)
    ...
    if(USE_INTERNAL_ODBC_LIBRARY AND NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/unixodbc/README")
    ...
    if(USE_INTERNAL_ODBC_LIBRARY AND NOT MISSING_INTERNAL_ODBC_LIBRARY)
        ...
        set(ODBC_INCLUDE_DIRS "${ClickHouse_SOURCE_DIR}/src/contrib/unixodbc/include")
        set(ODBC_FOUND 1)
    else()
        find_package(ODBC)
    endif ()
