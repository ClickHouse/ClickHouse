...
if(NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/openssl/README")
...
if (NOT OPENSSL_FOUND AND NOT MISSING_INTERNAL_SSL_LIBRARY)
    ...
    set (OPENSSL_ROOT_DIR "${ClickHouse_SOURCE_DIR}/src/contrib/openssl")

    if (ARCH_AMD64)
        set (OPENSSL_INCLUDE_DIR "${OPENSSL_ROOT_DIR}/include" "${ClickHouse_SOURCE_DIR}/src/contrib/openssl-cmake/linux_x86_64/include")
    elseif (ARCH_AARCH64)
        set (OPENSSL_INCLUDE_DIR "${OPENSSL_ROOT_DIR}/include" "${ClickHouse_SOURCE_DIR}/src/contrib/openssl-cmake/linux_aarch64/include")
    endif ()
