...
if (ENABLE_JEMALLOC)
    if (USE_INTERNAL_JEMALLOC_LIBRARY AND NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/jemalloc/src/jemalloc.c")
    ...
    if ((NOT JEMALLOC_LIBRARIES OR NOT JEMALLOC_INCLUDE_DIR) AND NOT MISSING_INTERNAL_JEMALLOC_LIBRARY )
        ...
        set (JEMALLOC_INCLUDE_DIR "${ClickHouse_SOURCE_DIR}/src/contrib/jemalloc-cmake/include" "${ClickHouse_SOURCE_DIR}/src/contrib/jemalloc-cmake/include_linux_x86_64")
