...
if (NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/googletest/googletest/CMakeLists.txt")
...
if (NOT GTEST_SRC_DIR AND NOT GTEST_INCLUDE_DIRS AND NOT MISSING_INTERNAL_GTEST_LIBRARY)
    ...
    set (GTEST_INCLUDE_DIRS ${ClickHouse_SOURCE_DIR}/src/contrib/googletest/googletest)
endif ()
