...
if(ENABLE_S3)
    ...
    if (NOT EXISTS "${ClickHouse_SOURCE_DIR}/src/contrib/aws/aws-cpp-sdk-s3")
    ...
    if (USE_INTERNAL_AWS_S3_LIBRARY AND NOT MISSING_AWS_S3)
        set(AWS_S3_INCLUDE_DIR "${ClickHouse_SOURCE_DIR}/src/contrib/aws/aws-cpp-sdk-s3/include")
        set(AWS_S3_CORE_INCLUDE_DIR "${ClickHouse_SOURCE_DIR}/src/contrib/aws/aws-cpp-sdk-core/include")
