...
if (NOT LINKER_NAME)
    ...
    elseif (COMPILER_CLANG)
        ...
        find_program (LD64_PATH NAMES "ld64.lld-${COMPILER_VERSION_MAJOR}" "ld64.lld" "ld64")
...
if (LINKER_NAME)
    if (COMPILER_CLANG)
        ...
        elseif (LINKER_NAME MATCHES "ld64")
            find_program (LD64_PATH NAMES ${LINKER_NAME})
            if (NOT LD64_PATH)
                message (FATAL_ERROR "Using linker ${LINKER_NAME} but can't find its path.")
            endif ()
            set (CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} --ld-path=${LD64_PATH}")
            set (CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} --ld-path=${LD64_PATH}")
        else ()
