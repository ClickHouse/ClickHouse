...
if (CMAKE_BUILD_TYPE_UC STREQUAL "RELWITHDEBINFO" AND (ENABLE_THINLTO OR ENABLE_FUZZING))
    if (ARCH_AARCH64 OR ARCH_RISCV64)
        ...
        if (LINKER_NAME MATCHES "lld")
            ...
            if (ENABLE_THINLTO)
                ...
                set (CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO "${CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO} -Wl,--thinlto-jobs=${LINKING_JOBS}")
            endif ()
            if (ENABLE_FUZZING)
