...
if (CCACHE_VERSION VERSION_GREATER "3.2.0" OR NOT COMPILER_CLANG)
   ...
   message(${RECONFIGURE_MESSAGE_LEVEL} "Using ccache: No. Found ${CCACHE_EXECUTABLE} (version ${CCACHE_VERSION}) but disabled because of bug: https://bugzilla.samba.org/show_bug.cgi?id=8118")
endif ()
