...
elseif(COMPILER_CACHE STREQUAL "chcache")
    ...
    corrosion_import_crate(MANIFEST_PATH ${CMAKE_CURRENT_SOURCE_DIR}/utils/chcache/Cargo.toml)
    _corrosion_set_imported_location_deferred(chcache IMPORTED_LOCATION ARCHIVE_OUTPUT_DIRECTORY chcache)
    message(STATUS "Using chcache!!!")
    get_target_property(CCACHE_EXECUTABLE chcache IMPORTED_LOCATION)
    add_custom_target(chcache_tool ALL DEPENDS _cargo-build_chcache)
