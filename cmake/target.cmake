...
if (CMAKE_CROSSCOMPILING)
    ...
    elseif (OS_LINUX OR OS_ANDROID)
        ...
        elseif (ARCH_RISCV64)
            ...
            # H3 is provided by the Rust h3o crate.
            set (ENABLE_H3 OFF CACHE INTERNAL "")
        elseif (ARCH_S390X)
            set (ENABLE_GRPC OFF CACHE INTERNAL "")
            set (ENABLE_ARROW_FLIGHT OFF CACHE INTERNAL "")
            set (ENABLE_RUST OFF CACHE INTERNAL "")
    ...
    elseif (OS_FREEBSD)
        ...
        set (ENABLE_EMBEDDED_COMPILER OFF CACHE INTERNAL "")
        set (ENABLE_DWARF_PARSER OFF CACHE INTERNAL "")
        # Rust build is disabled for FreeBSD (see rust/workspace/CMakeLists.txt),
        # which means the H3 (h3o) crate is unavailable.
        set (ENABLE_H3 OFF CACHE INTERNAL "")
    else ()
