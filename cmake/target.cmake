...
if (CMAKE_CROSSCOMPILING)
    if (OS_DARWIN)
        ...
        set (CLICKHOUSE_ENABLE_GRPC OFF CACHE INTERNAL "") # no protobuf -> no grpc
        set (CLICKHOUSE_ENABLE_ICU OFF CACHE INTERNAL "")
        set (CLICKHOUSE_ENABLE_FASTOPS OFF CACHE INTERNAL "")
    elseif (OS_LINUX OR OS_ANDROID)
        if (ARCH_AARCH64)
            # FIXME: broken dependencies
            set (CLICKHOUSE_ENABLE_GRPC OFF CACHE INTERNAL "")
            set (CLICKHOUSE_ENABLE_SENTRY OFF CACHE INTERNAL "")
        elseif (ARCH_PPC64LE)
            set (CLICKHOUSE_ENABLE_GRPC OFF CACHE INTERNAL "")
            set (CLICKHOUSE_ENABLE_SENTRY OFF CACHE INTERNAL "")
        endif ()
    elseif (OS_FREEBSD)
        # FIXME: broken dependencies
        set (CLICKHOUSE_ENABLE_PARQUET OFF CACHE INTERNAL "")
        set (CLICKHOUSE_ENABLE_GRPC OFF CACHE INTERNAL "")
    ...
    if (USE_MUSL)
        set (CLICKHOUSE_ENABLE_SENTRY OFF CACHE INTERNAL "")
        set (CLICKHOUSE_ENABLE_ODBC OFF CACHE INTERNAL "")
        set (CLICKHOUSE_ENABLE_GRPC OFF CACHE INTERNAL "")
        set (CLICKHOUSE_ENABLE_HDFS OFF CACHE INTERNAL "")
        set (ENABLE_EMBEDDED_COMPILER OFF CACHE INTERNAL "")
    endif ()
