...
if(NOT TARGET FARMHASH::FARMHASH AND FARMHASH_INCLUDE_DIR AND FARMHASH_LIBRARIES)
  add_library(FARMHASH::FARMHASH UNKNOWN IMPORTED)
  set_target_properties(FARMHASH::FARMHASH PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${FARMHASH_INCLUDE_DIR}")
  set_property(TARGET FARMHASH::FARMHASH APPEND PROPERTY IMPORTED_LOCATION "${FARMHASH_LIBRARIES}")
endif()
