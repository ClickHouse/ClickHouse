...
if (ENABLE_CFI)
    ...
    if (DEFINED ENABLE_THINLTO AND NOT ENABLE_THINLTO)
        message (FATAL_ERROR "ENABLE_CFI requires ENABLE_THINLTO: CFI needs -flto=thin and -fwhole-program-vtables to work correctly")
    endif()
