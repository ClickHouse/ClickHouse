option (USE_INTERNAL_SSL_LIBRARY "Set to FALSE to use system *ssl library instead of bundled" 0)
...
if (NOT OPENSSL_FOUND)
    ...
    set (OPENSSL_INCLUDE_DIR "${ClickHouse_SOURCE_DIR}/contrib/ssl/include")
    if (USE_STATIC_LIBRARIES)
