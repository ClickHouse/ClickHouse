if (NOT READLINE_PATHS)
	...
	if (READLINE_LIB)
		...
		message (STATUS "Using line editing libraries (readline): ${LINE_EDITING_LIBS}; ${READLINE_INCLUDE_DIR}")
	elseif (EDIT_LIB)
		if (USE_STATIC_LIBRARIES)
		...
		message (STATUS "Using line editing libraries (edit): ${LINE_EDITING_LIBS}; ${READLINE_INCLUDE_DIR}")
	else ()
