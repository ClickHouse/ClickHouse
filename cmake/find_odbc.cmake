...
option (USE_INTERNAL_ODBC_LIBRARY "Set to FALSE to use system iodbc or unixodbc library instead of bundled" ${NOT_UNBUNDLED})
if (USE_INTERNAL_ODBC_LIBRARY AND NOT EXISTS "${ClickHouse_SOURCE_DIR}/contrib/iodbc/README")
    message (WARNING "submodule contrib/iodbc is missing. to fix try run: \n git submodule update --init --recursive")
   set (USE_INTERNAL_ODBC_LIBRARY 0)
endif ()

if (ENABLE_ODBC)
    if (USE_INTERNAL_ODBC_LIBRARY)
        set (ODBC_LIBRARIES iodbc)
        set (ODBC_FOUND 1)
        set (USE_ODBC 1)
    else ()
